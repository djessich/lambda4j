...
public interface BiObjLongConsumer<T, U> {
    ...
    /**
     * Creates a {@link BiObjLongConsumer} which uses the {@code first} parameter of this one as argument for the given {@link
     * Consumer}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjLongConsumer} which uses the {@code first} parameter of this one as argument for the given
     * {@code Consumer}.
    ...
    /**
     * Creates a {@link BiObjLongConsumer} which uses the {@code second} parameter of this one as argument for the given {@link
     * Consumer}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjLongConsumer} which uses the {@code second} parameter of this one as argument for the given
     * {@code Consumer}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link BiObjLongConsumer} which uses the {@code third} parameter of this one as argument for the given {@link
     * LongConsumer}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjLongConsumer} which uses the {@code third} parameter of this one as argument for the given
     * {@code LongConsumer}.
     * @throws NullPointerException If the given argument is {@code null}
     */
