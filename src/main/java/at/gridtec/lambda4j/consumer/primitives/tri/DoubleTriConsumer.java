...
public interface DoubleTriConsumer {
     ...
     */
    static void call(@Nonnull final DoubleTriConsumer consumer, double value1, double value2, double value3) {
     ...
     */
    @Nonnull
    default DoubleBiConsumer partial(double value1) {
     ...
     */
    @Nonnull
    default DoubleConsumer partial(double value1, double value2) {
