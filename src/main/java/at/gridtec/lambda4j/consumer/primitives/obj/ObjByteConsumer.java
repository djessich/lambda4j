...
public interface ObjByteConsumer<T> {
    ...
    /**
     * Returns a composed {@link ObjByteConsumer} that applies the given {@code before} {@link Function} and {@link
     ...
     * @param before2 The {@code ByteUnaryOperator} to apply before this operation is applied
     * @return A composed {@code ObjByteConsumer} that applies the given {@code before} {@code Function} and {@code
     * ByteUnaryOperator} to its input, and then applies this operation to the result.
     * @throws NullPointerException If one of the given functions are {@code null}
     * @see #andThen(ObjByteConsumer)
     */
    default <U> ObjByteConsumer<U> compose(final Function<? super U, ? extends T> before1,
     ...
     * @param before2 The {@code ToByteFunction} to apply after this operation is applied
