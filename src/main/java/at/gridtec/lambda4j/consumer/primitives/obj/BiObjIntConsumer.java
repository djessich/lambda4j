...
public interface BiObjIntConsumer<T, U> {
     ...
     */
    @Nonnull
    default ObjIntConsumer<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiConsumer<T, U> partial(int value) {
     ...
     */
    @Nonnull
    default IntConsumer partial(T t, U u) {
     ...
     */
    @Nonnull
    default Consumer<U> partial(T t, int value) {
     ...
     */
    @Nonnull
    default ObjIntConsumer<Pair<T, U>> tupled() {
        return this::accept;
    }
