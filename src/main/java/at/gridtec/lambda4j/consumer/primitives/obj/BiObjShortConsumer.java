...
public interface BiObjShortConsumer<T, U> {
     ...
     */
    @Nonnull
    default ObjShortConsumer<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiConsumer<T, U> partial(short value) {
     ...
     */
    @Nonnull
    default ShortConsumer partial(T t, U u) {
     ...
     */
    @Nonnull
    default Consumer<U> partial(T t, short value) {
