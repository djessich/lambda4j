...
public interface ThrowableBooleanTriConsumer extends BooleanTriConsumer {
    ...
    /**
     * Creates a {@link BooleanTriConsumer} which uses the first parameter of this one as argument for the given {@link
     * BooleanConsumer}.
     *
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code BooleanTriConsumer} which uses the first parameter of this one as argument for the given
    ...
    /**
     * Creates a {@link BooleanTriConsumer} which uses the second parameter of this one as argument for the given {@link
     * BooleanConsumer}.
     *
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code BooleanTriConsumer} which uses the second parameter of this one as argument for the
