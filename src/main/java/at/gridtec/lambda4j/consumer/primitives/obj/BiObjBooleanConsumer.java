...
public interface BiObjBooleanConsumer<T, U> {
     ...
     */
    @Nonnull
    default ObjBooleanConsumer<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiConsumer<T, U> partial(boolean value) {
     ...
     */
    @Nonnull
    default BooleanConsumer partial(T t, U u) {
     ...
     */
    @Nonnull
    default Consumer<U> partial(T t, boolean value) {
