...
public interface BiObjBooleanConsumer<T, U> {
    ...
    /**
     * Creates a {@link BiObjBooleanConsumer} which uses the first parameter of this one as argument for the given
     * {@link Consumer}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjBooleanConsumer} which uses the first parameter of this one as argument for the
     * given {@code Consumer}.
    ...
    /**
     * Creates a {@link BiObjBooleanConsumer} which uses the second parameter of this one as argument for the given
     * {@link Consumer}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjBooleanConsumer} which uses the second parameter of this one as argument for the
     * given {@code Consumer}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link BiObjBooleanConsumer} which uses the third parameter of this one as argument for the given
     * {@link BooleanConsumer}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjBooleanConsumer} which uses the third parameter of this one as argument for the
