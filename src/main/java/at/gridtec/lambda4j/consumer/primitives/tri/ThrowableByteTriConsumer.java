...
public interface ThrowableByteTriConsumer extends ByteTriConsumer {
    ...
    /**
     * Creates a {@link ByteTriConsumer} which uses the first parameter of this one as argument for the given {@link
     * ByteConsumer}.
     *
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ByteTriConsumer} which uses the first parameter of this one as argument for the given
     * {@code ByteConsumer}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link ByteTriConsumer} which uses the second parameter of this one as argument for the given {@link
     * ByteConsumer}.
     *
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ByteTriConsumer} which uses the second parameter of this one as argument for the given
     * {@code ByteConsumer}.
     * @throws NullPointerException If the given argument is {@code null}
     */
