...
public interface FloatTriConsumer {
     ...
     */
    static void call(@Nonnull final FloatTriConsumer consumer, float value1, float value2, float value3) {
        Objects.requireNonNull(consumer);
        consumer.accept(value1, value2, value3);
    }

    /**
     * Creates a {@link FloatTriConsumer} which uses the {@code first} parameter as argument for the given {@link
     * FloatConsumer}.
     *
    ...
    /**
     * Creates a {@link FloatTriConsumer} which uses the {@code second} parameter as argument for the given {@link
     * FloatConsumer}.
     *
    ...
    /**
     * Creates a {@link FloatTriConsumer} which uses the {@code third} parameter as argument for the given {@link
     * FloatConsumer}.
     *
    ...
    /**
     * Returns a composed {@link FloatTriConsumer} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@link FloatTriConsumer} that first applies the {@code before} operations to its input, and
     ...
     */
    @Nonnull
    default FloatTriConsumer compose(@Nonnull final FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U, V> TriConsumer<T, U, V> compose(@Nonnull final ToFloatFunction<? super T> before1,
     ...
     */
    @Nonnull
    default FloatTriConsumer andThen(@Nonnull final FloatTriConsumer after) {
     ...
     */
    @Nonnull
    default FloatBiConsumer partial(float value1) {
     ...
     */
    @Nonnull
    default FloatConsumer partial(float value1, float value2) {
