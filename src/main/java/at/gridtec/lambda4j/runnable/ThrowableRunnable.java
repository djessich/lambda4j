...
public interface ThrowableRunnable extends Runnable {
    ...
    /**
     * Creates a {@link ThrowableRunnable} from the given {@link Runnable}. This method is just convenience to provide a
     ...
     * #runThrows()} method of this interface and catches the thrown {@link Exception}s from it. If it is of type {@link
     ...
     * error occurred, throws the given {@link Exception}. The exception from this {@code ThrowableRunnable} is added as
