...
public interface ThrowableFunction<T, R> extends Function<T, R> {
    ...
    /**
     * Creates a {@link ThrowableFunction} from the given {@link Function}. This method is just convenience to provide a
    ...
    /**
     * Returns a composed {@link ThrowableFunction} that applies this {@code ThrowableFunction} to its input, and if an
     * error occurred, throws the given {@link Exception}. The exception from this {@code ThrowableFunction} is added as
     ...
     * @return A composed {@code Function} that applies this {@code ThrowableFunction}, and if an error occurred, the
     * supplied value from the given {@code Supplier}.
     * @throws NullPointerException If the given argument is {@code null}
     */
