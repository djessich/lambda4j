...
public interface ThrowableIntFunction<R> extends IntFunction<R> {
     ...
     * {@link #applyThrows(int)} method of this interface and catches the thrown {@link Exception}s from it. If it is of
    ...
    /**
     * Returns a composed {@link ThrowableIntFunction} that applies this {@code ThrowableIntFunction} to its input, and
     * if an error occurred, throws the given {@link Exception}. The exception from this {@code ThrowableIntFunction} is
