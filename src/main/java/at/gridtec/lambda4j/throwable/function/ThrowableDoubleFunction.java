...
public interface ThrowableDoubleFunction<R> extends DoubleFunction<R> {
    ...
    /**
     * Overrides the {@link DoubleFunction#apply(double)} method by using a redefinition as default method. It calls the
     * {@link #applyThrows(double)} method of this interface and catches the thrown {@link Exception}s from it. If it is
     ...
     * occurred, applies the given {@code DoubleFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
