 ...
 */
package at.gridtec.lambda4j.throwable.operators.unary;
...
public interface ThrowableLongUnaryOperator extends LongUnaryOperator {
     ...
     * from it. If it is of type {@link RuntimeException}, the exception is rethrown. Other throwable types are
     * sneakily thrown.
     *
     * @param operand The argument for the operator
     * @return The return value from the operator.
