...
public interface ThrowableCharTriPredicate extends CharTriPredicate {
     ...
     * ThrowableCharTriPredicate} is ignored.
     *
    ...
    /**
     * Returns a composed {@link CharTriPredicate} that applies this {@link ThrowableCharTriPredicate} to its input,
     * and if an error occurred, applies the given {@code CharTriPredicate} representing a fallback. The exception from
     * this {@code ThrowableCharTriPredicate} is ignored.
     *
    ...
    /**
     * Returns a composed {@link CharTriPredicate} that applies this {@link ThrowableCharTriPredicate} to its input,
     * and if an error occurred, returns {@code true}. The exception from this {@code ThrowableCharTriPredicate} is
     * ignored.
     *
     * @return A composed {@code CharTriPredicate} that applies this {@code ThrowableCharTriPredicate}, and if an error
    ...
    /**
     * Returns a composed {@link CharTriPredicate} that applies this {@link ThrowableCharTriPredicate} to its input,
     * and if an error occurred, returns {@code false}. The exception from this {@code ThrowableCharTriPredicate} is
     * ignored.
     *
     * @return A composed {@code CharTriPredicate} that applies this {@code ThrowableCharTriPredicate}, and if an error
