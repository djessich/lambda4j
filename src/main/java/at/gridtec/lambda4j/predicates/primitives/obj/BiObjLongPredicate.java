...
public interface BiObjLongPredicate<T, U> {
    ...
    /**
     * Returns a {@link BiObjLongPredicate} the always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @return A {@link BiObjLongPredicate} the always returns {@code true}.
     * @see #alwaysFalse()
     */
     ...
     * this {@code BiObjLongPredicate} with JRE specific methods, only accepting {@code TriPredicate}.
     *
