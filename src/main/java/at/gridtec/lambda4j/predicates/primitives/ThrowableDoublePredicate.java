...
public interface ThrowableDoublePredicate extends DoublePredicate {
    ...
    /**
     * Returns a {@link ThrowableDoublePredicate} that tests if the given argument is equal to the one of this predicate
    ...
    /**
     * Overrides the {@link DoublePredicate#test(double)} method by using a redefinition as default method. It calls the
     * {@link #testThrows(double)} method of this interface and catches the thrown {@link Exception}s from it. If it is
