...
public interface ThrowableCharBiPredicate extends CharBiPredicate {
    ...
    /**
     * Overrides the {@link CharBiPredicate#test(char, char)} method by using a redefinition as default method. It
     * calls the {@link #testThrows(char, char)} method of this interface and catches the thrown {@link Exception}s
