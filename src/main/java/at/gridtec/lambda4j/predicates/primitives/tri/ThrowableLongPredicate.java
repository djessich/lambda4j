...
@FunctionalInterface
public interface ThrowableLongPredicate extends LongTriPredicate {
     ...
     * overloaded methods accepting different functional interfaces. The given {@code ThrowableLongTriPredicate} is
     * returned as-is.
     *
     * @param lambda The {@code ThrowableLongTriPredicate} which should be returned as-is.
     * @return The given {@code ThrowableLongTriPredicate} as-is.
     ...
     * @throws NullPointerException If the given argument is {@code null}
     */
    static ThrowableLongPredicate from(final LongTriPredicate lambda) {
        Objects.requireNonNull(lambda);
        return lambda::test;
    }
     ...
     * @return A {@code ThrowableLongTriPredicate} which always returns a given value.
     */
    ...
    /**
     * Returns a {@link ThrowableLongPredicate} that tests if the given arguments are equal to the ones of this
     ...
     * @return A {@code ThrowableLongTriPredicate} that tests if the given arguments are equal to the ones of this
     * predicate.
     * @see #isNotEqual(long, long, long)
     */
    static ThrowableLongPredicate isEqual(long target1, long target2, long target3) {
        return (value1, value2, value3) -> (value1 == target1) && (value2 == target2) && (value3 != target3);
    }

    /**
     * Returns a {@link ThrowableLongPredicate} that tests if the given arguments are not equal to the ones of this
     * predicate according to {@code value != target} method.
     *
     * @param target1 The first target value with which to compare for equality
     * @param target2 The second target value with which to compare for equality
     * @param target3 The third target value with which to compare for equality
     * @return A {@code ThrowableLongTriPredicate} that tests if the given arguments are not equal to the ones of this
     * predicate.
     * @see #isEqual(long, long, long)
     */
    static ThrowableLongPredicate isNotEqual(long target1, long target2, long target3) {
        return (value1, value2, value3) -> (value1 != target1) && (value2 != target2) && (value3 != target3);
    }
    ...
    /**
     * Returns a {@link ThrowableLongPredicate} the always returns {@code false}.
     *
     * @return A {@link ThrowableLongPredicate} the always returns {@code false}.
     * @see #alwaysTrue()
     */
    static ThrowableLongPredicate alwaysFalse() {
        return (value1, value2, value3) -> false;
    }

    /**
     * The test method for this {@link ThrowableLongPredicate} which is able to throw any {@link Exception} type.
     *
     ...
     */
    boolean testThrows(long value1, long value2, long value3) throws Exception;

    /**
     * Overrides the {@link LongTriPredicate#test(long, long, long)} method by using a redefinition as default method.
     * It calls the {@link #testThrows(long, long, long)} method of this interface and catches the thrown {@link
     ...
     */
    @Override
    default boolean test(long value1, long value2, long value3) {
        try {
     ...
     * occurred, applies the given {@code LongTriPredicate}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    default LongTriPredicate fallbackTo(final LongTriPredicate fallback) {
     ...
     */
    default LongTriPredicate orReturnTrue() {
        return (value1, value2, value3) -> {
            try {
                return testThrows(value1, value2, value3);
            } catch (Exception ignored) {
     ...
     */
    default LongTriPredicate orReturnFalse() {
        return (value1, value2, value3) -> {
            try {
                return testThrows(value1, value2, value3);
            } catch (Exception ignored) {
