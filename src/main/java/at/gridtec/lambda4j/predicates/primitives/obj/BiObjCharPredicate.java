...
public interface BiObjCharPredicate<T, U> {
     ...
     */
    static <T, U> BiObjCharPredicate<T, U> isEqual(Object targetRef1, Object targetRef2, char targetValue) {
     ...
     */
    static <T, U> BiObjCharPredicate<T, U> isNotEqual(Object targetRef1, Object targetRef2, char targetValue) {
        return (t, u, value) -> !(t == null ? targetRef1 == null : t.equals(targetRef1)) || !(t == null ? targetRef2
                == null : t.equals(targetRef2)) || (value != targetValue);
    }
     ...
     * {@code BiObjCharPredicate} throws an exception, the {@code other} {@code BiObjCharPredicate} will not be
     * evaluated.
     *
     ...
     */
    default BiObjCharPredicate<T, U> and(final BiObjCharPredicate<T, U> other) {
     ...
     */
    default BiObjCharPredicate<T, U> or(final BiObjCharPredicate<T, U> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> test(t, u, value) && other.test(t, u, value);
    }
     ...
     * of this {@code BiObjCharPredicate} throws an exception, the {@code other} {@code BiObjCharPredicate} will not be
     * evaluated.
     *
     ...
     * @see #or(BiObjCharPredicate)
     */
    default BiObjCharPredicate<T, U> xor(final BiObjCharPredicate<T, U> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> test(t, u, value) ^ other.test(t, u, value);
    }
     ...
     * this {@code BiObjCharPredicate} with JRE specific methods, only accepting {@code TriPredicate}.
     *
