...
public interface ThrowableFloatTriPredicate extends FloatTriPredicate {
    ...
    /**
     * Implicitly casts, and therefore wraps a given lambda as {@link ThrowableFloatTriPredicate}. This is a
     * convenience method in case the given {@link ThrowableFloatTriPredicate} is ambiguous for the compiler. This
     * might happen for overloaded methods accepting different functional interfaces. The given {@code
     * ThrowableFloatTriPredicate} is returned as-is.
     *
    ...
    /**
     * Returns a composed {@link ThrowableFloatTriPredicate} that applies this {@code ThrowableFloatTriPredicate} to
     ...
     * and if an error occurred, applies the given {@code FloatTriPredicate} representing a fallback. The exception
     * from this {@code ThrowableFloatTriPredicate} is ignored.
     *
    ...
    /**
     * Returns a composed {@link FloatTriPredicate} that applies this {@link ThrowableFloatTriPredicate} to its
