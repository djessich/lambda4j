...
public interface ThrowableIntPredicate extends IntPredicate {
     ...
     * overloaded methods accepting different functional interfaces. The given {@code ThrowableIntPredicate} is returned
     * as-is.
     *
     ...
     * and if an error occurred, applies the given one. The exception from this {@code ThrowableIntPredicate} is
     * ignored.
     *
     ...
     * error occurred, applies the given {@code IntPredicate} representing a fallback. The exception from this {@code
     * ThrowableIntPredicate} is ignored.
     *
    ...
    /**
     * Returns a composed {@link IntPredicate} that applies this {@link ThrowableIntPredicate} to its input, and if an
     * error occurred, returns {@code true}. The exception from this {@code ThrowableIntPredicate} is ignored.
     *
     * @return A composed {@code IntPredicate} that applies this {@code ThrowableIntPredicate}, and if an error
