...
public interface BiObjDoublePredicate<T, U> {
    ...
    /**
     * Returns a {@link BiObjDoublePredicate} the always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @return A {@link BiObjDoublePredicate} the always returns {@code true}.
     * @see #alwaysFalse()
     */
     ...
     * this {@code BiObjDoublePredicate} with JRE specific methods, only accepting {@code TriPredicate}.
     *
