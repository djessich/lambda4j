...
public interface ThrowableByteBiPredicate extends ByteBiPredicate {
    ...
    /**
     * Returns a {@link ThrowableByteBiPredicate} that always returns {@code true}.
     *
     * @return A {@link ThrowableByteBiPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    ...
    /**
     * Overrides the {@link ByteBiPredicate#test(byte, byte)} method by using a redefinition as default method. It calls
     * the {@link #testThrows(byte, byte)} method of this interface and catches the thrown {@link Exception}s from it.
