...
public interface ThrowableBytePredicate extends BytePredicate {
    ...
    /**
     * Creates a {@link ThrowableBytePredicate} from the given {@link BytePredicate}. This method is just convenience
    ...
    /**
     * Returns a {@link ThrowableBytePredicate} that tests if two arguments are equal according to {@code value ==
     * target} operation.
     *
     * @param target The target value with which to compare for equality
     * @return A {@code ThrowableBytePredicate} that tests if two arguments are equal.
     * @see #isNotEqual(byte)
     */
    ...
    /**
     * Returns a {@link ThrowableBytePredicate} that tests if two arguments are not equal according to {@code value !=
     * target} operation.
     *
     * @param target The target value with which to compare for equality
     * @return A {@code ThrowableBytePredicate} that tests if two arguments are not equal.
     * @see #isEqual(byte)
     */
     ...
     * {@link #testThrows(byte)} method of this interface and catches the thrown {@link Exception}s from it. If it is
    ...
    /**
     * Returns a composed {@link BytePredicate} that applies this {@link ThrowableBytePredicate} to its input, and if
     * an error occurred, applies the given {@code BytePredicate} representing a fallback. The exception from this
     * {@code ThrowableBytePredicate} is ignored.
     *
    ...
    /**
     * Returns a composed {@link BytePredicate} that applies this {@link ThrowableBytePredicate} to its input, and if
     * an error occurred, returns {@code true}. The exception from this {@code ThrowableBytePredicate} is ignored.
     *
     * @return A composed {@code BytePredicate} that applies this {@code ThrowableBytePredicate}, and if an error
    ...
    /**
     * Returns a composed {@link BytePredicate} that applies this {@link ThrowableBytePredicate} to its input, and if
     * an error occurred, returns {@code false}. The exception from this {@code ThrowableBytePredicate} is ignored.
     *
     * @return A composed {@code BytePredicate} that applies this {@code ThrowableBytePredicate}, and if an error
