...
/**
 * Represents a predicate (boolean-valued function) of two object-valued and a {@code byte}-valued argument. This is
 * the {@code (reference, reference, byte)}-consuming specialization of {@link TriPredicate}.
 * <p>
