...
public interface BiObjBytePredicate<T, U> {
     ...
     */
    static <T, U> BiObjBytePredicate<T, U> isEqual(Object targetRef1, Object targetRef2, byte targetValue) {
     ...
     */
    static <T, U> BiObjBytePredicate<T, U> isNotEqual(Object targetRef1, Object targetRef2, byte targetValue) {
        return (t, u, value) -> !(t == null ? targetRef1 == null : t.equals(targetRef1)) || !(t == null ? targetRef2
                == null : t.equals(targetRef2)) || (value != targetValue);
    }

    /**
     * Returns a {@link BiObjBytePredicate} the always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @return A {@link BiObjBytePredicate} the always returns {@code true}.
     * @see #alwaysFalse()
     */
     ...
     */
    default BiObjBytePredicate<T, U> and(final BiObjBytePredicate<T, U> other) {
     ...
     * this {@code BiObjBytePredicate} with JRE specific methods, only accepting {@code TriPredicate}.
     *
