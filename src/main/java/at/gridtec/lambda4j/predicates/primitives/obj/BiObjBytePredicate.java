...
public interface BiObjBytePredicate<T, U> {
     ...
     */
    @Nonnull
    default ObjBytePredicate<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiPredicate<T, U> partial(byte value) {
     ...
     */
    @Nonnull
    default BytePredicate partial(T t, U u) {
     ...
     */
    @Nonnull
    default Predicate<U> partial(T t, byte value) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(T t, U u, byte value) {
