...
public interface ThrowableLongPredicate extends LongPredicate {
    ...
    /**
     * Creates a {@link ThrowableLongPredicate} from the given {@link LongPredicate}. This method is just convenience to
     ...
     * {@link #testThrows(long)} method of this interface and catches the thrown {@link Exception}s from it. If it is of
    ...
    /**
     * Returns a composed {@link LongPredicate} that applies this {@link ThrowableLongPredicate} to its input, and if an
     * error occurred, applies the given {@code LongPredicate} representing a fallback. The exception from this {@code
     * ThrowableLongPredicate} is ignored.
     *
    ...
    /**
     * Returns a composed {@link LongPredicate} that applies this {@link ThrowableLongPredicate} to its input, and if an
     * error occurred, returns {@code true}. The exception from this {@code ThrowableLongPredicate} is ignored.
     *
     * @return A composed {@code LongPredicate} that applies this {@code ThrowableLongPredicate}, and if an error
    ...
    /**
     * Returns a composed {@link LongPredicate} that applies this {@link ThrowableLongPredicate} to its input, and if an
     * error occurred, returns {@code false}. The exception from this {@code ThrowableLongPredicate} is ignored.
     *
     * @return A composed {@code LongPredicate} that applies this {@code ThrowableLongPredicate}, and if an error
