...
public interface ThrowableBiPredicate<T, U> extends BiPredicate<T, U> {
    ...
    /**
     * Overrides the {@link BiPredicate#test(Object, Object)} method by using a redefinition as default method. It calls
     * the {@link #testThrows(Object, Object)} method of this interface and catches the thrown {@link Exception}s from
    ...
    /**
     * Returns a composed {@link ThrowableBiPredicate} that applies this {@code ThrowableBiPredicate} to its input, and
     * if an error occurred, throws the given {@link Exception}. The exception from this {@code ThrowableBiPredicate} is
