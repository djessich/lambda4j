...
public interface ObjLongFunction<T, R> {
    ...
    /**
     * Creates a {@link ObjLongFunction} which uses the first parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of argument to the function
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjLongFunction} which uses the first parameter of this one as argument for the given
     * {@code Function}.
    ...
    /**
     * Creates a {@link ObjLongFunction} which uses the second parameter of this one as argument for the given {@link
     * LongFunction}.
     *
     * @param <T> The type of argument to the function
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjLongFunction} which uses the second parameter of this one as argument for the given
     * {@code LongFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
     ...
     */
    default ObjLongToLongFunction<T> andThen(final ToLongFunction<? super R> after) {
