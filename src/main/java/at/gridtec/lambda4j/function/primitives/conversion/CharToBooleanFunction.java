...
/**
 * Represents a function that accepts a {@code char}-valued argument and produces a {@code boolean}-valued result. This
 * is the {@code char}-to-{@code boolean} primitive specialization for {@link Function}.
 * <p>
