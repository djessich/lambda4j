...
public interface BiObjIntFunction<T, U, R> {
    ...
    /**
     * Creates a {@link BiObjIntFunction} which uses the first parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjIntFunction} which uses the first parameter of this one as argument for the given
     * {@code Function}.
    ...
    /**
     * Creates a {@link BiObjIntFunction} which uses the second parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjIntFunction} which uses the second parameter of this one as argument for the given
     * {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link BiObjIntFunction} which uses the third parameter of this one as argument for the given {@link
     * IntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjIntFunction} which uses the third parameter of this one as argument for the given
     * {@code IntFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
