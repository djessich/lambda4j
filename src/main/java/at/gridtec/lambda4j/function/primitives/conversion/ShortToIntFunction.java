...
/**
 * Represents a function that accepts a {@code short}-valued argument and produces a {@code int}-valued result. This is
 * the {@code short}-to-{@code int} primitive specialization for {@link Function}.
 * <p>
