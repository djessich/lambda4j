...
/**
 * Represents a function that accepts a {@code long}-valued argument and produces a {@code byte}-valued result. This is
 * the {@code long}-to-{@code byte} primitive specialization for {@link Function}.
 * <p>
