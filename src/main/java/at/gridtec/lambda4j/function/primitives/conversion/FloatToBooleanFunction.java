...
/**
 * Represents a function that accepts a float-valued argument and produces a boolean-valued result. This is the {@code
 * float}-to-{@code boolean} primitive specialization for {@link Function}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsBoolean(float)}.
 *
...
public interface FloatToBooleanFunction {
     ...
     * @return A {@code FloatToBooleanFunction} which always returns a given value.
     */
    @Nonnull
    static FloatToBooleanFunction constant(boolean ret) {
        return value -> ret;
    }
    ...
    /**
     * Returns a composed {@link FloatToBooleanFunction} that first applies the {@code before} operation to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code FloatToBooleanFunction} that first applies the {@code before} operation to its input,
     ...
     */
    @Nonnull
    default FloatToBooleanFunction compose(@Nonnull final FloatUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsBoolean(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default <T> Predicate<T> compose(@Nonnull final ToFloatFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsBoolean(before.applyAsFloat(t));
    }
     ...
     */
    @Nonnull
    default <R> FloatFunction<R> andThen(@Nonnull final BooleanFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default FloatToBooleanFunction andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanSupplier partial(float value) {
        return () -> applyAsBoolean(value);
    }

    /**
     * Returns a composed {@link Function} which represents this {@link FloatToBooleanFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code FloatToBooleanFunction} with JRE specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code FloatToBooleanFunction}.
     */
    @Nonnull
    default Function<Float, Boolean> boxed() {
