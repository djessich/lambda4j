...
public interface TriBooleanToByteFunction {
     ...
     */
    @Nonnull
    default BiBooleanToByteFunction partial(boolean value1) {
     ...
     */
    @Nonnull
    default BooleanToByteFunction partial(boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    default ByteSupplier partial(boolean value1, boolean value2, boolean value3) {
