...
public interface BiLongToDoubleFunction {
     ...
     */
    @Nonnull
    default LongBinaryOperator andThenToLong(@Nonnull final DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToDoubleFunction partial(long value1) {
     ...
     */
    @Nonnull
    default DoubleSupplier partial(long value1, long value2) {
