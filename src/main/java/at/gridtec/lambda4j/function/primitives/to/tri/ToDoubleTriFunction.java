...
public interface ToDoubleTriFunction<T, U, V> {
     ...
     * returning {@code boolean}. Thereby the {@code double}-to-{@code boolean} primitive specialization of {@link
     * Function} is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code byte}. Thereby the {@code double}-to-{@code byte} primitive specialization of {@link Function}
     * is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code char}. Thereby the {@code double}-to-{@code char} primitive specialization of {@link Function}
     * is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code double}. Thereby the {@code double}-producing primitive specialization of {@link UnaryOperator}
     * is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code float}. Thereby the {@code double}-to-{@code float} primitive specialization of {@link Function}
     * is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code int}. Thereby the {@code double}-to-{@code int} primitive specialization of {@link Function} is
     * used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code long}. Thereby the {@code double}-to-{@code long} primitive specialization of {@link Function}
     * is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code short}. Thereby the {@code double}-to-{@code short} primitive specialization of {@link Function}
     * is used.
     *
     * @param after The function to apply after this function is applied
