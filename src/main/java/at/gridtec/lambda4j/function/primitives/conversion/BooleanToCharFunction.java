...
/**
 * Represents a function that accepts a {@code boolean}-valued argument and produces a {@code char}-valued result. This
 * is the {@code boolean}-to-{@code char} primitive specialization for {@link Function}.
 * <p>
