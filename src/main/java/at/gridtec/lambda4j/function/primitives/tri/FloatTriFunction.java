...
import at.gridtec.lambda4j.function.primitives.conversion.tri.TriFloatToBooleanFunction;
...
public interface FloatTriFunction<R> {
    ...
    /**
     * Returns a composed {@link FloatTriFunction} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@code FloatTriFunction} that first applies the {@code before} operations to its input, and
     ...
     */
    @Nonnull
    default FloatTriFunction<R> compose(@Nonnull final FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U, V> TriFunction<T, U, V, R> compose(@Nonnull final ToFloatFunction<? super T> before1,
     ...
     */
    @Nonnull
    default <S> FloatTriFunction<S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default TriFloatToBooleanFunction andThenToBoolean(@Nonnull final Predicate<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToByteFunction andThenToByte(@Nonnull final ToByteFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToCharFunction andThenToChar(@Nonnull final ToCharFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction andThenToDouble(@Nonnull final ToDoubleFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatTernaryOperator andThenToFloat(@Nonnull final ToFloatFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToIntFunction andThenToInt(@Nonnull final ToIntFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToLongFunction andThenToLong(@Nonnull final ToLongFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToShortFunction andThenToShort(@Nonnull final ToShortFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     * @return A composed {@code FloatTriConsumer} that first applies this function to its input, and then consumes the
     * result using the given {@code Consumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default FloatTriConsumer consume(@Nonnull final Consumer<? super R> consumer) {
     ...
     */
    @Nonnull
    default FloatBiFunction<R> partial(float value1) {
     ...
     */
    @Nonnull
    default FloatFunction<R> partial(float value1, float value2) {
     ...
     */
    @Nonnull
    default Supplier<R> partial(float value1, float value2, float value3) {
     ...
     */
    @Nonnull
    default FloatTriFunction<Optional<R>> nonNull() {
