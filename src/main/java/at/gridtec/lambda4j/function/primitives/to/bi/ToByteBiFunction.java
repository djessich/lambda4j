...
public interface ToByteBiFunction<T, U> {
     ...
     */
    @Nonnull
    default ToByteBiFunction<T, U> andThen(@Nonnull final ByteUnaryOperator after) {
     ...
     */
    @Nonnull
    default ToCharBiFunction<T, U> toChar(@Nonnull final ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToDoubleBiFunction<T, U> toDouble(@Nonnull final ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToFloatBiFunction<T, U> toFloat(@Nonnull final ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToIntBiFunction<T, U> toInt(@Nonnull final ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToLongBiFunction<T, U> toLong(@Nonnull final ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToShortBiFunction<T, U> toShort(@Nonnull final ByteToShortFunction after) {
        Objects.requireNonNull(after);
