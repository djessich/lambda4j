...
/**
 * Represents a function that accepts three int-valued arguments and produces a char-valued result. This is the {@code
 * int}-to-{@code char} primitive specialization for {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface TriIntToCharFunction {
    ...
    /**
     * Returns a composed {@link TriIntToCharFunction} that first applies the {@code before} operations to its input,
     ...
     * @return A composed {@code TriIntToCharFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default TriIntToCharFunction compose(@Nonnull final IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U, V> ToCharTriFunction<T, U, V> compose(@Nonnull final ToIntFunction<? super T> before1,
            @Nonnull final ToIntFunction<? super U> before2, @Nonnull final ToIntFunction<? super V> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u, v) -> applyAsChar(before1.applyAsInt(t), before2.applyAsInt(u), before3.applyAsInt(v));
    }
     ...
     */
    @Nonnull
    default <R> IntTriFunction<R> andThen(@Nonnull final CharFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default IntTriConsumer consume(@Nonnull final CharConsumer consumer) {
     ...
     */
    @Nonnull
    default BiIntToCharFunction partial(int value1) {
     ...
     */
    @Nonnull
    default IntToCharFunction partial(int value1, int value2) {
     ...
     */
    @Nonnull
    default CharSupplier partial(int value1, int value2, int value3) {
