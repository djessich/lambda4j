...
/**
 * Represents a function that accepts a {@code byte}-valued argument and produces a {@code float}-valued result. This
 * is the {@code byte}-to-{@code float} primitive specialization for {@link Function}.
 * <p>
