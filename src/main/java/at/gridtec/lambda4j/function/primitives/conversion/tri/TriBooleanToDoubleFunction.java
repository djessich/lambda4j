...
/**
 * Represents a function that accepts three boolean-valued arguments and produces a double-valued result. This is the
 * {@code boolean}-to-{@code double} primitive specialization for {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface TriBooleanToDoubleFunction {
    ...
    /**
     * Returns a composed {@link TriBooleanToDoubleFunction} that first applies the {@code before} operations to its
     ...
     * @return A composed {@code TriBooleanToDoubleFunction} that first applies the {@code before} operations to its
     ...
     */
    @Nonnull
    default TriBooleanToDoubleFunction compose(@Nonnull final BooleanUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U, V> ToDoubleTriFunction<T, U, V> compose(@Nonnull final Predicate<? super T> before1,
            @Nonnull final Predicate<? super U> before2, @Nonnull final Predicate<? super V> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u, v) -> applyAsDouble(before1.test(t), before2.test(u), before3.test(v));
    }
     ...
     */
    @Nonnull
    default <R> BooleanTriFunction<R> andThen(@Nonnull final DoubleFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default BooleanTriConsumer consume(@Nonnull final DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default BiBooleanToDoubleFunction partial(boolean value1) {
     ...
     */
    @Nonnull
    default BooleanToDoubleFunction partial(boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    default DoubleSupplier partial(boolean value1, boolean value2, boolean value3) {
