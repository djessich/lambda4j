...
public interface ToIntTriFunction<T, U, V> {
     ...
     */
    @Nonnull
    static <T, U, V> ToIntTriFunction<T, U, V> constant(byte ret) {
        return (t, u, v) -> ret;
    }
     ...
     */
    @Nonnull
    default ToIntTriFunction<T, U, V> compose(@Nonnull final UnaryOperator<T> before1,
     ...
     */
    @Nonnull
    default <R> TriFunction<T, U, V, R> andThen(@Nonnull final IntFunction<? extends R> after) {
     ...
     * returning {@code boolean}. Thereby the {@code int}-to-{@code boolean} primitive specialization of {@link
     * Function} is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code byte}. Thereby the {@code int}-to-{@code byte} primitive specialization of {@link Function} is
     * used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code char}. Thereby the {@code int}-to-{@code char} primitive specialization of {@link Function} is
     * used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code double}. Thereby the {@code int}-to-{@code double} primitive specialization of {@link Function}
     * is used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code float}. Thereby the {@code int}-to-{@code float} primitive specialization of {@link Function} is
     * used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code int}. Thereby the {@code int}-producing primitive specialization of {@link UnaryOperator} is
     * used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code long}. Thereby the {@code int}-to-{@code long} primitive specialization of {@link Function} is
     * used.
     *
     * @param after The function to apply after this function is applied
     ...
     * <p>
     * This method is just convenience, to provide the ability to transform this function to an equal function,
     * returning {@code short}. Thereby the {@code int}-to-{@code short} primitive specialization of {@link Function} is
     * used.
     *
     * @param after The function to apply after this function is applied
