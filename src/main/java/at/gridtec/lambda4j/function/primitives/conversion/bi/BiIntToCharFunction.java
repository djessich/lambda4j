...
public interface BiIntToCharFunction {
     ...
     */
    @Nonnull
    default IntBiPredicate andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToCharFunction partial(int value1) {
     ...
     */
    @Nonnull
    default CharSupplier partial(int value1, int value2) {
