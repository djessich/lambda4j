...
/**
 * Represents a function that accepts a char-valued argument and produces a float-valued result. This is the {@code
 * char}-to-{@code float} primitive specialization for {@link Function}.
 * <p>
...
public interface CharToFloatFunction {
    ...
    /**
     * Returns a composed {@link CharToFloatFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code CharToFloatFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default CharToFloatFunction compose(@Nonnull final CharUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToFloatFunction<T> compose(@Nonnull final ToCharFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsFloat(before.applyAsChar(t));
    }
     ...
     */
    @Nonnull
    default <R> CharFunction<R> andThen(@Nonnull final FloatFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default CharToBooleanFunction andThenToBoolean(@Nonnull final FloatToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatSupplier partial(char value) {
     ...
     * {@code CharToFloatFunction} with JRE specific methods, only accepting {@code Function}.
     *
