...
/**
 * Represents a function that accepts a {@code byte}-valued argument and produces a {@code char}-valued result. This is
 * the {@code byte}-to-{@code char} primitive specialization for {@link Function}.
 * <p>
