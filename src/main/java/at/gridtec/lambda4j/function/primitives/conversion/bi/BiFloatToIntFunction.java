...
/**
 * Represents a function that accepts two float-valued arguments and produces a int-valued result. This is the {@code
 * float}-to-{@code int} primitive specialization for {@link BiFunction}.
 * <p>
...
@FunctionalInterface
public interface BiFloatToIntFunction {
    ...
    /**
     * Returns a composed {@link BiFloatToIntFunction} that first applies the {@code before} operations to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before1 The first operation to apply before this function is applied
     * @param before2 The second operation to apply before this function is applied
     * @return A composed {@code BiFloatToIntFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default BiFloatToIntFunction compose(@Nonnull final FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U> ToIntBiFunction<T, U> compose(@Nonnull final ToFloatFunction<? super T> before1,
            @Nonnull final ToFloatFunction<? super U> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u) -> applyAsInt(before1.applyAsFloat(t), before2.applyAsFloat(u));
    }
     ...
     */
    @Nonnull
    default <R> FloatBiFunction<R> andThen(@Nonnull final IntFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default FloatBiPredicate andThenToBoolean(@Nonnull final IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatBiConsumer consume(@Nonnull final IntConsumer consumer) {
     ...
     */
    @Nonnull
    default FloatToIntFunction partial(float value1) {
     ...
     */
    @Nonnull
    default IntSupplier partial(float value1, float value2) {
     ...
     * {@code BiFloatToIntFunction} with JRE specific methods, only accepting {@code BiFunction}.
     *
