...
/**
 * Represents a function that accepts a {@code short}-valued argument and produces a {@code byte}-valued result. This
 * is the {@code short}-to-{@code byte} primitive specialization for {@link Function}.
 * <p>
