...
public interface BiIntToShortFunction {
     ...
     */
    @Nonnull
    default IntBiPredicate andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToShortFunction partial(int value1) {
     ...
     */
    @Nonnull
    default ShortSupplier partial(int value1, int value2) {
