...
/**
 * Represents a function that accepts a {@code int}-valued argument and produces a {@code byte}-valued result. This is
 * the {@code int}-to-{@code byte} primitive specialization for {@link Function}.
 * <p>
