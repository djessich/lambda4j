...
public interface ThrowableIntToDoubleFunction extends IntToDoubleFunction {
    ...
    /**
     * Overrides the {@link IntToDoubleFunction#applyAsDouble(int)} method by using a redefinition as default method. It
     * calls the {@link #applyAsDoubleThrows(int)} method of this interface and catches the thrown {@link Exception}s
    ...
    /**
     * Returns a composed {@link ThrowableIntToDoubleFunction} that applies this {@code ThrowableIntToDoubleFunction} to
