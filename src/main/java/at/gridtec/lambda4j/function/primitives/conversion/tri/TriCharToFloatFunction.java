...
public interface TriCharToFloatFunction {
     ...
     */
    @Nonnull
    default CharTriPredicate andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToFloatFunction partial(char value1) {
     ...
     */
    @Nonnull
    default CharToFloatFunction partial(char value1, char value2) {
     ...
     */
    @Nonnull
    default FloatSupplier partial(char value1, char value2, char value3) {
