...
public interface LongBiFunction<R> {
    ...
    /**
     * Creates a {@link LongBiFunction} which uses the {@code first} parameter of this one as argument for the given {@link
     * LongFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code LongBiFunction} which uses the {@code first} parameter of this one as argument for the given
     * {@code LongFunction}.
    ...
    /**
     * Creates a {@link LongBiFunction} which uses the {@code second} parameter of this one as argument for the given {@link
     * LongFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code LongBiFunction} which uses the {@code second} parameter of this one as argument for the given
     * {@code LongFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
