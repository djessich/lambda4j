...
public interface ShortToLongFunction {
    ...
    /**
     * Returns a composed {@link ShortToLongFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code ShortToLongFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default ShortToLongFunction compose(@Nonnull final ShortUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToLongFunction<T> compose(@Nonnull final ToShortFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsLong(before.applyAsShort(t));
    }
     ...
     */
    @Nonnull
    default <R> ShortFunction<R> andThen(@Nonnull final LongFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default ShortToBooleanFunction andThenToBoolean(@Nonnull final LongToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongSupplier partial(short value) {
        return () -> applyAsLong(value);
    }
    /**
     * Returns a composed {@link Function} which represents this {@link ShortToLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ShortToLongFunction} with JRE specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code ShortToLongFunction}.
     */
    @Nonnull
    default Function<Short, Long> boxed() {
