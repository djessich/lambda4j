...
/**
 * Represents a function that accepts a {@code short}-valued argument and produces a {@code long}-valued result. This
 * is the {@code short}-to-{@code long} primitive specialization for {@link Function}.
 * <p>
