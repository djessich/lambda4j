...
public interface BiObjByteFunction<T, U, R> {
    ...
    /**
     * Creates a {@link BiObjByteFunction} which uses the first parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjByteFunction} which uses the first parameter of this one as argument for the given
     * {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjByteFunction<T, U, R> onlyFirst(final Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(t);
    }

    /**
     * Creates a {@link BiObjByteFunction} which uses the second parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjByteFunction} which uses the second parameter of this one as argument for the given
     * {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjByteFunction<T, U, R> onlySecond(final Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(u);
    }

    /**
     * Creates a {@link BiObjByteFunction} which uses the third parameter of this one as argument for the given {@link
     * ByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjByteFunction} which uses the third parameter of this one as argument for the given
     * {@code ByteFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjByteFunction<T, U, R> onlyThird(final ByteFunction<? extends R> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Returns a composed {@link BiObjByteToByteFunction} that first applies this operation to its input, and then
     ...
     * @return A composed {@code BiObjByteToByteFunction} that first applies this operation, and then applies the {@code
     * after} operation to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @see #compose(Function, Function, ByteUnaryOperator)
     * @see #compose(Function, Function, ToByteFunction)
     */
    default BiObjByteToByteFunction<T, U> andThen(final ToByteFunction<? super R> after) {
