...
public interface BiObjByteFunction<T, U, R> {
    ...
    /**
     * Returns a composed {@link BiObjByteFunction} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@code BiObjByteFunction} that first applies the {@code before} operations to its input, and
     ...
     */
    @Nonnull
    default <A, B> BiObjByteFunction<A, B, R> compose(@Nonnull final Function<? super A, ? extends T> before1,
    ...
    /**
     * Returns a composed {@link ToByteBiObjByteFunction} that first applies this function to its input, and then
     * applies the {@code after} function to the result. If evaluation of either function throws an exception, it is
     * relayed to the caller of the composed function.
     *
     * @param after The function to apply after this function is applied
     * @return A composed {@code ToByteBiObjByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ToByteBiObjByteFunction<T, U> andThen(@Nonnull final ToByteFunction<? super R> after) {
     ...
     */
    @Nonnull
    default <S> BiObjByteFunction<T, U, S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
        Objects.requireNonNull(after);
