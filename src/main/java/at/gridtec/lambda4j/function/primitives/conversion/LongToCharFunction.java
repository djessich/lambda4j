...
/**
 * Represents a function that accepts a {@code long}-valued argument and produces a {@code char}-valued result. This is
 * the {@code long}-to-{@code char} primitive specialization for {@link Function}.
 * <p>
