...
public interface ToShortBiFunction<T, U> {
    ...
    /**
     * Creates a {@link ToShortBiFunction} which uses the first parameter of this one as argument for the given {@link
     * ToShortFunction}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ToShortBiFunction} which uses the first parameter of this one as argument for the given
    ...
    /**
     * Creates a {@link ToShortBiFunction} which uses the second parameter of this one as argument for the given {@link
     * ToShortFunction}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     * @param function The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ToShortBiFunction} which uses the second parameter of this one as argument for the given
     * {@code ToShortFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
