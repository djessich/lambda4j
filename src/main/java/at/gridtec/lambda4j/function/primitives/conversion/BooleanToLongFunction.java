...
/**
 * Represents a function that accepts a {@code boolean}-valued argument and produces a {@code long}-valued result. This
 * is the {@code boolean}-to-{@code long} primitive specialization for {@link Function}.
 * <p>
