...
/**
 * Represents a function that accepts two float-valued arguments and produces a boolean-valued result. This is the
 * {@code float}-to-{@code boolean} primitive specialization for {@link BiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsBoolean(float, float)}.
 *
 * @see BiFunction
 */
@SuppressWarnings("unused")
@FunctionalInterface
public interface BiFloatToBooleanFunction {

    /**
     * Calls the given {@link BiFloatToBooleanFunction} with the given arguments and returns its result.
     *
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code BiFloatToBooleanFunction}.
     * @throws NullPointerException If the given function is {@code null}
     */
    static boolean call(@Nonnull final BiFloatToBooleanFunction function, float value1, float value2) {
        Objects.requireNonNull(function);
        return function.applyAsBoolean(value1, value2);
    }

    /**
     * Creates a {@link BiFloatToBooleanFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link FloatToBooleanFunction}.
     *
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiFloatToBooleanFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code FloatToBooleanFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    @Nonnull
    static BiFloatToBooleanFunction onlyFirst(@Nonnull final FloatToBooleanFunction function) {
        Objects.requireNonNull(function);
        return (value1, value2) -> function.applyAsBoolean(value1);
    }

    /**
     * Creates a {@link BiFloatToBooleanFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link FloatToBooleanFunction}.
     *
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiFloatToBooleanFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code FloatToBooleanFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    @Nonnull
    static BiFloatToBooleanFunction onlySecond(@Nonnull final FloatToBooleanFunction function) {
        Objects.requireNonNull(function);
        return (value1, value2) -> function.applyAsBoolean(value2);
    }

    /**
     * Creates a {@link BiFloatToBooleanFunction} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code BiFloatToBooleanFunction} which always returns a given value.
     */
    @Nonnull
    static BiFloatToBooleanFunction constant(boolean ret) {
     ...
     */
    boolean applyAsBoolean(float value1, float value2);
    ...
    /**
     * Returns a composed {@link BiFloatToBooleanFunction} that first applies the {@code before} operations to its
     * input, and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before1 The first operation to apply before this function is applied
     * @param before2 The second operation to apply before this function is applied
     * @return A composed {@code BiFloatToBooleanFunction} that first applies the {@code before} operations to its
     ...
     */
    @Nonnull
    default BiFloatToBooleanFunction compose(@Nonnull final FloatUnaryOperator before1,
            @Nonnull final FloatUnaryOperator before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsBoolean(before1.applyAsFloat(value1), before2.applyAsFloat(value2));
    }
     ...
     */
    @Nonnull
    default <T, U> BiPredicate<T, U> compose(@Nonnull final ToFloatFunction<? super T> before1,
            @Nonnull final ToFloatFunction<? super U> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u) -> applyAsBoolean(before1.applyAsFloat(t), before2.applyAsFloat(u));
    }
     ...
     */
    @Nonnull
    default <R> FloatBiFunction<R> andThen(@Nonnull final BooleanFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default BiFloatToBooleanFunction andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatBiConsumer consume(@Nonnull final BooleanConsumer consumer) {
     ...
     */
    @Nonnull
    default FloatToBooleanFunction partial(float value1) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(float value1, float value2) {
        return () -> applyAsBoolean(value1, value2);
    }

    /**
     * Returns a composed {@link BiFunction} which represents this {@link BiFloatToBooleanFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code BiFloatToBooleanFunction} with JRE specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code BiFloatToBooleanFunction}.
     */
    @Nonnull
    default BiFunction<Float, Float, Boolean> boxed() {
