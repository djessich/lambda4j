...
/**
 * Represents a function that accepts a {@code float}-valued argument and produces a {@code char}-valued result. This
 * is the {@code float}-to-{@code char} primitive specialization for {@link Function}.
 * <p>
