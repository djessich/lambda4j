...
/**
 * Represents a function that accepts a float-valued argument and produces a char-valued result. This is the {@code
 * float}-to-{@code char} primitive specialization for {@link Function}.
 * <p>
...
public interface FloatToCharFunction {
    ...
    /**
     * Returns a composed {@link FloatToCharFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code FloatToCharFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default FloatToCharFunction compose(@Nonnull final FloatUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToCharFunction<T> compose(@Nonnull final ToFloatFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsChar(before.applyAsFloat(t));
    }
     ...
     */
    @Nonnull
    default <R> FloatFunction<R> andThen(@Nonnull final CharFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default FloatToBooleanFunction andThenToBoolean(@Nonnull final CharToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharSupplier partial(float value) {
     ...
     * {@code FloatToCharFunction} with JRE specific methods, only accepting {@code Function}.
     *
