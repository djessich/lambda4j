...
public interface ShortToBooleanFunction {
    ...
    /**
     * Calls the given {@link ShortToBooleanFunction} with the given arguments and returns its result.
     *
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ShortToBooleanFunction}.
     * @throws NullPointerException If the given function is {@code null}
     */
    static boolean call(@Nonnull final ShortToBooleanFunction function, short value) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(short value) {
