...
/**
 * Represents a function that accepts a {@code long}-valued argument and produces a {@code float}-valued result. This
 * is the {@code long}-to-{@code float} primitive specialization for {@link Function}.
 * <p>
