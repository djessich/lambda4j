...
/**
 * Represents a function that accepts two boolean-valued arguments and produces a long-valued result. This is the {@code
 * boolean}-to-{@code long} primitive specialization for {@link BiFunction}.
 * <p>
...
@FunctionalInterface
public interface BiBooleanToLongFunction {
     ...
     */
    static long call(@Nonnull final BiBooleanToLongFunction function, boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    static BiBooleanToLongFunction onlyFirst(@Nonnull final BooleanToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiBooleanToLongFunction onlySecond(@Nonnull final BooleanToLongFunction function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Returns a composed {@link BiBooleanToLongFunction} that first applies the {@code before} operations to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before1 The first operation to apply before this function is applied
     * @param before2 The second operation to apply before this function is applied
     * @return A composed {@code BiBooleanToLongFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction compose(@Nonnull final BooleanUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link ToLongBiFunction} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@code ToLongBiFunction} that first applies the {@code before} operations to its input, and
     ...
     */
    @Nonnull
    default <T, U> ToLongBiFunction<T, U> compose(@Nonnull final Predicate<? super T> before1,
            @Nonnull final Predicate<? super U> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u) -> applyAsLong(before1.test(t), before2.test(u));
    }
     ...
     */
    @Nonnull
    default <R> BooleanBiFunction<R> andThen(@Nonnull final LongFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default BiBooleanToByteFunction andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction andThenToLong(@Nonnull final LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToShortFunction andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanBiConsumer consume(@Nonnull final LongConsumer consumer) {
     ...
     */
    @Nonnull
    default BooleanToLongFunction partial(boolean value1) {
     ...
     */
    @Nonnull
    default LongSupplier partial(boolean value1, boolean value2) {
        return () -> applyAsLong(value1, value2);
    }

    /**
     * Returns a composed {@link BiFunction} which represents this {@link BiBooleanToLongFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code BiBooleanToLongFunction} with JRE specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code BiBooleanToLongFunction}.
     */
    @Nonnull
    default BiFunction<Boolean, Boolean, Long> boxed() {
