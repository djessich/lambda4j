...
/**
 * Represents a function that accepts a {@code boolean}-valued argument and produces a {@code byte}-valued result. This
 * is the {@code boolean}-to-{@code byte} primitive specialization for {@link Function}.
 * <p>
