...
public interface BiFloatToShortFunction {
     ...
     */
    @Nonnull
    default BiFloatToBooleanFunction andThenToBoolean(@Nonnull final ShortToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatToShortFunction partial(float value1) {
     ...
     */
    @Nonnull
    default ShortSupplier partial(float value1, float value2) {
