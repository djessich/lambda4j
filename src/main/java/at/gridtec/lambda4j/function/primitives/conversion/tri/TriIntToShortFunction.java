...
public interface TriIntToShortFunction {
     ...
     */
    @Nonnull
    default IntTriPredicate andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToShortFunction partial(int value1) {
     ...
     */
    @Nonnull
    default IntToShortFunction partial(int value1, int value2) {
     ...
     */
    @Nonnull
    default ShortSupplier partial(int value1, int value2, int value3) {
