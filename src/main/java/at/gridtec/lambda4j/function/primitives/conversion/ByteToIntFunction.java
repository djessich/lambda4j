...
/**
 * Represents a function that accepts a {@code byte}-valued argument and produces a {@code int}-valued result. This is
 * the {@code byte}-to-{@code int} primitive specialization for {@link Function}.
 * <p>
