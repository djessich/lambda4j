...
public interface ByteBiFunction<R> {
    ...
    /**
     * Creates a {@link ByteBiFunction} which uses the first parameter of this one as argument for the given {@link
     * ByteFunction}.
     *
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ByteBiFunction} which uses the first parameter of this one as argument for the given
     * {@code ByteFunction}.
    ...
    /**
     * Creates a {@link ByteBiFunction} which uses the second parameter of this one as argument for the given {@link
     * ByteFunction}.
     *
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ByteBiFunction} which uses the second parameter of this one as argument for the given
     * {@code ByteFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Applies this {@link ByteBiFunction} to the given argument.
     *
     ...
     * @return A composed {@code ByteBiFunction} that first applies the {@code before} {@code ByteBiUnaryOperator}s to
     ...
     * @see #andThen(Function)
     */
    default <T, V> BiFunction<T, V, R> compose(final ToByteFunction<? super T> before1,
