...
public interface IntToBooleanFunction {
    ...
    /**
     * Calls the given {@link IntToBooleanFunction} with the given arguments and returns its result.
     *
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code IntToBooleanFunction}.
     * @throws NullPointerException If the given function is {@code null}
     */
    static boolean call(@Nonnull final IntToBooleanFunction function, int value) {
        Objects.requireNonNull(function);
        return function.applyAsBoolean(value);
    }

    /**
     * Creates a {@link IntToBooleanFunction} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code IntToBooleanFunction} which always returns a given value.
     */
    @Nonnull
    static IntToBooleanFunction constant(boolean ret) {
        return value -> ret;
    }
    ...
    /**
     * Returns a composed {@link IntToBooleanFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code IntToBooleanFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default IntToBooleanFunction compose(@Nonnull final IntUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsBoolean(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default <T> Predicate<T> compose(@Nonnull final ToIntFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsBoolean(before.applyAsInt(t));
    }
     ...
     */
    @Nonnull
    default <R> IntFunction<R> andThen(@Nonnull final BooleanFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default IntToBooleanFunction andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToDoubleFunction andThenToDouble(@Nonnull final BooleanToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntUnaryOperator andThenToInt(@Nonnull final BooleanToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToLongFunction andThenToLong(@Nonnull final BooleanToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntConsumer consume(@Nonnull final BooleanConsumer consumer) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(int value) {
        return () -> applyAsBoolean(value);
    }

    /**
     * Returns a composed {@link Function} which represents this {@link IntToBooleanFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code IntToBooleanFunction} with JRE specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code IntToBooleanFunction}.
     */
    @Nonnull
    default Function<Integer, Boolean> boxed() {
