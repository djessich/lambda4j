...
/**
 * Represents a function that accepts a boolean-valued argument and produces a float-valued result. This is the {@code
 * boolean}-to-{@code float} primitive specialization for {@link Function}.
 * <p>
...
public interface BooleanToFloatFunction {
    ...
    /**
     * Returns a composed {@link BooleanToFloatFunction} that first applies the {@code before} operation to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code BooleanToFloatFunction} that first applies the {@code before} operation to its input,
     ...
     */
    @Nonnull
    default BooleanToFloatFunction compose(@Nonnull final BooleanUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToFloatFunction<T> compose(@Nonnull final Predicate<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsFloat(before.test(t));
    }
     ...
     */
    @Nonnull
    default <R> BooleanFunction<R> andThen(@Nonnull final FloatFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default FloatSupplier partial(boolean value) {
     ...
     * {@code BooleanToFloatFunction} with JRE specific methods, only accepting {@code Function}.
     *
