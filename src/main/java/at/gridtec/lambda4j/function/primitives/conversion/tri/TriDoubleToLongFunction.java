...
/**
 * Represents a function that accepts three double-valued arguments and produces a long-valued result. This is the
 * {@code double}-to-{@code long} primitive specialization for {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface TriDoubleToLongFunction {
    ...
    /**
     * Returns a composed {@link TriDoubleToLongFunction} that first applies the {@code before} operations to its input,
     ...
     * @return A composed {@code TriDoubleToLongFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction compose(@Nonnull final DoubleUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U, V> ToLongTriFunction<T, U, V> compose(@Nonnull final ToDoubleFunction<? super T> before1,
            @Nonnull final ToDoubleFunction<? super U> before2, @Nonnull final ToDoubleFunction<? super V> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u, v) -> applyAsLong(before1.applyAsDouble(t), before2.applyAsDouble(u), before3.applyAsDouble(v));
    }
     ...
     */
    @Nonnull
    default <R> DoubleTriFunction<R> andThen(@Nonnull final LongFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default TriDoubleToBooleanFunction andThenToBoolean(@Nonnull final LongToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleTriConsumer consume(@Nonnull final LongConsumer consumer) {
     ...
     */
    @Nonnull
    default BiDoubleToLongFunction partial(double value1) {
     ...
     */
    @Nonnull
    default DoubleToLongFunction partial(double value1, double value2) {
     ...
     */
    @Nonnull
    default LongSupplier partial(double value1, double value2, double value3) {
