...
/**
 * Represents a function that accepts a {@code long}-valued argument and produces a {@code boolean}-valued result. This
 * is the {@code long}-to-{@code boolean} primitive specialization for {@link Function}.
 * <p>
