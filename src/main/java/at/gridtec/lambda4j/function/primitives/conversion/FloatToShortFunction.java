...
/**
 * Represents a function that accepts a float-valued argument and produces a short-valued result. This is the {@code
 * float}-to-{@code short} primitive specialization for {@link Function}.
 * <p>
...
public interface FloatToShortFunction {
    ...
    /**
     * Returns a composed {@link FloatToShortFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code FloatToShortFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default FloatToShortFunction compose(@Nonnull final FloatUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToShortFunction<T> compose(@Nonnull final ToFloatFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsShort(before.applyAsFloat(t));
    }
     ...
     */
    @Nonnull
    default <R> FloatFunction<R> andThen(@Nonnull final ShortFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default FloatToBooleanFunction andThenToBoolean(@Nonnull final ShortToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortSupplier partial(float value) {
     ...
     * {@code FloatToShortFunction} with JRE specific methods, only accepting {@code Function}.
     *
