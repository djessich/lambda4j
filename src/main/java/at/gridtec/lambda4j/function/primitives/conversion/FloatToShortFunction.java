...
/**
 * Represents a function that accepts a {@code float}-valued argument and produces a {@code short}-valued result. This
 * is the {@code float}-to-{@code short} primitive specialization for {@link Function}.
 * <p>
