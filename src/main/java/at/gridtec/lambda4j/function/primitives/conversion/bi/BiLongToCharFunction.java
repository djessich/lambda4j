...
public interface BiLongToCharFunction {
     ...
     */
    @Nonnull
    default LongBiPredicate andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToCharFunction partial(long value1) {
     ...
     */
    @Nonnull
    default CharSupplier partial(long value1, long value2) {
