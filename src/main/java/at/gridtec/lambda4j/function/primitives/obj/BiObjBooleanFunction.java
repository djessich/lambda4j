...
public interface BiObjBooleanFunction<T, U, R> {
    ...
    /**
     * Returns a composed {@link BiObjBooleanConsumer} that fist applies this operation to its input, and then consumes the
     * result using the given {@link Consumer}. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code BiObjBooleanConsumer} that first applies this operation to its input, and then consumes the
