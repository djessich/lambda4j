...
/**
 * Represents a function that accepts a {@code boolean}-valued argument and produces a {@code int}-valued result. This
 * is the {@code boolean}-to-{@code int} primitive specialization for {@link Function}.
 * <p>
