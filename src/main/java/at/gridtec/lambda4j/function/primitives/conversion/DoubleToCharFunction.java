...
/**
 * Represents a function that accepts a {@code double}-valued argument and produces a {@code char}-valued result. This
 * is the {@code double}-to-{@code char} primitive specialization for {@link Function}.
 * <p>
