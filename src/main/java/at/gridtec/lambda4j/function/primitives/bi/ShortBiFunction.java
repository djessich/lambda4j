...
public interface ShortBiFunction<R> {
     ...
     * @return A composed {@code ShortBiFunction} that first applies the {@code before} {@code ShortBiUnaryOperator}s to
     ...
     * @see #andThen(Function)
     */
    default <T, V> BiFunction<T, V, R> compose(final ToShortFunction<? super T> before1,
