...
public interface BiShortToCharFunction {
     ...
     */
    @Nonnull
    default BiShortToBooleanFunction andThenToBoolean(@Nonnull final CharToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToCharFunction partial(short value1) {
     ...
     */
    @Nonnull
    default CharSupplier partial(short value1, short value2) {
