...
public interface LongTriFunction<R> {
     ...
     */
    @Nonnull
    default LongBiFunction<R> partial(long value1) {
     ...
     */
    @Nonnull
    default LongFunction<R> partial(long value1, long value2) {
     ...
     */
    @Nonnull
    default Supplier<R> partial(long value1, long value2, long value3) {
