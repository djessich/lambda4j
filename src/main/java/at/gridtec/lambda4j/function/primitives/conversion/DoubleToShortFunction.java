...
/**
 * Represents a function that accepts a {@code double}-valued argument and produces a {@code short}-valued result. This
 * is the {@code double}-to-{@code short} primitive specialization for {@link Function}.
 * <p>
