...
/**
 * Represents a function that accepts two object-valued and a {@code float}-valued argument, and produces a result. This
 * is the {@code (reference, reference, float)} specialization of {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface BiObjFloatFunction<T, U, R> {
     ...
     */
    static <T, U, R> BiObjFloatFunction<T, U, R> constant(R r) {
        return (t, u, value) -> r;
    }

    /**
     * Creates a {@link BiObjFloatFunction} which uses the first parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjFloatFunction} which uses the first parameter of this one as argument for the given
     * {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjFloatFunction<T, U, R> onlyFirst(final Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(t);
    }

    /**
     * Creates a {@link BiObjFloatFunction} which uses the second parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjFloatFunction} which uses the second parameter of this one as argument for the
     * given {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjFloatFunction<T, U, R> onlySecond(final Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(u);
    }

    /**
     * Creates a {@link BiObjFloatFunction} which uses the third parameter of this one as argument for the given {@link
     * FloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjFloatFunction} which uses the third parameter of this one as argument for the given
     * {@code FloatFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjFloatFunction<T, U, R> onlyThird(final FloatFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(value);
    }

    /**
     * Performs this {@link BiObjFloatFunction} to the given arguments.
     *
    ...
    /**
     * Returns a composed {@link BiObjFloatFunction} that first applies the {@code before} functions to its input, and
     ...
     * @return A composed {@code BiObjFloatFunction} that first applies the {@code before} functions to its input, and
     * then applies this operation to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @see #andThen(ToFloatFunction)
     * @see #andThen(Function)
     */
    default <A, B> BiObjFloatFunction<A, B, R> compose(final Function<? super A, ? extends T> before1,
            final Function<? super B, ? extends U> before2, final FloatUnaryOperator before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, value) -> apply(before1.apply(a), before2.apply(b), before3.applyAsFloat(value));
    }
    ...
    /**
     * Returns a composed {@link BiObjFloatToFloatFunction} that first applies this operation to its input, and then
     ...
     * @return A composed {@code BiObjFloatToFloatFunction} that first applies this operation, and then applies the
     * {@code after} operation to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @see #compose(Function, Function, FloatUnaryOperator)
     * @see #compose(Function, Function, ToFloatFunction)
     */
    default BiObjFloatToFloatFunction<T, U> andThen(final ToFloatFunction<? super R> after) {
        Objects.requireNonNull(after);
        return (t, u, value) -> after.applyAsFloat(apply(t, u, value));
    }
     ...
     * @see #compose(Function, Function, ToFloatFunction)
     */
    default <S> BiObjFloatFunction<T, U, S> andThen(final Function<? super R, ? extends S> after) {
        Objects.requireNonNull(after);
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    default BiObjFloatConsumer<T, U> consume(Consumer<? super R> consumer) {
