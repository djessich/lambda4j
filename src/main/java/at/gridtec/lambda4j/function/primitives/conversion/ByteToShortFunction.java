...
/**
 * Represents a function that accepts a {@code byte}-valued argument and produces a {@code short}-valued result. This
 * is the {@code byte}-to-{@code short} primitive specialization for {@link Function}.
 * <p>
