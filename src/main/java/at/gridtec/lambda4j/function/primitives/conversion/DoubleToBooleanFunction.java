...
public interface DoubleToBooleanFunction {
    ...
    /**
     * Calls the given {@link DoubleToBooleanFunction} with the given arguments and returns its result.
     *
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code DoubleToBooleanFunction}.
     * @throws NullPointerException If the given function is {@code null}
     */
    static boolean call(@Nonnull final DoubleToBooleanFunction function, double value) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(double value) {
