...
/**
 * Represents a function that accepts a short-valued argument and produces a float-valued result. This is the {@code
 * short}-to-{@code float} primitive specialization for {@link Function}.
 * <p>
...
public interface ShortToFloatFunction {
    ...
    /**
     * Returns a composed {@link ShortToFloatFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code ShortToFloatFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default ShortToFloatFunction compose(@Nonnull final ShortUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToFloatFunction<T> compose(@Nonnull final ToShortFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsFloat(before.applyAsShort(t));
    }
     ...
     */
    @Nonnull
    default <R> ShortFunction<R> andThen(@Nonnull final FloatFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default ShortToBooleanFunction andThenToBoolean(@Nonnull final FloatToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatSupplier partial(short value) {
     ...
     * {@code ShortToFloatFunction} with JRE specific methods, only accepting {@code Function}.
     *
