...
/**
 * Represents a function that accepts a {@code short}-valued argument and produces a {@code float}-valued result. This
 * is the {@code short}-to-{@code float} primitive specialization for {@link Function}.
 * <p>
