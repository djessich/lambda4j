...
public interface BiObjDoubleFunction<T, U, R> {
    ...
    /**
     * Returns a composed {@link BiObjDoubleFunction} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@code BiObjDoubleFunction} that first applies the {@code before} operations to its input, and
     ...
     */
    @Nonnull
    default <A, B> BiObjDoubleFunction<A, B, R> compose(@Nonnull final Function<? super A, ? extends T> before1,
     ...
     */
    @Nonnull
    default ToDoubleBiObjDoubleFunction<T, U> andThen(@Nonnull final ToDoubleFunction<? super R> after) {
