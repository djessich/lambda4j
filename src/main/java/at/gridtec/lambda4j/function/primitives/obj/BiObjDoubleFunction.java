...
public interface BiObjDoubleFunction<T, U, R> {
    ...
    /**
     * Creates a {@link BiObjDoubleFunction} which uses the first parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjDoubleFunction} which uses the first parameter of this one as argument for the
     * given {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjDoubleFunction<T, U, R> onlyFirst(final Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(t);
    }

    /**
     * Creates a {@link BiObjDoubleFunction} which uses the second parameter of this one as argument for the given
     * {@link Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjDoubleFunction} which uses the second parameter of this one as argument for the
     * given {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjDoubleFunction<T, U, R> onlySecond(final Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(u);
    }

    /**
     * Creates a {@link BiObjDoubleFunction} which uses the third parameter of this one as argument for the given {@link
     * DoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjDoubleFunction} which uses the third parameter of this one as argument for the
     * given {@code DoubleFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    static <T, U, R> BiObjDoubleFunction<T, U, R> onlyThird(final DoubleFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.apply(value);
    }

    /**
     * Performs this {@link BiObjDoubleFunction} to the given arguments.
     *
