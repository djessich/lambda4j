...
public interface ThrowableDoubleToIntFunction extends DoubleToIntFunction {
    ...
    /**
     * Overrides the {@link DoubleToIntFunction#applyAsInt(double)} method by using a redefinition as default method. It
     * calls the {@link #applyAsIntThrows(double)} method of this interface and catches the thrown {@link Exception}s
    ...
    /**
     * Returns a composed {@link ThrowableDoubleToIntFunction} that applies this {@code ThrowableDoubleToIntFunction} to
