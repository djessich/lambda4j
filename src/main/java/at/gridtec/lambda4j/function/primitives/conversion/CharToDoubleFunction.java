...
/**
 * Represents a function that accepts a char-valued argument and produces a double-valued result. This is the {@code
 * char}-to-{@code double} primitive specialization for {@link Function}.
 * <p>
...
public interface CharToDoubleFunction {
    ...
    /**
     * Returns a composed {@link CharToDoubleFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code CharToDoubleFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default CharToDoubleFunction compose(@Nonnull final CharUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToDoubleFunction<T> compose(@Nonnull final ToCharFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsDouble(before.applyAsChar(t));
    }
     ...
     */
    @Nonnull
    default <R> CharFunction<R> andThen(@Nonnull final DoubleFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default CharToBooleanFunction andThenToBoolean(@Nonnull final DoubleToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     * {@code CharToDoubleFunction} with JRE specific methods, only accepting {@code Function}.
     *
