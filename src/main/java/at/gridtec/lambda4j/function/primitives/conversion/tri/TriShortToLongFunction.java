...
public interface TriShortToLongFunction {
     ...
     */
    @Nonnull
    default ShortTriPredicate andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortToLongFunction partial(short value1) {
     ...
     */
    @Nonnull
    default ShortToLongFunction partial(short value1, short value2) {
     ...
     */
    @Nonnull
    default LongSupplier partial(short value1, short value2, short value3) {
