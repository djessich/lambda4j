...
public interface BiShortToIntFunction {
     ...
     */
    @Nonnull
    default BiShortToBooleanFunction andThenToBoolean(@Nonnull final IntToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToIntFunction partial(short value1) {
     ...
     */
    @Nonnull
    default IntSupplier partial(short value1, short value2) {
