...
public interface ToLongTriFunction<T, U, V> {
    ...
    /**
     * Creates a {@link ToLongTriFunction} which uses the first parameter of this one as argument for the given {@link
     * ToLongFunction}.
     *
     ...
     * @return Creates a {@code ToLongTriFunction} which uses the first parameter of this one as argument for the given
     * {@code ToLongFunction}.
    ...
    /**
     * Creates a {@link ToLongTriFunction} which uses the second parameter of this one as argument for the given {@link
     * ToLongFunction}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     ...
     * @return Creates a {@code ToLongTriFunction} which uses the second parameter of this one as argument for the given
     * {@code ToLongFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link ToLongTriFunction} which uses the third parameter of this one as argument for the given {@link
     * ToLongFunction}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     ...
     * @return Creates a {@code ToLongTriFunction} which uses the third parameter of this one as argument for the given
     * {@code ToLongFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
