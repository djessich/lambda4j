...
public interface ObjCharFunction<T, R> {
    ...
    /**
     * Returns a composed {@link ObjCharFunction} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@code ObjCharFunction} that first applies the {@code before} operations to its input, and
     ...
     */
    @Nonnull
    default <U> ObjCharFunction<U, R> compose(@Nonnull final Function<? super U, ? extends T> before1,
     ...
     */
    @Nonnull
    default CharFunction<R> partial(T t) {
     ...
     */
    @Nonnull
    default Function<T, R> partial(char value) {
     ...
     */
    @Nonnull
    default Supplier<R> partial(T t, char value) {
