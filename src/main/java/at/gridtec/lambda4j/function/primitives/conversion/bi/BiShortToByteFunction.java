...
/**
 * Represents a function that accepts two short-valued arguments and produces a byte-valued result. This is the {@code
 * short}-to-{@code byte} primitive specialization for {@link BiFunction}.
 * <p>
...
@FunctionalInterface
public interface BiShortToByteFunction {
    ...
    /**
     * Returns a composed {@link BiShortToByteFunction} that first applies the {@code before} operations to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before1 The first operation to apply before this function is applied
     * @param before2 The second operation to apply before this function is applied
     * @return A composed {@code BiShortToByteFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default BiShortToByteFunction compose(@Nonnull final ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U> ToByteBiFunction<T, U> compose(@Nonnull final ToShortFunction<? super T> before1,
            @Nonnull final ToShortFunction<? super U> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u) -> applyAsByte(before1.applyAsShort(t), before2.applyAsShort(u));
    }
     ...
     */
    @Nonnull
    default <R> ShortBiFunction<R> andThen(@Nonnull final ByteFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default BiShortToBooleanFunction andThenToBoolean(@Nonnull final ByteToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortBiConsumer consume(@Nonnull final ByteConsumer consumer) {
     ...
     */
    @Nonnull
    default ShortToByteFunction partial(short value1) {
     ...
     */
    @Nonnull
    default ByteSupplier partial(short value1, short value2) {
     ...
     * {@code BiShortToByteFunction} with JRE specific methods, only accepting {@code BiFunction}.
     *
