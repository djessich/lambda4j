...
public interface DoubleTriFunction<R> {
    ...
    /**
     * Creates a {@link DoubleTriFunction} which uses the first parameter of this one as argument for the given {@link
     * DoubleFunction}.
     *
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code DoubleTriFunction} which uses the first parameter of this one as argument for the given
     * {@code DoubleFunction}.
    ...
    /**
     * Creates a {@link DoubleTriFunction} which uses the second parameter of this one as argument for the given {@link
     * DoubleFunction}.
     *
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code DoubleTriFunction} which uses the second parameter of this one as argument for the given
     * {@code DoubleFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link DoubleTriFunction} which uses the third parameter of this one as argument for the given {@link
     * DoubleFunction}.
     *
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code DoubleTriFunction} which uses the third parameter of this one as argument for the given
     * {@code DoubleFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
