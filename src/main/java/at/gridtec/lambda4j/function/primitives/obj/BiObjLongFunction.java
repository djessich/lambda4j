...
public interface BiObjLongFunction<T, U, R> {
    ...
    /**
     * Creates a {@link BiObjLongFunction} which uses the first parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjLongFunction} which uses the first parameter of this one as argument for the given
     * {@code Function}.
    ...
    /**
     * Creates a {@link BiObjLongFunction} which uses the second parameter of this one as argument for the given {@link
     * Function}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjLongFunction} which uses the second parameter of this one as argument for the given
     * {@code Function}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link BiObjLongFunction} which uses the third parameter of this one as argument for the given {@link
     * LongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code BiObjLongFunction} which uses the third parameter of this one as argument for the given
     * {@code LongFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Performs this {@link BiObjLongFunction} to the given arguments.
     *
