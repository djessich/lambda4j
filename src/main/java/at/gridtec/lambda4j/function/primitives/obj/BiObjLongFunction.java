...
public interface BiObjLongFunction<T, U, R> {
    ...
    /**
     * Returns a composed {@link BiObjLongFunction} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@code BiObjLongFunction} that first applies the {@code before} operations to its input, and
     ...
     */
    @Nonnull
    default <A, B> BiObjLongFunction<A, B, R> compose(@Nonnull final Function<? super A, ? extends T> before1,
     ...
     */
    @Nonnull
    default ObjLongFunction<U, R> partial(T t) {
     ...
     */
    @Nonnull
    default BiFunction<T, U, R> partial(long value) {
     ...
     */
    @Nonnull
    default LongFunction<R> partial(T t, U u) {
     ...
     */
    @Nonnull
    default Function<U, R> partial(T t, long value) {
     ...
     */
    @Nonnull
    default Supplier<R> partial(T t, U u, long value) {
