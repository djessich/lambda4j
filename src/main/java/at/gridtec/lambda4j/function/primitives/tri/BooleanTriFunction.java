...
public interface BooleanTriFunction<R> {
     ...
     */
    @Nonnull
    default BooleanBiFunction<R> partial(boolean value1) {
     ...
     */
    @Nonnull
    default BooleanFunction<R> partial(boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    default Supplier<R> partial(boolean value1, boolean value2, boolean value3) {
