...
/**
 * Represents a function that accepts two double-valued arguments and produces a float-valued result. This is the {@code
 * double}-to-{@code float} primitive specialization for {@link BiFunction}.
 * <p>
...
@FunctionalInterface
public interface BiDoubleToFloatFunction {
    ...
    /**
     * Returns a composed {@link BiDoubleToFloatFunction} that first applies the {@code before} operations to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before1 The first operation to apply before this function is applied
     * @param before2 The second operation to apply before this function is applied
     * @return A composed {@code BiDoubleToFloatFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default BiDoubleToFloatFunction compose(@Nonnull final DoubleUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U> ToFloatBiFunction<T, U> compose(@Nonnull final ToDoubleFunction<? super T> before1,
            @Nonnull final ToDoubleFunction<? super U> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u) -> applyAsFloat(before1.applyAsDouble(t), before2.applyAsDouble(u));
    }
     ...
     */
    @Nonnull
    default DoubleBiPredicate andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleBiConsumer consume(@Nonnull final FloatConsumer consumer) {
     ...
     */
    @Nonnull
    default DoubleToFloatFunction partial(double value1) {
     ...
     */
    @Nonnull
    default FloatSupplier partial(double value1, double value2) {
     ...
     * to use this {@code BiDoubleToFloatFunction} with JRE specific methods, only accepting {@code BiFunction}.
     *
