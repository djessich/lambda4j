...
public interface ToFloatTriFunction<T, U, V> {
     ...
     */
    @Nonnull
    default ToFloatTriFunction<T, U, V> andThen(@Nonnull final FloatUnaryOperator after) {
     ...
     */
    @Nonnull
    default TriPredicate<T, U, V> toBoolean(@Nonnull final FloatToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToByteTriFunction<T, U, V> toByte(@Nonnull final FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToCharTriFunction<T, U, V> toChar(@Nonnull final FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToDoubleTriFunction<T, U, V> toDouble(@Nonnull final FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToIntTriFunction<T, U, V> toInt(@Nonnull final FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToLongTriFunction<T, U, V> toLong(@Nonnull final FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToShortTriFunction<T, U, V> toShort(@Nonnull final FloatToShortFunction after) {
        Objects.requireNonNull(after);
