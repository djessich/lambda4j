...
public interface ToFloatTriFunction<T, U, V> {
    ...
    /**
     * Creates a {@link ToFloatTriFunction} which uses the first parameter of this one as argument for the given {@link
     * ToFloatFunction}.
     *
     ...
     * @return Creates a {@code ToFloatTriFunction} which uses the first parameter of this one as argument for the given
    ...
    /**
     * Creates a {@link ToFloatTriFunction} which uses the second parameter of this one as argument for the given {@link
     * ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     ...
     * @return Creates a {@code ToFloatTriFunction} which uses the second parameter of this one as argument for the
    ...
    /**
     * Creates a {@link ToFloatTriFunction} which uses the third parameter of this one as argument for the given {@link
     * ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the operation
     * @param <U> The type of the second argument to the operation
     ...
     * @return Creates a {@code ToFloatTriFunction} which uses the third parameter of this one as argument for the given
     * {@code ToFloatFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
