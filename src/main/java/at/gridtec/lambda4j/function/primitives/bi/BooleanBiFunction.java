...
public interface BooleanBiFunction<R> {
     ...
     * @return A composed {@link BooleanBiFunction} that first applies the {@code before} operations to its input, and
     ...
     * @return A composed {@link BooleanBinaryOperator} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BooleanBinaryOperator andThen(@Nonnull final Predicate<? super R> after) {
     ...
     * @param after The function to apply after this function is applied
     * @return A composed {@link BooleanBiFunction} that first applies this function to its input, and then applies the
