...
public interface BooleanBiFunction<R> {
    ...
    /**
     * Creates a {@link BooleanBiFunction} which uses the first parameter of this one as argument for the given {@link
     * BooleanFunction}.
     *
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BooleanBiFunction} which uses the first parameter of this one as argument for the given
    ...
    /**
     * Creates a {@link BooleanBiFunction} which uses the second parameter of this one as argument for the given {@link
     * BooleanFunction}.
     *
     * @param <R> The return value from the operation
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BooleanBiFunction} which uses the second parameter of this one as argument for the given
     * {@code BooleanFunction}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Applies this {@link BooleanBiFunction} to the given argument.
     *
     ...
     * @return A composed {@code BooleanBiFunction} that first applies the {@code before} {@code
     * BooleanBiUnaryOperator}s to its input, and then applies this operation to the result.
     ...
     * @see #andThen(Function)
     */
    default <T, V> BiFunction<T, V, R> compose(final Predicate<? super T> before1, final Predicate<? super V> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
