...
public interface ByteToBooleanFunction {
    ...
    /**
     * Calls the given {@link ByteToBooleanFunction} with the given arguments and returns its result.
     *
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ByteToBooleanFunction}.
     * @throws NullPointerException If the given function is {@code null}
     */
    static boolean call(@Nonnull final ByteToBooleanFunction function, byte value) {
        Objects.requireNonNull(function);
        return function.applyAsBoolean(value);
    }

    /**
     * Creates a {@link ByteToBooleanFunction} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code ByteToBooleanFunction} which always returns a given value.
     */
    @Nonnull
    static ByteToBooleanFunction constant(boolean ret) {
        return value -> ret;
    }
    ...
    /**
     * Returns a composed {@link ByteToBooleanFunction} that first applies the {@code before} operation to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code ByteToBooleanFunction} that first applies the {@code before} operation to its input,
     ...
     */
    @Nonnull
    default ByteToBooleanFunction compose(@Nonnull final ByteUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsBoolean(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default <T> Predicate<T> compose(@Nonnull final ToByteFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsBoolean(before.applyAsByte(t));
    }
     ...
     */
    @Nonnull
    default <R> ByteFunction<R> andThen(@Nonnull final BooleanFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default ByteToBooleanFunction andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a composed {@link Function} which represents this {@link ByteToBooleanFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ByteToBooleanFunction} with JRE specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code ByteToBooleanFunction}.
     */
    @Nonnull
    default Function<Byte, Boolean> boxed() {
