...
/**
 * Represents a function that accepts a {@code byte}-valued argument and produces a {@code boolean}-valued result. This
 * is the {@code byte}-to-{@code boolean} primitive specialization for {@link Function}.
 * <p>
