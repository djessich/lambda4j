...
/**
 * Represents a function that accepts a {@code short}-valued argument and produces a {@code double}-valued result. This
 * is the {@code short}-to-{@code double} primitive specialization for {@link Function}.
 * <p>
