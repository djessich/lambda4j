...
/**
 * Represents a function that accepts a {@code float}-valued argument and produces a {@code byte}-valued result. This
 * is the {@code float}-to-{@code byte} primitive specialization for {@link Function}.
 * <p>
