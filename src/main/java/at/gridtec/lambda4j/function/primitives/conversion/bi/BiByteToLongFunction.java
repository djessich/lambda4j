...
/**
 * Represents a function that accepts two byte-valued arguments and produces a long-valued result. This is the {@code
 * byte}-to-{@code long} primitive specialization for {@link BiFunction}.
 * <p>
...
@FunctionalInterface
public interface BiByteToLongFunction {
    ...
    /**
     * Returns a composed {@link BiByteToLongFunction} that first applies the {@code before} operations to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before1 The first operation to apply before this function is applied
     * @param before2 The second operation to apply before this function is applied
     * @return A composed {@code BiByteToLongFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default BiByteToLongFunction compose(@Nonnull final ByteUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U> ToLongBiFunction<T, U> compose(@Nonnull final ToByteFunction<? super T> before1,
            @Nonnull final ToByteFunction<? super U> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u) -> applyAsLong(before1.applyAsByte(t), before2.applyAsByte(u));
    }
     ...
     */
    @Nonnull
    default <R> ByteBiFunction<R> andThen(@Nonnull final LongFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default BiByteToBooleanFunction andThenToBoolean(@Nonnull final LongToBooleanFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteBiConsumer consume(@Nonnull final LongConsumer consumer) {
     ...
     */
    @Nonnull
    default ByteToLongFunction partial(byte value1) {
     ...
     */
    @Nonnull
    default LongSupplier partial(byte value1, byte value2) {
     ...
     * {@code BiByteToLongFunction} with JRE specific methods, only accepting {@code BiFunction}.
     *
