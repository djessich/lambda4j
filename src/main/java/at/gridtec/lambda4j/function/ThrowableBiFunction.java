...
public interface ThrowableBiFunction<T, U, R> extends BiFunction<T, U, R> {
    ...
    /**
     * Implicitly casts, and therefore wraps a given lambda as {@link ThrowableBiFunction}. This is a convenience method
     * in case the given {@link ThrowableBiFunction} is ambiguous for the compiler. This might happen for overloaded
     * methods accepting different functional interfaces. The given {@code ThrowableBiFunction} is returned as-is.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <R> The type of return value from the function
    ...
    /**
     * Overrides the {@link BiFunction#apply(Object, Object)} method by using a redefinition as default method. It calls
     * the {@link #applyThrows(Object, Object)} method of this interface and catches the thrown {@link Exception}s from
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} that applies this {@code ThrowableBiFunction} to its input, and if
     * an error occurred, applies the given one. The exception from this {@code ThrowableBiFunction} is ignored.
     *
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} that applies this {@code ThrowableBiFunction} to its input, and if
     * an error occurred, throws the given {@link Exception}. The exception from this {@code ThrowableBiFunction} is
    ...
    /**
     * Returns a composed {@link BiFunction} that applies this {@link ThrowableBiFunction} to its input, and if an error
     * occurred, applies the given {@code BiFunction} representing a fallback. The exception from this {@code
    ...
    /**
     * Returns a composed {@link BiFunction} that applies this {@link ThrowableBiFunction} to its input, and if an error
     * occurred, returns the given value. The exception from this {@code ThrowableBiFunction} is ignored.
     *
    ...
    /**
     * Returns a composed {@link BiFunction} that applies this {@link ThrowableBiFunction} to its input, and if an error
     * occurred, returns the supplied value from the given {@link Supplier}. The exception from this {@code
     * ThrowableBiFunction} is ignored.
     *
