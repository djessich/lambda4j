...
public interface ThrowableByteSupplier extends ByteSupplier {
     ...
     * overloaded methods accepting different functional interfaces. The given {@code ThrowableByteSupplier} is
     * returned as-is.
     *
    ...
    /**
     * Returns a composed {@link ThrowableByteSupplier} that applies this {@code ThrowableByteSupplier} to its
     * input, and if an error occurred, applies the given one. The exception from this {@code ThrowableByteSupplier}
     * is ignored.
     *
