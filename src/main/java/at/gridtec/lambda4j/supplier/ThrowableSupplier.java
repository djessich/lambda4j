...
public interface ThrowableSupplier<T> extends Supplier<T> {
    ...
    /**
     * Creates a {@link ThrowableSupplier} from the given {@link Supplier}. This method is just convenience to provide a
    ...
    /**
     * Overrides the {@link Supplier#get()} method by using a redefinition as default method. It calls the {@link
     * #getThrows()} method of this interface and catches the thrown {@link Exception}s from it. If it is of type {@link
     * RuntimeException}, the exception is rethrown. Other exception types are sneakily thrown.
     *
     * @return The supplied value.
    ...
    /**
     * Returns a composed {@link ThrowableSupplier} that applies this {@code ThrowableSupplier} to its input, and if an
     * error occurred, throws the given {@link Exception}. The exception from this {@code ThrowableSupplier} is added as
    ...
    /**
     * Returns a composed {@link Supplier} that applies this {@link ThrowableSupplier} to its input, and if an error
     * occurred, returns the given value. The exception from this {@code ThrowableSupplier} is ignored.
     *
