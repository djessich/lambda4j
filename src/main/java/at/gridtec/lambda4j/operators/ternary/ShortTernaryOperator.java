...
public interface ShortTernaryOperator {
     ...
     * @return Creates a {@code ShortTernaryOperator} which uses the {@code left} parameter as argument for the given {@code
     * ShortUnaryOperator}.
     ...
     * @return Creates a {@code ShortTernaryOperator} which uses the {@code middle} parameter as argument for the given {@code
     * ShortUnaryOperator}.
     * @throws NullPointerException If the given argument is {@code null}
     */
     ...
     * @return Creates a {@code ShortTernaryOperator} which uses the {@code right} parameter as argument for the given {@code
     * ShortUnaryOperator}.
     * @throws NullPointerException If the given argument is {@code null}
     */
