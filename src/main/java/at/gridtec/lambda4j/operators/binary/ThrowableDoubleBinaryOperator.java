...
public interface ThrowableDoubleBinaryOperator extends DoubleBinaryOperator {
    ...
    /**
     * Creates a {@link DoubleBinaryOperator} which uses the {@code left} parameter as argument for the given {@link
     * DoubleUnaryOperator}.
     *
     * @param operator The operator which accepts the {@code short} parameter of this one
     * @return Creates a {@code DoubleBinaryOperator} which uses the {@code left} parameter as argument for the given {@code
     * DoubleUnaryOperator}.
     * @throws NullPointerException If the given argument is {@code null}
     */
    ...
    /**
     * Creates a {@link DoubleBinaryOperator} which uses the {@code right} parameter as argument for the given {@link
     * DoubleUnaryOperator}.
     *
     * @param operator The operator which accepts the {@code right} parameter of this one
     * @return Creates a {@code DoubleBinaryOperator} which uses the {@code right} parameter as argument for the given {@code
     * DoubleUnaryOperator}.
     * @throws NullPointerException If the given argument is {@code null}
     */
