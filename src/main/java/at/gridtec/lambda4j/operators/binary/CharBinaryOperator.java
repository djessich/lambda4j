...
public interface CharBinaryOperator {
     ...
     * right} operation.
     *
     * @return A {@code CharBinaryOperator} which returns the lesser of its operands.
     ...
     * right} operation.
     *
     * @return A {@code CharBinaryOperator} which returns the greater of its operands.
     ...
     * @return A composed {@code CharBinaryOperator} that first applies the {@code before} operator and then applies
     * this operator
