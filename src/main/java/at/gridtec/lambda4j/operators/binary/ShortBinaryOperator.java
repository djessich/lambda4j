...
public interface ShortBinaryOperator {
    ...
    /**
     * Returns a composed {@link ShortUnaryOperator} that first applies the {@code before} operators to its input, and
     ...
     * @return A composed {@code ShortUnaryOperator} that first applies the {@code before} operators and then applies
     ...
     * @param before1 The first operator to apply before this operator is applied
     * @param before2 The second operator to apply before this operator is applied
     * @return A composed {@code ToShortBiFunction} that first applies the {@code before} operation and then applies
     * this operator to the result.
     * @throws NullPointerException If given argument is {@code null}
