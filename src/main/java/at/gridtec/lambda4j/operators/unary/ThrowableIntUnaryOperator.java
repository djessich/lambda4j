...
public interface ThrowableIntUnaryOperator extends IntUnaryOperator {
    ...
    /**
     * Overrides the {@link IntUnaryOperator#applyAsInt(int)} method by using a redefinition as default method. It calls
     * the {@link #applyAsIntThrows(int)} method of this interface and catches the thrown {@link Exception}s from it. If
     * it is of type {@link RuntimeException}, the exception is rethrown. Other throwable types are sneakily thrown.
     *
     * @param operand The argument for the operator
     * @return The return value from the operator.
     ...
     * if an error occurred, applies the given {@code IntUnaryOperator} representing a fallback. The exception from this
    ...
    /**
     * Returns a composed {@link IntUnaryOperator} that applies this {@link ThrowableIntUnaryOperator} to its input, and
     * if an error occurred, returns the given value. The exception from this {@code ThrowableIntUnaryOperator} is
     * ignored.
     *
    ...
    /**
     * Returns a composed {@link IntUnaryOperator} that applies this {@link ThrowableIntUnaryOperator} to its input, and
     * if an error occurred, returns its value. The exception from this {@code ThrowableIntUnaryOperator} is ignored.
     *
     * @return A composed {@code IntUnaryOperator} that applies this {@code ThrowableIntUnaryOperator}, and if an error
