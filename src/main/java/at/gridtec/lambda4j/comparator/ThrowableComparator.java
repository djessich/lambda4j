...
public interface ThrowableComparator<T> extends Comparator<T> {
    ...
    /**
     * Implicitly casts, and therefore wraps a given lambda as {@link ThrowableComparator}. This is a convenience method
     * in case the given {@link ThrowableComparator} is ambiguous for the compiler. This might happen for overloaded
     * methods accepting different functional interfaces. The given {@code ThrowableComparator} is returned as-is.
     *
     * @param <T> The type of the compared values
    ...
    /**
     * Returns a composed {@link ThrowableComparator} that applies this {@code ThrowableComparator} to its input, and if
     * an error occurred, applies the given one. The exception from this {@code ThrowableComparator} is ignored.
     *
    ...
    /**
     * Returns a composed {@link ThrowableComparator} that applies this {@code ThrowableComparator} to its input, and if
     * an error occurred, throws the given {@link Exception}. The exception from this {@code ThrowableComparator} is
    ...
    /**
     * Returns a composed {@link Comparator} that applies this {@link ThrowableComparator} to its input, and if an error
     * occurred, applies the given {@code Comparator} representing a fallback. The exception from this {@code
    ...
    /**
     * Returns a composed {@link Comparator} that applies this {@link ThrowableComparator} to its input, and if an error
     * occurred, returns the given value. The exception from this {@code ThrowableComparator} is ignored.
     *
    ...
    /**
     * Returns a composed {@link Comparator} that applies this {@link ThrowableComparator} to its input, and if an error
     * occurred, returns the supplied value from the given {@link IntSupplier}. The exception from this {@code
     * ThrowableComparator} is ignored.
     *
