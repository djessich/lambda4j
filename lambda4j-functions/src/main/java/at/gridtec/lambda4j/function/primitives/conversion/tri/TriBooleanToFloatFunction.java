...
public interface TriBooleanToFloatFunction {
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction partial(boolean value1) {
     ...
     */
    @Nonnull
    default BooleanToFloatFunction partial(boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    default FloatSupplier partial(boolean value1, boolean value2, boolean value3) {
