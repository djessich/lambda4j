...
/**
 * Represents a function that accepts three int-valued arguments and produces a long-valued result. This is the {@code
 * int}-to-{@code long} primitive specialization for {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface TriIntToLongFunction {
    ...
    /**
     * Returns a composed {@link TriIntToLongFunction} that first applies the {@code before} operations to its input,
     ...
     * @return A composed {@code TriIntToLongFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default TriIntToLongFunction compose(@Nonnull final IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U, V> ToLongTriFunction<T, U, V> compose(@Nonnull final ToIntFunction<? super T> before1,
            @Nonnull final ToIntFunction<? super U> before2, @Nonnull final ToIntFunction<? super V> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u, v) -> applyAsLong(before1.applyAsInt(t), before2.applyAsInt(u), before3.applyAsInt(v));
    }
     ...
     */
    @Nonnull
    default <R> IntTriFunction<R> andThen(@Nonnull final LongFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default IntTriConsumer consume(@Nonnull final LongConsumer consumer) {
     ...
     */
    @Nonnull
    default BiIntToLongFunction partial(int value1) {
     ...
     */
    @Nonnull
    default IntToLongFunction partial(int value1, int value2) {
     ...
     */
    @Nonnull
    default LongSupplier partial(int value1, int value2, int value3) {
