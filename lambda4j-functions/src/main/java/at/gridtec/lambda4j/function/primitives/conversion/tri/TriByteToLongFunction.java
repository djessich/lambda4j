...
public interface TriByteToLongFunction {
     ...
     */
    @Nonnull
    default ByteTriPredicate andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToLongFunction partial(byte value1) {
     ...
     */
    @Nonnull
    default ByteToLongFunction partial(byte value1, byte value2) {
     ...
     */
    @Nonnull
    default LongSupplier partial(byte value1, byte value2, byte value3) {
