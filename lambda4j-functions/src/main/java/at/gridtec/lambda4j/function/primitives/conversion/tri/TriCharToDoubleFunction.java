...
public interface TriCharToDoubleFunction {
     ...
     */
    @Nonnull
    default CharTriPredicate andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToDoubleFunction partial(char value1) {
     ...
     */
    @Nonnull
    default CharToDoubleFunction partial(char value1, char value2) {
     ...
     */
    @Nonnull
    default DoubleSupplier partial(char value1, char value2, char value3) {
