...
public interface ThrowableToIntFunction<T> extends ToIntFunction<T> {
    ...
    /**
     * Creates a {@link ThrowableToIntFunction} from the given {@link ToIntFunction}. This method is just convenience to
    ...
    /**
     * Overrides the {@link ToIntFunction#applyAsInt(Object)} method by using a redefinition as default method. It calls
     * the {@link #applyAsIntThrows(Object)} method of this interface and catches the thrown {@link Exception}s from it.
    ...
    /**
     * Returns a composed {@link ToIntFunction} that applies this {@link ThrowableToIntFunction} to its input, and if an
     * error occurred, applies the given {@code ToIntFunction} representing a fallback. The exception from this {@code
    ...
    /**
     * Returns a composed {@link ToIntFunction} that applies this {@link ThrowableToIntFunction} to its input, and if an
     * error occurred, returns the given value. The exception from this {@code ThrowableToIntFunction} is ignored.
     *
