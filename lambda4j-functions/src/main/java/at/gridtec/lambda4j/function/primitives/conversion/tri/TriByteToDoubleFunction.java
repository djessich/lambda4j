...
public interface TriByteToDoubleFunction {
     ...
     */
    @Nonnull
    default ByteTriPredicate andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction partial(byte value1) {
     ...
     */
    @Nonnull
    default ByteToDoubleFunction partial(byte value1, byte value2) {
     ...
     */
    @Nonnull
    default DoubleSupplier partial(byte value1, byte value2, byte value3) {
