...
/**
 * Represents a function that accepts a long-valued argument and produces a char-valued result. This is the {@code
 * long}-to-{@code char} primitive specialization for {@link Function}.
 * <p>
...
public interface LongToCharFunction {
    ...
    /**
     * Returns a composed {@link LongToCharFunction} that first applies the {@code before} operation to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation.
     *
     * @param before The operation to apply before this function is applied
     * @return A composed {@code LongToCharFunction} that first applies the {@code before} operation to its input, and
     ...
     */
    @Nonnull
    default LongToCharFunction compose(@Nonnull final LongUnaryOperator before) {
     ...
     */
    @Nonnull
    default <T> ToCharFunction<T> compose(@Nonnull final ToLongFunction<? super T> before) {
        Objects.requireNonNull(before);
        return t -> applyAsChar(before.applyAsLong(t));
    }
     ...
     */
    @Nonnull
    default <R> LongFunction<R> andThen(@Nonnull final CharFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default LongPredicate andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToDoubleFunction andThenToDouble(@Nonnull final CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToIntFunction andThenToInt(@Nonnull final CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongUnaryOperator andThenToLong(@Nonnull final CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongConsumer consume(@Nonnull final CharConsumer consumer) {
     ...
     */
    @Nonnull
    default CharSupplier partial(long value) {
     ...
     * {@code LongToCharFunction} with JRE specific methods, only accepting {@code Function}.
     *
