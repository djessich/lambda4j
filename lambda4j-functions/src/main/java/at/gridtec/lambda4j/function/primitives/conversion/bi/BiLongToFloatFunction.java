...
public interface BiLongToFloatFunction {
     ...
     */
    @Nonnull
    default LongBiPredicate andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToFloatFunction partial(long value1) {
     ...
     */
    @Nonnull
    default FloatSupplier partial(long value1, long value2) {
