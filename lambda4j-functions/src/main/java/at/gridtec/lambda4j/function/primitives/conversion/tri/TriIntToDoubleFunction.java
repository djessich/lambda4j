...
public interface TriIntToDoubleFunction {
     ...
     */
    @Nonnull
    default IntTriPredicate andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToDoubleFunction partial(int value1) {
     ...
     */
    @Nonnull
    default IntToDoubleFunction partial(int value1, int value2) {
     ...
     */
    @Nonnull
    default DoubleSupplier partial(int value1, int value2, int value3) {
