...
public interface IntTriFunction<R> {
     ...
     */
    @Nonnull
    default IntTriPredicate andThenToBoolean(@Nonnull final Predicate<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntBiFunction<R> partial(int value1) {
     ...
     */
    @Nonnull
    default IntFunction<R> partial(int value1, int value2) {
     ...
     */
    @Nonnull
    default Supplier<R> partial(int value1, int value2, int value3) {
     ...
     */
    @Nonnull
    default IntTriFunction<Optional<R>> nonNull() {
