...
public interface BiObjByteFunction<T, U, R> {
     ...
     */
    @Nonnull
    default ObjByteFunction<U, R> partial(T t) {
     ...
     */
    @Nonnull
    default BiFunction<T, U, R> partial(byte value) {
     ...
     */
    @Nonnull
    default ByteFunction<R> partial(T t, U u) {
     ...
     */
    @Nonnull
    default Function<U, R> partial(T t, byte value) {
     ...
     */
    @Nonnull
    default Supplier<R> partial(T t, U u, byte value) {
