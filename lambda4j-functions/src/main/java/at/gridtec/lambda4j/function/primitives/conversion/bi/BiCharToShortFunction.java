...
/**
 * Represents a function that accepts two char-valued arguments and produces a short-valued result. This is the {@code
 * char}-to-{@code short} primitive specialization for {@link BiFunction}.
 * <p>
...
@FunctionalInterface
public interface BiCharToShortFunction {
    ...
    /**
     * Returns a composed {@link BiCharToShortFunction} that first applies the {@code before} operations to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation.
     *
     * @param before1 The first operation to apply before this function is applied
     * @param before2 The second operation to apply before this function is applied
     * @return A composed {@code BiCharToShortFunction} that first applies the {@code before} operations to its input,
     ...
     */
    @Nonnull
    default BiCharToShortFunction compose(@Nonnull final CharUnaryOperator before1,
     ...
     */
    @Nonnull
    default <T, U> ToShortBiFunction<T, U> compose(@Nonnull final ToCharFunction<? super T> before1,
            @Nonnull final ToCharFunction<? super U> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (t, u) -> applyAsShort(before1.applyAsChar(t), before2.applyAsChar(u));
    }
     ...
     */
    @Nonnull
    default <R> CharBiFunction<R> andThen(@Nonnull final ShortFunction<? extends R> after) {
     ...
     */
    @Nonnull
    default CharBiPredicate andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharBiConsumer consume(@Nonnull final ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default CharToShortFunction partial(char value1) {
     ...
     */
    @Nonnull
    default ShortSupplier partial(char value1, char value2) {
     ...
     * {@code BiCharToShortFunction} with JRE specific methods, only accepting {@code BiFunction}.
     *
