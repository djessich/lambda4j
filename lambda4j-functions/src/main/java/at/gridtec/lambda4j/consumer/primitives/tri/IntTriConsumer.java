...
public interface IntTriConsumer {
     ...
     */
    static void call(@Nonnull final IntTriConsumer consumer, int value1, int value2, int value3) {
     ...
     */
    @Nonnull
    default IntBiConsumer partial(int value1) {
     ...
     */
    @Nonnull
    default IntConsumer partial(int value1, int value2) {
