...
public interface BiObjLongConsumer<T, U> {
     ...
     */
    @Nonnull
    default ObjLongConsumer<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiConsumer<T, U> partial(long value) {
     ...
     */
    @Nonnull
    default LongConsumer partial(T t, U u) {
     ...
     */
    @Nonnull
    default Consumer<U> partial(T t, long value) {
     ...
     */
    @Nonnull
    default ObjLongConsumer<Pair<T, U>> tupled() {
        return this::accept;
    }
