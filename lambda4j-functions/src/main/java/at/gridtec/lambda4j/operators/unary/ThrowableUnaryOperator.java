...
public interface ThrowableUnaryOperator<T> extends UnaryOperator<T> {
    ...
    /**
     * Creates a {@link ThrowableUnaryOperator} from the given {@link UnaryOperator}. This method is just convenience to
     ...
     * {@link #applyThrows(Object)} method of this interface and catches the thrown {@link Exception}s from it. If it is
     * of type {@link RuntimeException}, the exception is rethrown. Other throwable types are sneakily thrown.
     *
     * @param t The first argument for the operator
     * @return The return value from the operator.
    ...
    /**
     * Returns a composed {@link UnaryOperator} that applies this {@link ThrowableUnaryOperator} to its input, and if an
     * error occurred, applies the given {@code UnaryOperator} representing a fallback. The exception from this {@code
    ...
    /**
     * Returns a composed {@link UnaryOperator} that applies this {@link ThrowableUnaryOperator} to its input, and if an
     * error occurred, returns the given value. The exception from this {@code ThrowableUnaryOperator} is ignored.
     *
    ...
    /**
     * Returns a composed {@link UnaryOperator} that applies this {@link ThrowableUnaryOperator} to its input, and if an
     * error occurred, returns its value. The exception from this {@code ThrowableUnaryOperator} is ignored.
     *
     * @return A composed {@code UnaryOperator} that applies this {@code ThrowableUnaryOperator}, and if an error
