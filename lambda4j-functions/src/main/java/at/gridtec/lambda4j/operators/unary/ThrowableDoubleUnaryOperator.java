...
public interface ThrowableDoubleUnaryOperator extends DoubleUnaryOperator {
    ...
    /**
     * Overrides the {@link DoubleUnaryOperator#applyAsDouble(double)} method by using a redefinition as default method.
     * It calls the {@link #applyAsDoubleThrows(double)} method of this interface and catches the thrown {@link
    ...
    /**
     * Returns a composed {@link ThrowableDoubleUnaryOperator} that applies this {@code ThrowableDoubleUnaryOperator} to
