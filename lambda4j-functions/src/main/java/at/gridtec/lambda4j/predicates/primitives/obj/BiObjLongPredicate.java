...
public interface BiObjLongPredicate<T, U> {
     ...
     */
    @Nonnull
    default ObjLongPredicate<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiPredicate<T, U> partial(long value) {
     ...
     */
    @Nonnull
    default LongPredicate partial(T t, U u) {
     ...
     */
    @Nonnull
    default Predicate<U> partial(T t, long value) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(T t, U u, long value) {
