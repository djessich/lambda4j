...
public interface ThrowableIntBiPredicate extends IntBiPredicate {
    ...
    /**
     * Returns a {@link ThrowableIntBiPredicate} that always returns {@code true}.
     *
     * @return A {@link ThrowableIntBiPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
     ...
     * an error occurred, applies the given {@code IntBiPredicate} representing a fallback. The exception from this
    ...
    /**
     * Returns a composed {@link IntBiPredicate} that applies this {@link ThrowableIntBiPredicate} to its input, and if
     * an error occurred, returns {@code true}. The exception from this {@code ThrowableIntBiPredicate} is ignored.
     *
     * @return A composed {@code IntBiPredicate} that applies this {@code ThrowableIntBiPredicate}, and if an error
