...
public interface ShortBiPredicate {
    ...
    /**
     * Returns a {@link ShortBiPredicate} that tests if the given arguments are equal to the ones of this predicate
     ...
     * @return A {@code ShortBiPredicate} that tests if the given arguments are equal to the ones of this predicate.
     * @see #isNotEqual(short, short)
     */
    @Nonnull
    static ShortBiPredicate isEqual(short target1, short target2) {
        return (value1, value2) -> (value1 == target1) && (value2 == target2);
    }

    /**
     * Returns a {@link ShortBiPredicate} that tests if the given arguments are not equal to the ones of this predicate
     * according to {@code value != target} method.
     *
     * @param target1 The first target value with which to compare for equality
     * @param target2 The second target value with which to compare for equality
     * @return A {@code ShortBiPredicate} that tests if the given arguments are not equal to the ones of this predicate.
    ...
    /**
     * Returns a {@link ShortBiPredicate} the always returns {@code false}.
     *
    ...
    /**
     * Returns a {@link ShortBiPredicate} that represents the logical negation of this one.
     *
    ...
    /**
     * Returns a composed {@link ShortBiPredicate} that represents a short-circuiting logical AND of this predicate and
     ...
     *
     * @param other A {@code ShortBiPredicate} that will be logically-ANDed with this one
     * @return A composed {@code ShortBiPredicate} that represents the short-circuiting logical AND of this predicate
     ...
     */
    @Nonnull
    default ShortBiPredicate and(@Nonnull final ShortBiPredicate other) {
        Objects.requireNonNull(other);
        return (value1, value2) -> test(value1, value2) && other.test(value1, value2);
    }

    /**
     * Returns a composed {@link ShortBiPredicate} that represents a short-circuiting logical OR of this predicate and
     ...
     */
    @Nonnull
    default ShortPredicate partial(short value1) {
    ...
    /**
     * Returns a composed {@link BiPredicate} which represents this {@link ShortBiPredicate}. Thereby the primitive
     * input argument for this predicate is autoboxed. This method is just convenience to provide the ability to use
     * this {@code ShortBiPredicate} with JRE specific methods, only accepting {@code BiPredicate}.
     *
     * @return A composed {@code BiPredicate} which represents this {@code ShortBiPredicate}.
     */
    @Nonnull
