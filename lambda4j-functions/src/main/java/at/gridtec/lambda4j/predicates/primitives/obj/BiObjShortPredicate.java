...
public interface BiObjShortPredicate<T, U> {
     ...
     */
    @Nonnull
    default ObjShortPredicate<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiPredicate<T, U> partial(short value) {
     ...
     */
    @Nonnull
    default ShortPredicate partial(T t, U u) {
     ...
     */
    @Nonnull
    default Predicate<U> partial(T t, short value) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(T t, U u, short value) {
