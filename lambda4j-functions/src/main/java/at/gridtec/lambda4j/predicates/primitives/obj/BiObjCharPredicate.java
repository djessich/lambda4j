...
public interface BiObjCharPredicate<T, U> {
     ...
     */
    @Nonnull
    default ObjCharPredicate<U> partial(T t) {
     ...
     */
    @Nonnull
    default BiPredicate<T, U> partial(char value) {
     ...
     */
    @Nonnull
    default CharPredicate partial(T t, U u) {
     ...
     */
    @Nonnull
    default Predicate<U> partial(T t, char value) {
     ...
     */
    @Nonnull
    default BooleanSupplier partial(T t, U u, char value) {
