...
public interface TriDoubleToFloatFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriDoubleToFloatFunction of(@Nonnull final TriDoubleToFloatFunction expression) {
        return expression;
    }
     ...
     * to use this {@code TriDoubleToFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
