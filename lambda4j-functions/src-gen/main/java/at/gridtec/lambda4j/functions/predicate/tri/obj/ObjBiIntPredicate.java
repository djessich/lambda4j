...
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntToCharFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntToDoubleFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntToFloatFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntToIntFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiIntToShortFunction;
...
public interface ObjBiIntPredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiIntPredicate<T> of(@Nonnull final ObjBiIntPredicate<T> expression) {
        return expression;
    }
