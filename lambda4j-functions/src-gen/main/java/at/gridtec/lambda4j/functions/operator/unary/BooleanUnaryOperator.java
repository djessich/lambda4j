...
public interface BooleanUnaryOperator extends Lambda {
     ...
     */
    @Nonnull
    static BooleanUnaryOperator of(@Nonnull final BooleanUnaryOperator expression) {
        return expression;
    }
     ...
     */
    static boolean call(@Nonnull final BooleanUnaryOperator operator, boolean value) {
     ...
     */
    @Nonnull
    default BooleanUnaryOperator composeFromBoolean(@Nonnull final BooleanUnaryOperator before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default BytePredicate composeFromByte(@Nonnull final BytePredicate before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default CharPredicate composeFromChar(@Nonnull final CharPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsBoolean(before.test(value));
    }
     ...
     */
    @Nonnull
    default DoublePredicate2 composeFromDouble(@Nonnull final DoublePredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsBoolean(before.test(value));
    }
     ...
     */
    @Nonnull
    default FloatPredicate composeFromFloat(@Nonnull final FloatPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsBoolean(before.test(value));
    }
     ...
     */
    @Nonnull
    default IntPredicate2 composeFromInt(@Nonnull final IntPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsBoolean(before.test(value));
    }
     ...
     */
    @Nonnull
    default LongPredicate2 composeFromLong(@Nonnull final LongPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsBoolean(before.test(value));
    }
     ...
     */
    @Nonnull
    default ShortPredicate composeFromShort(@Nonnull final ShortPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsBoolean(before.test(value));
    }
