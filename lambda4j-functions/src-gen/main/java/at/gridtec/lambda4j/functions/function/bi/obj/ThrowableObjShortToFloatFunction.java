 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, short) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(Object, short)}.
 *
...
@FunctionalInterface
public interface ThrowableObjShortToFloatFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjShortToFloatFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjShortToFloatFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToFloatFunction<T, X> of(
            @Nonnull final ThrowableObjShortToFloatFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjShortToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjShortToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> float call(
            @Nonnull final ThrowableObjShortToFloatFunction<? super T, ? extends X> function, T t, short value) throws
            X {
    ...
    /**
     * Creates a {@link ThrowableObjShortToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjShortToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToFloatFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjShortToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableShortToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjShortToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableShortToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToFloatFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjShortToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjShortToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToFloatFunction<T, X> constant(float ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(T t, short value) throws X;
    ...
    default <A, B> ThrowableToFloatBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsFloatThrows(before1.applyThrows(a), before2.applyAsShortThrows(b));
    }
    ...
    default ThrowableBiBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsFloatThrows(before1.applyThrows(value1), before2.applyAsShortThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsFloatThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjShortToFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjShortToFloatFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjShortToFloatFunction<T, X> memoized() {
        if (this instanceof Memoized) {
            return this;
        } else {
            final Map<Pair<T, Short>, Float> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjShortToFloatFunction<T, X> & Memoized) (t, value) -> {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, Short, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link ObjShortToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}. The throwable is
     * nested (wrapped) in a {@link ThrownByFunctionalInterfaceException}, which is constructed from the thrown
     * throwables message and the thrown throwable itself.
     *
     * @return A composed {@code ObjShortToFloatFunction} that applies this function to its input and nests the thrown
     * {@code {@code Throwable} from it, unless it is of type {@code RuntimeException} or {@code Error}.
     */
    @Nonnull
    default ObjShortToFloatFunction<T> nest() {
        return (t, value) -> {
            try {
    ...
    /**
     * Returns a composed {@link ObjShortToFloatFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjShortToFloatFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjShortToFloatFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.applyAsFloatThrows(t, value);
            } catch (RuntimeException | Error e) {
