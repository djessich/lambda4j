...
public interface BiObjCharFunction<T, U, R> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjCharFunction<T, U, R> of(@Nonnull final BiObjCharFunction<T, U, R> expression) {
        return expression;
    }
     ...
     * {@code BiObjCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
