 ...
 * ThrowableBiConsumer}. Unlike most other functional interfaces, {@code ThrowableObjLongConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjLongConsumer<T, X extends Throwable> extends Lambda, ObjLongConsumer<T> {

    /**
     * Constructs a {@link ThrowableObjLongConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjLongConsumer} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongConsumer<T, X> of(
            @Nonnull final ThrowableObjLongConsumer<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjLongConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <T, X extends Throwable> void call(@Nonnull final ThrowableObjLongConsumer<? super T, ? extends X> consumer,
            T t, long value) throws X {
        Objects.requireNonNull(consumer);
        consumer.acceptThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjLongConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjLongConsumer} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjLongConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableLongConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjLongConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongConsumer<T, X> onlySecond(
     ...
     * @implSpec Overrides the {@link ObjLongConsumer#accept(Object, long)} method by using a redefinition as default
    ...
    default <A, B> ThrowableBiConsumer<A, B, X> compose(
        ...
        return (a, b) -> acceptThrows(before1.applyThrows(a), before2.applyAsLongThrows(b));
    }
    ...
    default ThrowableBiBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> acceptThrows(before1.applyThrows(value1), before2.applyAsLongThrows(value2));
    }
    ...
    /**
     * Returns a composed {@link ThrowableObjLongConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjLongConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> andThen(
            @Nonnull final ThrowableObjLongConsumer<? super T, ? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, Long, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjLongConsumer2} that applies this consumer to its input and nests the thrown {@link
     ...
     *
     * @return A composed {@code ObjLongConsumer2} that applies this consumer to its input and nests the thrown {@code
     * {@code Throwable} from it, unless it is of type {@code RuntimeException} or {@code Error}.
     */
    @Nonnull
    default ObjLongConsumer2<T> nest() {
        return (t, value) -> {
            try {
                this.acceptThrows(t, value);
            } catch (RuntimeException | Error e) {
    ...
    /**
     * Returns a composed {@link ObjLongConsumer2} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjLongConsumer2} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjLongConsumer2<T> sneakyThrow() {
        return (t, value) -> {
            try {
                this.acceptThrows(t, value);
            } catch (RuntimeException | Error e) {
