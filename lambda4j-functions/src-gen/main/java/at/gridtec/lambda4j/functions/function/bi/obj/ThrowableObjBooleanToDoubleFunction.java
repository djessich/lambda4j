...
public interface ThrowableObjBooleanToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBooleanToDoubleFunction<T, X> of(
            @Nonnull final ThrowableObjBooleanToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull final ThrowableObjBooleanToDoubleFunction<? super T, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableObjBooleanConsumer<T, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjBooleanToDoubleFunction} that applies this function to its input and nests the
