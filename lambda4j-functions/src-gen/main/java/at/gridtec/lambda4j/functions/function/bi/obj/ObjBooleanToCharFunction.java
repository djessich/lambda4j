...
public interface ObjBooleanToCharFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBooleanToCharFunction<T> of(@Nonnull final ObjBooleanToCharFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjBooleanToCharFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjBooleanToCharFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjBooleanToCharFunction}.
     */
    @Nonnull
    default BiFunction<T, Boolean, Character> boxed() {
