...
public interface BiByteToDoubleFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiByteToDoubleFunction of(@Nonnull final BiByteToDoubleFunction expression) {
        return expression;
    }
     ...
     * {@code BiByteToDoubleFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
