...
public interface ToFloatTriFunction<T, U, V> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U, V> ToFloatTriFunction<T, U, V> of(@Nonnull final ToFloatTriFunction<T, U, V> expression) {
        return expression;
    }
     ...
     * {@code ToFloatTriFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
