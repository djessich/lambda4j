...
public interface ThrowableByteConsumer<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableByteConsumer<X> of(@Nonnull final ThrowableByteConsumer<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ByteConsumer} that applies this consumer to its input and nests the thrown {@code
