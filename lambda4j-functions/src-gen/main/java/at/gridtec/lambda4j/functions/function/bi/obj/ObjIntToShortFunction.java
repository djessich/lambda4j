...
import at.gridtec.lambda4j.functions.consumer.bi.obj.ObjIntConsumer2;
...
import at.gridtec.lambda4j.functions.function.bi.conversion.BiBooleanToShortFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.BiByteToShortFunction;
...
import at.gridtec.lambda4j.functions.function.bi.conversion.BiIntToShortFunction;
...
import at.gridtec.lambda4j.functions.predicate.bi.obj.ObjIntPredicate;
 ...
 * {@code short}-valued result. This is a (reference, int) specialization of {@link BiFunction2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShort(Object, int)}.
 *
...
@FunctionalInterface
public interface ObjIntToShortFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjIntToShortFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ObjIntToShortFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjIntToShortFunction<T> of(@Nonnull final ObjIntToShortFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjIntToShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function to be called
     * @param t The first argument to the function
     * @param value The second argument to the function
     * @return The result from the given {@code ObjIntToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> short call(@Nonnull final ObjIntToShortFunction<? super T> function, T t, int value) {
        Objects.requireNonNull(function);
        return function.applyAsShort(t, value);
    }

    /**
     * Creates a {@link ObjIntToShortFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjIntToShortFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjIntToShortFunction<T> onlyFirst(@Nonnull final ToShortFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsShort(t);
    }

    /**
     * Creates a {@link ObjIntToShortFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link IntToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjIntToShortFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code IntToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjIntToShortFunction<T> onlySecond(@Nonnull final IntToShortFunction function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsShort(value);
    }

    /**
     * Creates a {@link ObjIntToShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjIntToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjIntToShortFunction<T> constant(short ret) {
        return (t, value) -> ret;
    }
     ...
     */
    short applyAsShort(T t, int value);
    ...
    default <A, B> ToShortBiFunction<A, B> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b) -> applyAsShort(before1.apply(a), before2.applyAsInt(b));
    }
     ...
     */
    @Nonnull
    default <S> ObjIntFunction<T, S> andThen(@Nonnull final ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjIntPredicate<T> andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToByteFunction<T> andThenToByte(@Nonnull final ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToCharFunction<T> andThenToChar(@Nonnull final ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToDoubleFunction<T> andThenToDouble(@Nonnull final ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToFloatFunction<T> andThenToFloat(@Nonnull final ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToIntFunction<T> andThenToInt(@Nonnull final ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToLongFunction<T> andThenToLong(@Nonnull final ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToShortFunction<T> andThenToShort(@Nonnull final ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntConsumer2<T> consume(@Nonnull final ShortConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.accept(applyAsShort(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ObjIntToShortFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ObjIntToShortFunction}.
    ...
    default ObjIntToShortFunction<T> memoized() {
        if (this instanceof Memoized) {
            ...
            return (ObjIntToShortFunction<T> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjIntToShortFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjIntToShortFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjIntToShortFunction}.
     */
    @Nonnull
    default BiFunction<T, Integer, Short> boxed() {
