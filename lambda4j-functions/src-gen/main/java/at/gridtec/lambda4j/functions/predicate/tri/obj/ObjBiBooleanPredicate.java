...
import at.gridtec.lambda4j.functions.consumer.tri.obj.ObjBiBooleanConsumer;
...
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanToCharFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanToDoubleFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanToFloatFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanToIntFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiBooleanToShortFunction;
...
/**
 * Represents an predicate (boolean-valued function) of one object-valued and two {@code boolean}-valued input
 * arguments. This is a (reference, boolean, boolean) specialization of {@link TriPredicate}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #test(Object, boolean, boolean)}.
 *
...
@FunctionalInterface
public interface ObjBiBooleanPredicate<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiBooleanPredicate} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ObjBiBooleanPredicate} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanPredicate<T> of(@Nonnull final ObjBiBooleanPredicate<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiBooleanPredicate} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the predicate
     ...
     * @return The result from the given {@code ObjBiBooleanPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> boolean call(@Nonnull final ObjBiBooleanPredicate<? super T> predicate, T t, boolean value1,
            boolean value2) {
    ...
    /**
     * Creates a {@link ObjBiBooleanPredicate} which uses the {@code second} parameter of this one as argument for the
     * given {@link BooleanUnaryOperator}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param operator The operator which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiBooleanPredicate} which uses the {@code second} parameter of this one as argument
     * for the given {@code BooleanUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiBooleanPredicate<T> onlySecond(@Nonnull final BooleanUnaryOperator operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsBoolean(value1);
    }

    /**
     * Creates a {@link ObjBiBooleanPredicate} which uses the {@code third} parameter of this one as argument for the
     * given {@link BooleanUnaryOperator}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param operator The operator which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiBooleanPredicate} which uses the {@code third} parameter of this one as argument
     * for the given {@code BooleanUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiBooleanPredicate<T> onlyThird(@Nonnull final BooleanUnaryOperator operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsBoolean(value2);
    }

    /**
     * Creates a {@link ObjBiBooleanPredicate} which always returns a given value.
     *
     * @param <T> The type of the first argument to the predicate
     * @param ret The return value for the constant
     * @return A {@code ObjBiBooleanPredicate} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiBooleanPredicate<T> constant(boolean ret) {
        return (t, value1, value2) -> ret;
    }

    /**
     * Returns a {@link ObjBiBooleanPredicate} that always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @return A {@link ObjBiBooleanPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static <T> ObjBiBooleanPredicate<T> alwaysTrue() {
        return (t, value1, value2) -> true;
    }

    /**
     * Returns a {@link ObjBiBooleanPredicate} that always returns {@code false}.
     *
     * @param <T> The type of the first argument to the predicate
     * @return A {@link ObjBiBooleanPredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <T> ObjBiBooleanPredicate<T> alwaysFalse() {
        return (t, value1, value2) -> false;
    }

    /**
     * Returns a {@link ObjBiBooleanPredicate} that tests if the given arguments are <b>equal</b> to the ones of this
     * predicate.
     *
     * @param <T> The type of the first argument to the predicate
     ...
     * @return A {@code ObjBiBooleanPredicate} that tests if the given arguments are <b>equal</b> to the ones of this
     * predicate.
     ...
     */
    boolean test(T t, boolean value1, boolean value2);
    ...
    default BooleanTernaryOperator composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> test(before1.apply(value1), before2.applyAsBoolean(value2),
    ...
    /**
     * Returns a composed {@link ObjBiBooleanFunction} that first applies this predicate to its input, and then applies
     ...
     */
    @Nonnull
    default ObjBiBooleanPredicate<T> andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
        return (t, value1, value2) -> after.applyAsBoolean(test(t, value1, value2));
    }

    /**
     * Returns a composed {@link ObjBiBooleanToByteFunction} that first applies this predicate to its input, and then
     ...
     */
    @Nonnull
    default ObjBiBooleanToByteFunction<T> andThenToByte(@Nonnull final BooleanToByteFunction after) {
        Objects.requireNonNull(after);
        return (t, value1, value2) -> after.applyAsByte(test(t, value1, value2));
    }

    /**
     * Returns a composed {@link ObjBiBooleanToCharFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ObjBiBooleanToCharFunction<T> andThenToChar(@Nonnull final BooleanToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToDoubleFunction<T> andThenToDouble(@Nonnull final BooleanToDoubleFunction after) {
        Objects.requireNonNull(after);
        return (t, value1, value2) -> after.applyAsDouble(test(t, value1, value2));
    }

    /**
     * Returns a composed {@link ObjBiBooleanToFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ObjBiBooleanToFloatFunction<T> andThenToFloat(@Nonnull final BooleanToFloatFunction after) {
        Objects.requireNonNull(after);
        return (t, value1, value2) -> after.applyAsFloat(test(t, value1, value2));
    }

    /**
     * Returns a composed {@link ObjBiBooleanToIntFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ObjBiBooleanToIntFunction<T> andThenToInt(@Nonnull final BooleanToIntFunction after) {
        Objects.requireNonNull(after);
        return (t, value1, value2) -> after.applyAsInt(test(t, value1, value2));
    }

    /**
     * Returns a composed {@link ObjBiBooleanToLongFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ObjBiBooleanToLongFunction<T> andThenToLong(@Nonnull final BooleanToLongFunction after) {
        Objects.requireNonNull(after);
        return (t, value1, value2) -> after.applyAsLong(test(t, value1, value2));
    }

    /**
     * Returns a composed {@link ObjBiBooleanToShortFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ObjBiBooleanToShortFunction<T> andThenToShort(@Nonnull final BooleanToShortFunction after) {
        Objects.requireNonNull(after);
        return (t, value1, value2) -> after.applyAsShort(test(t, value1, value2));
    }

    /**
     * Returns a composed {@link ObjBiBooleanConsumer} that fist applies this predicate to its input, and then consumes
     ...
     * @return A composed {@code ObjBiBooleanConsumer} that first applies this predicate to its input, and then consumes
     * the result using the given {@code BooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ObjBiBooleanConsumer<T> consume(@Nonnull final BooleanConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(test(t, value1, value2));
    }

    /**
     * Returns a {@link ObjBiBooleanPredicate} that represents the logical negation of this one.
     *
     * @return A {@code ObjBiBooleanPredicate} that represents the logical negation of this one.
     */
    @Nonnull
    ...
    /**
     * Returns a composed {@link ObjBiBooleanPredicate} that represents a short-circuiting logical AND of this predicate
     ...
     * {@code ObjBiBooleanPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ObjBiBooleanPredicate} that will be logically-ANDed with this one
     * @return A composed {@code ObjBiBooleanPredicate} that represents the short-circuiting logical AND of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ObjBiBooleanPredicate)
     * @see #xor(ObjBiBooleanPredicate)
     */
    @Nonnull
    default ObjBiBooleanPredicate<T> and(@Nonnull final ObjBiBooleanPredicate<? super T> other) {
        Objects.requireNonNull(other);
        return (t, value1, value2) -> test(t, value1, value2) && other.test(t, value1, value2);
    }

    /**
     * Returns a composed {@link ObjBiBooleanPredicate} that represents a short-circuiting logical OR of this predicate
     ...
     * {@code ObjBiBooleanPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ObjBiBooleanPredicate} that will be logically-ORed with this one
     * @return A composed {@code ObjBiBooleanPredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ObjBiBooleanPredicate)
     * @see #xor(ObjBiBooleanPredicate)
     */
    @Nonnull
    default ObjBiBooleanPredicate<T> or(@Nonnull final ObjBiBooleanPredicate<? super T> other) {
        Objects.requireNonNull(other);
        return (t, value1, value2) -> test(t, value1, value2) || other.test(t, value1, value2);
    }

    /**
     * Returns a composed {@link ObjBiBooleanPredicate} that represents a short-circuiting logical XOR of this predicate
     * and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if evaluation
     * of this {@code ObjBiBooleanPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ObjBiBooleanPredicate} that will be logically-XORed with this one
     * @return A composed {@code ObjBiBooleanPredicate} that represents the short-circuiting logical XOR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ObjBiBooleanPredicate)
     * @see #or(ObjBiBooleanPredicate)
     */
    @Nonnull
    default ObjBiBooleanPredicate<T> xor(@Nonnull final ObjBiBooleanPredicate<? super T> other) {
        Objects.requireNonNull(other);
        return (t, value1, value2) -> test(t, value1, value2) ^ other.test(t, value1, value2);
    }
    ...
    /**
     * Returns a composed {@link TriPredicate} which represents this {@link ObjBiBooleanPredicate}. Thereby the
     * primitive input argument for this predicate is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjBiBooleanPredicate} with JDK specific methods, only accepting {@code TriPredicate}.
     *
     * @return A composed {@code TriPredicate} which represents this {@code ObjBiBooleanPredicate}.
     */
    @Nonnull
    default TriPredicate<T, Boolean, Boolean> boxed() {
        return this::test;
    }
