 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, float)
...
public interface ThrowableBiObjFloatToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToLongFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjFloatToLongFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjFloatToLongFunction} that applies this function to its input and nests the thrown
