...
public interface ThrowableObjCharToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToShortFunction<T, X> of(
            @Nonnull final ThrowableObjCharToShortFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjCharToShortFunction} that applies this function to its input and nests the thrown
