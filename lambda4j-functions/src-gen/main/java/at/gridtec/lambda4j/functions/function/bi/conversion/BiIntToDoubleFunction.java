...
public interface BiIntToDoubleFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiIntToDoubleFunction of(@Nonnull final BiIntToDoubleFunction expression) {
        return expression;
    }
     ...
     * {@code BiIntToDoubleFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
