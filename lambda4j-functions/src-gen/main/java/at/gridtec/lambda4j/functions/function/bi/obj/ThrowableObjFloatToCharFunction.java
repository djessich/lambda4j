...
public interface ThrowableObjFloatToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToCharFunction<T, X> of(
            @Nonnull final ThrowableObjFloatToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjFloatToCharFunction} that applies this function to its input and nests the thrown
