...
public interface ThrowableTriFloatToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriFloatToLongFunction<X> of(
            @Nonnull final ThrowableTriFloatToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriFloatToLongFunction} that applies this function to its input and nests the thrown
