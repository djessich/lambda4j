...
public interface ThrowableObjBiFloatToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatToLongFunction<T, X> of(
            @Nonnull final ThrowableObjBiFloatToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjBiFloatToLongFunction<? super T, ? extends X> function, T t, float value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
