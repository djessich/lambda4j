...
public interface ThrowableByteFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableByteFunction<R, X> of(
            @Nonnull final ThrowableByteFunction<R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ByteFunction} that applies this function to its input and nests the thrown {@code
