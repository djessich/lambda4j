...
public interface ThrowableTriCharToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriCharToByteFunction<X> of(
            @Nonnull final ThrowableTriCharToByteFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriCharToByteFunction} that applies this function to its input and nests the thrown
