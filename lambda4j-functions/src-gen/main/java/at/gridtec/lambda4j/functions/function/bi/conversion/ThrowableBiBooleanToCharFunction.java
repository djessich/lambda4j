...
import at.gridtec.lambda4j.functions.consumer.bi.ThrowableBiBooleanConsumer;
...
import at.gridtec.lambda4j.functions.function.bi.ThrowableBiBooleanFunction;
...
public interface ThrowableBiBooleanToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiBooleanToCharFunction<X> of(
            @Nonnull final ThrowableBiBooleanToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull final ThrowableBiBooleanToCharFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiByteToCharFunction<X> composeFromByte(@Nonnull final ThrowableBytePredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableCharBinaryOperator<X> composeFromChar(@Nonnull final ThrowableCharPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiIntToCharFunction<X> composeFromInt(@Nonnull final ThrowableIntPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongToCharFunction<X> composeFromLong(@Nonnull final ThrowableLongPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiBooleanConsumer<X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code BiBooleanToCharFunction} that applies this function to its input and nests the thrown
