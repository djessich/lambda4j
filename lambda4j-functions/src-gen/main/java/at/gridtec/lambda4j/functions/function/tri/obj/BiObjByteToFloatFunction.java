...
public interface BiObjByteToFloatFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjByteToFloatFunction<T, U> of(@Nonnull final BiObjByteToFloatFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjByteToFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
