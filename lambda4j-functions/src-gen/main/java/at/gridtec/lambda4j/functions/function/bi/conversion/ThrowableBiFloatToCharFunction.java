...
public interface ThrowableBiFloatToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToCharFunction<X> of(
            @Nonnull final ThrowableBiFloatToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull final ThrowableBiFloatToCharFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiFloatPredicate<X> andThenToBoolean(@Nonnull final ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code BiFloatToCharFunction} that applies this function to its input and nests the thrown
