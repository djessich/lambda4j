...
public interface ThrowableBiByteToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiByteToIntFunction<X> of(
            @Nonnull final ThrowableBiByteToIntFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiByteToIntFunction} that applies this function to its input and nests the thrown
