...
public interface ObjBiCharFunction<T, R> extends Lambda {
     ...
     */
    @Nonnull
    static <T, R> ObjBiCharFunction<T, R> of(@Nonnull final ObjBiCharFunction<T, R> expression) {
        return expression;
    }
     ...
     * {@code ObjBiCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
