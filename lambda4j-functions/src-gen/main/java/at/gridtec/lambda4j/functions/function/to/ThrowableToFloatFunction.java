...
public interface ThrowableToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableToFloatFunction<T, X> of(
            @Nonnull final ThrowableToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ToFloatFunction} that applies this function to its input and nests the thrown {@code
