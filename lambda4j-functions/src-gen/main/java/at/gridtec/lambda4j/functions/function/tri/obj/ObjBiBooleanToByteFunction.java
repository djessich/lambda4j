...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ObjBiBooleanPredicate;
 ...
 * {@code byte}-valued result. This is a (reference, boolean, boolean) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByte(Object, boolean, boolean)}.
 *
...
@FunctionalInterface
public interface ObjBiBooleanToByteFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiBooleanToByteFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjBiBooleanToByteFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToByteFunction<T> of(@Nonnull final ObjBiBooleanToByteFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiBooleanToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiBooleanToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> byte call(@Nonnull final ObjBiBooleanToByteFunction<? super T> function, T t, boolean value1,
            boolean value2) {
    ...
    /**
     * Creates a {@link ObjBiBooleanToByteFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiBooleanToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiBooleanToByteFunction<T> onlyFirst(@Nonnull final ToByteFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsByte(t);
    }

    /**
     * Creates a {@link ObjBiBooleanToByteFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link BooleanToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiBooleanToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code BooleanToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiBooleanToByteFunction<T> onlySecond(@Nonnull final BooleanToByteFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsByte(value1);
    }

    /**
     * Creates a {@link ObjBiBooleanToByteFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link BooleanToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiBooleanToByteFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code BooleanToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiBooleanToByteFunction<T> onlyThird(@Nonnull final BooleanToByteFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsByte(value2);
    }

    /**
     * Creates a {@link ObjBiBooleanToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiBooleanToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiBooleanToByteFunction<T> constant(byte ret) {
    ...
    default TriBooleanToByteFunction composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsByte(before1.apply(value1), before2.applyAsBoolean(value2),
     ...
     */
    @Nonnull
    default <S> ObjBiBooleanFunction<T, S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiBooleanPredicate<T> andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToByteFunction<T> andThenToByte(@Nonnull final ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToCharFunction<T> andThenToChar(@Nonnull final ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToDoubleFunction<T> andThenToDouble(@Nonnull final ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToFloatFunction<T> andThenToFloat(@Nonnull final ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToIntFunction<T> andThenToInt(@Nonnull final ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToLongFunction<T> andThenToLong(@Nonnull final ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToShortFunction<T> andThenToShort(@Nonnull final ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanConsumer<T> consume(@Nonnull final ByteConsumer consumer) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiBooleanToByteFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjBiBooleanToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiBooleanToByteFunction}.
     */
    @Nonnull
