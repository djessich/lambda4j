...
public interface ThrowableDoublePredicate<X extends Throwable> extends Lambda, DoublePredicate {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableDoublePredicate<X> of(@Nonnull final ThrowableDoublePredicate<X> expression) {
        return expression;
    }
     ...
     * @implSpec Overrides the {@link DoublePredicate#test(double)} method by using a redefinition as default method.
