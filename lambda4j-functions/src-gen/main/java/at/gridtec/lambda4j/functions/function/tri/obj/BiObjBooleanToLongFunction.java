...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToLongFunction;
...
public interface BiObjBooleanToLongFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToLongFunction<T, U> of(@Nonnull final BiObjBooleanToLongFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjBooleanToLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
