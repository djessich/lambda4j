...
public interface ThrowableTriByteFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableTriByteFunction<R, X> of(
            @Nonnull final ThrowableTriByteFunction<R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriByteFunction} that applies this function to its input and nests the thrown {@code
