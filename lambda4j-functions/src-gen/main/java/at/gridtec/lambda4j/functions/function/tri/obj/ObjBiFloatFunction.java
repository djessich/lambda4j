...
public interface ObjBiFloatFunction<T, R> extends Lambda {
     ...
     */
    @Nonnull
    static <T, R> ObjBiFloatFunction<T, R> of(@Nonnull final ObjBiFloatFunction<T, R> expression) {
        return expression;
    }
     ...
     * {@code ObjBiFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
