...
public interface TriShortToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriShortToByteFunction of(@Nonnull final TriShortToByteFunction expression) {
        return expression;
    }
     ...
     * to use this {@code TriShortToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
