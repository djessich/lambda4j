...
public interface ShortToLongFunction extends Lambda {
     ...
     */
    @Nonnull
    static ShortToLongFunction of(@Nonnull final ShortToLongFunction expression) {
        return expression;
    }
     ...
     * {@code ShortToLongFunction} with JDK specific methods, only accepting {@code Function}.
     *
