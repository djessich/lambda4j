...
public interface ObjLongToLongFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjLongToLongFunction<T> of(@Nonnull final ObjLongToLongFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> long call(@Nonnull final ObjLongToLongFunction<? super T> function, T t, long value) {
     ...
     */
    @Nonnull
    static <T> ObjLongToLongFunction<T> onlySecond(@Nonnull final LongUnaryOperator operator) {
     ...
     */
    @Nonnull
    default ObjLongPredicate<T> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<T> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToCharFunction<T> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToDoubleFunction<T> andThenToDouble(@Nonnull final LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToFloatFunction<T> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToIntFunction<T> andThenToInt(@Nonnull final LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToShortFunction<T> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjLongToLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjLongToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjLongToLongFunction}.
     */
    @Nonnull
