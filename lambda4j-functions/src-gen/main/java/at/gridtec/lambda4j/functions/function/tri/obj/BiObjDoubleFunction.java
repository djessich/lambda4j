...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjDoubleFunction;
...
public interface BiObjDoubleFunction<T, U, R> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjDoubleFunction<T, U, R> of(@Nonnull final BiObjDoubleFunction<T, U, R> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <S> BiObjDoubleFunction<T, U, S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
     ...
     * {@code BiObjDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
