...
public interface ThrowableTriLongToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriLongToIntFunction<X> of(
            @Nonnull final ThrowableTriLongToIntFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriLongToIntFunction} that applies this function to its input and nests the thrown
