...
public interface ThrowableBiFloatToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToShortFunction<X> of(
            @Nonnull final ThrowableBiFloatToShortFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiFloatToShortFunction} that applies this function to its input and nests the thrown
