...
public interface ObjByteToShortFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjByteToShortFunction<T> of(@Nonnull final ObjByteToShortFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjByteToShortFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjByteToShortFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjByteToShortFunction}.
     */
    @Nonnull
    default BiFunction<T, Byte, Short> boxed() {
