...
public interface ThrowableObjLongToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToLongFunction<T, X> of(
            @Nonnull final ThrowableObjLongToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjLongToLongFunction<? super T, ? extends X> function, T t, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjLongToLongFunction} that applies this function to its input and nests the thrown
