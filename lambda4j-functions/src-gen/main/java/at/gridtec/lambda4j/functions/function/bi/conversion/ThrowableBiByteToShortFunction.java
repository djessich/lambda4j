...
public interface ThrowableBiByteToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiByteToShortFunction<X> of(
            @Nonnull final ThrowableBiByteToShortFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiByteToShortFunction} that applies this function to its input and nests the thrown
