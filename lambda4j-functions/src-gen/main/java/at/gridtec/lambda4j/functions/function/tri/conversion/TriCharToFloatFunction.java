...
@FunctionalInterface
public interface TriCharToFloatFunction extends Lambda {

    /**
     * Constructs a {@link TriCharToFloatFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriCharToFloatFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static TriCharToFloatFunction of(@Nonnull final TriCharToFloatFunction expression) {
        return expression;
    }
    ...
    default <A, B, C> ToFloatTriFunction<A, B, C> compose(@Nonnull final ToCharFunction<? super A> before1,
        ...
        return (a, b, c) -> applyAsFloat(before1.applyAsChar(a), before2.applyAsChar(b), before3.applyAsChar(c));
    }
    ...
    /**
     * Returns a memoized (caching) version of this {@link TriCharToFloatFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code TriCharToFloatFunction}.
     ...
     */
    @Nonnull
    default TriCharToFloatFunction memoized() {
     ...
     * to use this {@code TriCharToFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
