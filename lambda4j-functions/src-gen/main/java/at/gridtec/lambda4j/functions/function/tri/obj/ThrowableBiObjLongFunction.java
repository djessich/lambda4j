...
public interface ThrowableBiObjLongFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjLongFunction<T, U, R, X> of(
            @Nonnull final ThrowableBiObjLongFunction<T, U, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjLongFunction} that applies this function to its input and nests the thrown {@code
