...
public interface IntFunction2<R> extends Lambda, IntFunction<R> {
     ...
     */
    @Nonnull
    static <R> IntFunction2<R> of(@Nonnull final IntFunction2<R> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link Function} which represents this {@link IntFunction2}. Thereby the primitive input
     * argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code IntFunction2} with JDK specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code IntFunction2}.
     */
    @Nonnull
    default Function<Integer, R> boxed() {
        return this::apply;
    }
