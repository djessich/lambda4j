...
import at.gridtec.lambda4j.functions.consumer.tri.obj.ThrowableBiObjFloatConsumer;
...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableBiObjFloatPredicate;
...
public interface ThrowableBiObjFloatToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToShortFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjFloatToShortFunction<T, U, X> expression) {
        return expression;
    }
