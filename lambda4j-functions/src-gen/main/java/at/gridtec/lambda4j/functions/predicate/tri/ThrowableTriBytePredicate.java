...
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriByteToCharFunction;
...
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriByteToLongFunction;
...
public interface ThrowableTriBytePredicate<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriBytePredicate<X> of(
            @Nonnull final ThrowableTriBytePredicate<X> expression) {
        return expression;
    }
