...
public interface TriBooleanToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriBooleanToByteFunction of(@Nonnull final TriBooleanToByteFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default TriBooleanToByteFunction composeFromBoolean(@Nonnull final BooleanUnaryOperator before1,
     ...
     */
    @Nonnull
    default ByteTernaryOperator composeFromByte(@Nonnull final BytePredicate before1,
     ...
     */
    @Nonnull
    default TriCharToByteFunction composeFromChar(@Nonnull final CharPredicate before1,
     ...
     */
    @Nonnull
    default TriFloatToByteFunction composeFromFloat(@Nonnull final FloatPredicate before1,
     ...
     */
    @Nonnull
    default TriLongToByteFunction composeFromLong(@Nonnull final LongPredicate before1,
     ...
     */
    @Nonnull
    default TriShortToByteFunction composeFromShort(@Nonnull final ShortPredicate before1,
     ...
     */
    @Nonnull
    default <S> TriBooleanFunction<S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriBooleanConsumer consume(@Nonnull final ByteConsumer consumer) {
     ...
     * to use this {@code TriBooleanToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
