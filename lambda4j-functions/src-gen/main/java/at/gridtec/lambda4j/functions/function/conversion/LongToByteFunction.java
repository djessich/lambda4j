...
public interface LongToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static LongToByteFunction of(@Nonnull final LongToByteFunction expression) {
        return expression;
    }
     ...
     * {@code LongToByteFunction} with JDK specific methods, only accepting {@code Function}.
     *
