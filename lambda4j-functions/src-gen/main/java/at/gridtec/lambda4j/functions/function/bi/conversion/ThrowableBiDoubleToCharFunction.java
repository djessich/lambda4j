...
public interface ThrowableBiDoubleToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleToCharFunction<X> of(
            @Nonnull final ThrowableBiDoubleToCharFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiDoubleToCharFunction} that applies this function to its input and nests the thrown
