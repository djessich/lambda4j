...
public interface ThrowableObjBiIntToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToCharFunction<T, X> of(
            @Nonnull final ThrowableObjBiIntToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiIntToCharFunction} that applies this function to its input and nests the thrown
