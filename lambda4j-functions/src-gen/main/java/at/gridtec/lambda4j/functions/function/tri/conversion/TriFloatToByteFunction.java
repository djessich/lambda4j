...
public interface TriFloatToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriFloatToByteFunction of(@Nonnull final TriFloatToByteFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToByteTriFunction<A, B, C> compose(@Nonnull final ToFloatFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToByteFunction composeFromBoolean(@Nonnull final BooleanToFloatFunction before1,
     ...
     */
    @Nonnull
    default ByteTernaryOperator composeFromByte(@Nonnull final ByteToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriCharToByteFunction composeFromChar(@Nonnull final CharToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction composeFromDouble(@Nonnull final DoubleToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToByteFunction composeFromFloat(@Nonnull final FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriIntToByteFunction composeFromInt(@Nonnull final IntToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriLongToByteFunction composeFromLong(@Nonnull final LongToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriShortToByteFunction composeFromShort(@Nonnull final ShortToFloatFunction before1,
     ...
     */
    @Nonnull
    default <S> TriFloatFunction<S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriFloatPredicate andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatConsumer consume(@Nonnull final ByteConsumer consumer) {
     ...
     * to use this {@code TriFloatToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
