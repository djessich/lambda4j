...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjCharToShortFunction;
...
public interface BiObjCharToShortFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjCharToShortFunction<T, U> of(@Nonnull final BiObjCharToShortFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjCharToShortFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
