...
public interface ThrowableTriIntToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriIntToLongFunction<X> of(
            @Nonnull final ThrowableTriIntToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriIntToLongFunction} that applies this function to its input and nests the thrown
