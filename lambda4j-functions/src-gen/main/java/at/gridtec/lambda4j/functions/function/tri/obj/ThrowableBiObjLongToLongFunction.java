...
public interface ThrowableBiObjLongToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToLongFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjLongToLongFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjLongToLongFunction} that applies this function to its input and nests the thrown
