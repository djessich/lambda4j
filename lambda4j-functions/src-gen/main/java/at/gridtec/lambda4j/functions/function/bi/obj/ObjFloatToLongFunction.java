...
public interface ObjFloatToLongFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjFloatToLongFunction<T> of(@Nonnull final ObjFloatToLongFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> long call(@Nonnull final ObjFloatToLongFunction<? super T> function, T t, float value) {
     ...
     */
    @Nonnull
    static <T> ObjFloatToLongFunction<T> onlySecond(@Nonnull final FloatToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjFloatPredicate<T> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToByteFunction<T> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToCharFunction<T> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToDoubleFunction<T> andThenToDouble(@Nonnull final LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToIntFunction<T> andThenToInt(@Nonnull final LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToShortFunction<T> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjFloatToLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjFloatToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjFloatToLongFunction}.
     */
    @Nonnull
    default BiFunction<T, Float, Long> boxed() {
