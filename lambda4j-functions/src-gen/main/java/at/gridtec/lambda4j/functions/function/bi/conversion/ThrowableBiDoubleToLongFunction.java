...
import at.gridtec.lambda4j.functions.consumer.bi.ThrowableBiDoubleConsumer;
...
import at.gridtec.lambda4j.functions.function.bi.ThrowableBiDoubleFunction;
import at.gridtec.lambda4j.functions.function.bi.ThrowableBiFunction;
import at.gridtec.lambda4j.functions.function.bi.to.ThrowableToLongBiFunction;
...
import at.gridtec.lambda4j.functions.operator.binary.ThrowableDoubleBinaryOperator;
...
public interface ThrowableBiDoubleToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleToLongFunction<X> of(
            @Nonnull final ThrowableBiDoubleToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiDoubleToLongFunction} that applies this function to its input and nests the thrown
