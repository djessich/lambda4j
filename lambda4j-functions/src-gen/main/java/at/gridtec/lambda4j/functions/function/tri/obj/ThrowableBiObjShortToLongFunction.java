...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjShortToLongFunction;
...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableBiObjShortPredicate;
 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, short)
...
public interface ThrowableBiObjShortToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortToLongFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjShortToLongFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjShortToLongFunction} that applies this function to its input and nests the thrown
