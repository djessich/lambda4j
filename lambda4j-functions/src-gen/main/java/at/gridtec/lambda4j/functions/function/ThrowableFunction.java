...
public interface ThrowableFunction<T, R, X extends Throwable> extends Lambda, Function<T, R> {
    ...
    static <T, R, X extends Throwable> ThrowableFunction<T, R, X> of(
            @Nonnull final ThrowableFunction<T, R, X> expression) {
        return expression;
    }
     ...
     * used.
     * @implSpec Overrides the {@link Function#apply(Object)} method by using a redefinition as default method. This
