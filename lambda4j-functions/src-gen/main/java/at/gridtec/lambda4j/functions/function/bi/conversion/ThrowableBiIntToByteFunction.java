...
public interface ThrowableBiIntToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiIntToByteFunction<X> of(
            @Nonnull final ThrowableBiIntToByteFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiIntToByteFunction} that applies this function to its input and nests the thrown
