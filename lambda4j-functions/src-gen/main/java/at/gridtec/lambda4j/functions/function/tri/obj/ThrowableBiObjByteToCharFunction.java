...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjByteToCharFunction;
...
public interface ThrowableBiObjByteToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToCharFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjByteToCharFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjByteToCharFunction} that applies this function to its input and nests the thrown
