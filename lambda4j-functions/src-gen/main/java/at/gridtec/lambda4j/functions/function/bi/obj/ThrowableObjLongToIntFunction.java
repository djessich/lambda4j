...
import at.gridtec.lambda4j.functions.predicate.bi.obj.ThrowableObjLongPredicate;
 ...
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, long) specialization of
 * {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjLongToIntFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjLongToIntFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjLongToIntFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToIntFunction<T, X> of(
            @Nonnull final ThrowableObjLongToIntFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjLongToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> int call(
            @Nonnull final ThrowableObjLongToIntFunction<? super T, ? extends X> function, T t, long value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsIntThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjLongToIntFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjLongToIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToIntFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjLongToIntFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableLongToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjLongToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToIntFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjLongToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjLongToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToIntFunction<T, X> constant(int ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    int applyAsIntThrows(T t, long value) throws X;
    ...
    default <A, B> ThrowableToIntBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsIntThrows(before1.applyThrows(a), before2.applyAsLongThrows(b));
    }
    ...
    default ThrowableBiBooleanToIntFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsIntThrows(before1.applyThrows(value1), before2.applyAsLongThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> andThenToBoolean(@Nonnull final ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsIntThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjLongToIntFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjLongToIntFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjLongToIntFunction<T, X> memoized() {
        if (this instanceof Memoized) {
            return this;
        } else {
            final Map<Pair<T, Long>, Integer> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjLongToIntFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjLongToIntFunction}.
     * Thereby the primitive input argument for this function is autoboxed.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjLongToIntFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Long, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link ObjLongToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}. The throwable is
     * nested (wrapped) in a {@link ThrownByFunctionalInterfaceException}, which is constructed from the thrown
     * throwables message and the thrown throwable itself.
     *
     * @return A composed {@code ObjLongToIntFunction} that applies this function to its input and nests the thrown
     * {@code {@code Throwable} from it, unless it is of type {@code RuntimeException} or {@code Error}.
     */
    @Nonnull
    default ObjLongToIntFunction<T> nest() {
        return (t, value) -> {
            try {
    ...
    /**
     * Returns a composed {@link ObjLongToIntFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjLongToIntFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjLongToIntFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.applyAsIntThrows(t, value);
            } catch (RuntimeException | Error e) {
