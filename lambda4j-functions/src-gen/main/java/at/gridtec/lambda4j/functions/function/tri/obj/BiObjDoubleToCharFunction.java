...
public interface BiObjDoubleToCharFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToCharFunction<T, U> of(@Nonnull final BiObjDoubleToCharFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjDoubleToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
