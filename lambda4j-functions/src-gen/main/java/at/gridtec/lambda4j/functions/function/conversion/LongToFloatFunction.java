...
public interface LongToFloatFunction extends Lambda {
     ...
     */
    @Nonnull
    static LongToFloatFunction of(@Nonnull final LongToFloatFunction expression) {
        return expression;
    }
     ...
     * {@code LongToFloatFunction} with JDK specific methods, only accepting {@code Function}.
     *
