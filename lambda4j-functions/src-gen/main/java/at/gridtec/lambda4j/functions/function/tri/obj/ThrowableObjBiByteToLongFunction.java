...
import at.gridtec.lambda4j.functions.consumer.tri.obj.ThrowableObjBiByteConsumer;
...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableObjBiBytePredicate;
 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, byte, byte)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, byte, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiByteToLongFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiByteToLongFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjBiByteToLongFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToLongFunction<T, X> of(
            @Nonnull final ThrowableObjBiByteToLongFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiByteToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiByteToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjBiByteToLongFunction<? super T, ? extends X> function, T t, byte value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToLongFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToLongFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToLongFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableByteToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableByteToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToLongFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToLongFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableByteToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToLongFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableByteToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToLongFunction<T, X> onlyThird(
            @Nonnull final ThrowableByteToLongFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiByteToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToLongFunction<T, X> constant(long ret) {
    ...
    default <A, B, C> ThrowableToLongTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsLongThrows(before1.applyThrows(a), before2.applyAsByteThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiByteToLongFunction}.
     * Thereby the primitive input argument for this function is autoboxed.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiByteToLongFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Byte, Byte, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link ObjBiByteToLongFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}. The throwable is
     * nested (wrapped) in a {@link ThrownByFunctionalInterfaceException}, which is constructed from the thrown
     * throwables message and the thrown throwable itself.
     *
     * @return A composed {@code ObjBiByteToLongFunction} that applies this function to its input and nests the thrown
    ...
    /**
     * Returns a composed {@link ObjBiByteToLongFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiByteToLongFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjBiByteToLongFunction<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return this.applyAsLongThrows(t, value1, value2);
            } catch (RuntimeException | Error e) {
