...
import at.gridtec.lambda4j.functions.function.bi.conversion.ThrowableBiBooleanToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.ThrowableBiByteToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.ThrowableBiCharToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.ThrowableBiDoubleToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.ThrowableBiFloatToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.ThrowableBiIntToLongFunction;
 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, double) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableObjDoubleToLongFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjDoubleToLongFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjDoubleToLongFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleToLongFunction<T, X> of(
            @Nonnull final ThrowableObjDoubleToLongFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjDoubleToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjDoubleToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjDoubleToLongFunction<? super T, ? extends X> function, T t, double value) throws
            X {
    ...
    /**
     * Creates a {@link ThrowableObjDoubleToLongFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjDoubleToLongFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleToLongFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjDoubleToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableDoubleToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjDoubleToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleToLongFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjDoubleToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjDoubleToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleToLongFunction<T, X> constant(long ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(T t, double value) throws X;
    ...
    default <A, B> ThrowableToLongBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsLongThrows(before1.applyThrows(a), before2.applyAsDoubleThrows(b));
    }
    ...
    default ThrowableBiBooleanToLongFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsLongThrows(before1.applyThrows(value1), before2.applyAsDoubleThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsLongThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjDoubleToLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjDoubleToLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToLongFunction<T, X> memoized() {
        if (this instanceof Memoized) {
            return this;
        } else {
            final Map<Pair<T, Double>, Long> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjDoubleToLongFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjDoubleToLongFunction}.
     * Thereby the primitive input argument for this function is autoboxed.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjDoubleToLongFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Double, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link ObjDoubleToLongFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}. The throwable is
     * nested (wrapped) in a {@link ThrownByFunctionalInterfaceException}, which is constructed from the thrown
     * throwables message and the thrown throwable itself.
     *
     * @return A composed {@code ObjDoubleToLongFunction} that applies this function to its input and nests the thrown
     * {@code {@code Throwable} from it, unless it is of type {@code RuntimeException} or {@code Error}.
     */
    @Nonnull
    default ObjDoubleToLongFunction<T> nest() {
        return (t, value) -> {
            try {
    ...
    /**
     * Returns a composed {@link ObjDoubleToLongFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjDoubleToLongFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjDoubleToLongFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.applyAsLongThrows(t, value);
            } catch (RuntimeException | Error e) {
