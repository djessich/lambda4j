...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableObjBiFloatPredicate;
...
public interface ThrowableObjBiFloatToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatToCharFunction<T, X> of(
            @Nonnull final ThrowableObjBiFloatToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiFloatToCharFunction} that applies this function to its input and nests the thrown
