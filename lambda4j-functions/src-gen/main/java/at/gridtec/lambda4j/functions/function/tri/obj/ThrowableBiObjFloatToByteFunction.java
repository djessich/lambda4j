...
public interface ThrowableBiObjFloatToByteFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToByteFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjFloatToByteFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjFloatToByteFunction} that applies this function to its input and nests the thrown
