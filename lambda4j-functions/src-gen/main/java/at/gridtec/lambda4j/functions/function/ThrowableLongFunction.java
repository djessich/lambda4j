...
public interface ThrowableLongFunction<R, X extends Throwable> extends Lambda, LongFunction<R> {
    ...
    static <R, X extends Throwable> ThrowableLongFunction<R, X> of(
            @Nonnull final ThrowableLongFunction<R, X> expression) {
        return expression;
    }
     ...
     * should be used.
     * @implSpec Overrides the {@link LongFunction#apply(long)} method by using a redefinition as default method. This
