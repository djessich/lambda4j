...
public interface ThrowableBiObjDoubleFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, R, X> of(
            @Nonnull final ThrowableBiObjDoubleFunction<T, U, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjDoubleFunction} that applies this function to its input and nests the thrown
