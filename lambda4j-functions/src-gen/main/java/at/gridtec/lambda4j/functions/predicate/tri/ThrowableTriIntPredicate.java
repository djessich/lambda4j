...
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriIntToCharFunction;
...
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriIntToLongFunction;
...
public interface ThrowableTriIntPredicate<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntPredicate<X> of(@Nonnull final ThrowableTriIntPredicate<X> expression) {
        return expression;
    }
