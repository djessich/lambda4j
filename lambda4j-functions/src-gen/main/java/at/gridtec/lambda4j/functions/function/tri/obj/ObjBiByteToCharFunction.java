...
public interface ObjBiByteToCharFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiByteToCharFunction<T> of(@Nonnull final ObjBiByteToCharFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiByteToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
