...
public interface BiByteToShortFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiByteToShortFunction of(@Nonnull final BiByteToShortFunction expression) {
        return expression;
    }
     ...
     * {@code BiByteToShortFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
