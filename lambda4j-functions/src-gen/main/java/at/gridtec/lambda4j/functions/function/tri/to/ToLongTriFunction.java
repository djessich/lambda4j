...
@FunctionalInterface
public interface ToLongTriFunction<T, U, V> extends Lambda {

    /**
     * Constructs a {@link ToLongTriFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ToLongTriFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, U, V> ToLongTriFunction<T, U, V> of(@Nonnull final ToLongTriFunction<T, U, V> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <T, U, V> ToLongTriFunction<T, U, V> constant(long ret) {
        return (t, u, v) -> ret;
    }
     ...
     */
    @Nonnull
    default ToLongFunction2<Triple<T, U, V>> tupled() {
     ...
     * {@code ToLongTriFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
