...
public interface BiObjByteToShortFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjByteToShortFunction<T, U> of(@Nonnull final BiObjByteToShortFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjByteToShortFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
