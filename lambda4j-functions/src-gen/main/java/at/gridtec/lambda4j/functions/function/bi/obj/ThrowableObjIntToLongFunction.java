 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, int) specialization of
...
public interface ThrowableObjIntToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntToLongFunction<T, X> of(
            @Nonnull final ThrowableObjIntToLongFunction<T, X> expression) {
        return expression;
    }
