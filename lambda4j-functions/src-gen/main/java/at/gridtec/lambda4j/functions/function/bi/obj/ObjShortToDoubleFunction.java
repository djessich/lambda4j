...
public interface ObjShortToDoubleFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjShortToDoubleFunction<T> of(@Nonnull final ObjShortToDoubleFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjShortToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjShortToDoubleFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjShortToDoubleFunction}.
     */
    @Nonnull
    default BiFunction<T, Short, Double> boxed() {
