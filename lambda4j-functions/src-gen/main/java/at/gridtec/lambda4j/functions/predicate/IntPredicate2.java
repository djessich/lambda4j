...
import at.gridtec.lambda4j.functions.function.conversion.IntToLongFunction2;
...
/**
 * Represents an predicate (boolean-valued function) of one {@code int}-valued input argument. This is a primitive
 * specialization of {@link Predicate2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #test(int)}.
 *
...
@FunctionalInterface
public interface IntPredicate2 extends Lambda, IntPredicate {

    /**
     * Constructs a {@link IntPredicate2} based on a lambda expression or a method reference. Thereby the given lambda
     * expression or method reference is returned on an as-is basis to implicitly transform it to the desired type. With
     * this method, it is possible to ensure that correct type is used from lambda expression or method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code IntPredicate2} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static IntPredicate2 of(@Nonnull final IntPredicate2 expression) {
        return expression;
    }
     ...
     * @return The result from the given {@code IntPredicate2}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static boolean call(@Nonnull final IntPredicate predicate, int value) {
        Objects.requireNonNull(predicate);
        return predicate.test(value);
    }

    /**
     * Creates a {@link IntPredicate2} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code IntPredicate2} which always returns a given value.
     */
    @Nonnull
    static IntPredicate2 constant(boolean ret) {
        return (value) -> ret;
    }

    /**
     * Returns a {@link IntPredicate2} that always returns {@code true}.
     *
     * @return A {@link IntPredicate2} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static IntPredicate2 alwaysTrue() {
        return (value) -> true;
    }

    /**
     * Returns a {@link IntPredicate2} that always returns {@code false}.
     *
     * @return A {@link IntPredicate2} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static IntPredicate2 alwaysFalse() {
        return (value) -> false;
    }

    /**
     * Returns a {@link IntPredicate2} that tests if the given argument are <b>equal</b> to the one of this predicate.
     *
     * @param target The reference with which to compare for equality, which may be {@code null}
     * @return A {@code IntPredicate2} that tests if the given argument are <b>equal</b> to the one of this predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static IntPredicate2 isEqual(int target) {
     ...
     */
    @Nonnull
    default <A> Predicate2<A> compose(@Nonnull final ToIntFunction<? super A> before) {
        Objects.requireNonNull(before);
        return (a) -> test(before.applyAsInt(a));
    }
     ...
     */
    @Nonnull
    default BooleanUnaryOperator composeFromBoolean(@Nonnull final BooleanToIntFunction before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default BytePredicate composeFromByte(@Nonnull final ByteToIntFunction before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default CharPredicate composeFromChar(@Nonnull final CharToIntFunction before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default DoublePredicate2 composeFromDouble(@Nonnull final DoubleToIntFunction before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default FloatPredicate composeFromFloat(@Nonnull final FloatToIntFunction before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }

    /**
     * Returns a composed {@link IntPredicate2} that first applies the {@code before} operator to its input, and then
     * applies this predicate to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation. This method is just convenience, to provide the ability to execute an operation
     ...
     * @return A composed {@code IntPredicate2} that first applies the {@code before} operator to its input, and then
     * applies this predicate to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to handle primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default IntPredicate2 composeFromInt(@Nonnull final IntUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default LongPredicate2 composeFromLong(@Nonnull final LongToIntFunction before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default ShortPredicate composeFromShort(@Nonnull final ShortToIntFunction before) {
        Objects.requireNonNull(before);
        return (value) -> test(before.applyAsInt(value));
    }

    /**
     * Returns a composed {@link IntFunction2} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntFunction2} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is able to return every type.
     */
    @Nonnull
    default <S> IntFunction2<S> andThen(@Nonnull final BooleanFunction<? extends S> after) {
     ...
     * @return A composed {@code IntPredicate2} that first applies this predicate to its input, and then applies the
     ...
     */
    @Nonnull
    default IntPredicate2 andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsBoolean(test(value));
    }

    /**
     * Returns a composed {@link IntToByteFunction} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation. This method is just convenience, to provide the ability to transform this
     * primitive predicate to an operation returning {@code byte}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntToByteFunction} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default IntToByteFunction andThenToByte(@Nonnull final BooleanToByteFunction after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsByte(test(value));
    }

    /**
     * Returns a composed {@link IntToCharFunction} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation. This method is just convenience, to provide the ability to transform this
     * primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntToCharFunction} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * char}.
     */
    @Nonnull
    default IntToCharFunction andThenToChar(@Nonnull final BooleanToCharFunction after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsChar(test(value));
    }

    /**
     * Returns a composed {@link IntToDoubleFunction2} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to transform this
     * primitive predicate to an operation returning {@code double}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntToDoubleFunction2} that first applies this predicate to its input, and then applies
     ...
     */
    @Nonnull
    default IntToDoubleFunction2 andThenToDouble(@Nonnull final BooleanToDoubleFunction after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsDouble(test(value));
    }

    /**
     * Returns a composed {@link IntToFloatFunction} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to transform this
     * primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntToFloatFunction} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * float}.
     */
    @Nonnull
    default IntToFloatFunction andThenToFloat(@Nonnull final BooleanToFloatFunction after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsFloat(test(value));
    }

    /**
     * Returns a composed {@link IntUnaryOperator2} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation. This method is just convenience, to provide the ability to transform this
     * primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntUnaryOperator2} that first applies this predicate to its input, and then applies the
     * {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default IntUnaryOperator2 andThenToInt(@Nonnull final BooleanToIntFunction after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsInt(test(value));
    }

    /**
     * Returns a composed {@link IntToLongFunction2} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to transform this
     * primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntToLongFunction2} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * long}.
     */
    @Nonnull
    default IntToLongFunction2 andThenToLong(@Nonnull final BooleanToLongFunction after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsLong(test(value));
    }

    /**
     * Returns a composed {@link IntToShortFunction} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to transform this
     * primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code IntToShortFunction} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default IntToShortFunction andThenToShort(@Nonnull final BooleanToShortFunction after) {
        Objects.requireNonNull(after);
        return (value) -> after.applyAsShort(test(value));
    }

    /**
     * Returns a composed {@link IntConsumer2} that fist applies this predicate to its input, and then consumes the
     ...
     * @return A composed {@code IntConsumer2} that first applies this predicate to its input, and then consumes the
     * result using the given {@code BooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default IntConsumer2 consume(@Nonnull final BooleanConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.accept(test(value));
    }

    /**
     * Returns a {@link IntPredicate2} that represents the logical negation of this one.
     *
     * @return A {@code IntPredicate2} that represents the logical negation of this one.
     */
    @Nonnull
    default IntPredicate2 negate() {
        return (value) -> !test(value);
    }

    /**
     * Returns a composed {@link IntPredicate2} that represents a short-circuiting logical AND of this predicate and
     * another. When evaluating the composed predicate, if this predicate is {@code false}, then the {@code other}
     * predicate is not evaluated.
     * <p>
     * Any exceptions thrown during evaluation of either predicate is relayed to the caller; if evaluation of this
     * {@code IntPredicate2} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code IntPredicate2} that will be logically-ANDed with this one
     * @return A composed {@code IntPredicate2} that represents the short-circuiting logical AND of this predicate and
     * the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(IntPredicate)
     * @see #xor(IntPredicate)
     */
    @Nonnull
    default IntPredicate2 and(@Nonnull final IntPredicate other) {
        Objects.requireNonNull(other);
        return (value) -> test(value) && other.test(value);
    }

    /**
     * Returns a composed {@link IntPredicate2} that represents a short-circuiting logical OR of this predicate and
     ...
     * {@code IntPredicate2} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code IntPredicate2} that will be logically-ORed with this one
     * @return A composed {@code IntPredicate2} that represents the short-circuiting logical OR of this predicate and
     * the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     ...
     */
    @Nonnull
    default IntPredicate2 or(@Nonnull final IntPredicate other) {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }

    /**
     * Returns a composed {@link IntPredicate2} that represents a short-circuiting logical XOR of this predicate and
     * another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if evaluation of
     * this {@code IntPredicate2} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code IntPredicate2} that will be logically-XORed with this one
     * @return A composed {@code IntPredicate2} that represents the short-circuiting logical XOR of this predicate and
     * the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(IntPredicate)
     * @see #or(IntPredicate)
     */
    @Nonnull
    default IntPredicate2 xor(@Nonnull final IntPredicate other) {
        Objects.requireNonNull(other);
        return (value) -> test(value) ^ other.test(value);
    }
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code IntPredicate2}.
