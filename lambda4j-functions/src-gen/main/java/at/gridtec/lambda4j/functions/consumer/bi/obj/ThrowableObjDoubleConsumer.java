 ...
 * ThrowableBiConsumer}. Unlike most other functional interfaces, {@code ThrowableObjDoubleConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableObjDoubleConsumer<T, X extends Throwable> extends Lambda, ObjDoubleConsumer<T> {

    /**
     * Constructs a {@link ThrowableObjDoubleConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjDoubleConsumer} from given lambda expression or method reference.
    ...
    static <T, X extends Throwable> ThrowableObjDoubleConsumer<T, X> of(
            @Nonnull final ThrowableObjDoubleConsumer<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjDoubleConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, X extends Throwable> void call(
            @Nonnull final ThrowableObjDoubleConsumer<? super T, ? extends X> consumer, T t, double value) throws X {
        Objects.requireNonNull(consumer);
        consumer.acceptThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjDoubleConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjDoubleConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjDoubleConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableDoubleConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjDoubleConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleConsumer<T, X> onlySecond(
     ...
     * @implSpec Overrides the {@link ObjDoubleConsumer#accept(Object, double)} method by using a redefinition as
     * default method. This implementation calls the {@link #acceptThrows(Object, double)} method of this function and
    ...
    default <A, B> ThrowableBiConsumer<A, B, X> compose(
        ...
        return (a, b) -> acceptThrows(before1.applyThrows(a), before2.applyAsDoubleThrows(b));
    }
    ...
    default ThrowableBiBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> acceptThrows(before1.applyThrows(value1), before2.applyAsDoubleThrows(value2));
    }
    ...
    /**
     * Returns a composed {@link ThrowableObjDoubleConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjDoubleConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> andThen(
            @Nonnull final ThrowableObjDoubleConsumer<? super T, ? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableBiConsumer} which represents this {@link ThrowableObjDoubleConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed.
     *
     * @return A composed {@code ThrowableBiConsumer} which represents this {@code ThrowableObjDoubleConsumer}.
     */
    @Nonnull
    default ThrowableBiConsumer<T, Double, X> boxed() {
