...
public interface BiObjLongConsumer<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjLongConsumer<T, U> of(@Nonnull final BiObjLongConsumer<T, U> expression) {
        return expression;
    }
     ...
     * {@code BiObjLongConsumer} with JDK specific methods, only accepting {@code TriConsumer}.
     *
