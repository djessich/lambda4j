...
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongToCharFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongToDoubleFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongToFloatFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongToIntFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableBiObjLongToShortFunction;
...
public interface ThrowableBiObjLongPredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongPredicate<T, U, X> of(
            @Nonnull final ThrowableBiObjLongPredicate<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> boolean call(
            @Nonnull final ThrowableBiObjLongPredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjLongPredicate<T, U, X> and(
            @Nonnull final ThrowableBiObjLongPredicate<? super T, ? super U, ? extends X> other) {
     ...
     *
     * @return A composed {@code BiObjLongPredicate} that applies this predicate to its input and nests the thrown
