...
public interface ThrowableBiObjBooleanFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjBooleanFunction<T, U, R, X> of(
            @Nonnull final ThrowableBiObjBooleanFunction<T, U, R, X> expression) {
        return expression;
    }
    ...
    static <T, U, R, X extends Throwable> R call(
            @Nonnull final ThrowableBiObjBooleanFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanFunction<T, U, Optional<R>, X> nonNull() {
     ...
     *
     * @return A composed {@code BiObjBooleanFunction} that applies this function to its input and nests the thrown
