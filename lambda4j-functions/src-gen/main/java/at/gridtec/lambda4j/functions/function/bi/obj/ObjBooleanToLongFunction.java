 ...
 * {@code long}-valued result. This is a (reference, boolean) specialization of {@link BiFunction2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLong(Object, boolean)}.
 *
...
@FunctionalInterface
public interface ObjBooleanToLongFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBooleanToLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjBooleanToLongFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjBooleanToLongFunction<T> of(@Nonnull final ObjBooleanToLongFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBooleanToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function to be called
     * @param t The first argument to the function
     * @param value The second argument to the function
     * @return The result from the given {@code ObjBooleanToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> long call(@Nonnull final ObjBooleanToLongFunction<? super T> function, T t, boolean value) {
    ...
    /**
     * Creates a {@link ObjBooleanToLongFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link BooleanToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBooleanToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code BooleanToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBooleanToLongFunction<T> onlySecond(@Nonnull final BooleanToLongFunction function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsLong(value);
    }

    /**
     * Creates a {@link ObjBooleanToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBooleanToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBooleanToLongFunction<T> constant(long ret) {
        return (t, value) -> ret;
    }
     ...
     */
    long applyAsLong(T t, boolean value);
    ...
    default BiBooleanToLongFunction composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsLong(before1.apply(value1), before2.applyAsBoolean(value2));
    }
     ...
     */
    @Nonnull
    default ObjBooleanPredicate<T> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBooleanToByteFunction<T> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBooleanToCharFunction<T> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBooleanToDoubleFunction<T> andThenToDouble(@Nonnull final LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBooleanToFloatFunction<T> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBooleanToShortFunction<T> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
