...
public interface ToShortBiFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> ToShortBiFunction<T, U> of(@Nonnull final ToShortBiFunction<T, U> expression) {
        return expression;
    }
     ...
     * {@code ToShortBiFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
