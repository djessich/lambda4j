...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjDoubleToFloatFunction;
...
public interface BiObjDoubleToFloatFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToFloatFunction<T, U> of(@Nonnull final BiObjDoubleToFloatFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjDoubleToFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
