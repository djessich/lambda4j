...
public interface ThrowableFloatFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableFloatFunction<R, X> of(
            @Nonnull final ThrowableFloatFunction<R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code FloatFunction} that applies this function to its input and nests the thrown {@code
