...
import at.gridtec.lambda4j.functions.consumer.tri.obj.ThrowableObjBiDoubleConsumer;
...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableObjBiDoublePredicate;
...
public interface ThrowableObjBiDoubleToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToByteFunction<T, X> of(
            @Nonnull final ThrowableObjBiDoubleToByteFunction<T, X> expression) {
        return expression;
    }
