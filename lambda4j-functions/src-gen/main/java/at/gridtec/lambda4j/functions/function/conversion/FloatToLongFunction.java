...
public interface FloatToLongFunction extends Lambda {
     ...
     */
    @Nonnull
    static FloatToLongFunction of(@Nonnull final FloatToLongFunction expression) {
        return expression;
    }
     ...
     * {@code FloatToLongFunction} with JDK specific methods, only accepting {@code Function}.
     *
