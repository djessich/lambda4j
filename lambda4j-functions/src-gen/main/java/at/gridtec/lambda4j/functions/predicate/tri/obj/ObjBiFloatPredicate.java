...
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatToCharFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatToDoubleFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatToFloatFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatToIntFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ObjBiFloatToShortFunction;
...
public interface ObjBiFloatPredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiFloatPredicate<T> of(@Nonnull final ObjBiFloatPredicate<T> expression) {
        return expression;
    }
     ...
     * this {@code ObjBiFloatPredicate} with JDK specific methods, only accepting {@code TriPredicate}.
     *
