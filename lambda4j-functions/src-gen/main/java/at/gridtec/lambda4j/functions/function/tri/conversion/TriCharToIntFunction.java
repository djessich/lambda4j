...
public interface TriCharToIntFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriCharToIntFunction of(@Nonnull final TriCharToIntFunction expression) {
        return expression;
    }
     ...
     * {@code TriCharToIntFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
