...
public interface ObjShortToIntFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjShortToIntFunction<T> of(@Nonnull final ObjShortToIntFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> int call(@Nonnull final ObjShortToIntFunction<? super T> function, T t, short value) {
     ...
     */
    @Nonnull
    static <T> ObjShortToIntFunction<T> onlyFirst(@Nonnull final ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjShortToIntFunction<T> onlySecond(@Nonnull final ShortToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjShortToByteFunction<T> andThenToByte(@Nonnull final IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToCharFunction<T> andThenToChar(@Nonnull final IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> andThenToDouble(@Nonnull final IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToFloatFunction<T> andThenToFloat(@Nonnull final IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToShortFunction<T> andThenToShort(@Nonnull final IntToShortFunction after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjShortToIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjShortToIntFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjShortToIntFunction}.
     */
    @Nonnull
    default BiFunction<T, Short, Integer> boxed() {
