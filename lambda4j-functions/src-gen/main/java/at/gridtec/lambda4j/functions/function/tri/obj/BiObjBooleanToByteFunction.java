...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToByteFunction;
...
public interface BiObjBooleanToByteFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToByteFunction<T, U> of(@Nonnull final BiObjBooleanToByteFunction<T, U> expression) {
        return expression;
    }
