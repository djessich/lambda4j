...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjDoubleToCharFunction;
...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjDoubleToShortFunction;
...
public interface ObjDoublePredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjDoublePredicate<T> of(@Nonnull final ObjDoublePredicate<T> expression) {
        return expression;
    }
     ...
     * this {@code ObjDoublePredicate} with JDK specific methods, only accepting {@code BiPredicate}.
     *
