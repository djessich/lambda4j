...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjIntToByteFunction;
...
import at.gridtec.lambda4j.functions.function.tri.conversion.TriBooleanToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.TriCharToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.TriDoubleToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.TriFloatToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.TriIntToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.TriLongToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.TriShortToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.to.ToByteTriFunction;
import at.gridtec.lambda4j.functions.operator.ternary.ByteTernaryOperator;
 ...
 * {@code byte}-valued result. This is a (reference, reference, int) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByte(Object, Object, int)}.
 *
...
@FunctionalInterface
public interface BiObjIntToByteFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjIntToByteFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjIntToByteFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, U> BiObjIntToByteFunction<T, U> of(@Nonnull final BiObjIntToByteFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjIntToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjIntToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> byte call(@Nonnull final BiObjIntToByteFunction<? super T, ? super U> function, T t, U u, int value) {
        Objects.requireNonNull(function);
        return function.applyAsByte(t, u, value);
    }

    /**
     * Creates a {@link BiObjIntToByteFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjIntToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjIntToByteFunction<T, U> onlyFirst(@Nonnull final ToByteFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByte(t);
    }

    /**
     * Creates a {@link BiObjIntToByteFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjIntToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjIntToByteFunction<T, U> onlySecond(@Nonnull final ToByteFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByte(u);
    }

    /**
     * Creates a {@link BiObjIntToByteFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link IntToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjIntToByteFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code IntToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjIntToByteFunction<T, U> onlyThird(@Nonnull final IntToByteFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByte(value);
    }

    /**
     * Creates a {@link BiObjIntToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjIntToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjIntToByteFunction<T, U> constant(byte ret) {
     ...
     */
    byte applyAsByte(T t, U u, int value);
     ...
     */
    default byte applyAsByte(@Nonnull Pair<T, U> tuple, int value) {
    ...
    default <A, B, C> ToByteTriFunction<A, B, C> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsByte(before1.apply(a), before2.apply(b), before3.applyAsInt(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjIntFunction<T, U, S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjIntPredicate<T, U> andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToByteFunction<T, U> andThenToByte(@Nonnull final ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToCharFunction<T, U> andThenToChar(@Nonnull final ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToDoubleFunction<T, U> andThenToDouble(@Nonnull final ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToFloatFunction<T, U> andThenToFloat(@Nonnull final ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToIntFunction<T, U> andThenToInt(@Nonnull final ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToLongFunction<T, U> andThenToLong(@Nonnull final ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToShortFunction<T, U> andThenToShort(@Nonnull final ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntConsumer<T, U> consume(@Nonnull final ByteConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjIntToByteFunction<Pair<T, U>> tupled() {
        return this::applyAsByte;
    }

    /**
     * Returns a memoized (caching) version of this {@link BiObjIntToByteFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiObjIntToByteFunction}.
     ...
     */
    @Nonnull
    default BiObjIntToByteFunction<T, U> memoized() {
        if (this instanceof Memoized) {
            return this;
        } else {
            final Map<Triple<T, U, Integer>, Byte> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (BiObjIntToByteFunction<T, U> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjIntToByteFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code BiObjIntToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjIntToByteFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Integer, Byte> boxed() {
        return this::applyAsByte;
    }
