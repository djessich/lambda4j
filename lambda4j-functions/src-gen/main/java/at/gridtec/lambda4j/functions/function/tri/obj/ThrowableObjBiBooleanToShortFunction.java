...
public interface ThrowableObjBiBooleanToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiBooleanToShortFunction<T, X> of(
            @Nonnull final ThrowableObjBiBooleanToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull final ThrowableObjBiBooleanToShortFunction<? super T, ? extends X> function, T t, boolean value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiBooleanConsumer<T, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     * ThrowableObjBiBooleanToShortFunction}. Thereby the primitive input argument for this function is autoboxed.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiBooleanToShortFunction}.
     */
    @Nonnull
