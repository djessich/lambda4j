...
public interface ThrowableBiByteToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiByteToLongFunction<X> of(
            @Nonnull final ThrowableBiByteToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiByteToLongFunction} that applies this function to its input and nests the thrown
