...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToDoubleFunction;
...
public interface BiObjBooleanToDoubleFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToDoubleFunction<T, U> of(@Nonnull final BiObjBooleanToDoubleFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> double call(@Nonnull final BiObjBooleanToDoubleFunction<? super T, ? super U> function, T t, U u,
            boolean value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToDoubleFunction<T, U> onlyFirst(@Nonnull final ToDoubleFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToDoubleFunction<T, U> onlySecond(@Nonnull final ToDoubleFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToDoubleFunction<T, U> onlyThird(@Nonnull final BooleanToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> BiObjBooleanFunction<T, U, S> andThen(@Nonnull final DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjBooleanToByteFunction<T, U> andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToCharFunction<T, U> andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToDoubleFunction<T, U> andThenToDouble(@Nonnull final DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToFloatFunction<T, U> andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToLongFunction<T, U> andThenToLong(@Nonnull final DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToShortFunction<T, U> andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code BiObjBooleanToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
