...
import at.gridtec.lambda4j.functions.consumer.tri.obj.ThrowableObjBiBooleanConsumer;
...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableObjBiBooleanPredicate;
...
public interface ThrowableObjBiBooleanToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiBooleanToLongFunction<T, X> of(
            @Nonnull final ThrowableObjBiBooleanToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjBiBooleanToLongFunction<? super T, ? extends X> function, T t, boolean value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiBooleanConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     * ThrowableObjBiBooleanToLongFunction}. Thereby the primitive input argument for this function is autoboxed.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiBooleanToLongFunction}.
     */
    @Nonnull
     ...
     *
     * @return A composed {@code ObjBiBooleanToLongFunction} that applies this function to its input and nests the
