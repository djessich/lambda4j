...
public interface ThrowableObjBiDoubleToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToIntFunction<T, X> of(
            @Nonnull final ThrowableObjBiDoubleToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiDoubleToIntFunction} that applies this function to its input and nests the thrown
