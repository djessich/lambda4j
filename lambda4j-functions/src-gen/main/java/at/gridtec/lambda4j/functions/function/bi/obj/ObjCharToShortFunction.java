...
public interface ObjCharToShortFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjCharToShortFunction<T> of(@Nonnull final ObjCharToShortFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> short call(@Nonnull final ObjCharToShortFunction<? super T> function, T t, char value) {
     ...
     */
    @Nonnull
    static <T> ObjCharToShortFunction<T> onlyFirst(@Nonnull final ToShortFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjCharToShortFunction<T> onlySecond(@Nonnull final CharToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjCharFunction<T, S> andThen(@Nonnull final ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjCharPredicate<T> andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToByteFunction<T> andThenToByte(@Nonnull final ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToCharFunction<T> andThenToChar(@Nonnull final ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToDoubleFunction<T> andThenToDouble(@Nonnull final ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToFloatFunction<T> andThenToFloat(@Nonnull final ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToIntFunction<T> andThenToInt(@Nonnull final ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToLongFunction<T> andThenToLong(@Nonnull final ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToShortFunction<T> andThenToShort(@Nonnull final ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharConsumer<T> consume(@Nonnull final ShortConsumer consumer) {
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjCharToShortFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjCharToShortFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjCharToShortFunction}.
     */
    @Nonnull
    default BiFunction<T, Character, Short> boxed() {
