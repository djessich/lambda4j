...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjBooleanToDoubleFunction;
...
public interface ThrowableBiObjBooleanToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToDoubleFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjBooleanToDoubleFunction<T, U, X> expression) {
        return expression;
    }
