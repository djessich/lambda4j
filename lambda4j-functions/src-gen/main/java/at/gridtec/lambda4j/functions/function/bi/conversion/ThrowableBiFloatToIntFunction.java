...
import at.gridtec.lambda4j.functions.consumer.bi.ThrowableBiFloatConsumer;
...
import at.gridtec.lambda4j.functions.function.bi.ThrowableBiFloatFunction;
...
public interface ThrowableBiFloatToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToIntFunction<X> of(
            @Nonnull final ThrowableBiFloatToIntFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiFloatToIntFunction} that applies this function to its input and nests the thrown
