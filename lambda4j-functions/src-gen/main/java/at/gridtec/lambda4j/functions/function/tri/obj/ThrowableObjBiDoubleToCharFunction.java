...
public interface ThrowableObjBiDoubleToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToCharFunction<T, X> of(
            @Nonnull final ThrowableObjBiDoubleToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiDoubleToCharFunction} that applies this function to its input and nests the thrown
