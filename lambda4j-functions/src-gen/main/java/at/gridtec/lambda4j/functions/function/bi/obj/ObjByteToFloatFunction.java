...
public interface ObjByteToFloatFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjByteToFloatFunction<T> of(@Nonnull final ObjByteToFloatFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjByteToFloatFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjByteToFloatFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjByteToFloatFunction}.
     */
    @Nonnull
    default BiFunction<T, Byte, Float> boxed() {
