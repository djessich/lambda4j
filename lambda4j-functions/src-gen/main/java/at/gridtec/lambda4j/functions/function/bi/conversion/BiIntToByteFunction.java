...
public interface BiIntToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiIntToByteFunction of(@Nonnull final BiIntToByteFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B> ToByteBiFunction<A, B> compose(@Nonnull final ToIntFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToByteFunction composeFromBoolean(@Nonnull final BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default ByteBinaryOperator composeFromByte(@Nonnull final ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default BiCharToByteFunction composeFromChar(@Nonnull final CharToIntFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToByteFunction composeFromDouble(@Nonnull final DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToByteFunction composeFromFloat(@Nonnull final FloatToIntFunction before1,
     ...
     */
    @Nonnull
    default BiLongToByteFunction composeFromLong(@Nonnull final LongToIntFunction before1,
     ...
     */
    @Nonnull
    default BiShortToByteFunction composeFromShort(@Nonnull final ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default <S> BiIntFunction<S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiIntPredicate andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToByteFunction andThenToByte(@Nonnull final ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToCharFunction andThenToChar(@Nonnull final ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToDoubleFunction andThenToDouble(@Nonnull final ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToFloatFunction andThenToFloat(@Nonnull final ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntBinaryOperator2 andThenToInt(@Nonnull final ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToLongFunction andThenToLong(@Nonnull final ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToShortFunction andThenToShort(@Nonnull final ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntConsumer consume(@Nonnull final ByteConsumer consumer) {
     ...
     * {@code BiIntToByteFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
