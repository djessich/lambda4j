...
public interface BiByteToFloatFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiByteToFloatFunction of(@Nonnull final BiByteToFloatFunction expression) {
        return expression;
    }
     ...
     * {@code BiByteToFloatFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
