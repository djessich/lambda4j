...
public interface ObjFloatToFloatFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjFloatToFloatFunction<T> of(@Nonnull final ObjFloatToFloatFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> float call(@Nonnull final ObjFloatToFloatFunction<? super T> function, T t, float value) {
     ...
     */
    @Nonnull
    static <T> ObjFloatToFloatFunction<T> onlyFirst(@Nonnull final ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjFloatToFloatFunction<T> onlySecond(@Nonnull final FloatUnaryOperator operator) {
     ...
     */
    @Nonnull
    default ObjFloatPredicate<T> andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToByteFunction<T> andThenToByte(@Nonnull final FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToCharFunction<T> andThenToChar(@Nonnull final FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToDoubleFunction<T> andThenToDouble(@Nonnull final FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> andThenToFloat(@Nonnull final FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToIntFunction<T> andThenToInt(@Nonnull final FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToLongFunction<T> andThenToLong(@Nonnull final FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToShortFunction<T> andThenToShort(@Nonnull final FloatToShortFunction after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjFloatToFloatFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjFloatToFloatFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjFloatToFloatFunction}.
     */
    @Nonnull
