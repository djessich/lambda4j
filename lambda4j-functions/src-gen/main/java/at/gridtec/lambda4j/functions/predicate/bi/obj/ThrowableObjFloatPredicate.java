...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatToByteFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatToCharFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatToDoubleFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatToFloatFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatToIntFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjFloatToShortFunction;
...
import at.gridtec.lambda4j.functions.operator.binary.ThrowableBooleanBinaryOperator;
...
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiBytePredicate;
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiCharPredicate;
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiDoublePredicate;
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiFloatPredicate;
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiIntPredicate;
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiLongPredicate;
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiPredicate;
import at.gridtec.lambda4j.functions.predicate.bi.ThrowableBiShortPredicate;
 ...
 * which is able to throw any {@link Throwable}. This is a (reference, float) specialization of {@link
 * ThrowableBiPredicate}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #testThrows(Object, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjFloatPredicate<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjFloatPredicate} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjFloatPredicate} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> of(
            @Nonnull final ThrowableObjFloatPredicate<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjFloatPredicate} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return The result from the given {@code ThrowableObjFloatPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this predicates action
     */
    static <T, X extends Throwable> boolean call(
            @Nonnull final ThrowableObjFloatPredicate<? super T, ? extends X> predicate, T t, float value) throws X {
        Objects.requireNonNull(predicate);
        return predicate.testThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjFloatPredicate} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowablePredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjFloatPredicate} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjFloatPredicate} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableFloatPredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjFloatPredicate} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjFloatPredicate} which always returns a given value.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjFloatPredicate} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> constant(boolean ret) {
        return (t, value) -> ret;
    }
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> alwaysTrue() {
        return (t, value) -> true;
    }

    /**
     * Returns a {@link ThrowableObjFloatPredicate} that always returns {@code false}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableObjFloatPredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> alwaysFalse() {
        return (t, value) -> false;
    }

    /**
     * Returns a {@link ThrowableObjFloatPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return A {@code ThrowableObjFloatPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> isEqual(@Nullable Object target1, float target2) {
     ...
     * @throws X Any throwable from this predicates action
     */
    boolean testThrows(T t, float value) throws X;
    ...
    default <A, B> ThrowableBiPredicate<A, B, X> compose(
        ...
        return (a, b) -> testThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b));
    }
    ...
    default ThrowableBooleanBinaryOperator<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> testThrows(before1.applyThrows(value1), before2.applyAsFloatThrows(value2));
    }
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatPredicate} that first applies this predicate to its input, and then
     * applies the {@code after} operator to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code boolean}.
     *
     * @param after The operator to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatPredicate} that first applies this predicate to its input, and then
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatToByteFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code byte}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatToByteFunction} that first applies this predicate to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatToDoubleFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code double}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatToDoubleFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * double}.
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * int}.
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * long}.
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjFloatToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to return primitive values. In this case this is {@code
     * short}.
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatConsumer} that fist applies this predicate to its input, and then
     * consumes the result using the given {@link ThrowableBooleanConsumer}.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code ThrowableObjFloatConsumer} that first applies this predicate to its input, and then
     * consumes the result using the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(testThrows(t, value));
    }

    /**
     * Returns a {@link ThrowableObjFloatPredicate} that represents the logical negation of this one.
     *
     * @return A {@code ThrowableObjFloatPredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default ThrowableObjFloatPredicate<T, X> negate() {
        return (t, value) -> !testThrows(t, value);
    }

    /**
     * Returns a composed {@link ThrowableObjFloatPredicate} that represents a short-circuiting logical AND of this
     ...
     * {@code ThrowableObjFloatPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableObjFloatPredicate} that will be logically-ANDed with this one
     * @return A composed {@code ThrowableObjFloatPredicate} that represents the short-circuiting logical AND of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ThrowableObjFloatPredicate)
     * @see #xor(ThrowableObjFloatPredicate)
     */
    @Nonnull
    default ThrowableObjFloatPredicate<T, X> and(
            @Nonnull final ThrowableObjFloatPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value) -> testThrows(t, value) && other.testThrows(t, value);
    }

    /**
     * Returns a composed {@link ThrowableObjFloatPredicate} that represents a short-circuiting logical OR of this
     ...
     * {@code ThrowableObjFloatPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableObjFloatPredicate} that will be logically-ORed with this one
     * @return A composed {@code ThrowableObjFloatPredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableObjFloatPredicate)
     * @see #xor(ThrowableObjFloatPredicate)
     */
    @Nonnull
    default ThrowableObjFloatPredicate<T, X> or(
            @Nonnull final ThrowableObjFloatPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value) -> testThrows(t, value) || other.testThrows(t, value);
    }
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatPredicate} that represents a short-circuiting logical XOR of this
     * predicate and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if
     * evaluation of this {@code ThrowableObjFloatPredicate} throws an exception, the {@code other} predicate will not
     * be evaluated.
     *
     * @param other A {@code ThrowableObjFloatPredicate} that will be logically-XORed with this one
     * @return A composed {@code ThrowableObjFloatPredicate} that represents the short-circuiting logical XOR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableObjFloatPredicate)
     * @see #or(ThrowableObjFloatPredicate)
     */
    @Nonnull
    default ThrowableObjFloatPredicate<T, X> xor(
            @Nonnull final ThrowableObjFloatPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value) -> testThrows(t, value) ^ other.testThrows(t, value);
    }
    ...
    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjFloatPredicate}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjFloatPredicate}.
    ...
    default ThrowableObjFloatPredicate<T, X> memoized() {
        if (this instanceof Memoized) {
            ...
            return (ThrowableObjFloatPredicate<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiPredicate} which represents this {@link ThrowableObjFloatPredicate}. Thereby
     * the primitive input argument for this predicate is autoboxed.
     *
     * @return A composed {@code ThrowableBiPredicate} which represents this {@code ThrowableObjFloatPredicate}.
     */
    @Nonnull
    default ThrowableBiPredicate<T, Float, X> boxed() {
        return this::testThrows;
    }

    /**
     * Returns a composed {@link ObjFloatPredicate} that applies this predicate to its input and nests the thrown {@link
    ...
    /**
     * Returns a composed {@link ObjFloatPredicate} that applies this predicate to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjFloatPredicate} that applies this predicate to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjFloatPredicate<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.testThrows(t, value);
            } catch (RuntimeException | Error e) {
