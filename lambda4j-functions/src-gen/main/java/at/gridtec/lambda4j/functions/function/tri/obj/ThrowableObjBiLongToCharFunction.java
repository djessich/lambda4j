...
public interface ThrowableObjBiLongToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToCharFunction<T, X> of(
            @Nonnull final ThrowableObjBiLongToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull final ThrowableObjBiLongToCharFunction<? super T, ? extends X> function, T t, long value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjBiLongToCharFunction} that applies this function to its input and nests the thrown
