...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjShortToCharFunction;
...
public interface ThrowableObjShortPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortPredicate<T, X> of(
            @Nonnull final ThrowableObjShortPredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull final ThrowableObjShortPredicate<? super T, ? extends X> predicate, T t, short value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjShortPredicate<T, X> and(
            @Nonnull final ThrowableObjShortPredicate<? super T, ? extends X> other) {
     ...
     *
     * @return A composed {@code ObjShortPredicate} that applies this predicate to its input and nests the thrown {@code
