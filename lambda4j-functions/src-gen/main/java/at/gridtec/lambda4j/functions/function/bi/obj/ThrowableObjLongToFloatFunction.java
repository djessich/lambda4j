 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, long) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjLongToFloatFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjLongToFloatFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjLongToFloatFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToFloatFunction<T, X> of(
            @Nonnull final ThrowableObjLongToFloatFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjLongToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjLongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> float call(
            @Nonnull final ThrowableObjLongToFloatFunction<? super T, ? extends X> function, T t, long value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsFloatThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjLongToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjLongToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToFloatFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjLongToFloatFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableLongToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjLongToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToFloatFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjLongToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjLongToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToFloatFunction<T, X> constant(float ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ThrowableToFloatBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsFloatThrows(before1.applyThrows(a), before2.applyAsLongThrows(b));
    }
    ...
    default ThrowableBiBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsFloatThrows(before1.applyThrows(value1), before2.applyAsLongThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsFloatThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjLongToFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjLongToFloatFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjLongToFloatFunction<T, X> memoized() {
        if (this instanceof Memoized) {
            return this;
        } else {
            final Map<Pair<T, Long>, Float> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjLongToFloatFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjLongToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjLongToFloatFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Long, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link ObjLongToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}. The throwable is
     * nested (wrapped) in a {@link ThrownByFunctionalInterfaceException}, which is constructed from the thrown
     * throwables message and the thrown throwable itself.
     *
     * @return A composed {@code ObjLongToFloatFunction} that applies this function to its input and nests the thrown
     * {@code {@code Throwable} from it, unless it is of type {@code RuntimeException} or {@code Error}.
     */
    @Nonnull
    default ObjLongToFloatFunction<T> nest() {
        return (t, value) -> {
            try {
    ...
    /**
     * Returns a composed {@link ObjLongToFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjLongToFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjLongToFloatFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.applyAsFloatThrows(t, value);
            } catch (RuntimeException | Error e) {
