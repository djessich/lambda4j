...
public interface BiObjByteFunction<T, U, R> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjByteFunction<T, U, R> of(@Nonnull final BiObjByteFunction<T, U, R> expression) {
        return expression;
    }
     ...
     * {@code BiObjByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
