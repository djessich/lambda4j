...
public interface ThrowableBiBytePredicate<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiBytePredicate<X> of(@Nonnull final ThrowableBiBytePredicate<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiBytePredicate} that applies this predicate to its input and nests the thrown {@code
