...
public interface ObjBiBooleanToDoubleFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToDoubleFunction<T> of(@Nonnull final ObjBiBooleanToDoubleFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiBooleanToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
