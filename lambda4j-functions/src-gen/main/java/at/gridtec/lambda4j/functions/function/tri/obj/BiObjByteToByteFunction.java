...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjByteToByteFunction;
...
public interface BiObjByteToByteFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjByteToByteFunction<T, U> of(@Nonnull final BiObjByteToByteFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjByteToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
