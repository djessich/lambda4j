...
public interface ObjFloatToCharFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjFloatToCharFunction<T> of(@Nonnull final ObjFloatToCharFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> char call(@Nonnull final ObjFloatToCharFunction<? super T> function, T t, float value) {
     ...
     */
    @Nonnull
    static <T> ObjFloatToCharFunction<T> onlyFirst(@Nonnull final ToCharFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjFloatToCharFunction<T> onlySecond(@Nonnull final FloatToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjFloatFunction<T, S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjFloatPredicate<T> andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToByteFunction<T> andThenToByte(@Nonnull final CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToCharFunction<T> andThenToChar(@Nonnull final CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToDoubleFunction<T> andThenToDouble(@Nonnull final CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> andThenToFloat(@Nonnull final CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToIntFunction<T> andThenToInt(@Nonnull final CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToLongFunction<T> andThenToLong(@Nonnull final CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToShortFunction<T> andThenToShort(@Nonnull final CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatConsumer<T> consume(@Nonnull final CharConsumer consumer) {
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjFloatToCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjFloatToCharFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjFloatToCharFunction}.
     */
    @Nonnull
    default BiFunction<T, Float, Character> boxed() {
