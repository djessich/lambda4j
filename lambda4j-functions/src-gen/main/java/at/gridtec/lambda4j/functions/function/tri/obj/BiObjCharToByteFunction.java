...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjCharToByteFunction;
...
public interface BiObjCharToByteFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjCharToByteFunction<T, U> of(@Nonnull final BiObjCharToByteFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjCharToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
