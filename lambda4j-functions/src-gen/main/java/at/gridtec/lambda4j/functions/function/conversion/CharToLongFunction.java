...
public interface CharToLongFunction extends Lambda {
     ...
     */
    @Nonnull
    static CharToLongFunction of(@Nonnull final CharToLongFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A> ToLongFunction2<A> compose(@Nonnull final ToCharFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToLongFunction composeFromBoolean(@Nonnull final BooleanToCharFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToLongFunction composeFromByte(@Nonnull final ByteToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default CharToLongFunction composeFromChar(@Nonnull final CharUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 composeFromDouble(@Nonnull final DoubleToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default FloatToLongFunction composeFromFloat(@Nonnull final FloatToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default IntToLongFunction2 composeFromInt(@Nonnull final IntToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default LongUnaryOperator2 composeFromLong(@Nonnull final LongToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default ShortToLongFunction composeFromShort(@Nonnull final ShortToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default <S> CharFunction<S> andThen(@Nonnull final LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default CharPredicate andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     * {@code CharToLongFunction} with JDK specific methods, only accepting {@code Function}.
     *
