...
public interface ThrowableDoubleBinaryOperator<X extends Throwable> extends Lambda, DoubleBinaryOperator {
    ...
    static <X extends Throwable> ThrowableDoubleBinaryOperator<X> of(
            @Nonnull final ThrowableDoubleBinaryOperator<X> expression) {
        return expression;
    }
     ...
     * @implSpec Overrides the {@link DoubleBinaryOperator#applyAsDouble(double, double)} method by using a redefinition
     ...
     *
     * @return A composed {@code DoubleBinaryOperator2} that applies this operator to its input and nests the thrown
