...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjLongToCharFunction;
...
public interface BiObjLongToCharFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> char call(@Nonnull final BiObjLongToCharFunction<? super T, ? super U> function, T t, U u,
            long value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToCharFunction<T, U> onlyFirst(@Nonnull final ToCharFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToCharFunction<T, U> onlySecond(@Nonnull final ToCharFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToCharFunction<T, U> onlyThird(@Nonnull final LongToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> BiObjLongFunction<T, U, S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjLongPredicate<T, U> andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> andThenToByte(@Nonnull final CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToCharFunction<T, U> andThenToChar(@Nonnull final CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> andThenToDouble(@Nonnull final CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToFloatFunction<T, U> andThenToFloat(@Nonnull final CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToIntFunction<T, U> andThenToInt(@Nonnull final CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToLongFunction<T, U> andThenToLong(@Nonnull final CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToShortFunction<T, U> andThenToShort(@Nonnull final CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> consume(@Nonnull final CharConsumer consumer) {
     ...
     * to use this {@code BiObjLongToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
