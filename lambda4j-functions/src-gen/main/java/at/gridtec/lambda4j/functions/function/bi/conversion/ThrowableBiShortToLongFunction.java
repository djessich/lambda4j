...
public interface ThrowableBiShortToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiShortToLongFunction<X> of(
            @Nonnull final ThrowableBiShortToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiShortToLongFunction} that applies this function to its input and nests the thrown
