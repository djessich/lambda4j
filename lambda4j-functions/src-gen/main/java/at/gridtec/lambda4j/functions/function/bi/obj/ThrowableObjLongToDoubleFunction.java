 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, long) specialization
...
public interface ThrowableObjLongToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToDoubleFunction<T, X> of(
            @Nonnull final ThrowableObjLongToDoubleFunction<T, X> expression) {
        return expression;
    }
