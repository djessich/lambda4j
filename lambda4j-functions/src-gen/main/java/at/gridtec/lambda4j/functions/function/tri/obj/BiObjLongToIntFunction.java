...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjLongToIntFunction;
...
public interface BiObjLongToIntFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToIntFunction<T, U> of(@Nonnull final BiObjLongToIntFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjLongToIntFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
