...
public interface BiObjBooleanToIntFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToIntFunction<T, U> of(@Nonnull final BiObjBooleanToIntFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjBooleanToIntFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
