...
public interface ToShortTriFunction<T, U, V> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U, V> ToShortTriFunction<T, U, V> of(@Nonnull final ToShortTriFunction<T, U, V> expression) {
        return expression;
    }
     ...
     * {@code ToShortTriFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
