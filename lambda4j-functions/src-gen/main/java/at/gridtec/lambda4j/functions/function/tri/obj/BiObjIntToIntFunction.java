...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjIntToIntFunction;
...
public interface BiObjIntToIntFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjIntToIntFunction<T, U> of(@Nonnull final BiObjIntToIntFunction<T, U> expression) {
        return expression;
    }
