...
import at.gridtec.lambda4j.functions.consumer.bi.ThrowableBiIntConsumer;
...
import at.gridtec.lambda4j.functions.function.bi.ThrowableBiIntFunction;
...
public interface ThrowableBiIntToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiIntToCharFunction<X> of(
            @Nonnull final ThrowableBiIntToCharFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiIntToCharFunction} that applies this function to its input and nests the thrown
