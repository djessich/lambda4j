...
public interface TriLongFunction<R> extends Lambda {
     ...
     */
    @Nonnull
    static <R> TriLongFunction<R> of(@Nonnull final TriLongFunction<R> expression) {
        return expression;
    }
     ...
     * {@code TriLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
