...
public interface ObjByteToLongFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjByteToLongFunction<T> of(@Nonnull final ObjByteToLongFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjByteToLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjByteToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjByteToLongFunction}.
     */
    @Nonnull
    default BiFunction<T, Byte, Long> boxed() {
