...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjShortToShortFunction;
...
public interface ThrowableBiObjShortToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortToShortFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjShortToShortFunction<T, U, X> expression) {
        return expression;
    }
