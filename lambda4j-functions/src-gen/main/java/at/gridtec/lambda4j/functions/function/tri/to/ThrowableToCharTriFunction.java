...
public interface ThrowableToCharTriFunction<T, U, V, X extends Throwable> extends Lambda {
    ...
    static <T, U, V, X extends Throwable> ThrowableToCharTriFunction<T, U, V, X> of(
            @Nonnull final ThrowableToCharTriFunction<T, U, V, X> expression) {
        return expression;
    }
    ...
    static <T, U, V, X extends Throwable> char call(
            @Nonnull final ThrowableToCharTriFunction<? super T, ? super U, ? super V, ? extends X> function, T t, U u,
            V v) throws X {
    ...
    static <T, U, V, X extends Throwable> ThrowableToCharTriFunction<T, U, V, X> onlyThird(
            @Nonnull final ThrowableToCharFunction<? super V, ? extends X> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, V, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ToCharTriFunction} that applies this function to its input and nests the thrown {@code
