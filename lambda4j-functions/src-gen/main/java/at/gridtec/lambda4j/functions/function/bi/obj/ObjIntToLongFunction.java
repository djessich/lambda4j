...
import at.gridtec.lambda4j.functions.function.bi.conversion.BiBooleanToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.BiByteToLongFunction;
...
import at.gridtec.lambda4j.functions.function.bi.conversion.BiIntToLongFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.BiShortToLongFunction;
...
public interface ObjIntToLongFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjIntToLongFunction<T> of(@Nonnull final ObjIntToLongFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> long call(@Nonnull final ObjIntToLongFunction<? super T> function, T t, int value) {
     ...
     */
    @Nonnull
    default ObjIntPredicate<T> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToByteFunction<T> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToCharFunction<T> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToFloatFunction<T> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToIntFunction<T> andThenToInt(@Nonnull final LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjIntToShortFunction<T> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjIntToLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjIntToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjIntToLongFunction}.
     */
    @Nonnull
    default BiFunction<T, Integer, Long> boxed() {
