...
public interface ObjFloatToDoubleFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjFloatToDoubleFunction<T> of(@Nonnull final ObjFloatToDoubleFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjFloatToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjFloatToDoubleFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjFloatToDoubleFunction}.
     */
    @Nonnull
    default BiFunction<T, Float, Double> boxed() {
