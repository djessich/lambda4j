...
public interface ThrowableObjBiIntToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToLongFunction<T, X> of(
            @Nonnull final ThrowableObjBiIntToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjBiIntToLongFunction<? super T, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjBiIntToLongFunction} that applies this function to its input and nests the thrown
