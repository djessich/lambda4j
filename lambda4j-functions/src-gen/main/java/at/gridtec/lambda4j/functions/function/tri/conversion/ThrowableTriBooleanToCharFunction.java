...
public interface ThrowableTriBooleanToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriBooleanToCharFunction<X> of(
            @Nonnull final ThrowableTriBooleanToCharFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriBooleanToCharFunction} that applies this function to its input and nests the thrown
