...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToByteFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToCharFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToDoubleFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToFloatFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjBooleanToIntFunction;
...
public interface ObjBooleanPredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBooleanPredicate<T> of(@Nonnull final ObjBooleanPredicate<T> expression) {
        return expression;
    }
     ...
     * this {@code ObjBooleanPredicate} with JDK specific methods, only accepting {@code BiPredicate}.
     *
