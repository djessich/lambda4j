...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjCharToLongFunction;
 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, char)
...
public interface ThrowableBiObjCharToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToLongFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjCharToLongFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjCharToLongFunction} that applies this function to its input and nests the thrown
