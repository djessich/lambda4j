...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjLongToShortFunction;
...
public interface ObjLongPredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjLongPredicate<T> of(@Nonnull final ObjLongPredicate<T> expression) {
        return expression;
    }
     ...
     * this {@code ObjLongPredicate} with JDK specific methods, only accepting {@code BiPredicate}.
     *
