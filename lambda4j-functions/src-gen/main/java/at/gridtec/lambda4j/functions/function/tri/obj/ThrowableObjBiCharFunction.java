...
public interface ThrowableObjBiCharFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, R, X> of(
            @Nonnull final ThrowableObjBiCharFunction<T, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiCharFunction} that applies this function to its input and nests the thrown {@code
