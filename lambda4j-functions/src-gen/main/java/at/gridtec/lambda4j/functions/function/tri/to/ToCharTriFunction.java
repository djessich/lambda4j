...
public interface ToCharTriFunction<T, U, V> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U, V> ToCharTriFunction<T, U, V> of(@Nonnull final ToCharTriFunction<T, U, V> expression) {
        return expression;
    }
     ...
     */
    static <T, U, V> char call(@Nonnull final ToCharTriFunction<? super T, ? super U, ? super V> function, T t, U u,
            V v) {
     ...
     */
    @Nonnull
    default <S> TriFunction<T, U, V, S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     * {@code ToCharTriFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
