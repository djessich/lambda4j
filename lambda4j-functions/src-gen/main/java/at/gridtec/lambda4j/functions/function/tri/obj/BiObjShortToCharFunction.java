...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortToCharFunction;
 ...
 * {@code char}-valued result. This is a (reference, reference, short) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsChar(Object, Object, short)}.
 *
...
@FunctionalInterface
public interface BiObjShortToCharFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjShortToCharFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjShortToCharFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, U> BiObjShortToCharFunction<T, U> of(@Nonnull final BiObjShortToCharFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjShortToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjShortToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> char call(@Nonnull final BiObjShortToCharFunction<? super T, ? super U> function, T t, U u,
            short value) {
    ...
    /**
     * Creates a {@link BiObjShortToCharFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjShortToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjShortToCharFunction<T, U> onlyFirst(@Nonnull final ToCharFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(t);
    }

    /**
     * Creates a {@link BiObjShortToCharFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjShortToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjShortToCharFunction<T, U> onlySecond(@Nonnull final ToCharFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(u);
    }

    /**
     * Creates a {@link BiObjShortToCharFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link ShortToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjShortToCharFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code ShortToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjShortToCharFunction<T, U> onlyThird(@Nonnull final ShortToCharFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(value);
    }

    /**
     * Creates a {@link BiObjShortToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjShortToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjShortToCharFunction<T, U> constant(char ret) {
     ...
     */
    char applyAsChar(T t, U u, short value);
     ...
     */
    default char applyAsChar(@Nonnull Pair<T, U> tuple, short value) {
    ...
    default <A, B, C> ToCharTriFunction<A, B, C> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsChar(before1.apply(a), before2.apply(b), before3.applyAsShort(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjShortFunction<T, U, S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjShortPredicate<T, U> andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToByteFunction<T, U> andThenToByte(@Nonnull final CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToCharFunction<T, U> andThenToChar(@Nonnull final CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToDoubleFunction<T, U> andThenToDouble(@Nonnull final CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToFloatFunction<T, U> andThenToFloat(@Nonnull final CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToIntFunction<T, U> andThenToInt(@Nonnull final CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToLongFunction<T, U> andThenToLong(@Nonnull final CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToShortFunction<T, U> andThenToShort(@Nonnull final CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortConsumer<T, U> consume(@Nonnull final CharConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjShortToCharFunction<Pair<T, U>> tupled() {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjShortToCharFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code BiObjShortToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjShortToCharFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Short, Character> boxed() {
        return this::applyAsChar;
    }
