 ...
 */
package at.gridtec.lambda4j.functions.function.to;
...
public interface ThrowableToIntFunction<T, X extends Throwable> extends Lambda, ToIntFunction<T> {
    ...
    static <T, X extends Throwable> ThrowableToIntFunction<T, X> of(
            @Nonnull final ThrowableToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     * @implSpec Overrides the {@link ToIntFunction#applyAsInt(Object)} method by using a redefinition as default
     * method. This implementation calls the {@link #applyAsIntThrows(Object)} method of this function and catches the
