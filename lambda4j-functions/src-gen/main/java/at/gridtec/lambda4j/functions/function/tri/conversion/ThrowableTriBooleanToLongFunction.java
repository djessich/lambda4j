...
public interface ThrowableTriBooleanToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriBooleanToLongFunction<X> of(
            @Nonnull final ThrowableTriBooleanToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriBooleanToLongFunction} that applies this function to its input and nests the thrown
