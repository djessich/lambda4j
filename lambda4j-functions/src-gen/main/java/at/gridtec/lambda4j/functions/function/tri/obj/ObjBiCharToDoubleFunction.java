...
public interface ObjBiCharToDoubleFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiCharToDoubleFunction<T> of(@Nonnull final ObjBiCharToDoubleFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> double call(@Nonnull final ObjBiCharToDoubleFunction<? super T> function, T t, char value1,
            char value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiCharToDoubleFunction<T> onlySecond(@Nonnull final CharToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjBiCharToDoubleFunction<T> onlyThird(@Nonnull final CharToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjBiCharFunction<T, S> andThen(@Nonnull final DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiCharPredicate<T> andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiCharToByteFunction<T> andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiCharToCharFunction<T> andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiCharToFloatFunction<T> andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiCharToLongFunction<T> andThenToLong(@Nonnull final DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiCharToShortFunction<T> andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiCharConsumer<T> consume(@Nonnull final DoubleConsumer consumer) {
     ...
     * to use this {@code ObjBiCharToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
