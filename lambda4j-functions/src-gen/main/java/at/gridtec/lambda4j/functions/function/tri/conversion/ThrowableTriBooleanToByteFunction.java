...
public interface ThrowableTriBooleanToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriBooleanToByteFunction<X> of(
            @Nonnull final ThrowableTriBooleanToByteFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriBooleanToByteFunction} that applies this function to its input and nests the thrown
