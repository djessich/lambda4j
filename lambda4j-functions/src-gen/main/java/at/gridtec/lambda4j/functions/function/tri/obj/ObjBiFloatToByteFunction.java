...
public interface ObjBiFloatToByteFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiFloatToByteFunction<T> of(@Nonnull final ObjBiFloatToByteFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiFloatToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
