...
public interface BiByteToIntFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiByteToIntFunction of(@Nonnull final BiByteToIntFunction expression) {
        return expression;
    }
     ...
     * {@code BiByteToIntFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
