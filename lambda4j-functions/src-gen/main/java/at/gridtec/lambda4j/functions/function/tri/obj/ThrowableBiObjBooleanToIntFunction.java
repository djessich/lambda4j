...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjBooleanToIntFunction;
...
public interface ThrowableBiObjBooleanToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToIntFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjBooleanToIntFunction<T, U, X> expression) {
        return expression;
    }
