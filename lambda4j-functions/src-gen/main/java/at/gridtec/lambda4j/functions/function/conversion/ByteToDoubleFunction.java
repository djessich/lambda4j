...
public interface ByteToDoubleFunction extends Lambda {
     ...
     */
    @Nonnull
    static ByteToDoubleFunction of(@Nonnull final ByteToDoubleFunction expression) {
        return expression;
    }
     ...
     * {@code ByteToDoubleFunction} with JDK specific methods, only accepting {@code Function}.
     *
