...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjIntFunction;
...
public interface ThrowableObjIntPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntPredicate<T, X> of(
            @Nonnull final ThrowableObjIntPredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull final ThrowableObjIntPredicate<? super T, ? extends X> predicate, T t, int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<T, X> and(@Nonnull final ThrowableObjIntPredicate<? super T, ? extends X> other) {
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<T, X> or(@Nonnull final ThrowableObjIntPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value) -> testThrows(t, value) || other.testThrows(t, value);
    }
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<T, X> xor(@Nonnull final ThrowableObjIntPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value) -> testThrows(t, value) ^ other.testThrows(t, value);
    }
     ...
     *
     * @return A composed {@code ObjIntPredicate} that applies this predicate to its input and nests the thrown {@code
