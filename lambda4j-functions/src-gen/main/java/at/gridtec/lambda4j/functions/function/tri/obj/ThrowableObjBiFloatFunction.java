...
public interface ThrowableObjBiFloatFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiFloatFunction<T, R, X> of(
            @Nonnull final ThrowableObjBiFloatFunction<T, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiFloatFunction} that applies this function to its input and nests the thrown {@code
