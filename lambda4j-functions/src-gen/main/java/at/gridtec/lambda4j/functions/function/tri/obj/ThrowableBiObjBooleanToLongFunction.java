 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, boolean)
...
public interface ThrowableBiObjBooleanToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToLongFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjBooleanToLongFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjBooleanToLongFunction} that applies this function to its input and nests the
