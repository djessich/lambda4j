...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableBiObjDoublePredicate;
 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, double)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjDoubleToLongFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoubleToLongFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjDoubleToLongFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToLongFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjDoubleToLongFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjDoubleToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjDoubleToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> long call(
            @Nonnull final ThrowableBiObjDoubleToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToLongFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToLongFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToLongFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToLongFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToLongFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToLongFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToLongFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableDoubleToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToLongFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjDoubleToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToLongFunction<T, U, X> constant(long ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(T t, U u, double value) throws X;
     ...
     */
    default long applyAsLongThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToLongFunction<Pair<T, U>, X> tupled() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjDoubleToLongFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjDoubleToLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleToLongFunction<T, U, X> memoized() {
        if (this instanceof Memoized) {
            return this;
        } else {
            final Map<Triple<T, U, Double>, Long> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjDoubleToLongFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjDoubleToLongFunction}.
     * Thereby the primitive input argument for this function is autoboxed.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjDoubleToLongFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Double, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link BiObjDoubleToLongFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}. The throwable is
     * nested (wrapped) in a {@link ThrownByFunctionalInterfaceException}, which is constructed from the thrown
     * throwables message and the thrown throwable itself.
     *
     * @return A composed {@code BiObjDoubleToLongFunction} that applies this function to its input and nests the thrown
    ...
    /**
     * Returns a composed {@link BiObjDoubleToLongFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjDoubleToLongFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default BiObjDoubleToLongFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return this.applyAsLongThrows(t, u, value);
            } catch (RuntimeException | Error e) {
