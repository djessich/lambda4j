...
public interface ThrowableObjBiFloatToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatToFloatFunction<T, X> of(
            @Nonnull final ThrowableObjBiFloatToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull final ThrowableObjBiFloatToFloatFunction<? super T, ? extends X> function, T t, float value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjBiFloatToFloatFunction} that applies this function to its input and nests the thrown
