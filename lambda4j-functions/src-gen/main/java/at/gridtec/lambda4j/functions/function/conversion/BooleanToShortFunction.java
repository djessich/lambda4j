...
public interface BooleanToShortFunction extends Lambda {
     ...
     */
    @Nonnull
    static BooleanToShortFunction of(@Nonnull final BooleanToShortFunction expression) {
        return expression;
    }
     ...
     * {@code BooleanToShortFunction} with JDK specific methods, only accepting {@code Function}.
     *
