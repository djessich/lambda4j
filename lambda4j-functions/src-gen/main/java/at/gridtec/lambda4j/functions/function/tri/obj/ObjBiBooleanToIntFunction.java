...
public interface ObjBiBooleanToIntFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToIntFunction<T> of(@Nonnull final ObjBiBooleanToIntFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> int call(@Nonnull final ObjBiBooleanToIntFunction<? super T> function, T t, boolean value1,
            boolean value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToIntFunction<T> onlySecond(@Nonnull final BooleanToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToIntFunction<T> onlyThird(@Nonnull final BooleanToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjBiBooleanPredicate<T> andThenToBoolean(@Nonnull final IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToByteFunction<T> andThenToByte(@Nonnull final IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToCharFunction<T> andThenToChar(@Nonnull final IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToDoubleFunction<T> andThenToDouble(@Nonnull final IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToFloatFunction<T> andThenToFloat(@Nonnull final IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToShortFunction<T> andThenToShort(@Nonnull final IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code ObjBiBooleanToIntFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
