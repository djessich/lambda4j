...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjCharFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjCharToByteFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjCharToCharFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjCharToDoubleFunction;
...
public interface ObjCharPredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjCharPredicate<T> of(@Nonnull final ObjCharPredicate<T> expression) {
        return expression;
    }
