 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, boolean) specialization of {@link
 * ThrowableBiFunction}.
 * <p>
...
public interface ThrowableObjBooleanFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBooleanFunction<T, R, X> of(
            @Nonnull final ThrowableObjBooleanFunction<T, R, X> expression) {
        return expression;
    }
