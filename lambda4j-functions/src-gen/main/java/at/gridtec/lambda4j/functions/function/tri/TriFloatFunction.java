...
public interface TriFloatFunction<R> extends Lambda {
     ...
     */
    @Nonnull
    static <R> TriFloatFunction<R> of(@Nonnull final TriFloatFunction<R> expression) {
        return expression;
    }
     ...
     * {@code TriFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
