...
public interface ThrowableObjBiCharToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToLongFunction<T, X> of(
            @Nonnull final ThrowableObjBiCharToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjBiCharToLongFunction<? super T, ? extends X> function, T t, char value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjBiCharToLongFunction} that applies this function to its input and nests the thrown
