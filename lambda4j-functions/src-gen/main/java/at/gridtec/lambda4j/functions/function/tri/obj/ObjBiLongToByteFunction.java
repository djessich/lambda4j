 ...
 * {@code byte}-valued result. This is a (reference, long, long) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByte(Object, long, long)}.
 *
...
@FunctionalInterface
public interface ObjBiLongToByteFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiLongToByteFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjBiLongToByteFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjBiLongToByteFunction<T> of(@Nonnull final ObjBiLongToByteFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiLongToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiLongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> byte call(@Nonnull final ObjBiLongToByteFunction<? super T> function, T t, long value1, long value2) {
        Objects.requireNonNull(function);
        return function.applyAsByte(t, value1, value2);
    }

    /**
     * Creates a {@link ObjBiLongToByteFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiLongToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiLongToByteFunction<T> onlyFirst(@Nonnull final ToByteFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsByte(t);
    }

    /**
     * Creates a {@link ObjBiLongToByteFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link LongToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiLongToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code LongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiLongToByteFunction<T> onlySecond(@Nonnull final LongToByteFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsByte(value1);
    }

    /**
     * Creates a {@link ObjBiLongToByteFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link LongToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiLongToByteFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code LongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiLongToByteFunction<T> onlyThird(@Nonnull final LongToByteFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsByte(value2);
    }

    /**
     * Creates a {@link ObjBiLongToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiLongToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiLongToByteFunction<T> constant(byte ret) {
     ...
     */
    byte applyAsByte(T t, long value1, long value2);
    ...
    default <A, B, C> ToByteTriFunction<A, B, C> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsByte(before1.apply(a), before2.applyAsLong(b), before3.applyAsLong(c));
    }
    ...
    default TriBooleanToByteFunction composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsByte(before1.apply(value1), before2.applyAsLong(value2),
     ...
     */
    @Nonnull
    default <S> ObjBiLongFunction<T, S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiLongPredicate<T> andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToByteFunction<T> andThenToByte(@Nonnull final ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToCharFunction<T> andThenToChar(@Nonnull final ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToDoubleFunction<T> andThenToDouble(@Nonnull final ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToFloatFunction<T> andThenToFloat(@Nonnull final ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToIntFunction<T> andThenToInt(@Nonnull final ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToLongFunction<T> andThenToLong(@Nonnull final ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToShortFunction<T> andThenToShort(@Nonnull final ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongConsumer<T> consume(@Nonnull final ByteConsumer consumer) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiLongToByteFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjBiLongToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiLongToByteFunction}.
     */
    @Nonnull
    default TriFunction<T, Long, Long, Byte> boxed() {
