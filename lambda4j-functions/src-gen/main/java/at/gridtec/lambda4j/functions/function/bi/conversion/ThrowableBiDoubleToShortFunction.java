...
public interface ThrowableBiDoubleToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleToShortFunction<X> of(
            @Nonnull final ThrowableBiDoubleToShortFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiDoubleToShortFunction} that applies this function to its input and nests the thrown
