...
public interface ThrowableObjIntConsumer<T, X extends Throwable> extends Lambda, ObjIntConsumer<T> {
    ...
    static <T, X extends Throwable> ThrowableObjIntConsumer<T, X> of(
            @Nonnull final ThrowableObjIntConsumer<T, X> expression) {
        return expression;
    }
     ...
     * @implSpec Overrides the {@link ObjIntConsumer#accept(Object, int)} method by using a redefinition as default
     ...
     *
     * @return A composed {@code ObjIntConsumer2} that applies this consumer to its input and nests the thrown {@code
    ...
    /**
     * Returns a composed {@link ObjIntConsumer2} that applies this consumer to its input and sneakily throws the thrown
