...
public interface ThrowableBiObjFloatFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjFloatFunction<T, U, R, X> of(
            @Nonnull final ThrowableBiObjFloatFunction<T, U, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjFloatFunction} that applies this function to its input and nests the thrown {@code
