...
public interface CharTernaryOperator extends Lambda {
     ...
     */
    @Nonnull
    static CharTernaryOperator of(@Nonnull final CharTernaryOperator expression) {
        return expression;
    }
     ...
     * to use this {@code CharTernaryOperator} with JDK specific methods, only accepting {@code TernaryOperator}.
     *
