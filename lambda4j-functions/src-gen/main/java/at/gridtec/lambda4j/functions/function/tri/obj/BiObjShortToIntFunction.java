...
public interface BiObjShortToIntFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjShortToIntFunction<T, U> of(@Nonnull final BiObjShortToIntFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> int call(@Nonnull final BiObjShortToIntFunction<? super T, ? super U> function, T t, U u,
            short value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjShortToIntFunction<T, U> onlyThird(@Nonnull final ShortToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> BiObjShortFunction<T, U, S> andThen(@Nonnull final IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjShortToByteFunction<T, U> andThenToByte(@Nonnull final IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToCharFunction<T, U> andThenToChar(@Nonnull final IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToFloatFunction<T, U> andThenToFloat(@Nonnull final IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToLongFunction<T, U> andThenToLong(@Nonnull final IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToShortFunction<T, U> andThenToShort(@Nonnull final IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code BiObjShortToIntFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
