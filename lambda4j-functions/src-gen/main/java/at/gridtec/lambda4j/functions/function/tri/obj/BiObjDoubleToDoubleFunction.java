...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjDoubleToDoubleFunction;
...
public interface BiObjDoubleToDoubleFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToDoubleFunction<T, U> of(@Nonnull final BiObjDoubleToDoubleFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> double call(@Nonnull final BiObjDoubleToDoubleFunction<? super T, ? super U> function, T t, U u,
            double value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToDoubleFunction<T, U> onlySecond(@Nonnull final ToDoubleFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToByteFunction<T, U> andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToCharFunction<T, U> andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> andThenToDouble(@Nonnull final DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToFloatFunction<T, U> andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToIntFunction<T, U> andThenToInt(@Nonnull final DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToShortFunction<T, U> andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code BiObjDoubleToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
