...
public interface ThrowableBiLongPredicate<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiLongPredicate<X> of(@Nonnull final ThrowableBiLongPredicate<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiLongPredicate} that applies this predicate to its input and nests the thrown {@code
