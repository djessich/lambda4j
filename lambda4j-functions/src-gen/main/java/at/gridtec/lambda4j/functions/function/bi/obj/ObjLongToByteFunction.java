...
import at.gridtec.lambda4j.functions.consumer.bi.obj.ObjLongConsumer2;
...
import at.gridtec.lambda4j.functions.function.bi.conversion.BiBooleanToByteFunction;
...
import at.gridtec.lambda4j.functions.function.bi.conversion.BiIntToByteFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.BiLongToByteFunction;
import at.gridtec.lambda4j.functions.function.bi.conversion.BiShortToByteFunction;
import at.gridtec.lambda4j.functions.function.bi.to.ToByteBiFunction;
...
import at.gridtec.lambda4j.functions.predicate.bi.obj.ObjLongPredicate;
 ...
 * {@code byte}-valued result. This is a (reference, long) specialization of {@link BiFunction2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByte(Object, long)}.
 *
...
@FunctionalInterface
public interface ObjLongToByteFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjLongToByteFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ObjLongToByteFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjLongToByteFunction<T> of(@Nonnull final ObjLongToByteFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjLongToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function to be called
     * @param t The first argument to the function
     * @param value The second argument to the function
     * @return The result from the given {@code ObjLongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> byte call(@Nonnull final ObjLongToByteFunction<? super T> function, T t, long value) {
        Objects.requireNonNull(function);
        return function.applyAsByte(t, value);
    }

    /**
     * Creates a {@link ObjLongToByteFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjLongToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjLongToByteFunction<T> onlyFirst(@Nonnull final ToByteFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsByte(t);
    }

    /**
     * Creates a {@link ObjLongToByteFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link LongToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjLongToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code LongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjLongToByteFunction<T> onlySecond(@Nonnull final LongToByteFunction function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsByte(value);
    }

    /**
     * Creates a {@link ObjLongToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjLongToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjLongToByteFunction<T> constant(byte ret) {
        return (t, value) -> ret;
    }
     ...
     */
    byte applyAsByte(T t, long value);
    ...
    default <A, B> ToByteBiFunction<A, B> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b) -> applyAsByte(before1.apply(a), before2.applyAsLong(b));
    }
    ...
    default BiBooleanToByteFunction composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsByte(before1.apply(value1), before2.applyAsLong(value2));
    }
     ...
     */
    @Nonnull
    default <S> ObjLongFunction<T, S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjLongPredicate<T> andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<T> andThenToByte(@Nonnull final ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToCharFunction<T> andThenToChar(@Nonnull final ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToDoubleFunction<T> andThenToDouble(@Nonnull final ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToFloatFunction<T> andThenToFloat(@Nonnull final ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToIntFunction<T> andThenToInt(@Nonnull final ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToLongFunction<T> andThenToLong(@Nonnull final ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongToShortFunction<T> andThenToShort(@Nonnull final ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjLongConsumer2<T> consume(@Nonnull final ByteConsumer consumer) {
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjLongToByteFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjLongToByteFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjLongToByteFunction}.
     */
    @Nonnull
    default BiFunction<T, Long, Byte> boxed() {
