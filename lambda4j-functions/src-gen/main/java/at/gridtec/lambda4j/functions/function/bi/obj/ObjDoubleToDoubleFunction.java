...
public interface ObjDoubleToDoubleFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjDoubleToDoubleFunction<T> of(@Nonnull final ObjDoubleToDoubleFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjDoubleToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjDoubleToDoubleFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjDoubleToDoubleFunction}.
     */
    @Nonnull
