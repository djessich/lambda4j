...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjCharToCharFunction;
...
public interface ThrowableBiObjCharToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToCharFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjCharToCharFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjCharToCharFunction} that applies this function to its input and nests the thrown
