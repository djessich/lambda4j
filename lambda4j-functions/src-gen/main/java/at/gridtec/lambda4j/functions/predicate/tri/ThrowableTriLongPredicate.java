...
import at.gridtec.lambda4j.functions.function.tri.ThrowableTriLongFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriLongToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriLongToCharFunction;
...
import at.gridtec.lambda4j.functions.operator.ternary.ThrowableLongTernaryOperator;
...
public interface ThrowableTriLongPredicate<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriLongPredicate<X> of(
            @Nonnull final ThrowableTriLongPredicate<X> expression) {
        return expression;
    }
