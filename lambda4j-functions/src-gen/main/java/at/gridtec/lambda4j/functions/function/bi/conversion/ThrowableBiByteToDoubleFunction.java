...
import at.gridtec.lambda4j.functions.consumer.bi.ThrowableBiByteConsumer;
...
import at.gridtec.lambda4j.functions.function.bi.ThrowableBiByteFunction;
...
public interface ThrowableBiByteToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiByteToDoubleFunction<X> of(
            @Nonnull final ThrowableBiByteToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiByteToDoubleFunction} that applies this function to its input and nests the thrown
