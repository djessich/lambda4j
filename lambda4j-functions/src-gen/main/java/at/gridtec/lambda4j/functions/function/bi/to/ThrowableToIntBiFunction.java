...
public interface ThrowableToIntBiFunction<T, U, X extends Throwable> extends Lambda, ToIntBiFunction<T, U> {
    ...
    static <T, U, X extends Throwable> ThrowableToIntBiFunction<T, U, X> of(
            @Nonnull final ThrowableToIntBiFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> int call(
            @Nonnull final ThrowableToIntBiFunction<? super T, ? super U, ? extends X> function, T t, U u) throws X {
     ...
     * @implSpec Overrides the {@link ToIntBiFunction#applyAsInt(Object, Object)} method by using a redefinition as
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> andThenToBoolean(@Nonnull final ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
