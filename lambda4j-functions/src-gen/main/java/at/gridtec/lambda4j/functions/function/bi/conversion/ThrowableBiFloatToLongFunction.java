...
public interface ThrowableBiFloatToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToLongFunction<X> of(
            @Nonnull final ThrowableBiFloatToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiFloatToLongFunction} that applies this function to its input and nests the thrown
