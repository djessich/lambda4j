...
public interface ObjCharToByteFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjCharToByteFunction<T> of(@Nonnull final ObjCharToByteFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjCharToByteFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjCharToByteFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjCharToByteFunction}.
     */
    @Nonnull
    default BiFunction<T, Character, Byte> boxed() {
