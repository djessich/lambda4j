...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjIntToFloatFunction;
...
public interface BiObjIntToFloatFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjIntToFloatFunction<T, U> of(@Nonnull final BiObjIntToFloatFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjIntToFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
