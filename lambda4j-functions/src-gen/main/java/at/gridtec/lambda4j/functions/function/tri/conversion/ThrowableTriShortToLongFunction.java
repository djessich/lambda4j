...
public interface ThrowableTriShortToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriShortToLongFunction<X> of(
            @Nonnull final ThrowableTriShortToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriShortToLongFunction} that applies this function to its input and nests the thrown
