...
public interface BiDoubleToCharFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiDoubleToCharFunction of(@Nonnull final BiDoubleToCharFunction expression) {
        return expression;
    }
     ...
     * {@code BiDoubleToCharFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
