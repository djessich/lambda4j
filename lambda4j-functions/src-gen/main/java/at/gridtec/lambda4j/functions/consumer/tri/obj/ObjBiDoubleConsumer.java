...
public interface ObjBiDoubleConsumer<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiDoubleConsumer<T> of(@Nonnull final ObjBiDoubleConsumer<T> expression) {
        return expression;
    }
     ...
     * {@code ObjBiDoubleConsumer} with JDK specific methods, only accepting {@code TriConsumer}.
     *
