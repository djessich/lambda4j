...
import at.gridtec.lambda4j.functions.predicate.bi.obj.ObjShortPredicate;
 ...
 * {@code char}-valued result. This is a (reference, short) specialization of {@link BiFunction2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsChar(Object, short)}.
 *
...
@FunctionalInterface
public interface ObjShortToCharFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjShortToCharFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ObjShortToCharFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjShortToCharFunction<T> of(@Nonnull final ObjShortToCharFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjShortToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function to be called
     * @param t The first argument to the function
     * @param value The second argument to the function
     * @return The result from the given {@code ObjShortToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> char call(@Nonnull final ObjShortToCharFunction<? super T> function, T t, short value) {
        Objects.requireNonNull(function);
        return function.applyAsChar(t, value);
    }

    /**
     * Creates a {@link ObjShortToCharFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjShortToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjShortToCharFunction<T> onlyFirst(@Nonnull final ToCharFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsChar(t);
    }

    /**
     * Creates a {@link ObjShortToCharFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ShortToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjShortToCharFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ShortToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjShortToCharFunction<T> onlySecond(@Nonnull final ShortToCharFunction function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsChar(value);
    }

    /**
     * Creates a {@link ObjShortToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjShortToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjShortToCharFunction<T> constant(char ret) {
        return (t, value) -> ret;
    }
     ...
     */
    char applyAsChar(T t, short value);
    ...
    default <A, B> ToCharBiFunction<A, B> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b) -> applyAsChar(before1.apply(a), before2.applyAsShort(b));
    }
    ...
    default BiBooleanToCharFunction composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsChar(before1.apply(value1), before2.applyAsShort(value2));
    }
     ...
     */
    @Nonnull
    default <S> ObjShortFunction<T, S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjShortPredicate<T> andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToByteFunction<T> andThenToByte(@Nonnull final CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToCharFunction<T> andThenToChar(@Nonnull final CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> andThenToDouble(@Nonnull final CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToFloatFunction<T> andThenToFloat(@Nonnull final CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToIntFunction<T> andThenToInt(@Nonnull final CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToLongFunction<T> andThenToLong(@Nonnull final CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToShortFunction<T> andThenToShort(@Nonnull final CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortConsumer<T> consume(@Nonnull final CharConsumer consumer) {
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjShortToCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjShortToCharFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjShortToCharFunction}.
     */
    @Nonnull
    default BiFunction<T, Short, Character> boxed() {
