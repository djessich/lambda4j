 ...
 * ThrowableBiConsumer}. Unlike most other functional interfaces, {@code ThrowableObjFloatConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjFloatConsumer<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjFloatConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjFloatConsumer} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatConsumer<T, X> of(
            @Nonnull final ThrowableObjFloatConsumer<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjFloatConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <T, X extends Throwable> void call(@Nonnull final ThrowableObjFloatConsumer<? super T, ? extends X> consumer,
            T t, float value) throws X {
        Objects.requireNonNull(consumer);
        consumer.acceptThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjFloatConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjFloatConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjFloatConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableFloatConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjFloatConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjFloatConsumer<T, X> onlySecond(
    ...
    default <A, B> ThrowableBiConsumer<A, B, X> compose(
        ...
        return (a, b) -> acceptThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b));
    }
    ...
    default ThrowableBiBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> acceptThrows(before1.applyThrows(value1), before2.applyAsFloatThrows(value2));
    }
    ...
    /**
     * Returns a composed {@link ThrowableObjFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> andThen(
            @Nonnull final ThrowableObjFloatConsumer<? super T, ? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, Float, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjFloatConsumer} that applies this consumer to its input and nests the thrown {@link
     ...
     *
     * @return A composed {@code ObjFloatConsumer} that applies this consumer to its input and nests the thrown {@code
     * {@code Throwable} from it, unless it is of type {@code RuntimeException} or {@code Error}.
     */
    @Nonnull
    default ObjFloatConsumer<T> nest() {
        return (t, value) -> {
            try {
    ...
    /**
     * Returns a composed {@link ObjFloatConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjFloatConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     */
    @Nonnull
    default ObjFloatConsumer<T> sneakyThrow() {
        return (t, value) -> {
            try {
                this.acceptThrows(t, value);
            } catch (RuntimeException | Error e) {
