...
public interface ThrowableTriShortPredicate<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriShortPredicate<X> of(
            @Nonnull final ThrowableTriShortPredicate<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriShortPredicate} that applies this predicate to its input and nests the thrown {@code
