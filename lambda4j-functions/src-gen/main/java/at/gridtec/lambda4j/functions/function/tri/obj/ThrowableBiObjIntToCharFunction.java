...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjIntToCharFunction;
...
public interface ThrowableBiObjIntToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjIntToCharFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjIntToCharFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjIntToCharFunction} that applies this function to its input and nests the thrown
