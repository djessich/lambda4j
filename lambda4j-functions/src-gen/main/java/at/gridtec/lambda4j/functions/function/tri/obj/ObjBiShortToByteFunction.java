...
public interface ObjBiShortToByteFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiShortToByteFunction<T> of(@Nonnull final ObjBiShortToByteFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiShortToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
