...
public interface ThrowableBiIntToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiIntToShortFunction<X> of(
            @Nonnull final ThrowableBiIntToShortFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiIntToShortFunction} that applies this function to its input and nests the thrown
