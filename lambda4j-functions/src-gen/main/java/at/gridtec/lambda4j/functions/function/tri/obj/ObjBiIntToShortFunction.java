...
public interface ObjBiIntToShortFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiIntToShortFunction<T> of(@Nonnull final ObjBiIntToShortFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiIntToShortFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
