 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, byte, byte)
...
public interface ThrowableObjBiByteToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToCharFunction<T, X> of(
            @Nonnull final ThrowableObjBiByteToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiByteToCharFunction} that applies this function to its input and nests the thrown
