...
public interface ThrowableBiObjLongToFloatFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToFloatFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjLongToFloatFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjLongToFloatFunction} that applies this function to its input and nests the thrown
