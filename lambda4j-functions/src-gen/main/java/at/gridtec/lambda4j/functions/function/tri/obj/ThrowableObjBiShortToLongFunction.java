...
public interface ThrowableObjBiShortToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToLongFunction<T, X> of(
            @Nonnull final ThrowableObjBiShortToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiShortToLongFunction} that applies this function to its input and nests the thrown
