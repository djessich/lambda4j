...
public interface ThrowableObjBiShortFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiShortFunction<T, R, X> of(
            @Nonnull final ThrowableObjBiShortFunction<T, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiShortFunction} that applies this function to its input and nests the thrown {@code
