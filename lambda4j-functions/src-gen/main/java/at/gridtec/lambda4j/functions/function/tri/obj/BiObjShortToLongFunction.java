...
public interface BiObjShortToLongFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjShortToLongFunction<T, U> of(@Nonnull final BiObjShortToLongFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjShortToLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
