...
public interface BiObjFloatToCharFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatToCharFunction<T, U> of(@Nonnull final BiObjFloatToCharFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjFloatToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
