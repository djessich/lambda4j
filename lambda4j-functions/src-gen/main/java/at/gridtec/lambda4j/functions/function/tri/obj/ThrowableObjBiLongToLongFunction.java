...
import at.gridtec.lambda4j.functions.consumer.tri.obj.ThrowableObjBiLongConsumer;
...
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriBooleanToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriByteToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriCharToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriDoubleToLongFunction;
...
import at.gridtec.lambda4j.functions.function.tri.conversion.ThrowableTriShortToLongFunction;
...
import at.gridtec.lambda4j.functions.predicate.tri.obj.ThrowableObjBiLongPredicate;
 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, long, long)
...
public interface ThrowableObjBiLongToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToLongFunction<T, X> of(
            @Nonnull final ThrowableObjBiLongToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiLongToLongFunction} that applies this function to its input and nests the thrown
