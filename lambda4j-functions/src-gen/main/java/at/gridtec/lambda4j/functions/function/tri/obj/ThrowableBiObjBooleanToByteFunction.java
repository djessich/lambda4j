...
import at.gridtec.lambda4j.functions.function.bi.obj.ThrowableObjBooleanToByteFunction;
...
public interface ThrowableBiObjBooleanToByteFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToByteFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjBooleanToByteFunction<T, U, X> expression) {
        return expression;
    }
