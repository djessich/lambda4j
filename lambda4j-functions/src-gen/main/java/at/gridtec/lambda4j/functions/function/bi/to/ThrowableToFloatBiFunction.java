...
public interface ThrowableToFloatBiFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableToFloatBiFunction<T, U, X> of(
            @Nonnull final ThrowableToFloatBiFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ToFloatBiFunction} that applies this function to its input and nests the thrown {@code
