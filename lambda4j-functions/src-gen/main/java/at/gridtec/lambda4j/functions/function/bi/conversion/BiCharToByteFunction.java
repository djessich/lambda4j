...
public interface BiCharToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiCharToByteFunction of(@Nonnull final BiCharToByteFunction expression) {
        return expression;
    }
     ...
     * {@code BiCharToByteFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
