...
public interface ThrowableObjBiDoubleToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToFloatFunction<T, X> of(
            @Nonnull final ThrowableObjBiDoubleToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     * ThrowableObjBiDoubleToFloatFunction}. Thereby the primitive input argument for this function is autoboxed.
     *
     ...
     *
     * @return A composed {@code ObjBiDoubleToFloatFunction} that applies this function to its input and nests the
