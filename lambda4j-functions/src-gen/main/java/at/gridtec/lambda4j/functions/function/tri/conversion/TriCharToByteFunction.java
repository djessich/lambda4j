...
public interface TriCharToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriCharToByteFunction of(@Nonnull final TriCharToByteFunction expression) {
        return expression;
    }
     ...
     * {@code TriCharToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
