...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjLongToDoubleFunction;
...
public interface BiObjLongToDoubleFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToDoubleFunction<T, U> of(@Nonnull final BiObjLongToDoubleFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjLongToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
