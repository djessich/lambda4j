...
public interface ThrowableObjBiBooleanFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiBooleanFunction<T, R, X> of(
            @Nonnull final ThrowableObjBiBooleanFunction<T, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiBooleanFunction} that applies this function to its input and nests the thrown
