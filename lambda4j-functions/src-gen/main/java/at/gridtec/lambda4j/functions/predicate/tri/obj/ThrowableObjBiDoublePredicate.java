...
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleToByteFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleToCharFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleToDoubleFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleToFloatFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleToIntFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleToLongFunction;
import at.gridtec.lambda4j.functions.function.tri.obj.ThrowableObjBiDoubleToShortFunction;
...
public interface ThrowableObjBiDoublePredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoublePredicate<T, X> of(
            @Nonnull final ThrowableObjBiDoublePredicate<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiDoublePredicate} that applies this predicate to its input and nests the thrown
