...
public interface ObjFloatToByteFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjFloatToByteFunction<T> of(@Nonnull final ObjFloatToByteFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjFloatToByteFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjFloatToByteFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjFloatToByteFunction}.
     */
    @Nonnull
    default BiFunction<T, Float, Byte> boxed() {
