...
import at.gridtec.lambda4j.functions.function.bi.to.ThrowableToIntBiFunction;
...
import at.gridtec.lambda4j.functions.operator.binary.ThrowableIntBinaryOperator;
...
public interface ThrowableBiDoubleToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleToIntFunction<X> of(
            @Nonnull final ThrowableBiDoubleToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull final ThrowableBiDoubleToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoublePredicate<X> andThenToBoolean(@Nonnull final ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiDoubleConsumer<X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code BiDoubleToIntFunction} that applies this function to its input and nests the thrown
