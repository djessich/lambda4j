...
public interface LongToDoubleFunction2 extends Lambda, LongToDoubleFunction {
     ...
     */
    @Nonnull
    static LongToDoubleFunction2 of(@Nonnull final LongToDoubleFunction2 expression) {
        return expression;
    }
     ...
     */
    static double call(@Nonnull final LongToDoubleFunction function, long value) {
     ...
     */
    @Nonnull
    default <A> ToDoubleFunction2<A> compose(@Nonnull final ToLongFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToDoubleFunction composeFromBoolean(@Nonnull final BooleanToLongFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToDoubleFunction composeFromByte(@Nonnull final ByteToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default CharToDoubleFunction composeFromChar(@Nonnull final CharToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default DoubleUnaryOperator2 composeFromDouble(@Nonnull final DoubleToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default FloatToDoubleFunction composeFromFloat(@Nonnull final FloatToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default IntToDoubleFunction2 composeFromInt(@Nonnull final IntToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 composeFromLong(@Nonnull final LongUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default ShortToDoubleFunction composeFromShort(@Nonnull final ShortToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default <S> LongFunction2<S> andThen(@Nonnull final DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default LongPredicate2 andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToByteFunction andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToCharFunction andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 andThenToDouble(@Nonnull final DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToFloatFunction andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToIntFunction2 andThenToInt(@Nonnull final DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongUnaryOperator2 andThenToLong(@Nonnull final DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToShortFunction andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongConsumer2 consume(@Nonnull final DoubleConsumer consumer) {
    ...
    /**
     * Returns a composed {@link Function} which represents this {@link LongToDoubleFunction2}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code LongToDoubleFunction2} with JDK specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code LongToDoubleFunction2}.
     */
    @Nonnull
    default Function<Long, Double> boxed() {
