...
public interface ThrowableObjBiByteFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiByteFunction<T, R, X> of(
            @Nonnull final ThrowableObjBiByteFunction<T, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiByteFunction} that applies this function to its input and nests the thrown {@code
