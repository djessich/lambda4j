...
public interface ObjCharToLongFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjCharToLongFunction<T> of(@Nonnull final ObjCharToLongFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjCharToLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjCharToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjCharToLongFunction}.
     */
    @Nonnull
    default BiFunction<T, Character, Long> boxed() {
