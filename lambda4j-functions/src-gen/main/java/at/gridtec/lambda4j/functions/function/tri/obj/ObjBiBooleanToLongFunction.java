...
public interface ObjBiBooleanToLongFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToLongFunction<T> of(@Nonnull final ObjBiBooleanToLongFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> long call(@Nonnull final ObjBiBooleanToLongFunction<? super T> function, T t, boolean value1,
            boolean value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToLongFunction<T> onlySecond(@Nonnull final BooleanToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjBiBooleanToLongFunction<T> onlyThird(@Nonnull final BooleanToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjBiBooleanFunction<T, S> andThen(@Nonnull final LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiBooleanPredicate<T> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToByteFunction<T> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToCharFunction<T> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToFloatFunction<T> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToIntFunction<T> andThenToInt(@Nonnull final LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToLongFunction<T> andThenToLong(@Nonnull final LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiBooleanToShortFunction<T> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code ObjBiBooleanToLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
