...
public interface ThrowableObjDoubleToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToDoubleFunction<T, X> of(
            @Nonnull final ThrowableObjDoubleToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull final ThrowableObjDoubleToDoubleFunction<? super T, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjDoubleToDoubleFunction} that applies this function to its input and nests the thrown
