...
public interface ThrowableDoubleFunction<R, X extends Throwable> extends Lambda, DoubleFunction<R> {
    ...
    static <R, X extends Throwable> ThrowableDoubleFunction<R, X> of(
            @Nonnull final ThrowableDoubleFunction<R, X> expression) {
        return expression;
    }
     ...
     * @implSpec Overrides the {@link DoubleFunction#apply(double)} method by using a redefinition as default method.
