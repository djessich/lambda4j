...
public interface TriIntToLongFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriIntToLongFunction of(@Nonnull final TriIntToLongFunction expression) {
        return expression;
    }
     ...
     * {@code TriIntToLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
