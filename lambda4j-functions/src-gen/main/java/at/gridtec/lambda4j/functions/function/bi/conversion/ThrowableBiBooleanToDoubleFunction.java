...
public interface ThrowableBiBooleanToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiBooleanToDoubleFunction<X> of(
            @Nonnull final ThrowableBiBooleanToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiBooleanToDoubleFunction} that applies this function to its input and nests the thrown
