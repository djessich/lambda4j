...
import at.gridtec.lambda4j.functions.function.tri.conversion.TriShortToByteFunction;
...
@FunctionalInterface
public interface TriShortPredicate extends Lambda {

    /**
     * Constructs a {@link TriShortPredicate} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriShortPredicate} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static TriShortPredicate of(@Nonnull final TriShortPredicate expression) {
        return expression;
    }

    /**
     * Calls the given {@link TriShortPredicate} with the given arguments and returns its result.
     *
    ...
    /**
     * Creates a {@link TriShortPredicate} which uses the {@code first} parameter of this one as argument for the given
     * {@link ShortPredicate}.
     *
     * @param predicate The predicate which accepts the {@code first} parameter of this one
     * @return Creates a {@code TriShortPredicate} which uses the {@code first} parameter of this one as argument for
    ...
    /**
     * Creates a {@link TriShortPredicate} which uses the {@code second} parameter of this one as argument for the given
     * {@link ShortPredicate}.
     *
     * @param predicate The predicate which accepts the {@code second} parameter of this one
     * @return Creates a {@code TriShortPredicate} which uses the {@code second} parameter of this one as argument for
     * the given {@code ShortPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    ...
    /**
     * Creates a {@link TriShortPredicate} which uses the {@code third} parameter of this one as argument for the given
     * {@link ShortPredicate}.
     *
     * @param predicate The predicate which accepts the {@code third} parameter of this one
     * @return Creates a {@code TriShortPredicate} which uses the {@code third} parameter of this one as argument for
     * the given {@code ShortPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    ...
    /**
     * Creates a {@link TriShortPredicate} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code TriShortPredicate} which always returns a given value.
     */
    @Nonnull
    static TriShortPredicate constant(boolean ret) {
        return (value1, value2, value3) -> ret;
    }

    /**
     * Returns a {@link TriShortPredicate} that always returns {@code true}.
     *
     * @return A {@link TriShortPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static TriShortPredicate alwaysTrue() {
        return (value1, value2, value3) -> true;
    }

    /**
     * Returns a {@link TriShortPredicate} that always returns {@code false}.
     *
     * @return A {@link TriShortPredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static TriShortPredicate alwaysFalse() {
        return (value1, value2, value3) -> false;
    }

    /**
     * Returns a {@link TriShortPredicate} that tests if the given arguments are <b>equal</b> to the ones of this
     * predicate.
     *
     ...
     * @return A {@code TriShortPredicate} that tests if the given arguments are <b>equal</b> to the ones of this
     * predicate.
    ...
    default <A, B, C> TriPredicate<A, B, C> compose(@Nonnull final ToShortFunction<? super A> before1,
        ...
        return (a, b, c) -> test(before1.applyAsShort(a), before2.applyAsShort(b), before3.applyAsShort(c));
    }
     ...
     * @return A composed {@code TriShortFunction} that first applies this predicate to its input, and then applies the
    ...
    /**
     * Returns a composed {@link TriShortToByteFunction} that first applies this predicate to its input, and then
    ...
    /**
     * Returns a composed {@link TriShortToCharFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link TriShortToDoubleFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link TriShortToFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link TriShortToIntFunction} that first applies this predicate to its input, and then applies
    ...
    /**
     * Returns a composed {@link TriShortToLongFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link ShortTernaryOperator} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to transform this
    ...
    /**
     * Returns a composed {@link TriShortConsumer} that fist applies this predicate to its input, and then consumes the
     ...
     * @return A composed {@code TriShortConsumer} that first applies this predicate to its input, and then consumes the
    ...
    /**
     * Returns a {@link TriShortPredicate} that represents the logical negation of this one.
     *
     * @return A {@code TriShortPredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default TriShortPredicate negate() {
        return (value1, value2, value3) -> !test(value1, value2, value3);
    }

    /**
     * Returns a composed {@link TriShortPredicate} that represents a short-circuiting logical AND of this predicate and
     * another. When evaluating the composed predicate, if this predicate is {@code false}, then the {@code other}
     * predicate is not evaluated.
     * <p>
     * Any exceptions thrown during evaluation of either predicate is relayed to the caller; if evaluation of this
     * {@code TriShortPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code TriShortPredicate} that will be logically-ANDed with this one
     * @return A composed {@code TriShortPredicate} that represents the short-circuiting logical AND of this predicate
    ...
    /**
     * Returns a composed {@link TriShortPredicate} that represents a short-circuiting logical OR of this predicate and
     ...
     * {@code TriShortPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code TriShortPredicate} that will be logically-ORed with this one
     * @return A composed {@code TriShortPredicate} that represents the short-circuiting logical OR of this predicate
     * and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(TriShortPredicate)
     * @see #xor(TriShortPredicate)
     */
    @Nonnull
    ...
    /**
     * Returns a composed {@link TriShortPredicate} that represents a short-circuiting logical XOR of this predicate and
     * another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if evaluation of
     * this {@code TriShortPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code TriShortPredicate} that will be logically-XORed with this one
     * @return A composed {@code TriShortPredicate} that represents the short-circuiting logical XOR of this predicate
     * and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(TriShortPredicate)
     * @see #or(TriShortPredicate)
    ...
    /**
     * Returns a memoized (caching) version of this {@link TriShortPredicate}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code TriShortPredicate}.
     ...
     * this {@code TriShortPredicate} with JDK specific methods, only accepting {@code TriPredicate}.
     *
