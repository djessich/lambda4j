...
public interface ThrowableObjBiDoubleFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> of(
            @Nonnull final ThrowableObjBiDoubleFunction<T, R, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiDoubleFunction} that applies this function to its input and nests the thrown
