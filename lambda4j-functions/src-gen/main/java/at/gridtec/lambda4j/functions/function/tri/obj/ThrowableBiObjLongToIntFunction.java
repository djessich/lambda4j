...
public interface ThrowableBiObjLongToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToIntFunction<T, U, X> of(
            @Nonnull final ThrowableBiObjLongToIntFunction<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiObjLongToIntFunction} that applies this function to its input and nests the thrown
