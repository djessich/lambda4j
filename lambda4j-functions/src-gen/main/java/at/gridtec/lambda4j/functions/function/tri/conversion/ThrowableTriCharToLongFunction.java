...
import at.gridtec.lambda4j.functions.function.tri.ThrowableTriCharFunction;
import at.gridtec.lambda4j.functions.function.tri.ThrowableTriFunction;
import at.gridtec.lambda4j.functions.function.tri.to.ThrowableToLongTriFunction;
...
public interface ThrowableTriCharToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriCharToLongFunction<X> of(
            @Nonnull final ThrowableTriCharToLongFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriCharToLongFunction} that applies this function to its input and nests the thrown
