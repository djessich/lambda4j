...
public interface ThrowableObjBiBooleanToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiBooleanToByteFunction<T, X> of(
            @Nonnull final ThrowableObjBiBooleanToByteFunction<T, X> expression) {
        return expression;
    }
     ...
     * ThrowableObjBiBooleanToByteFunction}. Thereby the primitive input argument for this function is autoboxed.
     *
