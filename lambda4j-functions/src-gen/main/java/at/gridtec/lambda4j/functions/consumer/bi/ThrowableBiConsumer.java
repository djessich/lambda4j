...
public interface ThrowableBiConsumer<T, U, X extends Throwable> extends Lambda, BiConsumer<T, U> {
    ...
    static <T, U, X extends Throwable> ThrowableBiConsumer<T, U, X> of(
            @Nonnull final ThrowableBiConsumer<T, U, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code BiConsumer2} that applies this consumer to its input and nests the thrown {@code {@code
