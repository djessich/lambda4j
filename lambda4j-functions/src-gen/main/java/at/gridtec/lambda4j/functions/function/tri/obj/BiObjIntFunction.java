...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjIntFunction;
...
public interface BiObjIntFunction<T, U, R> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjIntFunction<T, U, R> of(@Nonnull final BiObjIntFunction<T, U, R> expression) {
        return expression;
    }
