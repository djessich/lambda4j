...
import at.gridtec.lambda4j.functions.consumer.LongConsumer2;
import at.gridtec.lambda4j.functions.consumer.ShortConsumer;
import at.gridtec.lambda4j.functions.function.Function2;
import at.gridtec.lambda4j.functions.function.LongFunction2;
...
import at.gridtec.lambda4j.functions.predicate.LongPredicate2;
...
/**
 * Represents an operation that accepts one {@code long}-valued input argument and produces a {@code short}-valued
 * result. This is a primitive specialization of {@link Function2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShort(long)}.
 *
 * @see Function2
 */
@SuppressWarnings("unused")
@FunctionalInterface
public interface LongToShortFunction extends Lambda {

    /**
     * Constructs a {@link LongToShortFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code LongToShortFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static LongToShortFunction of(@Nonnull final LongToShortFunction expression) {
        return expression;
    }

    /**
     * Calls the given {@link LongToShortFunction} with the given argument and returns its result.
     *
     ...
     */
    static short call(@Nonnull final LongToShortFunction function, long value) {
        Objects.requireNonNull(function);
        return function.applyAsShort(value);
    }

    /**
     * Creates a {@link LongToShortFunction} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code LongToShortFunction} which always returns a given value.
     */
    @Nonnull
    static LongToShortFunction constant(short ret) {
        return (value) -> ret;
    }
     ...
     */
    @Nonnull
    default <A> ToShortFunction<A> compose(@Nonnull final ToLongFunction<? super A> before) {
        Objects.requireNonNull(before);
        return (a) -> applyAsShort(before.applyAsLong(a));
    }
     ...
     */
    @Nonnull
    default BooleanToShortFunction composeFromBoolean(@Nonnull final BooleanToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default ByteToShortFunction composeFromByte(@Nonnull final ByteToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default CharToShortFunction composeFromChar(@Nonnull final CharToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default DoubleToShortFunction composeFromDouble(@Nonnull final DoubleToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default FloatToShortFunction composeFromFloat(@Nonnull final FloatToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default IntToShortFunction composeFromInt(@Nonnull final IntToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }

    /**
     * Returns a composed {@link LongToShortFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     * operation which accepts {@code long} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code LongToShortFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to handle primitive values. In this case this is {@code
     * long}.
     */
    @Nonnull
    default LongToShortFunction composeFromLong(@Nonnull final LongUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default ShortUnaryOperator composeFromShort(@Nonnull final ShortToLongFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShort(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default <S> LongFunction2<S> andThen(@Nonnull final ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default LongPredicate2 andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToByteFunction andThenToByte(@Nonnull final ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToCharFunction andThenToChar(@Nonnull final ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 andThenToDouble(@Nonnull final ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToFloatFunction andThenToFloat(@Nonnull final ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToIntFunction2 andThenToInt(@Nonnull final ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongUnaryOperator2 andThenToLong(@Nonnull final ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToShortFunction andThenToShort(@Nonnull final ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongConsumer2 consume(@Nonnull final ShortConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.accept(applyAsShort(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link LongToShortFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code LongToShortFunction}.
    ...
    /**
     * Returns a composed {@link Function} which represents this {@link LongToShortFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code LongToShortFunction} with JDK specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code LongToShortFunction}.
     */
    @Nonnull
    default Function<Long, Short> boxed() {
