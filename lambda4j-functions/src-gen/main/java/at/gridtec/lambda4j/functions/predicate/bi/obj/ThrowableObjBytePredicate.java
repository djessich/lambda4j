...
public interface ThrowableObjBytePredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBytePredicate<T, X> of(
            @Nonnull final ThrowableObjBytePredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull final ThrowableObjBytePredicate<? super T, ? extends X> predicate, T t, byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBytePredicate<T, X> and(
            @Nonnull final ThrowableObjBytePredicate<? super T, ? extends X> other) {
     ...
     */
    @Nonnull
    default ThrowableObjBytePredicate<T, X> or(@Nonnull final ThrowableObjBytePredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value) -> testThrows(t, value) || other.testThrows(t, value);
    }
     ...
     *
     * @return A composed {@code ObjBytePredicate} that applies this predicate to its input and nests the thrown {@code
