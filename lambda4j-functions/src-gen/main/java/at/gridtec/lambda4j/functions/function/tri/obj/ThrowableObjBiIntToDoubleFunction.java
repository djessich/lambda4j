...
public interface ThrowableObjBiIntToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToDoubleFunction<T, X> of(
            @Nonnull final ThrowableObjBiIntToDoubleFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiIntToDoubleFunction} that applies this function to its input and nests the thrown
