...
import at.gridtec.lambda4j.functions.predicate.bi.obj.ObjDoublePredicate;
 ...
 * {@code long}-valued result. This is a (reference, double) specialization of {@link BiFunction2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLong(Object, double)}.
 *
...
@FunctionalInterface
public interface ObjDoubleToLongFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjDoubleToLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjDoubleToLongFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T> ObjDoubleToLongFunction<T> of(@Nonnull final ObjDoubleToLongFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjDoubleToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function to be called
     * @param t The first argument to the function
     * @param value The second argument to the function
     * @return The result from the given {@code ObjDoubleToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> long call(@Nonnull final ObjDoubleToLongFunction<? super T> function, T t, double value) {
    ...
    /**
     * Creates a {@link ObjDoubleToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjDoubleToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjDoubleToLongFunction<T> constant(long ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ToLongBiFunction2<A, B> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b) -> applyAsLong(before1.apply(a), before2.applyAsDouble(b));
    }
     ...
     */
    @Nonnull
    default ObjDoublePredicate<T> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjDoubleToByteFunction<T> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjDoubleToCharFunction<T> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjDoubleToDoubleFunction<T> andThenToDouble(@Nonnull final LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjDoubleToFloatFunction<T> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjDoubleToIntFunction<T> andThenToInt(@Nonnull final LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjDoubleToShortFunction<T> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjDoubleToLongFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjDoubleToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjDoubleToLongFunction}.
     */
    @Nonnull
    default BiFunction<T, Double, Long> boxed() {
