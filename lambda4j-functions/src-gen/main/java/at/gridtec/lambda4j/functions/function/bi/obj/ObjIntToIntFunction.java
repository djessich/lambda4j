...
public interface ObjIntToIntFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjIntToIntFunction<T> of(@Nonnull final ObjIntToIntFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjIntToIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjIntToIntFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjIntToIntFunction}.
     */
    @Nonnull
