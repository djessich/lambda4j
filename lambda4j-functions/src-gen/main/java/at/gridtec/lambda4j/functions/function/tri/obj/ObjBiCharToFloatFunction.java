...
public interface ObjBiCharToFloatFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiCharToFloatFunction<T> of(@Nonnull final ObjBiCharToFloatFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiCharToFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
