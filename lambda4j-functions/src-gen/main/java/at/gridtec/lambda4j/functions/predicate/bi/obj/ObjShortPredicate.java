...
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortToByteFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortToCharFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortToDoubleFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortToFloatFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortToIntFunction;
import at.gridtec.lambda4j.functions.function.bi.obj.ObjShortToLongFunction;
...
public interface ObjShortPredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjShortPredicate<T> of(@Nonnull final ObjShortPredicate<T> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <S> ObjShortFunction<T, S> andThen(@Nonnull final BooleanFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjShortPredicate<T> andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToByteFunction<T> andThenToByte(@Nonnull final BooleanToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToCharFunction<T> andThenToChar(@Nonnull final BooleanToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> andThenToDouble(@Nonnull final BooleanToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToFloatFunction<T> andThenToFloat(@Nonnull final BooleanToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToIntFunction<T> andThenToInt(@Nonnull final BooleanToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToLongFunction<T> andThenToLong(@Nonnull final BooleanToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortToShortFunction<T> andThenToShort(@Nonnull final BooleanToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjShortConsumer<T> consume(@Nonnull final BooleanConsumer consumer) {
     ...
     * this {@code ObjShortPredicate} with JDK specific methods, only accepting {@code BiPredicate}.
     *
