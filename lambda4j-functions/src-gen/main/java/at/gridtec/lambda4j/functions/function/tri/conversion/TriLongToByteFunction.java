...
public interface TriLongToByteFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriLongToByteFunction of(@Nonnull final TriLongToByteFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToByteTriFunction<A, B, C> compose(@Nonnull final ToLongFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToByteFunction composeFromBoolean(@Nonnull final BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default ByteTernaryOperator composeFromByte(@Nonnull final ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default TriCharToByteFunction composeFromChar(@Nonnull final CharToLongFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction composeFromDouble(@Nonnull final DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToByteFunction composeFromFloat(@Nonnull final FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default TriIntToByteFunction composeFromInt(@Nonnull final IntToLongFunction before1,
     ...
     */
    @Nonnull
    default TriShortToByteFunction composeFromShort(@Nonnull final ShortToLongFunction before1,
     ...
     */
    @Nonnull
    default <S> TriLongFunction<S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriLongPredicate andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongConsumer consume(@Nonnull final ByteConsumer consumer) {
     ...
     * {@code TriLongToByteFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
