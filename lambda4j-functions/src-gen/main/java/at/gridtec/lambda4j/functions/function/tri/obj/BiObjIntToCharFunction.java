...
public interface BiObjIntToCharFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjIntToCharFunction<T, U> of(@Nonnull final BiObjIntToCharFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjIntToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
