 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, int) specialization
...
public interface ThrowableObjIntToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntToDoubleFunction<T, X> of(
            @Nonnull final ThrowableObjIntToDoubleFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjIntToDoubleFunction} that applies this function to its input and nests the thrown
