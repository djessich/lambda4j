 ...
 * result. This is a (reference, reference, double) specialization of {@link TriConsumer}. Unlike most other functional
 * interfaces, {@code BiObjDoubleConsumer} is expected to operate via side-effects.
 * <p>
...
@FunctionalInterface
public interface BiObjDoubleConsumer<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjDoubleConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjDoubleConsumer} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleConsumer<T, U> of(@Nonnull final BiObjDoubleConsumer<T, U> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiObjDoubleConsumer} that performs, in sequence, this consumer followed by the {@code
     ...
     * @return A composed {@link BiObjDoubleConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
     ...
     */
    @Nonnull
    default ObjDoubleConsumer2<Pair<T, U>> tupled() {
        return this::accept;
    }
     ...
     * {@code BiObjDoubleConsumer} with JDK specific methods, only accepting {@code TriConsumer}.
     *
