...
public interface BiObjBooleanToCharFunction<T, U> extends Lambda {
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToCharFunction<T, U> of(@Nonnull final BiObjBooleanToCharFunction<T, U> expression) {
        return expression;
    }
     ...
     * to use this {@code BiObjBooleanToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
