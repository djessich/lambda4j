...
public interface ThrowableLongConsumer extends LongConsumer {
     ...
     * ThrowableLongConsumer} is added as suppressed to the given one, unless it is an unchecked exception.
     * <p>
     ...
     * @throws NullPointerException If the given argument is {@code null}
     */
    default <X extends Exception> ThrowableLongConsumer orThrowAlways(Class<X> clazz) {
        Objects.requireNonNull(clazz);
        return value -> {
            try {
                acceptThrows(value);
