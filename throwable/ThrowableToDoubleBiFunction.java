...
public interface ThrowableToDoubleBiFunction<T, U> extends ToDoubleBiFunction<T, U> {
     ...
     * ThrowableToDoubleBiFunction} is ignored, unless it is an unchecked exception.
     *
     ...
     * ThrowableToDoubleBiFunction} is added as suppressed to the given one, unless it is an unchecked exception.
     * <p>
     ...
     * @throws NullPointerException If the given argument is {@code null}
     */
    default <X extends Exception> ThrowableToDoubleBiFunction<T, U> orThrowAlways(Class<X> clazz) {
        Objects.requireNonNull(clazz);
        return (t, u) -> {
            try {
     ...
     * exception from this {@code ThrowableToDoubleBiFunction} is ignored, unless it is an unchecked exception.
     *
     ...
     * from this {@code ThrowableToDoubleBiFunction} is ignored, unless it is an unchecked exception.
     *
     ...
     * error occurred, returns the given value.
     */
    default ToDoubleBiFunction<T, U> orReturnAlways(double value) {
        return (t, u) -> {
            try {
                return applyAsDoubleThrows(t, u);
            } catch (Exception ignored) {
     ...
     * @throws NullPointerException If the given argument is {@code null}
     */
    default ToDoubleBiFunction<T, U> orReturnAlways(final DoubleSupplier supplier) {
        Objects.requireNonNull(supplier);
        return (t, u) -> {
            try {
                return applyAsDoubleThrows(t, u);
