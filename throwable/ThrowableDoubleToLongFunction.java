...
public interface ThrowableDoubleToLongFunction extends DoubleToLongFunction {
     ...
     * ThrowableDoubleToLongFunction} is ignored, unless it is an unchecked exception.
     *
     ...
     * ThrowableDoubleToLongFunction} is added as suppressed to the given one, unless it is an unchecked exception.
     * <p>
     ...
     * @throws NullPointerException If the given argument is {@code null}
     */
    default <X extends Exception> ThrowableDoubleToLongFunction orThrowAlways(Class<X> clazz) {
        Objects.requireNonNull(clazz);
        return value -> {
            try {
                return applyAsLongThrows(value);
     ...
     * exception from this {@code ThrowableDoubleToLongFunction} is ignored, unless it is an unchecked exception.
     *
     ...
     * from this {@code ThrowableDoubleToLongFunction} is ignored, unless it is an unchecked exception.
     *
     ...
     * an error occurred, returns the given value.
     */
    default DoubleToLongFunction orReturnAlways(long retVal) {
        return value -> {
            try {
                return applyAsLongThrows(value);
            } catch (Exception ignored) {
     ...
     * @throws NullPointerException If the given argument is {@code null}
     */
    default DoubleToLongFunction orReturnAlways(final LongSupplier supplier) {
        Objects.requireNonNull(supplier);
        return value -> {
            try {
                return applyAsLongThrows(value);
