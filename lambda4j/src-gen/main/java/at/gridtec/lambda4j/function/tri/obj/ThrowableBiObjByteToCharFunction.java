...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjByteToCharFunction;
...
public interface ThrowableBiObjByteToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToCharFunction<T, U, X> of(
            @Nullable final ThrowableBiObjByteToCharFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> char call(
            @Nonnull final ThrowableBiObjByteToCharFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjByteToCharFunction<U, X> papplyAsCharThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToCharFunction<X> papplyAsCharThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToCharBiFunction<T, U, X> papplyAsCharThrows(byte value) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<U, X> papplyAsCharThrows(T t, byte value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjByteToCharFunction<T, U> nestWith(
    ...
    default BiObjByteToCharFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjByteToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjByteToCharFunction<? super T, ? super U> function = recover.apply(throwable);
