...
public interface TriIntToByteFunction extends Lambda {
     ...
     */
    static TriIntToByteFunction of(@Nullable final TriIntToByteFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiIntToByteFunction papplyAsByte(int value1) {
     ...
     */
    @Nonnull
    default IntToByteFunction papplyAsByte(int value1, int value2) {
     ...
     * {@code TriIntToByteFunction} with methods provided by the {@code JDK}.
     *
