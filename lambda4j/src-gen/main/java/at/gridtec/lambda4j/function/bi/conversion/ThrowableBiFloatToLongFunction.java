...
public interface ThrowableBiFloatToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToLongFunction<X> of(
            @Nullable final ThrowableBiFloatToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableBiFloatToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiFloatPredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiFloatToLongFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiFloatToLongFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiFloatToLongFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiFloatToLongFunction function = recover.apply(throwable);
