...
public interface ToCharBiFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> ToCharBiFunction<T, U> of(@Nullable final ToCharBiFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <S> BiFunction2<T, U, S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiPredicate2<T, U> andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToDoubleBiFunction2<T, U> andThenToDouble(@Nonnull final CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> andThenToInt(@Nonnull final CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToLongBiFunction2<T, U> andThenToLong(@Nonnull final CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> consume(@Nonnull final CharConsumer consumer) {
     ...
     * {@code ToCharBiFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
