...
public interface ThrowableTriBooleanToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriBooleanToIntFunction<X> of(
            @Nullable final ThrowableTriBooleanToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull final ThrowableTriBooleanToIntFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableTriByteToIntFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriByteToIntFunction<X> composeFromByte(@Nonnull final ThrowableBytePredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriCharToIntFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriCharToIntFunction<X> composeFromChar(@Nonnull final ThrowableCharPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableIntTernaryOperator} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableIntTernaryOperator<X> composeFromInt(@Nonnull final ThrowableIntPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToIntFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriLongToIntFunction<X> composeFromLong(@Nonnull final ThrowableLongPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriBooleanConsumer<X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriBooleanToIntFunction nestWith(
    ...
    default TriBooleanToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriBooleanToIntFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriBooleanToIntFunction function = recover.apply(throwable);
