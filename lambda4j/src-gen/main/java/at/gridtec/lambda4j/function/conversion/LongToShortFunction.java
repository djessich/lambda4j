...
public interface LongToShortFunction extends Lambda {
    ...
    /**
     * Returns a composed {@link ByteToShortFunction} that first applies the {@code before} function to
    ...
    /**
     * Returns a composed {@link LongToShortFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
