...
public interface TriShortToDoubleFunction extends Lambda {
     ...
     */
    static TriShortToDoubleFunction of(@Nullable final TriShortToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToDoubleTriFunction<A, B, C> compose(@Nonnull final ToShortFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToDoubleFunction composeFromBoolean(@Nonnull final BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default TriByteToDoubleFunction composeFromByte(@Nonnull final ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default TriCharToDoubleFunction composeFromChar(@Nonnull final CharToShortFunction before1,
     ...
     */
    @Nonnull
    default DoubleTernaryOperator composeFromDouble(@Nonnull final DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction composeFromFloat(@Nonnull final FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default TriIntToDoubleFunction composeFromInt(@Nonnull final IntToShortFunction before1,
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction composeFromLong(@Nonnull final LongToShortFunction before1,
     ...
     */
    @Nonnull
    default TriShortToDoubleFunction composeFromShort(@Nonnull final ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriShortConsumer consume(@Nonnull final DoubleConsumer consumer) {
     ...
     * to use this {@code TriShortToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
