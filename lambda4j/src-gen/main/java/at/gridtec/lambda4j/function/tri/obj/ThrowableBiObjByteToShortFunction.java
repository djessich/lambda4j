...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjByteToShortFunction;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(Object, Object, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjByteToShortFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjByteToShortFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjByteToShortFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjByteToShortFunction<T, U, X> of(
            @Nullable final ThrowableBiObjByteToShortFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjByteToShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjByteToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> short call(
            @Nonnull final ThrowableBiObjByteToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToShortFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjByteToShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToShortFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjByteToShortFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToShortFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToShortFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjByteToShortFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableByteToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToShortFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjByteToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToShortFunction<T, U, X> constant(short ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(T t, U u, byte value) throws X;
     ...
     */
    default short applyAsShortThrows(@Nonnull Pair<T, U> tuple, byte value) throws X {
     ...
     * ThrowableObjByteToShortFunction} as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableObjByteToShortFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjByteToShortFunction<U, X> papplyAsShortThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToShortFunction<X> papplyAsShortThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToShortBiFunction<T, U, X> papplyAsShortThrows(byte value) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<U, X> papplyAsShortThrows(T t, byte value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjByteToShortFunction<Pair<T, U>, X> tupled() {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjByteToShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjByteToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjByteToShortFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Byte, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link BiObjByteToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjByteToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjByteToShortFunction<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjByteToShortFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjByteToShortFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjByteToShortFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjByteToShortFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjByteToShortFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjByteToShortFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjByteToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjByteToShortFunction<? super T, ? super U> function = recover.apply(throwable);
