...
public interface BiBooleanToIntFunction extends Lambda {
     ...
     */
    static BiBooleanToIntFunction of(@Nullable final BiBooleanToIntFunction expression) {
        return expression;
    }
     ...
     */
    static int call(@Nonnull final BiBooleanToIntFunction function, boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    static BiBooleanToIntFunction onlyFirst(@Nonnull final BooleanToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiBooleanToIntFunction onlySecond(@Nonnull final BooleanToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiBooleanToIntFunction composeFromBoolean(@Nonnull final BooleanUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link BiByteToIntFunction} that first applies the {@code before} predicates to
     ...
     */
    @Nonnull
    default BiByteToIntFunction composeFromByte(@Nonnull final BytePredicate before1,
    ...
    /**
     * Returns a composed {@link BiCharToIntFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default BiCharToIntFunction composeFromChar(@Nonnull final CharPredicate before1,
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction composeFromDouble(@Nonnull final DoublePredicate before1,
     ...
     */
    @Nonnull
    default BiFloatToIntFunction composeFromFloat(@Nonnull final FloatPredicate before1,
    ...
    /**
     * Returns a composed {@link BiLongToIntFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default BiLongToIntFunction composeFromLong(@Nonnull final LongPredicate before1,
     ...
     */
    @Nonnull
    default BiShortToIntFunction composeFromShort(@Nonnull final ShortPredicate before1,
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link BiBooleanToIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code BiBooleanToIntFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code BiBooleanToIntFunction}.
     */
    @Nonnull
    default BiFunction<Boolean, Boolean, Integer> boxed() {
