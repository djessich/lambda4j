...
public interface ThrowableBiLongToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiLongToIntFunction<X> of(
            @Nullable final ThrowableBiLongToIntFunction<X> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiLongToIntFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default BiLongToIntFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiLongToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiLongToIntFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiLongToIntFunction function = recover.apply(throwable);
