...
public interface ThrowableTriDoubleToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToIntFunction<X> of(
            @Nonnull final ThrowableTriDoubleToIntFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriDoubleToIntFunction} that applies this function to its input and nests the thrown
