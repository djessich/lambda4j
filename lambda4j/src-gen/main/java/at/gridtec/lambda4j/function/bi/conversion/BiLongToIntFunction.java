...
public interface BiLongToIntFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiLongToIntFunction of(@Nonnull final BiLongToIntFunction expression) {
        return expression;
    }
     ...
     * {@code BiLongToIntFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
