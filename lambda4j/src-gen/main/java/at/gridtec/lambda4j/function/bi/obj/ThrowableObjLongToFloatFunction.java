...
public interface ThrowableObjLongToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToFloatFunction<T, X> of(
            @Nullable final ThrowableObjLongToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjLongToFloatFunction<T> nestWith(
    ...
    default ObjLongToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjLongToFloatFunction<? super T> function = recover.apply(throwable);
