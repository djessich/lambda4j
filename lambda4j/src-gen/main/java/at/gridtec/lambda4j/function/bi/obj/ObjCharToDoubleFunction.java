...
public interface ObjCharToDoubleFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjCharToDoubleFunction<T> of(@Nonnull final ObjCharToDoubleFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjCharToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method is just convenience to provide the ability
     * to use this {@code ObjCharToDoubleFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjCharToDoubleFunction}.
     */
    @Nonnull
    default BiFunction<T, Character, Double> boxed() {
