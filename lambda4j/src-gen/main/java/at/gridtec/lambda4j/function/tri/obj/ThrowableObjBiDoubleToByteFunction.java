...
public interface ThrowableObjBiDoubleToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToByteFunction<T, X> of(
            @Nullable final ThrowableObjBiDoubleToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull final ThrowableObjBiDoubleToByteFunction<? super T, ? extends X> function, T t, double value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiDoubleToByteFunction<T> nestWith(
    ...
    default ObjBiDoubleToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiDoubleToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiDoubleToByteFunction<? super T> function = recover.apply(throwable);
