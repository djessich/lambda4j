...
public interface ThrowableObjBiLongToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToByteFunction<T, X> of(
            @Nullable final ThrowableObjBiLongToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull final ThrowableObjBiLongToByteFunction<? super T, ? extends X> function, T t, long value1,
     ...
     */
    @Nonnull
    default ThrowableBiLongToByteFunction<X> papplyAsByteThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToByteFunction<X> papplyAsByteThrows(T t, long value1) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToByteFunction<T, X> papplyAsByteThrows(long value1) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> papplyAsByteThrows(long value1, long value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiLongToByteFunction<T> nestWith(
    ...
    default ObjBiLongToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiLongToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiLongToByteFunction<? super T> function = recover.apply(throwable);
