 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, char, char)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiCharFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiCharFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiCharFunction} from given lambda expression or method reference.
     ...
     */
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, R, X> of(
            @Nullable final ThrowableObjBiCharFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjBiCharFunction} into a total {@link ThrowableObjBiCharFunction} that returns
     ...
     * @return A partial {@code ThrowableObjBiCharFunction} lifted into a total {@code ThrowableObjBiCharFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjBiCharFunction<? super T, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, value1, value2) -> Optional.ofNullable(partial.applyThrows(t, value1, value2));
    }

    /**
     * Calls the given {@link ThrowableObjBiCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjBiCharFunction<? super T, ? extends R, ? extends X> function, T t, char value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiCharFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiCharFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiCharFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return Creates a {@code ThrowableObjBiCharFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, R, X> onlyThird(
            @Nonnull final ThrowableCharFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, char value1, char value2) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableBiCharFunction} as
     * result.
     *
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyAsCharThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyThrows(value1), before2.applyAsCharThrows(value2),
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(
    ...
    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjBiCharFunction<T, R, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, Character, Character>, R> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjBiCharFunction<T, R, X> & Memoized) (t, value1, value2) -> {
                final R returnValue;
                synchronized (lock) {
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjBiCharFunction<T, Optional<R>, X> nonNull() {
        return (t, value1, value2) -> Optional.ofNullable(applyThrows(t, value1, value2));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiCharFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjBiCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiCharFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Character, Character, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjBiCharFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiCharFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjBiCharFunction<T, R> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiCharFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiCharFunction<T, R> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiCharFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiCharFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharFunction<? super T, ? extends R> function = recover.apply(throwable);
