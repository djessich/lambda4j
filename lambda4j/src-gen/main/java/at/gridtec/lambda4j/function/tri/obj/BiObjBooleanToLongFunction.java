...
import at.gridtec.lambda4j.function.bi.obj.ObjBooleanToLongFunction;
...
public interface BiObjBooleanToLongFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjBooleanToLongFunction<T, U> of(@Nullable final BiObjBooleanToLongFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> long call(@Nonnull final BiObjBooleanToLongFunction<? super T, ? super U> function, T t, U u,
            boolean value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjBooleanToLongFunction<T, U> onlyThird(@Nonnull final BooleanToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjBooleanToLongFunction<U> papplyAsLong(T t) {
     ...
     */
    @Nonnull
    default BooleanToLongFunction papplyAsLong(T t, U u) {
     ...
     */
    @Nonnull
    default ToLongBiFunction2<T, U> papplyAsLong(boolean value) {
     ...
     */
    @Nonnull
    default ToLongFunction2<U> papplyAsLong(T t, boolean value) {
     ...
     */
    @Nonnull
    default BiObjBooleanPredicate<T, U> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToByteFunction<T, U> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToCharFunction<T, U> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToDoubleFunction<T, U> andThenToDouble(@Nonnull final LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToFloatFunction<T, U> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToIntFunction<T, U> andThenToInt(@Nonnull final LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToLongFunction<T, U> andThenToLong(@Nonnull final LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjBooleanToShortFunction<T, U> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
