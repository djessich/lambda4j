...
public interface BiDoubleToLongFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiDoubleToLongFunction of(@Nonnull final BiDoubleToLongFunction expression) {
        return expression;
    }
     ...
     * {@code BiDoubleToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
