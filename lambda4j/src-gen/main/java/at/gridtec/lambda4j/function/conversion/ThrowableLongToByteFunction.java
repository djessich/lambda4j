...
public interface ThrowableLongToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableLongToByteFunction<X> of(
            @Nullable final ThrowableLongToByteFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> byte call(@Nonnull final ThrowableLongToByteFunction<? extends X> function,
            long value) throws X {
    ...
    /**
     * Returns a composed {@link ThrowableLongToByteFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableLongPredicate<X> andThenToBoolean(@Nonnull final ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongToByteFunction<X> andThenToByte(@Nonnull final ThrowableByteUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> andThenToInt(@Nonnull final ThrowableByteToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongUnaryOperator<X> andThenToLong(@Nonnull final ThrowableByteToLongFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code LongToByteFunction} that applies this function to its input and nests the thrown {@code
    ...
    default LongToByteFunction recover(
            @Nonnull final Function<? super Throwable, ? extends LongToByteFunction> recover) {
        Objects.requireNonNull(recover);
        return (value) -> {
            try {
                return this.applyAsByteThrows(value);
            } catch (Throwable throwable) {
                final LongToByteFunction function = recover.apply(throwable);
