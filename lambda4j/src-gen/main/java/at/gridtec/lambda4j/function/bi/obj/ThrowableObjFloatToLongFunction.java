...
public interface ThrowableObjFloatToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToLongFunction<T, X> of(
            @Nullable final ThrowableObjFloatToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableFloatToLongFunction<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(float value) {
     ...
     */
    @Nonnull
    default ObjFloatToLongFunction<T> nestWith(
    ...
    default ObjFloatToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjFloatToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjFloatToLongFunction<? super T> function = recover.apply(throwable);
