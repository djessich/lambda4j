...
public interface ThrowableBiObjCharToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToShortFunction<T, U, X> of(
            @Nullable final ThrowableBiObjCharToShortFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> short call(
            @Nonnull final ThrowableBiObjCharToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjCharToShortFunction<T, U> nestWith(
    ...
    default BiObjCharToShortFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjCharToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjCharToShortFunction<? super T, ? super U> function = recover.apply(throwable);
