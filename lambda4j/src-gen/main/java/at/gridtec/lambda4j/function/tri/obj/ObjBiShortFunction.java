...
public interface ObjBiShortFunction<T, R> extends Lambda {
     ...
     */
    static <T, R> ObjBiShortFunction<T, R> of(@Nullable final ObjBiShortFunction<T, R> expression) {
        return expression;
    }
    ...
    static <T, R> ObjBiShortFunction<T, Optional<R>> lift(
            @Nonnull final ObjBiShortFunction<? super T, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, R> R call(@Nonnull final ObjBiShortFunction<? super T, ? extends R> function, T t, short value1,
            short value2) {
     ...
     */
    @Nonnull
    static <T, R> ObjBiShortFunction<T, R> onlyFirst(@Nonnull final Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjBiShortFunction<T, R> onlySecond(@Nonnull final ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjBiShortFunction<T, R> onlyThird(@Nonnull final ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjBiShortFunction<T, S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
    ...
    @Deprecated
    @Nonnull
    default ObjBiShortFunction<T, Optional<R>> nonNull() {
     ...
     * {@code ObjBiShortFunction} with methods provided by the {@code JDK}.
     *
