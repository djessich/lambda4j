...
public interface ObjBiDoubleToIntFunction<T> extends Lambda {
     ...
     */
    static <T> ObjBiDoubleToIntFunction<T> of(@Nullable final ObjBiDoubleToIntFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> int call(@Nonnull final ObjBiDoubleToIntFunction<? super T> function, T t, double value1,
            double value2) {
     ...
     */
    @Nonnull
    default <S> ObjBiDoubleFunction<T, S> andThen(@Nonnull final IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiDoublePredicate<T> andThenToBoolean(@Nonnull final IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToByteFunction<T> andThenToByte(@Nonnull final IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToCharFunction<T> andThenToChar(@Nonnull final IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToFloatFunction<T> andThenToFloat(@Nonnull final IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToShortFunction<T> andThenToShort(@Nonnull final IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code ObjBiDoubleToIntFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
