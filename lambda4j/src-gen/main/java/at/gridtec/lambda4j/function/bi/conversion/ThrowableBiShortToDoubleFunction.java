...
public interface ThrowableBiShortToDoubleFunction<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default BiShortToDoubleFunction nestWith(
    ...
    default BiShortToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiShortToDoubleFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiShortToDoubleFunction function = recover.apply(throwable);
