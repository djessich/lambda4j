...
public interface ThrowableTriLongToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriLongToDoubleFunction<X> of(
            @Nullable final ThrowableTriLongToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction nestWith(
    ...
    default TriLongToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriLongToDoubleFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriLongToDoubleFunction function = recover.apply(throwable);
