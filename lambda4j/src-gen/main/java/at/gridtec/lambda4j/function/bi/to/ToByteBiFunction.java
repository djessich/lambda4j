...
public interface ToByteBiFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> ToByteBiFunction<T, U> of(@Nullable final ToByteBiFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <S> BiFunction2<T, U, S> andThen(@Nonnull final ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiPredicate2<T, U> andThenToBoolean(@Nonnull final BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToDoubleBiFunction2<T, U> andThenToDouble(@Nonnull final ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> andThenToInt(@Nonnull final ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToLongBiFunction2<T, U> andThenToLong(@Nonnull final ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> consume(@Nonnull final ByteConsumer consumer) {
