...
public interface ThrowableBiShortFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableBiShortFunction<R, X> of(
            @Nullable final ThrowableBiShortFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableBiShortFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableBiShortFunction<? extends R, ? extends X> partial) {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableBiShortFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiIntFunction<R, X> composeFromInt(@Nonnull final ThrowableIntToShortFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiShortConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    @Deprecated
    @Nonnull
    default ThrowableBiShortFunction<Optional<R>, X> nonNull() {
     ...
     */
    @Nonnull
    default BiShortFunction<R> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiShortFunction} that applies this function to its input and sneakily throws the
    ...
    default BiShortFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiShortFunction<? extends R>> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiShortFunction<? extends R> function = recover.apply(throwable);
