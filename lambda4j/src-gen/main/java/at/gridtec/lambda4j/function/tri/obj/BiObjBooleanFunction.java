...
public interface BiObjBooleanFunction<T, U, R> extends Lambda {
     ...
     */
    static <T, U, R> BiObjBooleanFunction<T, U, R> of(@Nullable final BiObjBooleanFunction<T, U, R> expression) {
        return expression;
    }
    ...
    static <T, U, R> BiObjBooleanFunction<T, U, Optional<R>> lift(
            @Nonnull final BiObjBooleanFunction<? super T, ? super U, ? extends R> partial) {
    ...
    @Deprecated
    @Nonnull
    default BiObjBooleanFunction<T, U, Optional<R>> nonNull() {
     ...
     * {@code BiObjBooleanFunction} with methods provided by the {@code JDK}.
     *
