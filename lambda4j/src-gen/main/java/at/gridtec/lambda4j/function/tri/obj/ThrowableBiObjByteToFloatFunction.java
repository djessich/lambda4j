...
public interface ThrowableBiObjByteToFloatFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToFloatFunction<T, U, X> of(
            @Nullable final ThrowableBiObjByteToFloatFunction<T, U, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiObjByteToFloatFunction<T, U> nestWith(
    ...
    default BiObjByteToFloatFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjByteToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjByteToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
