...
public interface ThrowableObjLongToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToIntFunction<T, X> of(
            @Nullable final ThrowableObjLongToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> papplyAsIntThrows(long value) {
     ...
     */
    @Nonnull
    default ObjLongToIntFunction<T> nestWith(
    ...
    default ObjLongToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjLongToIntFunction<? super T> function = recover.apply(throwable);
