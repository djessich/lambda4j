...
public interface ObjCharFunction<T, R> extends Lambda {
     ...
     */
    static <T, R> ObjCharFunction<T, R> of(@Nullable final ObjCharFunction<T, R> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <T, R> ObjCharFunction<T, Optional<R>> lift(@Nonnull final ObjCharFunction<? super T, ? extends R> partial) {
     ...
     */
    @Nonnull
    default <S> ObjCharFunction<T, S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link ObjCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ObjCharFunction} with methods provided by the {@code JDK}.
     *
