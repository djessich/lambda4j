...
import at.gridtec.lambda4j.consumer.tri.obj.ThrowableBiObjShortConsumer;
...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjShortToIntFunction;
...
import at.gridtec.lambda4j.predicate.tri.obj.ThrowableBiObjShortPredicate;
 ...
 * This is a (reference, reference, short) specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(Object, Object, short)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjShortToIntFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjShortToIntFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjShortToIntFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjShortToIntFunction<T, U, X> of(
            @Nullable final ThrowableBiObjShortToIntFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjShortToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjShortToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> int call(
            @Nonnull final ThrowableBiObjShortToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToIntFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjShortToIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToIntFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToIntFunction} which uses the {@code second} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjShortToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToIntFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToIntFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjShortToIntFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableShortToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToIntFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjShortToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToIntFunction<T, U, X> constant(int ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    int applyAsIntThrows(T t, U u, short value) throws X;
     ...
     */
    default int applyAsIntThrows(@Nonnull Pair<T, U> tuple, short value) throws X {
        Objects.requireNonNull(tuple);
        return applyAsIntThrows(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableObjShortToIntFunction}
     * as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableObjShortToIntFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjShortToIntFunction<U, X> papplyAsIntThrows(T t) {
        return (u, value) -> this.applyAsIntThrows(t, u, value);
    }
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> papplyAsIntThrows(T t, U u) {
        return (value) -> this.applyAsIntThrows(t, u, value);
    }
     ...
     */
    @Nonnull
    default ThrowableToIntBiFunction<T, U, X> papplyAsIntThrows(short value) {
        return (t, u) -> this.applyAsIntThrows(t, u, value);
    }
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<U, X> papplyAsIntThrows(T t, short value) {
        return (u) -> this.applyAsIntThrows(t, u, value);
    }
     ...
     */
    @Nonnull
    default ThrowableBiObjShortConsumer<T, U, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjShortToIntFunction<Pair<T, U>, X> tupled() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjShortToIntFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjShortToIntFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjShortToIntFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Short>, Integer> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjShortToIntFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjShortToIntFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjShortToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjShortToIntFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Short, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link BiObjShortToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjShortToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjShortToIntFunction<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjShortToIntFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjShortToIntFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjShortToIntFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjShortToIntFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjShortToIntFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjShortToIntFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjShortToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjShortToIntFunction<? super T, ? super U> function = recover.apply(throwable);
