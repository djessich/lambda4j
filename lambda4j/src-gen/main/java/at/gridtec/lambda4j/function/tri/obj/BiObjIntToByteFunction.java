...
import at.gridtec.lambda4j.predicate.tri.obj.BiObjIntPredicate;
...
public interface BiObjIntToByteFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjIntToByteFunction<T, U> of(@Nullable final BiObjIntToByteFunction<T, U> expression) {
        return expression;
    }
