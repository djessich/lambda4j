...
public interface ThrowableObjFloatToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToIntFunction<T, X> of(
            @Nullable final ThrowableObjFloatToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> papplyAsIntThrows(float value) {
     ...
     */
    @Nonnull
    default ObjFloatToIntFunction<T> nestWith(
    ...
    default ObjFloatToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjFloatToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjFloatToIntFunction<? super T> function = recover.apply(throwable);
