...
public interface ThrowableBiFloatToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToCharFunction<X> of(
            @Nullable final ThrowableBiFloatToCharFunction<X> expression) {
        return expression;
    }
    ...
    default BiFloatToCharFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiFloatToCharFunction> recover) {
        Objects.requireNonNull(recover);
        return (value1, value2) -> {
            try {
                return this.applyAsCharThrows(value1, value2);
            } catch (Throwable throwable) {
                final BiFloatToCharFunction function = recover.apply(throwable);
