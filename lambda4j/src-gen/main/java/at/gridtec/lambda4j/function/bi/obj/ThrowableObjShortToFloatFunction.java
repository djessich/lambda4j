...
public interface ThrowableObjShortToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToFloatFunction<T, X> of(
            @Nullable final ThrowableObjShortToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@link ObjShortToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjShortToFloatFunction<T> nestWith(
     ...
     * @return A composed {@link ObjShortToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjShortToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjShortToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjShortToFloatFunction<? super T> function = recover.apply(throwable);
