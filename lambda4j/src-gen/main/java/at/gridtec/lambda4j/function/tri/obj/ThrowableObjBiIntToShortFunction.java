...
public interface ThrowableObjBiIntToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToShortFunction<T, X> of(
            @Nullable final ThrowableObjBiIntToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull final ThrowableObjBiIntToShortFunction<? super T, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiIntToShortFunction<X> papplyAsShortThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntToShortFunction<X> papplyAsShortThrows(T t, int value1) {
     ...
     */
    @Nonnull
    default ThrowableObjIntToShortFunction<T, X> papplyAsShortThrows(int value1) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> papplyAsShortThrows(int value1, int value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiIntToShortFunction<T> nestWith(
    ...
    default ObjBiIntToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiIntToShortFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiIntToShortFunction<? super T> function = recover.apply(throwable);
