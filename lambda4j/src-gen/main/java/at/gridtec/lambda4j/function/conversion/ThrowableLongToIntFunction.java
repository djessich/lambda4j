 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(long)}.
 *
...
@FunctionalInterface
public interface ThrowableLongToIntFunction<X extends Throwable> extends Lambda, LongToIntFunction {

    /**
     * Constructs a {@link ThrowableLongToIntFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableLongToIntFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableLongToIntFunction<X> of(
            @Nullable final ThrowableLongToIntFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableLongToIntFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> int call(@Nonnull final ThrowableLongToIntFunction<? extends X> function,
            long value) throws X {
     ...
     * @return A {@code ThrowableLongToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableLongToIntFunction<X> constant(int ret) {
        return (value) -> ret;
    }
     ...
     * @param value The argument to the function
     * @return The return value from the function, which is its result.
     * @apiNote This method mainly exists to use this {@link ThrowableLongToIntFunction} in JRE specific methods only
     * accepting {@link LongToIntFunction}. If this function should be applied, then the {@link #applyAsIntThrows(long)}
     * method should be used.
     * @apiNote Overrides the {@link LongToIntFunction#applyAsInt(long)} method by using a redefinition as default
     * method. This implementation calls the {@link #applyAsIntThrows(long)} method of this function and catches the
    ...
    default <A> ThrowableToIntFunction<A, X> compose(
        ...
        return (a) -> applyAsIntThrows(before.applyAsLongThrows(a));
    }
    ...
    default ThrowableBooleanToIntFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsIntThrows(before.applyAsLongThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableIntUnaryOperator} that first applies the {@code before} function to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> composeFromInt(@Nonnull final ThrowableIntToLongFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsIntThrows(before.applyAsLongThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableLongToIntFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * This method is just convenience, to provide the ability to execute an operation which accepts {@code long} input,
     * before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableLongToIntFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * long}.
     ...
     */
    @Nonnull
    default ThrowableLongPredicate<X> andThenToBoolean(@Nonnull final ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongToByteFunction<X> andThenToByte(@Nonnull final ThrowableIntToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongToCharFunction<X> andThenToChar(@Nonnull final ThrowableIntToCharFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> andThenToInt(@Nonnull final ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongUnaryOperator<X> andThenToLong(@Nonnull final ThrowableIntToLongFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsIntThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableLongToIntFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableLongToIntFunction}.
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Long, Integer> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableLongToIntFunction<X> & Memoized) (value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableLongToIntFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableLongToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableLongToIntFunction}.
     */
    @Nonnull
    default ThrowableFunction<Long, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link LongToIntFunction2} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link LongToIntFunction2} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default LongToIntFunction2 nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link LongToIntFunction2} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link LongToIntFunction2} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default LongToIntFunction2 sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsIntThrows(value);
            } catch (RuntimeException | Error e) {
     ...
     * @return A composed {@link LongToIntFunction2} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default LongToIntFunction2 recover(
            @Nonnull final Function<? super Throwable, ? extends LongToIntFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final LongToIntFunction function = recover.apply(throwable);
