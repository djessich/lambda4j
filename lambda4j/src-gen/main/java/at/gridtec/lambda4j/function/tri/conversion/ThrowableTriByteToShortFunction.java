...
public interface ThrowableTriByteToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriByteToShortFunction<X> of(
            @Nullable final ThrowableTriByteToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableTriByteToShortFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableTriByteToShortFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriBytePredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriByteToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriByteToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriByteToShortFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriByteToShortFunction function = recover.apply(throwable);
