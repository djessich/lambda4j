...
public interface ThrowableObjDoubleToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToIntFunction<T, X> of(
            @Nullable final ThrowableObjDoubleToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     * this {@code ThrowableObjDoubleToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjDoubleToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjDoubleToIntFunction<T> nestWith(
     ...
     * @return A composed {@link ObjDoubleToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjDoubleToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjDoubleToIntFunction<? super T> function = recover.apply(throwable);
