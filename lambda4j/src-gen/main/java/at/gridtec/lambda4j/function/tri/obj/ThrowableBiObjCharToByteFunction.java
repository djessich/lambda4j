...
public interface ThrowableBiObjCharToByteFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToByteFunction<T, U, X> of(
            @Nullable final ThrowableBiObjCharToByteFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableBiObjCharToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharToByteFunction<U, X> papplyAsByteThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToByteFunction<X> papplyAsByteThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToByteBiFunction<T, U, X> papplyAsByteThrows(char value) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<U, X> papplyAsByteThrows(T t, char value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjCharToByteFunction<T, U> nestWith(
    ...
    default BiObjCharToByteFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjCharToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjCharToByteFunction<? super T, ? super U> function = recover.apply(throwable);
