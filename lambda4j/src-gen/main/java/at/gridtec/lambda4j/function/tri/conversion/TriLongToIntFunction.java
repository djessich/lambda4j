...
public interface TriLongToIntFunction extends Lambda {
     ...
     */
    static TriLongToIntFunction of(@Nullable final TriLongToIntFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull final ToLongFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToIntFunction composeFromBoolean(@Nonnull final BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default TriByteToIntFunction composeFromByte(@Nonnull final ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default TriCharToIntFunction composeFromChar(@Nonnull final CharToLongFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction composeFromDouble(@Nonnull final DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToIntFunction composeFromFloat(@Nonnull final FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default IntTernaryOperator composeFromInt(@Nonnull final IntToLongFunction before1,
     ...
     */
    @Nonnull
    default TriShortToIntFunction composeFromShort(@Nonnull final ShortToLongFunction before1,
     ...
     * {@code TriLongToIntFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
