...
public interface ByteToCharFunction extends Lambda {
     ...
     */
    static ByteToCharFunction of(@Nullable final ByteToCharFunction expression) {
        return expression;
    }
     ...
     */
    static char call(@Nonnull final ByteToCharFunction function, byte value) {
     ...
     */
    @Nonnull
    default <A> ToCharFunction<A> compose(@Nonnull final ToByteFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToCharFunction composeFromBoolean(@Nonnull final BooleanToByteFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToCharFunction composeFromByte(@Nonnull final ByteUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default CharUnaryOperator composeFromChar(@Nonnull final CharToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default DoubleToCharFunction composeFromDouble(@Nonnull final DoubleToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default FloatToCharFunction composeFromFloat(@Nonnull final FloatToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default IntToCharFunction composeFromInt(@Nonnull final IntToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default LongToCharFunction composeFromLong(@Nonnull final LongToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default ShortToCharFunction composeFromShort(@Nonnull final ShortToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default <S> ByteFunction<S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BytePredicate andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteConsumer consume(@Nonnull final CharConsumer consumer) {
    ...
    /**
     * Returns a composed {@link Function} which represents this {@link ByteToCharFunction}. Thereby the primitive input
     * argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ByteToCharFunction} with JDK specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code ByteToCharFunction}.
     */
    @Nonnull
    default Function<Byte, Character> boxed() {
