...
public interface ThrowableObjBiCharToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToDoubleFunction<T, X> of(
            @Nonnull final ThrowableObjBiCharToDoubleFunction<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiCharToDoubleFunction} that applies this function to its input and nests the thrown
