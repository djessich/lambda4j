...
public interface ThrowableObjBiLongToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToCharFunction<T, X> of(
            @Nullable final ThrowableObjBiLongToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableBiLongToCharFunction<X> papplyAsCharThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToCharFunction<X> papplyAsCharThrows(T t, long value1) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToCharFunction<T, X> papplyAsCharThrows(long value1) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> papplyAsCharThrows(long value1, long value2) {
     ...
     */
    @Nonnull
    default ObjBiLongToCharFunction<T> nestWith(
    ...
    default ObjBiLongToCharFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiLongToCharFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiLongToCharFunction<? super T> function = recover.apply(throwable);
