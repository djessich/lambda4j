 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableObjCharToByteFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjCharToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjCharToByteFunction} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjCharToByteFunction<T, X> of(
            @Nullable final ThrowableObjCharToByteFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjCharToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjCharToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> byte call(
            @Nonnull final ThrowableObjCharToByteFunction<? super T, ? extends X> function, T t, char value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsByteThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjCharToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjCharToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjCharToByteFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjCharToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableCharToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjCharToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableCharToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjCharToByteFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjCharToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjCharToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjCharToByteFunction<T, X> constant(byte ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ThrowableToByteBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsByteThrows(before1.applyThrows(a), before2.applyAsCharThrows(b));
    }
    ...
    default ThrowableBiBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsByteThrows(before1.applyThrows(value1), before2.applyAsCharThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<T, X> andThenToBoolean(@Nonnull final ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsByteThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjCharToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjCharToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjCharToByteFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Pair<T, Character>, Byte> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjCharToByteFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjCharToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjCharToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjCharToByteFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Character, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ObjCharToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjCharToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjCharToByteFunction<T> nestWith(
    ...
    /**
     * Returns a composed {@link ObjCharToByteFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjCharToByteFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjCharToByteFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
     ...
     * @return A composed {@link ObjCharToByteFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjCharToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjCharToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjCharToByteFunction<? super T> function = recover.apply(throwable);
