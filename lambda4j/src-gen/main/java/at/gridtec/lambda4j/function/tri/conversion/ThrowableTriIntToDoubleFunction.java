...
public interface ThrowableTriIntToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriIntToDoubleFunction<X> of(
            @Nullable final ThrowableTriIntToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull final ThrowableTriIntToDoubleFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableTriIntToDoubleFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriIntPredicate<X> andThenToBoolean(@Nonnull final ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
    ...
    default ThrowableTriIntToDoubleFunction<X> memoized() {
        if (isMemoized()) {
            ...
            final Map<Triple<Integer, Integer, Integer>, Double> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default TriIntToDoubleFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriIntToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriIntToDoubleFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriIntToDoubleFunction function = recover.apply(throwable);
