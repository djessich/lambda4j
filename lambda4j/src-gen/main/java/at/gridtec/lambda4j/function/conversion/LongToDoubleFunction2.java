...
public interface LongToDoubleFunction2 extends Lambda, LongToDoubleFunction {
     ...
     */
    static LongToDoubleFunction2 of(@Nullable final LongToDoubleFunction2 expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link LongToDoubleFunction2} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
