...
public interface ObjByteToCharFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjByteToCharFunction<T> of(@Nonnull final ObjByteToCharFunction<T> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjByteToCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjByteToCharFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjByteToCharFunction}.
     */
    @Nonnull
    default BiFunction<T, Byte, Character> boxed() {
