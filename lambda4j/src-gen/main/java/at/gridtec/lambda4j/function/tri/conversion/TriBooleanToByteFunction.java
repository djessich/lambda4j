...
public interface TriBooleanToByteFunction extends Lambda {
    ...
    /**
     * Returns a composed {@link ByteTernaryOperator} that first applies the {@code before} predicates to
    ...
    /**
     * Returns a composed {@link TriCharToByteFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
    ...
    /**
     * Returns a composed {@link TriLongToByteFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
