...
public interface ThrowableFloatToDoubleFunction<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default FloatToDoubleFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default FloatToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends FloatToDoubleFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final FloatToDoubleFunction function = recover.apply(throwable);
