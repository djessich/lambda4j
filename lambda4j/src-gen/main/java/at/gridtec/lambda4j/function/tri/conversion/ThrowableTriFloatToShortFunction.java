...
public interface ThrowableTriFloatToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriFloatToShortFunction<X> of(
            @Nullable final ThrowableTriFloatToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableTriFloatToShortFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriFloatPredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code TriFloatToShortFunction} that applies this function to its input and nests the thrown
