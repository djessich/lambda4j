...
public interface IntToByteFunction extends Lambda {
     ...
     */
    static IntToByteFunction of(@Nullable final IntToByteFunction expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link IntToByteFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
    ...
    /**
     * Returns a composed {@link Function2} which represents this {@link IntToByteFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code IntToByteFunction} with methods provided by the {@code JDK}.
     *
