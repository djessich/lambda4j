...
public interface BiShortToFloatFunction extends Lambda {
     ...
     */
    static BiShortToFloatFunction of(@Nullable final BiShortToFloatFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B> ToFloatBiFunction<A, B> compose(@Nonnull final ToShortFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction composeFromBoolean(@Nonnull final BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default BiByteToFloatFunction composeFromByte(@Nonnull final ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default BiCharToFloatFunction composeFromChar(@Nonnull final CharToShortFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToFloatFunction composeFromDouble(@Nonnull final DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default FloatBinaryOperator composeFromFloat(@Nonnull final FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default BiIntToFloatFunction composeFromInt(@Nonnull final IntToShortFunction before1,
     ...
     */
    @Nonnull
    default BiLongToFloatFunction composeFromLong(@Nonnull final LongToShortFunction before1,
     ...
     */
    @Nonnull
    default BiShortToFloatFunction composeFromShort(@Nonnull final ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <S> BiShortFunction<S> andThen(@Nonnull final FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiShortPredicate andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortConsumer consume(@Nonnull final FloatConsumer consumer) {
