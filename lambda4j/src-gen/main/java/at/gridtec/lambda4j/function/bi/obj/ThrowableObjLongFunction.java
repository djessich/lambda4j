 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjLongFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjLongFunction} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link ThrowableObjLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjLongFunction<? super T, ? extends R, ? extends X> function, T t,
            long value) throws X {
    ...
    /**
     * Creates a {@link ThrowableObjLongFunction} which uses the {@code first} parameter of this one as argument for the
     ...
     * @return Creates a {@code ThrowableObjLongFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjLongFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjLongFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjLongFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjLongFunction<T, R, X> constant(R ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ThrowableBiFunction<A, B, R, X> compose(
        ...
        return (a, b) -> applyThrows(before1.applyThrows(a), before2.applyAsLongThrows(b));
    }
    ...
    default ThrowableBiBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyThrows(before1.applyThrows(value1), before2.applyAsLongThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjLongFunction<T, Optional<R>, X> nonNull() {
        return (t, value) -> Optional.ofNullable(applyThrows(t, value));
    }

    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjLongFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjLongFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Long, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjLongFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjLongFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjLongFunction<T, R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjLongFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjLongFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjLongFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjLongFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjLongFunction} that applies this function to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjLongFunction<T, R> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.applyThrows(t, value);
