...
public interface BiBooleanToFloatFunction extends Lambda {
     ...
     */
    static BiBooleanToFloatFunction of(@Nullable final BiBooleanToFloatFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction composeFromBoolean(@Nonnull final BooleanUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link BiByteToFloatFunction} that first applies the {@code before} predicates to
     ...
     */
    @Nonnull
    default BiByteToFloatFunction composeFromByte(@Nonnull final BytePredicate before1,
    ...
    /**
     * Returns a composed {@link BiCharToFloatFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default BiCharToFloatFunction composeFromChar(@Nonnull final CharPredicate before1,
     ...
     */
    @Nonnull
    default FloatBinaryOperator composeFromFloat(@Nonnull final FloatPredicate before1,
    ...
    /**
     * Returns a composed {@link BiLongToFloatFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default BiLongToFloatFunction composeFromLong(@Nonnull final LongPredicate before1,
     ...
     */
    @Nonnull
    default BiShortToFloatFunction composeFromShort(@Nonnull final ShortPredicate before1,
     ...
     */
    @Nonnull
    default <S> BiBooleanFunction<S> andThen(@Nonnull final FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction andThenToChar(@Nonnull final FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction andThenToFloat(@Nonnull final FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction andThenToLong(@Nonnull final FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToShortFunction andThenToShort(@Nonnull final FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanConsumer consume(@Nonnull final FloatConsumer consumer) {
     ...
     * to use this {@code BiBooleanToFloatFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
