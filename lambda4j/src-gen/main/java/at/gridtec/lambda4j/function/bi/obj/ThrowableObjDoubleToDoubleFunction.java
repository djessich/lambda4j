...
public interface ThrowableObjDoubleToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToDoubleFunction<T, X> of(
            @Nullable final ThrowableObjDoubleToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    default ObjDoubleToDoubleFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleToDoubleFunction<? super T>> recover) {
        Objects.requireNonNull(recover);
        return (t, value) -> {
            try {
                return this.applyAsDoubleThrows(t, value);
            } catch (Throwable throwable) {
                final ObjDoubleToDoubleFunction<? super T> function = recover.apply(throwable);
