...
public interface TriLongToCharFunction extends Lambda {
     ...
     */
    static TriLongToCharFunction of(@Nullable final TriLongToCharFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToCharTriFunction<A, B, C> compose(@Nonnull final ToLongFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToCharFunction composeFromBoolean(@Nonnull final BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default TriByteToCharFunction composeFromByte(@Nonnull final ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default CharTernaryOperator composeFromChar(@Nonnull final CharToLongFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction composeFromDouble(@Nonnull final DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToCharFunction composeFromFloat(@Nonnull final FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default TriIntToCharFunction composeFromInt(@Nonnull final IntToLongFunction before1,
     ...
     */
    @Nonnull
    default TriShortToCharFunction composeFromShort(@Nonnull final ShortToLongFunction before1,
     ...
     */
    @Nonnull
    default <S> TriLongFunction<S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriLongPredicate andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongConsumer consume(@Nonnull final CharConsumer consumer) {
     ...
     * {@code TriLongToCharFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
