...
public interface BiShortToDoubleFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiShortToDoubleFunction of(@Nonnull final BiShortToDoubleFunction expression) {
        return expression;
    }
     ...
     * to use this {@code BiShortToDoubleFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
