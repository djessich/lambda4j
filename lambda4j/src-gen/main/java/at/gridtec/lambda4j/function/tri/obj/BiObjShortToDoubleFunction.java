...
public interface BiObjShortToDoubleFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjShortToDoubleFunction<T, U> of(@Nullable final BiObjShortToDoubleFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> double call(@Nonnull final BiObjShortToDoubleFunction<? super T, ? super U> function, T t, U u,
            short value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjShortToDoubleFunction<T, U> onlyFirst(@Nonnull final ToDoubleFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjShortToDoubleFunction<T, U> onlySecond(@Nonnull final ToDoubleFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjShortToDoubleFunction<T, U> onlyThird(@Nonnull final ShortToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> BiObjShortFunction<T, U, S> andThen(@Nonnull final DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjShortPredicate<T, U> andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToByteFunction<T, U> andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToCharFunction<T, U> andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToDoubleFunction<T, U> andThenToDouble(@Nonnull final DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToFloatFunction<T, U> andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToIntFunction<T, U> andThenToInt(@Nonnull final DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjShortToShortFunction<T, U> andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code BiObjShortToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
