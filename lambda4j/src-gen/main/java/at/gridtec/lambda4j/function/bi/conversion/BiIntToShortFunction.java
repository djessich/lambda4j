...
public interface BiIntToShortFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiIntToShortFunction of(@Nonnull final BiIntToShortFunction expression) {
        return expression;
    }
     ...
     * {@code BiIntToShortFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
