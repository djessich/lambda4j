...
public interface TriCharToDoubleFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriCharToDoubleFunction of(@Nonnull final TriCharToDoubleFunction expression) {
        return expression;
    }
     ...
     * to use this {@code TriCharToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
