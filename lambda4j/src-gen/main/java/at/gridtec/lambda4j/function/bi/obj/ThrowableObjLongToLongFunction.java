...
public interface ThrowableObjLongToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToLongFunction<T, X> of(
            @Nullable final ThrowableObjLongToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    default ObjLongToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongToLongFunction<? super T>> recover) {
        Objects.requireNonNull(recover);
        return (t, value) -> {
            try {
                return this.applyAsLongThrows(t, value);
            } catch (Throwable throwable) {
                final ObjLongToLongFunction<? super T> function = recover.apply(throwable);
