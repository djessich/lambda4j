...
public interface ThrowableCharToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableCharToIntFunction<X> of(
            @Nullable final ThrowableCharToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull final ThrowableCharToIntFunction<? extends X> function,
            char value) throws X {
    ...
    /**
     * Returns a composed {@link ThrowableCharToIntFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> composeFromInt(@Nonnull final ThrowableIntToCharFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsIntThrows(before.applyAsCharThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> andThenToBoolean(@Nonnull final ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToByteFunction<X> andThenToByte(@Nonnull final ThrowableIntToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharUnaryOperator<X> andThenToChar(@Nonnull final ThrowableIntToCharFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> andThenToInt(@Nonnull final ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> andThenToLong(@Nonnull final ThrowableIntToLongFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default CharToIntFunction nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default CharToIntFunction recover(@Nonnull final Function<? super Throwable, ? extends CharToIntFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final CharToIntFunction function = recover.apply(throwable);
