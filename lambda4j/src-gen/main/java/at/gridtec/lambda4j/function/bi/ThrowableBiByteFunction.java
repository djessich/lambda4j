...
public interface ThrowableBiByteFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableBiByteFunction<R, X> of(
            @Nullable final ThrowableBiByteFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableBiByteFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableBiByteFunction<? extends R, ? extends X> partial) {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableBiByteFunction<? extends R, ? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableBiByteFunction} that first applies the {@code before} operators to
     ...
     */
    @Nonnull
    default ThrowableBiIntFunction<R, X> composeFromInt(@Nonnull final ThrowableIntToByteFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiByteFunction<R> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiByteFunction} that applies this function to its input and sneakily throws the
    ...
    default BiByteFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiByteFunction<? extends R>> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiByteFunction<? extends R> function = recover.apply(throwable);
