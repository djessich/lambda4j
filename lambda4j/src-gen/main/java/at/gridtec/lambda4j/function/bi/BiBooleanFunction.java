...
public interface BiBooleanFunction<R> extends Lambda {
     ...
     */
    static <R> BiBooleanFunction<R> of(@Nullable final BiBooleanFunction<R> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <R> BiBooleanFunction<Optional<R>> lift(@Nonnull final BiBooleanFunction<? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <R> R call(@Nonnull final BiBooleanFunction<? extends R> function, boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    static <R> BiBooleanFunction<R> onlyFirst(@Nonnull final BooleanFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <R> BiBooleanFunction<R> onlySecond(@Nonnull final BooleanFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiBooleanFunction<R> composeFromBoolean(@Nonnull final BooleanUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiByteFunction<R> composeFromByte(@Nonnull final BytePredicate before1,
     ...
     */
    @Nonnull
    default BiCharFunction<R> composeFromChar(@Nonnull final CharPredicate before1,
     ...
     */
    @Nonnull
    default BiFloatFunction<R> composeFromFloat(@Nonnull final FloatPredicate before1,
     ...
     */
    @Nonnull
    default BiIntFunction<R> composeFromInt(@Nonnull final IntPredicate before1, @Nonnull final IntPredicate before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> apply(before1.test(value1), before2.test(value2));
    }
     ...
     */
    @Nonnull
    default BiLongFunction<R> composeFromLong(@Nonnull final LongPredicate before1,
     ...
     */
    @Nonnull
    default BiShortFunction<R> composeFromShort(@Nonnull final ShortPredicate before1,
