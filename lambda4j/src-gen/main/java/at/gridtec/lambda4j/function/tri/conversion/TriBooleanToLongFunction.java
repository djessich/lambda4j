...
public interface TriBooleanToLongFunction extends Lambda {
     ...
     */
    @Nonnull
    static TriBooleanToLongFunction of(@Nonnull final TriBooleanToLongFunction expression) {
        return expression;
    }
     ...
     * to use this {@code TriBooleanToLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
