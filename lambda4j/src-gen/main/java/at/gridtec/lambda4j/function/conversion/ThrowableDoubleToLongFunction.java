...
public interface ThrowableDoubleToLongFunction<X extends Throwable> extends Lambda, DoubleToLongFunction {
     ...
     * @implSpec Overrides the {@link DoubleToLongFunction#applyAsLong(double)} method by using a redefinition as
     * default method. This implementation calls the {@link #applyAsLongThrows(double)} method of this function and
