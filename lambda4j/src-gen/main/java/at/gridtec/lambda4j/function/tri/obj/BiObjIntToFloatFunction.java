...
public interface BiObjIntToFloatFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjIntToFloatFunction<T, U> of(@Nullable final BiObjIntToFloatFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> float call(@Nonnull final BiObjIntToFloatFunction<? super T, ? super U> function, T t, U u,
            int value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjIntToFloatFunction<T, U> onlyFirst(@Nonnull final ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjIntToFloatFunction<T, U> onlySecond(@Nonnull final ToFloatFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjIntToFloatFunction<T, U> onlyThird(@Nonnull final IntToFloatFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjIntToFloatFunction<U> papplyAsFloat(T t) {
     ...
     */
    @Nonnull
    default IntToFloatFunction papplyAsFloat(T t, U u) {
     ...
     */
    @Nonnull
    default ToFloatBiFunction<T, U> papplyAsFloat(int value) {
     ...
     */
    @Nonnull
    default ToFloatFunction<U> papplyAsFloat(T t, int value) {
     ...
     */
    @Nonnull
    default <S> BiObjIntFunction<T, U, S> andThen(@Nonnull final FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjIntPredicate<T, U> andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToByteFunction<T, U> andThenToByte(@Nonnull final FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToCharFunction<T, U> andThenToChar(@Nonnull final FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToDoubleFunction<T, U> andThenToDouble(@Nonnull final FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToFloatFunction<T, U> andThenToFloat(@Nonnull final FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToIntFunction<T, U> andThenToInt(@Nonnull final FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToLongFunction<T, U> andThenToLong(@Nonnull final FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToShortFunction<T, U> andThenToShort(@Nonnull final FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntConsumer<T, U> consume(@Nonnull final FloatConsumer consumer) {
