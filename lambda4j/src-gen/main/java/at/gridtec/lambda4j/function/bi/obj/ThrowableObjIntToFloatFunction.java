...
public interface ThrowableObjIntToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntToFloatFunction<T, X> of(
            @Nullable final ThrowableObjIntToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     * this {@code ThrowableObjIntToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjIntToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjIntToFloatFunction<T> nestWith(
     ...
     * @return A composed {@link ObjIntToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjIntToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjIntToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjIntToFloatFunction<? super T> function = recover.apply(throwable);
