...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjShortFunction;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, Object, short)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjShortFunction<T, U, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjShortFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjShortFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, R, X> of(
            @Nullable final ThrowableBiObjShortFunction<T, U, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableBiObjShortFunction} into a total {@link ThrowableBiObjShortFunction} that returns
     ...
     * @return A partial {@code ThrowableBiObjShortFunction} lifted into a total {@code ThrowableBiObjShortFunction}
     * that returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, Optional<R>, X> lift(
            @Nonnull final ThrowableBiObjShortFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, u, value) -> Optional.ofNullable(partial.applyThrows(t, u, value));
    }

    /**
     * Calls the given {@link ThrowableBiObjShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return The result from the given {@code ThrowableBiObjShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, R, X extends Throwable> R call(
            @Nonnull final ThrowableBiObjShortFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
            U u, short value) throws X {
        Objects.requireNonNull(function);
        return function.applyThrows(t, u, value);
    }

    /**
     * Creates a {@link ThrowableBiObjShortFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortFunction} which uses the {@code third} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjShortFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, R, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return A {@code ThrowableBiObjShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, U u, short value) throws X;
     ...
     */
    default R applyThrows(@Nonnull Pair<T, U> tuple, short value) throws X {
        Objects.requireNonNull(tuple);
        return applyThrows(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableObjShortFunction} as
     * result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableObjShortFunction} that represents this function partially applied the some arguments.
     */
    @Nonnull
    default ThrowableObjShortFunction<U, R, X> papplyThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortFunction<R, X> papplyThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, U, R, X> papplyThrows(short value) {
     ...
     */
    @Nonnull
    default ThrowableFunction<U, R, X> papplyThrows(T t, short value) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsShortThrows(c));
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortFunction<Pair<T, U>, R, X> tupled() {
    ...
    @Deprecated
    @Nonnull
    default ThrowableBiObjShortFunction<T, U, Optional<R>, X> nonNull() {
        return (t, u, value) -> Optional.ofNullable(applyThrows(t, u, value));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjShortFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Short, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link BiObjShortFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjShortFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiObjShortFunction<T, U, R> nest() {
     ...
     */
    @Nonnull
    default BiObjShortFunction<T, U, R> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjShortFunction<T, U, R> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjShortFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default BiObjShortFunction<T, U, R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjShortFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjShortFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
