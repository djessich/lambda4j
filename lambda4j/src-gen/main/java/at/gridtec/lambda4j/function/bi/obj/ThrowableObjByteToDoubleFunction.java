...
public interface ThrowableObjByteToDoubleFunction<T, X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ObjByteToDoubleFunction<T> nestWith(
    ...
    default ObjByteToDoubleFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjByteToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjByteToDoubleFunction<? super T> function = recover.apply(throwable);
