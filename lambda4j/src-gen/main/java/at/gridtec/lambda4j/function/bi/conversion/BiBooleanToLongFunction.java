...
public interface BiBooleanToLongFunction extends Lambda {
     ...
     */
    static BiBooleanToLongFunction of(@Nullable final BiBooleanToLongFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction composeFromBoolean(@Nonnull final BooleanUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link BiByteToLongFunction} that first applies the {@code before} predicates to
     ...
     */
    @Nonnull
    default BiByteToLongFunction composeFromByte(@Nonnull final BytePredicate before1,
    ...
    /**
     * Returns a composed {@link BiCharToLongFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default BiCharToLongFunction composeFromChar(@Nonnull final CharPredicate before1,
     ...
     */
    @Nonnull
    default BiFloatToLongFunction composeFromFloat(@Nonnull final FloatPredicate before1,
    ...
    /**
     * Returns a composed {@link LongBinaryOperator2} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default LongBinaryOperator2 composeFromLong(@Nonnull final LongPredicate before1,
     ...
     */
    @Nonnull
    default BiShortToLongFunction composeFromShort(@Nonnull final ShortPredicate before1,
     ...
     */
    @Nonnull
    default BiBooleanConsumer consume(@Nonnull final LongConsumer consumer) {
     ...
     * to use this {@code BiBooleanToLongFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
