...
public interface ObjDoubleFunction<T, R> extends Lambda {
     ...
     */
    static <T, R> ObjDoubleFunction<T, R> of(@Nullable final ObjDoubleFunction<T, R> expression) {
        return expression;
    }
    ...
    static <T, R> ObjDoubleFunction<T, Optional<R>> lift(
            @Nonnull final ObjDoubleFunction<? super T, ? extends R> partial) {
     ...
     * {@code ObjDoubleFunction} with methods provided by the {@code JDK}.
     *
