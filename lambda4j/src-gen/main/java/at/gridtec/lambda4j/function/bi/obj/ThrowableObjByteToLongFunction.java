...
public interface ThrowableObjByteToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjByteToLongFunction<T, X> of(
            @Nullable final ThrowableObjByteToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(byte value) {
     ...
     */
    @Nonnull
    default ObjByteToLongFunction<T> nestWith(
    ...
    default ObjByteToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjByteToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjByteToLongFunction<? super T> function = recover.apply(throwable);
