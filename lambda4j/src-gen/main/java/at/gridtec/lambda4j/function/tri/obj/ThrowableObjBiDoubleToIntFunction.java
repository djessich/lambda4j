...
public interface ThrowableObjBiDoubleToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToIntFunction<T, X> of(
            @Nullable final ThrowableObjBiDoubleToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull final ThrowableObjBiDoubleToIntFunction<? super T, ? extends X> function, T t, double value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiDoubleToIntFunction<T> nestWith(
    ...
    default ObjBiDoubleToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiDoubleToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiDoubleToIntFunction<? super T> function = recover.apply(throwable);
