...
public interface ObjBiFloatToShortFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiFloatToShortFunction<T> of(@Nonnull final ObjBiFloatToShortFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiFloatToShortFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
