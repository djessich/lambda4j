...
public interface ThrowableObjBiCharToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToLongFunction<T, X> of(
            @Nullable final ThrowableObjBiCharToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableBiCharToLongFunction<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> papplyAsLongThrows(T t, char value1) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToLongFunction<T, X> papplyAsLongThrows(char value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(char value1, char value2) {
     ...
     */
    @Nonnull
    default ObjBiCharToLongFunction<T> nestWith(
    ...
    default ObjBiCharToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharToLongFunction<? super T> function = recover.apply(throwable);
