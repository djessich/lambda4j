...
public interface BooleanToCharFunction extends Lambda {
     ...
     */
    static BooleanToCharFunction of(@Nullable final BooleanToCharFunction expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ToCharFunction} that first applies the {@code before} predicate to its input, and
    ...
    /**
     * Returns a composed {@link ByteToCharFunction} that first applies the {@code before} predicate to
    ...
    /**
     * Returns a composed {@link CharUnaryOperator} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
    ...
    /**
     * Returns a composed {@link IntToCharFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
    ...
    /**
     * Returns a composed {@link LongToCharFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     * {@code BooleanToCharFunction} with methods provided by the {@code JDK}.
     *
