...
@FunctionalInterface
public interface ThrowableLongToCharFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableLongToCharFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableLongToCharFunction} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link ThrowableLongToCharFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableLongToCharFunction}.
    ...
    /**
     * Creates a {@link ThrowableLongToCharFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableLongToCharFunction} which always returns a given value.
     */
    @Nonnull
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(long value) throws X;
    ...
    /**
     * Returns a memoized (caching) version of this {@link ThrowableLongToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableLongToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableLongToCharFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableLongToCharFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableLongToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableLongToCharFunction}.
     */
    @Nonnull
    default ThrowableFunction<Long, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link LongToCharFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link LongToCharFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default LongToCharFunction nest() {
     ...
     */
    @Nonnull
    default LongToCharFunction nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link LongToCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link LongToCharFunction} that applies this function to its input and sneakily throws the
     ...
     * @return A composed {@link LongToCharFunction} that first applies this function to its input, and then applies the
