...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjIntToShortFunction;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(Object, Object, int)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjIntToShortFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjIntToShortFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjIntToShortFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjIntToShortFunction<T, U, X> of(
            @Nullable final ThrowableBiObjIntToShortFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjIntToShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjIntToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> short call(
            @Nonnull final ThrowableBiObjIntToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
            int value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToShortFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjIntToShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToShortFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToShortFunction} which uses the {@code second} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjIntToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToShortFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToShortFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjIntToShortFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableIntToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToShortFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjIntToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToShortFunction<T, U, X> constant(short ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(T t, U u, int value) throws X;
     ...
     */
    default short applyAsShortThrows(@Nonnull Pair<T, U> tuple, int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntToShortFunction<U, X> papplyAsShortThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntToShortFunction<X> papplyAsShortThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToShortBiFunction<T, U, X> papplyAsShortThrows(int value) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<U, X> papplyAsShortThrows(T t, int value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjIntConsumer<T, U, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjIntToShortFunction<Pair<T, U>, X> tupled() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjIntToShortFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjIntToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjIntToShortFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Integer>, Short> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjIntToShortFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjIntToShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjIntToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjIntToShortFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Integer, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link BiObjIntToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjIntToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjIntToShortFunction<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjIntToShortFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjIntToShortFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjIntToShortFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjIntToShortFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjIntToShortFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjIntToShortFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjIntToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjIntToShortFunction<? super T, ? super U> function = recover.apply(throwable);
