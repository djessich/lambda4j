...
public interface ThrowableObjBiShortToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToIntFunction<T, X> of(
            @Nullable final ThrowableObjBiShortToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableBiShortToIntFunction<X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> papplyAsIntThrows(T t, short value1) {
     ...
     */
    @Nonnull
    default ThrowableObjShortToIntFunction<T, X> papplyAsIntThrows(short value1) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> papplyAsIntThrows(short value1, short value2) {
     ...
     */
    @Nonnull
    default ObjBiShortToIntFunction<T> nestWith(
    ...
    default ObjBiShortToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiShortToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiShortToIntFunction<? super T> function = recover.apply(throwable);
