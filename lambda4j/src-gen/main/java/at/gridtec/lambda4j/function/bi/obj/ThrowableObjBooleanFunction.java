 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, boolean)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBooleanFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBooleanFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBooleanFunction} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link ThrowableObjBooleanFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBooleanFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjBooleanFunction<? super T, ? extends R, ? extends X> function, T t,
    ...
    /**
     * Creates a {@link ThrowableObjBooleanFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBooleanFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBooleanFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBooleanFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBooleanFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableBooleanFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBooleanFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBooleanFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBooleanFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBooleanFunction<T, R, X> constant(R ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, boolean value) throws X;
    ...
    default <A, B> ThrowableBiFunction<A, B, R, X> compose(
        ...
        return (a, b) -> applyThrows(before1.applyThrows(a), before2.testThrows(b));
    }
    ...
    default ThrowableBiBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyThrows(before1.applyThrows(value1), before2.applyAsBooleanThrows(value2));
    }
    ...
    default ThrowableBiByteFunction<R, X> composeFromByte(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyThrows(before1.applyThrows(value1), before2.testThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjBooleanConsumer<T, X> consume(
    ...
    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBooleanFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBooleanFunction}.
    ...
    default ThrowableObjBooleanFunction<T, R, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableObjBooleanFunction<T, R, X> & Memoized) (t, value) -> {
                final R returnValue;
                synchronized (lock) {
     ...
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjBooleanFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Boolean, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjBooleanFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBooleanFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjBooleanFunction<T, R> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBooleanFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBooleanFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBooleanFunction<T, R> sneakyThrow() {
        return (t, value) -> {
            try {
     ...
     * @return A composed {@link ObjBooleanFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBooleanFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBooleanFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjBooleanFunction<? super T, ? extends R> function = recover.apply(throwable);
