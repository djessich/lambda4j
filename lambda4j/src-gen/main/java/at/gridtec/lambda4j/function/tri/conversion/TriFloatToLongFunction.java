...
public interface TriFloatToLongFunction extends Lambda {
     ...
     */
    static TriFloatToLongFunction of(@Nullable final TriFloatToLongFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default TriBooleanToLongFunction composeFromBoolean(@Nonnull final BooleanToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriByteToLongFunction composeFromByte(@Nonnull final ByteToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriCharToLongFunction composeFromChar(@Nonnull final CharToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction composeFromDouble(@Nonnull final DoubleToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToLongFunction composeFromFloat(@Nonnull final FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriIntToLongFunction composeFromInt(@Nonnull final IntToFloatFunction before1,
     ...
     */
    @Nonnull
    default LongTernaryOperator composeFromLong(@Nonnull final LongToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriShortToLongFunction composeFromShort(@Nonnull final ShortToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriFloatPredicate andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
