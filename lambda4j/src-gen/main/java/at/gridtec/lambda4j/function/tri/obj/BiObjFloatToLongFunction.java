...
public interface BiObjFloatToLongFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjFloatToLongFunction<T, U> of(@Nullable final BiObjFloatToLongFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> long call(@Nonnull final BiObjFloatToLongFunction<? super T, ? super U> function, T t, U u,
            float value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatToLongFunction<T, U> onlyThird(@Nonnull final FloatToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjFloatToLongFunction<U> papplyAsLong(T t) {
     ...
     */
    @Nonnull
    default FloatToLongFunction papplyAsLong(T t, U u) {
     ...
     */
    @Nonnull
    default ToLongBiFunction2<T, U> papplyAsLong(float value) {
     ...
     */
    @Nonnull
    default ToLongFunction2<U> papplyAsLong(T t, float value) {
     ...
     */
    @Nonnull
    default BiObjFloatPredicate<T, U> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToByteFunction<T, U> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToCharFunction<T, U> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToFloatFunction<T, U> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToIntFunction<T, U> andThenToInt(@Nonnull final LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToLongFunction<T, U> andThenToLong(@Nonnull final LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToShortFunction<T, U> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatConsumer<T, U> consume(@Nonnull final LongConsumer consumer) {
