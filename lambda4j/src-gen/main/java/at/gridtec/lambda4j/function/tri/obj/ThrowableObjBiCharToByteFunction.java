...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjCharToByteFunction;
...
public interface ThrowableObjBiCharToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToByteFunction<T, X> of(
            @Nullable final ThrowableObjBiCharToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull final ThrowableObjBiCharToByteFunction<? super T, ? extends X> function, T t, char value1,
     ...
     */
    @Nonnull
    default ThrowableBiCharToByteFunction<X> papplyAsByteThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToByteFunction<X> papplyAsByteThrows(T t, char value1) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToByteFunction<T, X> papplyAsByteThrows(char value1) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> papplyAsByteThrows(char value1, char value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiCharToByteFunction<T> nestWith(
    ...
    default ObjBiCharToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharToByteFunction<? super T> function = recover.apply(throwable);
