 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(short, short)}.
 *
...
@FunctionalInterface
public interface ThrowableBiShortToFloatFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiShortToFloatFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiShortToFloatFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableBiShortToFloatFunction<X> of(
            @Nullable final ThrowableBiShortToFloatFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiShortToFloatFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code ThrowableBiShortToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> float call(@Nonnull final ThrowableBiShortToFloatFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiShortToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableShortToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiShortToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableShortToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiShortToFloatFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiShortToFloatFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableShortToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiShortToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableShortToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiShortToFloatFunction<X> onlySecond(
            @Nonnull final ThrowableShortToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiShortToFloatFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiShortToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiShortToFloatFunction<X> constant(float ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(short value1, short value2) throws X;
    ...
    default <A, B> ThrowableToFloatBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsFloatThrows(before1.applyAsShortThrows(a), before2.applyAsShortThrows(b));
    }
    ...
    default ThrowableBiBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsFloatThrows(before1.applyAsShortThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableBiShortToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code short} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiShortToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * short}.
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiShortConsumer<X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableBiShortToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiShortToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableBiShortToFloatFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<Short, Short, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link BiShortToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiShortToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiShortToFloatFunction nest() {
     ...
     */
    @Nonnull
    default BiShortToFloatFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiShortToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiShortToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiShortToFloatFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiShortToFloatFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiShortToFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiShortToFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiShortToFloatFunction sneakyThrow() {
        return (value1, value2) -> {
            try {
                return this.applyAsFloatThrows(value1, value2);
