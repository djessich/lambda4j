...
public interface ThrowableBiIntToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiIntToDoubleFunction<X> of(
            @Nullable final ThrowableBiIntToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableIntToDoubleFunction<X> papplyAsDoubleThrows(int value1) {
    ...
    /**
     * Returns a composed {@link ThrowableBiIntToDoubleFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default BiIntToDoubleFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiIntToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiIntToDoubleFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiIntToDoubleFunction function = recover.apply(throwable);
