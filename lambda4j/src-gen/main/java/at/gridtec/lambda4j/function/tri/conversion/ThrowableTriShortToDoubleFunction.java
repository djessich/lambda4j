...
public interface ThrowableTriShortToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriShortToDoubleFunction<X> of(
            @Nullable final ThrowableTriShortToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull final ThrowableTriShortToDoubleFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiShortToDoubleFunction<X> papplyAsDoubleThrows(short value1) {
     ...
     */
    @Nonnull
    default ThrowableShortToDoubleFunction<X> papplyAsDoubleThrows(short value1, short value2) {
     ...
     */
    @Nonnull
    default ThrowableTriShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriShortConsumer<X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
    ...
    default ThrowableTriShortToDoubleFunction<X> memoized() {
        if (isMemoized()) {
            ...
            final Map<Triple<Short, Short, Short>, Double> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default TriShortToDoubleFunction nestWith(
    ...
    default TriShortToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriShortToDoubleFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriShortToDoubleFunction function = recover.apply(throwable);
