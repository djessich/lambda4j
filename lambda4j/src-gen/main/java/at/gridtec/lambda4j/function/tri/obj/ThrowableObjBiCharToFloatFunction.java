...
public interface ThrowableObjBiCharToFloatFunction<T, X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ObjBiCharToFloatFunction<T> nestWith(
    ...
    default ObjBiCharToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharToFloatFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharToFloatFunction<? super T> function = recover.apply(throwable);
