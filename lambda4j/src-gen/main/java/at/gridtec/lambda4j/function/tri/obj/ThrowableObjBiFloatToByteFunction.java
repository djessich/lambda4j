...
public interface ThrowableObjBiFloatToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatToByteFunction<T, X> of(
            @Nullable final ThrowableObjBiFloatToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull final ThrowableObjBiFloatToByteFunction<? super T, ? extends X> function, T t, float value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiFloatToByteFunction<T> nestWith(
    ...
    default ObjBiFloatToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiFloatToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiFloatToByteFunction<? super T> function = recover.apply(throwable);
