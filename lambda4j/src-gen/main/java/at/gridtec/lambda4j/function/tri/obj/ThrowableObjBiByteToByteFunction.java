...
public interface ThrowableObjBiByteToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToByteFunction<T, X> of(
            @Nullable final ThrowableObjBiByteToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull final ThrowableObjBiByteToByteFunction<? super T, ? extends X> function, T t, byte value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiByteToByteFunction<T> nestWith(
    ...
    default ObjBiByteToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiByteToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiByteToByteFunction<? super T> function = recover.apply(throwable);
