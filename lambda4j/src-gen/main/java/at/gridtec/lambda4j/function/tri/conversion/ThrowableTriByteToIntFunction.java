...
public interface ThrowableTriByteToIntFunction<X extends Throwable> extends Lambda {
    ...
    /**
     * Returns a composed {@link ThrowableTriByteToIntFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default TriByteToIntFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriByteToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriByteToIntFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriByteToIntFunction function = recover.apply(throwable);
