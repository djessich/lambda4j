...
public interface ThrowableTriDoubleToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToByteFunction<X> of(
            @Nullable final ThrowableTriDoubleToByteFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> byte call(@Nonnull final ThrowableTriDoubleToByteFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToByteFunction<X> papplyAsByteThrows(double value1) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToByteFunction<X> papplyAsByteThrows(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableTriDoublePredicate<X> andThenToBoolean(@Nonnull final ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction nestWith(
    ...
    default TriDoubleToByteFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriDoubleToByteFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriDoubleToByteFunction function = recover.apply(throwable);
