...
public interface ThrowableFloatToIntFunction<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default FloatToIntFunction nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default FloatToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends FloatToIntFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final FloatToIntFunction function = recover.apply(throwable);
