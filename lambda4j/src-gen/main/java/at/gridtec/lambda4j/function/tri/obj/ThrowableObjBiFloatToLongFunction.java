...
public interface ThrowableObjBiFloatToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatToLongFunction<T, X> of(
            @Nullable final ThrowableObjBiFloatToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableBiFloatToLongFunction<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToLongFunction<X> papplyAsLongThrows(T t, float value1) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToLongFunction<T, X> papplyAsLongThrows(float value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(float value1, float value2) {
     ...
     */
    @Nonnull
    default ObjBiFloatToLongFunction<T> nestWith(
    ...
    default ObjBiFloatToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiFloatToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiFloatToLongFunction<? super T> function = recover.apply(throwable);
