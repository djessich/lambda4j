...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjCharToLongFunction;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjCharToLongFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjCharToLongFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjCharToLongFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjCharToLongFunction<T, U, X> of(
            @Nullable final ThrowableBiObjCharToLongFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjCharToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjCharToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> long call(
            @Nonnull final ThrowableBiObjCharToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToLongFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjCharToLongFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToLongFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToLongFunction} which uses the {@code second} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjCharToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToLongFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToLongFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjCharToLongFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToLongFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjCharToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToLongFunction<T, U, X> constant(long ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(T t, U u, char value) throws X;
     ...
     */
    default long applyAsLongThrows(@Nonnull Pair<T, U> tuple, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharToLongFunction<U, X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> papplyAsLongThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToLongBiFunction<T, U, X> papplyAsLongThrows(char value) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<U, X> papplyAsLongThrows(T t, char value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToLongFunction<Pair<T, U>, X> tupled() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjCharToLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjCharToLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjCharToLongFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Character>, Long> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjCharToLongFunction<T, U, X> & Memoized) (t, u, value) -> {
     ...
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Character, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link BiObjCharToLongFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjCharToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjCharToLongFunction<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjCharToLongFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjCharToLongFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjCharToLongFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjCharToLongFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjCharToLongFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjCharToLongFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjCharToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjCharToLongFunction<? super T, ? super U> function = recover.apply(throwable);
