...
public interface ThrowableTriIntToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriIntToCharFunction<X> of(
            @Nullable final ThrowableTriIntToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull final ThrowableTriIntToCharFunction<? extends X> function,
    ...
    static <X extends Throwable> ThrowableTriIntToCharFunction<X> onlyFirst(
            @Nonnull final ThrowableIntToCharFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Returns a composed {@link ThrowableTriIntToCharFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriIntPredicate<X> andThenToBoolean(@Nonnull final ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntTernaryOperator<X> andThenToInt(@Nonnull final ThrowableCharToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriIntToCharFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriIntToCharFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriIntToCharFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriIntToCharFunction function = recover.apply(throwable);
