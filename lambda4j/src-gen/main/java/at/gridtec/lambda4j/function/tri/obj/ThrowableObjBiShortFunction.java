 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, short, short)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiShortFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiShortFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiShortFunction} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link ThrowableObjBiShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjBiShortFunction<? super T, ? extends R, ? extends X> function, T t, short value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiShortFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiShortFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiShortFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiShortFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiShortFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return Creates a {@code ThrowableObjBiShortFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiShortFunction<T, R, X> onlyThird(
            @Nonnull final ThrowableShortFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiShortFunction<T, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, short value1, short value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiShortFunction<R, X> papplyThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortFunction<R, X> papplyThrows(T t, short value1) {
     ...
     */
    @Nonnull
    default ThrowableObjShortFunction<T, R, X> papplyThrows(short value1) {
     ...
     */
    @Nonnull
    default ThrowableFunction<T, R, X> papplyThrows(short value1, short value2) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyAsShortThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyThrows(value1), before2.applyAsShortThrows(value2),
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjBiShortFunction<T, Optional<R>, X> nonNull() {
        return (t, value1, value2) -> Optional.ofNullable(applyThrows(t, value1, value2));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiShortFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Short, Short, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjBiShortFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiShortFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjBiShortFunction<T, R> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiShortFunction<T, R> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiShortFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiShortFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiShortFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiShortFunction<? super T, ? extends R> function = recover.apply(throwable);
