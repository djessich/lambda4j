...
public interface ThrowableBiDoubleToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleToLongFunction<X> of(
            @Nullable final ThrowableBiDoubleToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableBiDoubleToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoublePredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiDoubleConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiDoubleToLongFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiDoubleToLongFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiDoubleToLongFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiDoubleToLongFunction function = recover.apply(throwable);
