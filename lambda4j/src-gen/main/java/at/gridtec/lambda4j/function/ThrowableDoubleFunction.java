...
public interface ThrowableDoubleFunction<R, X extends Throwable> extends Lambda, DoubleFunction<R> {
    ...
    static <R, X extends Throwable> ThrowableDoubleFunction<R, X> of(
            @Nullable final ThrowableDoubleFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableDoubleFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableDoubleFunction<? extends R, ? extends X> partial) {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableDoubleFunction<? extends R, ? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableByteFunction} that first applies the {@code before} function to
     ...
     */
    @Nonnull
    default ThrowableIntFunction<R, X> composeFromInt(@Nonnull final ThrowableIntToDoubleFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyThrows(before.applyAsDoubleThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableDoubleConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default DoubleFunction2<R> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link DoubleFunction2} that applies this function to its input and sneakily throws the
    ...
    default DoubleFunction2<R> recover(
            @Nonnull final Function<? super Throwable, ? extends DoubleFunction<? extends R>> recover) {
        ...
        return (value) -> {
            try {
                ...
                final DoubleFunction<? extends R> function = recover.apply(throwable);
