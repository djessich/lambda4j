...
public interface ThrowableBiObjShortToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortToCharFunction<T, U, X> of(
            @Nullable final ThrowableBiObjShortToCharFunction<T, U, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortToCharFunction<U, X> papplyAsCharThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToCharFunction<X> papplyAsCharThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToCharBiFunction<T, U, X> papplyAsCharThrows(short value) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<U, X> papplyAsCharThrows(T t, short value) {
     ...
     */
    @Nonnull
    default BiObjShortToCharFunction<T, U> nestWith(
    ...
    default BiObjShortToCharFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjShortToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjShortToCharFunction<? super T, ? super U> function = recover.apply(throwable);
