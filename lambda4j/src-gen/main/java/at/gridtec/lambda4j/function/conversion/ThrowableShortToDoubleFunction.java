 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(short)}.
 *
...
@FunctionalInterface
public interface ThrowableShortToDoubleFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableShortToDoubleFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableShortToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableShortToDoubleFunction<X> of(
            @Nullable final ThrowableShortToDoubleFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableShortToDoubleFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableShortToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> double call(@Nonnull final ThrowableShortToDoubleFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableShortToDoubleFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableShortToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableShortToDoubleFunction<X> constant(double ret) {
        return (value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(short value) throws X;
    ...
    default <A> ThrowableToDoubleFunction<A, X> compose(
        ...
        return (a) -> applyAsDoubleThrows(before.applyAsShortThrows(a));
    }
    ...
    default ThrowableBooleanToDoubleFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsDoubleThrows(before.applyAsShortThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableShortToDoubleFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code short} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableShortToDoubleFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * short}.
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsDoubleThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableShortToDoubleFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableShortToDoubleFunction}.
     ...
     */
    @Nonnull
    default ThrowableShortToDoubleFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableShortToDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableShortToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableShortToDoubleFunction}.
     */
    @Nonnull
    default ThrowableFunction<Short, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link ShortToDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ShortToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ShortToDoubleFunction nest() {
     ...
     */
    @Nonnull
    default ShortToDoubleFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default ShortToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends ShortToDoubleFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ShortToDoubleFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ShortToDoubleFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ShortToDoubleFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ShortToDoubleFunction sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsDoubleThrows(value);
