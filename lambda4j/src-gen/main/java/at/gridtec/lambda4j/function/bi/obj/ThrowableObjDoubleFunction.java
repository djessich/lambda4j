 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableObjDoubleFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjDoubleFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static <T, R, X extends Throwable> ThrowableObjDoubleFunction<T, R, X> of(
            @Nullable final ThrowableObjDoubleFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjDoubleFunction} into a total {@link ThrowableObjDoubleFunction} that returns
     ...
     * @return A partial {@code ThrowableObjDoubleFunction} lifted into a total {@code ThrowableObjDoubleFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjDoubleFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjDoubleFunction<? super T, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, value) -> Optional.ofNullable(partial.applyThrows(t, value));
    }

    /**
     * Calls the given {@link ThrowableObjDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjDoubleFunction<? super T, ? extends R, ? extends X> function, T t,
    ...
    /**
     * Creates a {@link ThrowableObjDoubleFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjDoubleFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjDoubleFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjDoubleFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjDoubleFunction<T, R, X> constant(R ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ThrowableBiFunction<A, B, R, X> compose(
        ...
        return (a, b) -> applyThrows(before1.applyThrows(a), before2.applyAsDoubleThrows(b));
    }
    ...
    default ThrowableBiBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyThrows(before1.applyThrows(value1), before2.applyAsDoubleThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjDoubleFunction<T, Optional<R>, X> nonNull() {
        return (t, value) -> Optional.ofNullable(applyThrows(t, value));
    }

    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjDoubleFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjDoubleFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Double, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjDoubleFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjDoubleFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjDoubleFunction<T, R> nestWith(
    ...
    /**
     * Returns a composed {@link ObjDoubleFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjDoubleFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjDoubleFunction<T, R> sneakyThrow() {
        return (t, value) -> {
            try {
     ...
     * @return A composed {@link ObjDoubleFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjDoubleFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjDoubleFunction<? super T, ? extends R> function = recover.apply(throwable);
