...
public interface ThrowableObjBiIntToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToCharFunction<T, X> of(
            @Nullable final ThrowableObjBiIntToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull final ThrowableObjBiIntToCharFunction<? super T, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiIntToCharFunction<T> nestWith(
    ...
    default ObjBiIntToCharFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiIntToCharFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiIntToCharFunction<? super T> function = recover.apply(throwable);
