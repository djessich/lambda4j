...
public interface ThrowableObjLongToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToByteFunction<T, X> of(
            @Nullable final ThrowableObjLongToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull final ThrowableObjLongToByteFunction<? super T, ? extends X> function, T t, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> andThenToBoolean(@Nonnull final ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<T> nestWith(
    ...
    default ObjLongToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjLongToByteFunction<? super T> function = recover.apply(throwable);
