...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjByteToFloatFunction;
...
public interface ThrowableObjBiByteToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToFloatFunction<T, X> of(
            @Nullable final ThrowableObjBiByteToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull final ThrowableObjBiByteToFloatFunction<? super T, ? extends X> function, T t, byte value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiByteToFloatFunction<T> nestWith(
    ...
    default ObjBiByteToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiByteToFloatFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiByteToFloatFunction<? super T> function = recover.apply(throwable);
