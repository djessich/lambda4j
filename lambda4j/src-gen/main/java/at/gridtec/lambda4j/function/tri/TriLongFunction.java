...
public interface TriLongFunction<R> extends Lambda {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <R> R call(@Nonnull final TriLongFunction<? extends R> function, long value1, long value2, long value3) {
     ...
     */
    @Nonnull
    static <R> TriLongFunction<R> onlyFirst(@Nonnull final LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <R> TriLongFunction<R> onlySecond(@Nonnull final LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <R> TriLongFunction<R> onlyThird(@Nonnull final LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B, C> TriFunction<A, B, C, R> compose(@Nonnull final ToLongFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanFunction<R> composeFromBoolean(@Nonnull final BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default TriByteFunction<R> composeFromByte(@Nonnull final ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default TriCharFunction<R> composeFromChar(@Nonnull final CharToLongFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> composeFromDouble(@Nonnull final DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default TriFloatFunction<R> composeFromFloat(@Nonnull final FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default TriIntFunction<R> composeFromInt(@Nonnull final IntToLongFunction before1,
    ...
    /**
     * Returns a composed {@link TriLongFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default TriLongFunction<R> composeFromLong(@Nonnull final LongUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriShortFunction<R> composeFromShort(@Nonnull final ShortToLongFunction before1,
     ...
     */
    @Nonnull
    default <S> TriLongFunction<S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default TriLongConsumer consume(@Nonnull final Consumer<? super R> consumer) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link TriLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code TriLongFunction} with methods provided by the {@code JDK}.
     *
