...
public interface ThrowableObjDoubleToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToLongFunction<T, X> of(
            @Nullable final ThrowableObjDoubleToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableDoubleToLongFunction<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(double value) {
     ...
     */
    @Nonnull
    default ObjDoubleToLongFunction<T> nestWith(
    ...
    default ObjDoubleToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjDoubleToLongFunction<? super T> function = recover.apply(throwable);
