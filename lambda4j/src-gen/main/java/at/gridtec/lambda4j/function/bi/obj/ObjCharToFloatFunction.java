...
public interface ObjCharToFloatFunction<T> extends Lambda {
     ...
     */
    static <T> ObjCharToFloatFunction<T> of(@Nullable final ObjCharToFloatFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> float call(@Nonnull final ObjCharToFloatFunction<? super T> function, T t, char value) {
     ...
     */
    @Nonnull
    static <T> ObjCharToFloatFunction<T> onlyFirst(@Nonnull final ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjCharToFloatFunction<T> onlySecond(@Nonnull final CharToFloatFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjCharFunction<T, S> andThen(@Nonnull final FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjCharPredicate<T> andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToByteFunction<T> andThenToByte(@Nonnull final FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToCharFunction<T> andThenToChar(@Nonnull final FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToDoubleFunction<T> andThenToDouble(@Nonnull final FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToFloatFunction<T> andThenToFloat(@Nonnull final FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToIntFunction<T> andThenToInt(@Nonnull final FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToLongFunction<T> andThenToLong(@Nonnull final FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharToShortFunction<T> andThenToShort(@Nonnull final FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjCharConsumer<T> consume(@Nonnull final FloatConsumer consumer) {
    ...
    /**
     * Returns a composed {@link BiFunction} which represents this {@link ObjCharToFloatFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjCharToFloatFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
     * @return A composed {@code BiFunction} which represents this {@code ObjCharToFloatFunction}.
     */
    @Nonnull
    default BiFunction<T, Character, Float> boxed() {
