...
import at.gridtec.lambda4j.predicate.tri.obj.ThrowableObjBiFloatPredicate;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiFloatToCharFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiFloatToCharFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableObjBiFloatToCharFunction} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiFloatToCharFunction<T, X> of(
            @Nullable final ThrowableObjBiFloatToCharFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiFloatToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiFloatToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> char call(
            @Nonnull final ThrowableObjBiFloatToCharFunction<? super T, ? extends X> function, T t, float value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@link ThrowableToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToCharFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableFloatToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToCharFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableFloatToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToCharFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToCharFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@link ThrowableFloatToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToCharFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToCharFunction<T, X> onlyThird(
            @Nonnull final ThrowableFloatToCharFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiFloatToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToCharFunction<T, X> constant(char ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(T t, float value1, float value2) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableBiFloatToCharFunction}
     * as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableBiFloatToCharFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableBiFloatToCharFunction<X> papplyAsCharThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToCharFunction<X> papplyAsCharThrows(T t, float value1) {
     ...
     * ThrowableObjFloatToCharFunction} as result.
     *
     * @param value1 The second argument to this function used to partially apply this function
     * @return A {@code ThrowableObjFloatToCharFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjFloatToCharFunction<T, X> papplyAsCharThrows(float value1) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> papplyAsCharThrows(float value1, float value2) {
    ...
    default <A, B, C> ThrowableToCharTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsCharThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(applyAsCharThrows(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiFloatToCharFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiFloatToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatToCharFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, Float, Float>, Character> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjBiFloatToCharFunction<T, X> & Memoized) (t, value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiFloatToCharFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiFloatToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiFloatToCharFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Float, Float, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link ObjBiFloatToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiFloatToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiFloatToCharFunction<T> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiFloatToCharFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiFloatToCharFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiFloatToCharFunction<T> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiFloatToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiFloatToCharFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiFloatToCharFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiFloatToCharFunction<? super T> function = recover.apply(throwable);
