...
public interface ShortToCharFunction extends Lambda {
     ...
     */
    static ShortToCharFunction of(@Nullable final ShortToCharFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A> ToCharFunction<A> compose(@Nonnull final ToShortFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToCharFunction composeFromBoolean(@Nonnull final BooleanToShortFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToCharFunction composeFromByte(@Nonnull final ByteToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default CharUnaryOperator composeFromChar(@Nonnull final CharToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default DoubleToCharFunction composeFromDouble(@Nonnull final DoubleToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default FloatToCharFunction composeFromFloat(@Nonnull final FloatToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default IntToCharFunction composeFromInt(@Nonnull final IntToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default LongToCharFunction composeFromLong(@Nonnull final LongToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default ShortToCharFunction composeFromShort(@Nonnull final ShortUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default <S> ShortFunction<S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     * {@code ShortToCharFunction} with methods provided by the {@code JDK}.
     *
