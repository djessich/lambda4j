...
public interface ThrowableObjBiByteToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToIntFunction<T, X> of(
            @Nullable final ThrowableObjBiByteToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull final ThrowableObjBiByteToIntFunction<? super T, ? extends X> function, T t, byte value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiByteToIntFunction<T> nestWith(
    ...
    default ObjBiByteToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiByteToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiByteToIntFunction<? super T> function = recover.apply(throwable);
