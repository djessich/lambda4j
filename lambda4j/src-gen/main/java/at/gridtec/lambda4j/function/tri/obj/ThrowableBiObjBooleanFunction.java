...
public interface ThrowableBiObjBooleanFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjBooleanFunction<T, U, R, X> of(
            @Nullable final ThrowableBiObjBooleanFunction<T, U, R, X> expression) {
        return expression;
    }
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjBooleanFunction<T, U, Optional<R>, X> lift(
            @Nonnull final ThrowableBiObjBooleanFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
     ...
     */
    @Nonnull
    default BiObjBooleanFunction<T, U, R> nestWith(
    ...
    default BiObjBooleanFunction<T, U, R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjBooleanFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjBooleanFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
