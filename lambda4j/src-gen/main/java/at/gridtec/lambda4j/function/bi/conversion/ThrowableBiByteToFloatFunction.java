...
public interface ThrowableBiByteToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiByteToFloatFunction<X> of(
            @Nullable final ThrowableBiByteToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull final ThrowableBiByteToFloatFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableBiByteToFloatFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiBytePredicate<X> andThenToBoolean(@Nonnull final ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiByteToFloatFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiByteToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiByteToFloatFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiByteToFloatFunction function = recover.apply(throwable);
