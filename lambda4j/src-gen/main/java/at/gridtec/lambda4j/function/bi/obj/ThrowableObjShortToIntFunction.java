...
public interface ThrowableObjShortToIntFunction<T, X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ObjShortToIntFunction<T> nestWith(
    ...
    default ObjShortToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjShortToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjShortToIntFunction<? super T> function = recover.apply(throwable);
