...
public interface BiIntToLongFunction extends Lambda {
     ...
     */
    static BiIntToLongFunction of(@Nullable final BiIntToLongFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B> ToLongBiFunction2<A, B> compose(@Nonnull final ToIntFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction composeFromBoolean(@Nonnull final BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default BiByteToLongFunction composeFromByte(@Nonnull final ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default BiCharToLongFunction composeFromChar(@Nonnull final CharToIntFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToLongFunction composeFromDouble(@Nonnull final DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToLongFunction composeFromFloat(@Nonnull final FloatToIntFunction before1,
     ...
     */
    @Nonnull
    default LongBinaryOperator2 composeFromLong(@Nonnull final LongToIntFunction before1,
     ...
     */
    @Nonnull
    default BiShortToLongFunction composeFromShort(@Nonnull final ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default BiIntPredicate andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
