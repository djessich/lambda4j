 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, boolean, * boolean)}.
 *
...
public interface ThrowableObjBiBooleanToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiBooleanToLongFunction<T, X> of(
            @Nullable final ThrowableObjBiBooleanToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    default ObjBiBooleanToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiBooleanToLongFunction<? super T>> recover) {
        Objects.requireNonNull(recover);
        return (t, value1, value2) -> {
            try {
                return this.applyAsLongThrows(t, value1, value2);
            } catch (Throwable throwable) {
                final ObjBiBooleanToLongFunction<? super T> function = recover.apply(throwable);
