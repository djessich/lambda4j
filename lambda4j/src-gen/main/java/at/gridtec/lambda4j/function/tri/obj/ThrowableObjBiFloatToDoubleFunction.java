 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiFloatToDoubleFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiFloatToDoubleFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableObjBiFloatToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiFloatToDoubleFunction<T, X> of(
            @Nullable final ThrowableObjBiFloatToDoubleFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiFloatToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiFloatToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> double call(
            @Nonnull final ThrowableObjBiFloatToDoubleFunction<? super T, ? extends X> function, T t, float value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToDoubleFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToDoubleFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableFloatToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToDoubleFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableFloatToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToDoubleFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToDoubleFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@link ThrowableFloatToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToDoubleFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableFloatToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToDoubleFunction<T, X> onlyThird(
            @Nonnull final ThrowableFloatToDoubleFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiFloatToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToDoubleFunction<T, X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, float value1, float value2) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link
     * ThrowableBiFloatToDoubleFunction} as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableBiFloatToDoubleFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableBiFloatToDoubleFunction<X> papplyAsDoubleThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToDoubleFunction<X> papplyAsDoubleThrows(T t, float value1) {
        return (value2) -> this.applyAsDoubleThrows(t, value1, value2);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link
     * ThrowableObjFloatToDoubleFunction} as result.
     *
     * @param value1 The second argument to this function used to partially apply this function
     * @return A {@code ThrowableObjFloatToDoubleFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjFloatToDoubleFunction<T, X> papplyAsDoubleThrows(float value1) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> papplyAsDoubleThrows(float value1, float value2) {
    ...
    default <A, B, C> ThrowableToDoubleTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsDoubleThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriFunction<T, Float, Float, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link ObjBiFloatToDoubleFunction} that applies this function to its input and nests the
     * thrown {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiFloatToDoubleFunction} that applies this function to its input and nests the
     ...
     */
    @Nonnull
    default ObjBiFloatToDoubleFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiFloatToDoubleFunction<T> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiFloatToDoubleFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiFloatToDoubleFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiFloatToDoubleFunction<T> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiFloatToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiFloatToDoubleFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiFloatToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiFloatToDoubleFunction<? super T> function = recover.apply(throwable);
