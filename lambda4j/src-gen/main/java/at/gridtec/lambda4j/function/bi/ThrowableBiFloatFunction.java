...
public interface ThrowableBiFloatFunction<R, X extends Throwable> extends Lambda {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableBiFloatFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiIntFunction<R, X> composeFromInt(@Nonnull final ThrowableIntToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    @Deprecated
    @Nonnull
    default ThrowableBiFloatFunction<Optional<R>, X> nonNull() {
     ...
     */
    @Nonnull
    default BiFloatFunction<R> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiFloatFunction} that applies this function to its input and sneakily throws the
    ...
    default BiFloatFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiFloatFunction<? extends R>> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiFloatFunction<? extends R> function = recover.apply(throwable);
