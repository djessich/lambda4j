...
public interface ThrowableCharToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableCharToShortFunction<X> of(
            @Nonnull final ThrowableCharToShortFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code CharToShortFunction} that applies this function to its input and nests the thrown
