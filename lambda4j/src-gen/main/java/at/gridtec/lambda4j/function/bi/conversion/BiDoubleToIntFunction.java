...
public interface BiDoubleToIntFunction extends Lambda {
     ...
     */
    @Nonnull
    static BiDoubleToIntFunction of(@Nonnull final BiDoubleToIntFunction expression) {
        return expression;
    }
     ...
     * {@code BiDoubleToIntFunction} with JDK specific methods, only accepting {@code BiFunction}.
     *
