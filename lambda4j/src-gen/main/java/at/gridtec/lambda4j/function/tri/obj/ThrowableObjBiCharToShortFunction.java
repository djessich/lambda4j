...
public interface ThrowableObjBiCharToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToShortFunction<T, X> of(
            @Nullable final ThrowableObjBiCharToShortFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableBiCharToShortFunction<X> papplyAsShortThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToShortFunction<X> papplyAsShortThrows(T t, char value1) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToShortFunction<T, X> papplyAsShortThrows(char value1) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> papplyAsShortThrows(char value1, char value2) {
     ...
     */
    @Nonnull
    default ObjBiCharToShortFunction<T> nestWith(
    ...
    default ObjBiCharToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharToShortFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharToShortFunction<? super T> function = recover.apply(throwable);
