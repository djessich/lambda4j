...
public interface ThrowableTriLongToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriLongToShortFunction<X> of(
            @Nullable final ThrowableTriLongToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableTriLongToShortFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToShortFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriLongToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriLongToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriLongToShortFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriLongToShortFunction function = recover.apply(throwable);
