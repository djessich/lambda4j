...
public interface ThrowableObjBiDoubleFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> of(
            @Nullable final ThrowableObjBiDoubleFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjBiDoubleFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjBiDoubleFunction<? super T, ? extends R, ? extends X> function, T t,
    ...
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> onlySecond(
            @Nonnull final ThrowableDoubleFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjBiDoubleFunction<T, R> nestWith(
    ...
    default ObjBiDoubleFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiDoubleFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiDoubleFunction<? super T, ? extends R> function = recover.apply(throwable);
