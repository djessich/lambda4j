...
public interface ThrowableBiBooleanFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableBiBooleanFunction<R, X> of(
            @Nullable final ThrowableBiBooleanFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableBiBooleanFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableBiBooleanFunction<? extends R, ? extends X> partial) {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableBiBooleanFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiByteFunction<R, X> composeFromByte(@Nonnull final ThrowableBytePredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiCharFunction<R, X> composeFromChar(@Nonnull final ThrowableCharPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiFloatFunction<R, X> composeFromFloat(@Nonnull final ThrowableFloatPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiIntFunction<R, X> composeFromInt(@Nonnull final ThrowableIntPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongFunction<R, X> composeFromLong(@Nonnull final ThrowableLongPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiShortFunction<R, X> composeFromShort(@Nonnull final ThrowableShortPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiBooleanConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    @Deprecated
    @Nonnull
    default ThrowableBiBooleanFunction<Optional<R>, X> nonNull() {
     ...
     */
    @Nonnull
    default BiBooleanFunction<R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
