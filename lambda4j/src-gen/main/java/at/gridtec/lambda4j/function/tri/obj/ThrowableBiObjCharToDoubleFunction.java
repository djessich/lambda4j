...
public interface ThrowableBiObjCharToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToDoubleFunction<T, U, X> of(
            @Nullable final ThrowableBiObjCharToDoubleFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> double call(
            @Nonnull final ThrowableBiObjCharToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code BiObjCharToDoubleFunction} that applies this function to its input and nests the thrown
    ...
    default BiObjCharToDoubleFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjCharToDoubleFunction<? super T, ? super U>> recover) {
        Objects.requireNonNull(recover);
        return (t, u, value) -> {
            try {
                return this.applyAsDoubleThrows(t, u, value);
            } catch (Throwable throwable) {
                final BiObjCharToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
