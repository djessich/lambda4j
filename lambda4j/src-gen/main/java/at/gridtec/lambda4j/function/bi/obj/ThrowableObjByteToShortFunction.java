...
public interface ThrowableObjByteToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjByteToShortFunction<T, X> of(
            @Nullable final ThrowableObjByteToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull final ThrowableObjByteToShortFunction<? super T, ? extends X> function, T t, byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjByteToShortFunction<T> nestWith(
    ...
    default ObjByteToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjByteToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjByteToShortFunction<? super T> function = recover.apply(throwable);
