 ...
 * This is a (reference, short) specialization of {@link ThrowableBiFunction}.
 * <p>
...
public interface ThrowableObjShortToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToDoubleFunction<T, X> of(
            @Nullable final ThrowableObjShortToDoubleFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> nestWith(
    ...
    default ObjShortToDoubleFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjShortToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjShortToDoubleFunction<? super T> function = recover.apply(throwable);
