...
public interface TriShortFunction<R> extends Lambda {
     ...
     */
    static <R> TriShortFunction<R> of(@Nullable final TriShortFunction<R> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <R> TriShortFunction<Optional<R>> lift(@Nonnull final TriShortFunction<? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <R> R call(@Nonnull final TriShortFunction<? extends R> function, short value1, short value2, short value3) {
     ...
     */
    @Nonnull
    static <R> TriShortFunction<R> onlyFirst(@Nonnull final ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <R> TriShortFunction<R> onlySecond(@Nonnull final ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <R> TriShortFunction<R> onlyThird(@Nonnull final ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B, C> TriFunction<A, B, C, R> compose(@Nonnull final ToShortFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanFunction<R> composeFromBoolean(@Nonnull final BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default TriByteFunction<R> composeFromByte(@Nonnull final ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default TriCharFunction<R> composeFromChar(@Nonnull final CharToShortFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> composeFromDouble(@Nonnull final DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default TriFloatFunction<R> composeFromFloat(@Nonnull final FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default TriIntFunction<R> composeFromInt(@Nonnull final IntToShortFunction before1,
     ...
     */
    @Nonnull
    default TriLongFunction<R> composeFromLong(@Nonnull final LongToShortFunction before1,
     ...
     */
    @Nonnull
    default TriShortFunction<R> composeFromShort(@Nonnull final ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <S> TriShortFunction<S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
     ...
     * {@code TriShortFunction} with methods provided by the {@code JDK}.
     *
