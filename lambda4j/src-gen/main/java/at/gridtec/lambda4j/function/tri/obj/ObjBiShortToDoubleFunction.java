...
import at.gridtec.lambda4j.function.bi.obj.ObjShortToDoubleFunction;
...
public interface ObjBiShortToDoubleFunction<T> extends Lambda {
     ...
     */
    static <T> ObjBiShortToDoubleFunction<T> of(@Nullable final ObjBiShortToDoubleFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> double call(@Nonnull final ObjBiShortToDoubleFunction<? super T> function, T t, short value1,
            short value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiShortToDoubleFunction<T> onlySecond(@Nonnull final ShortToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjBiShortToDoubleFunction<T> onlyThird(@Nonnull final ShortToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjBiShortFunction<T, S> andThen(@Nonnull final DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiShortPredicate<T> andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToByteFunction<T> andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToCharFunction<T> andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToFloatFunction<T> andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToIntFunction<T> andThenToInt(@Nonnull final DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToLongFunction<T> andThenToLong(@Nonnull final DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToShortFunction<T> andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortConsumer<T> consume(@Nonnull final DoubleConsumer consumer) {
