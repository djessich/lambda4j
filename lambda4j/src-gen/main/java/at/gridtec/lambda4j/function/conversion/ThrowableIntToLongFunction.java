 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(int)}.
 *
...
@FunctionalInterface
public interface ThrowableIntToLongFunction<X extends Throwable> extends Lambda, IntToLongFunction {

    /**
     * Constructs a {@link ThrowableIntToLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableIntToLongFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableIntToLongFunction<X> of(
            @Nullable final ThrowableIntToLongFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableIntToLongFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableIntToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableIntToLongFunction<? extends X> function,
            int value) throws X {
    ...
    /**
     * Creates a {@link ThrowableIntToLongFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableIntToLongFunction<X> constant(long ret) {
        return (value) -> ret;
    }
     ...
     * @param value The argument to the function
     * @return The return value from the function, which is its result.
     * @apiNote This method mainly exists to use this {@link ThrowableIntToLongFunction} in JRE specific methods only
     * accepting {@link IntToLongFunction}. If this function should be applied, then the {@link #applyAsLongThrows(int)}
     * method should be used.
     * @apiNote Overrides the {@link IntToLongFunction#applyAsLong(int)} method by using a redefinition as default
     * method. This implementation calls the {@link #applyAsLongThrows(int)} method of this function and catches the
    ...
    default <A> ThrowableToLongFunction<A, X> compose(
        ...
        return (a) -> applyAsLongThrows(before.applyAsIntThrows(a));
    }
    ...
    default ThrowableBooleanToLongFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsLongThrows(before.applyAsIntThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableIntToLongFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * This method is just convenience, to provide the ability to execute an operation which accepts {@code int} input,
     * before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableIntToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default ThrowableIntToLongFunction<X> composeFromInt(@Nonnull final ThrowableIntUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLongThrows(before.applyAsIntThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableLongUnaryOperator} that first applies the {@code before} function to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableIntPredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> andThenToByte(@Nonnull final ThrowableLongToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToCharFunction<X> andThenToChar(@Nonnull final ThrowableLongToCharFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> andThenToInt(@Nonnull final ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToLongFunction<X> andThenToLong(@Nonnull final ThrowableLongUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsLongThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableIntToLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableIntToLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableIntToLongFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Integer, Long> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableIntToLongFunction<X> & Memoized) (value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableIntToLongFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableIntToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableIntToLongFunction}.
     */
    @Nonnull
    default ThrowableFunction<Integer, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link IntToLongFunction2} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link IntToLongFunction2} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default IntToLongFunction2 nest() {
     ...
     */
    @Nonnull
    default IntToLongFunction2 nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link IntToLongFunction2} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link IntToLongFunction2} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default IntToLongFunction2 sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsLongThrows(value);
            } catch (RuntimeException | Error e) {
     ...
     * @return A composed {@link IntToLongFunction2} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default IntToLongFunction2 recover(
            @Nonnull final Function<? super Throwable, ? extends IntToLongFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final IntToLongFunction function = recover.apply(throwable);
