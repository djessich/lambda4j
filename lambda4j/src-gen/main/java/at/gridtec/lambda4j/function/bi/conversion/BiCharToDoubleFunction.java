...
public interface BiCharToDoubleFunction extends Lambda {
     ...
     */
    static BiCharToDoubleFunction of(@Nullable final BiCharToDoubleFunction expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiCharToDoubleFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
