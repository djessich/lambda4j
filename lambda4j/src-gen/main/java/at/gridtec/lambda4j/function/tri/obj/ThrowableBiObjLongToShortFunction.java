...
public interface ThrowableBiObjLongToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToShortFunction<T, U, X> of(
            @Nullable final ThrowableBiObjLongToShortFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> short call(
            @Nonnull final ThrowableBiObjLongToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjLongToShortFunction<T, U> nestWith(
    ...
    default BiObjLongToShortFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return this.applyAsShortThrows(t, u, value);
    ...
    default BiObjLongToShortFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjLongToShortFunction<? super T, ? super U> function = recover.apply(throwable);
