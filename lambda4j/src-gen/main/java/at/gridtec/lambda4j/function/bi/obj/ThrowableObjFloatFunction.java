...
public interface ThrowableObjFloatFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjFloatFunction<T, R, X> of(
            @Nullable final ThrowableObjFloatFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjFloatFunction} into a total {@link ThrowableObjFloatFunction} that returns an
     ...
     * @return A partial {@code ThrowableObjFloatFunction} lifted into a total {@code ThrowableObjFloatFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjFloatFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjFloatFunction<? super T, ? extends R, ? extends X> partial) {
     ...
     * {@code ThrowableObjFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjFloatFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjFloatFunction<T, R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjFloatFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjFloatFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjFloatFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjFloatFunction<? super T, ? extends R> function = recover.apply(throwable);
