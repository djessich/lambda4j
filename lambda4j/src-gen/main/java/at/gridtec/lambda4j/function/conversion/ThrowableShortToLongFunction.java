 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(short)}.
 *
...
@FunctionalInterface
public interface ThrowableShortToLongFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableShortToLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableShortToLongFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableShortToLongFunction<X> of(
            @Nullable final ThrowableShortToLongFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableShortToLongFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableShortToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableShortToLongFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableShortToLongFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableShortToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableShortToLongFunction<X> constant(long ret) {
        return (value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(short value) throws X;
    ...
    default <A> ThrowableToLongFunction<A, X> compose(
        ...
        return (a) -> applyAsLongThrows(before.applyAsShortThrows(a));
    }
    ...
    default ThrowableBooleanToLongFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsLongThrows(before.applyAsShortThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableShortToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code short} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableShortToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * short}.
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> andThenToInt(@Nonnull final ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableShortToLongFunction}.
    ...
    default ThrowableShortToLongFunction<X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableShortToLongFunction<X> & Memoized) (value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableShortToLongFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableShortToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableShortToLongFunction}.
     */
    @Nonnull
    default ThrowableFunction<Short, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link ShortToLongFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ShortToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ShortToLongFunction nest() {
     ...
     */
    @Nonnull
    default ShortToLongFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default ShortToLongFunction recover(
            @Nonnull final Function<? super Throwable, ? extends ShortToLongFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ShortToLongFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ShortToLongFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ShortToLongFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ShortToLongFunction sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsLongThrows(value);
