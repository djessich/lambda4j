...
public interface ThrowableObjShortToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToByteFunction<T, X> of(
            @Nullable final ThrowableObjShortToByteFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableShortToByteFunction<X> papplyAsByteThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> papplyAsByteThrows(short value) {
     ...
     */
    @Nonnull
    default ObjShortToByteFunction<T> nestWith(
    ...
    default ObjShortToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjShortToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjShortToByteFunction<? super T> function = recover.apply(throwable);
