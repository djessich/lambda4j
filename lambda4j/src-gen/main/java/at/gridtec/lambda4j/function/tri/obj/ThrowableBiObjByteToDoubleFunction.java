...
public interface ThrowableBiObjByteToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToDoubleFunction<T, U, X> of(
            @Nullable final ThrowableBiObjByteToDoubleFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> double call(
            @Nonnull final ThrowableBiObjByteToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjByteToDoubleFunction<T, U> nestWith(
    ...
    default BiObjByteToDoubleFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjByteToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjByteToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
