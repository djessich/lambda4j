...
public interface ThrowableObjFloatToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToFloatFunction<T, X> of(
            @Nullable final ThrowableObjFloatToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     * this {@code ThrowableObjFloatToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjFloatToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> nestWith(
     ...
     * @return A composed {@link ObjFloatToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjFloatToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjFloatToFloatFunction<? super T> function = recover.apply(throwable);
