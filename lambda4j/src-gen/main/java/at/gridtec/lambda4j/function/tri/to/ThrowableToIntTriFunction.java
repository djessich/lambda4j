...
public interface ThrowableToIntTriFunction<T, U, V, X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ToIntTriFunction<T, U, V> nestWith(
    ...
    default ToIntTriFunction<T, U, V> recover(
            @Nonnull final Function<? super Throwable, ? extends ToIntTriFunction<? super T, ? super U, ? super V>> recover) {
        ...
        return (t, u, v) -> {
            try {
                ...
                final ToIntTriFunction<? super T, ? super U, ? super V> function = recover.apply(throwable);
