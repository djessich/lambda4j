...
public interface ObjBiShortToShortFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjBiShortToShortFunction<T> of(@Nonnull final ObjBiShortToShortFunction<T> expression) {
        return expression;
    }
     ...
     * to use this {@code ObjBiShortToShortFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
