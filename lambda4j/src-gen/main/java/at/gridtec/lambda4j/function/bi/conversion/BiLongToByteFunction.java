...
public interface BiLongToByteFunction extends Lambda {
    ...
    /**
     * Returns a composed {@link BiLongToByteFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     * {@code BiLongToByteFunction} with methods provided by the {@code JDK}.
     *
