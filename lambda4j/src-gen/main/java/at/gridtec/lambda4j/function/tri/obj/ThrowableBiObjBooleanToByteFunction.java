 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, Object, boolean)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjBooleanToByteFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjBooleanToByteFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjBooleanToByteFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToByteFunction<T, U, X> of(
            @Nullable final ThrowableBiObjBooleanToByteFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjBooleanToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjBooleanToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableBiObjBooleanToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToByteFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjBooleanToByteFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToByteFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjBooleanToByteFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToByteFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToByteFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjBooleanToByteFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableBooleanToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToByteFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjBooleanToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToByteFunction<T, U, X> constant(byte ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, U u, boolean value) throws X;
     ...
     */
    default byte applyAsByteThrows(@Nonnull Pair<T, U> tuple, boolean value) throws X {
    ...
    default <A, B, C> ThrowableToByteTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsByteThrows(before1.applyThrows(a), before2.applyThrows(b), before3.testThrows(c));
    }
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjBooleanToByteFunction<Pair<T, U>, X> tupled() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjBooleanToByteFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjBooleanToByteFunction}.
    ...
    default ThrowableBiObjBooleanToByteFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableBiObjBooleanToByteFunction<T, U, X> & Memoized) (t, u, value) -> {
     ...
     * ThrowableBiObjBooleanToByteFunction}. Thereby the primitive input argument for this function is autoboxed. This
     * method provides the possibility to use this {@code ThrowableBiObjBooleanToByteFunction} with methods provided by
     * the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjBooleanToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Boolean, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link BiObjBooleanToByteFunction} that applies this function to its input and nests the
     * thrown {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjBooleanToByteFunction} that applies this function to its input and nests the
     ...
     */
    @Nonnull
    default BiObjBooleanToByteFunction<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjBooleanToByteFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjBooleanToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjBooleanToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjBooleanToByteFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjBooleanToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjBooleanToByteFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjBooleanToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjBooleanToByteFunction<? super T, ? super U> function = recover.apply(throwable);
