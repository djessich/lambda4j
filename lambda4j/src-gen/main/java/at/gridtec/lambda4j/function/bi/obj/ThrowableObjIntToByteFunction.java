...
public interface ThrowableObjIntToByteFunction<T, X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> papplyAsByteThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> papplyAsByteThrows(int value) {
     ...
     */
    @Nonnull
    default ObjIntToByteFunction<T> nestWith(
    ...
    default ObjIntToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjIntToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjIntToByteFunction<? super T> function = recover.apply(throwable);
