...
public interface TriShortToFloatFunction extends Lambda {
     ...
     */
    static TriShortToFloatFunction of(@Nullable final TriShortToFloatFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToFloatTriFunction<A, B, C> compose(@Nonnull final ToShortFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToFloatFunction composeFromBoolean(@Nonnull final BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default TriByteToFloatFunction composeFromByte(@Nonnull final ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default TriCharToFloatFunction composeFromChar(@Nonnull final CharToShortFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToFloatFunction composeFromDouble(@Nonnull final DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default FloatTernaryOperator composeFromFloat(@Nonnull final FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default TriIntToFloatFunction composeFromInt(@Nonnull final IntToShortFunction before1,
     ...
     */
    @Nonnull
    default TriLongToFloatFunction composeFromLong(@Nonnull final LongToShortFunction before1,
     ...
     */
    @Nonnull
    default TriShortToFloatFunction composeFromShort(@Nonnull final ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <S> TriShortFunction<S> andThen(@Nonnull final FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriShortPredicate andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortConsumer consume(@Nonnull final FloatConsumer consumer) {
     ...
     * to use this {@code TriShortToFloatFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
