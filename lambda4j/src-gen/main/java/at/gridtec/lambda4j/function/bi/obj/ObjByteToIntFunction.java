...
public interface ObjByteToIntFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    default ByteToIntFunction papplyAsInt(T t) {
     ...
     */
    @Nonnull
    default ToIntFunction2<T> papplyAsInt(byte value) {
     ...
     * {@code ObjByteToIntFunction} with methods provided by the {@code JDK}.
     *
