...
public interface ThrowableToByteBiFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableToByteBiFunction<T, U, X> of(
            @Nullable final ThrowableToByteBiFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableToByteBiFunction<? super T, ? super U, ? extends X> function, T t, U u) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> andThenToBoolean(@Nonnull final ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ToByteBiFunction<T, U> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ToByteBiFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends ToByteBiFunction<? super T, ? super U>> recover) {
        Objects.requireNonNull(recover);
        return (t, u) -> {
            try {
                return this.applyAsByteThrows(t, u);
            } catch (Error e) {
                throw e;
            } catch (Throwable throwable) {
                final ToByteBiFunction<? super T, ? super U> function = recover.apply(throwable);
