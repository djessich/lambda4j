...
public interface TriBooleanToDoubleFunction extends Lambda {
     ...
     */
    static TriBooleanToDoubleFunction of(@Nullable final TriBooleanToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    static double call(@Nonnull final TriBooleanToDoubleFunction function, boolean value1, boolean value2,
            boolean value3) {
     ...
     */
    @Nonnull
    static TriBooleanToDoubleFunction onlyFirst(@Nonnull final BooleanToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriBooleanToDoubleFunction onlySecond(@Nonnull final BooleanToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriBooleanToDoubleFunction onlyThird(@Nonnull final BooleanToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default TriBooleanToDoubleFunction composeFromBoolean(@Nonnull final BooleanUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link TriByteToDoubleFunction} that first applies the {@code before} predicates to
     ...
     */
    @Nonnull
    default TriByteToDoubleFunction composeFromByte(@Nonnull final BytePredicate before1,
    ...
    /**
     * Returns a composed {@link TriCharToDoubleFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default TriCharToDoubleFunction composeFromChar(@Nonnull final CharPredicate before1,
     ...
     */
    @Nonnull
    default DoubleTernaryOperator composeFromDouble(@Nonnull final DoublePredicate before1,
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction composeFromFloat(@Nonnull final FloatPredicate before1,
    ...
    /**
     * Returns a composed {@link TriIntToDoubleFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default TriIntToDoubleFunction composeFromInt(@Nonnull final IntPredicate before1,
    ...
    /**
     * Returns a composed {@link TriLongToDoubleFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction composeFromLong(@Nonnull final LongPredicate before1,
     ...
     */
    @Nonnull
    default TriShortToDoubleFunction composeFromShort(@Nonnull final ShortPredicate before1,
     ...
     */
    @Nonnull
    default TriBooleanToByteFunction andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToCharFunction andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToFloatFunction andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToShortFunction andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanConsumer consume(@Nonnull final DoubleConsumer consumer) {
     ...
     * to use this {@code TriBooleanToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
