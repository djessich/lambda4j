...
public interface ThrowableObjBooleanToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBooleanToIntFunction<T, X> of(
            @Nullable final ThrowableObjBooleanToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     * this {@code ThrowableObjBooleanToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBooleanToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBooleanToIntFunction<T> nestWith(
     ...
     * @return A composed {@link ObjBooleanToIntFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBooleanToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBooleanToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjBooleanToIntFunction<? super T> function = recover.apply(throwable);
