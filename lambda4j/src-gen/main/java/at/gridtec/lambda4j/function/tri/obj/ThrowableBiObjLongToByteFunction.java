...
public interface ThrowableBiObjLongToByteFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToByteFunction<T, U, X> of(
            @Nullable final ThrowableBiObjLongToByteFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableBiObjLongToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> nestWith(
    ...
    default BiObjLongToByteFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjLongToByteFunction<? super T, ? super U> function = recover.apply(throwable);
