...
public interface ThrowableBiObjFloatFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjFloatFunction<T, U, R, X> of(
            @Nullable final ThrowableBiObjFloatFunction<T, U, R, X> expression) {
        return expression;
    }
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjFloatFunction<T, U, Optional<R>, X> lift(
            @Nonnull final ThrowableBiObjFloatFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
    ...
    static <T, U, R, X extends Throwable> R call(
            @Nonnull final ThrowableBiObjFloatFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableObjFloatFunction<U, R, X> papplyThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatFunction<R, X> papplyThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, U, R, X> papplyThrows(float value) {
     ...
     */
    @Nonnull
    default ThrowableFunction<U, R, X> papplyThrows(T t, float value) {
     ...
     */
    @Nonnull
    default BiObjFloatFunction<T, U, R> nestWith(
    ...
    default BiObjFloatFunction<T, U, R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjFloatFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjFloatFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
