...
public interface ThrowableObjBiDoubleToLongFunction<T, X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToLongFunction<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToLongFunction<X> papplyAsLongThrows(T t, double value1) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToLongFunction<T, X> papplyAsLongThrows(double value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(double value1, double value2) {
     ...
     */
    @Nonnull
    default ObjBiDoubleToLongFunction<T> nestWith(
    ...
    default ObjBiDoubleToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiDoubleToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiDoubleToLongFunction<? super T> function = recover.apply(throwable);
