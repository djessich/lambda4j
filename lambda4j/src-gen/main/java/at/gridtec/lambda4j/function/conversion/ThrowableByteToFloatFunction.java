...
public interface ThrowableByteToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableByteToFloatFunction<X> of(
            @Nullable final ThrowableByteToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull final ThrowableByteToFloatFunction<? extends X> function,
            byte value) throws X {
    ...
    /**
     * Returns a composed {@link ThrowableByteToFloatFunction} that first applies the {@code before} operator to
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> andThenToBoolean(@Nonnull final ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> andThenToInt(@Nonnull final ThrowableFloatToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ByteToFloatFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ByteToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends ByteToFloatFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ByteToFloatFunction function = recover.apply(throwable);
