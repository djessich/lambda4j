...
public interface ThrowableObjLongToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToCharFunction<T, X> of(
            @Nullable final ThrowableObjLongToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull final ThrowableObjLongToCharFunction<? super T, ? extends X> function, T t, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> andThenToBoolean(@Nonnull final ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjLongToCharFunction<T> nestWith(
    ...
    default ObjLongToCharFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjLongToCharFunction<? super T> function = recover.apply(throwable);
