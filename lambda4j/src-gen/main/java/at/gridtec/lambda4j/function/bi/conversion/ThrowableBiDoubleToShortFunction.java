...
public interface ThrowableBiDoubleToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleToShortFunction<X> of(
            @Nullable final ThrowableBiDoubleToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableBiDoubleToShortFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoublePredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiDoubleConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiDoubleToShortFunction nestWith(
    ...
    default BiDoubleToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiDoubleToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiDoubleToShortFunction function = recover.apply(throwable);
