...
public interface ThrowableObjBiCharToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToIntFunction<T, X> of(
            @Nullable final ThrowableObjBiCharToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull final ThrowableObjBiCharToIntFunction<? super T, ? extends X> function, T t, char value1,
     ...
     */
    @Nonnull
    default ThrowableBiCharToIntFunction<X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> papplyAsIntThrows(T t, char value1) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToIntFunction<T, X> papplyAsIntThrows(char value1) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> papplyAsIntThrows(char value1, char value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiCharToIntFunction<T> nestWith(
    ...
    default ObjBiCharToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharToIntFunction<? super T> function = recover.apply(throwable);
