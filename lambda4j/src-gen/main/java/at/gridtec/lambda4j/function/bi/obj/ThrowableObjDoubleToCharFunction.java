...
public interface ThrowableObjDoubleToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToCharFunction<T, X> of(
            @Nullable final ThrowableObjDoubleToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull final ThrowableObjDoubleToCharFunction<? super T, ? extends X> function, T t, double value) throws
            X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjDoubleToCharFunction<T> nestWith(
    ...
    default ObjDoubleToCharFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjDoubleToCharFunction<? super T> function = recover.apply(throwable);
