...
public interface ThrowableObjCharToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToCharFunction<T, X> of(
            @Nullable final ThrowableObjCharToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjCharToCharFunction<T> nestWith(
    ...
    default ObjCharToCharFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjCharToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjCharToCharFunction<? super T> function = recover.apply(throwable);
