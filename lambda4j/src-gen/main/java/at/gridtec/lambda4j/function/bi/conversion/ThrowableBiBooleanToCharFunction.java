...
public interface ThrowableBiBooleanToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiBooleanToCharFunction<X> of(
            @Nullable final ThrowableBiBooleanToCharFunction<X> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiByteToCharFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
    ...
    /**
     * Returns a composed {@link ThrowableCharBinaryOperator} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
    ...
    /**
     * Returns a composed {@link ThrowableBiIntToCharFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
    ...
    /**
     * Returns a composed {@link ThrowableBiLongToCharFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction nestWith(
    ...
    default BiBooleanToCharFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiBooleanToCharFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiBooleanToCharFunction function = recover.apply(throwable);
