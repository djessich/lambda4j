...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjShortToFloatFunction;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(Object, Object, short)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjShortToFloatFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjShortToFloatFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjShortToFloatFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjShortToFloatFunction<T, U, X> of(
            @Nullable final ThrowableBiObjShortToFloatFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjShortToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjShortToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> float call(
            @Nonnull final ThrowableBiObjShortToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToFloatFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjShortToFloatFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToFloatFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjShortToFloatFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToFloatFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToFloatFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjShortToFloatFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableShortToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToFloatFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjShortToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjShortToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortToFloatFunction<T, U, X> constant(float ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(T t, U u, short value) throws X;
     ...
     */
    default float applyAsFloatThrows(@Nonnull Pair<T, U> tuple, short value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjShortToFloatFunction<U, X> papplyAsFloatThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToFloatFunction<X> papplyAsFloatThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToFloatBiFunction<T, U, X> papplyAsFloatThrows(short value) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<U, X> papplyAsFloatThrows(T t, short value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjShortConsumer<T, U, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjShortToFloatFunction<Pair<T, U>, X> tupled() {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjShortToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjShortToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjShortToFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Short, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link BiObjShortToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjShortToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjShortToFloatFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjShortToFloatFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjShortToFloatFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjShortToFloatFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjShortToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjShortToFloatFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjShortToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjShortToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
