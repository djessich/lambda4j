...
public interface ThrowableTriDoubleToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToLongFunction<X> of(
            @Nullable final ThrowableTriDoubleToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableTriDoubleToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToLongFunction<X> papplyAsLongThrows(double value1) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToLongFunction<X> papplyAsLongThrows(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableTriDoublePredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction nestWith(
    ...
    default TriDoubleToLongFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriDoubleToLongFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriDoubleToLongFunction function = recover.apply(throwable);
