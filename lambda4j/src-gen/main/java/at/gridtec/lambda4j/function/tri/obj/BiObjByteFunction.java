...
public interface BiObjByteFunction<T, U, R> extends Lambda {
     ...
     */
    static <T, U, R> BiObjByteFunction<T, U, R> of(@Nullable final BiObjByteFunction<T, U, R> expression) {
        return expression;
    }
    ...
    static <T, U, R> BiObjByteFunction<T, U, Optional<R>> lift(
            @Nonnull final BiObjByteFunction<? super T, ? super U, ? extends R> partial) {
     ...
     */
    @Nonnull
    default ObjByteFunction<U, R> papply(T t) {
     ...
     */
    @Nonnull
    default ByteFunction<R> papply(T t, U u) {
     ...
     */
    @Nonnull
    default BiFunction2<T, U, R> papply(byte value) {
     ...
     */
    @Nonnull
    default Function2<U, R> papply(T t, byte value) {
     ...
     * {@code BiObjByteFunction} with methods provided by the {@code JDK}.
     *
