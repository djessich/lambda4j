...
public interface TriIntToShortFunction extends Lambda {
     ...
     */
    static TriIntToShortFunction of(@Nullable final TriIntToShortFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToShortTriFunction<A, B, C> compose(@Nonnull final ToIntFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToShortFunction composeFromBoolean(@Nonnull final BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default TriByteToShortFunction composeFromByte(@Nonnull final ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default TriCharToShortFunction composeFromChar(@Nonnull final CharToIntFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToShortFunction composeFromFloat(@Nonnull final FloatToIntFunction before1,
     ...
     */
    @Nonnull
    default TriLongToShortFunction composeFromLong(@Nonnull final LongToIntFunction before1,
     ...
     */
    @Nonnull
    default ShortTernaryOperator composeFromShort(@Nonnull final ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default <S> TriIntFunction<S> andThen(@Nonnull final ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriIntPredicate andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntConsumer consume(@Nonnull final ShortConsumer consumer) {
     ...
     * {@code TriIntToShortFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
