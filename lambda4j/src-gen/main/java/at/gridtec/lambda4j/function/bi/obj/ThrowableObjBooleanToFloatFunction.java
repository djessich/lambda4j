...
public interface ThrowableObjBooleanToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBooleanToFloatFunction<T, X> of(
            @Nullable final ThrowableObjBooleanToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    default ObjBooleanToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBooleanToFloatFunction<? super T>> recover) {
        Objects.requireNonNull(recover);
        return (t, value) -> {
            try {
                return this.applyAsFloatThrows(t, value);
            } catch (Throwable throwable) {
                final ObjBooleanToFloatFunction<? super T> function = recover.apply(throwable);
