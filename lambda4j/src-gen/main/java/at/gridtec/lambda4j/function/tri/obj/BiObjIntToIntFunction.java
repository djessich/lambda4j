...
public interface BiObjIntToIntFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjIntToIntFunction<T, U> of(@Nullable final BiObjIntToIntFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> int call(@Nonnull final BiObjIntToIntFunction<? super T, ? super U> function, T t, U u, int value) {
    ...
    /**
     * Applies this operator partially to some arguments of this one, producing a {@link ObjIntToIntFunction} as result.
     *
     ...
     */
    @Nonnull
    default BiObjIntToByteFunction<T, U> andThenToByte(@Nonnull final IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToCharFunction<T, U> andThenToChar(@Nonnull final IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToDoubleFunction<T, U> andThenToDouble(@Nonnull final IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToFloatFunction<T, U> andThenToFloat(@Nonnull final IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjIntToShortFunction<T, U> andThenToShort(@Nonnull final IntToShortFunction after) {
        Objects.requireNonNull(after);
