...
public interface ObjLongToByteFunction<T> extends Lambda {
     ...
     */
    @Nonnull
    default LongToByteFunction papplyAsByte(T t) {
     ...
     */
    @Nonnull
    default ToByteFunction<T> papplyAsByte(long value) {
     ...
     * {@code ObjLongToByteFunction} with methods provided by the {@code JDK}.
     *
