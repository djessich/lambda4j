...
import at.gridtec.lambda4j.predicate.tri.obj.ThrowableBiObjCharPredicate;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(Object, Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjCharToCharFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjCharToCharFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjCharToCharFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjCharToCharFunction<T, U, X> of(
            @Nullable final ThrowableBiObjCharToCharFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjCharToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjCharToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> char call(
            @Nonnull final ThrowableBiObjCharToCharFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToCharFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjCharToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToCharFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToCharFunction} which uses the {@code second} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjCharToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToCharFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToCharFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjCharToCharFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToCharFunction<T, U, X> onlyThird(
            @Nonnull final ThrowableCharUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, u, value) -> operator.applyAsCharThrows(value);
    }

    /**
     * Creates a {@link ThrowableBiObjCharToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjCharToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToCharFunction<T, U, X> constant(char ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(T t, U u, char value) throws X;
     ...
     */
    default char applyAsCharThrows(@Nonnull Pair<T, U> tuple, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharToCharFunction<U, X> papplyAsCharThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharUnaryOperator<X> papplyAsCharThrows(T t, U u) {
        return (value) -> this.applyAsCharThrows(t, u, value);
    }

    /**
     * Applies this operator partially to some arguments of this one, producing a {@link ThrowableToCharBiFunction} as
     * result.
     *
     * @param value The third argument to this function used to partially apply this function
     * @return A {@code ThrowableToCharBiFunction} that represents this operator partially applied the some arguments.
     */
    @Nonnull
    default ThrowableToCharBiFunction<T, U, X> papplyAsCharThrows(char value) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<U, X> papplyAsCharThrows(T t, char value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToCharFunction<Pair<T, U>, X> tupled() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjCharToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjCharToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjCharToCharFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Character>, Character> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjCharToCharFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjCharToCharFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjCharToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjCharToCharFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Character, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link BiObjCharToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjCharToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjCharToCharFunction<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjCharToCharFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjCharToCharFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjCharToCharFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjCharToCharFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjCharToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjCharToCharFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjCharToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjCharToCharFunction<? super T, ? super U> function = recover.apply(throwable);
