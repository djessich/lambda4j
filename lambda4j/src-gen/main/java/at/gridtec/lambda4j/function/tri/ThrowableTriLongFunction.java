...
public interface ThrowableTriLongFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableTriLongFunction<R, X> of(
            @Nullable final ThrowableTriLongFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableTriLongFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableTriLongFunction<? extends R, ? extends X> partial) {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableTriLongFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriIntFunction<R, X> composeFromInt(@Nonnull final ThrowableIntToLongFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriLongFunction<R> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link TriLongFunction} that applies this function to its input and sneakily throws the
    ...
    default TriLongFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends TriLongFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriLongFunction<? extends R> function = recover.apply(throwable);
