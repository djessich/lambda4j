...
public interface ShortToFloatFunction extends Lambda {
     ...
     */
    static ShortToFloatFunction of(@Nullable final ShortToFloatFunction expression) {
        return expression;
    }
     ...
     */
    static float call(@Nonnull final ShortToFloatFunction function, short value) {
     ...
     */
    @Nonnull
    default BooleanToFloatFunction composeFromBoolean(@Nonnull final BooleanToShortFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToFloatFunction composeFromByte(@Nonnull final ByteToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsFloat(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default CharToFloatFunction composeFromChar(@Nonnull final CharToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsFloat(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default DoubleToFloatFunction composeFromDouble(@Nonnull final DoubleToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsFloat(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default FloatUnaryOperator composeFromFloat(@Nonnull final FloatToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsFloat(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default IntToFloatFunction composeFromInt(@Nonnull final IntToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsFloat(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default LongToFloatFunction composeFromLong(@Nonnull final LongToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsFloat(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default ShortToFloatFunction composeFromShort(@Nonnull final ShortUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsFloat(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default ShortPredicate andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToByteFunction andThenToByte(@Nonnull final FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToCharFunction andThenToChar(@Nonnull final FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToDoubleFunction andThenToDouble(@Nonnull final FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToFloatFunction andThenToFloat(@Nonnull final FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToIntFunction andThenToInt(@Nonnull final FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToLongFunction andThenToLong(@Nonnull final FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortUnaryOperator andThenToShort(@Nonnull final FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortConsumer consume(@Nonnull final FloatConsumer consumer) {
    ...
    /**
     * Returns a composed {@link Function} which represents this {@link ShortToFloatFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ShortToFloatFunction} with JDK specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code ShortToFloatFunction}.
     */
    @Nonnull
    default Function<Short, Float> boxed() {
