...
public interface ThrowableBiShortToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiShortToLongFunction<X> of(
            @Nullable final ThrowableBiShortToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableBiShortToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiShortConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiShortToLongFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiShortToLongFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiShortToLongFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiShortToLongFunction function = recover.apply(throwable);
