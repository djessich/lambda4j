...
public interface ThrowableToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableToCharFunction<T, X> of(
            @Nullable final ThrowableToCharFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    static <T, X extends Throwable> char call(@Nonnull final ThrowableToCharFunction<? super T, ? extends X> function,
            T t) throws X {
     ...
     */
    @Nonnull
    default ThrowablePredicate<T, X> andThenToBoolean(@Nonnull final ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> andThenToByte(@Nonnull final ThrowableCharToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> andThenToChar(@Nonnull final ThrowableCharUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> andThenToInt(@Nonnull final ThrowableCharToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> andThenToLong(@Nonnull final ThrowableCharToLongFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
    ...
    default ThrowableToCharFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableToCharFunction<T, X> & Memoized) (t) -> {
                ...
                synchronized (lock) {
                    returnValue = cache.computeIfAbsent(t, ThrowableFunction.of(this::applyAsCharThrows));
                }
                return returnValue;
            };
        }
     ...
     *
     * @return A composed {@code ToCharFunction} that applies this function to its input and nests the thrown {@code
    ...
    /**
     * Returns a composed {@link ToCharFunction} that applies this function to its input and sneakily throws the
