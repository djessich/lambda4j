...
public interface ThrowableTriCharFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableTriCharFunction<R, X> of(
            @Nullable final ThrowableTriCharFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableTriCharFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableTriCharFunction<? extends R, ? extends X> partial) {
    ...
    /**
     * Returns a composed {@link ThrowableTriCharFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default TriCharFunction<R> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link TriCharFunction} that applies this function to its input and sneakily throws the
    ...
    default TriCharFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends TriCharFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriCharFunction<? extends R> function = recover.apply(throwable);
