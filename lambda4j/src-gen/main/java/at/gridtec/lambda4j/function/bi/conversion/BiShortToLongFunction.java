...
public interface BiShortToLongFunction extends Lambda {
     ...
     */
    static BiShortToLongFunction of(@Nullable final BiShortToLongFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B> ToLongBiFunction2<A, B> compose(@Nonnull final ToShortFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction composeFromBoolean(@Nonnull final BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default BiByteToLongFunction composeFromByte(@Nonnull final ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default BiCharToLongFunction composeFromChar(@Nonnull final CharToShortFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToLongFunction composeFromDouble(@Nonnull final DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToLongFunction composeFromFloat(@Nonnull final FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default BiIntToLongFunction composeFromInt(@Nonnull final IntToShortFunction before1,
     ...
     */
    @Nonnull
    default LongBinaryOperator2 composeFromLong(@Nonnull final LongToShortFunction before1,
     ...
     */
    @Nonnull
    default BiShortToLongFunction composeFromShort(@Nonnull final ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiShortPredicate andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortConsumer consume(@Nonnull final LongConsumer consumer) {
