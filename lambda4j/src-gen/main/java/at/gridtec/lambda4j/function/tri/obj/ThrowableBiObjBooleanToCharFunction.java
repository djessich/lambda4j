 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(Object, Object, boolean)}.
 *
...
public interface ThrowableBiObjBooleanToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToCharFunction<T, U, X> of(
            @Nullable final ThrowableBiObjBooleanToCharFunction<T, U, X> expression) {
        return expression;
    }
     ...
     * ThrowableBiObjBooleanToCharFunction}. Thereby the primitive input argument for this function is autoboxed. This
     * method provides the possibility to use this {@code ThrowableBiObjBooleanToCharFunction} with methods provided by
     * the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjBooleanToCharFunction} that applies this function to its input and nests the
     ...
     */
    @Nonnull
    default BiObjBooleanToCharFunction<T, U> nestWith(
     ...
     * @return A composed {@link BiObjBooleanToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjBooleanToCharFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjBooleanToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjBooleanToCharFunction<? super T, ? super U> function = recover.apply(throwable);
