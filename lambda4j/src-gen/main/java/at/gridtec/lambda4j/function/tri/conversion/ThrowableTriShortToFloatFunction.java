...
public interface ThrowableTriShortToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriShortToFloatFunction<X> of(
            @Nullable final ThrowableTriShortToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull final ThrowableTriShortToFloatFunction<? extends X> function,
    ...
    static <X extends Throwable> ThrowableTriShortToFloatFunction<X> onlyFirst(
            @Nonnull final ThrowableShortToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ThrowableTriShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriShortConsumer<X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriShortToFloatFunction nestWith(
    ...
    default TriShortToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriShortToFloatFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriShortToFloatFunction function = recover.apply(throwable);
