...
public interface ThrowableTriFloatToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriFloatToDoubleFunction<X> of(
            @Nonnull final ThrowableTriFloatToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriFloatToDoubleFunction} that applies this function to its input and nests the thrown
