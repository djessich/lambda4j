...
public interface ThrowableObjBooleanToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBooleanToShortFunction<T, X> of(
            @Nullable final ThrowableObjBooleanToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull final ThrowableObjBooleanToShortFunction<? super T, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableObjBooleanConsumer<T, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBooleanToShortFunction<T> nestWith(
    ...
    default ObjBooleanToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBooleanToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjBooleanToShortFunction<? super T> function = recover.apply(throwable);
