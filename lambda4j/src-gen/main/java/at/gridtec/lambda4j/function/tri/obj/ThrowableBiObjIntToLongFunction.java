...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjIntToLongFunction;
...
public interface ThrowableBiObjIntToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjIntToLongFunction<T, U, X> of(
            @Nullable final ThrowableBiObjIntToLongFunction<T, U, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiObjIntToLongFunction<T, U> nestWith(
    ...
    default BiObjIntToLongFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjIntToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjIntToLongFunction<? super T, ? super U> function = recover.apply(throwable);
