 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, long, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiLongToLongFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiLongToLongFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjBiLongToLongFunction} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiLongToLongFunction<T, X> of(
            @Nullable final ThrowableObjBiLongToLongFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiLongToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiLongToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjBiLongToLongFunction<? super T, ? extends X> function, T t, long value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiLongToLongFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongToLongFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToLongFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiLongToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableLongUnaryOperator}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param operator The operator which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToLongFunction<T, X> onlySecond(
            @Nonnull final ThrowableLongUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsLongThrows(value1);
    }

    /**
     * Creates a {@link ThrowableObjBiLongToLongFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableObjBiLongToLongFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToLongFunction<T, X> onlyThird(
            @Nonnull final ThrowableLongUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsLongThrows(value2);
    }

    /**
     * Creates a {@link ThrowableObjBiLongToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiLongToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToLongFunction<T, X> constant(long ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(T t, long value1, long value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableLongBinaryOperator<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongUnaryOperator<X> papplyAsLongThrows(T t, long value1) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToLongFunction<T, X> papplyAsLongThrows(long value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(long value1, long value2) {
    ...
    default <A, B, C> ThrowableToLongTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsLongThrows(before1.applyThrows(a), before2.applyAsLongThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(applyAsLongThrows(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiLongToLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiLongToLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjBiLongToLongFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, Long, Long>, Long> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjBiLongToLongFunction<T, X> & Memoized) (t, value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiLongToLongFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiLongToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiLongToLongFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Long, Long, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link ObjBiLongToLongFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiLongToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiLongToLongFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiLongToLongFunction<T> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiLongToLongFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiLongToLongFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiLongToLongFunction<T> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiLongToLongFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiLongToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiLongToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiLongToLongFunction<? super T> function = recover.apply(throwable);
