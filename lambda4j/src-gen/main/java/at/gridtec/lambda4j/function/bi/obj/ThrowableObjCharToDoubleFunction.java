...
public interface ThrowableObjCharToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToDoubleFunction<T, X> of(
            @Nullable final ThrowableObjCharToDoubleFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjCharToDoubleFunction<T> nestWith(
    ...
    default ObjCharToDoubleFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjCharToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjCharToDoubleFunction<? super T> function = recover.apply(throwable);
