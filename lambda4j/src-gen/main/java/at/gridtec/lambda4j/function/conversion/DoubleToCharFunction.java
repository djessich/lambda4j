...
public interface DoubleToCharFunction extends Lambda {
     ...
     */
    static DoubleToCharFunction of(@Nullable final DoubleToCharFunction expression) {
        return expression;
    }
     ...
     */
    static char call(@Nonnull final DoubleToCharFunction function, double value) {
     ...
     */
    @Nonnull
    default <A> ToCharFunction<A> compose(@Nonnull final ToDoubleFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToCharFunction composeFromBoolean(@Nonnull final BooleanToDoubleFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToCharFunction composeFromByte(@Nonnull final ByteToDoubleFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default CharUnaryOperator composeFromChar(@Nonnull final CharToDoubleFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default DoubleToCharFunction composeFromDouble(@Nonnull final DoubleUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default FloatToCharFunction composeFromFloat(@Nonnull final FloatToDoubleFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default IntToCharFunction composeFromInt(@Nonnull final IntToDoubleFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default LongToCharFunction composeFromLong(@Nonnull final LongToDoubleFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default ShortToCharFunction composeFromShort(@Nonnull final ShortToDoubleFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsChar(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default <S> DoubleFunction2<S> andThen(@Nonnull final CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default DoublePredicate2 andThenToBoolean(@Nonnull final CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleUnaryOperator2 andThenToDouble(@Nonnull final CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToIntFunction2 andThenToInt(@Nonnull final CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 andThenToLong(@Nonnull final CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleConsumer2 consume(@Nonnull final CharConsumer consumer) {
     ...
     * {@code DoubleToCharFunction} with JDK specific methods, only accepting {@code Function}.
     *
