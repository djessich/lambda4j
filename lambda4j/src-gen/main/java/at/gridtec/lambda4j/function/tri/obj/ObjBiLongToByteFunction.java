...
import at.gridtec.lambda4j.predicate.tri.obj.ObjBiLongPredicate;
...
public interface ObjBiLongToByteFunction<T> extends Lambda {
     ...
     */
    static <T> ObjBiLongToByteFunction<T> of(@Nullable final ObjBiLongToByteFunction<T> expression) {
        return expression;
    }
