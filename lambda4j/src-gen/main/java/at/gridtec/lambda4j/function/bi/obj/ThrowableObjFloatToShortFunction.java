...
public interface ThrowableObjFloatToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToShortFunction<T, X> of(
            @Nullable final ThrowableObjFloatToShortFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjFloatToShortFunction<T> nestWith(
    ...
    default ObjFloatToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjFloatToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjFloatToShortFunction<? super T> function = recover.apply(throwable);
