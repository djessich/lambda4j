...
public interface ThrowableBiFloatToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToDoubleFunction<X> of(
            @Nullable final ThrowableBiFloatToDoubleFunction<X> expression) {
        return expression;
    }
    ...
    default BiFloatToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiFloatToDoubleFunction> recover) {
        Objects.requireNonNull(recover);
        return (value1, value2) -> {
            try {
                return this.applyAsDoubleThrows(value1, value2);
            } catch (Throwable throwable) {
                final BiFloatToDoubleFunction function = recover.apply(throwable);
