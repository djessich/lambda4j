 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, Object, Object)}.
 *
...
@FunctionalInterface
public interface ThrowableToByteTriFunction<T, U, V, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableToByteTriFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableToByteTriFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, V, X extends Throwable> ThrowableToByteTriFunction<T, U, V, X> of(
            @Nullable final ThrowableToByteTriFunction<T, U, V, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableToByteTriFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <V> The type of the third argument to the function
     ...
     * @return The result from the given {@code ThrowableToByteTriFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, V, X extends Throwable> byte call(
            @Nonnull final ThrowableToByteTriFunction<? super T, ? super U, ? super V, ? extends X> function, T t, U u,
            V v) throws X {
        Objects.requireNonNull(function);
        return function.applyAsByteThrows(t, u, v);
    }

    /**
     * Creates a {@link ThrowableToByteTriFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <V> The type of the third argument to the function
     ...
     * @return Creates a {@code ThrowableToByteTriFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToByteTriFunction<T, U, V, X> onlyFirst(
            @Nonnull final ThrowableToByteFunction<? super T, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, v) -> function.applyAsByteThrows(t);
    }

    /**
     * Creates a {@link ThrowableToByteTriFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableToByteTriFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToByteTriFunction<T, U, V, X> onlySecond(
            @Nonnull final ThrowableToByteFunction<? super U, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, v) -> function.applyAsByteThrows(u);
    }

    /**
     * Creates a {@link ThrowableToByteTriFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableToByteTriFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToByteTriFunction<T, U, V, X> onlyThird(
            @Nonnull final ThrowableToByteFunction<? super V, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, v) -> function.applyAsByteThrows(v);
    }

    /**
     * Creates a {@link ThrowableToByteTriFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <V> The type of the third argument to the function
     ...
     * @return A {@code ThrowableToByteTriFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToByteTriFunction<T, U, V, X> constant(byte ret) {
        return (t, u, v) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, U u, V v) throws X;
    ...
    default ThrowableToByteBiFunction<U, V, X> papplyAsByteThrows(T t) {
        return (u, v) -> this.applyAsByteThrows(t, u, v);
    }
    ...
    default ThrowableToByteFunction<V, X> papplyAsByteThrows(T t, U u) {
        return (v) -> this.applyAsByteThrows(t, u, v);
    }
    ...
    default <A, B, C> ThrowableToByteTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsByteThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyThrows(c));
    }
    ...
    default <S> ThrowableTriFunction<T, U, V, S, X> andThen(
        ...
        return (t, u, v) -> after.applyThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableTriPredicate<T, U, V, X> andThenToBoolean(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.testThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableToByteTriFunction<T, U, V, X> andThenToByte(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsByteThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableToCharTriFunction<T, U, V, X> andThenToChar(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsCharThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableToDoubleTriFunction<T, U, V, X> andThenToDouble(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsDoubleThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableToFloatTriFunction<T, U, V, X> andThenToFloat(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsFloatThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableToIntTriFunction<T, U, V, X> andThenToInt(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsIntThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableToLongTriFunction<T, U, V, X> andThenToLong(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsLongThrows(applyAsByteThrows(t, u, v));
    }
    ...
    default ThrowableToShortTriFunction<T, U, V, X> andThenToShort(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsShortThrows(applyAsByteThrows(t, u, v));
    }
     ...
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, V, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, u, v) -> consumer.acceptThrows(applyAsByteThrows(t, u, v));
    }
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<Triple<T, U, V>, X> tupled() {
     ...
     */
    @Nonnull
    default ThrowableToByteTriFunction<V, U, T, X> reversed() {
        return (v, u, t) -> applyAsByteThrows(t, u, v);
    }
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableToByteTriFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableToByteTriFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableToByteTriFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, V, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ToByteTriFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ToByteTriFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ToByteTriFunction<T, U, V> nest() {
     ...
     */
    @Nonnull
    default ToByteTriFunction<T, U, V> nestWith(
    ...
    /**
     * Returns a composed {@link ToByteTriFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ToByteTriFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ToByteTriFunction<T, U, V> sneakyThrow() {
        return (t, u, v) -> {
            try {
                return this.applyAsByteThrows(t, u, v);
     ...
     * @return A composed {@link ToByteTriFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ToByteTriFunction<T, U, V> recover(
            @Nonnull final Function<? super Throwable, ? extends ToByteTriFunction<? super T, ? super U, ? super V>> recover) {
        ...
        return (t, u, v) -> {
            try {
                ...
                final ToByteTriFunction<? super T, ? super U, ? super V> function = recover.apply(throwable);
