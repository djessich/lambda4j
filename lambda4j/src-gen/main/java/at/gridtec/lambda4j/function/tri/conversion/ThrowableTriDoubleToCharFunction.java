...
public interface ThrowableTriDoubleToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToCharFunction<X> of(
            @Nullable final ThrowableTriDoubleToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction nestWith(
    ...
    default TriDoubleToCharFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriDoubleToCharFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriDoubleToCharFunction function = recover.apply(throwable);
