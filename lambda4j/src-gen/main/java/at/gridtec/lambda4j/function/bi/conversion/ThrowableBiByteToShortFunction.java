...
public interface ThrowableBiByteToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiByteToShortFunction<X> of(
            @Nullable final ThrowableBiByteToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableBiByteToShortFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableBiByteToShortFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiBytePredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
    ...
    default ThrowableBiByteToShortFunction<X> memoized() {
        if (isMemoized()) {
            ...
            final Map<Pair<Byte, Byte>, Short> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default BiByteToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiByteToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiByteToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiByteToShortFunction function = recover.apply(throwable);
