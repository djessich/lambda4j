...
public interface ThrowableObjBiDoubleToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToDoubleFunction<T, X> of(
            @Nullable final ThrowableObjBiDoubleToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull final ThrowableObjBiDoubleToDoubleFunction<? super T, ? extends X> function, T t, double value1,
     ...
     */
    @Nonnull
    default ThrowableDoubleBinaryOperator<X> papplyAsDoubleThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleUnaryOperator<X> papplyAsDoubleThrows(T t, double value1) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToDoubleFunction<T, X> papplyAsDoubleThrows(double value1) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> papplyAsDoubleThrows(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiDoubleToDoubleFunction<T> nestWith(
    ...
    default ObjBiDoubleToDoubleFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiDoubleToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiDoubleToDoubleFunction<? super T> function = recover.apply(throwable);
