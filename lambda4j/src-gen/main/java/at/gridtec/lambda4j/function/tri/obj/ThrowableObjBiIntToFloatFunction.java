...
public interface ThrowableObjBiIntToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> float call(
            @Nonnull final ThrowableObjBiIntToFloatFunction<? super T, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiIntToFloatFunction<X> papplyAsFloatThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntToFloatFunction<X> papplyAsFloatThrows(T t, int value1) {
     ...
     */
    @Nonnull
    default ThrowableObjIntToFloatFunction<T, X> papplyAsFloatThrows(int value1) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<T, X> papplyAsFloatThrows(int value1, int value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiIntToFloatFunction<T> nestWith(
    ...
    default ObjBiIntToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiIntToFloatFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiIntToFloatFunction<? super T> function = recover.apply(throwable);
