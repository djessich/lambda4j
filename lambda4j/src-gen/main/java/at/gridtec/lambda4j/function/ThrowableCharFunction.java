...
public interface ThrowableCharFunction<R, X extends Throwable> extends Lambda {
    ...
    /**
     * Returns a composed {@link ThrowableCharFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default CharFunction<R> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link CharFunction} that applies this function to its input and sneakily throws the
    ...
    default CharFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends CharFunction<? extends R>> recover) {
        ...
        return (value) -> {
            try {
                ...
                final CharFunction<? extends R> function = recover.apply(throwable);
