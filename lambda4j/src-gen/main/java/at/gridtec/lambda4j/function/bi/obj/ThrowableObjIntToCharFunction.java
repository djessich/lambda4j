...
public interface ThrowableObjIntToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntToCharFunction<T, X> of(
            @Nullable final ThrowableObjIntToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull final ThrowableObjIntToCharFunction<? super T, ? extends X> function, T t, int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<T, X> andThenToBoolean(@Nonnull final ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjIntToCharFunction<T> nestWith(
    ...
    default ObjIntToCharFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjIntToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjIntToCharFunction<? super T> function = recover.apply(throwable);
