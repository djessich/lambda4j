...
public interface ThrowableObjBiLongToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToIntFunction<T, X> of(
            @Nullable final ThrowableObjBiLongToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull final ThrowableObjBiLongToIntFunction<? super T, ? extends X> function, T t, long value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiLongToIntFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            final Map<Triple<T, Long, Long>, Integer> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ObjBiLongToIntFunction<T> nestWith(
    ...
    default ObjBiLongToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiLongToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiLongToIntFunction<? super T> function = recover.apply(throwable);
