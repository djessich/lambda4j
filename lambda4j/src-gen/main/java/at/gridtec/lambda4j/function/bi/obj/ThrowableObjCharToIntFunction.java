...
public interface ThrowableObjCharToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToIntFunction<T, X> of(
            @Nullable final ThrowableObjCharToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> papplyAsIntThrows(char value) {
     ...
     */
    @Nonnull
    default ObjCharToIntFunction<T> nestWith(
    ...
    default ObjCharToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjCharToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjCharToIntFunction<? super T> function = recover.apply(throwable);
