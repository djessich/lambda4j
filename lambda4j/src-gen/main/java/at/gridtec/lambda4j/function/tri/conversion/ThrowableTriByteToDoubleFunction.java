...
public interface ThrowableTriByteToDoubleFunction<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default TriByteToDoubleFunction nestWith(
    ...
    default TriByteToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriByteToDoubleFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriByteToDoubleFunction function = recover.apply(throwable);
