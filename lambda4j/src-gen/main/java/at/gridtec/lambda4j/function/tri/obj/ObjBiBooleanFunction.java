...
import at.gridtec.lambda4j.function.bi.obj.ObjBooleanFunction;
...
public interface ObjBiBooleanFunction<T, R> extends Lambda {
    ...
    static <T, R> ObjBiBooleanFunction<T, Optional<R>> lift(
            @Nonnull final ObjBiBooleanFunction<? super T, ? extends R> partial) {
     ...
     * {@code ObjBiBooleanFunction} with methods provided by the {@code JDK}.
     *
