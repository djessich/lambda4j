...
public interface ThrowableShortToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableShortToIntFunction<X> of(
            @Nullable final ThrowableShortToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull final ThrowableShortToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> andThenToInt(@Nonnull final ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ShortToIntFunction} that applies this function to its input and nests the thrown {@code
    ...
    default ShortToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends ShortToIntFunction> recover) {
        Objects.requireNonNull(recover);
        return (value) -> {
            try {
                return this.applyAsIntThrows(value);
            } catch (Throwable throwable) {
                final ShortToIntFunction function = recover.apply(throwable);
