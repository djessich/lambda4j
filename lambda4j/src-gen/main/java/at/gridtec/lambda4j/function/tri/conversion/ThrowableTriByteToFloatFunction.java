...
public interface ThrowableTriByteToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriByteToFloatFunction<X> of(
            @Nullable final ThrowableTriByteToFloatFunction<X> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ThrowableTriByteToFloatFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default TriByteToFloatFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriByteToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriByteToFloatFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriByteToFloatFunction function = recover.apply(throwable);
