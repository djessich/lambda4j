...
public interface ThrowableBiLongToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiLongToByteFunction<X> of(
            @Nullable final ThrowableBiLongToByteFunction<X> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiLongToByteFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default BiLongToByteFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiLongToByteFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiLongToByteFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiLongToByteFunction function = recover.apply(throwable);
