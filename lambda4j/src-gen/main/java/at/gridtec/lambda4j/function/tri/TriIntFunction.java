...
public interface TriIntFunction<R> extends Lambda {
     ...
     */
    static <R> TriIntFunction<R> of(@Nullable final TriIntFunction<R> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <R> TriIntFunction<Optional<R>> lift(@Nonnull final TriIntFunction<? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <R> R call(@Nonnull final TriIntFunction<? extends R> function, int value1, int value2, int value3) {
     ...
     */
    @Nonnull
    default <A, B, C> TriFunction<A, B, C, R> compose(@Nonnull final ToIntFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanFunction<R> composeFromBoolean(@Nonnull final BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default TriByteFunction<R> composeFromByte(@Nonnull final ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default TriCharFunction<R> composeFromChar(@Nonnull final CharToIntFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> composeFromDouble(@Nonnull final DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default TriFloatFunction<R> composeFromFloat(@Nonnull final FloatToIntFunction before1,
     ...
     */
    @Nonnull
    default TriLongFunction<R> composeFromLong(@Nonnull final LongToIntFunction before1,
     ...
     */
    @Nonnull
    default TriShortFunction<R> composeFromShort(@Nonnull final ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default <S> TriIntFunction<S> andThen(@Nonnull final Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default TriIntConsumer consume(@Nonnull final Consumer<? super R> consumer) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link TriIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code TriIntFunction} with methods provided by the {@code JDK}.
     *
