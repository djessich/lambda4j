...
public interface ThrowableObjDoubleToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToFloatFunction<T, X> of(
            @Nullable final ThrowableObjDoubleToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableDoubleToFloatFunction<X> papplyAsFloatThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<T, X> papplyAsFloatThrows(double value) {
     ...
     * this {@code ThrowableObjDoubleToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjDoubleToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjDoubleToFloatFunction<T> nestWith(
     ...
     * @return A composed {@link ObjDoubleToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjDoubleToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjDoubleToFloatFunction<? super T> function = recover.apply(throwable);
