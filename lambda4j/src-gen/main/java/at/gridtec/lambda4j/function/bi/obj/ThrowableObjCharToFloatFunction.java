...
public interface ThrowableObjCharToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToFloatFunction<T, X> of(
            @Nullable final ThrowableObjCharToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjCharToFloatFunction<T> nestWith(
    ...
    default ObjCharToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjCharToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjCharToFloatFunction<? super T> function = recover.apply(throwable);
