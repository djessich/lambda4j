...
public interface ThrowableTriDoubleToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToShortFunction<X> of(
            @Nonnull final ThrowableTriDoubleToShortFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriDoubleToShortFunction} that applies this function to its input and nests the thrown
