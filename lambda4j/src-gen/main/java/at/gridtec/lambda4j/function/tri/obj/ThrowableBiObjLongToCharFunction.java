...
public interface ThrowableBiObjLongToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToCharFunction<T, U, X> of(
            @Nullable final ThrowableBiObjLongToCharFunction<T, U, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiObjLongToCharFunction<T, U> nestWith(
    ...
    default BiObjLongToCharFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjLongToCharFunction<? super T, ? super U> function = recover.apply(throwable);
