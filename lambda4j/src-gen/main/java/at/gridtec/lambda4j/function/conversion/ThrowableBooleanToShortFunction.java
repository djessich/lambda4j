...
public interface ThrowableBooleanToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBooleanToShortFunction<X> of(
            @Nullable final ThrowableBooleanToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableBooleanToShortFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableByteToShortFunction} that first applies the {@code before} predicate to
     ...
     */
    @Nonnull
    default ThrowableByteToShortFunction<X> composeFromByte(@Nonnull final ThrowableBytePredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShortThrows(before.testThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableCharToShortFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableCharToShortFunction<X> composeFromChar(@Nonnull final ThrowableCharPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShortThrows(before.testThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableIntToShortFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableIntToShortFunction<X> composeFromInt(@Nonnull final ThrowableIntPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShortThrows(before.testThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableLongToShortFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableLongToShortFunction<X> composeFromLong(@Nonnull final ThrowableLongPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsShortThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableBooleanConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BooleanToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BooleanToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BooleanToShortFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final BooleanToShortFunction function = recover.apply(throwable);
