...
public interface ThrowableObjBiShortToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToFloatFunction<T, X> of(
            @Nullable final ThrowableObjBiShortToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull final ThrowableObjBiShortToFloatFunction<? super T, ? extends X> function, T t, short value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiShortToFloatFunction<T> nestWith(
    ...
    default ObjBiShortToFloatFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiShortToFloatFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiShortToFloatFunction<? super T> function = recover.apply(throwable);
