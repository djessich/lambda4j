 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(byte)}.
 *
...
@FunctionalInterface
public interface ThrowableByteToLongFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableByteToLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableByteToLongFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableByteToLongFunction<X> of(
            @Nullable final ThrowableByteToLongFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableByteToLongFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableByteToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableByteToLongFunction<? extends X> function,
            byte value) throws X {
    ...
    /**
     * Creates a {@link ThrowableByteToLongFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableByteToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableByteToLongFunction<X> constant(long ret) {
        return (value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(byte value) throws X;
    ...
    default <A> ThrowableToLongFunction<A, X> compose(
        ...
        return (a) -> applyAsLongThrows(before.applyAsByteThrows(a));
    }
    ...
    default ThrowableBooleanToLongFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsLongThrows(before.applyAsByteThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableByteToLongFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * This method is just convenience, to provide the ability to execute an operation which accepts {@code byte} input,
     * before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableByteToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * byte}.
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteUnaryOperator<X> andThenToByte(@Nonnull final ThrowableLongToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> andThenToInt(@Nonnull final ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> andThenToLong(@Nonnull final ThrowableLongUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsLongThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableByteToLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableByteToLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Byte, Long> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableByteToLongFunction<X> & Memoized) (value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableByteToLongFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableByteToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableByteToLongFunction}.
     */
    @Nonnull
    default ThrowableFunction<Byte, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link ByteToLongFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ByteToLongFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ByteToLongFunction nest() {
     ...
     */
    @Nonnull
    default ByteToLongFunction nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ByteToLongFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ByteToLongFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ByteToLongFunction sneakyThrow() {
        return (value) -> {
            try {
     ...
     */
    @Nonnull
    default ByteToLongFunction recover(
            @Nonnull final Function<? super Throwable, ? extends ByteToLongFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ByteToLongFunction function = recover.apply(throwable);
