...
import at.gridtec.lambda4j.predicate.tri.obj.ThrowableBiObjBooleanPredicate;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(Object, Object, boolean)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjBooleanToIntFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjBooleanToIntFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjBooleanToIntFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToIntFunction<T, U, X> of(
            @Nullable final ThrowableBiObjBooleanToIntFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjBooleanToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjBooleanToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> int call(
            @Nonnull final ThrowableBiObjBooleanToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToIntFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjBooleanToIntFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToIntFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjBooleanToIntFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToIntFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToIntFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjBooleanToIntFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableBooleanToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToIntFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjBooleanToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToIntFunction<T, U, X> constant(int ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    int applyAsIntThrows(T t, U u, boolean value) throws X;
     ...
     */
    default int applyAsIntThrows(@Nonnull Pair<T, U> tuple, boolean value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjBooleanToIntFunction<U, X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableBooleanToIntFunction<X> papplyAsIntThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToIntBiFunction<T, U, X> papplyAsIntThrows(boolean value) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<U, X> papplyAsIntThrows(T t, boolean value) {
    ...
    default <A, B, C> ThrowableToIntTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsIntThrows(before1.applyThrows(a), before2.applyThrows(b), before3.testThrows(c));
    }
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanConsumer<T, U, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjBooleanToIntFunction<Pair<T, U>, X> tupled() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjBooleanToIntFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjBooleanToIntFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanToIntFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Boolean>, Integer> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjBooleanToIntFunction<T, U, X> & Memoized) (t, u, value) -> {
     ...
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Boolean, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link BiObjBooleanToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjBooleanToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjBooleanToIntFunction<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjBooleanToIntFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjBooleanToIntFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjBooleanToIntFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjBooleanToIntFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjBooleanToIntFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjBooleanToIntFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjBooleanToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjBooleanToIntFunction<? super T, ? super U> function = recover.apply(throwable);
