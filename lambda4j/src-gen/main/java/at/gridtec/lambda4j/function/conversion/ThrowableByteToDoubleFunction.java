...
public interface ThrowableByteToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableByteToDoubleFunction<X> of(
            @Nonnull final ThrowableByteToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ByteToDoubleFunction} that applies this function to its input and nests the thrown
