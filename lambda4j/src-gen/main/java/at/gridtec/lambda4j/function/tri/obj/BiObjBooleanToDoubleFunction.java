...
import at.gridtec.lambda4j.function.bi.obj.ObjBooleanToDoubleFunction;
...
public interface BiObjBooleanToDoubleFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjBooleanToDoubleFunction<T, U> of(@Nullable final BiObjBooleanToDoubleFunction<T, U> expression) {
        return expression;
    }
