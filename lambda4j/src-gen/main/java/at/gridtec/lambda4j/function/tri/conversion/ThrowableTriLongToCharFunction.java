...
public interface ThrowableTriLongToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriLongToCharFunction<X> of(
            @Nullable final ThrowableTriLongToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull final ThrowableTriLongToCharFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToCharFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> andThenToBoolean(@Nonnull final ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code TriLongToCharFunction} that applies this function to its input and nests the thrown
    ...
    default TriLongToCharFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriLongToCharFunction> recover) {
        Objects.requireNonNull(recover);
        return (value1, value2, value3) -> {
            try {
                return this.applyAsCharThrows(value1, value2, value3);
            } catch (Throwable throwable) {
                final TriLongToCharFunction function = recover.apply(throwable);
