...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjIntToByteFunction;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, Object, int)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjIntToByteFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjIntToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjIntToByteFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjIntToByteFunction<T, U, X> of(
            @Nullable final ThrowableBiObjIntToByteFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjIntToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjIntToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableBiObjIntToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
            int value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToByteFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjIntToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToByteFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjIntToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToByteFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToByteFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjIntToByteFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableIntToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToByteFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjIntToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjIntToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjIntToByteFunction<T, U, X> constant(byte ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, U u, int value) throws X;
     ...
     */
    default byte applyAsByteThrows(@Nonnull Pair<T, U> tuple, int value) throws X {
        Objects.requireNonNull(tuple);
        return applyAsByteThrows(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableObjIntToByteFunction}
     * as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableObjIntToByteFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjIntToByteFunction<U, X> papplyAsByteThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> papplyAsByteThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToByteBiFunction<T, U, X> papplyAsByteThrows(int value) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<U, X> papplyAsByteThrows(T t, int value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjIntConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjIntToByteFunction<Pair<T, U>, X> tupled() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjIntToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjIntToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjIntToByteFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Integer>, Byte> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjIntToByteFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjIntToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjIntToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjIntToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Integer, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link BiObjIntToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjIntToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjIntToByteFunction<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjIntToByteFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjIntToByteFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjIntToByteFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjIntToByteFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjIntToByteFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjIntToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjIntToByteFunction<? super T, ? super U> function = recover.apply(throwable);
