...
public interface ThrowableObjBiByteToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToShortFunction<T, X> of(
            @Nullable final ThrowableObjBiByteToShortFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjBiByteToShortFunction<T> nestWith(
    ...
    default ObjBiByteToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiByteToShortFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiByteToShortFunction<? super T> function = recover.apply(throwable);
