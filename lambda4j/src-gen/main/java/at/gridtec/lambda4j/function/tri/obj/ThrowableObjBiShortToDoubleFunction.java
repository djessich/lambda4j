...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjShortToDoubleFunction;
...
import at.gridtec.lambda4j.predicate.tri.obj.ThrowableObjBiShortPredicate;
 ...
 * This is a (reference, short, short) specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(Object, short, short)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiShortToDoubleFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiShortToDoubleFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableObjBiShortToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiShortToDoubleFunction<T, X> of(
            @Nullable final ThrowableObjBiShortToDoubleFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiShortToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiShortToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> double call(
            @Nonnull final ThrowableObjBiShortToDoubleFunction<? super T, ? extends X> function, T t, short value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiShortToDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiShortToDoubleFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToDoubleFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiShortToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableShortToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiShortToDoubleFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableShortToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToDoubleFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiShortToDoubleFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@link ThrowableShortToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiShortToDoubleFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableShortToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToDoubleFunction<T, X> onlyThird(
            @Nonnull final ThrowableShortToDoubleFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiShortToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiShortToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToDoubleFunction<T, X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, short value1, short value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiShortToDoubleFunction<X> papplyAsDoubleThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToDoubleFunction<X> papplyAsDoubleThrows(T t, short value1) {
        return (value2) -> this.applyAsDoubleThrows(t, value1, value2);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link
     * ThrowableObjShortToDoubleFunction} as result.
     *
     * @param value1 The second argument to this function used to partially apply this function
     * @return A {@code ThrowableObjShortToDoubleFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjShortToDoubleFunction<T, X> papplyAsDoubleThrows(short value1) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> papplyAsDoubleThrows(short value1, short value2) {
    ...
    default <A, B, C> ThrowableToDoubleTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsDoubleThrows(before1.applyThrows(a), before2.applyAsShortThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     * ThrowableObjBiShortToDoubleFunction}. Thereby the primitive input argument for this function is autoboxed. This
     * method provides the possibility to use this {@code ThrowableObjBiShortToDoubleFunction} with methods provided by
     * the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiShortToDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Short, Short, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link ObjBiShortToDoubleFunction} that applies this function to its input and nests the
     * thrown {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiShortToDoubleFunction} that applies this function to its input and nests the
     ...
     */
    @Nonnull
    default ObjBiShortToDoubleFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiShortToDoubleFunction<T> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiShortToDoubleFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiShortToDoubleFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiShortToDoubleFunction<T> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiShortToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiShortToDoubleFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiShortToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiShortToDoubleFunction<? super T> function = recover.apply(throwable);
