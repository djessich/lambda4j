...
public interface ThrowableObjBiIntToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToByteFunction<T, X> of(
            @Nullable final ThrowableObjBiIntToByteFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjBiIntToByteFunction<T> nestWith(
    ...
    default ObjBiIntToByteFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiIntToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiIntToByteFunction<? super T> function = recover.apply(throwable);
