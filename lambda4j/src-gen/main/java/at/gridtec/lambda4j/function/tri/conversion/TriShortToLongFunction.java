...
public interface TriShortToLongFunction extends Lambda {
     ...
     */
    static TriShortToLongFunction of(@Nullable final TriShortToLongFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToLongTriFunction<A, B, C> compose(@Nonnull final ToShortFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToLongFunction composeFromBoolean(@Nonnull final BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default TriByteToLongFunction composeFromByte(@Nonnull final ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default TriCharToLongFunction composeFromChar(@Nonnull final CharToShortFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction composeFromDouble(@Nonnull final DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToLongFunction composeFromFloat(@Nonnull final FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default TriIntToLongFunction composeFromInt(@Nonnull final IntToShortFunction before1,
     ...
     */
    @Nonnull
    default LongTernaryOperator composeFromLong(@Nonnull final LongToShortFunction before1,
     ...
     */
    @Nonnull
    default TriShortToLongFunction composeFromShort(@Nonnull final ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <S> TriShortFunction<S> andThen(@Nonnull final LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriShortPredicate andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code TriShortToLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
