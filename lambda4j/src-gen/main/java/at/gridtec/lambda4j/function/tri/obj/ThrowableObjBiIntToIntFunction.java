...
public interface ThrowableObjBiIntToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToIntFunction<T, X> of(
            @Nullable final ThrowableObjBiIntToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjBiIntToIntFunction<T> nestWith(
    ...
    default ObjBiIntToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiIntToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiIntToIntFunction<? super T> function = recover.apply(throwable);
