...
public interface BiByteToIntFunction extends Lambda {
     ...
     */
    static BiByteToIntFunction of(@Nullable final BiByteToIntFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B> ToIntBiFunction2<A, B> compose(@Nonnull final ToByteFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToIntFunction composeFromBoolean(@Nonnull final BooleanToByteFunction before1,
    ...
    /**
     * Returns a composed {@link BiByteToIntFunction} that first applies the {@code before} operators to
     ...
     */
    @Nonnull
    default BiByteToIntFunction composeFromByte(@Nonnull final ByteUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiCharToIntFunction composeFromChar(@Nonnull final CharToByteFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction composeFromDouble(@Nonnull final DoubleToByteFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToIntFunction composeFromFloat(@Nonnull final FloatToByteFunction before1,
     ...
     */
    @Nonnull
    default IntBinaryOperator2 composeFromInt(@Nonnull final IntToByteFunction before1,
     ...
     */
    @Nonnull
    default BiLongToIntFunction composeFromLong(@Nonnull final LongToByteFunction before1,
     ...
     */
    @Nonnull
    default BiShortToIntFunction composeFromShort(@Nonnull final ShortToByteFunction before1,
     ...
     * {@code BiByteToIntFunction} with methods provided by the {@code JDK}.
     *
