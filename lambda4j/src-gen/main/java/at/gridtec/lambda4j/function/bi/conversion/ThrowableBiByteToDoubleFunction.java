...
public interface ThrowableBiByteToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiByteToDoubleFunction<X> of(
            @Nullable final ThrowableBiByteToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull final ThrowableBiByteToDoubleFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableBiByteToDoubleFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiBytePredicate<X> andThenToBoolean(@Nonnull final ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiByteToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiByteToDoubleFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiByteToDoubleFunction function = recover.apply(throwable);
