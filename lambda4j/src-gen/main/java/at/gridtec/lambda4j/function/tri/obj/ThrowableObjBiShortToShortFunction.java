...
public interface ThrowableObjBiShortToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToShortFunction<T, X> of(
            @Nullable final ThrowableObjBiShortToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull final ThrowableObjBiShortToShortFunction<? super T, ? extends X> function, T t, short value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjBiShortToShortFunction} that applies this function to its input and nests the thrown
    ...
    default ObjBiShortToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiShortToShortFunction<? super T>> recover) {
        Objects.requireNonNull(recover);
        return (t, value1, value2) -> {
            try {
                return this.applyAsShortThrows(t, value1, value2);
            } catch (Throwable throwable) {
                final ObjBiShortToShortFunction<? super T> function = recover.apply(throwable);
