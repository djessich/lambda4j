...
public interface ThrowableTriByteToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriByteToLongFunction<X> of(
            @Nullable final ThrowableTriByteToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableTriByteToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiByteToLongFunction<X> papplyAsLongThrows(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> papplyAsLongThrows(byte value1, byte value2) {
    ...
    /**
     * Returns a composed {@link ThrowableTriByteToLongFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableTriBytePredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriByteToLongFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriByteToLongFunction recover(
            @Nonnull final Function<? super Throwable, ? extends TriByteToLongFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriByteToLongFunction function = recover.apply(throwable);
