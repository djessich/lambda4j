...
public interface ThrowableBiObjLongToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToDoubleFunction<T, U, X> of(
            @Nullable final ThrowableBiObjLongToDoubleFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> double call(
            @Nonnull final ThrowableBiObjLongToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> nestWith(
    ...
    default BiObjLongToDoubleFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjLongToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
