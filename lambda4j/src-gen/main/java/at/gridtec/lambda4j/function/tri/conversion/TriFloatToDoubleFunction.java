...
public interface TriFloatToDoubleFunction extends Lambda {
     ...
     */
    static TriFloatToDoubleFunction of(@Nullable final TriFloatToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A, B, C> ToDoubleTriFunction<A, B, C> compose(@Nonnull final ToFloatFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToDoubleFunction composeFromBoolean(@Nonnull final BooleanToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriByteToDoubleFunction composeFromByte(@Nonnull final ByteToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriCharToDoubleFunction composeFromChar(@Nonnull final CharToFloatFunction before1,
     ...
     */
    @Nonnull
    default DoubleTernaryOperator composeFromDouble(@Nonnull final DoubleToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction composeFromFloat(@Nonnull final FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriIntToDoubleFunction composeFromInt(@Nonnull final IntToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction composeFromLong(@Nonnull final LongToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriShortToDoubleFunction composeFromShort(@Nonnull final ShortToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriFloatConsumer consume(@Nonnull final DoubleConsumer consumer) {
     ...
     * to use this {@code TriFloatToDoubleFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
