...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjShortToLongFunction;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, short, short)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiShortToLongFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiShortToLongFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableObjBiShortToLongFunction} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiShortToLongFunction<T, X> of(
            @Nullable final ThrowableObjBiShortToLongFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiShortToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiShortToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> long call(
            @Nonnull final ThrowableObjBiShortToLongFunction<? super T, ? extends X> function, T t, short value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiShortToLongFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@link ThrowableToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiShortToLongFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToLongFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiShortToLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableShortToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiShortToLongFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableShortToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToLongFunction<T, X> onlySecond(
            @Nonnull final ThrowableShortToLongFunction<? extends X> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsLongThrows(value1);
    }

    /**
     * Creates a {@link ThrowableObjBiShortToLongFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@link ThrowableShortToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiShortToLongFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableShortToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToLongFunction<T, X> onlyThird(
            @Nonnull final ThrowableShortToLongFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiShortToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiShortToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiShortToLongFunction<T, X> constant(long ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(T t, short value1, short value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiShortToLongFunction<X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToLongFunction<X> papplyAsLongThrows(T t, short value1) {
     ...
     * ThrowableObjShortToLongFunction} as result.
     *
     * @param value1 The second argument to this function used to partially apply this function
     * @return A {@code ThrowableObjShortToLongFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjShortToLongFunction<T, X> papplyAsLongThrows(short value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> papplyAsLongThrows(short value1, short value2) {
    ...
    default <A, B, C> ThrowableToLongTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsLongThrows(before1.applyThrows(a), before2.applyAsShortThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(applyAsLongThrows(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiShortToLongFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiShortToLongFunction}.
    ...
    default ThrowableObjBiShortToLongFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableObjBiShortToLongFunction<T, X> & Memoized) (t, value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiShortToLongFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiShortToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiShortToLongFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Short, Short, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link ObjBiShortToLongFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiShortToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiShortToLongFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiShortToLongFunction<T> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiShortToLongFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiShortToLongFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiShortToLongFunction<T> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiShortToLongFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiShortToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiShortToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiShortToLongFunction<? super T> function = recover.apply(throwable);
