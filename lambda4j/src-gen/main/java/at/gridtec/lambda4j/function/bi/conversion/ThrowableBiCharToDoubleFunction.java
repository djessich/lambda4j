...
public interface ThrowableBiCharToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiCharToDoubleFunction<X> of(
            @Nullable final ThrowableBiCharToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull final ThrowableBiCharToDoubleFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableCharToDoubleFunction<X> papplyAsDoubleThrows(char value1) {
    ...
    /**
     * Returns a composed {@link ThrowableBiCharToDoubleFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiCharPredicate<X> andThenToBoolean(@Nonnull final ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiCharToDoubleFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiCharToDoubleFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiCharToDoubleFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiCharToDoubleFunction function = recover.apply(throwable);
