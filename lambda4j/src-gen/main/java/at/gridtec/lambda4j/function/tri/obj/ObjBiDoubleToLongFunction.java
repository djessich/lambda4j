...
public interface ObjBiDoubleToLongFunction<T> extends Lambda {
     ...
     */
    static <T> ObjBiDoubleToLongFunction<T> of(@Nullable final ObjBiDoubleToLongFunction<T> expression) {
        return expression;
    }
     ...
     */
    static <T> long call(@Nonnull final ObjBiDoubleToLongFunction<? super T> function, T t, double value1,
            double value2) {
     ...
     */
    @Nonnull
    default <S> ObjBiDoubleFunction<T, S> andThen(@Nonnull final LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiDoublePredicate<T> andThenToBoolean(@Nonnull final LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToByteFunction<T> andThenToByte(@Nonnull final LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToCharFunction<T> andThenToChar(@Nonnull final LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToFloatFunction<T> andThenToFloat(@Nonnull final LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToLongFunction<T> andThenToLong(@Nonnull final LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToShortFunction<T> andThenToShort(@Nonnull final LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     * to use this {@code ObjBiDoubleToLongFunction} with JDK specific methods, only accepting {@code TriFunction}.
     *
