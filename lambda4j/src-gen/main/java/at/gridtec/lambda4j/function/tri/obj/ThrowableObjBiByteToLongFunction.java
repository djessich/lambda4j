...
public interface ThrowableObjBiByteToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToLongFunction<T, X> of(
            @Nullable final ThrowableObjBiByteToLongFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjBiByteToLongFunction<T> nestWith(
    ...
    default ObjBiByteToLongFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiByteToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiByteToLongFunction<? super T> function = recover.apply(throwable);
