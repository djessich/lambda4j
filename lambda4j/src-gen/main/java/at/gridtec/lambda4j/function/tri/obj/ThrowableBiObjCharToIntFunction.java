...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjCharToIntFunction;
...
public interface ThrowableBiObjCharToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToIntFunction<T, U, X> of(
            @Nullable final ThrowableBiObjCharToIntFunction<T, U, X> expression) {
        return expression;
    }
     ...
     * this {@code ThrowableBiObjCharToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjCharToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjCharToIntFunction<T, U> nestWith(
     ...
     * @return A composed {@link BiObjCharToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjCharToIntFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjCharToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjCharToIntFunction<? super T, ? super U> function = recover.apply(throwable);
