...
public interface ToDoubleBiFunction2<T, U> extends Lambda, ToDoubleBiFunction<T, U> {
     ...
     */
    static <T, U> ToDoubleBiFunction2<T, U> of(@Nullable final ToDoubleBiFunction2<T, U> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <S> BiFunction2<T, U, S> andThen(@Nonnull final DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ToByteBiFunction<T, U> andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToCharBiFunction<T, U> andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToFloatBiFunction<T, U> andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> andThenToInt(@Nonnull final DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToShortBiFunction<T, U> andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> consume(@Nonnull final DoubleConsumer consumer) {
