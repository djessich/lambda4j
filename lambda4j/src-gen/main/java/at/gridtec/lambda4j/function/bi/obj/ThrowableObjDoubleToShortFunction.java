...
public interface ThrowableObjDoubleToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToShortFunction<T, X> of(
            @Nullable final ThrowableObjDoubleToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull final ThrowableObjDoubleToShortFunction<? super T, ? extends X> function, T t, double value) throws
            X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@code ObjDoubleToShortFunction} that applies this function to its input and nests the thrown
    ...
    default ObjDoubleToShortFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleToShortFunction<? super T>> recover) {
        Objects.requireNonNull(recover);
        return (t, value) -> {
            try {
                return this.applyAsShortThrows(t, value);
            } catch (Throwable throwable) {
                final ObjDoubleToShortFunction<? super T> function = recover.apply(throwable);
