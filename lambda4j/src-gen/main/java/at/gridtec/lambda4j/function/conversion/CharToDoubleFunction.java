...
/**
 * Represents an operation that accepts one {@code char}-valued input argument and produces a {@code double}-valued
 * result. This is a primitive specialization of {@link Function2}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDouble(char)}.
 *
 * @see Function2
 */
@SuppressWarnings("unused")
@FunctionalInterface
public interface CharToDoubleFunction extends Lambda {

    /**
     * Constructs a {@link CharToDoubleFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code CharToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static CharToDoubleFunction of(@Nullable final CharToDoubleFunction expression) {
        return expression;
    }

    /**
     * Calls the given {@link CharToDoubleFunction} with the given argument and returns its result.
     *
     ...
     */
    static double call(@Nonnull final CharToDoubleFunction function, char value) {
        Objects.requireNonNull(function);
        return function.applyAsDouble(value);
    }

    /**
     * Creates a {@link CharToDoubleFunction} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code CharToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static CharToDoubleFunction constant(double ret) {
        return (value) -> ret;
    }
     ...
     */
    @Nonnull
    default <A> ToDoubleFunction2<A> compose(@Nonnull final ToCharFunction<? super A> before) {
        Objects.requireNonNull(before);
        return (a) -> applyAsDouble(before.applyAsChar(a));
    }
     ...
     */
    @Nonnull
    default BooleanToDoubleFunction composeFromBoolean(@Nonnull final BooleanToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default ByteToDoubleFunction composeFromByte(@Nonnull final ByteToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }

    /**
     * Returns a composed {@link CharToDoubleFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     * operation which accepts {@code char} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code CharToDoubleFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to handle primitive values. In this case this is {@code
     * char}.
     */
    @Nonnull
    default CharToDoubleFunction composeFromChar(@Nonnull final CharUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default DoubleUnaryOperator2 composeFromDouble(@Nonnull final DoubleToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default FloatToDoubleFunction composeFromFloat(@Nonnull final FloatToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default IntToDoubleFunction2 composeFromInt(@Nonnull final IntToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 composeFromLong(@Nonnull final LongToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default ShortToDoubleFunction composeFromShort(@Nonnull final ShortToCharFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default <S> CharFunction<S> andThen(@Nonnull final DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default CharPredicate andThenToBoolean(@Nonnull final DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToByteFunction andThenToByte(@Nonnull final DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharUnaryOperator andThenToChar(@Nonnull final DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToDoubleFunction andThenToDouble(@Nonnull final DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToFloatFunction andThenToFloat(@Nonnull final DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToIntFunction andThenToInt(@Nonnull final DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToLongFunction andThenToLong(@Nonnull final DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToShortFunction andThenToShort(@Nonnull final DoubleToShortFunction after) {
        Objects.requireNonNull(after);
    ...
    /**
     * Returns a memoized (caching) version of this {@link CharToDoubleFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code CharToDoubleFunction}.
     ...
     */
    @Nonnull
    default CharToDoubleFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Character, Double> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (CharToDoubleFunction & Memoized) (value) -> {
    ...
    /**
     * Returns a composed {@link Function} which represents this {@link CharToDoubleFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method is just convenience to provide the ability to use this
     * {@code CharToDoubleFunction} with JDK specific methods, only accepting {@code Function}.
     *
     * @return A composed {@code Function} which represents this {@code CharToDoubleFunction}.
     */
    @Nonnull
    default Function<Character, Double> boxed() {
