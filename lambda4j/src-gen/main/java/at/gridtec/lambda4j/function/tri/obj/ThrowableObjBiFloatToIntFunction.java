 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiFloatToIntFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiFloatToIntFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjBiFloatToIntFunction} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiFloatToIntFunction<T, X> of(
            @Nullable final ThrowableObjBiFloatToIntFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiFloatToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiFloatToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> int call(
            @Nonnull final ThrowableObjBiFloatToIntFunction<? super T, ? extends X> function, T t, float value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToIntFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToIntFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableFloatToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToIntFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToIntFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableFloatToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatToIntFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToIntFunction<T, X> onlyThird(
            @Nonnull final ThrowableFloatToIntFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiFloatToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatToIntFunction<T, X> constant(int ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    int applyAsIntThrows(T t, float value1, float value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiFloatToIntFunction<X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> papplyAsIntThrows(T t, float value1) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToIntFunction<T, X> papplyAsIntThrows(float value1) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> papplyAsIntThrows(float value1, float value2) {
    ...
    default <A, B, C> ThrowableToIntTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsIntThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiFloatToIntFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiFloatToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiFloatToIntFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Float, Float, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link ObjBiFloatToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiFloatToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiFloatToIntFunction<T> nestWith(
    ...
    /**
     * Returns a composed {@link ObjBiFloatToIntFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiFloatToIntFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiFloatToIntFunction<T> sneakyThrow() {
     ...
     * @return A composed {@link ObjBiFloatToIntFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiFloatToIntFunction<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiFloatToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiFloatToIntFunction<? super T> function = recover.apply(throwable);
