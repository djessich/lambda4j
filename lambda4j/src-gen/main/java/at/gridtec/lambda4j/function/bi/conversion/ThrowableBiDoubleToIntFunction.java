...
public interface ThrowableBiDoubleToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleToIntFunction<X> of(
            @Nullable final ThrowableBiDoubleToIntFunction<X> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ThrowableIntBinaryOperator} that first applies the {@code before} functions to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiDoubleToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiDoubleToIntFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiDoubleToIntFunction function = recover.apply(throwable);
