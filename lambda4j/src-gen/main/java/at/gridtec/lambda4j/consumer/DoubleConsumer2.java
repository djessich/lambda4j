...
public interface DoubleConsumer2 extends Lambda, DoubleConsumer {
     ...
     */
    @Nonnull
    static DoubleConsumer2 of(@Nonnull final DoubleConsumer2 expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link Consumer} which represents this {@link DoubleConsumer2}. Thereby the primitive input
     * argument for this consumer is autoboxed. This method is just convenience to provide the ability to use this
     * {@code DoubleConsumer2} with JDK specific methods, only accepting {@code Consumer}.
     *
     * @return A composed {@code Consumer} which represents this {@code DoubleConsumer2}.
     */
    @Nonnull
