...
public interface ThrowableBiObjIntConsumer<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjIntConsumer<T, U, X> of(
            @Nullable final ThrowableBiObjIntConsumer<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull final ThrowableBiObjIntConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
            int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<U, X> pacceptThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> pacceptThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> pacceptThrows(int value) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<U, X> pacceptThrows(T t, int value) {
    ...
    default ThrowableBiObjIntConsumer<T, U, X> andThen(
            @Nonnull final ThrowableBiObjIntConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default BiObjIntConsumer<T, U> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiObjIntConsumer<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjIntConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjIntConsumer<? super T, ? super U> consumer = recover.apply(throwable);
