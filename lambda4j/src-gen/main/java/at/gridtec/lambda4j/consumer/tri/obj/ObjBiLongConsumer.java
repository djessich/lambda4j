...
public interface ObjBiLongConsumer<T> extends Lambda {
     ...
     */
    static <T> ObjBiLongConsumer<T> of(@Nullable final ObjBiLongConsumer<T> expression) {
        return expression;
    }
     ...
     */
    static <T> void call(@Nonnull final ObjBiLongConsumer<? super T> consumer, T t, long value1, long value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiLongConsumer<T> onlyFirst(@Nonnull final Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T> ObjBiLongConsumer<T> onlySecond(@Nonnull final LongConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T> ObjBiLongConsumer<T> onlyThird(@Nonnull final LongConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default ObjBiLongConsumer<T> andThen(@Nonnull final ObjBiLongConsumer<? super T> after) {
     ...
     * {@code ObjBiLongConsumer} with JDK specific methods, only accepting {@code TriConsumer}.
     *
