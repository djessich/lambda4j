 ...
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableObjBiDoubleConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, double, double)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiDoubleConsumer<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiDoubleConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiDoubleConsumer} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiDoubleConsumer<T, X> of(
            @Nullable final ThrowableObjBiDoubleConsumer<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiDoubleConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, X extends Throwable> void call(
            @Nonnull final ThrowableObjBiDoubleConsumer<? super T, ? extends X> consumer, T t, double value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiDoubleConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiDoubleConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiDoubleConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiDoubleConsumer} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableDoubleConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiDoubleConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiDoubleConsumer<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiDoubleConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableDoubleConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiDoubleConsumer} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableDoubleConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiDoubleConsumer<T, X> onlyThird(
            @Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, double value1, double value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiDoubleConsumer<X> pacceptThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleConsumer<X> pacceptThrows(T t, double value1) {
        return (value2) -> this.acceptThrows(t, value1, value2);
    }

    /**
     * Applies this consumer partially to some arguments of this one, producing a {@link ThrowableObjDoubleConsumer} as
     * result.
     *
     * @param value1 The second argument to this consumer used to partially apply this function
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> pacceptThrows(double value1) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> pacceptThrows(double value1, double value2) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyAsDoubleThrows(b),
    ...
    /**
     * Returns a composed {@link ThrowableObjBiDoubleConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjBiDoubleConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> andThen(
            @Nonnull final ThrowableObjBiDoubleConsumer<? super T, ? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableObjBiDoubleConsumer}.
     * Thereby the primitive input argument for this consumer is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiDoubleConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableObjBiDoubleConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, Double, Double, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjBiDoubleConsumer} that applies this consumer to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiDoubleConsumer} that applies this consumer to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiDoubleConsumer<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjBiDoubleConsumer} that first applies this consumer to its input, and then applies
     * the {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjBiDoubleConsumer} that first applies this consumer to its input, and then applies
     ...
     */
    @Nonnull
    default ObjBiDoubleConsumer<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiDoubleConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiDoubleConsumer<? super T> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiDoubleConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiDoubleConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiDoubleConsumer<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                this.acceptThrows(t, value1, value2);
