...
public interface ObjFloatConsumer<T> extends Lambda {
     ...
     */
    @Nonnull
    static <T> ObjFloatConsumer<T> of(@Nonnull final ObjFloatConsumer<T> expression) {
        return expression;
    }
     ...
     * {@code ObjFloatConsumer} with JDK specific methods, only accepting {@code BiConsumer}.
     *
