...
public interface ThrowableTriShortConsumer<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriShortConsumer<X> of(
            @Nonnull final ThrowableTriShortConsumer<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code TriShortConsumer} that applies this consumer to its input and nests the thrown {@code
