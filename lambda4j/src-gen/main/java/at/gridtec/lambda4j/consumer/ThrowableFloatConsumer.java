...
/**
 * Represents an operation that accepts one {@code float}-valued input argument and returns no result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableConsumer}. Unlike most other
 * functional interfaces, {@code ThrowableFloatConsumer} is expected to operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(float)}.
 *
...
@FunctionalInterface
public interface ThrowableFloatConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableFloatConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ThrowableFloatConsumer} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableFloatConsumer<X> of(@Nullable final ThrowableFloatConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableFloatConsumer} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull final ThrowableFloatConsumer<? extends X> consumer,
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(float value) throws X;
    ...
    default <A> ThrowableConsumer<A, X> compose(
        ...
        return (a) -> acceptThrows(before.applyAsFloatThrows(a));
    }
    ...
    default ThrowableBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsFloatThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> composeFromByte(@Nonnull final ThrowableByteToFloatFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsFloatThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> composeFromChar(@Nonnull final ThrowableCharToFloatFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsFloatThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableFloatConsumer} that first applies the {@code before} operator to its input,
     * and then applies this consumer to the result. This method is just convenience, to provide the ability to execute
     ...
     * @return A composed {@code ThrowableFloatConsumer} that first applies the {@code before} operator to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * float}.
     */
    @Nonnull
    default ThrowableFloatConsumer<X> composeFromFloat(@Nonnull final ThrowableFloatUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsFloatThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> composeFromInt(@Nonnull final ThrowableIntToFloatFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsFloatThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> composeFromLong(@Nonnull final ThrowableLongToFloatFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsFloatThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableFloatConsumer<X> andThen(@Nonnull final ThrowableFloatConsumer<? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableConsumer} which represents this {@link ThrowableFloatConsumer}. Thereby the
     * primitive input argument for this consumer is autoboxed. This method provides the possibility to use this {@code
     * ThrowableFloatConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableConsumer} which represents this {@code ThrowableFloatConsumer}.
     */
    @Nonnull
    default ThrowableConsumer<Float, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link FloatConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link FloatConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default FloatConsumer nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link FloatConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link FloatConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default FloatConsumer sneakyThrow() {
        return (value) -> {
            try {
    ...
    /**
     * Returns a composed {@link FloatConsumer} that first applies this consumer to its input, and then applies the
     ...
     * @return A composed {@link FloatConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default FloatConsumer recover(@Nonnull final Function<? super Throwable, ? extends FloatConsumer> recover) {
        ...
        return (value) -> {
            try {
                ...
                final FloatConsumer consumer = recover.apply(throwable);
