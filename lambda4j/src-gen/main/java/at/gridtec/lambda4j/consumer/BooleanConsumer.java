...
/**
 * Represents an operation that accepts one {@code boolean}-valued input argument and returns no result.
...
public interface BooleanConsumer extends Lambda {
     ...
     */
    static BooleanConsumer of(@Nullable final BooleanConsumer expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link Consumer2} that first applies the {@code before} predicate to its input, and
     ...
     */
    @Nonnull
    default <A> Consumer2<A> compose(@Nonnull final Predicate<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanConsumer composeFromBoolean(@Nonnull final BooleanUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsBoolean(value));
    }

    /**
     * Returns a composed {@link ByteConsumer} that first applies the {@code before} predicate to
     ...
     */
    @Nonnull
    default ByteConsumer composeFromByte(@Nonnull final BytePredicate before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.test(value));
    }

    /**
     * Returns a composed {@link CharConsumer} that first applies the {@code before} predicate to
     * its input, and then applies this consumer to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default CharConsumer composeFromChar(@Nonnull final CharPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.test(value));
    }
     ...
     */
    @Nonnull
    default DoubleConsumer2 composeFromDouble(@Nonnull final DoublePredicate before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.test(value));
    }
     ...
     */
    @Nonnull
    default FloatConsumer composeFromFloat(@Nonnull final FloatPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.test(value));
    }

    /**
     * Returns a composed {@link IntConsumer2} that first applies the {@code before} predicate to
     * its input, and then applies this consumer to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default IntConsumer2 composeFromInt(@Nonnull final IntPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.test(value));
    }

    /**
     * Returns a composed {@link LongConsumer2} that first applies the {@code before} predicate to
     * its input, and then applies this consumer to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default LongConsumer2 composeFromLong(@Nonnull final LongPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.test(value));
    }
     ...
     */
    @Nonnull
    default ShortConsumer composeFromShort(@Nonnull final ShortPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.test(value));
    }
    ...
    /**
     * Returns a composed {@link Consumer2} which represents this {@link BooleanConsumer}. Thereby the primitive
     * input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code BooleanConsumer} with methods provided by the {@code JDK}.
     *
