...
public interface ThrowableBiObjLongConsumer<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongConsumer<T, U, X> of(
            @Nullable final ThrowableBiObjLongConsumer<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull final ThrowableBiObjLongConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<U, X> pacceptThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> pacceptThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> pacceptThrows(long value) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<U, X> pacceptThrows(T t, long value) {
    ...
    default ThrowableBiObjLongConsumer<T, U, X> andThen(
            @Nonnull final ThrowableBiObjLongConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> nestWith(
    ...
    default BiObjLongConsumer<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjLongConsumer<? super T, ? super U> consumer = recover.apply(throwable);
