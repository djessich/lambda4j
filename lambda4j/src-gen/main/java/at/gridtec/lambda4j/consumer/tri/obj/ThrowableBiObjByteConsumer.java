...
public interface ThrowableBiObjByteConsumer<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteConsumer<T, U, X> of(
            @Nullable final ThrowableBiObjByteConsumer<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull final ThrowableBiObjByteConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
            byte value) throws X {
    ...
    default ThrowableBiObjByteConsumer<T, U, X> andThen(
            @Nonnull final ThrowableBiObjByteConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default BiObjByteConsumer<T, U> nestWith(
    ...
    default BiObjByteConsumer<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjByteConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjByteConsumer<? super T, ? super U> consumer = recover.apply(throwable);
