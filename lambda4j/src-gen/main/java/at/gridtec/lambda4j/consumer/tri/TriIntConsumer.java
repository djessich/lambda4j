...
public interface TriIntConsumer extends Lambda {
     ...
     */
    static void call(@Nonnull final TriIntConsumer consumer, int value1, int value2, int value3) {
     ...
     */
    @Nonnull
    static TriIntConsumer onlyFirst(@Nonnull final IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static TriIntConsumer onlySecond(@Nonnull final IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static TriIntConsumer onlyThird(@Nonnull final IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default TriBooleanConsumer composeFromBoolean(@Nonnull final BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default TriByteConsumer composeFromByte(@Nonnull final ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default TriCharConsumer composeFromChar(@Nonnull final CharToIntFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleConsumer composeFromDouble(@Nonnull final DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default TriFloatConsumer composeFromFloat(@Nonnull final FloatToIntFunction before1,
     ...
     */
    @Nonnull
    default TriIntConsumer composeFromInt(@Nonnull final IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriLongConsumer composeFromLong(@Nonnull final LongToIntFunction before1,
     ...
     */
    @Nonnull
    default TriShortConsumer composeFromShort(@Nonnull final ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default TriIntConsumer andThen(@Nonnull final TriIntConsumer after) {
     ...
     * {@code TriIntConsumer} with JDK specific methods, only accepting {@code TriConsumer}.
     *
