...
public interface ThrowableObjBiBooleanConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiBooleanConsumer<T, X> of(
            @Nonnull final ThrowableObjBiBooleanConsumer<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code ObjBiBooleanConsumer} that applies this consumer to its input and nests the thrown
