...
public interface BiObjBooleanConsumer<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjBooleanConsumer<T, U> of(@Nullable final BiObjBooleanConsumer<T, U> expression) {
        return expression;
    }
     ...
     * {@code BiObjBooleanConsumer} with methods provided by the {@code JDK}.
     *
