...
public interface BiObjCharConsumer<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjCharConsumer<T, U> of(@Nullable final BiObjCharConsumer<T, U> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjCharConsumer<U> paccept(T t) {
     ...
     */
    @Nonnull
    default CharConsumer paccept(T t, U u) {
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> paccept(char value) {
     ...
     */
    @Nonnull
    default Consumer2<U> paccept(T t, char value) {
     ...
     * {@code BiObjCharConsumer} with methods provided by the {@code JDK}.
     *
