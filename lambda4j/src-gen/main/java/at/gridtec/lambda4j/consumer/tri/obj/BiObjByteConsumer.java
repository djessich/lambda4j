...
public interface BiObjByteConsumer<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjByteConsumer<T, U> of(@Nullable final BiObjByteConsumer<T, U> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjByteConsumer<U> paccept(T t) {
     ...
     */
    @Nonnull
    default ByteConsumer paccept(T t, U u) {
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> paccept(byte value) {
     ...
     */
    @Nonnull
    default Consumer2<U> paccept(T t, byte value) {
     ...
     * {@code BiObjByteConsumer} with methods provided by the {@code JDK}.
     *
