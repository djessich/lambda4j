...
public interface ThrowableBiObjShortConsumer<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortConsumer<T, U, X> of(
            @Nullable final ThrowableBiObjShortConsumer<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull final ThrowableBiObjShortConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<U, X> pacceptThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> pacceptThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> pacceptThrows(short value) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<U, X> pacceptThrows(T t, short value) {
    ...
    default ThrowableBiObjShortConsumer<T, U, X> andThen(
            @Nonnull final ThrowableBiObjShortConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default BiObjShortConsumer<T, U> nestWith(
    ...
    default BiObjShortConsumer<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjShortConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjShortConsumer<? super T, ? super U> consumer = recover.apply(throwable);
