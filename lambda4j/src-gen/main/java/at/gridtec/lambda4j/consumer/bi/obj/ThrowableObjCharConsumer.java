...
public interface ThrowableObjCharConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharConsumer<T, X> of(
            @Nullable final ThrowableObjCharConsumer<T, X> expression) {
        return expression;
    }
     ...
     */
    static <T, X extends Throwable> void call(@Nonnull final ThrowableObjCharConsumer<? super T, ? extends X> consumer,
    ...
    default ThrowableObjCharConsumer<T, X> andThen(
            @Nonnull final ThrowableObjCharConsumer<? super T, ? extends X> after) {
     ...
     */
    @Nonnull
    default ObjCharConsumer<T> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjCharConsumer} that applies this consumer to its input and sneakily throws the
    ...
    default ObjCharConsumer<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjCharConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjCharConsumer<? super T> consumer = recover.apply(throwable);
