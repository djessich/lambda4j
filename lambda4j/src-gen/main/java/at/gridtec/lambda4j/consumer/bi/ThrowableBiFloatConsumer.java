 ...
 * functional interfaces, {@code ThrowableBiFloatConsumer} is expected to operate via side-effects.
 * <p>
...
@FunctionalInterface
public interface ThrowableBiFloatConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiFloatConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiFloatConsumer} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableBiFloatConsumer<X> of(
            @Nullable final ThrowableBiFloatConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiFloatConsumer} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull final ThrowableBiFloatConsumer<? extends X> consumer, float value1,
    ...
    /**
     * Creates a {@link ThrowableBiFloatConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableFloatConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiFloatConsumer} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableFloatConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiFloatConsumer<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiFloatConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableFloatConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiFloatConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiFloatConsumer<X> onlySecond(
            @Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
    ...
    default <A, B> ThrowableBiConsumer<A, B, X> compose(
        ...
        return (a, b) -> acceptThrows(before1.applyAsFloatThrows(a), before2.applyAsFloatThrows(b));
    }
    ...
    default ThrowableBiBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> acceptThrows(before1.applyAsFloatThrows(value1), before2.applyAsFloatThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> composeFromByte(@Nonnull final ThrowableByteToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> composeFromChar(@Nonnull final ThrowableCharToFloatFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiFloatConsumer} that first applies the {@code before} operators to its input,
     ...
     * @return A composed {@code ThrowableBiFloatConsumer} that first applies the {@code before} operators to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * float}.
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> composeFromInt(@Nonnull final ThrowableIntToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> composeFromLong(@Nonnull final ThrowableLongToFloatFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> andThen(@Nonnull final ThrowableBiFloatConsumer<? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableBiConsumer} which represents this {@link ThrowableBiFloatConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableBiFloatConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiConsumer} which represents this {@code ThrowableBiFloatConsumer}.
     */
    @Nonnull
    default ThrowableBiConsumer<Float, Float, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiFloatConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiFloatConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiFloatConsumer nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiFloatConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiFloatConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiFloatConsumer sneakyThrow() {
        return (value1, value2) -> {
            try {
    ...
    /**
     * Returns a composed {@link BiFloatConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiFloatConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default BiFloatConsumer recover(@Nonnull final Function<? super Throwable, ? extends BiFloatConsumer> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiFloatConsumer consumer = recover.apply(throwable);
