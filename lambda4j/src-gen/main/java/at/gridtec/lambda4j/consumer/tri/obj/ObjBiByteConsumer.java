 ...
 * result. This is a (reference, byte, byte) specialization of {@link TriConsumer}. Unlike most other functional
 * interfaces, {@code ObjBiByteConsumer} is expected to operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #accept(Object, byte, byte)}.
 *
...
@FunctionalInterface
public interface ObjBiByteConsumer<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiByteConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ObjBiByteConsumer} from given lambda expression or method reference.
     ...
     */
    static <T> ObjBiByteConsumer<T> of(@Nullable final ObjBiByteConsumer<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiByteConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     ...
     */
    static <T> void call(@Nonnull final ObjBiByteConsumer<? super T> consumer, T t, byte value1, byte value2) {
        Objects.requireNonNull(consumer);
        consumer.accept(t, value1, value2);
    }

    /**
     * Creates a {@link ObjBiByteConsumer} which uses the {@code first} parameter of this one as argument for the given
     * {@link Consumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiByteConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@code Consumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiByteConsumer<T> onlyFirst(@Nonnull final Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(t);
    }

    /**
     * Creates a {@link ObjBiByteConsumer} which uses the {@code second} parameter of this one as argument for the given
     * {@link ByteConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiByteConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@code ByteConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiByteConsumer<T> onlySecond(@Nonnull final ByteConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(value1);
    }

    /**
     * Creates a {@link ObjBiByteConsumer} which uses the {@code third} parameter of this one as argument for the given
     * {@link ByteConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiByteConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@code ByteConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiByteConsumer<T> onlyThird(@Nonnull final ByteConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @param value2 The third argument to the consumer
     */
    void accept(T t, byte value1, byte value2);
    ...
    default <A, B, C> TriConsumer<A, B, C> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> accept(before1.apply(a), before2.applyAsByte(b), before3.applyAsByte(c));
    }
    ...
    default TriBooleanConsumer composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> accept(before1.apply(value1), before2.applyAsByte(value2),
    ...
    /**
     * Returns a composed {@link ObjBiByteConsumer} that performs, in sequence, this consumer followed by the {@code
     ...
     * @return A composed {@link ObjBiByteConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ObjBiByteConsumer<T> andThen(@Nonnull final ObjBiByteConsumer<? super T> after) {
    ...
    /**
     * Returns a composed {@link TriConsumer} which represents this {@link ObjBiByteConsumer}. Thereby the primitive
     * input argument for this consumer is autoboxed. This method is just convenience to provide the ability to use this
     * {@code ObjBiByteConsumer} with JDK specific methods, only accepting {@code TriConsumer}.
     *
     * @return A composed {@code TriConsumer} which represents this {@code ObjBiByteConsumer}.
     */
    @Nonnull
    default TriConsumer<T, Byte, Byte> boxed() {
        return this::accept;
    }
