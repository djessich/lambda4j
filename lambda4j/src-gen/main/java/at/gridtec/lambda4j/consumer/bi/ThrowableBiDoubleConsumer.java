...
public interface ThrowableBiDoubleConsumer<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiDoubleConsumer<X> of(
            @Nullable final ThrowableBiDoubleConsumer<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> void call(@Nonnull final ThrowableBiDoubleConsumer<? extends X> consumer,
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> composeFromInt(@Nonnull final ThrowableIntToDoubleFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleConsumer<X> andThen(@Nonnull final ThrowableBiDoubleConsumer<? extends X> after) {
     ...
     *
     * @return A composed {@code BiDoubleConsumer} that applies this consumer to its input and nests the thrown {@code
     ...
     */
    @Nonnull
    default BiDoubleConsumer recover(@Nonnull final Function<? super Throwable, ? extends BiDoubleConsumer> recover) {
        Objects.requireNonNull(recover);
        return (value1, value2) -> {
            try {
                this.acceptThrows(value1, value2);
            } catch (Throwable throwable) {
                final BiDoubleConsumer consumer = recover.apply(throwable);
