...
public interface FloatConsumer extends Lambda {
     ...
     */
    static FloatConsumer of(@Nullable final FloatConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull final FloatConsumer consumer, float value) {
     ...
     */
    @Nonnull
    default <A> Consumer2<A> compose(@Nonnull final ToFloatFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanConsumer composeFromBoolean(@Nonnull final BooleanToFloatFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteConsumer composeFromByte(@Nonnull final ByteToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default CharConsumer composeFromChar(@Nonnull final CharToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default DoubleConsumer2 composeFromDouble(@Nonnull final DoubleToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default FloatConsumer composeFromFloat(@Nonnull final FloatUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default IntConsumer2 composeFromInt(@Nonnull final IntToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default LongConsumer2 composeFromLong(@Nonnull final LongToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default ShortConsumer composeFromShort(@Nonnull final ShortToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsFloat(value));
    }
