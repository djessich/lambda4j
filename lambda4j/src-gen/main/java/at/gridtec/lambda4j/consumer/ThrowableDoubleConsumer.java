...
public interface ThrowableDoubleConsumer<X extends Throwable> extends Lambda, DoubleConsumer {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableDoubleConsumer<X> of(@Nonnull final ThrowableDoubleConsumer<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code DoubleConsumer2} that applies this consumer to its input and nests the thrown {@code
