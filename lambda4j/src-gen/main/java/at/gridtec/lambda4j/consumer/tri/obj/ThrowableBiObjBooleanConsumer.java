 ...
 * {@link ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableBiObjBooleanConsumer} is
...
@FunctionalInterface
public interface ThrowableBiObjBooleanConsumer<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjBooleanConsumer} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjBooleanConsumer} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjBooleanConsumer<T, U, X> of(
            @Nullable final ThrowableBiObjBooleanConsumer<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjBooleanConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <U> The type of the second argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull final ThrowableBiObjBooleanConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanConsumer<T, U, X> onlyFirst(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanConsumer<T, U, X> onlySecond(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanConsumer<T, U, X> onlyThird(
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, U u, boolean value) throws X;
     ...
     */
    default void acceptThrows(@Nonnull Pair<T, U> tuple, boolean value) throws X {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyThrows(b), before3.testThrows(c));
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanConsumer} that performs, in sequence, this consumer followed by
     * the {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not
     * be performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiObjBooleanConsumer} that performs, in sequence, this consumer followed by
     * the {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiObjBooleanConsumer<T, U, X> andThen(
            @Nonnull final ThrowableBiObjBooleanConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableObjBooleanConsumer<Pair<T, U>, X> tupled() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableBiObjBooleanConsumer}.
     * Thereby the primitive input argument for this consumer is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjBooleanConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableBiObjBooleanConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, Boolean, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiObjBooleanConsumer} that applies this consumer to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjBooleanConsumer} that applies this consumer to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjBooleanConsumer<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjBooleanConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjBooleanConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjBooleanConsumer<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
    ...
    /**
     * Returns a composed {@link BiObjBooleanConsumer} that first applies this consumer to its input, and then applies
     * the {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiObjBooleanConsumer} that first applies this consumer to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjBooleanConsumer<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjBooleanConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjBooleanConsumer<? super T, ? super U> consumer = recover.apply(throwable);
