...
/**
 * Represents an operation that accepts one object-valued and two {@code byte}-valued input arguments and returns no
 * result which is able to throw any {@link Throwable}. This is a (reference, byte, byte) specialization of {@link
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableObjBiByteConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, byte, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiByteConsumer<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiByteConsumer} based on a lambda expression or a method reference. Thereby the
    ...
    /**
     * Calls the given {@link ThrowableObjBiByteConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, X extends Throwable> void call(
            @Nonnull final ThrowableObjBiByteConsumer<? super T, ? extends X> consumer, T t, byte value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiByteConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiByteConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableByteConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableByteConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteConsumer<T, X> onlySecond(
            @Nonnull final ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(value1);
    }

    /**
     * Creates a {@link ThrowableObjBiByteConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableByteConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteConsumer} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableByteConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteConsumer<T, X> onlyThird(
            @Nonnull final ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, byte value1, byte value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> pacceptThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> pacceptThrows(T t, byte value1) {
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> pacceptThrows(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> pacceptThrows(byte value1, byte value2) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyAsByteThrows(b),
    ...
    default ThrowableTriBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> acceptThrows(before1.applyThrows(value1), before2.applyAsByteThrows(value2),
    ...
    /**
     * Returns a composed {@link ThrowableObjBiByteConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjBiByteConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> andThen(
            @Nonnull final ThrowableObjBiByteConsumer<? super T, ? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableObjBiByteConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjBiByteConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableObjBiByteConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, Byte, Byte, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjBiByteConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiByteConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjBiByteConsumer<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiByteConsumer<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjBiByteConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjBiByteConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiByteConsumer<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiByteConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiByteConsumer<? super T> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiByteConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiByteConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiByteConsumer<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                this.acceptThrows(t, value1, value2);
