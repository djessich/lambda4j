...
/**
 * Represents an operation that accepts one {@code char}-valued input argument and returns no result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableConsumer}. Unlike most other
 * functional interfaces, {@code ThrowableCharConsumer} is expected to operate via side-effects.
 * <p>
...
@FunctionalInterface
public interface ThrowableCharConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableCharConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ThrowableCharConsumer} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableCharConsumer<X> of(@Nullable final ThrowableCharConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableCharConsumer} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull final ThrowableCharConsumer<? extends X> consumer,
            char value) throws X {
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(char value) throws X;
     ...
     */
    @Nonnull
    default <A> ThrowableConsumer<A, X> compose(@Nonnull final ThrowableToCharFunction<? super A, ? extends X> before) {
        Objects.requireNonNull(before);
        return (a) -> acceptThrows(before.applyAsCharThrows(a));
    }
    ...
    default ThrowableBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsCharThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> composeFromByte(@Nonnull final ThrowableByteToCharFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsCharThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableCharConsumer} that first applies the {@code before} operator to
     * its input, and then applies this consumer to the result.
     * This method is just convenience, to provide the ability to execute an operation which accepts {@code char} input,
     * before this primitive consumer is executed.
     *
     * @param before The operator to apply before this consumer is applied
     * @return A composed {@code ThrowableCharConsumer} that first applies the {@code before} operator to its input, and
     * then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * char}.
     */
    @Nonnull
    default ThrowableCharConsumer<X> composeFromChar(@Nonnull final ThrowableCharUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsCharThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> composeFromInt(@Nonnull final ThrowableIntToCharFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsCharThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> composeFromLong(@Nonnull final ThrowableLongToCharFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsCharThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableCharConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableCharConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableCharConsumer<X> andThen(@Nonnull final ThrowableCharConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<Character, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link CharConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link CharConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default CharConsumer nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link CharConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link CharConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default CharConsumer sneakyThrow() {
        return (value) -> {
            try {
    ...
    /**
     * Returns a composed {@link CharConsumer} that first applies this consumer to its input, and then applies the
     ...
     * @return A composed {@link CharConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default CharConsumer recover(@Nonnull final Function<? super Throwable, ? extends CharConsumer> recover) {
        ...
        return (value) -> {
            try {
                ...
                final CharConsumer consumer = recover.apply(throwable);
