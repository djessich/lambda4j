...
/**
 * Represents an operation that accepts two {@code short}-valued input arguments and returns no result. This is a
 * primitive specialization of {@link BiConsumer2}. Unlike most other functional interfaces, {@code BiShortConsumer} is
...
@FunctionalInterface
public interface BiShortConsumer extends Lambda {

    /**
     * Constructs a {@link BiShortConsumer} based on a lambda expression or a method reference. Thereby the given lambda
     * expression or method reference is returned on an as-is basis to implicitly transform it to the desired type. With
     * this method, it is possible to ensure that correct type is used from lambda expression or method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiShortConsumer} from given lambda expression or method reference.
     ...
     */
    static BiShortConsumer of(@Nullable final BiShortConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull final BiShortConsumer consumer, short value1, short value2) {
        Objects.requireNonNull(consumer);
        consumer.accept(value1, value2);
    }

    /**
     * Creates a {@link BiShortConsumer} which uses the {@code first} parameter of this one as argument for the given
     * {@link ShortConsumer}.
     *
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiShortConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@code ShortConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static BiShortConsumer onlyFirst(@Nonnull final ShortConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (value1, value2) -> consumer.accept(value1);
    }

    /**
     * Creates a {@link BiShortConsumer} which uses the {@code second} parameter of this one as argument for the given
     * {@link ShortConsumer}.
     *
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiShortConsumer} which uses the {@code second} parameter of this one as argument for the
     * given {@code ShortConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static BiShortConsumer onlySecond(@Nonnull final ShortConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default <A, B> BiConsumer2<A, B> compose(@Nonnull final ToShortFunction<? super A> before1,
            @Nonnull final ToShortFunction<? super B> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (a, b) -> accept(before1.applyAsShort(a), before2.applyAsShort(b));
    }
     ...
     */
    @Nonnull
    default BiBooleanConsumer composeFromBoolean(@Nonnull final BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default BiByteConsumer composeFromByte(@Nonnull final ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default BiCharConsumer composeFromChar(@Nonnull final CharToShortFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleConsumer composeFromDouble(@Nonnull final DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default BiFloatConsumer composeFromFloat(@Nonnull final FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default BiIntConsumer composeFromInt(@Nonnull final IntToShortFunction before1,
     ...
     */
    @Nonnull
    default BiLongConsumer composeFromLong(@Nonnull final LongToShortFunction before1,
    ...
    /**
     * Returns a composed {@link BiShortConsumer} that first applies the {@code before} operators to its input, and then
     * applies this consumer to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation. This method is just convenience, to provide the ability to execute an operation
     ...
     * @return A composed {@code BiShortConsumer} that first applies the {@code before} operators to its input, and then
     * applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implNote The input argument of this method is a able to handle primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default BiShortConsumer composeFromShort(@Nonnull final ShortUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link BiShortConsumer} that performs, in sequence, this consumer followed by the {@code
     ...
     * @return A composed {@link BiShortConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default BiShortConsumer andThen(@Nonnull final BiShortConsumer after) {
    ...
    /**
     * Returns a composed {@link BiConsumer} which represents this {@link BiShortConsumer}. Thereby the primitive input
     * argument for this consumer is autoboxed. This method is just convenience to provide the ability to use this
     * {@code BiShortConsumer} with JDK specific methods, only accepting {@code BiConsumer}.
     *
     * @return A composed {@code BiConsumer} which represents this {@code BiShortConsumer}.
     */
    @Nonnull
