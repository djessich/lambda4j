...
/**
 * Represents an operation that accepts two {@code short}-valued input arguments and returns no result.
 * This is a primitive specialization of {@link BiConsumer2}.
 * Unlike most other functional interfaces, {@code BiShortConsumer} is expected to operate via side-effects.
 * <p>
