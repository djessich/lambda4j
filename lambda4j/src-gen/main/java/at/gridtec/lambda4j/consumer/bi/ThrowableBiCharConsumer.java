...
public interface ThrowableBiCharConsumer<X extends Throwable> extends Lambda {
     ...
     */
    static <X extends Throwable> ThrowableBiCharConsumer<X> of(@Nullable final ThrowableBiCharConsumer<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> void call(@Nonnull final ThrowableBiCharConsumer<? extends X> consumer, char value1,
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> composeFromByte(@Nonnull final ThrowableByteToCharFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiCharConsumer} that first applies the {@code before} operators to
     * its input, and then applies this consumer to the result.
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> composeFromChar(@Nonnull final ThrowableCharUnaryOperator<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> composeFromInt(@Nonnull final ThrowableIntToCharFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> composeFromLong(@Nonnull final ThrowableLongToCharFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> andThen(@Nonnull final ThrowableBiCharConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default BiCharConsumer nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiCharConsumer} that applies this consumer to its input and sneakily throws the
     ...
     */
    @Nonnull
    default BiCharConsumer recover(@Nonnull final Function<? super Throwable, ? extends BiCharConsumer> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiCharConsumer consumer = recover.apply(throwable);
