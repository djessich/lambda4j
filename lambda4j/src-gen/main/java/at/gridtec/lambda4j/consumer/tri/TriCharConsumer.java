...
/**
 * Represents an operation that accepts three {@code char}-valued input arguments and returns no result.
 * This is a primitive specialization of {@link TriConsumer}.
 * Unlike most other functional interfaces, {@code TriCharConsumer} is expected to operate via side-effects.
 * <p>
...
public interface TriCharConsumer extends Lambda {
    ...
    /**
     * Returns a composed {@link TriCharConsumer} that first applies the {@code before} operators to
     * its input, and then applies this consumer to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
