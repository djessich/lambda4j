...
/**
 * Represents an operation that accepts one {@code short}-valued input argument and returns no result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableConsumer}. Unlike most other
 * functional interfaces, {@code ThrowableShortConsumer} is expected to operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(short)}.
 *
...
@FunctionalInterface
public interface ThrowableShortConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableShortConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ThrowableShortConsumer} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableShortConsumer<X> of(@Nullable final ThrowableShortConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableShortConsumer} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull final ThrowableShortConsumer<? extends X> consumer,
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(short value) throws X;
    ...
    default <A> ThrowableConsumer<A, X> compose(
        ...
        return (a) -> acceptThrows(before.applyAsShortThrows(a));
    }
    ...
    default ThrowableBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> composeFromByte(@Nonnull final ThrowableByteToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> composeFromChar(@Nonnull final ThrowableCharToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> composeFromInt(@Nonnull final ThrowableIntToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> composeFromLong(@Nonnull final ThrowableLongToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsShortThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableShortConsumer} that first applies the {@code before} operator to its input,
     * and then applies this consumer to the result. This method is just convenience, to provide the ability to execute
     ...
     * @return A composed {@code ThrowableShortConsumer} that first applies the {@code before} operator to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default ThrowableShortConsumer<X> composeFromShort(@Nonnull final ThrowableShortUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> acceptThrows(before.applyAsShortThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableShortConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableShortConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableShortConsumer<X> andThen(@Nonnull final ThrowableShortConsumer<? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableConsumer} which represents this {@link ThrowableShortConsumer}. Thereby the
     * primitive input argument for this consumer is autoboxed. This method provides the possibility to use this {@code
     * ThrowableShortConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableConsumer} which represents this {@code ThrowableShortConsumer}.
     */
    @Nonnull
    default ThrowableConsumer<Short, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ShortConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ShortConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ShortConsumer nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ShortConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ShortConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ShortConsumer sneakyThrow() {
        return (value) -> {
            try {
    ...
    /**
     * Returns a composed {@link ShortConsumer} that first applies this consumer to its input, and then applies the
     ...
     * @return A composed {@link ShortConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ShortConsumer recover(@Nonnull final Function<? super Throwable, ? extends ShortConsumer> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ShortConsumer consumer = recover.apply(throwable);
