...
public interface ThrowableBiIntConsumer<X extends Throwable> extends Lambda {
     ...
     */
    static <X extends Throwable> ThrowableBiIntConsumer<X> of(@Nullable final ThrowableBiIntConsumer<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> void call(@Nonnull final ThrowableBiIntConsumer<? extends X> consumer, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> pacceptThrows(int value1) {
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> composeFromByte(@Nonnull final ThrowableByteToIntFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> composeFromChar(@Nonnull final ThrowableCharToIntFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiIntConsumer} that first applies the {@code before} operators to
     * its input, and then applies this consumer to the result.
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> composeFromInt(@Nonnull final ThrowableIntUnaryOperator<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> composeFromLong(@Nonnull final ThrowableLongToIntFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> andThen(@Nonnull final ThrowableBiIntConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default BiIntConsumer nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiIntConsumer} that applies this consumer to its input and sneakily throws the
     ...
     */
    @Nonnull
    default BiIntConsumer recover(@Nonnull final Function<? super Throwable, ? extends BiIntConsumer> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiIntConsumer consumer = recover.apply(throwable);
