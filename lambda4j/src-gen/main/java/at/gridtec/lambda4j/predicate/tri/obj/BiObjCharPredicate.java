...
import at.gridtec.lambda4j.function.tri.obj.BiObjCharFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjCharToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjCharToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjCharToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjCharToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjCharToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjCharToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjCharToShortFunction;
...
public interface BiObjCharPredicate<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjCharPredicate<T, U> of(@Nullable final BiObjCharPredicate<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> boolean call(@Nonnull final BiObjCharPredicate<? super T, ? super U> predicate, T t, U u,
            char value) {
     ...
     */
    @Nonnull
    default <S> BiObjCharFunction<T, U, S> andThen(@Nonnull final BooleanFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjCharPredicate<T, U> andThenToBoolean(@Nonnull final BooleanUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToByteFunction<T, U> andThenToByte(@Nonnull final BooleanToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToCharFunction<T, U> andThenToChar(@Nonnull final BooleanToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToDoubleFunction<T, U> andThenToDouble(@Nonnull final BooleanToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToFloatFunction<T, U> andThenToFloat(@Nonnull final BooleanToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToIntFunction<T, U> andThenToInt(@Nonnull final BooleanToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToLongFunction<T, U> andThenToLong(@Nonnull final BooleanToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToShortFunction<T, U> andThenToShort(@Nonnull final BooleanToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharConsumer<T, U> consume(@Nonnull final BooleanConsumer consumer) {
     ...
     * this {@code BiObjCharPredicate} with JDK specific methods, only accepting {@code TriPredicate}.
     *
