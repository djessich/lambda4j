...
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjShortToShortFunction;
...
public interface ThrowableBiObjShortPredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortPredicate<T, U, X> of(
            @Nullable final ThrowableBiObjShortPredicate<T, U, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortPredicate<U, X> ptestThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> ptestThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> ptestThrows(short value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> ptestThrows(T t, short value) {
     ...
     * this {@code ThrowableBiObjShortPredicate} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjShortPredicate} that applies this predicate to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjShortPredicate<T, U> nestWith(
     ...
     * @return A composed {@link BiObjShortPredicate} that first applies this predicate to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjShortPredicate<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjShortPredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjShortPredicate<? super T, ? super U> predicate = recover.apply(throwable);
