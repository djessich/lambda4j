...
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiCharToShortFunction;
...
public interface ThrowableObjBiCharPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharPredicate<T, X> of(
            @Nullable final ThrowableObjBiCharPredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull final ThrowableObjBiCharPredicate<? super T, ? extends X> predicate, T t, char value1,
     ...
     */
    @Nonnull
    default ThrowableBiCharPredicate<X> ptestThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> ptestThrows(T t, char value1) {
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<T, X> ptestThrows(char value1) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<T, X> ptestThrows(char value1, char value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiCharPredicate<T, X> and(
            @Nonnull final ThrowableObjBiCharPredicate<? super T, ? extends X> other) {
     ...
     */
    @Nonnull
    default ObjBiCharPredicate<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiCharPredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharPredicate<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharPredicate<? super T> predicate = recover.apply(throwable);
