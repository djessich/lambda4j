...
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjDoubleToShortFunction;
...
public interface ThrowableBiObjDoublePredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> of(
            @Nullable final ThrowableBiObjDoublePredicate<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> boolean call(
            @Nonnull final ThrowableBiObjDoublePredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjDoublePredicate<U, X> ptestThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> ptestThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> ptestThrows(double value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> ptestThrows(T t, double value) {
    ...
    default ThrowableBiObjDoublePredicate<T, U, X> and(
            @Nonnull final ThrowableBiObjDoublePredicate<? super T, ? super U, ? extends X> other) {
     ...
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> nestWith(
    ...
    default BiObjDoublePredicate<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjDoublePredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjDoublePredicate<? super T, ? super U> predicate = recover.apply(throwable);
