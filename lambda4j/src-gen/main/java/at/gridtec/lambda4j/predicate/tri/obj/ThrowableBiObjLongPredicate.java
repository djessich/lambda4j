...
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjLongToShortFunction;
...
public interface ThrowableBiObjLongPredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongPredicate<T, U, X> of(
            @Nullable final ThrowableBiObjLongPredicate<T, U, X> expression) {
        return expression;
    }
    ...
    default BiObjLongPredicate<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongPredicate<? super T, ? super U>> recover) {
        Objects.requireNonNull(recover);
        return (t, u, value) -> {
            try {
                return this.testThrows(t, u, value);
            } catch (Throwable throwable) {
                final BiObjLongPredicate<? super T, ? super U> predicate = recover.apply(throwable);
