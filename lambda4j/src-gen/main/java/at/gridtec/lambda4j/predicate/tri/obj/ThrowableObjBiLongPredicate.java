...
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiLongToShortFunction;
...
public interface ThrowableObjBiLongPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongPredicate<T, X> of(
            @Nullable final ThrowableObjBiLongPredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull final ThrowableObjBiLongPredicate<? super T, ? extends X> predicate, T t, long value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiLongPredicate<T, X> and(
            @Nonnull final ThrowableObjBiLongPredicate<? super T, ? extends X> other) {
     ...
     */
    @Nonnull
    default ObjBiLongPredicate<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiLongPredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiLongPredicate<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiLongPredicate<? super T> predicate = recover.apply(throwable);
