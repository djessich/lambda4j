...
public interface ThrowableLongPredicate<X extends Throwable> extends Lambda, LongPredicate {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableLongPredicate<X> of(@Nonnull final ThrowableLongPredicate<X> expression) {
        return expression;
    }
     ...
     * should be used.
     * @implSpec Overrides the {@link LongPredicate#test(long)} method by using a redefinition as default method. This
