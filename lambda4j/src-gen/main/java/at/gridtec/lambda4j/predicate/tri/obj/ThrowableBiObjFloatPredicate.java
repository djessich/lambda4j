...
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjFloatToShortFunction;
...
public interface ThrowableBiObjFloatPredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatPredicate<T, U, X> of(
            @Nullable final ThrowableBiObjFloatPredicate<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> boolean call(
            @Nonnull final ThrowableBiObjFloatPredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
    ...
    default ThrowableBiObjFloatPredicate<T, U, X> and(
            @Nonnull final ThrowableBiObjFloatPredicate<? super T, ? super U, ? extends X> other) {
     ...
     *
     * @return A composed {@code BiObjFloatPredicate} that applies this predicate to its input and nests the thrown
    ...
    default BiObjFloatPredicate<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjFloatPredicate<? super T, ? super U>> recover) {
        Objects.requireNonNull(recover);
        return (t, u, value) -> {
            try {
                return this.testThrows(t, u, value);
            } catch (Throwable throwable) {
                final BiObjFloatPredicate<? super T, ? super U> predicate = recover.apply(throwable);
