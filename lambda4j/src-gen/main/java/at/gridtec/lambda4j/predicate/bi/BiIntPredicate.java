...
/**
 * Represents an predicate (boolean-valued function) of two {@code int}-valued input arguments.
...
public interface BiIntPredicate extends Lambda {
     ...
     */
    static BiIntPredicate of(@Nullable final BiIntPredicate expression) {
        return expression;
    }
