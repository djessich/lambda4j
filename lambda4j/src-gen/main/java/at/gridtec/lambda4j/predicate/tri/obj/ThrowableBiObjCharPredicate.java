...
import at.gridtec.lambda4j.consumer.tri.obj.ThrowableBiObjCharConsumer;
...
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjCharToShortFunction;
...
/**
 * Represents an predicate (boolean-valued function) of two object-valued and one {@code char}-valued input argument
 * which is able to throw any {@link Throwable}. This is a (reference, reference, char) specialization of {@link
 * ThrowableTriPredicate}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #testThrows(Object, Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjCharPredicate<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjCharPredicate} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjCharPredicate} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> of(
            @Nullable final ThrowableBiObjCharPredicate<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjCharPredicate} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return The result from the given {@code ThrowableBiObjCharPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this predicates action
     */
    static <T, U, X extends Throwable> boolean call(
            @Nonnull final ThrowableBiObjCharPredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjCharPredicate} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjCharPredicate} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharPredicate} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowablePredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     ...
     * @return Creates a {@code ThrowableBiObjCharPredicate} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharPredicate} which uses the {@code third} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjCharPredicate} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharPredicate} which always returns a given value.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjCharPredicate} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> constant(boolean ret) {
        return (t, u, value) -> ret;
    }

    /**
     * Returns a {@link ThrowableBiObjCharPredicate} that always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBiObjCharPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> alwaysTrue() {
        return (t, u, value) -> true;
    }

    /**
     * Returns a {@link ThrowableBiObjCharPredicate} that always returns {@code false}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBiObjCharPredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> alwaysFalse() {
        return (t, u, value) -> false;
    }

    /**
     * Returns a {@link ThrowableBiObjCharPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     ...
     * @return A {@code ThrowableBiObjCharPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> isEqual(@Nullable Object target1,
            @Nullable Object target2, char target3) {
     ...
     * @throws X Any throwable from this predicates action
     */
    boolean testThrows(T t, U u, char value) throws X;
     ...
     */
    default boolean testThrows(@Nonnull Pair<T, U> tuple, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<U, X> ptestThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> ptestThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> ptestThrows(char value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> ptestThrows(T t, char value) {
    ...
    default <A, B, C> ThrowableTriPredicate<A, B, C, X> compose(
        ...
        return (a, b, c) -> testThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsCharThrows(c));
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharPredicate} that first applies this predicate to its input, and then
     * applies the {@code after} operator to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code boolean}.
     *
     * @param after The operator to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharPredicate} that first applies this predicate to its input, and then
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharToByteFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code byte}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharToByteFunction} that first applies this predicate to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharToDoubleFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code double}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharToDoubleFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * double}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * int}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * long}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjCharToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * short}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharConsumer} that fist applies this predicate to its input, and then
     * consumes the result using the given {@link ThrowableBooleanConsumer}.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code ThrowableBiObjCharConsumer} that first applies this predicate to its input, and then
     * consumes the result using the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, u, value) -> consumer.acceptThrows(testThrows(t, u, value));
    }

    /**
     * Returns a {@link ThrowableBiObjCharPredicate} that represents the logical negation of this one.
     *
     * @return A {@code ThrowableBiObjCharPredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default ThrowableBiObjCharPredicate<T, U, X> negate() {
        return (t, u, value) -> !testThrows(t, u, value);
    }

    /**
     * Returns a composed {@link ThrowableBiObjCharPredicate} that represents a short-circuiting logical AND of this
     ...
     * {@code ThrowableBiObjCharPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBiObjCharPredicate} that will be logically-ANDed with this one
     * @return A composed {@code ThrowableBiObjCharPredicate} that represents the short-circuiting logical AND of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ThrowableBiObjCharPredicate)
     * @see #xor(ThrowableBiObjCharPredicate)
     */
    @Nonnull
    default ThrowableBiObjCharPredicate<T, U, X> and(
            @Nonnull final ThrowableBiObjCharPredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) && other.testThrows(t, u, value);
    }

    /**
     * Returns a composed {@link ThrowableBiObjCharPredicate} that represents a short-circuiting logical OR of this
     ...
     * {@code ThrowableBiObjCharPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBiObjCharPredicate} that will be logically-ORed with this one
     * @return A composed {@code ThrowableBiObjCharPredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBiObjCharPredicate)
     * @see #xor(ThrowableBiObjCharPredicate)
     */
    @Nonnull
    default ThrowableBiObjCharPredicate<T, U, X> or(
            @Nonnull final ThrowableBiObjCharPredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) || other.testThrows(t, u, value);
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharPredicate} that represents a short-circuiting logical XOR of this
     * predicate and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if
     * evaluation of this {@code ThrowableBiObjCharPredicate} throws an exception, the {@code other} predicate will not
     * be evaluated.
     *
     * @param other A {@code ThrowableBiObjCharPredicate} that will be logically-XORed with this one
     * @return A composed {@code ThrowableBiObjCharPredicate} that represents the short-circuiting logical XOR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBiObjCharPredicate)
     * @see #or(ThrowableBiObjCharPredicate)
     */
    @Nonnull
    default ThrowableBiObjCharPredicate<T, U, X> xor(
            @Nonnull final ThrowableBiObjCharPredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) ^ other.testThrows(t, u, value);
    }
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<Pair<T, U>, X> tupled() {
        return this::testThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjCharPredicate}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjCharPredicate}.
    ...
    default ThrowableBiObjCharPredicate<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableBiObjCharPredicate<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriPredicate} which represents this {@link ThrowableBiObjCharPredicate}.
     * Thereby the primitive input argument for this predicate is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjCharPredicate} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriPredicate} which represents this {@code ThrowableBiObjCharPredicate}.
     */
    @Nonnull
    default ThrowableTriPredicate<T, U, Character, X> boxed() {
        return this::testThrows;
    }

    /**
     * Returns a composed {@link BiObjCharPredicate} that applies this predicate to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjCharPredicate} that applies this predicate to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjCharPredicate<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjCharPredicate<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjCharPredicate} that applies this predicate to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjCharPredicate} that applies this predicate to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjCharPredicate<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
    ...
    /**
     * Returns a composed {@link BiObjCharPredicate} that first applies this predicate to its input, and then applies
     * the {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * predicate.
     *
     * @param recover The operation to apply if this predicate throws a {@code Throwable}
     * @return A composed {@link BiObjCharPredicate} that first applies this predicate to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjCharPredicate<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjCharPredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjCharPredicate<? super T, ? super U> predicate = recover.apply(throwable);
