...
public interface ThrowableObjBytePredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBytePredicate<T, X> of(
            @Nullable final ThrowableObjBytePredicate<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> ptestThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<T, X> ptestThrows(byte value) {
     ...
     */
    @Nonnull
    default ObjBytePredicate<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBytePredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBytePredicate<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjBytePredicate<? super T> predicate = recover.apply(throwable);
