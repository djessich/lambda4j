...
/**
 * Represents an predicate (boolean-valued function) of three {@code long}-valued input arguments which is able to throw
 * any {@link Throwable}. This is a primitive specialization of {@link ThrowableTriPredicate}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #testThrows(long, long, long)}.
 *
...
@FunctionalInterface
public interface ThrowableTriLongPredicate<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriLongPredicate} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableTriLongPredicate} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableTriLongPredicate<X> of(
            @Nullable final ThrowableTriLongPredicate<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriLongPredicate} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return The result from the given {@code ThrowableTriLongPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this predicates action
     */
    static <X extends Throwable> boolean call(@Nonnull final ThrowableTriLongPredicate<? extends X> predicate,
    ...
    /**
     * Creates a {@link ThrowableTriLongPredicate} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableLongPredicate}.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriLongPredicate} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableLongPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongPredicate<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriLongPredicate} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableLongPredicate}.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriLongPredicate} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongPredicate<X> onlySecond(
            @Nonnull final ThrowableLongPredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
    ...
    /**
     * Creates a {@link ThrowableTriLongPredicate} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableLongPredicate}.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriLongPredicate} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongPredicate<X> onlyThird(
            @Nonnull final ThrowableLongPredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
    ...
    /**
     * Creates a {@link ThrowableTriLongPredicate} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriLongPredicate} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongPredicate<X> constant(boolean ret) {
        return (value1, value2, value3) -> ret;
    }

    /**
     * Returns a {@link ThrowableTriLongPredicate} that always returns {@code true}.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableTriLongPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongPredicate<X> alwaysTrue() {
        return (value1, value2, value3) -> true;
    }

    /**
     * Returns a {@link ThrowableTriLongPredicate} that always returns {@code false}.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableTriLongPredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongPredicate<X> alwaysFalse() {
        return (value1, value2, value3) -> false;
    }

    /**
     * Returns a {@link ThrowableTriLongPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return A {@code ThrowableTriLongPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongPredicate<X> isEqual(long target1, long target2, long target3) {
    ...
    default <A, B, C> ThrowableTriPredicate<A, B, C, X> compose(
        ...
        return (a, b, c) -> testThrows(before1.applyAsLongThrows(a), before2.applyAsLongThrows(b),
    ...
    default ThrowableBooleanTernaryOperator<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> testThrows(before1.applyAsLongThrows(value1),
     ...
     */
    @Nonnull
    default ThrowableTriIntPredicate<X> composeFromInt(@Nonnull final ThrowableIntToLongFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongPredicate} that first applies the {@code before} operators to
     * its input, and then applies this predicate to the result.
     ...
     * @return A composed {@code ThrowableTriLongPredicate} that first applies the {@code before} operators to its
     * input, and then applies this predicate to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * long}.
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> composeFromLong(@Nonnull final ThrowableLongUnaryOperator<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    /**
     * Returns a composed {@link ThrowableTriLongPredicate} that first applies this predicate to its input, and then
     * applies the {@code after} operator to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code boolean}.
     *
     * @param after The operator to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongPredicate} that first applies this predicate to its input, and then
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> andThenToBoolean(
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToByteFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code byte}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongToByteFunction} that first applies this predicate to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToDoubleFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code double}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongToDoubleFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * double}.
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToIntFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongToIntFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * int}.
    ...
    /**
     * Returns a composed {@link ThrowableLongTernaryOperator} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableLongTernaryOperator} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * long}.
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableTriLongToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * short}.
    ...
    /**
     * Returns a composed {@link ThrowableTriLongConsumer} that fist applies this predicate to its input, and then
     * consumes the result using the given {@link ThrowableBooleanConsumer}.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code ThrowableTriLongConsumer} that first applies this predicate to its input, and then
     * consumes the result using the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value1, value2, value3) -> consumer.acceptThrows(testThrows(value1, value2, value3));
    }

    /**
     * Returns a {@link ThrowableTriLongPredicate} that represents the logical negation of this one.
     *
     * @return A {@code ThrowableTriLongPredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> negate() {
        return (value1, value2, value3) -> !testThrows(value1, value2, value3);
    }

    /**
     * Returns a composed {@link ThrowableTriLongPredicate} that represents a short-circuiting logical AND of this
     ...
     * {@code ThrowableTriLongPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableTriLongPredicate} that will be logically-ANDed with this one
     * @return A composed {@code ThrowableTriLongPredicate} that represents the short-circuiting logical AND of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ThrowableTriLongPredicate)
     * @see #xor(ThrowableTriLongPredicate)
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> and(@Nonnull final ThrowableTriLongPredicate<? extends X> other) {
    ...
    /**
     * Returns a composed {@link ThrowableTriLongPredicate} that represents a short-circuiting logical OR of this
     ...
     * {@code ThrowableTriLongPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableTriLongPredicate} that will be logically-ORed with this one
     * @return A composed {@code ThrowableTriLongPredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableTriLongPredicate)
     * @see #xor(ThrowableTriLongPredicate)
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> or(@Nonnull final ThrowableTriLongPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value1, value2, value3) -> testThrows(value1, value2, value3) || other.testThrows(value1, value2,
                                                                                                  value3);
    }
    ...
    /**
     * Returns a composed {@link ThrowableTriLongPredicate} that represents a short-circuiting logical XOR of this
     * predicate and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if
     * evaluation of this {@code ThrowableTriLongPredicate} throws an exception, the {@code other} predicate will not be
     * evaluated.
     *
     * @param other A {@code ThrowableTriLongPredicate} that will be logically-XORed with this one
     * @return A composed {@code ThrowableTriLongPredicate} that represents the short-circuiting logical XOR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableTriLongPredicate)
     * @see #or(ThrowableTriLongPredicate)
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> xor(@Nonnull final ThrowableTriLongPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value1, value2, value3) -> testThrows(value1, value2, value3) ^ other.testThrows(value1, value2,
                                                                                                 value3);
    }
    ...
    /**
     * Returns a composed {@link ThrowableTriPredicate} which represents this {@link ThrowableTriLongPredicate}. Thereby
     * the primitive input argument for this predicate is autoboxed. This method provides the possibility to use this
     * {@code ThrowableTriLongPredicate} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriPredicate} which represents this {@code ThrowableTriLongPredicate}.
     */
    @Nonnull
    default ThrowableTriPredicate<Long, Long, Long, X> boxed() {
        return this::testThrows;
    }

    /**
     * Returns a composed {@link TriLongPredicate} that applies this predicate to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriLongPredicate} that applies this predicate to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default TriLongPredicate nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link TriLongPredicate} that applies this predicate to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriLongPredicate} that applies this predicate to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriLongPredicate sneakyThrow() {
     ...
     * @return A composed {@link TriLongPredicate} that first applies this predicate to its input, and then applies the
     ...
     */
    @Nonnull
    default TriLongPredicate recover(@Nonnull final Function<? super Throwable, ? extends TriLongPredicate> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriLongPredicate predicate = recover.apply(throwable);
