...
import at.gridtec.lambda4j.consumer.tri.obj.ThrowableBiObjBooleanConsumer;
...
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjBooleanToShortFunction;
 ...
 * which is able to throw any {@link Throwable}. This is a (reference, reference, boolean) specialization of {@link
 * ThrowableTriPredicate}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #testThrows(Object, Object, boolean)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjBooleanPredicate<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjBooleanPredicate} based on a lambda expression or a method reference. Thereby
    ...
    /**
     * Calls the given {@link ThrowableBiObjBooleanPredicate} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return The result from the given {@code ThrowableBiObjBooleanPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this predicates action
     */
    static <T, U, X extends Throwable> boolean call(
            @Nonnull final ThrowableBiObjBooleanPredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanPredicate} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjBooleanPredicate} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanPredicate<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanPredicate} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowablePredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     ...
     * @return Creates a {@code ThrowableBiObjBooleanPredicate} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanPredicate<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjBooleanPredicate} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjBooleanPredicate} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableBooleanUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanPredicate<T, U, X> onlyThird(
            @Nonnull final ThrowableBooleanUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, u, value) -> operator.applyAsBooleanThrows(value);
    }

    /**
     * Creates a {@link ThrowableBiObjBooleanPredicate} which always returns a given value.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjBooleanPredicate} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanPredicate<T, U, X> constant(boolean ret) {
        return (t, u, value) -> ret;
    }

    /**
     * Returns a {@link ThrowableBiObjBooleanPredicate} that always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBiObjBooleanPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanPredicate<T, U, X> alwaysTrue() {
        return (t, u, value) -> true;
    }

    /**
     * Returns a {@link ThrowableBiObjBooleanPredicate} that always returns {@code false}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBiObjBooleanPredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanPredicate<T, U, X> alwaysFalse() {
        return (t, u, value) -> false;
    }

    /**
     * Returns a {@link ThrowableBiObjBooleanPredicate} that tests if the given arguments are <b>equal</b> to the ones
     * of this predicate.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     ...
     * @return A {@code ThrowableBiObjBooleanPredicate} that tests if the given arguments are <b>equal</b> to the ones
     * of this predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjBooleanPredicate<T, U, X> isEqual(@Nullable Object target1,
            @Nullable Object target2, boolean target3) {
     ...
     * @throws X Any throwable from this predicates action
     */
    boolean testThrows(T t, U u, boolean value) throws X;
    ...
    default <A, B, C> ThrowableTriPredicate<A, B, C, X> compose(
        ...
        return (a, b, c) -> testThrows(before1.applyThrows(a), before2.applyThrows(b), before3.testThrows(c));
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanPredicate} that first applies this predicate to its input, and
     * then applies the {@code after} operator to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code boolean}.
     *
     * @param after The operator to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanPredicate} that first applies this predicate to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanToByteFunction} that first applies this predicate to its input,
     ...
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanToByteFunction} that first applies this predicate to its input,
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanToCharFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result. This method is just convenience, to provide the
     * ability to transform this primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanToCharFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanToDoubleFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result. This method is just convenience, to provide the
     * ability to transform this primitive predicate to an operation returning {@code double}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanToDoubleFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * double}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanToFloatFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result. This method is just convenience, to provide the
     * ability to transform this primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanToFloatFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanToIntFunction} that first applies this predicate to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanToLongFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result. This method is just convenience, to provide the
     * ability to transform this primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanToLongFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * long}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanToShortFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result. This method is just convenience, to provide the
     * ability to transform this primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjBooleanToShortFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * short}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanConsumer} that fist applies this predicate to its input, and then
     * consumes the result using the given {@link ThrowableBooleanConsumer}.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code ThrowableBiObjBooleanConsumer} that first applies this predicate to its input, and then
    ...
    /**
     * Returns a {@link ThrowableBiObjBooleanPredicate} that represents the logical negation of this one.
     *
     * @return A {@code ThrowableBiObjBooleanPredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default ThrowableBiObjBooleanPredicate<T, U, X> negate() {
        return (t, u, value) -> !testThrows(t, u, value);
    }

    /**
     * Returns a composed {@link ThrowableBiObjBooleanPredicate} that represents a short-circuiting logical AND of this
     ...
     * {@code ThrowableBiObjBooleanPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBiObjBooleanPredicate} that will be logically-ANDed with this one
     * @return A composed {@code ThrowableBiObjBooleanPredicate} that represents the short-circuiting logical AND of
     * this predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ThrowableBiObjBooleanPredicate)
     * @see #xor(ThrowableBiObjBooleanPredicate)
     */
    @Nonnull
    default ThrowableBiObjBooleanPredicate<T, U, X> and(
            @Nonnull final ThrowableBiObjBooleanPredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) && other.testThrows(t, u, value);
    }

    /**
     * Returns a composed {@link ThrowableBiObjBooleanPredicate} that represents a short-circuiting logical OR of this
     ...
     * {@code ThrowableBiObjBooleanPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBiObjBooleanPredicate} that will be logically-ORed with this one
     * @return A composed {@code ThrowableBiObjBooleanPredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBiObjBooleanPredicate)
     * @see #xor(ThrowableBiObjBooleanPredicate)
     */
    @Nonnull
    default ThrowableBiObjBooleanPredicate<T, U, X> or(
            @Nonnull final ThrowableBiObjBooleanPredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) || other.testThrows(t, u, value);
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjBooleanPredicate} that represents a short-circuiting logical XOR of this
     * predicate and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if
     * evaluation of this {@code ThrowableBiObjBooleanPredicate} throws an exception, the {@code other} predicate will
     * not be evaluated.
     *
     * @param other A {@code ThrowableBiObjBooleanPredicate} that will be logically-XORed with this one
     * @return A composed {@code ThrowableBiObjBooleanPredicate} that represents the short-circuiting logical XOR of
     * this predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBiObjBooleanPredicate)
     * @see #or(ThrowableBiObjBooleanPredicate)
     */
    @Nonnull
    default ThrowableBiObjBooleanPredicate<T, U, X> xor(
            @Nonnull final ThrowableBiObjBooleanPredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) ^ other.testThrows(t, u, value);
    }
     ...
     */
    @Nonnull
    default ThrowableObjBooleanPredicate<Pair<T, U>, X> tupled() {
        return this::testThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjBooleanPredicate}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjBooleanPredicate}.
    ...
    /**
     * Returns a composed {@link ThrowableTriPredicate} which represents this {@link ThrowableBiObjBooleanPredicate}.
     * Thereby the primitive input argument for this predicate is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjBooleanPredicate} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriPredicate} which represents this {@code ThrowableBiObjBooleanPredicate}.
     */
    @Nonnull
    default ThrowableTriPredicate<T, U, Boolean, X> boxed() {
        return this::testThrows;
    }

    /**
     * Returns a composed {@link BiObjBooleanPredicate} that applies this predicate to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjBooleanPredicate} that applies this predicate to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjBooleanPredicate<T, U> nestWith(
    ...
    /**
     * Returns a composed {@link BiObjBooleanPredicate} that applies this predicate to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjBooleanPredicate} that applies this predicate to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjBooleanPredicate<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
     ...
     * @return A composed {@link BiObjBooleanPredicate} that first applies this predicate to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjBooleanPredicate<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjBooleanPredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjBooleanPredicate<? super T, ? super U> predicate = recover.apply(throwable);
