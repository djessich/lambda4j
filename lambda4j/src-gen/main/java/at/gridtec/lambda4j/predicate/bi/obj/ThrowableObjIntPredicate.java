...
public interface ThrowableObjIntPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntPredicate<T, X> of(
            @Nullable final ThrowableObjIntPredicate<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjIntPredicate<T> nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjIntPredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjIntPredicate<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjIntPredicate<? super T> predicate = recover.apply(throwable);
