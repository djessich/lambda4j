...
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatFunction;
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatToByteFunction;
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatToCharFunction;
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatToDoubleFunction;
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatToFloatFunction;
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatToIntFunction;
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatToLongFunction;
import at.gridtec.lambda4j.function.bi.obj.ThrowableObjFloatToShortFunction;
...
public interface ThrowableObjFloatPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> of(
            @Nullable final ThrowableObjFloatPredicate<T, X> expression) {
        return expression;
    }
     ...
     * {@code ThrowableObjFloatPredicate} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjFloatPredicate} that applies this predicate to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjFloatPredicate<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjFloatPredicate} that first applies this predicate to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjFloatPredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjFloatPredicate<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjFloatPredicate<? super T> predicate = recover.apply(throwable);
