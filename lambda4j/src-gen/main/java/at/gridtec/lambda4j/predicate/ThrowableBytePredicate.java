...
/**
 * Represents an predicate (boolean-valued function) of one {@code byte}-valued input argument which is able to throw
...
@FunctionalInterface
public interface ThrowableBytePredicate<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBytePredicate} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ThrowableBytePredicate} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableBytePredicate<X> of(@Nullable final ThrowableBytePredicate<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBytePredicate} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate to be called
     * @param value The argument to the predicate
     * @return The result from the given {@code ThrowableBytePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this predicates action
     */
    static <X extends Throwable> boolean call(@Nonnull final ThrowableBytePredicate<? extends X> predicate,
            byte value) throws X {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableBytePredicate<X> constant(boolean ret) {
        return (value) -> ret;
    }

    /**
     * Returns a {@link ThrowableBytePredicate} that always returns {@code true}.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBytePredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static <X extends Throwable> ThrowableBytePredicate<X> alwaysTrue() {
        return (value) -> true;
    }

    /**
     * Returns a {@link ThrowableBytePredicate} that always returns {@code false}.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBytePredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <X extends Throwable> ThrowableBytePredicate<X> alwaysFalse() {
        return (value) -> false;
    }

    /**
     * Returns a {@link ThrowableBytePredicate} that tests if the given argument are <b>equal</b> to the one of this
     * predicate.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param target The reference with which to compare for equality, which may be {@code null}
     * @return A {@code ThrowableBytePredicate} that tests if the given argument are <b>equal</b> to the one of this
     * predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBytePredicate<X> isEqual(byte target) {
     ...
     * @throws X Any throwable from this predicates action
     */
    boolean testThrows(byte value) throws X;
    ...
    default <A> ThrowablePredicate<A, X> compose(
        ...
        return (a) -> testThrows(before.applyAsByteThrows(a));
    }
    ...
    default ThrowableBooleanUnaryOperator<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsByteThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableBytePredicate} that first applies the {@code before} operator to
     ...
     * @return A composed {@code ThrowableBytePredicate} that first applies the {@code before} operator to its input,
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> composeFromByte(@Nonnull final ThrowableByteUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsByteThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> composeFromChar(@Nonnull final ThrowableCharToByteFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsByteThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntPredicate<X> composeFromInt(@Nonnull final ThrowableIntToByteFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsByteThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongPredicate<X> composeFromLong(@Nonnull final ThrowableLongToByteFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsByteThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableByteFunction} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteFunction} that first applies this predicate to its input, and then applies
     * the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    /**
     * Returns a composed {@link ThrowableBytePredicate} that first applies this predicate to its input, and then
     * applies the {@code after} operator to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code boolean}.
     *
     * @param after The operator to apply after this predicate is applied
     * @return A composed {@code ThrowableBytePredicate} that first applies this predicate to its input, and then
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> andThenToBoolean(
    ...
    /**
     * Returns a composed {@link ThrowableByteUnaryOperator} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code byte}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteUnaryOperator} that first applies this predicate to its input, and then
    ...
    /**
     * Returns a composed {@link ThrowableByteToCharFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteToCharFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableByteToDoubleFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code double}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteToDoubleFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * double}.
    ...
    /**
     * Returns a composed {@link ThrowableByteToFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteToFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableByteToIntFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteToIntFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> andThenToInt(
    ...
    /**
     * Returns a composed {@link ThrowableByteToLongFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteToLongFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * long}.
    ...
    /**
     * Returns a composed {@link ThrowableByteToShortFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableByteToShortFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * short}.
    ...
    /**
     * Returns a composed {@link ThrowableByteConsumer} that fist applies this predicate to its input, and then consumes
     * the result using the given {@link ThrowableBooleanConsumer}.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code ThrowableByteConsumer} that first applies this predicate to its input, and then
     * consumes the result using the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableByteConsumer<X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(testThrows(value));
    }

    /**
     * Returns a {@link ThrowableBytePredicate} that represents the logical negation of this one.
     *
     * @return A {@code ThrowableBytePredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default ThrowableBytePredicate<X> negate() {
        return (value) -> !testThrows(value);
    }

    /**
     * Returns a composed {@link ThrowableBytePredicate} that represents a short-circuiting logical AND of this
     ...
     * {@code ThrowableBytePredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBytePredicate} that will be logically-ANDed with this one
     * @return A composed {@code ThrowableBytePredicate} that represents the short-circuiting logical AND of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ThrowableBytePredicate)
     * @see #xor(ThrowableBytePredicate)
     */
    @Nonnull
    default ThrowableBytePredicate<X> and(@Nonnull final ThrowableBytePredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) && other.testThrows(value);
    }

    /**
     * Returns a composed {@link ThrowableBytePredicate} that represents a short-circuiting logical OR of this predicate
     ...
     * {@code ThrowableBytePredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBytePredicate} that will be logically-ORed with this one
     * @return A composed {@code ThrowableBytePredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBytePredicate)
     * @see #xor(ThrowableBytePredicate)
     */
    @Nonnull
    default ThrowableBytePredicate<X> or(@Nonnull final ThrowableBytePredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) || other.testThrows(value);
    }

    /**
     * Returns a composed {@link ThrowableBytePredicate} that represents a short-circuiting logical XOR of this
     * predicate and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if
     * evaluation of this {@code ThrowableBytePredicate} throws an exception, the {@code other} predicate will not be
     * evaluated.
     *
     * @param other A {@code ThrowableBytePredicate} that will be logically-XORed with this one
     * @return A composed {@code ThrowableBytePredicate} that represents the short-circuiting logical XOR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBytePredicate)
     * @see #or(ThrowableBytePredicate)
     */
    @Nonnull
    default ThrowableBytePredicate<X> xor(@Nonnull final ThrowableBytePredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) ^ other.testThrows(value);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBytePredicate}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBytePredicate}.
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
    ...
    /**
     * Returns a composed {@link ThrowablePredicate} which represents this {@link ThrowableBytePredicate}. Thereby the
     * primitive input argument for this predicate is autoboxed. This method provides the possibility to use this {@code
     * ThrowableBytePredicate} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowablePredicate} which represents this {@code ThrowableBytePredicate}.
     */
    @Nonnull
    default ThrowablePredicate<Byte, X> boxed() {
        return this::testThrows;
    }

    /**
     * Returns a composed {@link BytePredicate} that applies this predicate to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BytePredicate} that applies this predicate to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BytePredicate nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BytePredicate} that applies this predicate to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BytePredicate} that applies this predicate to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BytePredicate sneakyThrow() {
        return (value) -> {
            try {
     ...
     * @return A composed {@link BytePredicate} that first applies this predicate to its input, and then applies the
     ...
     */
    @Nonnull
    default BytePredicate recover(@Nonnull final Function<? super Throwable, ? extends BytePredicate> recover) {
        ...
        return (value) -> {
            try {
                ...
                final BytePredicate predicate = recover.apply(throwable);
