...
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ObjBiCharToShortFunction;
...
public interface ObjBiCharPredicate<T> extends Lambda {
     ...
     */
    static <T> ObjBiCharPredicate<T> of(@Nullable final ObjBiCharPredicate<T> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiCharPredicate ptest(T t) {
     ...
     */
    @Nonnull
    default CharPredicate ptest(T t, char value1) {
     ...
     */
    @Nonnull
    default ObjCharPredicate<T> ptest(char value1) {
     ...
     */
    @Nonnull
    default Predicate2<T> ptest(char value1, char value2) {
     ...
     * {@code ObjBiCharPredicate} with methods provided by the {@code JDK}.
     *
