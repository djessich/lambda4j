...
import at.gridtec.lambda4j.function.tri.obj.BiObjByteFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjByteToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjByteToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjByteToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjByteToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjByteToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjByteToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.BiObjByteToShortFunction;
...
public interface BiObjBytePredicate<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjBytePredicate<T, U> of(@Nullable final BiObjBytePredicate<T, U> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjBytePredicate<U> ptest(T t) {
     ...
     */
    @Nonnull
    default BytePredicate ptest(T t, U u) {
     ...
     */
    @Nonnull
    default BiPredicate2<T, U> ptest(byte value) {
     ...
     */
    @Nonnull
    default Predicate2<U> ptest(T t, byte value) {
