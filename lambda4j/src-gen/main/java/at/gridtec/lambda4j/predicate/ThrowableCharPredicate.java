...
public interface ThrowableCharPredicate<X extends Throwable> extends Lambda {
     ...
     */
    static <X extends Throwable> ThrowableCharPredicate<X> of(@Nullable final ThrowableCharPredicate<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> boolean call(@Nonnull final ThrowableCharPredicate<? extends X> predicate,
            char value) throws X {
    ...
    /**
     * Returns a {@link ThrowableCharPredicate} that tests if the given argument are <b>equal</b> to the one of this
     * predicate.
     *
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param target The reference with which to compare for equality, which may be {@code null}
     * @return A {@code ThrowableCharPredicate} that tests if the given argument are <b>equal</b> to the one of this
     * predicate.
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> composeFromByte(@Nonnull final ThrowableByteToCharFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsCharThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableCharPredicate} that first applies the {@code before} operator to
     * its input, and then applies this predicate to the result.
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> composeFromChar(@Nonnull final ThrowableCharUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsCharThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntPredicate<X> composeFromInt(@Nonnull final ThrowableIntToCharFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsCharThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongPredicate<X> composeFromLong(@Nonnull final ThrowableLongToCharFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> testThrows(before.applyAsCharThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> and(@Nonnull final ThrowableCharPredicate<? extends X> other) {
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> or(@Nonnull final ThrowableCharPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) || other.testThrows(value);
    }
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> xor(@Nonnull final ThrowableCharPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) ^ other.testThrows(value);
    }
     ...
     *
     * @return A composed {@code CharPredicate} that applies this predicate to its input and nests the thrown {@code
    ...
    /**
     * Returns a composed {@link CharPredicate} that applies this predicate to its input and sneakily throws the
     ...
     */
    @Nonnull
    default CharPredicate recover(@Nonnull final Function<? super Throwable, ? extends CharPredicate> recover) {
        Objects.requireNonNull(recover);
        return (value) -> {
            try {
                return this.testThrows(value);
            } catch (Throwable throwable) {
                final CharPredicate predicate = recover.apply(throwable);
