...
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableBiObjIntToShortFunction;
...
public interface ThrowableBiObjIntPredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjIntPredicate<T, U, X> of(
            @Nullable final ThrowableBiObjIntPredicate<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> boolean call(
            @Nonnull final ThrowableBiObjIntPredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
            int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<U, X> ptestThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntPredicate<X> ptestThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> ptestThrows(int value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> ptestThrows(T t, int value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjIntConsumer<T, U, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjIntPredicate<T, U, X> and(
            @Nonnull final ThrowableBiObjIntPredicate<? super T, ? super U, ? extends X> other) {
     ...
     */
    @Nonnull
    default BiObjIntPredicate<T, U> nestWith(
    ...
    default BiObjIntPredicate<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjIntPredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjIntPredicate<? super T, ? super U> predicate = recover.apply(throwable);
