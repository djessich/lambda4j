...
public interface ThrowableIntPredicate<X extends Throwable> extends Lambda, IntPredicate {
     ...
     */
    static <X extends Throwable> ThrowableIntPredicate<X> of(@Nullable final ThrowableIntPredicate<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default IntPredicate2 nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
