...
import at.gridtec.lambda4j.consumer.tri.obj.ThrowableObjBiFloatConsumer;
...
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatToByteFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatToCharFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatToDoubleFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatToFloatFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatToIntFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatToLongFunction;
import at.gridtec.lambda4j.function.tri.obj.ThrowableObjBiFloatToShortFunction;
 ...
 * which is able to throw any {@link Throwable}. This is a (reference, float, float) specialization of {@link
 * ThrowableTriPredicate}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #testThrows(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiFloatPredicate<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiFloatPredicate} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiFloatPredicate} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> of(
            @Nullable final ThrowableObjBiFloatPredicate<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiFloatPredicate} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return The result from the given {@code ThrowableObjBiFloatPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this predicates action
     */
    static <T, X extends Throwable> boolean call(
            @Nonnull final ThrowableObjBiFloatPredicate<? super T, ? extends X> predicate, T t, float value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatPredicate} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowablePredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatPredicate} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatPredicate} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableFloatPredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatPredicate} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatPredicate} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableFloatPredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param predicate The predicate which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatPredicate} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatPredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> onlyThird(
            @Nonnull final ThrowableFloatPredicate<? extends X> predicate) {
        Objects.requireNonNull(predicate);
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatPredicate} which always returns a given value.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiFloatPredicate} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> constant(boolean ret) {
        return (t, value1, value2) -> ret;
    }

    /**
     * Returns a {@link ThrowableObjBiFloatPredicate} that always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableObjBiFloatPredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> alwaysTrue() {
        return (t, value1, value2) -> true;
    }

    /**
     * Returns a {@link ThrowableObjBiFloatPredicate} that always returns {@code false}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableObjBiFloatPredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> alwaysFalse() {
        return (t, value1, value2) -> false;
    }

    /**
     * Returns a {@link ThrowableObjBiFloatPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return A {@code ThrowableObjBiFloatPredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatPredicate<T, X> isEqual(@Nullable Object target1, float target2,
            float target3) {
     ...
     * @throws X Any throwable from this predicates action
     */
    boolean testThrows(T t, float value1, float value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiFloatPredicate<X> ptestThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatPredicate<X> ptestThrows(T t, float value1) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatPredicate<T, X> ptestThrows(float value1) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<T, X> ptestThrows(float value1, float value2) {
    ...
    default <A, B, C> ThrowableTriPredicate<A, B, C, X> compose(
        ...
        return (a, b, c) -> testThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b),
    ...
    default ThrowableBooleanTernaryOperator<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> testThrows(before1.applyThrows(value1), before2.applyAsFloatThrows(value2),
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatPredicate} that first applies this predicate to its input, and then
     * applies the {@code after} operator to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code boolean}.
     *
     * @param after The operator to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatPredicate} that first applies this predicate to its input, and then
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatToByteFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code byte}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatToByteFunction} that first applies this predicate to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatToDoubleFunction} that first applies this predicate to its input,
     ...
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatToDoubleFunction} that first applies this predicate to its input,
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatToFloatFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * int}.
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * long}.
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableObjBiFloatToShortFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to return primitive values. In this case this is {@code
     * short}.
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatConsumer} that fist applies this predicate to its input, and then
     * consumes the result using the given {@link ThrowableBooleanConsumer}.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code ThrowableObjBiFloatConsumer} that first applies this predicate to its input, and then
     * consumes the result using the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull final ThrowableBooleanConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(testThrows(t, value1, value2));
    }

    /**
     * Returns a {@link ThrowableObjBiFloatPredicate} that represents the logical negation of this one.
     *
     * @return A {@code ThrowableObjBiFloatPredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default ThrowableObjBiFloatPredicate<T, X> negate() {
        return (t, value1, value2) -> !testThrows(t, value1, value2);
    }

    /**
     * Returns a composed {@link ThrowableObjBiFloatPredicate} that represents a short-circuiting logical AND of this
     ...
     * {@code ThrowableObjBiFloatPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableObjBiFloatPredicate} that will be logically-ANDed with this one
     * @return A composed {@code ThrowableObjBiFloatPredicate} that represents the short-circuiting logical AND of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ThrowableObjBiFloatPredicate)
     * @see #xor(ThrowableObjBiFloatPredicate)
     */
    @Nonnull
    default ThrowableObjBiFloatPredicate<T, X> and(
            @Nonnull final ThrowableObjBiFloatPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value1, value2) -> testThrows(t, value1, value2) && other.testThrows(t, value1, value2);
    }

    /**
     * Returns a composed {@link ThrowableObjBiFloatPredicate} that represents a short-circuiting logical OR of this
     ...
     * {@code ThrowableObjBiFloatPredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableObjBiFloatPredicate} that will be logically-ORed with this one
     * @return A composed {@code ThrowableObjBiFloatPredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableObjBiFloatPredicate)
     * @see #xor(ThrowableObjBiFloatPredicate)
     */
    @Nonnull
    default ThrowableObjBiFloatPredicate<T, X> or(
            @Nonnull final ThrowableObjBiFloatPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value1, value2) -> testThrows(t, value1, value2) || other.testThrows(t, value1, value2);
    }
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatPredicate} that represents a short-circuiting logical XOR of this
     * predicate and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if
     * evaluation of this {@code ThrowableObjBiFloatPredicate} throws an exception, the {@code other} predicate will not
     * be evaluated.
     *
     * @param other A {@code ThrowableObjBiFloatPredicate} that will be logically-XORed with this one
     * @return A composed {@code ThrowableObjBiFloatPredicate} that represents the short-circuiting logical XOR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableObjBiFloatPredicate)
     * @see #or(ThrowableObjBiFloatPredicate)
     */
    @Nonnull
    default ThrowableObjBiFloatPredicate<T, X> xor(
            @Nonnull final ThrowableObjBiFloatPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value1, value2) -> testThrows(t, value1, value2) ^ other.testThrows(t, value1, value2);
    }
    ...
    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiFloatPredicate}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiFloatPredicate}.
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatPredicate<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, Float, Float>, Boolean> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableObjBiFloatPredicate<T, X> & Memoized) (t, value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriPredicate} which represents this {@link ThrowableObjBiFloatPredicate}.
     * Thereby the primitive input argument for this predicate is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiFloatPredicate} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriPredicate} which represents this {@code ThrowableObjBiFloatPredicate}.
     */
    @Nonnull
    default ThrowableTriPredicate<T, Float, Float, X> boxed() {
        return this::testThrows;
    }

    /**
     * Returns a composed {@link ObjBiFloatPredicate} that applies this predicate to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiFloatPredicate} that applies this predicate to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiFloatPredicate<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiFloatPredicate<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiFloatPredicate} that first applies this predicate to its input, and then applies
     ...
     */
    @Nonnull
    default ObjBiFloatPredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiFloatPredicate<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiFloatPredicate<? super T> predicate = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiFloatPredicate} that applies this predicate to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiFloatPredicate} that applies this predicate to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiFloatPredicate<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return this.testThrows(t, value1, value2);
