...
public interface ThrowableShortPredicate<X extends Throwable> extends Lambda {
     ...
     */
    static <X extends Throwable> ThrowableShortPredicate<X> of(@Nullable final ThrowableShortPredicate<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ShortPredicate nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ShortPredicate} that applies this predicate to its input and sneakily throws the
     ...
     */
    @Nonnull
    default ShortPredicate recover(@Nonnull final Function<? super Throwable, ? extends ShortPredicate> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ShortPredicate predicate = recover.apply(throwable);
