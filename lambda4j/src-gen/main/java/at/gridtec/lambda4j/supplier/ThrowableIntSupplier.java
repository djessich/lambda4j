...
public interface ThrowableIntSupplier<X extends Throwable> extends Lambda, IntSupplier {
    ...
    /**
     * Returns a memoized (caching) version of this {@link ThrowableIntSupplier}. Whenever it is called, the return
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableIntSupplier}.
     ...
     */
    @Nonnull
    default ThrowableIntSupplier<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
     ...
     */
    @Nonnull
    default IntSupplier2 nestWith(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
