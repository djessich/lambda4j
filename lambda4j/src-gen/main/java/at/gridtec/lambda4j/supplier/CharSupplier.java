...
@FunctionalInterface
public interface CharSupplier extends Lambda {

    /**
     * Constructs a {@link CharSupplier} based on a lambda expression or a method reference. Thereby the given lambda
     * expression or method reference is returned on an as-is basis to implicitly transform it to the desired type. With
     * this method, it is possible to ensure that correct type is used from lambda expression or method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code CharSupplier} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link CharSupplier} with the given argument and returns its result.
     *
     ...
     * @throws NullPointerException If given argument is {@code null}
     * @implNote Due to the fact that a {@link CharSupplier} receives no input, we do not need to pass an argument of a
    ...
    /**
     * Returns a memoized (caching) version of this {@link CharSupplier}. Whenever it is called, the return value is
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code CharSupplier}.
     ...
     * {@code CharSupplier} with JDK specific methods, only accepting {@code Supplier}.
     *
