...
public interface ThrowableFloatSupplier<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableFloatSupplier<X> of(@Nonnull final ThrowableFloatSupplier<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code FloatSupplier} that applies this supplier to its input and nests the thrown {@code
