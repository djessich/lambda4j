...
public interface ThrowableFloatUnaryOperator<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableFloatUnaryOperator<X> of(
            @Nonnull final ThrowableFloatUnaryOperator<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code FloatUnaryOperator} that applies this operator to its input and nests the thrown {@code
