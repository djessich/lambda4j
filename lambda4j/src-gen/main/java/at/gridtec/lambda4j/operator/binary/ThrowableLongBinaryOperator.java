...
public interface ThrowableLongBinaryOperator<X extends Throwable> extends Lambda, LongBinaryOperator {
    ...
    static <X extends Throwable> ThrowableLongBinaryOperator<X> of(
            @Nullable final ThrowableLongBinaryOperator<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableLongBinaryOperator<X> minBy(@Nonnull final Comparator<Long> comparator) {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableLongBinaryOperator<X> maxBy(@Nonnull final Comparator<Long> comparator) {
        Objects.requireNonNull(comparator);
        return (value1, value2) -> comparator.compare(value1, value2) >= 0 ? value1 : value2;
    }
     ...
     */
    @Nonnull
    default LongBinaryOperator2 nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
