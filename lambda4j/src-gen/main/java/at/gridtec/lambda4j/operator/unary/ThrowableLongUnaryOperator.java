...
public interface ThrowableLongUnaryOperator<X extends Throwable> extends Lambda, LongUnaryOperator {
    ...
    static <X extends Throwable> ThrowableLongUnaryOperator<X> of(
            @Nonnull final ThrowableLongUnaryOperator<X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@code LongUnaryOperator2} that applies this operator to its input and nests the thrown {@code
