...
public interface ThrowableDoubleTernaryOperator<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default DoubleTernaryOperator nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default DoubleTernaryOperator recover(
            @Nonnull final Function<? super Throwable, ? extends DoubleTernaryOperator> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final DoubleTernaryOperator operator = recover.apply(throwable);
