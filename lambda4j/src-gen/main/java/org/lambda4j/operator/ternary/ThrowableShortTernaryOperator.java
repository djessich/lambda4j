...
public interface ThrowableShortTernaryOperator<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ShortTernaryOperator nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ShortTernaryOperator recover(
            @Nonnull final Function<? super Throwable, ? extends ShortTernaryOperator> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final ShortTernaryOperator operator = recover.apply(throwable);
