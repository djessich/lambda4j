...
/**
 * Represents an predicate (boolean-valued function) of two {@code double}-valued input arguments.
...
public interface BiDoublePredicate extends Lambda {
     ...
     */
    static BiDoublePredicate of(@Nullable final BiDoublePredicate expression) {
        return expression;
    }
