 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(double)}.
 *
...
@FunctionalInterface
public interface ThrowableDoubleToFloatFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableDoubleToFloatFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableDoubleToFloatFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableDoubleToFloatFunction<X> of(
            @Nullable final ThrowableDoubleToFloatFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableDoubleToFloatFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableDoubleToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> float call(@Nonnull final ThrowableDoubleToFloatFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableDoubleToFloatFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableDoubleToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableDoubleToFloatFunction<X> constant(float ret) {
        return (value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(double value) throws X;
    ...
    default <A> ThrowableToFloatFunction<A, X> compose(
        ...
        return (a) -> applyAsFloatThrows(before.applyAsDoubleThrows(a));
    }
    ...
    default ThrowableBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsFloatThrows(before.applyAsDoubleThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableDoubleToFloatFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code double} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableDoubleToFloatFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * double}.
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> andThenToBoolean(@Nonnull final ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleConsumer<X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableDoubleToFloatFunction}.
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableDoubleToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableDoubleToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableDoubleToFloatFunction}.
     */
    @Nonnull
    default ThrowableFunction<Double, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link DoubleToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link DoubleToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default DoubleToFloatFunction nest() {
     ...
     */
    @Nonnull
    default DoubleToFloatFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link DoubleToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default DoubleToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends DoubleToFloatFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final DoubleToFloatFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link DoubleToFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link DoubleToFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default DoubleToFloatFunction sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsFloatThrows(value);
