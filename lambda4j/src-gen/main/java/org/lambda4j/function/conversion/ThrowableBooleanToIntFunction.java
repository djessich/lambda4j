...
public interface ThrowableBooleanToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBooleanToIntFunction<X> of(
            @Nullable final ThrowableBooleanToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BooleanToIntFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
