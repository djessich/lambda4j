 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(float)}.
 *
...
@FunctionalInterface
public interface ThrowableFloatToShortFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableFloatToShortFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableFloatToShortFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableFloatToShortFunction<X> of(
            @Nullable final ThrowableFloatToShortFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableFloatToShortFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableFloatToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableFloatToShortFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableFloatToShortFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableFloatToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableFloatToShortFunction<X> constant(short ret) {
        return (value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(float value) throws X;
    ...
    default <A> ThrowableToShortFunction<A, X> compose(
        ...
        return (a) -> applyAsShortThrows(before.applyAsFloatThrows(a));
    }
    ...
    default ThrowableBooleanToShortFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsShortThrows(before.applyAsFloatThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableFloatToShortFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code float} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableFloatToShortFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * float}.
     ...
     */
    @Nonnull
    default ThrowableFloatPredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> andThenToInt(@Nonnull final ThrowableShortToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsShortThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableFloatToShortFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableFloatToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableFloatToShortFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Float, Short> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableFloatToShortFunction<X> & Memoized) (value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableFloatToShortFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableFloatToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableFloatToShortFunction}.
     */
    @Nonnull
    default ThrowableFunction<Float, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link FloatToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link FloatToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default FloatToShortFunction nest() {
     ...
     */
    @Nonnull
    default FloatToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default FloatToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends FloatToShortFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final FloatToShortFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link FloatToShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link FloatToShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default FloatToShortFunction sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsShortThrows(value);
