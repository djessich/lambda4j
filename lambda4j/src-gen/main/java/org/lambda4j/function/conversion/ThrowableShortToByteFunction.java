 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(short)}.
 *
...
@FunctionalInterface
public interface ThrowableShortToByteFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableShortToByteFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableShortToByteFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableShortToByteFunction<X> of(
            @Nullable final ThrowableShortToByteFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableShortToByteFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableShortToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> byte call(@Nonnull final ThrowableShortToByteFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableShortToByteFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableShortToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableShortToByteFunction<X> constant(byte ret) {
        return (value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(short value) throws X;
    ...
    default <A> ThrowableToByteFunction<A, X> compose(
        ...
        return (a) -> applyAsByteThrows(before.applyAsShortThrows(a));
    }
    ...
    default ThrowableBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsByteThrows(before.applyAsShortThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableShortToByteFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code short} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableShortToByteFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * short}.
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> andThenToInt(@Nonnull final ThrowableByteToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsByteThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableShortToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableShortToByteFunction}.
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableShortToByteFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableShortToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableShortToByteFunction}.
     */
    @Nonnull
    default ThrowableFunction<Short, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ShortToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ShortToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ShortToByteFunction nest() {
     ...
     */
    @Nonnull
    default ShortToByteFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default ShortToByteFunction recover(
            @Nonnull final Function<? super Throwable, ? extends ShortToByteFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ShortToByteFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ShortToByteFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ShortToByteFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ShortToByteFunction sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsByteThrows(value);
