...
public interface CharToLongFunction extends Lambda {
     ...
     */
    static CharToLongFunction of(@Nullable final CharToLongFunction expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link CharToLongFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     * {@code CharToLongFunction} with methods provided by the {@code JDK}.
     *
