...
@FunctionalInterface
public interface ThrowableLongToDoubleFunction<X extends Throwable> extends Lambda, LongToDoubleFunction {

    /**
     * Constructs a {@link ThrowableLongToDoubleFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableLongToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableLongToDoubleFunction<X> of(
            @Nullable final ThrowableLongToDoubleFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableLongToDoubleFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableLongToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> double call(@Nonnull final ThrowableLongToDoubleFunction<? extends X> function,
            long value) throws X {
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableLongToDoubleFunction<X> constant(double ret) {
        return (value) -> ret;
    }
     ...
     * @param value The argument to the function
     * @return The return value from the function, which is its result.
     * @apiNote This method mainly exists to use this {@link ThrowableLongToDoubleFunction} in JRE specific methods only
     * accepting {@link LongToDoubleFunction}. If this function should be applied, then the {@link
     * #applyAsDoubleThrows(long)} method should be used.
     * @apiNote Overrides the {@link LongToDoubleFunction#applyAsDouble(long)} method by using a redefinition as default
     * method. This implementation calls the {@link #applyAsDoubleThrows(long)} method of this function and catches the
    ...
    default <A> ThrowableToDoubleFunction<A, X> compose(
        ...
        return (a) -> applyAsDoubleThrows(before.applyAsLongThrows(a));
    }
    ...
    default ThrowableBooleanToDoubleFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsDoubleThrows(before.applyAsLongThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableLongToDoubleFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     * This method is just convenience, to provide the ability to execute an operation which accepts {@code long} input,
     * before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableLongToDoubleFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * long}.
     ...
     */
    @Nonnull
    default ThrowableLongPredicate<X> andThenToBoolean(@Nonnull final ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> andThenToInt(@Nonnull final ThrowableDoubleToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsDoubleThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableLongToDoubleFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableLongToDoubleFunction}.
     ...
     */
    @Nonnull
    default ThrowableLongToDoubleFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Long, Double> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableLongToDoubleFunction<X> & Memoized) (value) -> {
     ...
     */
    @Nonnull
    default ThrowableFunction<Long, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link LongToDoubleFunction2} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link LongToDoubleFunction2} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link LongToDoubleFunction2} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 recover(
            @Nonnull final Function<? super Throwable, ? extends LongToDoubleFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final LongToDoubleFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link LongToDoubleFunction2} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link LongToDoubleFunction2} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default LongToDoubleFunction2 sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsDoubleThrows(value);
            } catch (RuntimeException | Error e) {
