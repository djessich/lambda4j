...
public interface ThrowableFloatToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableFloatToCharFunction<X> of(
            @Nullable final ThrowableFloatToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default FloatToCharFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default FloatToCharFunction recover(
            @Nonnull final Function<? super Throwable, ? extends FloatToCharFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final FloatToCharFunction function = recover.apply(throwable);
