...
public interface TriBooleanToShortFunction extends Lambda {
     ...
     */
    static TriBooleanToShortFunction of(@Nullable final TriBooleanToShortFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default BiBooleanToShortFunction papplyAsShort(boolean value1) {
     ...
     */
    @Nonnull
    default BooleanToShortFunction papplyAsShort(boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    default TriBooleanToShortFunction composeFromBoolean(@Nonnull final BooleanUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link TriByteToShortFunction} that first applies the {@code before} predicates to
     ...
     */
    @Nonnull
    default TriByteToShortFunction composeFromByte(@Nonnull final BytePredicate before1,
    ...
    /**
     * Returns a composed {@link TriCharToShortFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default TriCharToShortFunction composeFromChar(@Nonnull final CharPredicate before1,
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction composeFromDouble(@Nonnull final DoublePredicate before1,
     ...
     */
    @Nonnull
    default TriFloatToShortFunction composeFromFloat(@Nonnull final FloatPredicate before1,
    ...
    /**
     * Returns a composed {@link TriIntToShortFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default TriIntToShortFunction composeFromInt(@Nonnull final IntPredicate before1,
    ...
    /**
     * Returns a composed {@link TriLongToShortFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default TriLongToShortFunction composeFromLong(@Nonnull final LongPredicate before1,
     ...
     */
    @Nonnull
    default ShortTernaryOperator composeFromShort(@Nonnull final ShortPredicate before1,
     ...
     */
    @Nonnull
    default <S> TriBooleanFunction<S> andThen(@Nonnull final ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriBooleanConsumer consume(@Nonnull final ShortConsumer consumer) {
