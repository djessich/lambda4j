...
public interface TriBooleanToCharFunction extends Lambda {
     ...
     */
    static TriBooleanToCharFunction of(@Nullable final TriBooleanToCharFunction expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link TriByteToCharFunction} that first applies the {@code before} predicates to
    ...
    /**
     * Returns a composed {@link CharTernaryOperator} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
    ...
    /**
     * Returns a composed {@link TriLongToCharFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
