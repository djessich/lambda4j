...
public interface ThrowableTriShortFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableTriShortFunction<R, X> of(
            @Nullable final ThrowableTriShortFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableTriShortFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableTriShortFunction<? extends R, ? extends X> partial) {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableTriShortFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriShortConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriShortFunction<R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriShortFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends TriShortFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriShortFunction<? extends R> function = recover.apply(throwable);
