...
public interface ThrowableBiFloatToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToIntFunction<X> of(
            @Nullable final ThrowableBiFloatToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull final ThrowableBiFloatToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiFloatPredicate<X> andThenToBoolean(@Nonnull final ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiFloatToIntFunction<X> andThenToInt(@Nonnull final ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiFloatToIntFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiFloatToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiFloatToIntFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiFloatToIntFunction function = recover.apply(throwable);
