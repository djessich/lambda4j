...
public interface BiIntFunction<R> extends Lambda {
     ...
     */
    static <R> BiIntFunction<R> of(@Nullable final BiIntFunction<R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link BiIntFunction} into a total {@link BiIntFunction} that returns an {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     ...
     */
    @Nonnull
    static <R> BiIntFunction<Optional<R>> lift(@Nonnull final BiIntFunction<? extends R> partial) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code BiIntFunction} with methods provided by the {@code JDK}.
     *
