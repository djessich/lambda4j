...
public interface ThrowableBiBooleanToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiBooleanToIntFunction<X> of(
            @Nullable final ThrowableBiBooleanToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull final ThrowableBiBooleanToIntFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableBiByteToIntFunction} that first applies the {@code before} predicates to
     ...
     */
    @Nonnull
    default ThrowableBiByteToIntFunction<X> composeFromByte(@Nonnull final ThrowableBytePredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiCharToIntFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiCharToIntFunction<X> composeFromChar(@Nonnull final ThrowableCharPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableIntBinaryOperator} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableIntBinaryOperator<X> composeFromInt(@Nonnull final ThrowableIntPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiLongToIntFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiLongToIntFunction<X> composeFromLong(@Nonnull final ThrowableLongPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiBooleanConsumer<X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiBooleanToIntFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiBooleanToIntFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiBooleanToIntFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiBooleanToIntFunction function = recover.apply(throwable);
