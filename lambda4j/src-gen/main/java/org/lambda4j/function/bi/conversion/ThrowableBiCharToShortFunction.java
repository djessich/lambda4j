...
public interface ThrowableBiCharToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiCharToShortFunction<X> of(
            @Nullable final ThrowableBiCharToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableBiCharToShortFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableBiCharToShortFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiCharPredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiCharToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiCharToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiCharToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiCharToShortFunction function = recover.apply(throwable);
