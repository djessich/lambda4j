...
public interface ThrowableBiFloatToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatToShortFunction<X> of(
            @Nullable final ThrowableBiFloatToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableBiFloatToShortFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiFloatPredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiFloatToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiFloatToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiFloatToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiFloatToShortFunction function = recover.apply(throwable);
