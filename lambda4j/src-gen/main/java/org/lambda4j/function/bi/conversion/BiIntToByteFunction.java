...
public interface BiIntToByteFunction extends Lambda {
     ...
     */
    static BiIntToByteFunction of(@Nullable final BiIntToByteFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default IntToByteFunction papplyAsByte(int value1) {
     ...
     * {@code BiIntToByteFunction} with methods provided by the {@code JDK}.
     *
