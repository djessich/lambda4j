...
public interface ThrowableBiCharToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiCharToByteFunction<X> of(
            @Nullable final ThrowableBiCharToByteFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> byte call(@Nonnull final ThrowableBiCharToByteFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableCharToByteFunction<X> papplyAsByteThrows(char value1) {
    ...
    /**
     * Returns a composed {@link ThrowableBiCharToByteFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiCharPredicate<X> andThenToBoolean(@Nonnull final ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiCharToIntFunction<X> andThenToInt(@Nonnull final ThrowableByteToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiCharToByteFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiCharToByteFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiCharToByteFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiCharToByteFunction function = recover.apply(throwable);
