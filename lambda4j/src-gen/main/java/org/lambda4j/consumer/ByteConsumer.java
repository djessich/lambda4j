...
public interface ByteConsumer extends Lambda {
     ...
     */
    static ByteConsumer of(@Nullable final ByteConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull final ByteConsumer consumer, byte value) {
     ...
     */
    @Nonnull
    default <A> Consumer2<A> compose(@Nonnull final ToByteFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanConsumer composeFromBoolean(@Nonnull final BooleanToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }

    /**
     * Returns a composed {@link ByteConsumer} that first applies the {@code before} operator to
     ...
     */
    @Nonnull
    default ByteConsumer composeFromByte(@Nonnull final ByteUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default CharConsumer composeFromChar(@Nonnull final CharToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default DoubleConsumer2 composeFromDouble(@Nonnull final DoubleToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default FloatConsumer composeFromFloat(@Nonnull final FloatToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default IntConsumer2 composeFromInt(@Nonnull final IntToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default LongConsumer2 composeFromLong(@Nonnull final LongToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default ShortConsumer composeFromShort(@Nonnull final ShortToByteFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsByte(value));
    }
