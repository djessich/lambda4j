 ...
 * Unlike most other functional interfaces, {@code BiByteConsumer} is expected to operate via side-effects.
 * <p>
...
public interface BiByteConsumer extends Lambda {
    ...
    /**
     * Returns a composed {@link BiByteConsumer} that first applies the {@code before} operators to
