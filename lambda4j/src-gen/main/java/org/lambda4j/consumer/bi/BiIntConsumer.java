...
/**
 * Represents an operation that accepts two {@code int}-valued input arguments and returns no result.
 * This is a primitive specialization of {@link BiConsumer2}.
 * Unlike most other functional interfaces, {@code BiIntConsumer} is expected to operate via side-effects.
 * <p>
...
public interface BiIntConsumer extends Lambda {
     ...
     */
    static BiIntConsumer of(@Nullable final BiIntConsumer expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link BiIntConsumer} that first applies the {@code before} operators to
     * its input, and then applies this consumer to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
    ...
    /**
     * Returns a composed {@link BiConsumer2} which represents this {@link BiIntConsumer}. Thereby the primitive
     * input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code BiIntConsumer} with methods provided by the {@code JDK}.
     *
