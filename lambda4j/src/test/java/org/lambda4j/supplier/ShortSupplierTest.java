...
class ShortSupplierTest {
    ...
    void call_givenExpression_executesFunctionalInterface() {
        Assertions.assertEquals((short) 0, ShortSupplier.call(() -> (short) 0));
    }

    @Test
    void call_givenNull_throwsException() {
        Assertions.assertThrows(NullPointerException.class, () -> ShortSupplier.call(null));
    }

    @Test
    void constant_givenValue_returnsAlwaysValue() {
        short ret = 0;
        ShortSupplier supplier = ShortSupplier.constant(ret);
        Assertions.assertEquals(ret, supplier.getAsShort());
        Assertions.assertEquals((short) 0, supplier.getAsShort());
    }

    @Test
    void getAsShort_givenNothing_executesFunctionalInterface() {
        ShortSupplier supplier = () -> (short) 0;
        Assertions.assertNotNull(supplier);
        Assertions.assertDoesNotThrow(() -> Assertions.assertEquals((short) 0, supplier.getAsShort()));
    }
    ...
    void andThen_givenExpression_returnsFunctionalInterface() {
        ShortSupplier supplier = () -> (short) 0;
        Assertions.assertNotNull(supplier);
        Supplier2<String> composed = supplier.andThen(Short::toString);
    ...
    void andThenToShort_givenExpression_returnsFunctionalInterface() {
        ShortSupplier supplier = () -> (short) 0;
        Assertions.assertNotNull(supplier);
        ShortSupplier composed = supplier.andThenToShort(value -> value);
        Assertions.assertNotNull(composed);
    }
    ...
    void consume_givenExpression_returnsFunctionalInterface() {
        ShortSupplier supplier = () -> (short) 0;
        Assertions.assertNotNull(supplier);
        Consumer2<Void> consumer = supplier.consume(value -> Assertions.assertEquals((short) 0, value));
    ...
    void boxed_givenNothing_returnsFunctionalInterface() {
        ShortSupplier supplier = () -> (short) 0;
        Assertions.assertNotNull(supplier);
        Supplier2<Short> boxed = supplier.boxed();
    ...
    void boxed_givenNothing_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(Short.valueOf((short) 0), boxed.get());
        });
    }
}
