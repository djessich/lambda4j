...
class CharSupplierTest {
    ...
    void call_givenExpression_executesFunctionalInterface() {
        Assertions.assertEquals('c', CharSupplier.call(() -> 'c'));
    }

    @Test
    void call_givenNull_throwsException() {
        Assertions.assertThrows(NullPointerException.class, () -> CharSupplier.call(null));
    }

    @Test
    void constant_givenValue_returnsAlwaysValue() {
        char ret = 'c';
        CharSupplier supplier = CharSupplier.constant(ret);
        Assertions.assertEquals(ret, supplier.getAsChar());
        Assertions.assertEquals('c', supplier.getAsChar());
    }

    @Test
    void getAsChar_givenNothing_executesFunctionalInterface() {
        CharSupplier supplier = () -> 'c';
        Assertions.assertNotNull(supplier);
        Assertions.assertDoesNotThrow(() -> Assertions.assertEquals('c', supplier.getAsChar()));
    }
    ...
    void andThen_givenExpression_returnsFunctionalInterface() {
        CharSupplier supplier = () -> 'c';
        Assertions.assertNotNull(supplier);
        Supplier2<String> composed = supplier.andThen(Character::toString);
    ...
    void andThen_givenExpression_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals("c", composed.get());
        });
    }
    ...
    void andThenToChar_givenExpression_returnsFunctionalInterface() {
        CharSupplier supplier = () -> 'c';
        Assertions.assertNotNull(supplier);
        CharSupplier composed = supplier.andThenToChar(value -> value);
        Assertions.assertNotNull(composed);
    }
    ...
    void consume_givenExpression_returnsFunctionalInterface() {
        CharSupplier supplier = () -> 'c';
        Assertions.assertNotNull(supplier);
        Consumer2<Void> consumer = supplier.consume(value -> Assertions.assertEquals('c', value));
    ...
    void boxed_givenNothing_returnsFunctionalInterface() {
        CharSupplier supplier = () -> 'c';
        Assertions.assertNotNull(supplier);
        Supplier2<Character> boxed = supplier.boxed();
    ...
    void boxed_givenNothing_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(Character.valueOf('c'), boxed.get());
        });
    }
}
