...
class FloatSupplierTest {
    ...
    void call_givenExpression_executesFunctionalInterface() {
        Assertions.assertEquals(0.0f, FloatSupplier.call(() -> 0.0f));
    }

    @Test
    void call_givenNull_throwsException() {
        Assertions.assertThrows(NullPointerException.class, () -> FloatSupplier.call(null));
    }

    @Test
    void constant_givenValue_returnsAlwaysValue() {
        float ret = 0.0f;
        FloatSupplier supplier = FloatSupplier.constant(ret);
        Assertions.assertEquals(ret, supplier.getAsFloat());
        Assertions.assertEquals(0.0f, supplier.getAsFloat());
    }

    @Test
    void getAsFloat_givenNothing_executesFunctionalInterface() {
        FloatSupplier supplier = () -> 0.0f;
        Assertions.assertNotNull(supplier);
        Assertions.assertDoesNotThrow(() -> Assertions.assertEquals(0.0f, supplier.getAsFloat()));
    }
    ...
    void andThen_givenExpression_returnsFunctionalInterface() {
        FloatSupplier supplier = () -> 0.0f;
        Assertions.assertNotNull(supplier);
        Supplier2<String> composed = supplier.andThen(Float::toString);
    ...
    void andThenToFloat_givenExpression_returnsFunctionalInterface() {
        FloatSupplier supplier = () -> 0.0f;
        Assertions.assertNotNull(supplier);
        FloatSupplier composed = supplier.andThenToFloat(value -> value);
        Assertions.assertNotNull(composed);
    }
    ...
    void consume_givenExpression_returnsFunctionalInterface() {
        FloatSupplier supplier = () -> 0.0f;
        Assertions.assertNotNull(supplier);
        Consumer2<Void> consumer = supplier.consume(value -> Assertions.assertEquals(0.0f, value));
    ...
    void boxed_givenNothing_returnsFunctionalInterface() {
        FloatSupplier supplier = () -> 0.0f;
        Assertions.assertNotNull(supplier);
        Supplier2<Float> boxed = supplier.boxed();
    ...
    void boxed_givenNothing_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(Float.valueOf(0.0f), boxed.get());
        });
    }
}
