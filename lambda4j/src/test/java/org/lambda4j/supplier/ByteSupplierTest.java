...
class ByteSupplierTest {
    ...
    void call_givenExpression_executesFunctionalInterface() {
        Assertions.assertEquals((byte) 0, ByteSupplier.call(() -> (byte) 0));
    }

    @Test
    void call_givenNull_throwsException() {
        Assertions.assertThrows(NullPointerException.class, () -> ByteSupplier.call(null));
    }

    @Test
    void constant_givenValue_returnsAlwaysValue() {
        byte ret = 0;
        ByteSupplier supplier = ByteSupplier.constant(ret);
        Assertions.assertEquals(ret, supplier.getAsByte());
        Assertions.assertEquals((byte) 0, supplier.getAsByte());
    }

    @Test
    void getAsByte_givenNothing_executesFunctionalInterface() {
        ByteSupplier supplier = () -> (byte) 0;
        Assertions.assertNotNull(supplier);
        Assertions.assertDoesNotThrow(() -> Assertions.assertEquals((byte) 0, supplier.getAsByte()));
    }
    ...
    void andThen_givenExpression_returnsFunctionalInterface() {
        ByteSupplier supplier = () -> (byte) 0;
        Assertions.assertNotNull(supplier);
        Supplier2<String> composed = supplier.andThen(Byte::toString);
    ...
    void andThenToByte_givenExpression_returnsFunctionalInterface() {
        ByteSupplier supplier = () -> (byte) 0;
        Assertions.assertNotNull(supplier);
        ByteSupplier composed = supplier.andThenToByte(value -> value);
        Assertions.assertNotNull(composed);
    }
    ...
    void consume_givenExpression_returnsFunctionalInterface() {
        ByteSupplier supplier = () -> (byte) 0;
        Assertions.assertNotNull(supplier);
        Consumer2<Void> consumer = supplier.consume(value -> Assertions.assertEquals((byte) 0, value));
    ...
    void boxed_givenNothing_returnsFunctionalInterface() {
        ByteSupplier supplier = () -> (byte) 0;
        Assertions.assertNotNull(supplier);
        Supplier2<Byte> boxed = supplier.boxed();
    ...
    void boxed_givenNothing_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(Byte.valueOf((byte) 0), boxed.get());
        });
    }
}
