...
class DoubleSupplier2Test {
    ...
    void call_givenExpression_executesFunctionalInterface() {
        Assertions.assertEquals(0.0d, DoubleSupplier2.call(() -> 0.0d));
    }

    @Test
    void call_givenNull_throwsException() {
        Assertions.assertThrows(NullPointerException.class, () -> DoubleSupplier2.call(null));
    }

    @Test
    void constant_givenValue_returnsAlwaysValue() {
        double ret = 0.0d;
        DoubleSupplier2 supplier = DoubleSupplier2.constant(ret);
        Assertions.assertEquals(ret, supplier.getAsDouble());
        Assertions.assertEquals(0.0d, supplier.getAsDouble());
    }

    @Test
    void getAsDouble_givenNothing_executesFunctionalInterface() {
        DoubleSupplier2 supplier = () -> 0.0d;
        Assertions.assertNotNull(supplier);
    ...
    void andThen_givenExpression_returnsFunctionalInterface() {
        DoubleSupplier2 supplier = () -> 0.0d;
        Assertions.assertNotNull(supplier);
        Supplier2<String> composed = supplier.andThen(Double::toString);
    ...
    void andThen_givenExpression_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals("0.0", composed.get());
        });
    }
    ...
    void andThenToDouble_givenExpression_returnsFunctionalInterface() {
        DoubleSupplier2 supplier = () -> 0.0d;
        Assertions.assertNotNull(supplier);
        DoubleSupplier2 composed = supplier.andThenToDouble(value -> value);
        Assertions.assertNotNull(composed);
    }
    ...
    void consume_givenExpression_returnsFunctionalInterface() {
        DoubleSupplier2 supplier = () -> 0.0d;
        Assertions.assertNotNull(supplier);
        Consumer2<Void> consumer = supplier.consume(value -> Assertions.assertEquals(0.0d, value));
    ...
    void boxed_givenNothing_returnsFunctionalInterface() {
        DoubleSupplier2 supplier = () -> 0.0d;
        Assertions.assertNotNull(supplier);
        Supplier2<Double> boxed = supplier.boxed();
    ...
    void boxed_givenNothing_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(Double.valueOf(0.0d), boxed.get());
        });
    }
}
