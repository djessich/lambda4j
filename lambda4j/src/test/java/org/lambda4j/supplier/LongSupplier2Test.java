...
class LongSupplier2Test {
    ...
    void call_givenExpression_executesFunctionalInterface() {
        Assertions.assertEquals(0L, LongSupplier2.call(() -> 0L));
    }

    @Test
    void call_givenNull_throwsException() {
        Assertions.assertThrows(NullPointerException.class, () -> LongSupplier2.call(null));
    }

    @Test
    void constant_givenValue_returnsAlwaysValue() {
        long ret = 0L;
        LongSupplier2 supplier = LongSupplier2.constant(ret);
        Assertions.assertEquals(ret, supplier.getAsLong());
        Assertions.assertEquals(0L, supplier.getAsLong());
    }

    @Test
    void getAsLong_givenNothing_executesFunctionalInterface() {
        LongSupplier2 supplier = () -> 0L;
        Assertions.assertNotNull(supplier);
    ...
    void andThen_givenExpression_returnsFunctionalInterface() {
        LongSupplier2 supplier = () -> 0L;
        Assertions.assertNotNull(supplier);
        Supplier2<String> composed = supplier.andThen(Long::toString);
    ...
    void andThenToLong_givenExpression_returnsFunctionalInterface() {
        LongSupplier2 supplier = () -> 0L;
        Assertions.assertNotNull(supplier);
        LongSupplier2 composed = supplier.andThenToLong(value -> value);
        Assertions.assertNotNull(composed);
    }
    ...
    void consume_givenExpression_returnsFunctionalInterface() {
        LongSupplier2 supplier = () -> 0L;
        Assertions.assertNotNull(supplier);
        Consumer2<Void> consumer = supplier.consume(value -> Assertions.assertEquals(0L, value));
    ...
    void boxed_givenNothing_returnsFunctionalInterface() {
        LongSupplier2 supplier = () -> 0L;
        Assertions.assertNotNull(supplier);
        Supplier2<Long> boxed = supplier.boxed();
    ...
    void boxed_givenNothing_executesFunctionalInterface() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(Long.valueOf(0L), boxed.get());
        });
    }
}
