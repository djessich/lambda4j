...
public interface LongTernaryOperator extends Lambda {
     ...
     */
    static LongTernaryOperator of(@Nullable final LongTernaryOperator expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link LongTernaryOperator} that first applies the {@code before} operators to
     * its input, and then applies this operator to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
