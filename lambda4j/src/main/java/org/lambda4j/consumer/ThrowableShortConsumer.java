...
public interface ThrowableShortConsumer<X extends Throwable> extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableShortConsumer<X> of(@Nullable ThrowableShortConsumer<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> void call(@Nonnull ThrowableShortConsumer<? extends X> consumer,
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> composeFromByte(@Nonnull ThrowableByteToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> composeFromChar(@Nonnull ThrowableCharToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> composeFromInt(@Nonnull ThrowableIntToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> composeFromLong(@Nonnull ThrowableLongToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> composeFromShort(@Nonnull ThrowableShortUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> acceptThrows(before.applyAsShortThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> andThen(@Nonnull ThrowableShortConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> reversed() {
        return this;
    }
     ...
     */
    @Nonnull
    default ShortConsumer nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default ShortConsumer recover(@Nonnull Function<? super Throwable, ? extends ShortConsumer> recover) {
        ...
        return value -> {
            try {
                ...
                ShortConsumer consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ShortConsumer} that applies this consumer to its input and sneakily throws the thrown
