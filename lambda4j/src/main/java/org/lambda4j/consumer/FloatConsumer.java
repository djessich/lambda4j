...
/**
 * Represents an operation that accepts one {@code float}-valued input argument and returns no result. This is a
 * primitive specialization of {@link Consumer2}. Unlike most other functional interfaces, {@code FloatConsumer} is
...
@FunctionalInterface
public interface FloatConsumer extends Lambda {

    /**
     * Constructs a {@link FloatConsumer} based on a lambda expression or a method reference. Thereby the given lambda
     * expression or method reference is returned on an as-is basis to implicitly transform it to the desired type. With
     * this method, it is possible to ensure that correct type is used from lambda expression or method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code FloatConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static FloatConsumer of(@Nullable FloatConsumer expression) {
        return expression;
    }

    /**
     * Calls the given {@link FloatConsumer} with the given argument and returns its result.
     *
     * @param consumer The consumer to be called
     * @param value The argument to the consumer
     * @throws NullPointerException If given argument is {@code null}
     */
    static void call(@Nonnull FloatConsumer consumer, float value) {
     ...
     */
    @Nonnull
    default <A> Consumer2<A> compose(@Nonnull ToFloatFunction<? super A> before) {
        Objects.requireNonNull(before);
        return a -> accept(before.applyAsFloat(a));
    }
     ...
     */
    @Nonnull
    default BooleanConsumer composeFromBoolean(@Nonnull BooleanToFloatFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteConsumer composeFromByte(@Nonnull ByteToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default CharConsumer composeFromChar(@Nonnull CharToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default DoubleConsumer2 composeFromDouble(@Nonnull DoubleToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsFloat(value));
    }

    /**
     * Returns a composed {@link FloatConsumer} that first applies the {@code before} operator to its input, and then
     * applies this consumer to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation. This method is just convenience, to provide the ability to execute an operation
     ...
     * @return A composed {@code FloatConsumer} that first applies the {@code before} operator to its input, and then
     * applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     */
    @Nonnull
    default FloatConsumer composeFromFloat(@Nonnull FloatUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default IntConsumer2 composeFromInt(@Nonnull IntToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default LongConsumer2 composeFromLong(@Nonnull LongToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default ShortConsumer composeFromShort(@Nonnull ShortToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsFloat(value));
    }

    /**
     * Returns a composed {@link FloatConsumer} that performs, in sequence, this consumer followed by the {@code after}
     ...
     * @return A composed {@link FloatConsumer} that performs, in sequence, this consumer followed by the {@code after}
     * consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default FloatConsumer andThen(@Nonnull FloatConsumer after) {
     ...
     */
    @Nonnull
    default FloatConsumer reversed() {
        return this;
    }

    /**
     * Returns a composed {@link Consumer2} which represents this {@link FloatConsumer}. Thereby the primitive input
     * argument for this consumer is autoboxed. This method provides the possibility to use this {@code FloatConsumer}
