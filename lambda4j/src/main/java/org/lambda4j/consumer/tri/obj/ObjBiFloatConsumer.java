 ...
 * result. This is a (reference, float, float) specialization of {@link TriConsumer}. Unlike most other functional
 * interfaces, {@code ObjBiFloatConsumer} is expected to operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #accept(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ObjBiFloatConsumer<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiFloatConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ObjBiFloatConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T> ObjBiFloatConsumer<T> of(@Nullable ObjBiFloatConsumer<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiFloatConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     ...
     */
    static <T> void call(@Nonnull ObjBiFloatConsumer<? super T> consumer, T t, float value1, float value2) {
        Objects.requireNonNull(consumer);
        consumer.accept(t, value1, value2);
    }

    /**
     * Creates a {@link ObjBiFloatConsumer} which uses the {@code first} parameter of this one as argument for the given
     * {@link Consumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiFloatConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@code Consumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiFloatConsumer<T> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(t);
    }

    /**
     * Creates a {@link ObjBiFloatConsumer} which uses the {@code second} parameter of this one as argument for the
     * given {@link FloatConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiFloatConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@code FloatConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiFloatConsumer<T> onlySecond(@Nonnull FloatConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(value1);
    }

    /**
     * Creates a {@link ObjBiFloatConsumer} which uses the {@code third} parameter of this one as argument for the given
     * {@link FloatConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiFloatConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@code FloatConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiFloatConsumer<T> onlyThird(@Nonnull FloatConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default BiFloatConsumer acceptPartially(T t) {
     ...
     */
    @Nonnull
    default FloatConsumer acceptPartially(T t, float value1) {
     ...
     */
    @Nonnull
    default ObjFloatConsumer<T> acceptPartially(float value1) {
     ...
     */
    @Nonnull
    default Consumer2<T> acceptPartially(float value1, float value2) {
    ...
    default <A, B, C> TriConsumer<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> accept(before1.apply(a), before2.applyAsFloat(b), before3.applyAsFloat(c));
    }
    ...
    default TriBooleanConsumer composeFromBoolean(@Nonnull BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> accept(before1.apply(value1), before2.applyAsFloat(value2),
    ...
    /**
     * Returns a composed {@link ObjBiFloatConsumer} that performs, in sequence, this consumer followed by the {@code
     ...
     * @return A composed {@link ObjBiFloatConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ObjBiFloatConsumer<T> andThen(@Nonnull ObjBiFloatConsumer<? super T> after) {
    ...
    /**
     * Returns a composed {@link TriConsumer} which represents this {@link ObjBiFloatConsumer}. Thereby the primitive
     * input argument for this consumer is autoboxed. This method provides the possibility to use this {@code
     * ObjBiFloatConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriConsumer} which represents this {@code ObjBiFloatConsumer}.
     */
    @Nonnull
    default TriConsumer<T, Float, Float> boxed() {
        return this::accept;
    }
