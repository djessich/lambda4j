 ...
 * result. This is a (reference, reference, float) specialization of {@link TriConsumer}. Unlike most other functional
...
@FunctionalInterface
public interface BiObjFloatConsumer<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjFloatConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjFloatConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjFloatConsumer<T, U> of(@Nullable BiObjFloatConsumer<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> void call(@Nonnull BiObjFloatConsumer<? super T, ? super U> consumer, T t, U u, float value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatConsumer<T, U> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatConsumer<T, U> onlySecond(@Nonnull Consumer<? super U> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatConsumer<T, U> onlyThird(@Nonnull FloatConsumer consumer) {
        Objects.requireNonNull(consumer);
    ...
    /**
     * Returns a composed {@link BiObjFloatConsumer} that performs, in sequence, this consumer followed by the {@code
     ...
     * @return A composed {@link BiObjFloatConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default BiObjFloatConsumer<T, U> andThen(@Nonnull BiObjFloatConsumer<? super T, ? super U> after) {
     ...
     * BiObjFloatConsumer} with methods provided by the {@code JDK}.
     *
