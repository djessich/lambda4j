...
public interface ThrowableBiObjFloatConsumer<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatConsumer<T, U, X> of(
            @Nullable ThrowableBiObjFloatConsumer<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull ThrowableBiObjFloatConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjFloatConsumer<U, X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> acceptThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> acceptThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<U, X> acceptThrowsPartially(T t, float value) {
    ...
    default ThrowableBiObjFloatConsumer<T, U, X> andThen(
            @Nonnull ThrowableBiObjFloatConsumer<? super T, ? super U, ? extends X> after) {
     ...
     * this {@code ThrowableBiObjFloatConsumer} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjFloatConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiObjFloatConsumer<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiObjFloatConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiObjFloatConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default BiObjFloatConsumer<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjFloatConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjFloatConsumer<? super T, ? super U> consumer = recover.apply(throwable);
