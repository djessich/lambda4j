 ...
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableBiObjCharConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjCharConsumer<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjCharConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjCharConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjCharConsumer<T, U, X> of(
            @Nullable ThrowableBiObjCharConsumer<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjCharConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <U> The type of the second argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull ThrowableBiObjCharConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjCharConsumer} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjCharConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharConsumer<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <U> The type of the second argument to the consumer
     ...
     * @return Creates a {@code ThrowableBiObjCharConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharConsumer<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharConsumer} which uses the {@code third} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjCharConsumer} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharConsumer<T, U, X> onlyThird(
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, U u, char value) throws X;
     ...
     */
    default void acceptThrows(@Nonnull Pair<T, U> tuple, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<U, X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> acceptThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> acceptThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<U, X> acceptThrowsPartially(T t, char value) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsCharThrows(c));
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjCharConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiObjCharConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> andThen(
            @Nonnull ThrowableBiObjCharConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<Pair<T, U>, X> tupled() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableBiObjCharConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableBiObjCharConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableBiObjCharConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, Character, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiObjCharConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjCharConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiObjCharConsumer<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjCharConsumer<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiObjCharConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiObjCharConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default BiObjCharConsumer<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjCharConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjCharConsumer<? super T, ? super U> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjCharConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjCharConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjCharConsumer<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                acceptThrows(t, u, value);
