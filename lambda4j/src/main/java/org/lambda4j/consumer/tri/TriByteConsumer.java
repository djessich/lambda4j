...
/**
 * Represents an operation that accepts three {@code byte}-valued input arguments and returns no result. This is a
 * primitive specialization of {@link TriConsumer}. Unlike most other functional interfaces, {@code TriByteConsumer} is
...
public interface TriByteConsumer extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static TriByteConsumer of(@Nullable TriByteConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull TriByteConsumer consumer, byte value1, byte value2, byte value3) {
     ...
     */
    @Nonnull
    static TriByteConsumer onlyFirst(@Nonnull ByteConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static TriByteConsumer onlySecond(@Nonnull ByteConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static TriByteConsumer onlyThird(@Nonnull ByteConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default <A, B, C> TriConsumer<A, B, C> compose(@Nonnull ToByteFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanConsumer composeFromBoolean(@Nonnull BooleanToByteFunction before1,
    ...
    /**
     * Returns a composed {@link TriByteConsumer} that first applies the {@code before} operators to its input, and then
     * applies this consumer to the result. If evaluation of either operation throws an exception, it is relayed to the
     ...
     */
    @Nonnull
    default TriByteConsumer composeFromByte(@Nonnull ByteUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriCharConsumer composeFromChar(@Nonnull CharToByteFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleConsumer composeFromDouble(@Nonnull DoubleToByteFunction before1,
     ...
     */
    @Nonnull
    default TriFloatConsumer composeFromFloat(@Nonnull FloatToByteFunction before1,
     ...
     */
    @Nonnull
    default TriIntConsumer composeFromInt(@Nonnull IntToByteFunction before1,
     ...
     */
    @Nonnull
    default TriLongConsumer composeFromLong(@Nonnull LongToByteFunction before1,
     ...
     */
    @Nonnull
    default TriShortConsumer composeFromShort(@Nonnull ShortToByteFunction before1,
     ...
     */
    @Nonnull
    default TriByteConsumer andThen(@Nonnull TriByteConsumer after) {
