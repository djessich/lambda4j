...
/**
 * Represents an operation that accepts one object-valued and two {@code float}-valued input arguments and returns no
 * result which is able to throw any {@link Throwable}. This is a (reference, float, float) specialization of {@link
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableObjBiFloatConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiFloatConsumer<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiFloatConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiFloatConsumer} from given lambda expression or method reference.
     ...
     */
    static <T, X extends Throwable> ThrowableObjBiFloatConsumer<T, X> of(
            @Nullable final ThrowableObjBiFloatConsumer<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiFloatConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, X extends Throwable> void call(
            @Nonnull final ThrowableObjBiFloatConsumer<? super T, ? extends X> consumer, T t, float value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableFloatConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatConsumer<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableFloatConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiFloatConsumer} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiFloatConsumer<T, X> onlyThird(
            @Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, float value1, float value2) throws X;

    /**
     * Applies this consumer partially to some arguments of this one, producing a {@link ThrowableBiFloatConsumer} as
     * result.
     *
    ...
    /**
     * Applies this consumer partially to some arguments of this one, producing a {@link ThrowableObjFloatConsumer} as
     * result.
     *
     * @param value1 The second argument to this consumer used to partially apply this function
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b),
    ...
    default ThrowableTriBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> acceptThrows(before1.applyThrows(value1), before2.applyAsFloatThrows(value2),
    ...
    /**
     * Returns a composed {@link ThrowableObjBiFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjBiFloatConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> andThen(
            @Nonnull final ThrowableObjBiFloatConsumer<? super T, ? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableObjBiFloatConsumer}.
     * Thereby the primitive input argument for this consumer is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiFloatConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableObjBiFloatConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, Float, Float, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjBiFloatConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiFloatConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjBiFloatConsumer<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjBiFloatConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjBiFloatConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiFloatConsumer<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiFloatConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiFloatConsumer<? super T> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiFloatConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiFloatConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiFloatConsumer<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                this.acceptThrows(t, value1, value2);
