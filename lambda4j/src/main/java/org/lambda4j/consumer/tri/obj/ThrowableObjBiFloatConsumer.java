...
public interface ThrowableObjBiFloatConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatConsumer<T, X> of(
            @Nullable ThrowableObjBiFloatConsumer<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> void call(
            @Nonnull ThrowableObjBiFloatConsumer<? super T, ? extends X> consumer, T t, float value1,
    ...
    default ThrowableObjBiFloatConsumer<T, X> andThen(
            @Nonnull ThrowableObjBiFloatConsumer<? super T, ? extends X> after) {
     ...
     */
    @Nonnull
    default ObjBiFloatConsumer<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiFloatConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiFloatConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiFloatConsumer<? super T> consumer = recover.apply(throwable);
