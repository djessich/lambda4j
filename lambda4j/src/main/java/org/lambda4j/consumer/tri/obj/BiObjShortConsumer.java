...
public interface BiObjShortConsumer<T, U> extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjShortConsumer<T, U> of(@Nullable BiObjShortConsumer<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> void call(@Nonnull BiObjShortConsumer<? super T, ? super U> consumer, T t, U u, short value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjShortConsumer<T, U> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjShortConsumer<T, U> onlySecond(@Nonnull Consumer<? super U> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjShortConsumer<T, U> onlyThird(@Nonnull ShortConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default ObjShortConsumer<U> acceptPartially(T t) {
     ...
     */
    @Nonnull
    default ShortConsumer acceptPartially(T t, U u) {
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> acceptPartially(short value) {
     ...
     */
    @Nonnull
    default Consumer2<U> acceptPartially(T t, short value) {
     ...
     */
    @Nonnull
    default BiObjShortConsumer<T, U> andThen(@Nonnull BiObjShortConsumer<? super T, ? super U> after) {
     ...
     * BiObjShortConsumer} with methods provided by the {@code JDK}.
     *
