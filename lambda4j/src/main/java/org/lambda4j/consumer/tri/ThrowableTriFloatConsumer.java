...
public interface ThrowableTriFloatConsumer<X extends Throwable> extends Lambda {
     ...
     */
    static <X extends Throwable> void call(@Nonnull ThrowableTriFloatConsumer<? extends X> consumer, float value1,
     ...
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> composeFromInt(@Nonnull ThrowableIntToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> andThen(@Nonnull ThrowableTriFloatConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> reversed() {
     ...
     * {@code ThrowableTriFloatConsumer} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriFloatConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default TriFloatConsumer nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link TriFloatConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link TriFloatConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default TriFloatConsumer recover(@Nonnull Function<? super Throwable, ? extends TriFloatConsumer> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriFloatConsumer consumer = recover.apply(throwable);
