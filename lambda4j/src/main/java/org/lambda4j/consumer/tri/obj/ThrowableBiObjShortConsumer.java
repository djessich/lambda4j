 ...
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableBiObjShortConsumer} is expected to
...
@FunctionalInterface
public interface ThrowableBiObjShortConsumer<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjShortConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjShortConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjShortConsumer<T, U, X> of(
            @Nullable ThrowableBiObjShortConsumer<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjShortConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <U> The type of the second argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull ThrowableBiObjShortConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortConsumer<T, U, X> onlyFirst(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortConsumer<T, U, X> onlySecond(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjShortConsumer<T, U, X> onlyThird(
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, U u, short value) throws X;
     ...
     */
    default void acceptThrows(@Nonnull Pair<T, U> tuple, short value) throws X {
        Objects.requireNonNull(tuple);
        acceptThrows(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this consumer partially to some arguments of this one, producing a {@link ThrowableObjShortConsumer} as
     * result.
     *
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<U, X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> acceptThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> acceptThrowsPartially(short value) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<U, X> acceptThrowsPartially(T t, short value) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsShortThrows(c));
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjShortConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiObjShortConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiObjShortConsumer<T, U, X> andThen(
            @Nonnull ThrowableBiObjShortConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<Pair<T, U>, X> tupled() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableBiObjShortConsumer}.
     * Thereby the primitive input argument for this consumer is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjShortConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableBiObjShortConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, Short, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiObjShortConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjShortConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiObjShortConsumer<T, U> nest() {
     ...
     */
    @Nonnull
    default BiObjShortConsumer<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiObjShortConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiObjShortConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default BiObjShortConsumer<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjShortConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjShortConsumer<? super T, ? super U> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjShortConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjShortConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjShortConsumer<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                acceptThrows(t, u, value);
