 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, long, long) specialization of {@link
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableObjBiLongConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, long, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiLongConsumer<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiLongConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiLongConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjBiLongConsumer<T, X> of(
            @Nullable ThrowableObjBiLongConsumer<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiLongConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, X extends Throwable> void call(
            @Nonnull ThrowableObjBiLongConsumer<? super T, ? extends X> consumer, T t, long value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiLongConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiLongConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableLongConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongConsumer<T, X> onlySecond(
            @Nonnull ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(value1);
    }

    /**
     * Creates a {@link ThrowableObjBiLongConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableLongConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongConsumer} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongConsumer<T, X> onlyThird(
            @Nonnull ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, long value1, long value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> acceptThrowsPartially(T t, long value1) {
        return value2 -> acceptThrows(t, value1, value2);
    }

    /**
     * Applies this consumer partially to some arguments of this one, producing a {@link ThrowableObjLongConsumer} as
     * result.
     *
     * @param value1 The second argument to this consumer used to partially apply this function
     * @return A {@code ThrowableObjLongConsumer} that represents this consumer partially applied the some arguments.
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> acceptThrowsPartially(long value1) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> acceptThrowsPartially(long value1, long value2) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyAsLongThrows(b),
    ...
    default ThrowableTriBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> acceptThrows(before1.applyThrows(value1), before2.applyAsLongThrows(value2),
    ...
    /**
     * Returns a composed {@link ThrowableObjBiLongConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjBiLongConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> andThen(
            @Nonnull ThrowableObjBiLongConsumer<? super T, ? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableObjBiLongConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjBiLongConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableObjBiLongConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, Long, Long, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjBiLongConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiLongConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjBiLongConsumer<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiLongConsumer<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjBiLongConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjBiLongConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiLongConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiLongConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiLongConsumer<? super T> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiLongConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiLongConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiLongConsumer<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                acceptThrows(t, value1, value2);
