...
public interface ObjBiDoubleConsumer<T> extends Lambda {
     ...
     */
    static <T> ObjBiDoubleConsumer<T> of(@Nullable ObjBiDoubleConsumer<T> expression) {
        return expression;
    }
     ...
     */
    static <T> void call(@Nonnull ObjBiDoubleConsumer<? super T> consumer, T t, double value1, double value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiDoubleConsumer<T> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T> ObjBiDoubleConsumer<T> onlySecond(@Nonnull DoubleConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T> ObjBiDoubleConsumer<T> onlyThird(@Nonnull DoubleConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default BiDoubleConsumer acceptPartially(T t) {
     ...
     */
    @Nonnull
    default DoubleConsumer2 acceptPartially(T t, double value1) {
     ...
     */
    @Nonnull
    default ObjDoubleConsumer2<T> acceptPartially(double value1) {
     ...
     */
    @Nonnull
    default Consumer2<T> acceptPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default ObjBiDoubleConsumer<T> andThen(@Nonnull ObjBiDoubleConsumer<? super T> after) {
     ...
     * ObjBiDoubleConsumer} with methods provided by the {@code JDK}.
     *
