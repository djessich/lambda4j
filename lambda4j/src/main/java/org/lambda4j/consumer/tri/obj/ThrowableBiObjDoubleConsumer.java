 ...
 * {@link ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableBiObjDoubleConsumer} is
...
@FunctionalInterface
public interface ThrowableBiObjDoubleConsumer<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoubleConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjDoubleConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjDoubleConsumer<T, U, X> of(
            @Nullable ThrowableBiObjDoubleConsumer<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjDoubleConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <U> The type of the second argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull ThrowableBiObjDoubleConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleConsumer<T, U, X> onlyFirst(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleConsumer<T, U, X> onlySecond(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleConsumer<T, U, X> onlyThird(
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, U u, double value) throws X;
     ...
     */
    default void acceptThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyThrows(b),
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiObjDoubleConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> andThen(
            @Nonnull ThrowableBiObjDoubleConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<Pair<T, U>, X> tupled() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableBiObjDoubleConsumer}.
     * Thereby the primitive input argument for this consumer is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjDoubleConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableBiObjDoubleConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, Double, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiObjDoubleConsumer} that applies this consumer to its input and nests the thrown
    ...
    default BiObjDoubleConsumer<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleConsumer<? super T, ? super U> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjDoubleConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjDoubleConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjDoubleConsumer<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                acceptThrows(t, u, value);
