...
@FunctionalInterface
public interface TriIntConsumer extends Lambda {

    /**
     * Constructs a {@link TriIntConsumer} based on a lambda expression or a method reference. Thereby the given lambda
    ...
    @CheckForNull
    @Nullable
    static TriIntConsumer of(@Nullable TriIntConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull TriIntConsumer consumer, int value1, int value2, int value3) {
        Objects.requireNonNull(consumer);
        consumer.accept(value1, value2, value3);
    }

    /**
     * Creates a {@link TriIntConsumer} which uses the {@code first} parameter of this one as argument for the given
     * {@link IntConsumer}.
     *
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code TriIntConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@code IntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static TriIntConsumer onlyFirst(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (value1, value2, value3) -> consumer.accept(value1);
    }

    /**
     * Creates a {@link TriIntConsumer} which uses the {@code second} parameter of this one as argument for the given
     * {@link IntConsumer}.
     *
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code TriIntConsumer} which uses the {@code second} parameter of this one as argument for the
     * given {@code IntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static TriIntConsumer onlySecond(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (value1, value2, value3) -> consumer.accept(value2);
    }

    /**
     * Creates a {@link TriIntConsumer} which uses the {@code third} parameter of this one as argument for the given
     * {@link IntConsumer}.
     *
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code TriIntConsumer} which uses the {@code third} parameter of this one as argument for the
     * given {@code IntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static TriIntConsumer onlyThird(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default <A, B, C> TriConsumer<A, B, C> compose(@Nonnull ToIntFunction<? super A> before1,
            @Nonnull ToIntFunction<? super B> before2, @Nonnull ToIntFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> accept(before1.applyAsInt(a), before2.applyAsInt(b), before3.applyAsInt(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanConsumer composeFromBoolean(@Nonnull BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default TriByteConsumer composeFromByte(@Nonnull ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default TriCharConsumer composeFromChar(@Nonnull CharToIntFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleConsumer composeFromDouble(@Nonnull DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default TriFloatConsumer composeFromFloat(@Nonnull FloatToIntFunction before1,
     ...
     */
    @Nonnull
    default TriIntConsumer composeFromInt(@Nonnull IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriLongConsumer composeFromLong(@Nonnull LongToIntFunction before1,
     ...
     */
    @Nonnull
    default TriShortConsumer composeFromShort(@Nonnull ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default TriIntConsumer andThen(@Nonnull TriIntConsumer after) {
     ...
     */
    @Nonnull
    default TriIntConsumer reversed() {
        return (value3, value2, value1) -> accept(value1, value2, value3);
    }

    /**
     * Returns a composed {@link TriConsumer} which represents this {@link TriIntConsumer}. Thereby the primitive input
     * argument for this consumer is autoboxed. This method provides the possibility to use this {@code TriIntConsumer}
     * with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriConsumer} which represents this {@code TriIntConsumer}.
     */
    @Nonnull
