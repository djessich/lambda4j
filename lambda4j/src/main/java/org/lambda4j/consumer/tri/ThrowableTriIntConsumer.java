...
/**
 * Represents an operation that accepts three {@code int}-valued input arguments and returns no result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableTriConsumer}. Unlike most other
 * functional interfaces, {@code ThrowableTriIntConsumer} is expected to operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(int, int, int)}.
 *
...
@FunctionalInterface
public interface ThrowableTriIntConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriIntConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableTriIntConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableTriIntConsumer<X> of(@Nullable ThrowableTriIntConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriIntConsumer} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull ThrowableTriIntConsumer<? extends X> consumer, int value1,
    ...
    /**
     * Creates a {@link ThrowableTriIntConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableIntConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriIntConsumer} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableIntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntConsumer<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriIntConsumer} which uses the {@code second} parameter of this one as argument for the
     * given {@link ThrowableIntConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriIntConsumer} which uses the {@code second} parameter of this one as argument
     * for the given {@code ThrowableIntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntConsumer<X> onlySecond(
            @Nonnull ThrowableIntConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
    ...
    /**
     * Creates a {@link ThrowableTriIntConsumer} which uses the {@code third} parameter of this one as argument for the
     * given {@link ThrowableIntConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriIntConsumer} which uses the {@code third} parameter of this one as argument
     * for the given {@code ThrowableIntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntConsumer<X> onlyThird(
            @Nonnull ThrowableIntConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> acceptThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> acceptThrowsPartially(int value1, int value2) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyAsIntThrows(a), before2.applyAsIntThrows(b),
    ...
    default ThrowableTriBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> acceptThrows(before1.applyAsIntThrows(value1),
     ...
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> composeFromByte(@Nonnull ThrowableByteToIntFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriCharConsumer<X> composeFromChar(@Nonnull ThrowableCharToIntFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriIntConsumer} that first applies the {@code before} operators to its input,
     * and then applies this consumer to the result. This method is just convenience, to provide the ability to execute
     ...
     * @return A composed {@code ThrowableTriIntConsumer} that first applies the {@code before} operators to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> composeFromInt(@Nonnull ThrowableIntUnaryOperator<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> composeFromLong(@Nonnull ThrowableLongToIntFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriIntConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableTriIntConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> andThen(@Nonnull ThrowableTriIntConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> reversed() {
        return (value3, value2, value1) -> acceptThrows(value1, value2, value3);
    }

    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableTriIntConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableTriIntConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableTriIntConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<Integer, Integer, Integer, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link TriIntConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriIntConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default TriIntConsumer nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link TriIntConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link TriIntConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default TriIntConsumer recover(@Nonnull Function<? super Throwable, ? extends TriIntConsumer> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriIntConsumer consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriIntConsumer} that applies this consumer to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link TriIntConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriIntConsumer sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                acceptThrows(value1, value2, value3);
