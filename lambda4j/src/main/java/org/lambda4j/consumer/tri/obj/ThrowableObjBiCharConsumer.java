...
public interface ThrowableObjBiCharConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharConsumer<T, X> of(
            @Nullable final ThrowableObjBiCharConsumer<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjBiCharConsumer<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiCharConsumer<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiCharConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiCharConsumer<? super T> consumer = recover.apply(throwable);
