...
public interface ThrowableObjBiByteConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteConsumer<T, X> of(
            @Nullable ThrowableObjBiByteConsumer<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> void call(
            @Nonnull ThrowableObjBiByteConsumer<? super T, ? extends X> consumer, T t, byte value1,
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> acceptThrowsPartially(T t, byte value1) {
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> acceptThrowsPartially(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> acceptThrowsPartially(byte value1, byte value2) {
    ...
    default ThrowableObjBiByteConsumer<T, X> andThen(
            @Nonnull ThrowableObjBiByteConsumer<? super T, ? extends X> after) {
     ...
     */
    @Nonnull
    default ObjBiByteConsumer<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiByteConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiByteConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiByteConsumer<? super T> consumer = recover.apply(throwable);
