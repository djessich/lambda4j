 ...
 * result. This is a (reference, reference, int) specialization of {@link TriConsumer}. Unlike most other functional
...
@FunctionalInterface
public interface BiObjIntConsumer<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjIntConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjIntConsumer} from given lambda expression or method reference.
     ...
     */
    static <T, U> BiObjIntConsumer<T, U> of(@Nullable BiObjIntConsumer<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> void call(@Nonnull BiObjIntConsumer<? super T, ? super U> consumer, T t, U u, int value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjIntConsumer<T, U> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjIntConsumer<T, U> onlySecond(@Nonnull Consumer<? super U> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjIntConsumer<T, U> onlyThird(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    default void accept(@Nonnull Pair<T, U> tuple, int value) {
     ...
     */
    @Nonnull
    default ObjIntConsumer2<U> acceptPartially(T t) {
     ...
     */
    @Nonnull
    default IntConsumer2 acceptPartially(T t, U u) {
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> acceptPartially(int value) {
     ...
     */
    @Nonnull
    default Consumer2<U> acceptPartially(T t, int value) {
    ...
    /**
     * Returns a composed {@link BiObjIntConsumer} that performs, in sequence, this consumer followed by the {@code
     ...
     * @return A composed {@link BiObjIntConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default BiObjIntConsumer<T, U> andThen(@Nonnull BiObjIntConsumer<? super T, ? super U> after) {
     ...
     */
    @Nonnull
    default ObjIntConsumer2<Pair<T, U>> tupled() {
        return this::accept;
    }
     ...
     * BiObjIntConsumer} with methods provided by the {@code JDK}.
     *
