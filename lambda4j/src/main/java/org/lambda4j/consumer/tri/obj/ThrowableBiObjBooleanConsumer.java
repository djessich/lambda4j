...
public interface ThrowableBiObjBooleanConsumer<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanConsumer<T, U, X> of(
            @Nullable ThrowableBiObjBooleanConsumer<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull ThrowableBiObjBooleanConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
    ...
    default ThrowableBiObjBooleanConsumer<T, U, X> andThen(
            @Nonnull ThrowableBiObjBooleanConsumer<? super T, ? super U, ? extends X> after) {
    ...
    default BiObjBooleanConsumer<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjBooleanConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjBooleanConsumer<? super T, ? super U> consumer = recover.apply(throwable);
