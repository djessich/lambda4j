...
public interface TriCharConsumer extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static TriCharConsumer of(@Nullable TriCharConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull TriCharConsumer consumer, char value1, char value2, char value3) {
     ...
     */
    @Nonnull
    static TriCharConsumer onlyFirst(@Nonnull CharConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static TriCharConsumer onlySecond(@Nonnull CharConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static TriCharConsumer onlyThird(@Nonnull CharConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default <A, B, C> TriConsumer<A, B, C> compose(@Nonnull ToCharFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanConsumer composeFromBoolean(@Nonnull BooleanToCharFunction before1,
     ...
     */
    @Nonnull
    default TriByteConsumer composeFromByte(@Nonnull ByteToCharFunction before1,
     ...
     */
    @Nonnull
    default TriCharConsumer composeFromChar(@Nonnull CharUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriDoubleConsumer composeFromDouble(@Nonnull DoubleToCharFunction before1,
     ...
     */
    @Nonnull
    default TriFloatConsumer composeFromFloat(@Nonnull FloatToCharFunction before1,
     ...
     */
    @Nonnull
    default TriIntConsumer composeFromInt(@Nonnull IntToCharFunction before1,
     ...
     */
    @Nonnull
    default TriLongConsumer composeFromLong(@Nonnull LongToCharFunction before1,
     ...
     */
    @Nonnull
    default TriShortConsumer composeFromShort(@Nonnull ShortToCharFunction before1,
     ...
     */
    @Nonnull
    default TriCharConsumer andThen(@Nonnull TriCharConsumer after) {
     ...
     */
    @Nonnull
    default TriCharConsumer reversed() {
     ...
     * argument for this consumer is autoboxed. This method provides the possibility to use this {@code TriCharConsumer}
