...
/**
 * Represents an operation that accepts three {@code boolean}-valued input arguments and returns no result which is able
 * to throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableTriConsumer}. Unlike most other
 * functional interfaces, {@code ThrowableTriBooleanConsumer} is expected to operate via side-effects.
 * <p>
...
@FunctionalInterface
public interface ThrowableTriBooleanConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriBooleanConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableTriBooleanConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableTriBooleanConsumer<X> of(
            @Nullable ThrowableTriBooleanConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriBooleanConsumer} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull ThrowableTriBooleanConsumer<? extends X> consumer,
    ...
    /**
     * Creates a {@link ThrowableTriBooleanConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableBooleanConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriBooleanConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriBooleanConsumer<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriBooleanConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableBooleanConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriBooleanConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriBooleanConsumer<X> onlySecond(
            @Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
    ...
    /**
     * Creates a {@link ThrowableTriBooleanConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableBooleanConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriBooleanConsumer} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriBooleanConsumer<X> onlyThird(
            @Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(boolean value1, boolean value2, boolean value3) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiBooleanConsumer<X> acceptThrowsPartially(boolean value1) {
     ...
     */
    @Nonnull
    default ThrowableBooleanConsumer<X> acceptThrowsPartially(boolean value1, boolean value2) {
    ...
    /**
     * Returns a composed {@link ThrowableTriConsumer} that first applies the {@code before} predicates to its input,
     ...
     * @return A composed {@code ThrowableTriConsumer} that first applies the {@code before} predicates to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.testThrows(a), before2.testThrows(b), before3.testThrows(c));
    }

    /**
     * Returns a composed {@link ThrowableTriBooleanConsumer} that first applies the {@code before} operators to its
     ...
     * @return A composed {@code ThrowableTriBooleanConsumer} that first applies the {@code before} operators to its
    ...
    default ThrowableTriBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> acceptThrows(before1.applyAsBooleanThrows(value1),
                before2.applyAsBooleanThrows(value2),
                before3.applyAsBooleanThrows(value3));
    }

    /**
     * Returns a composed {@link ThrowableTriByteConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code byte} input, before this primitive consumer is executed.
     *
     * @param before1 The first predicate to apply before this consumer is applied
     * @param before2 The second predicate to apply before this consumer is applied
     * @param before3 The third predicate to apply before this consumer is applied
     * @return A composed {@code ThrowableTriByteConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> composeFromByte(@Nonnull ThrowableBytePredicate<? extends X> before1,
            @Nonnull ThrowableBytePredicate<? extends X> before2,
            @Nonnull ThrowableBytePredicate<? extends X> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> acceptThrows(before1.testThrows(value1), before2.testThrows(value2),
                before3.testThrows(value3));
    }

    /**
     * Returns a composed {@link ThrowableTriCharConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code char} input, before this primitive consumer is executed.
     *
     * @param before1 The first predicate to apply before this consumer is applied
     * @param before2 The second predicate to apply before this consumer is applied
     * @param before3 The third predicate to apply before this consumer is applied
     * @return A composed {@code ThrowableTriCharConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * char}.
     */
    @Nonnull
    default ThrowableTriCharConsumer<X> composeFromChar(@Nonnull ThrowableCharPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriDoubleConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result. This method is just convenience, to provide the ability to
     ...
     * @param before2 The second predicate to apply before this consumer is applied
     * @param before3 The third predicate to apply before this consumer is applied
     * @return A composed {@code ThrowableTriDoubleConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * double}.
    ...
    /**
     * Returns a composed {@link ThrowableTriFloatConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result. This method is just convenience, to provide the ability to
     ...
     * @param before2 The second predicate to apply before this consumer is applied
     * @param before3 The third predicate to apply before this consumer is applied
     * @return A composed {@code ThrowableTriFloatConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> composeFromFloat(@Nonnull ThrowableFloatPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriIntConsumer} that first applies the {@code before} predicates to its input,
     ...
     * @param before2 The second predicate to apply before this consumer is applied
     * @param before3 The third predicate to apply before this consumer is applied
     * @return A composed {@code ThrowableTriIntConsumer} that first applies the {@code before} predicates to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code long} input, before this primitive consumer is executed.
     *
     * @param before1 The first predicate to apply before this consumer is applied
     * @param before2 The second predicate to apply before this consumer is applied
     * @param before3 The third predicate to apply before this consumer is applied
     * @return A composed {@code ThrowableTriLongConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> composeFromLong(@Nonnull ThrowableLongPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriShortConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result. This method is just convenience, to provide the ability to
     ...
     * @param before2 The second predicate to apply before this consumer is applied
     * @param before3 The third predicate to apply before this consumer is applied
     * @return A composed {@code ThrowableTriShortConsumer} that first applies the {@code before} predicates to its
     * input, and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default ThrowableTriShortConsumer<X> composeFromShort(@Nonnull ThrowableShortPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriBooleanConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableTriBooleanConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableTriBooleanConsumer<X> andThen(@Nonnull ThrowableTriBooleanConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableTriBooleanConsumer<X> reversed() {
        return (value3, value2, value1) -> acceptThrows(value1, value2, value3);
    }

    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableTriBooleanConsumer}.
     * Thereby the primitive input argument for this consumer is autoboxed. This method provides the possibility to use
     * this {@code ThrowableTriBooleanConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableTriBooleanConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<Boolean, Boolean, Boolean, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link TriBooleanConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriBooleanConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default TriBooleanConsumer nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link TriBooleanConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link TriBooleanConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default TriBooleanConsumer recover(
            @Nonnull Function<? super Throwable, ? extends TriBooleanConsumer> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriBooleanConsumer consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriBooleanConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriBooleanConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriBooleanConsumer sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                acceptThrows(value1, value2, value3);
