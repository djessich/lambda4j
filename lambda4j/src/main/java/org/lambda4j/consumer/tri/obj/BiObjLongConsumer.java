 ...
 * result. This is a (reference, reference, long) specialization of {@link TriConsumer}. Unlike most other functional
...
@FunctionalInterface
public interface BiObjLongConsumer<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjLongConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjLongConsumer} from given lambda expression or method reference.
     ...
     */
    static <T, U> void call(@Nonnull BiObjLongConsumer<? super T, ? super U> consumer, T t, U u, long value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjLongConsumer<T, U> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjLongConsumer<T, U> onlySecond(@Nonnull Consumer<? super U> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T, U> BiObjLongConsumer<T, U> onlyThird(@Nonnull LongConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    default void accept(@Nonnull Pair<T, U> tuple, long value) {
     ...
     */
    @Nonnull
    default ObjLongConsumer2<U> acceptPartially(T t) {
     ...
     */
    @Nonnull
    default LongConsumer2 acceptPartially(T t, U u) {
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> acceptPartially(long value) {
     ...
     */
    @Nonnull
    default Consumer2<U> acceptPartially(T t, long value) {
    ...
    /**
     * Returns a composed {@link BiObjLongConsumer} that performs, in sequence, this consumer followed by the {@code
     ...
     * @return A composed {@link BiObjLongConsumer} that performs, in sequence, this consumer followed by the {@code
     * after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default BiObjLongConsumer<T, U> andThen(@Nonnull BiObjLongConsumer<? super T, ? super U> after) {
     ...
     */
    @Nonnull
    default ObjLongConsumer2<Pair<T, U>> tupled() {
        return this::accept;
    }
     ...
     * BiObjLongConsumer} with methods provided by the {@code JDK}.
     *
