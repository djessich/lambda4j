 ...
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableObjBiIntConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, int, int)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiIntConsumer<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiIntConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiIntConsumer} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link ThrowableObjBiIntConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <T, X extends Throwable> void call(@Nonnull ThrowableObjBiIntConsumer<? super T, ? extends X> consumer,
            T t, int value1, int value2) throws X {
        Objects.requireNonNull(consumer);
        consumer.acceptThrows(t, value1, value2);
    }

    /**
     * Creates a {@link ThrowableObjBiIntConsumer} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiIntConsumer} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiIntConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiIntConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableIntConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiIntConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableIntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiIntConsumer<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiIntConsumer} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableIntConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiIntConsumer} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableIntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiIntConsumer<T, X> onlyThird(
            @Nonnull ThrowableIntConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, int value1, int value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> acceptThrowsPartially(T t, int value1) {
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> acceptThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> acceptThrowsPartially(int value1, int value2) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyAsIntThrows(b),
    ...
    default ThrowableTriBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> acceptThrows(before1.applyThrows(value1), before2.applyAsIntThrows(value2),
    ...
    /**
     * Returns a composed {@link ThrowableObjBiIntConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjBiIntConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> andThen(
            @Nonnull ThrowableObjBiIntConsumer<? super T, ? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableObjBiIntConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjBiIntConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableObjBiIntConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, Integer, Integer, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjBiIntConsumer} that applies this consumer to its input and nests the thrown {@link
     ...
     */
    @Nonnull
    default ObjBiIntConsumer<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiIntConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiIntConsumer<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiIntConsumer<? super T> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiIntConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiIntConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiIntConsumer<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                acceptThrows(t, value1, value2);
