...
/**
 * Represents an operation that accepts two object-valued and one {@code long}-valued input argument and returns no
 * result which is able to throw any {@link Throwable}. This is a (reference, reference, long) specialization of {@link
 * ThrowableTriConsumer}. Unlike most other functional interfaces, {@code ThrowableBiObjLongConsumer} is expected to
...
@FunctionalInterface
public interface ThrowableBiObjLongConsumer<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjLongConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjLongConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjLongConsumer<T, U, X> of(
            @Nullable ThrowableBiObjLongConsumer<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjLongConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <U> The type of the second argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
    ...
    static <T, U, X extends Throwable> void call(
            @Nonnull ThrowableBiObjLongConsumer<? super T, ? super U, ? extends X> consumer, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongConsumer<T, U, X> onlyFirst(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongConsumer<T, U, X> onlySecond(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongConsumer<T, U, X> onlyThird(
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(T t, U u, long value) throws X;
     ...
     */
    default void acceptThrows(@Nonnull Pair<T, U> tuple, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<U, X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> acceptThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> acceptThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<U, X> acceptThrowsPartially(T t, long value) {
    ...
    default <A, B, C> ThrowableTriConsumer<A, B, C, X> compose(
        ...
        return (a, b, c) -> acceptThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsLongThrows(c));
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjLongConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiObjLongConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> andThen(
            @Nonnull ThrowableBiObjLongConsumer<? super T, ? super U, ? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<Pair<T, U>, X> tupled() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ThrowableTriConsumer} which represents this {@link ThrowableBiObjLongConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableBiObjLongConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriConsumer} which represents this {@code ThrowableBiObjLongConsumer}.
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, Long, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiObjLongConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjLongConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
    ...
    /**
     * Returns a composed {@link BiObjLongConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiObjLongConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjLongConsumer<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjLongConsumer<? super T, ? super U> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjLongConsumer} that applies this consumer to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjLongConsumer} that applies this consumer to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjLongConsumer<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                acceptThrows(t, u, value);
