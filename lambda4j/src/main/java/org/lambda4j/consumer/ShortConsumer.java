...
/**
 * Represents an operation that accepts one {@code short}-valued input argument and returns no result.
...
public interface ShortConsumer extends Lambda {
     ...
     */
    static ShortConsumer of(@Nullable final ShortConsumer expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A> Consumer2<A> compose(@Nonnull final ToShortFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanConsumer composeFromBoolean(@Nonnull final BooleanToShortFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteConsumer composeFromByte(@Nonnull final ByteToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default CharConsumer composeFromChar(@Nonnull final CharToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default DoubleConsumer2 composeFromDouble(@Nonnull final DoubleToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default FloatConsumer composeFromFloat(@Nonnull final FloatToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default IntConsumer2 composeFromInt(@Nonnull final IntToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default LongConsumer2 composeFromLong(@Nonnull final LongToShortFunction before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default ShortConsumer composeFromShort(@Nonnull final ShortUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> accept(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default ShortConsumer andThen(@Nonnull final ShortConsumer after) {
    ...
    /**
     * Returns a composed {@link Consumer2} which represents this {@link ShortConsumer}. Thereby the primitive
     * input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ShortConsumer} with methods provided by the {@code JDK}.
     *
