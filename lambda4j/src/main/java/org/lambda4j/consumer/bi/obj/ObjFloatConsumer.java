...
public interface ObjFloatConsumer<T> extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static <T> ObjFloatConsumer<T> of(@Nullable ObjFloatConsumer<T> expression) {
        return expression;
    }
     ...
     */
    static <T> void call(@Nonnull ObjFloatConsumer<? super T> consumer, T t, float value) {
     ...
     */
    @Nonnull
    static <T> ObjFloatConsumer<T> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T> ObjFloatConsumer<T> onlySecond(@Nonnull FloatConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default ObjFloatConsumer<T> andThen(@Nonnull ObjFloatConsumer<? super T> after) {
     ...
     * ObjFloatConsumer} with methods provided by the {@code JDK}.
     *
