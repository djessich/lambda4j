...
public interface BiIntConsumer extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static BiIntConsumer of(@Nullable BiIntConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull BiIntConsumer consumer, int value1, int value2) {
     ...
     */
    @Nonnull
    static BiIntConsumer onlyFirst(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static BiIntConsumer onlySecond(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default <A, B> BiConsumer2<A, B> compose(@Nonnull ToIntFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanConsumer composeFromBoolean(@Nonnull BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default BiByteConsumer composeFromByte(@Nonnull ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default BiCharConsumer composeFromChar(@Nonnull CharToIntFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleConsumer composeFromDouble(@Nonnull DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default BiFloatConsumer composeFromFloat(@Nonnull FloatToIntFunction before1,
     ...
     */
    @Nonnull
    default BiIntConsumer composeFromInt(@Nonnull IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiLongConsumer composeFromLong(@Nonnull LongToIntFunction before1,
     ...
     */
    @Nonnull
    default BiShortConsumer composeFromShort(@Nonnull ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default BiIntConsumer andThen(@Nonnull BiIntConsumer after) {
     ...
     */
    @Nonnull
    default BiIntConsumer reversed() {
        return (value2, value1) -> accept(value1, value2);
    }

    /**
     * Returns a composed {@link BiConsumer2} which represents this {@link BiIntConsumer}. Thereby the primitive input
     * argument for this consumer is autoboxed. This method provides the possibility to use this {@code BiIntConsumer}
     * with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiConsumer2} which represents this {@code BiIntConsumer}.
     */
    @Nonnull
