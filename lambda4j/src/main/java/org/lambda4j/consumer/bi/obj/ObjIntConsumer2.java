...
public interface ObjIntConsumer2<T> extends Lambda, ObjIntConsumer<T> {
     ...
     */
    static <T> void call(@Nonnull ObjIntConsumer<? super T> consumer, T t, int value) {
     ...
     */
    @Nonnull
    static <T> ObjIntConsumer2<T> onlyFirst(@Nonnull Consumer<? super T> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    static <T> ObjIntConsumer2<T> onlySecond(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default ObjIntConsumer2<T> andThen(@Nonnull ObjIntConsumer<? super T> after) {
    ...
    /**
     * Returns a composed {@link BiConsumer2} which represents this {@link ObjIntConsumer2}. Thereby the primitive input
     * argument for this consumer is autoboxed. This method provides the possibility to use this {@code ObjIntConsumer2}
