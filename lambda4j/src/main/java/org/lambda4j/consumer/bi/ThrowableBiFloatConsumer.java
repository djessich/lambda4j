...
public interface ThrowableBiFloatConsumer<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiFloatConsumer<X> of(
            @Nullable ThrowableBiFloatConsumer<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> void call(@Nonnull ThrowableBiFloatConsumer<? extends X> consumer, float value1,
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> acceptThrowsPartially(float value1) {
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> composeFromByte(@Nonnull ThrowableByteToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> composeFromChar(@Nonnull ThrowableCharToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> composeFromInt(@Nonnull ThrowableIntToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> composeFromLong(@Nonnull ThrowableLongToFloatFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> andThen(@Nonnull ThrowableBiFloatConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> reversed() {
     ...
     */
    @Nonnull
    default BiFloatConsumer recover(@Nonnull Function<? super Throwable, ? extends BiFloatConsumer> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiFloatConsumer consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiFloatConsumer} that applies this consumer to its input and sneakily throws the thrown
