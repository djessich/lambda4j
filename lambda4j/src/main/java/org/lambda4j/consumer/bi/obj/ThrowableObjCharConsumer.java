 ...
 * ThrowableBiConsumer}. Unlike most other functional interfaces, {@code ThrowableObjCharConsumer} is expected to
 * operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableObjCharConsumer<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjCharConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjCharConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjCharConsumer<T, X> of(
            @Nullable ThrowableObjCharConsumer<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjCharConsumer} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <T, X extends Throwable> void call(@Nonnull ThrowableObjCharConsumer<? super T, ? extends X> consumer,
            T t, char value) throws X {
        Objects.requireNonNull(consumer);
        consumer.acceptThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjCharConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjCharConsumer} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjCharConsumer<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjCharConsumer} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableCharConsumer}.
     *
     * @param <T> The type of the first argument to the consumer
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjCharConsumer} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableCharConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjCharConsumer<T, X> onlySecond(
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> acceptThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> acceptThrowsPartially(char value) {
    ...
    default <A, B> ThrowableBiConsumer<A, B, X> compose(
        ...
        return (a, b) -> acceptThrows(before1.applyThrows(a), before2.applyAsCharThrows(b));
    }
    ...
    default ThrowableBiBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> acceptThrows(before1.applyThrows(value1), before2.applyAsCharThrows(value2));
    }
    ...
    /**
     * Returns a composed {@link ThrowableObjCharConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableObjCharConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> andThen(
            @Nonnull ThrowableObjCharConsumer<? super T, ? extends X> after) {
    ...
    /**
     * Returns a composed {@link ThrowableBiConsumer} which represents this {@link ThrowableObjCharConsumer}. Thereby
     * the primitive input argument for this consumer is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjCharConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiConsumer} which represents this {@code ThrowableObjCharConsumer}.
     */
    @Nonnull
    default ThrowableBiConsumer<T, Character, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link ObjCharConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjCharConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjCharConsumer<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjCharConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjCharConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjCharConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjCharConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjCharConsumer<? super T> consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjCharConsumer} that applies this consumer to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link ObjCharConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjCharConsumer<T> sneakyThrow() {
        return (t, value) -> {
            try {
                acceptThrows(t, value);
