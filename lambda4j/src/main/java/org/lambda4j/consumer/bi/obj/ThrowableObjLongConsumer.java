...
public interface ThrowableObjLongConsumer<T, X extends Throwable> extends Lambda, ObjLongConsumer<T> {
    ...
    static <T, X extends Throwable> ThrowableObjLongConsumer<T, X> of(
            @Nullable final ThrowableObjLongConsumer<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> pacceptThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableConsumer<T, X> pacceptThrows(long value) {
     ...
     *
     * @return A composed {@link ObjLongConsumer2} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjLongConsumer2<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjLongConsumer2} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjLongConsumer2} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjLongConsumer2<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjLongConsumer<? super T> consumer = recover.apply(throwable);
