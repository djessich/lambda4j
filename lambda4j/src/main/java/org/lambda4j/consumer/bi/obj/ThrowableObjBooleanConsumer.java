...
public interface ThrowableObjBooleanConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBooleanConsumer<T, X> of(
            @Nullable ThrowableObjBooleanConsumer<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> void call(
            @Nonnull ThrowableObjBooleanConsumer<? super T, ? extends X> consumer, T t, boolean value) throws X {
    ...
    default ThrowableObjBooleanConsumer<T, X> andThen(
            @Nonnull ThrowableObjBooleanConsumer<? super T, ? extends X> after) {
    ...
    default ObjBooleanConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBooleanConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjBooleanConsumer<? super T> consumer = recover.apply(throwable);
