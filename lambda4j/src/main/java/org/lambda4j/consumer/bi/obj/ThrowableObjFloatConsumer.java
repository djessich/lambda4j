...
public interface ThrowableObjFloatConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatConsumer<T, X> of(
            @Nullable ThrowableObjFloatConsumer<T, X> expression) {
        return expression;
    }
     ...
     */
    static <T, X extends Throwable> void call(@Nonnull ThrowableObjFloatConsumer<? super T, ? extends X> consumer,
    ...
    default ThrowableObjFloatConsumer<T, X> andThen(
            @Nonnull ThrowableObjFloatConsumer<? super T, ? extends X> after) {
    ...
    default ObjFloatConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjFloatConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjFloatConsumer<? super T> consumer = recover.apply(throwable);
