...
public interface ThrowableObjFloatConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatConsumer<T, X> of(
            @Nullable final ThrowableObjFloatConsumer<T, X> expression) {
        return expression;
    }
     ...
     *
     * @return A composed {@link ObjFloatConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjFloatConsumer<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjFloatConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjFloatConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjFloatConsumer<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjFloatConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjFloatConsumer<? super T> consumer = recover.apply(throwable);
