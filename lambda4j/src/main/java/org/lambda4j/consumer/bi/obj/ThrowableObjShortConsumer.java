...
public interface ThrowableObjShortConsumer<T, X extends Throwable> extends Lambda {
     ...
     */
    static <T, X extends Throwable> void call(@Nonnull ThrowableObjShortConsumer<? super T, ? extends X> consumer,
    ...
    default ThrowableObjShortConsumer<T, X> andThen(
            @Nonnull ThrowableObjShortConsumer<? super T, ? extends X> after) {
     ...
     * {@code ThrowableObjShortConsumer} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjShortConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjShortConsumer<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjShortConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link ObjShortConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjShortConsumer<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortConsumer<? super T> consumer = recover.apply(throwable);
