...
public interface ThrowableObjShortConsumer<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortConsumer<T, X> of(
            @Nullable final ThrowableObjShortConsumer<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjShortConsumer<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjShortConsumer<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjShortConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjShortConsumer<? super T> consumer = recover.apply(throwable);
