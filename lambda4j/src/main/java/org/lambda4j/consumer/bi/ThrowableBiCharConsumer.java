 ...
 * functional interfaces, {@code ThrowableBiCharConsumer} is expected to operate via side-effects.
 * <p>
...
@FunctionalInterface
public interface ThrowableBiCharConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiCharConsumer} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiCharConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiCharConsumer<X> of(@Nullable ThrowableBiCharConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiCharConsumer} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull ThrowableBiCharConsumer<? extends X> consumer, char value1,
    ...
    /**
     * Creates a {@link ThrowableBiCharConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableCharConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiCharConsumer} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableCharConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiCharConsumer<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiCharConsumer} which uses the {@code second} parameter of this one as argument for the
     * given {@link ThrowableCharConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiCharConsumer} which uses the {@code second} parameter of this one as argument
     * for the given {@code ThrowableCharConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiCharConsumer<X> onlySecond(
            @Nonnull ThrowableCharConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> acceptThrowsPartially(char value1) {
    ...
    default <A, B> ThrowableBiConsumer<A, B, X> compose(
        ...
        return (a, b) -> acceptThrows(before1.applyAsCharThrows(a), before2.applyAsCharThrows(b));
    }
    ...
    default ThrowableBiBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> acceptThrows(before1.applyAsCharThrows(value1), before2.applyAsCharThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> composeFromByte(@Nonnull ThrowableByteToCharFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiCharConsumer} that first applies the {@code before} operators to its input,
     * and then applies this consumer to the result. This method is just convenience, to provide the ability to execute
     ...
     * @return A composed {@code ThrowableBiCharConsumer} that first applies the {@code before} operators to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * char}.
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> composeFromChar(@Nonnull ThrowableCharUnaryOperator<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> composeFromInt(@Nonnull ThrowableIntToCharFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> composeFromLong(@Nonnull ThrowableLongToCharFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiCharConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiCharConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> andThen(@Nonnull ThrowableBiCharConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> reversed() {
        return (value2, value1) -> acceptThrows(value1, value2);
    }

    /**
     * Returns a composed {@link ThrowableBiConsumer} which represents this {@link ThrowableBiCharConsumer}. Thereby the
     * primitive input argument for this consumer is autoboxed. This method provides the possibility to use this {@code
     * ThrowableBiCharConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiConsumer} which represents this {@code ThrowableBiCharConsumer}.
     */
    @Nonnull
    default ThrowableBiConsumer<Character, Character, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiCharConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiCharConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiCharConsumer nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiCharConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiCharConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default BiCharConsumer recover(@Nonnull Function<? super Throwable, ? extends BiCharConsumer> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiCharConsumer consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiCharConsumer} that applies this consumer to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link BiCharConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiCharConsumer sneakyThrow() {
        return (value1, value2) -> {
            try {
                acceptThrows(value1, value2);
