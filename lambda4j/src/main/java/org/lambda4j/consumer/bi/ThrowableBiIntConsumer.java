...
/**
 * Represents an operation that accepts two {@code int}-valued input arguments and returns no result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableBiConsumer}. Unlike most other
 * functional interfaces, {@code ThrowableBiIntConsumer} is expected to operate via side-effects.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #acceptThrows(int, int)}.
 *
...
@FunctionalInterface
public interface ThrowableBiIntConsumer<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiIntConsumer} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ThrowableBiIntConsumer} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiIntConsumer<X> of(@Nullable ThrowableBiIntConsumer<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiIntConsumer} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     ...
     */
    static <X extends Throwable> void call(@Nonnull ThrowableBiIntConsumer<? extends X> consumer, int value1,
            int value2) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiIntConsumer} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableIntConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiIntConsumer} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableIntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiIntConsumer<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiIntConsumer} which uses the {@code second} parameter of this one as argument for the
     * given {@link ThrowableIntConsumer}.
     *
     * @param <X> The type of the throwable to be thrown by this consumer
     * @param consumer The consumer which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiIntConsumer} which uses the {@code second} parameter of this one as argument
     * for the given {@code ThrowableIntConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiIntConsumer<X> onlySecond(
            @Nonnull ThrowableIntConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
     ...
     * @throws X Any throwable from this consumers action
     */
    void acceptThrows(int value1, int value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> acceptThrowsPartially(int value1) {
    ...
    default <A, B> ThrowableBiConsumer<A, B, X> compose(
        ...
        return (a, b) -> acceptThrows(before1.applyAsIntThrows(a), before2.applyAsIntThrows(b));
    }
    ...
    default ThrowableBiBooleanConsumer<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> acceptThrows(before1.applyAsIntThrows(value1), before2.applyAsIntThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> composeFromByte(@Nonnull ThrowableByteToIntFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> composeFromChar(@Nonnull ThrowableCharToIntFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiIntConsumer} that first applies the {@code before} operators to its input,
     * and then applies this consumer to the result. This method is just convenience, to provide the ability to execute
     ...
     * @return A composed {@code ThrowableBiIntConsumer} that first applies the {@code before} operators to its input,
     * and then applies this consumer to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> composeFromInt(@Nonnull ThrowableIntUnaryOperator<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> composeFromLong(@Nonnull ThrowableLongToIntFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiIntConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer. If performing this consumer throws an exception, the {@code after} consumer will not be
     * performed.
     *
     * @param after The consumer to apply after this consumer is applied
     * @return A composed {@link ThrowableBiIntConsumer} that performs, in sequence, this consumer followed by the
     * {@code after} consumer.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> andThen(@Nonnull ThrowableBiIntConsumer<? extends X> after) {
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> reversed() {
        return (value2, value1) -> acceptThrows(value1, value2);
    }

    /**
     * Returns a composed {@link ThrowableBiConsumer} which represents this {@link ThrowableBiIntConsumer}. Thereby the
     * primitive input argument for this consumer is autoboxed. This method provides the possibility to use this {@code
     * ThrowableBiIntConsumer} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiConsumer} which represents this {@code ThrowableBiIntConsumer}.
     */
    @Nonnull
    default ThrowableBiConsumer<Integer, Integer, X> boxed() {
        return this::acceptThrows;
    }

    /**
     * Returns a composed {@link BiIntConsumer} that applies this consumer to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiIntConsumer} that applies this consumer to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiIntConsumer nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link BiIntConsumer} that first applies this consumer to its input, and then applies the
     * {@code recover} operation if a {@link Throwable} is thrown from this one. The {@code recover} operation is
     * represented by a curried operation which is called with throwable information and same arguments of this
     * consumer.
     *
     * @param recover The operation to apply if this consumer throws a {@code Throwable}
     * @return A composed {@link BiIntConsumer} that first applies this consumer to its input, and then applies the
     ...
     */
    @Nonnull
    default BiIntConsumer recover(@Nonnull Function<? super Throwable, ? extends BiIntConsumer> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiIntConsumer consumer = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiIntConsumer} that applies this consumer to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link BiIntConsumer} that applies this consumer to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiIntConsumer sneakyThrow() {
        return (value1, value2) -> {
            try {
                acceptThrows(value1, value2);
