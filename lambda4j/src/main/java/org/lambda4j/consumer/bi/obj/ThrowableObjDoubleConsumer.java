...
public interface ThrowableObjDoubleConsumer<T, X extends Throwable> extends Lambda, ObjDoubleConsumer<T> {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleConsumer<T, X> of(
            @Nullable final ThrowableObjDoubleConsumer<T, X> expression) {
        return expression;
    }
     ...
     * {@code ThrowableObjDoubleConsumer} with methods provided by the {@code JDK}.
     *
     ...
     */
    @Nonnull
    default ObjDoubleConsumer2<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    /**
     * Returns a composed {@link ObjDoubleConsumer2} that first applies this consumer to its input, and then applies the
    ...
    default ObjDoubleConsumer2<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjDoubleConsumer<? super T>> recover) {
