...
public interface ThrowableObjDoubleConsumer<T, X extends Throwable> extends Lambda, ObjDoubleConsumer<T> {
    ...
    static <T, X extends Throwable> void call(
            @Nonnull ThrowableObjDoubleConsumer<? super T, ? extends X> consumer, T t, double value) throws X {
    ...
    default ThrowableObjDoubleConsumer<T, X> andThen(
            @Nonnull ThrowableObjDoubleConsumer<? super T, ? extends X> after) {
    ...
    default ObjDoubleConsumer2<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoubleConsumer<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoubleConsumer<? super T> consumer = recover.apply(throwable);
