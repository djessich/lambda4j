...
/**
 * Represents an operation that accepts one {@code char}-valued input argument and returns no result. This is a
 * primitive specialization of {@link Consumer2}. Unlike most other functional interfaces, {@code CharConsumer} is
...
public interface CharConsumer extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static CharConsumer of(@Nullable CharConsumer expression) {
        return expression;
    }
     ...
     */
    static void call(@Nonnull CharConsumer consumer, char value) {
     ...
     */
    @Nonnull
    default <A> Consumer2<A> compose(@Nonnull ToCharFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanConsumer composeFromBoolean(@Nonnull BooleanToCharFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteConsumer composeFromByte(@Nonnull ByteToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsChar(value));
    }

    /**
     * Returns a composed {@link CharConsumer} that first applies the {@code before} operator to its input, and then
     * applies this consumer to the result. If evaluation of either operation throws an exception, it is relayed to the
     * caller of the composed operation. This method is just convenience, to provide the ability to execute an operation
     ...
     */
    @Nonnull
    default CharConsumer composeFromChar(@Nonnull CharUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default DoubleConsumer2 composeFromDouble(@Nonnull DoubleToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default FloatConsumer composeFromFloat(@Nonnull FloatToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default IntConsumer2 composeFromInt(@Nonnull IntToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default LongConsumer2 composeFromLong(@Nonnull LongToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default ShortConsumer composeFromShort(@Nonnull ShortToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> accept(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default CharConsumer reversed() {
        return this;
    }

    /**
     * Returns a composed {@link Consumer2} which represents this {@link CharConsumer}. Thereby the primitive input
     * argument for this consumer is autoboxed. This method provides the possibility to use this {@code CharConsumer}
     * with methods provided by the {@code JDK}.
     *
     * @return A composed {@code Consumer2} which represents this {@code CharConsumer}.
     */
    @Nonnull
