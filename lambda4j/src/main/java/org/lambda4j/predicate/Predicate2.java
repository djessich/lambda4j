...
public interface Predicate2<T> extends Lambda, Predicate<T> {
    ...
    /**
     * Returns a {@link Predicate2} that tests if the given argument is <b>equal</b> to the one of this predicate.
     *
     * @param <T> The type of the argument to the predicate
     * @param target The reference with which to compare for equality, which may be {@code null}
     * @return A {@code Predicate2} that tests if the given argument is <b>equal</b> to the one of this predicate.
