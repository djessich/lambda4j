...
public interface ThrowableTriLongPredicate<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriLongPredicate<X> of(
            @Nullable ThrowableTriLongPredicate<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> boolean call(@Nonnull ThrowableTriLongPredicate<? extends X> predicate,
     ...
     */
    @Nonnull
    default ThrowableTriIntPredicate<X> composeFromInt(@Nonnull ThrowableIntToLongFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriLongPredicate} that first applies the {@code before} operators to its
     * input, and then applies this predicate to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> composeFromLong(@Nonnull ThrowableLongUnaryOperator<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> and(@Nonnull ThrowableTriLongPredicate<? extends X> other) {
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> or(@Nonnull ThrowableTriLongPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value1, value2, value3) -> testThrows(value1, value2, value3) || other.testThrows(value1, value2,
                value3);
    }
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> xor(@Nonnull ThrowableTriLongPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value1, value2, value3) -> testThrows(value1, value2, value3) ^ other.testThrows(value1, value2,
                value3);
    }
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> reversed() {
     ...
     */
    @Nonnull
    default TriLongPredicate nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default TriLongPredicate recover(@Nonnull Function<? super Throwable, ? extends TriLongPredicate> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriLongPredicate predicate = recover.apply(throwable);
