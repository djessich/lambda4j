...
import org.lambda4j.function.tri.obj.ObjBiByteFunction;
import org.lambda4j.function.tri.obj.ObjBiByteToByteFunction;
import org.lambda4j.function.tri.obj.ObjBiByteToCharFunction;
import org.lambda4j.function.tri.obj.ObjBiByteToDoubleFunction;
import org.lambda4j.function.tri.obj.ObjBiByteToFloatFunction;
import org.lambda4j.function.tri.obj.ObjBiByteToIntFunction;
import org.lambda4j.function.tri.obj.ObjBiByteToLongFunction;
import org.lambda4j.function.tri.obj.ObjBiByteToShortFunction;
...
public interface ObjBiBytePredicate<T> extends Lambda {
     ...
     */
    @Nonnull
    default BiBytePredicate testPartially(T t) {
     ...
     */
    @Nonnull
    default BytePredicate testPartially(T t, byte value1) {
     ...
     */
    @Nonnull
    default ObjBytePredicate<T> testPartially(byte value1) {
     ...
     */
    @Nonnull
    default Predicate2<T> testPartially(byte value1, byte value2) {
