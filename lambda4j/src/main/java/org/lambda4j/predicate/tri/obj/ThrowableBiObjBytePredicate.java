...
import org.lambda4j.function.tri.obj.ThrowableBiObjByteFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjByteToByteFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjByteToCharFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjByteToDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjByteToFloatFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjByteToIntFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjByteToLongFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjByteToShortFunction;
...
public interface ThrowableBiObjBytePredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBytePredicate<T, U, X> of(
            @Nullable ThrowableBiObjBytePredicate<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> boolean call(
            @Nonnull ThrowableBiObjBytePredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjBytePredicate<U, X> testThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> testThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> testThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> testThrowsPartially(T t, byte value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjBytePredicate<T, U, X> and(
            @Nonnull ThrowableBiObjBytePredicate<? super T, ? super U, ? extends X> other) {
    ...
    default BiObjBytePredicate<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjBytePredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjBytePredicate<? super T, ? super U> predicate = recover.apply(throwable);
