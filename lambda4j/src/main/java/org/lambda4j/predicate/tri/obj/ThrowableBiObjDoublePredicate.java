...
import org.lambda4j.consumer.tri.obj.ThrowableBiObjDoubleConsumer;
...
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleToByteFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleToCharFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleToDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleToFloatFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleToIntFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleToLongFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjDoubleToShortFunction;
 ...
 * which is able to throw any {@link Throwable}. This is a (reference, reference, double) specialization of {@link
...
@FunctionalInterface
public interface ThrowableBiObjDoublePredicate<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoublePredicate} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjDoublePredicate} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> of(
            @Nullable ThrowableBiObjDoublePredicate<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjDoublePredicate} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     ...
     * @return The result from the given {@code ThrowableBiObjDoublePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this predicates action
     */
    static <T, U, X extends Throwable> boolean call(
            @Nonnull ThrowableBiObjDoublePredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjDoublePredicate} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjDoublePredicate} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoublePredicate} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowablePredicate}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     ...
     * @return Creates a {@code ThrowableBiObjDoublePredicate} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowablePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoublePredicate} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjDoublePredicate} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableDoublePredicate}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> onlyThird(
     ...
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> constant(boolean ret) {
        return (t, u, value) -> ret;
    }

    /**
     * Returns a {@link ThrowableBiObjDoublePredicate} that always returns {@code true}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBiObjDoublePredicate} that always returns {@code true}.
     * @see #alwaysFalse()
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> alwaysTrue() {
        return (t, u, value) -> true;
    }

    /**
     * Returns a {@link ThrowableBiObjDoublePredicate} that always returns {@code false}.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     * @param <X> The type of the throwable to be thrown by this predicate
     * @return A {@link ThrowableBiObjDoublePredicate} that always returns {@code false}.
     * @see #alwaysTrue()
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> alwaysFalse() {
        return (t, u, value) -> false;
    }

    /**
     * Returns a {@link ThrowableBiObjDoublePredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     *
     * @param <T> The type of the first argument to the predicate
     * @param <U> The type of the second argument to the predicate
     ...
     * @return A {@code ThrowableBiObjDoublePredicate} that tests if the given arguments are <b>equal</b> to the ones of
     * this predicate.
     * @implNote This implementation checks equality according to {@link Objects#equals(Object)} operation for {@link
     * Object} references and {@code value == target} operation for primitive values.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoublePredicate<T, U, X> isEqual(@Nullable Object target1,
            @Nullable Object target2, double target3) {
     ...
     * @throws X Any throwable from this predicates action
     */
    boolean testThrows(T t, U u, double value) throws X;
     ...
     */
    default boolean testThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoublePredicate<U, X> testThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> testThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> testThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> testThrowsPartially(T t, double value) {
    ...
    default <A, B, C> ThrowableTriPredicate<A, B, C, X> compose(
        ...
        return (a, b, c) -> testThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsDoubleThrows(c));
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     *
     * @param <S> The type of return value from the {@code after} function, and of the composed function
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleFunction} that first applies this predicate to its input, and then
     * applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoublePredicate} that first applies this predicate to its input, and then
     * applies the {@code after} operator to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code boolean}.
     *
     * @param after The operator to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoublePredicate} that first applies this predicate to its input, and then
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleToByteFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code byte}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleToByteFunction} that first applies this predicate to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code char}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleToCharFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to return primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleToDoubleFunction} that first applies this predicate to its input,
     ...
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleToDoubleFunction} that first applies this predicate to its input,
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleToFloatFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result. This method is just convenience, to provide the
     * ability to transform this primitive predicate to an operation returning {@code float}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleToFloatFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to return primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code int}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleToIntFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to return primitive values. In this case this is {@code
     * int}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     * transform this primitive predicate to an operation returning {@code long}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleToLongFunction} that first applies this predicate to its input, and
     * then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to return primitive values. In this case this is {@code
     * long}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleToShortFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result. This method is just convenience, to provide the
     * ability to transform this primitive predicate to an operation returning {@code short}.
     *
     * @param after The function to apply after this predicate is applied
     * @return A composed {@code ThrowableBiObjDoubleToShortFunction} that first applies this predicate to its input,
     * and then applies the {@code after} function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to return primitive values. In this case this is {@code
     * short}.
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoubleConsumer} that fist applies this predicate to its input, and then
     * consumes the result using the given {@link ThrowableBooleanConsumer}.
     *
     * @param consumer The operation which consumes the result from this operation
     * @return A composed {@code ThrowableBiObjDoubleConsumer} that first applies this predicate to its input, and then
     * consumes the result using the given {@code ThrowableBooleanConsumer}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(
    ...
    /**
     * Returns a {@link ThrowableBiObjDoublePredicate} that represents the logical negation of this one.
     *
     * @return A {@code ThrowableBiObjDoublePredicate} that represents the logical negation of this one.
     */
    @Nonnull
    default ThrowableBiObjDoublePredicate<T, U, X> negate() {
        return (t, u, value) -> !testThrows(t, u, value);
    }

    /**
     * Returns a composed {@link ThrowableBiObjDoublePredicate} that represents a short-circuiting logical AND of this
     ...
     * {@code ThrowableBiObjDoublePredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBiObjDoublePredicate} that will be logically-ANDed with this one
     * @return A composed {@code ThrowableBiObjDoublePredicate} that represents the short-circuiting logical AND of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #or(ThrowableBiObjDoublePredicate)
     * @see #xor(ThrowableBiObjDoublePredicate)
     */
    @Nonnull
    default ThrowableBiObjDoublePredicate<T, U, X> and(
            @Nonnull ThrowableBiObjDoublePredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) && other.testThrows(t, u, value);
    }

    /**
     * Returns a composed {@link ThrowableBiObjDoublePredicate} that represents a short-circuiting logical OR of this
     ...
     * {@code ThrowableBiObjDoublePredicate} throws an exception, the {@code other} predicate will not be evaluated.
     *
     * @param other A {@code ThrowableBiObjDoublePredicate} that will be logically-ORed with this one
     * @return A composed {@code ThrowableBiObjDoublePredicate} that represents the short-circuiting logical OR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBiObjDoublePredicate)
     * @see #xor(ThrowableBiObjDoublePredicate)
     */
    @Nonnull
    default ThrowableBiObjDoublePredicate<T, U, X> or(
            @Nonnull ThrowableBiObjDoublePredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) || other.testThrows(t, u, value);
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiObjDoublePredicate} that represents a short-circuiting logical XOR of this
     * predicate and another. Any exceptions thrown during evaluation of either predicate is relayed to the caller; if
     * evaluation of this {@code ThrowableBiObjDoublePredicate} throws an exception, the {@code other} predicate will
     * not be evaluated.
     *
     * @param other A {@code ThrowableBiObjDoublePredicate} that will be logically-XORed with this one
     * @return A composed {@code ThrowableBiObjDoublePredicate} that represents the short-circuiting logical XOR of this
     * predicate and the {@code other} predicate.
     * @throws NullPointerException If given argument is {@code null}
     * @see #and(ThrowableBiObjDoublePredicate)
     * @see #or(ThrowableBiObjDoublePredicate)
     */
    @Nonnull
    default ThrowableBiObjDoublePredicate<T, U, X> xor(
            @Nonnull ThrowableBiObjDoublePredicate<? super T, ? super U, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, u, value) -> testThrows(t, u, value) ^ other.testThrows(t, u, value);
    }
     ...
     */
    @Nonnull
    default ThrowableObjDoublePredicate<Pair<T, U>, X> tupled() {
        return this::testThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjDoublePredicate}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjDoublePredicate}.
     ...
     */
    @Nonnull
    default ThrowableBiObjDoublePredicate<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Double>, Boolean> cache = new ConcurrentHashMap<>();
            return (ThrowableBiObjDoublePredicate<T, U, X> & Memoized) (t, u, value) -> {
     ...
     */
    @Nonnull
    default ThrowableTriPredicate<T, U, Double, X> boxed() {
        return this::testThrows;
    }

    /**
     * Returns a composed {@link BiObjDoublePredicate} that applies this predicate to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjDoublePredicate} that applies this predicate to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiObjDoublePredicate} that first applies this predicate to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoublePredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoublePredicate<? super T, ? super U> predicate = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjDoublePredicate} that applies this predicate to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjDoublePredicate} that applies this predicate to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return testThrows(t, u, value);
