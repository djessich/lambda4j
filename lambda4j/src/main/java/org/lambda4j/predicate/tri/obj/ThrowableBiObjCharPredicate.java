...
import org.lambda4j.function.tri.obj.ThrowableBiObjCharFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjCharToByteFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjCharToCharFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjCharToDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjCharToFloatFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjCharToIntFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjCharToLongFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjCharToShortFunction;
...
public interface ThrowableBiObjCharPredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharPredicate<T, U, X> of(
            @Nullable ThrowableBiObjCharPredicate<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> boolean call(
            @Nonnull ThrowableBiObjCharPredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
            char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<U, X> testThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> testThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> testThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> testThrowsPartially(T t, char value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjCharPredicate<T, U, X> and(
            @Nonnull ThrowableBiObjCharPredicate<? super T, ? super U, ? extends X> other) {
    ...
    default ThrowableBiObjCharPredicate<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Character>, Boolean> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default BiObjCharPredicate<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiObjCharPredicate<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjCharPredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjCharPredicate<? super T, ? super U> predicate = recover.apply(throwable);
