...
import org.lambda4j.function.tri.obj.ThrowableBiObjShortFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjShortToByteFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjShortToCharFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjShortToDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjShortToFloatFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjShortToIntFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjShortToLongFunction;
import org.lambda4j.function.tri.obj.ThrowableBiObjShortToShortFunction;
...
public interface ThrowableBiObjShortPredicate<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortPredicate<T, U, X> of(
            @Nullable ThrowableBiObjShortPredicate<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> boolean call(
            @Nonnull ThrowableBiObjShortPredicate<? super T, ? super U, ? extends X> predicate, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjShortPredicate<U, X> testThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> testThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> testThrowsPartially(short value) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<U, X> testThrowsPartially(T t, short value) {
    ...
    default ThrowableBiObjShortPredicate<T, U, X> and(
            @Nonnull ThrowableBiObjShortPredicate<? super T, ? super U, ? extends X> other) {
    ...
    default BiObjShortPredicate<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjShortPredicate<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjShortPredicate<? super T, ? super U> predicate = recover.apply(throwable);
