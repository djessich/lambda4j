...
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleToByteFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleToCharFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleToDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleToFloatFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleToIntFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleToLongFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiDoubleToShortFunction;
...
public interface ThrowableObjBiDoublePredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoublePredicate<T, X> of(
            @Nullable ThrowableObjBiDoublePredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull ThrowableObjBiDoublePredicate<? super T, ? extends X> predicate, T t, double value1,
     ...
     */
    @Nonnull
    default ThrowableBiDoublePredicate<X> testThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> testThrowsPartially(T t, double value1) {
     ...
     */
    @Nonnull
    default ThrowableObjDoublePredicate<T, X> testThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<T, X> testThrowsPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiDoublePredicate<T, X> and(
            @Nonnull ThrowableObjBiDoublePredicate<? super T, ? extends X> other) {
    ...
    default ObjBiDoublePredicate<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiDoublePredicate<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiDoublePredicate<? super T> predicate = recover.apply(throwable);
