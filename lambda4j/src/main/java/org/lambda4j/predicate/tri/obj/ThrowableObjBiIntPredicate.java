...
import org.lambda4j.function.tri.obj.ThrowableObjBiIntFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiIntToByteFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiIntToCharFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiIntToDoubleFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiIntToFloatFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiIntToIntFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiIntToLongFunction;
import org.lambda4j.function.tri.obj.ThrowableObjBiIntToShortFunction;
...
public interface ThrowableObjBiIntPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntPredicate<T, X> of(
            @Nullable ThrowableObjBiIntPredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull ThrowableObjBiIntPredicate<? super T, ? extends X> predicate, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiIntPredicate<X> testThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntPredicate<X> testThrowsPartially(T t, int value1) {
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<T, X> testThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowablePredicate<T, X> testThrowsPartially(int value1, int value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiIntPredicate<T, X> and(
            @Nonnull ThrowableObjBiIntPredicate<? super T, ? extends X> other) {
     ...
     * this {@code ThrowableObjBiIntPredicate} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBiIntPredicate} that applies this predicate to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     * @return A composed {@link ObjBiIntPredicate} that first applies this predicate to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiIntPredicate<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiIntPredicate<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiIntPredicate<? super T> predicate = recover.apply(throwable);
