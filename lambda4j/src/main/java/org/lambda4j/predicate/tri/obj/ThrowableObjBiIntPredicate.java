...
public interface ThrowableObjBiIntPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntPredicate<T, X> of(
            @Nullable final ThrowableObjBiIntPredicate<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjBiIntPredicate<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiIntPredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiIntPredicate<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiIntPredicate<? super T> predicate = recover.apply(throwable);
