...
public interface ObjBiBooleanPredicate<T> extends Lambda {
     ...
     */
    static <T> ObjBiBooleanPredicate<T> of(@Nullable final ObjBiBooleanPredicate<T> expression) {
        return expression;
    }
    ...
    /**
     * Applies this operator partially to some arguments of this one, producing a {@link ObjBooleanPredicate} as result.
     *
     * @param value1 The second argument to this predicate used to partially apply this function
