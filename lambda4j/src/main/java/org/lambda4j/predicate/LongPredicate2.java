...
public interface LongPredicate2 extends Lambda, LongPredicate {
    ...
    /**
     * Returns a {@link LongPredicate2} that tests if the given argument is <b>equal</b> to the one of this predicate.
     *
     * @param target The reference with which to compare for equality, which may be {@code null}
     * @return A {@code LongPredicate2} that tests if the given argument is <b>equal</b> to the one of this predicate.
     ...
     */
    @Nonnull
    default LongPredicate2 reversed() {
        return this;
    }
