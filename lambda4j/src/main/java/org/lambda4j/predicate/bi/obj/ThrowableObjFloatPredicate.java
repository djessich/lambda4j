...
import org.lambda4j.function.bi.obj.ThrowableObjFloatFunction;
import org.lambda4j.function.bi.obj.ThrowableObjFloatToByteFunction;
import org.lambda4j.function.bi.obj.ThrowableObjFloatToCharFunction;
import org.lambda4j.function.bi.obj.ThrowableObjFloatToDoubleFunction;
import org.lambda4j.function.bi.obj.ThrowableObjFloatToFloatFunction;
import org.lambda4j.function.bi.obj.ThrowableObjFloatToIntFunction;
...
public interface ThrowableObjFloatPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatPredicate<T, X> of(
            @Nullable ThrowableObjFloatPredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull ThrowableObjFloatPredicate<? super T, ? extends X> predicate, T t, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjFloatPredicate<T, X> and(
            @Nonnull ThrowableObjFloatPredicate<? super T, ? extends X> other) {
    ...
    default ThrowableObjFloatPredicate<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Float>, Boolean> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ObjFloatPredicate<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjFloatPredicate<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjFloatPredicate<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjFloatPredicate<? super T> predicate = recover.apply(throwable);
