...
public interface ThrowableObjDoublePredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoublePredicate<T, X> of(
            @Nullable ThrowableObjDoublePredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull ThrowableObjDoublePredicate<? super T, ? extends X> predicate, T t, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjDoublePredicate<T, X> and(
            @Nonnull ThrowableObjDoublePredicate<? super T, ? extends X> other) {
    ...
    default ObjDoublePredicate<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoublePredicate<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoublePredicate<? super T> predicate = recover.apply(throwable);
