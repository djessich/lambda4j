...
import org.lambda4j.function.bi.obj.ThrowableObjLongFunction;
import org.lambda4j.function.bi.obj.ThrowableObjLongToByteFunction;
import org.lambda4j.function.bi.obj.ThrowableObjLongToCharFunction;
import org.lambda4j.function.bi.obj.ThrowableObjLongToDoubleFunction;
import org.lambda4j.function.bi.obj.ThrowableObjLongToFloatFunction;
import org.lambda4j.function.bi.obj.ThrowableObjLongToIntFunction;
import org.lambda4j.function.bi.obj.ThrowableObjLongToLongFunction;
import org.lambda4j.function.bi.obj.ThrowableObjLongToShortFunction;
...
public interface ThrowableObjLongPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongPredicate<T, X> of(
            @Nullable ThrowableObjLongPredicate<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> boolean call(
            @Nonnull ThrowableObjLongPredicate<? super T, ? extends X> predicate, T t, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
    ...
    default ThrowableObjLongPredicate<T, X> and(
            @Nonnull ThrowableObjLongPredicate<? super T, ? extends X> other) {
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> or(@Nonnull ThrowableObjLongPredicate<? super T, ? extends X> other) {
        Objects.requireNonNull(other);
        return (t, value) -> testThrows(t, value) || other.testThrows(t, value);
    }
    ...
    default ThrowableObjLongPredicate<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Long>, Boolean> cache = new ConcurrentHashMap<>();
     ...
     * {@code ThrowableObjLongPredicate} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjLongPredicate} that applies this predicate to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjLongPredicate<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjLongPredicate} that first applies this predicate to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjLongPredicate<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjLongPredicate<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjLongPredicate<? super T> predicate = recover.apply(throwable);
