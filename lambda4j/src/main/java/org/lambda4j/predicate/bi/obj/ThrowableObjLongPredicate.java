...
public interface ThrowableObjLongPredicate<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongPredicate<T, X> of(
            @Nullable final ThrowableObjLongPredicate<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ObjLongPredicate<T> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjLongPredicate<T> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjLongPredicate<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjLongPredicate<? super T> predicate = recover.apply(throwable);
