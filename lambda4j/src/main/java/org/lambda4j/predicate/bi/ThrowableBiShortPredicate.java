...
public interface ThrowableBiShortPredicate<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiShortPredicate<X> of(
            @Nullable ThrowableBiShortPredicate<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> boolean call(@Nonnull ThrowableBiShortPredicate<? extends X> predicate,
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> testThrowsPartially(short value1) {
     ...
     */
    @Nonnull
    default ThrowableBiIntPredicate<X> composeFromInt(@Nonnull ThrowableIntToShortFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiShortConsumer<X> consume(@Nonnull ThrowableBooleanConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> and(@Nonnull ThrowableBiShortPredicate<? extends X> other) {
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> or(@Nonnull ThrowableBiShortPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value1, value2) -> testThrows(value1, value2) || other.testThrows(value1, value2);
    }
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> xor(@Nonnull ThrowableBiShortPredicate<? extends X> other) {
        Objects.requireNonNull(other);
        return (value1, value2) -> testThrows(value1, value2) ^ other.testThrows(value1, value2);
    }
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> reversed() {
     ...
     */
    @Nonnull
    default BiShortPredicate nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default BiShortPredicate recover(@Nonnull Function<? super Throwable, ? extends BiShortPredicate> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiShortPredicate predicate = recover.apply(throwable);
