...
/**
 * Represents an operation that accepts one {@code double}-valued input argument and produces a result which is able to
...
@FunctionalInterface
public interface ThrowableDoubleFunction<R, X extends Throwable> extends Lambda, DoubleFunction<R> {

    /**
     * Constructs a {@link ThrowableDoubleFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableDoubleFunction} from given lambda expression or method reference.
    ...
    /**
     * Lifts a partial {@link ThrowableDoubleFunction} into a total {@link ThrowableDoubleFunction} that returns an
     * {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ThrowableDoubleFunction} lifted into a total {@code ThrowableDoubleFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableDoubleFunction<Optional<R>, X> lift(
            @Nonnull ThrowableDoubleFunction<? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return value -> Optional.ofNullable(partial.applyThrows(value));
    }

    /**
     * Calls the given {@link ThrowableDoubleFunction} with the given argument and returns its result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableDoubleFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableDoubleFunction<R, X> constant(R ret) {
        return value -> ret;
    }
     ...
     * @param value The argument to the function
     * @return The return value from the function, which is its result.
     * @apiNote This method mainly exists to use this {@link ThrowableDoubleFunction} in JRE specific methods only
     * accepting {@link DoubleFunction}. If this function should be applied, then the {@link #applyThrows(double)}
     * method should be used.
     * @apiNote Overrides the {@link DoubleFunction#apply(double)} method by using a redefinition as default method.
     * This implementation calls the {@link #applyThrows(double)} method of this function and catches the eventually
    ...
    default <A> ThrowableFunction<A, R, X> compose(
        ...
        return a -> applyThrows(before.applyAsDoubleThrows(a));
    }
    ...
    default ThrowableBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyThrows(before.applyAsDoubleThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableDoubleFunction} that first applies the {@code before} operator to its input,
     * and then applies this function to the result. This method is just convenience, to provide the ability to execute
     * an operation which accepts {@code double} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableDoubleFunction} that first applies the {@code before} operator to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * double}.
     ...
     */
    @Nonnull
    default ThrowableIntFunction<R, X> composeFromInt(@Nonnull ThrowableIntToDoubleFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyThrows(before.applyAsDoubleThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableDoubleFunction<R, X> reversed() {
        return this;
    }
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableDoubleFunction}.
    ...
    default ThrowableDoubleFunction<R, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableDoubleFunction<R, X> & Memoized) value -> {
    ...
    @Deprecated
    @Nonnull
    default ThrowableDoubleFunction<Optional<R>, X> nonNull() {
        return value -> Optional.ofNullable(applyThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ThrowableDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableDoubleFunction}.
     */
    @Nonnull
    default ThrowableFunction<Double, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link DoubleFunction2} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link DoubleFunction2} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default DoubleFunction2<R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link DoubleFunction2} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default DoubleFunction2<R> recover(
            @Nonnull Function<? super Throwable, ? extends DoubleFunction<? extends R>> recover) {
        ...
        return value -> {
            try {
                ...
                DoubleFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link DoubleFunction2} that applies this function to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link DoubleFunction2} that applies this function to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default DoubleFunction2<R> sneakyThrow() {
        return value -> {
            try {
                return applyThrows(value);
