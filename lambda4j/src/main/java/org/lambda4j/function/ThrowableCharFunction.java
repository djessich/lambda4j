...
public interface ThrowableCharFunction<R, X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> andThenToInt(@Nonnull ThrowableToIntFunction<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharFunction<R, X> curried() {
        return this;
    }
     ...
     */
    @Nonnull
    default ThrowableCharFunction<R, X> reversed() {
        return this;
    }
