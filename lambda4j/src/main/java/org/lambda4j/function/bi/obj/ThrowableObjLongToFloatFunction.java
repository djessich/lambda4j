...
public interface ThrowableObjLongToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToFloatFunction<T, X> of(
            @Nullable ThrowableObjLongToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull ThrowableObjLongToFloatFunction<? super T, ? extends X> function, T t, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
    ...
    default ThrowableObjLongToFloatFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Long>, Float> cache = new ConcurrentHashMap<>();
     ...
     * this {@code ThrowableObjLongToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjLongToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjLongToFloatFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjLongToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjLongToFloatFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjLongToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjLongToFloatFunction<? super T> function = recover.apply(throwable);
