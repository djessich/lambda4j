...
public interface ThrowableObjFloatToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToShortFunction<T, X> of(
            @Nullable ThrowableObjFloatToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull ThrowableObjFloatToShortFunction<? super T, ? extends X> function, T t, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableFloatToShortFunction<X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> applyAsShortThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjFloatToShortFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjFloatToShortFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link ObjFloatToShortFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjFloatToShortFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjFloatToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjFloatToShortFunction<? super T> function = recover.apply(throwable);
