...
public interface ThrowableObjDoubleToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToFloatFunction<T, X> of(
            @Nullable ThrowableObjDoubleToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull ThrowableObjDoubleToFloatFunction<? super T, ? extends X> function, T t, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableDoubleToFloatFunction<X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<T, X> applyAsFloatThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjDoubleToFloatFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjDoubleToFloatFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoubleToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoubleToFloatFunction<? super T> function = recover.apply(throwable);
