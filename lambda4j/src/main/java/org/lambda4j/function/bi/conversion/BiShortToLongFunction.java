...
@FunctionalInterface
public interface BiShortToLongFunction extends Lambda {

    /**
     * Constructs a {@link BiShortToLongFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiShortToLongFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static BiShortToLongFunction of(@Nullable BiShortToLongFunction expression) {
        return expression;
    }
     ...
     */
    static long call(@Nonnull BiShortToLongFunction function, short value1, short value2) {
     ...
     */
    @Nonnull
    static BiShortToLongFunction onlyFirst(@Nonnull ShortToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiShortToLongFunction onlySecond(@Nonnull ShortToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B> ToLongBiFunction2<A, B> compose(@Nonnull ToShortFunction<? super A> before1,
            @Nonnull ToShortFunction<? super B> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (a, b) -> applyAsLong(before1.applyAsShort(a), before2.applyAsShort(b));
    }
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction composeFromBoolean(@Nonnull BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default BiByteToLongFunction composeFromByte(@Nonnull ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default BiCharToLongFunction composeFromChar(@Nonnull CharToShortFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToLongFunction composeFromDouble(@Nonnull DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToLongFunction composeFromFloat(@Nonnull FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default BiIntToLongFunction composeFromInt(@Nonnull IntToShortFunction before1,
     ...
     */
    @Nonnull
    default LongBinaryOperator2 composeFromLong(@Nonnull LongToShortFunction before1,
    ...
    /**
     * Returns a composed {@link BiShortToLongFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code BiShortToLongFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default BiShortToLongFunction composeFromShort(@Nonnull ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <S> BiShortFunction<S> andThen(@Nonnull LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiShortPredicate andThenToBoolean(@Nonnull LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortToByteFunction andThenToByte(@Nonnull LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortToCharFunction andThenToChar(@Nonnull LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortToDoubleFunction andThenToDouble(@Nonnull LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortToFloatFunction andThenToFloat(@Nonnull LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortToIntFunction andThenToInt(@Nonnull LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortToLongFunction andThenToLong(@Nonnull LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortBinaryOperator andThenToShort(@Nonnull LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiShortConsumer consume(@Nonnull LongConsumer consumer) {
     ...
     */
    @Nonnull
    default BiShortToLongFunction reversed() {
     ...
     * BiShortToLongFunction} with methods provided by the {@code JDK}.
     *
