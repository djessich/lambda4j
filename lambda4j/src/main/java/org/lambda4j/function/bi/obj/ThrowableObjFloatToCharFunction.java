 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, float) specialization
...
public interface ThrowableObjFloatToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToCharFunction<T, X> of(
            @Nullable ThrowableObjFloatToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjFloatToCharFunction<? super T, ? extends X> function, T t, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableFloatToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjFloatToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjFloatToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjFloatToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjFloatToCharFunction<? super T> function = recover.apply(throwable);
