...
public interface ThrowableBiBooleanToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiBooleanToDoubleFunction<X> of(
            @Nullable ThrowableBiBooleanToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull ThrowableBiBooleanToDoubleFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableBiIntToDoubleFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableBiIntToDoubleFunction<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiBooleanConsumer<X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableBiBooleanToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     */
    @Nonnull
    default BiBooleanToDoubleFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiBooleanToDoubleFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiBooleanToDoubleFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiBooleanToDoubleFunction function = recover.apply(throwable);
