...
public interface BiCharToDoubleFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static BiCharToDoubleFunction of(@Nullable BiCharToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    static double call(@Nonnull BiCharToDoubleFunction function, char value1, char value2) {
     ...
     */
    @Nonnull
    static BiCharToDoubleFunction onlyFirst(@Nonnull CharToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiCharToDoubleFunction onlySecond(@Nonnull CharToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default CharToDoubleFunction applyAsDoublePartially(char value1) {
     ...
     */
    @Nonnull
    default <A, B> ToDoubleBiFunction2<A, B> compose(@Nonnull ToCharFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToDoubleFunction composeFromBoolean(@Nonnull BooleanToCharFunction before1,
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction composeFromByte(@Nonnull ByteToCharFunction before1,
     ...
     */
    @Nonnull
    default BiCharToDoubleFunction composeFromChar(@Nonnull CharUnaryOperator before1,
     ...
     */
    @Nonnull
    default DoubleBinaryOperator2 composeFromDouble(@Nonnull DoubleToCharFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToDoubleFunction composeFromFloat(@Nonnull FloatToCharFunction before1,
     ...
     */
    @Nonnull
    default BiIntToDoubleFunction composeFromInt(@Nonnull IntToCharFunction before1,
     ...
     */
    @Nonnull
    default BiLongToDoubleFunction composeFromLong(@Nonnull LongToCharFunction before1,
     ...
     */
    @Nonnull
    default BiShortToDoubleFunction composeFromShort(@Nonnull ShortToCharFunction before1,
     ...
     */
    @Nonnull
    default <S> BiCharFunction<S> andThen(@Nonnull DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiCharPredicate andThenToBoolean(@Nonnull DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToByteFunction andThenToByte(@Nonnull DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharBinaryOperator andThenToChar(@Nonnull DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToDoubleFunction andThenToDouble(@Nonnull DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToFloatFunction andThenToFloat(@Nonnull DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToIntFunction andThenToInt(@Nonnull DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToLongFunction andThenToLong(@Nonnull DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharToShortFunction andThenToShort(@Nonnull DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiCharConsumer consume(@Nonnull DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default BiCharToDoubleFunction reversed() {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiCharToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiCharToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiCharToDoubleFunction}.
     */
    @Nonnull
    default BiFunction2<Character, Character, Double> boxed() {
