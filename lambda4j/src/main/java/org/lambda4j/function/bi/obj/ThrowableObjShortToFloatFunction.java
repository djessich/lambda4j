...
public interface ThrowableObjShortToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToFloatFunction<T, X> of(
            @Nullable ThrowableObjShortToFloatFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
    ...
    default ThrowableObjShortToFloatFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Short>, Float> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ObjShortToFloatFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjShortToFloatFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortToFloatFunction<? super T> function = recover.apply(throwable);
