...
/**
 * Represents an operation that accepts two {@code long}-valued input arguments and produces a result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(long, long)}.
 *
...
@FunctionalInterface
public interface ThrowableBiLongFunction<R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiLongFunction} from given lambda expression or method reference.
    ...
    /**
     * Constructs a {@link ThrowableBiLongFunction} based on a curried lambda expression. Thereby the given curried
     ...
     * @return A {@code ThrowableBiLongFunction} from given curried lambda expression.
    ...
    @Nullable
    static <R, X extends Throwable> ThrowableBiLongFunction<R, X> of(
            @Nullable ThrowableLongFunction<ThrowableLongFunction<R, X>, X> curried) throws X {
    ...
    /**
     * Lifts a partial {@link ThrowableBiLongFunction} into a total {@link ThrowableBiLongFunction} that returns an
     * {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ThrowableBiLongFunction} lifted into a total {@code ThrowableBiLongFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableBiLongFunction<Optional<R>, X> lift(
            @Nonnull ThrowableBiLongFunction<? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (value1, value2) -> Optional.ofNullable(partial.applyThrows(value1, value2));
    }

    /**
     * Calls the given {@link ThrowableBiLongFunction} with the given arguments and returns its result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableBiLongFunction<? extends R, ? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiLongFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableLongFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiLongFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableBiLongFunction<R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiLongFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ThrowableLongFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiLongFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ThrowableLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableBiLongFunction<R, X> onlySecond(
            @Nonnull ThrowableLongFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiLongFunction} which always returns a given value.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiLongFunction} which always returns a given value.
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableBiLongFunction<R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(long value1, long value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableLongFunction<R, X> applyThrowsPartially(long value1) {
    ...
    default <A, B> ThrowableBiFunction<A, B, R, X> compose(
        ...
        return (a, b) -> applyThrows(before1.applyAsLongThrows(a), before2.applyAsLongThrows(b));
    }
    ...
    default ThrowableBiBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyThrows(before1.applyAsLongThrows(value1), before2.applyAsLongThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableBiIntFunction<R, X> composeFromInt(@Nonnull ThrowableIntToLongFunction<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiLongFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. This method is just convenience, to provide the ability to execute
     * an operation which accepts {@code long} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiLongFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     ...
     */
    @Nonnull
    default ThrowableBiLongPredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableLongFunction<ThrowableLongFunction<R, X>, X> curried() {
     ...
     */
    @Nonnull
    default ThrowableBiLongFunction<R, X> reversed() {
        return (value2, value1) -> applyThrows(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiLongFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiLongFunction<R, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<Long, Long>, R> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ThrowableBiLongFunction<R, X> & Memoized) (value1, value2) -> {
                R returnValue;
                synchronized (lock) {
    ...
    @Deprecated
    @Nonnull
    default ThrowableBiLongFunction<Optional<R>, X> nonNull() {
        return (value1, value2) -> Optional.ofNullable(applyThrows(value1, value2));
    }

    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableBiLongFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ThrowableBiLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableBiLongFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<Long, Long, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link BiLongFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiLongFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiLongFunction<R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiLongFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default BiLongFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends BiLongFunction<? extends R>> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiLongFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiLongFunction} that applies this function to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link BiLongFunction} that applies this function to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiLongFunction<R> sneakyThrow() {
        return (value1, value2) -> {
            try {
                return applyThrows(value1, value2);
