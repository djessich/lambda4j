...
public interface ThrowableObjShortToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToIntFunction<T, X> of(
            @Nullable ThrowableObjShortToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjShortToIntFunction<? super T, ? extends X> function, T t, short value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjShortPredicate<T, X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjShortToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjShortToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjShortToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjShortToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjShortToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortToIntFunction<? super T> function = recover.apply(throwable);
