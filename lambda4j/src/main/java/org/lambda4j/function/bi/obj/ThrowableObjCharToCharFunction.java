...
public interface ThrowableObjCharToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToCharFunction<T, X> of(
            @Nullable ThrowableObjCharToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjCharToCharFunction<? super T, ? extends X> function, T t, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<T, X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjCharToCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjCharToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjCharToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjCharToCharFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjCharToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjCharToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjCharToCharFunction<? super T> function = recover.apply(throwable);
