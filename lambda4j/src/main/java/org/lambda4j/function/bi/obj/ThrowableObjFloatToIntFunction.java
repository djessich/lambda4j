...
public interface ThrowableObjFloatToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToIntFunction<T, X> of(
            @Nullable ThrowableObjFloatToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjFloatToIntFunction<? super T, ? extends X> function, T t, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> applyAsIntThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatPredicate<T, X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default ThrowableObjFloatToIntFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Float>, Integer> cache = new ConcurrentHashMap<>();
     ...
     * this {@code ThrowableObjFloatToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjFloatToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjFloatToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjFloatToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjFloatToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjFloatToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjFloatToIntFunction<? super T> function = recover.apply(throwable);
