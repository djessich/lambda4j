...
public interface ThrowableObjFloatToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjFloatToLongFunction<T, X> of(
            @Nullable ThrowableObjFloatToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjFloatToLongFunction<? super T, ? extends X> function, T t, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableFloatToLongFunction<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjFloatToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjFloatToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjFloatToLongFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjFloatToLongFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjFloatToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjFloatToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjFloatToLongFunction<? super T> function = recover.apply(throwable);
