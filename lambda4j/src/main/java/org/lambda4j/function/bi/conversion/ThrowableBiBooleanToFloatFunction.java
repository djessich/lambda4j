...
public interface ThrowableBiBooleanToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiBooleanToFloatFunction<X> of(
            @Nullable ThrowableBiBooleanToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull ThrowableBiBooleanToFloatFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiIntToFloatFunction<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiBooleanConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiBooleanToFloatFunction<X> reversed() {
     ...
     * this {@code ThrowableBiBooleanToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiBooleanToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiBooleanToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiBooleanToFloatFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiBooleanToFloatFunction function = recover.apply(throwable);
