 ...
 * {@code float}-valued result. This is a (reference, float) specialization of {@link BiFunction2}.
 * <p>
...
@FunctionalInterface
public interface ObjFloatToFloatFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjFloatToFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjFloatToFloatFunction} from given lambda expression or method reference.
     ...
     */
    static <T> ObjFloatToFloatFunction<T> of(@Nullable ObjFloatToFloatFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjFloatToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function to be called
     * @param t The first argument to the function
     * @param value The second argument to the function
     * @return The result from the given {@code ObjFloatToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> float call(@Nonnull ObjFloatToFloatFunction<? super T> function, T t, float value) {
        Objects.requireNonNull(function);
        return function.applyAsFloat(t, value);
    }

    /**
     * Creates a {@link ObjFloatToFloatFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjFloatToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjFloatToFloatFunction<T> onlyFirst(@Nonnull ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value) -> function.applyAsFloat(t);
    }

    /**
     * Creates a {@link ObjFloatToFloatFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link FloatUnaryOperator}.
     *
     * @param <T> The type of the first argument to the function
     * @param operator The operator which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjFloatToFloatFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code FloatUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjFloatToFloatFunction<T> onlySecond(@Nonnull FloatUnaryOperator operator) {
        Objects.requireNonNull(operator);
        return (t, value) -> operator.applyAsFloat(value);
    }

    /**
     * Creates a {@link ObjFloatToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjFloatToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjFloatToFloatFunction<T> constant(float ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ToFloatBiFunction<A, B> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b) -> applyAsFloat(before1.apply(a), before2.applyAsFloat(b));
    }
    ...
    default BiBooleanToFloatFunction composeFromBoolean(@Nonnull BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsFloat(before1.apply(value1), before2.applyAsFloat(value2));
    }
     ...
     */
    @Nonnull
    default <S> ObjFloatFunction<T, S> andThen(@Nonnull FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjFloatPredicate<T> andThenToBoolean(@Nonnull FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToByteFunction<T> andThenToByte(@Nonnull FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToCharFunction<T> andThenToChar(@Nonnull FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToDoubleFunction<T> andThenToDouble(@Nonnull FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> andThenToFloat(@Nonnull FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToIntFunction<T> andThenToInt(@Nonnull FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToLongFunction<T> andThenToLong(@Nonnull FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatToShortFunction<T> andThenToShort(@Nonnull FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjFloatConsumer<T> consume(@Nonnull FloatConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.accept(applyAsFloat(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ObjFloatToFloatFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ObjFloatToFloatFunction}.
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<T, Float>, Float> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ObjFloatToFloatFunction<T> & Memoized) (t, value) -> {
                float returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link ObjFloatToFloatFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjFloatToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code ObjFloatToFloatFunction}.
     */
    @Nonnull
    default BiFunction2<T, Float, Float> boxed() {
