...
/**
 * Represents an operation that accepts two {@code int}-valued input arguments and produces a {@code char}-valued
...
@FunctionalInterface
public interface BiIntToCharFunction extends Lambda {

    /**
     * Constructs a {@link BiIntToCharFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiIntToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static BiIntToCharFunction of(@Nullable BiIntToCharFunction expression) {
        return expression;
    }
     ...
     */
    static char call(@Nonnull BiIntToCharFunction function, int value1, int value2) {
     ...
     */
    @Nonnull
    static BiIntToCharFunction onlyFirst(@Nonnull IntToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiIntToCharFunction onlySecond(@Nonnull IntToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B> ToCharBiFunction<A, B> compose(@Nonnull ToIntFunction<? super A> before1,
            @Nonnull ToIntFunction<? super B> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (a, b) -> applyAsChar(before1.applyAsInt(a), before2.applyAsInt(b));
    }
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction composeFromBoolean(@Nonnull BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default BiByteToCharFunction composeFromByte(@Nonnull ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default CharBinaryOperator composeFromChar(@Nonnull CharToIntFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToCharFunction composeFromDouble(@Nonnull DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToCharFunction composeFromFloat(@Nonnull FloatToIntFunction before1,
    ...
    /**
     * Returns a composed {@link BiIntToCharFunction} that first applies the {@code before} operators to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     ...
     */
    @Nonnull
    default BiIntToCharFunction composeFromInt(@Nonnull IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiLongToCharFunction composeFromLong(@Nonnull LongToIntFunction before1,
     ...
     */
    @Nonnull
    default BiShortToCharFunction composeFromShort(@Nonnull ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default <S> BiIntFunction<S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiIntPredicate andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToByteFunction andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToCharFunction andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToDoubleFunction andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToFloatFunction andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntBinaryOperator2 andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToLongFunction andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToShortFunction andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntConsumer consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default BiIntToCharFunction reversed() {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiIntToCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiIntToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiIntToCharFunction}.
     */
    @Nonnull
