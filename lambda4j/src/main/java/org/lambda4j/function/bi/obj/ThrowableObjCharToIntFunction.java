...
public interface ThrowableObjCharToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToIntFunction<T, X> of(
            @Nullable ThrowableObjCharToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjCharToIntFunction<? super T, ? extends X> function, T t, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> applyAsIntThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<T, X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     *
     * @return A composed {@link ObjCharToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjCharToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjCharToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjCharToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjCharToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjCharToIntFunction<? super T> function = recover.apply(throwable);
