...
@FunctionalInterface
public interface BiBooleanToDoubleFunction extends Lambda {

    /**
     * Constructs a {@link BiBooleanToDoubleFunction} based on a lambda expression or a method reference. Thereby the
     * given lambda expression or method reference is returned on an as-is basis to implicitly transform it to the
     * desired type. With this method, it is possible to ensure that correct type is used from lambda expression or
     * method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiBooleanToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static BiBooleanToDoubleFunction of(@Nullable BiBooleanToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    static double call(@Nonnull BiBooleanToDoubleFunction function, boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    static BiBooleanToDoubleFunction onlyFirst(@Nonnull BooleanToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiBooleanToDoubleFunction onlySecond(@Nonnull BooleanToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B> ToDoubleBiFunction2<A, B> compose(@Nonnull Predicate<? super A> before1,
    ...
    /**
     * Returns a composed {@link BiBooleanToDoubleFunction} that first applies the {@code before} operators to its
     ...
     */
    @Nonnull
    default BiBooleanToDoubleFunction composeFromBoolean(@Nonnull BooleanUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction composeFromByte(@Nonnull BytePredicate before1,
     ...
     */
    @Nonnull
    default BiCharToDoubleFunction composeFromChar(@Nonnull CharPredicate before1,
     ...
     */
    @Nonnull
    default DoubleBinaryOperator2 composeFromDouble(@Nonnull DoublePredicate before1,
    ...
    /**
     * Returns a composed {@link BiFloatToDoubleFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default BiFloatToDoubleFunction composeFromFloat(@Nonnull FloatPredicate before1,
     ...
     */
    @Nonnull
    default BiIntToDoubleFunction composeFromInt(@Nonnull IntPredicate before1,
     ...
     */
    @Nonnull
    default BiLongToDoubleFunction composeFromLong(@Nonnull LongPredicate before1,
    ...
    /**
     * Returns a composed {@link BiShortToDoubleFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default BiShortToDoubleFunction composeFromShort(@Nonnull ShortPredicate before1,
     ...
     */
    @Nonnull
    default <S> BiBooleanFunction<S> andThen(@Nonnull DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BooleanBinaryOperator andThenToBoolean(@Nonnull DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToByteFunction andThenToByte(@Nonnull DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction andThenToChar(@Nonnull DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToDoubleFunction andThenToDouble(@Nonnull DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToFloatFunction andThenToFloat(@Nonnull DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToIntFunction andThenToInt(@Nonnull DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction andThenToLong(@Nonnull DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanToShortFunction andThenToShort(@Nonnull DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiBooleanConsumer consume(@Nonnull DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default BiBooleanToDoubleFunction reversed() {
        return (value2, value1) -> applyAsDouble(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link BiBooleanToDoubleFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiBooleanToDoubleFunction}.
    ...
    default BiBooleanToDoubleFunction memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<Boolean, Boolean>, Double> cache = new ConcurrentHashMap<>();
            return (BiBooleanToDoubleFunction & Memoized) (value1, value2) -> {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiBooleanToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiBooleanToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiBooleanToDoubleFunction}.
     */
    @Nonnull
