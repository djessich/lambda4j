...
public interface ThrowableObjByteFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjByteFunction<T, R, X> of(
            @Nullable final ThrowableObjByteFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjByteFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjByteFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjByteFunction<? super T, ? extends R, ? extends X> function, T t,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjByteFunction<T, R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjByteFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjByteFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjByteFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjByteFunction} that applies this function to its input and sneakily throws the
