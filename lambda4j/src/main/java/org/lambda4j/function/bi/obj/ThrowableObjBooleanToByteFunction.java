 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, boolean)
...
@FunctionalInterface
public interface ThrowableObjBooleanToByteFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBooleanToByteFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableObjBooleanToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjBooleanToByteFunction<T, X> of(
            @Nullable ThrowableObjBooleanToByteFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBooleanToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBooleanToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjBooleanToByteFunction<? super T, ? extends X> function, T t,
    ...
    /**
     * Creates a {@link ThrowableObjBooleanToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBooleanToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBooleanToByteFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBooleanToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableBooleanToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBooleanToByteFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableBooleanToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBooleanToByteFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBooleanToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBooleanToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBooleanToByteFunction<T, X> constant(byte ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, boolean value) throws X;
    ...
    default <A, B> ThrowableToByteBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsByteThrows(before1.applyThrows(a), before2.testThrows(b));
    }
    ...
    default ThrowableBiBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsByteThrows(before1.applyThrows(value1), before2.applyAsBooleanThrows(value2));
    }
    ...
    default ThrowableByteBinaryOperator<X> composeFromByte(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsByteThrows(before1.applyThrows(value1), before2.testThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjBooleanConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsByteThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBooleanToByteFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBooleanToByteFunction}.
    ...
    default ThrowableObjBooleanToByteFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Boolean>, Byte> cache = new ConcurrentHashMap<>();
            return (ThrowableObjBooleanToByteFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjBooleanToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBooleanToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjBooleanToByteFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Boolean, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ObjBooleanToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBooleanToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBooleanToByteFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBooleanToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBooleanToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBooleanToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBooleanToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjBooleanToByteFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBooleanToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBooleanToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBooleanToByteFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsByteThrows(t, value);
