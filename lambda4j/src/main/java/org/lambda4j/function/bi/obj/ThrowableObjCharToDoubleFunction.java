...
public interface ThrowableObjCharToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToDoubleFunction<T, X> of(
            @Nullable ThrowableObjCharToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjCharToDoubleFunction<? super T, ? extends X> function, T t, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableCharToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjCharToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjCharToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjCharToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjCharToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjCharToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjCharToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjCharToDoubleFunction<? super T> function = recover.apply(throwable);
