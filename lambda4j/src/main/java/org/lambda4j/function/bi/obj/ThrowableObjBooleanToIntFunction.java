...
public interface ThrowableObjBooleanToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBooleanToIntFunction<T, X> of(
            @Nullable ThrowableObjBooleanToIntFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableObjBooleanConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default ObjBooleanToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBooleanToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjBooleanToIntFunction<? super T> function = recover.apply(throwable);
