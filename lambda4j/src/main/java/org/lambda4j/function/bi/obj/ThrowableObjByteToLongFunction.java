...
public interface ThrowableObjByteToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjByteToLongFunction<T, X> of(
            @Nullable ThrowableObjByteToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjByteToLongFunction<? super T, ? extends X> function, T t, byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableObjBytePredicate<T, X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjByteToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjByteToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjByteToLongFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjByteToLongFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjByteToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjByteToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjByteToLongFunction<? super T> function = recover.apply(throwable);
