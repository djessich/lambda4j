 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, byte) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(Object, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableObjByteToShortFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjByteToShortFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjByteToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjByteToShortFunction<T, X> of(
            @Nullable ThrowableObjByteToShortFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjByteToShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjByteToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> short call(
            @Nonnull ThrowableObjByteToShortFunction<? super T, ? extends X> function, T t, byte value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsShortThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjByteToShortFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjByteToShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjByteToShortFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjByteToShortFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableByteToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjByteToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableByteToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjByteToShortFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjByteToShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjByteToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjByteToShortFunction<T, X> constant(short ret) {
        return (t, value) -> ret;
    }
     ...
     */
    @Nonnull
    default ThrowableByteToShortFunction<X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> applyAsShortThrowsPartially(byte value) {
    ...
    default <A, B> ThrowableToShortBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsShortThrows(before1.applyThrows(a), before2.applyAsByteThrows(b));
    }
    ...
    default ThrowableBiBooleanToShortFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsShortThrows(before1.applyThrows(value1), before2.applyAsByteThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsShortThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjByteToShortFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjByteToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjByteToShortFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<T, Byte>, Short> cache = new ConcurrentHashMap<>();
            return (ThrowableObjByteToShortFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjByteToShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjByteToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjByteToShortFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Byte, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link ObjByteToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjByteToShortFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link ObjByteToShortFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjByteToShortFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjByteToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjByteToShortFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjByteToShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjByteToShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjByteToShortFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsShortThrows(t, value);
