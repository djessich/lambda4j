...
public interface ThrowableObjByteToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjByteToDoubleFunction<T, X> of(
            @Nullable ThrowableObjByteToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjByteToDoubleFunction<? super T, ? extends X> function, T t, byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableByteToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjByteToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjByteToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjByteToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjByteToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjByteToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjByteToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjByteToDoubleFunction<? super T> function = recover.apply(throwable);
