 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, short)
 * specialization of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(Object, short)}.
 *
...
@FunctionalInterface
public interface ThrowableObjShortToDoubleFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjShortToDoubleFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableObjShortToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjShortToDoubleFunction<T, X> of(
            @Nullable ThrowableObjShortToDoubleFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjShortToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjShortToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjShortToDoubleFunction<? super T, ? extends X> function, T t, short value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsDoubleThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjShortToDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjShortToDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToDoubleFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjShortToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableShortToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjShortToDoubleFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableShortToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToDoubleFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjShortToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjShortToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToDoubleFunction<T, X> constant(double ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, short value) throws X;
     ...
     */
    @Nonnull
    default ThrowableShortToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(short value) {
    ...
    default <A, B> ThrowableToDoubleBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsDoubleThrows(before1.applyThrows(a), before2.applyAsShortThrows(b));
    }
    ...
    default ThrowableBiBooleanToDoubleFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsDoubleThrows(before1.applyThrows(value1), before2.applyAsShortThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsDoubleThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjShortToDoubleFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjShortToDoubleFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjShortToDoubleFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<T, Short>, Double> cache = new ConcurrentHashMap<>();
            return (ThrowableObjShortToDoubleFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjShortToDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjShortToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjShortToDoubleFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Short, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link ObjShortToDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjShortToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjShortToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortToDoubleFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjShortToDoubleFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjShortToDoubleFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjShortToDoubleFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsDoubleThrows(t, value);
