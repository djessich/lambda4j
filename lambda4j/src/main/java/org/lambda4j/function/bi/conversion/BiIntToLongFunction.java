...
/**
 * Represents an operation that accepts two {@code int}-valued input arguments and produces a {@code long}-valued
...
@FunctionalInterface
public interface BiIntToLongFunction extends Lambda {

    /**
     * Constructs a {@link BiIntToLongFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiIntToLongFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static BiIntToLongFunction of(@Nullable BiIntToLongFunction expression) {
        return expression;
    }
     ...
     */
    static long call(@Nonnull BiIntToLongFunction function, int value1, int value2) {
     ...
     */
    @Nonnull
    static BiIntToLongFunction onlyFirst(@Nonnull IntToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiIntToLongFunction onlySecond(@Nonnull IntToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default IntToLongFunction2 applyAsLongPartially(int value1) {
     ...
     */
    @Nonnull
    default <A, B> ToLongBiFunction2<A, B> compose(@Nonnull ToIntFunction<? super A> before1,
            @Nonnull ToIntFunction<? super B> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (a, b) -> applyAsLong(before1.applyAsInt(a), before2.applyAsInt(b));
    }
     ...
     */
    @Nonnull
    default BiBooleanToLongFunction composeFromBoolean(@Nonnull BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default BiByteToLongFunction composeFromByte(@Nonnull ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default BiCharToLongFunction composeFromChar(@Nonnull CharToIntFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToLongFunction composeFromDouble(@Nonnull DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToLongFunction composeFromFloat(@Nonnull FloatToIntFunction before1,
    ...
    /**
     * Returns a composed {@link BiIntToLongFunction} that first applies the {@code before} operators to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     ...
     */
    @Nonnull
    default BiIntToLongFunction composeFromInt(@Nonnull IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default LongBinaryOperator2 composeFromLong(@Nonnull LongToIntFunction before1,
     ...
     */
    @Nonnull
    default BiShortToLongFunction composeFromShort(@Nonnull ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default <S> BiIntFunction<S> andThen(@Nonnull LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiIntPredicate andThenToBoolean(@Nonnull LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToByteFunction andThenToByte(@Nonnull LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToCharFunction andThenToChar(@Nonnull LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToDoubleFunction andThenToDouble(@Nonnull LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToFloatFunction andThenToFloat(@Nonnull LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntBinaryOperator2 andThenToInt(@Nonnull LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToLongFunction andThenToLong(@Nonnull LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntToShortFunction andThenToShort(@Nonnull LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiIntConsumer consume(@Nonnull LongConsumer consumer) {
     ...
     */
    @Nonnull
    default BiIntToLongFunction reversed() {
    ...
    default BiIntToLongFunction memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<Integer, Integer>, Long> cache = new ConcurrentHashMap<>();
     ...
     * BiIntToLongFunction} with methods provided by the {@code JDK}.
     *
