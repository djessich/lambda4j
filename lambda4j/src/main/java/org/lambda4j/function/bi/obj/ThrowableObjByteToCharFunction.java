 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, byte) specialization
...
public interface ThrowableObjByteToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjByteToCharFunction<T, X> of(
            @Nullable ThrowableObjByteToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjByteToCharFunction<? super T, ? extends X> function, T t, byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableByteToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableObjBytePredicate<T, X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjByteToCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjByteToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjByteToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjByteToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjByteToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjByteToCharFunction<? super T> function = recover.apply(throwable);
