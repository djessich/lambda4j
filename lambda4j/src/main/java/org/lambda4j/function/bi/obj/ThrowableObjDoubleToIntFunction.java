...
public interface ThrowableObjDoubleToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToIntFunction<T, X> of(
            @Nullable ThrowableObjDoubleToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjDoubleToIntFunction<? super T, ? extends X> function, T t, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default ThrowableObjDoubleToIntFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Double>, Integer> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ObjDoubleToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjDoubleToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoubleToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoubleToIntFunction<? super T> function = recover.apply(throwable);
