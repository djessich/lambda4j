 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, long) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjLongToByteFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjLongToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjLongToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjLongToByteFunction<T, X> of(
            @Nullable ThrowableObjLongToByteFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjLongToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjLongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjLongToByteFunction<? super T, ? extends X> function, T t, long value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsByteThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjLongToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjLongToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToByteFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjLongToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableLongToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjLongToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToByteFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjLongToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjLongToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToByteFunction<T, X> constant(byte ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ThrowableToByteBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsByteThrows(before1.applyThrows(a), before2.applyAsLongThrows(b));
    }
    ...
    default ThrowableBiBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsByteThrows(before1.applyThrows(value1), before2.applyAsLongThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsByteThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjLongToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjLongToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjLongToByteFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, Long, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ObjLongToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjLongToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjLongToByteFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjLongToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjLongToByteFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjLongToByteFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjLongToByteFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjLongToByteFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsByteThrows(t, value);
