...
public interface ThrowableObjCharToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToLongFunction<T, X> of(
            @Nullable ThrowableObjCharToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjCharToLongFunction<? super T, ? extends X> function, T t, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableObjCharPredicate<T, X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjCharToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjCharToLongFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link ObjCharToLongFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjCharToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjCharToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjCharToLongFunction<? super T> function = recover.apply(throwable);
