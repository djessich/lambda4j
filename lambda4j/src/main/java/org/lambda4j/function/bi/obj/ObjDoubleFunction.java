...
public interface ObjDoubleFunction<T, R> extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static <T, R> ObjDoubleFunction<T, R> of(@Nullable ObjDoubleFunction<T, R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ObjDoubleFunction} into a total {@link ObjDoubleFunction} that returns an {@link Optional}
     * result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ObjDoubleFunction} lifted into a total {@code ObjDoubleFunction} that returns an {@code
     * Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R> ObjDoubleFunction<T, Optional<R>> lift(
            @Nonnull ObjDoubleFunction<? super T, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, R> R call(@Nonnull ObjDoubleFunction<? super T, ? extends R> function, T t, double value) {
     ...
     */
    @Nonnull
    static <T, R> ObjDoubleFunction<T, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjDoubleFunction<T, R> onlySecond(@Nonnull DoubleFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <S> ObjDoubleFunction<T, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default ObjDoubleConsumer2<T> consume(@Nonnull Consumer<? super R> consumer) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link ObjDoubleFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code ObjDoubleFunction}.
     */
    @Nonnull
    default BiFunction2<T, Double, R> boxed() {
        return this::apply;
    }
