 ...
 * result. This is a (reference, long) specialization of {@link BiFunction2}.
 * <p>
...
@FunctionalInterface
public interface ObjLongFunction<T, R> extends Lambda {

    /**
     * Constructs a {@link ObjLongFunction} based on a lambda expression or a method reference. Thereby the given lambda
     ...
     * @return A {@code ObjLongFunction} from given lambda expression or method reference.
     ...
     */
    static <T, R> ObjLongFunction<T, R> of(@Nullable ObjLongFunction<T, R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ObjLongFunction} into a total {@link ObjLongFunction} that returns an {@link Optional}
     * result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ObjLongFunction} lifted into a total {@code ObjLongFunction} that returns an {@code
     * Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R> ObjLongFunction<T, Optional<R>> lift(@Nonnull ObjLongFunction<? super T, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, R> R call(@Nonnull ObjLongFunction<? super T, ? extends R> function, T t, long value) {
     ...
     */
    @Nonnull
    static <T, R> ObjLongFunction<T, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjLongFunction<T, R> onlySecond(@Nonnull LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjLongFunction<T, R> constant(R ret) {
        return (t, value) -> ret;
    }
     ...
     */
    @Nonnull
    default <S> ObjLongFunction<T, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default ObjLongConsumer2<T> consume(@Nonnull Consumer<? super R> consumer) {
    ...
    @Deprecated
    @Nonnull
    default ObjLongFunction<T, Optional<R>> nonNull() {
        return (t, value) -> Optional.ofNullable(apply(t, value));
    }

    /**
     * Returns a composed {@link BiFunction2} which represents this {@link ObjLongFunction}. Thereby the primitive input
     * argument for this function is autoboxed. This method provides the possibility to use this {@code ObjLongFunction}
     * with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code ObjLongFunction}.
     */
    @Nonnull
    default BiFunction2<T, Long, R> boxed() {
        return this::apply;
    }
