...
public interface ObjLongFunction<T, R> extends Lambda {
     ...
     */
    static <T, R> ObjLongFunction<T, R> of(@Nullable final ObjLongFunction<T, R> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <T, R> ObjLongFunction<T, Optional<R>> lift(@Nonnull final ObjLongFunction<? super T, ? extends R> partial) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link ObjLongFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ObjLongFunction} with methods provided by the {@code JDK}.
     *
