...
public interface ThrowableBiCharToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiCharToFloatFunction<X> of(
            @Nullable ThrowableBiCharToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull ThrowableBiCharToFloatFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableCharToFloatFunction<X> applyAsFloatThrowsPartially(char value1) {
     ...
     */
    @Nonnull
    default ThrowableBiCharPredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiCharConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiCharToFloatFunction<X> reversed() {
     ...
     */
    @Nonnull
    default BiCharToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiCharToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiCharToFloatFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiCharToFloatFunction function = recover.apply(throwable);
