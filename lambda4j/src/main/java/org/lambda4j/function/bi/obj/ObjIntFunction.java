...
public interface ObjIntFunction<T, R> extends Lambda {
     ...
     */
    static <T, R> ObjIntFunction<T, R> of(@Nullable final ObjIntFunction<T, R> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    static <T, R> ObjIntFunction<T, Optional<R>> lift(@Nonnull final ObjIntFunction<? super T, ? extends R> partial) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link ObjIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ObjIntFunction} with methods provided by the {@code JDK}.
     *
