 ...
 * result. This is a (reference, int) specialization of {@link BiFunction2}.
 * <p>
...
@FunctionalInterface
public interface ObjIntFunction<T, R> extends Lambda {

    /**
     * Constructs a {@link ObjIntFunction} based on a lambda expression or a method reference. Thereby the given lambda
     ...
     * @return A {@code ObjIntFunction} from given lambda expression or method reference.
     ...
     */
    static <T, R> ObjIntFunction<T, R> of(@Nullable ObjIntFunction<T, R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ObjIntFunction} into a total {@link ObjIntFunction} that returns an {@link Optional}
     * result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ObjIntFunction} lifted into a total {@code ObjIntFunction} that returns an {@code
     * Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R> ObjIntFunction<T, Optional<R>> lift(@Nonnull ObjIntFunction<? super T, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, R> R call(@Nonnull ObjIntFunction<? super T, ? extends R> function, T t, int value) {
     ...
     */
    @Nonnull
    static <T, R> ObjIntFunction<T, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjIntFunction<T, R> onlySecond(@Nonnull IntFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjIntFunction<T, R> constant(R ret) {
        return (t, value) -> ret;
    }
     ...
     */
    @Nonnull
    default <S> ObjIntFunction<T, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default ObjIntConsumer2<T> consume(@Nonnull Consumer<? super R> consumer) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link ObjIntFunction}. Thereby the primitive input
     * argument for this function is autoboxed. This method provides the possibility to use this {@code ObjIntFunction}
     * with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code ObjIntFunction}.
     */
    @Nonnull
    default BiFunction2<T, Integer, R> boxed() {
        return this::apply;
    }
