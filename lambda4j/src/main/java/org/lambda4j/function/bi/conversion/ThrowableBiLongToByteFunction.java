...
public interface ThrowableBiLongToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiLongToByteFunction<X> of(
            @Nullable ThrowableBiLongToByteFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> byte call(@Nonnull ThrowableBiLongToByteFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiLongPredicate<X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiLongToIntFunction<X> andThenToInt(@Nonnull ThrowableByteToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiLongToByteFunction<X> reversed() {
     ...
     * this {@code ThrowableBiLongToByteFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiLongToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiLongToByteFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiLongToByteFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiLongToByteFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiLongToByteFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiLongToByteFunction function = recover.apply(throwable);
