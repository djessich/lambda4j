...
/**
 * Represents an operation that accepts two {@code byte}-valued input arguments and produces a {@code int}-valued
...
@FunctionalInterface
public interface BiByteToIntFunction extends Lambda {

    /**
     * Constructs a {@link BiByteToIntFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiByteToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static BiByteToIntFunction of(@Nullable BiByteToIntFunction expression) {
        return expression;
    }
     ...
     */
    static int call(@Nonnull BiByteToIntFunction function, byte value1, byte value2) {
     ...
     */
    @Nonnull
    static BiByteToIntFunction onlyFirst(@Nonnull ByteToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiByteToIntFunction onlySecond(@Nonnull ByteToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B> ToIntBiFunction2<A, B> compose(@Nonnull ToByteFunction<? super A> before1,
            @Nonnull ToByteFunction<? super B> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (a, b) -> applyAsInt(before1.applyAsByte(a), before2.applyAsByte(b));
    }
     ...
     */
    @Nonnull
    default BiBooleanToIntFunction composeFromBoolean(@Nonnull BooleanToByteFunction before1,
    ...
    /**
     * Returns a composed {@link BiByteToIntFunction} that first applies the {@code before} operators to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     ...
     * @return A composed {@code BiByteToIntFunction} that first applies the {@code before} operators to its input, and
     * then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default BiByteToIntFunction composeFromByte(@Nonnull ByteUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiCharToIntFunction composeFromChar(@Nonnull CharToByteFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction composeFromDouble(@Nonnull DoubleToByteFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToIntFunction composeFromFloat(@Nonnull FloatToByteFunction before1,
     ...
     */
    @Nonnull
    default IntBinaryOperator2 composeFromInt(@Nonnull IntToByteFunction before1,
     ...
     */
    @Nonnull
    default BiLongToIntFunction composeFromLong(@Nonnull LongToByteFunction before1,
     ...
     */
    @Nonnull
    default BiShortToIntFunction composeFromShort(@Nonnull ShortToByteFunction before1,
     ...
     */
    @Nonnull
    default <S> BiByteFunction<S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiBytePredicate andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteBinaryOperator andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToCharFunction andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToFloatFunction andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToIntFunction andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToLongFunction andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToShortFunction andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteConsumer consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default BiByteToIntFunction reversed() {
        return (value2, value1) -> applyAsInt(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link BiByteToIntFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiByteToIntFunction}.
     ...
     */
    @Nonnull
    default BiByteToIntFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<Byte, Byte>, Integer> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (BiByteToIntFunction & Memoized) (value1, value2) -> {
                int returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiByteToIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiByteToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiByteToIntFunction}.
     */
    @Nonnull
    default BiFunction2<Byte, Byte, Integer> boxed() {
