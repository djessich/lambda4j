 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, double) specialization
...
public interface ThrowableObjDoubleToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToByteFunction<T, X> of(
            @Nullable ThrowableObjDoubleToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjDoubleToByteFunction<? super T, ? extends X> function, T t, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableDoubleToByteFunction<X> applyAsByteThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> applyAsByteThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
    ...
    default ThrowableObjDoubleToByteFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Double>, Byte> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ObjDoubleToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjDoubleToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoubleToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoubleToByteFunction<? super T> function = recover.apply(throwable);
