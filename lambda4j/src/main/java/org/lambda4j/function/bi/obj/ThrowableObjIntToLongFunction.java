...
public interface ThrowableObjIntToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntToLongFunction<T, X> of(
            @Nullable ThrowableObjIntToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjIntToLongFunction<? super T, ? extends X> function, T t, int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<T, X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjIntToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjIntToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjIntToLongFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjIntToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjIntToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjIntToLongFunction<? super T> function = recover.apply(throwable);
