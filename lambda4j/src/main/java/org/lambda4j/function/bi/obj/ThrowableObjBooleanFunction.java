...
public interface ThrowableObjBooleanFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBooleanFunction<T, R, X> of(
            @Nullable ThrowableObjBooleanFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjBooleanFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjBooleanFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjBooleanFunction<? super T, ? extends R, ? extends X> function, T t,
    ...
    default ThrowableObjBooleanFunction<T, R, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Boolean>, R> cache = new ConcurrentHashMap<>();
    ...
    default ObjBooleanFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBooleanFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjBooleanFunction<? super T, ? extends R> function = recover.apply(throwable);
