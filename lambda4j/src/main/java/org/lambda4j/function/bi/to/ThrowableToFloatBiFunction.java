...
@FunctionalInterface
public interface ThrowableToFloatBiFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableToFloatBiFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableToFloatBiFunction} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link ThrowableToFloatBiFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableToFloatBiFunction}.
    ...
    /**
     * Creates a {@link ThrowableToFloatBiFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableToFloatBiFunction} which uses the {@code first} parameter of this one as
    ...
    /**
     * Creates a {@link ThrowableToFloatBiFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableToFloatBiFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    ...
    /**
     * Creates a {@link ThrowableToFloatBiFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableToFloatBiFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableToFloatBiFunction<T, U, X> constant(float ret) {
        return (t, u) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(T t, U u) throws X;
     ...
     */
    default float applyAsFloatThrows(@Nonnull Pair<T, U> tuple) throws X {
        Objects.requireNonNull(tuple);
        return applyAsFloatThrows(tuple.getLeft(), tuple.getRight());
    }
    ...
    default ThrowableBiBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsFloatThrows(before1.applyThrows(value1), before2.applyThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<Pair<T, U>, X> tupled() {
     ...
     */
    @Nonnull
    default ThrowableToFloatBiFunction<U, T, X> reversed() {
        return (u, t) -> applyAsFloatThrows(t, u);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableToFloatBiFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableToFloatBiFunction}.
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableToFloatBiFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableToFloatBiFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableToFloatBiFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, U, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link ToFloatBiFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ToFloatBiFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ToFloatBiFunction<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ToFloatBiFunction} that first applies this function to its input, and then applies the
    ...
    /**
     * Returns a composed {@link ToFloatBiFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ToFloatBiFunction} that applies this function to its input and sneakily throws the
