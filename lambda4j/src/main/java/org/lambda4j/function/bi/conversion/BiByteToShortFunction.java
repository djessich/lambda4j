...
@FunctionalInterface
public interface BiByteToShortFunction extends Lambda {

    /**
     * Constructs a {@link BiByteToShortFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiByteToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static BiByteToShortFunction of(@Nullable BiByteToShortFunction expression) {
        return expression;
    }
     ...
     */
    static short call(@Nonnull BiByteToShortFunction function, byte value1, byte value2) {
     ...
     */
    @Nonnull
    static BiByteToShortFunction onlyFirst(@Nonnull ByteToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiByteToShortFunction onlySecond(@Nonnull ByteToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B> ToShortBiFunction<A, B> compose(@Nonnull ToByteFunction<? super A> before1,
            @Nonnull ToByteFunction<? super B> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (a, b) -> applyAsShort(before1.applyAsByte(a), before2.applyAsByte(b));
    }
     ...
     */
    @Nonnull
    default BiBooleanToShortFunction composeFromBoolean(@Nonnull BooleanToByteFunction before1,
    ...
    /**
     * Returns a composed {@link BiByteToShortFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code BiByteToShortFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default BiByteToShortFunction composeFromByte(@Nonnull ByteUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiCharToShortFunction composeFromChar(@Nonnull CharToByteFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToShortFunction composeFromDouble(@Nonnull DoubleToByteFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToShortFunction composeFromFloat(@Nonnull FloatToByteFunction before1,
     ...
     */
    @Nonnull
    default BiIntToShortFunction composeFromInt(@Nonnull IntToByteFunction before1,
     ...
     */
    @Nonnull
    default BiLongToShortFunction composeFromLong(@Nonnull LongToByteFunction before1,
     ...
     */
    @Nonnull
    default ShortBinaryOperator composeFromShort(@Nonnull ShortToByteFunction before1,
     ...
     */
    @Nonnull
    default <S> BiByteFunction<S> andThen(@Nonnull ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiBytePredicate andThenToBoolean(@Nonnull ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteBinaryOperator andThenToByte(@Nonnull ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToCharFunction andThenToChar(@Nonnull ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction andThenToDouble(@Nonnull ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToFloatFunction andThenToFloat(@Nonnull ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToIntFunction andThenToInt(@Nonnull ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToLongFunction andThenToLong(@Nonnull ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteToShortFunction andThenToShort(@Nonnull ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiByteConsumer consume(@Nonnull ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default BiByteToShortFunction reversed() {
        return (value2, value1) -> applyAsShort(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link BiByteToShortFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiByteToShortFunction}.
     ...
     */
    @Nonnull
    default BiByteToShortFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<Byte, Byte>, Short> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (BiByteToShortFunction & Memoized) (value1, value2) -> {
                short returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiByteToShortFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiByteToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiByteToShortFunction}.
     */
    @Nonnull
    default BiFunction2<Byte, Byte, Short> boxed() {
