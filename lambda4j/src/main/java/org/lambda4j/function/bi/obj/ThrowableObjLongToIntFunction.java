...
public interface ThrowableObjLongToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToIntFunction<T, X> of(
            @Nullable ThrowableObjLongToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjLongToIntFunction<? super T, ? extends X> function, T t, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> applyAsIntThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjLongToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjLongToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjLongToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjLongToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjLongToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjLongToIntFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjLongToIntFunction<? super T> function = recover.apply(throwable);
