...
public interface ThrowableObjIntToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntToDoubleFunction<T, X> of(
            @Nullable ThrowableObjIntToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjIntToDoubleFunction<? super T, ? extends X> function, T t, int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableIntToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(int value) {
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
    ...
    default ObjIntToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjIntToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjIntToDoubleFunction<? super T> function = recover.apply(throwable);
