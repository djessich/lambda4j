...
public interface ThrowableObjIntFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjIntFunction<T, R, X> of(
            @Nullable ThrowableObjIntFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjIntFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjIntFunction<? super T, ? extends R, ? extends X> partial) {
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    default ThrowableObjIntFunction<T, R, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Integer>, R> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ObjIntFunction<T, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjIntFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjIntFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjIntFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjIntFunction} that applies this function to its input and sneakily throws the thrown
