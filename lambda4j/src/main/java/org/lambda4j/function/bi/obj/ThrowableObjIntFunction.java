 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, int)}.
 *
...
@FunctionalInterface
public interface ThrowableObjIntFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjIntFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjIntFunction} from given lambda expression or method reference.
     ...
     */
    static <T, R, X extends Throwable> ThrowableObjIntFunction<T, R, X> of(
            @Nullable final ThrowableObjIntFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjIntFunction} into a total {@link ThrowableObjIntFunction} that returns an
     ...
     * @return A partial {@code ThrowableObjIntFunction} lifted into a total {@code ThrowableObjIntFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjIntFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjIntFunction<? super T, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, value) -> Optional.ofNullable(partial.applyThrows(t, value));
    }

    /**
     * Calls the given {@link ThrowableObjIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjIntFunction<? super T, ? extends R, ? extends X> function, T t, int value) throws
            X {
    ...
    /**
     * Creates a {@link ThrowableObjIntFunction} which uses the {@code first} parameter of this one as argument for the
     ...
     * @return Creates a {@code ThrowableObjIntFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjIntFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjIntFunction} which uses the {@code second} parameter of this one as argument for the
     ...
     * @return Creates a {@code ThrowableObjIntFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ThrowableIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjIntFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjIntFunction<T, R, X> constant(R ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, int value) throws X;
    ...
    default <A, B> ThrowableBiFunction<A, B, R, X> compose(
        ...
        return (a, b) -> applyThrows(before1.applyThrows(a), before2.applyAsIntThrows(b));
    }
    ...
    default ThrowableBiBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyThrows(before1.applyThrows(value1), before2.applyAsIntThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjIntFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Integer, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjIntFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjIntFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjIntFunction<T, R> nest() {
     ...
     */
    @Nonnull
    default ObjIntFunction<T, R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjIntFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjIntFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjIntFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjIntFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjIntFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjIntFunction} that applies this function to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjIntFunction<T, R> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.applyThrows(t, value);
