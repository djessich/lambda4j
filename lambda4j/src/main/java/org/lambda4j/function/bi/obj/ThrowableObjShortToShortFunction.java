 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, short) specialization
...
public interface ThrowableObjShortToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToShortFunction<T, X> of(
            @Nullable ThrowableObjShortToShortFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjShortToShortFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjShortToShortFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortToShortFunction<? super T> function = recover.apply(throwable);
