...
public interface ThrowableBiLongToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiLongToShortFunction<X> of(
            @Nullable final ThrowableBiLongToShortFunction<X> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ThrowableBiLongToShortFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default BiLongToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiLongToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiLongToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiLongToShortFunction function = recover.apply(throwable);
