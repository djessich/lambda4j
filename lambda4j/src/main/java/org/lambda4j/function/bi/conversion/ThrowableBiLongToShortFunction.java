...
public interface ThrowableBiLongToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiLongToShortFunction<X> of(
            @Nullable ThrowableBiLongToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull ThrowableBiLongToShortFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiLongPredicate<X> andThenToBoolean(@Nonnull ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiLongToShortFunction<X> reversed() {
     ...
     * this {@code ThrowableBiLongToShortFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiLongToShortFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiLongToShortFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiLongToShortFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiLongToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiLongToShortFunction function = recover.apply(throwable);
