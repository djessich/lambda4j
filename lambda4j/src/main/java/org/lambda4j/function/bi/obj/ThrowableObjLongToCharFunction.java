 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, long) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjLongToCharFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjLongToCharFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjLongToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjLongToCharFunction<T, X> of(
            @Nullable ThrowableObjLongToCharFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjLongToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjLongToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjLongToCharFunction<? super T, ? extends X> function, T t, long value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsCharThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjLongToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjLongToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToCharFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjLongToCharFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableLongToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjLongToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToCharFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjLongToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjLongToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjLongToCharFunction<T, X> constant(char ret) {
        return (t, value) -> ret;
    }
     ...
     */
    @Nonnull
    default ThrowableLongToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(long value) {
    ...
    default <A, B> ThrowableToCharBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsCharThrows(before1.applyThrows(a), before2.applyAsLongThrows(b));
    }
    ...
    default ThrowableBiBooleanToCharFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsCharThrows(before1.applyThrows(value1), before2.applyAsLongThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjLongPredicate<T, X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsCharThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjLongToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjLongToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjLongToCharFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<T, Long>, Character> cache = new ConcurrentHashMap<>();
            return (ThrowableObjLongToCharFunction<T, X> & Memoized) (t, value) -> {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, Long, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link ObjLongToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjLongToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjLongToCharFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjLongToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjLongToCharFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjLongToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjLongToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjLongToCharFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjLongToCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjLongToCharFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjLongToCharFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsCharThrows(t, value);
