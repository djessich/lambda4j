...
public interface BiDoubleToIntFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static BiDoubleToIntFunction of(@Nullable BiDoubleToIntFunction expression) {
        return expression;
    }
     ...
     */
    static int call(@Nonnull BiDoubleToIntFunction function, double value1, double value2) {
     ...
     */
    @Nonnull
    static BiDoubleToIntFunction onlyFirst(@Nonnull DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiDoubleToIntFunction onlySecond(@Nonnull DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default DoubleToIntFunction2 applyAsIntPartially(double value1) {
     ...
     */
    @Nonnull
    default <A, B> ToIntBiFunction2<A, B> compose(@Nonnull ToDoubleFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToIntFunction composeFromBoolean(@Nonnull BooleanToDoubleFunction before1,
     ...
     */
    @Nonnull
    default BiByteToIntFunction composeFromByte(@Nonnull ByteToDoubleFunction before1,
     ...
     */
    @Nonnull
    default BiCharToIntFunction composeFromChar(@Nonnull CharToDoubleFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction composeFromDouble(@Nonnull DoubleUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiFloatToIntFunction composeFromFloat(@Nonnull FloatToDoubleFunction before1,
     ...
     */
    @Nonnull
    default IntBinaryOperator2 composeFromInt(@Nonnull IntToDoubleFunction before1,
     ...
     */
    @Nonnull
    default BiLongToIntFunction composeFromLong(@Nonnull LongToDoubleFunction before1,
     ...
     */
    @Nonnull
    default BiShortToIntFunction composeFromShort(@Nonnull ShortToDoubleFunction before1,
     ...
     */
    @Nonnull
    default <S> BiDoubleFunction<S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiDoublePredicate andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiDoubleToByteFunction andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiDoubleToCharFunction andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleBinaryOperator2 andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiDoubleToFloatFunction andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiDoubleToLongFunction andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiDoubleToShortFunction andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiDoubleConsumer consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction reversed() {
     ...
     * BiDoubleToIntFunction} with methods provided by the {@code JDK}.
     *
