...
public interface ThrowableObjFloatFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjFloatFunction<T, R, X> of(
            @Nullable ThrowableObjFloatFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjFloatFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjFloatFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjFloatFunction<? super T, ? extends R, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableObjFloatConsumer<T, X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    default ObjFloatFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjFloatFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjFloatFunction<? super T, ? extends R> function = recover.apply(throwable);
