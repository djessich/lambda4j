...
/**
 * Represents an operation that accepts two input arguments and produces a {@code byte}-valued result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, Object)}.
 *
...
@FunctionalInterface
public interface ThrowableToByteBiFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableToByteBiFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableToByteBiFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableToByteBiFunction<T, U, X> of(
            @Nullable ThrowableToByteBiFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableToByteBiFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableToByteBiFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> byte call(
            @Nonnull ThrowableToByteBiFunction<? super T, ? super U, ? extends X> function, T t, U u) throws X {
        Objects.requireNonNull(function);
        return function.applyAsByteThrows(t, u);
    }

    /**
     * Creates a {@link ThrowableToByteBiFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableToByteBiFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableToByteBiFunction<T, U, X> onlyFirst(
            @Nonnull ThrowableToByteFunction<? super T, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u) -> function.applyAsByteThrows(t);
    }

    /**
     * Creates a {@link ThrowableToByteBiFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableToByteBiFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableToByteBiFunction<T, U, X> onlySecond(
            @Nonnull ThrowableToByteFunction<? super U, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u) -> function.applyAsByteThrows(u);
    }

    /**
     * Creates a {@link ThrowableToByteBiFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableToByteBiFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableToByteBiFunction<T, U, X> constant(byte ret) {
        return (t, u) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, U u) throws X;
     ...
     */
    default byte applyAsByteThrows(@Nonnull Pair<T, U> tuple) throws X {
        Objects.requireNonNull(tuple);
        return applyAsByteThrows(tuple.getLeft(), tuple.getRight());
    }
    ...
    default <A, B> ThrowableToByteBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsByteThrows(before1.applyThrows(a), before2.applyThrows(b));
    }
    ...
    default ThrowableBiBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsByteThrows(before1.applyThrows(value1), before2.applyThrows(value2));
    }
    ...
    default <S> ThrowableBiFunction<T, U, S, X> andThen(
        ...
        return (t, u) -> after.applyThrows(applyAsByteThrows(t, u));
    }
     ...
     */
    @Nonnull
    default ThrowableBiPredicate<T, U, X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
        return (t, u) -> after.testThrows(applyAsByteThrows(t, u));
    }
    ...
    default ThrowableToByteBiFunction<T, U, X> andThenToByte(
        ...
        Objects.requireNonNull(after);
        return (t, u) -> after.applyAsByteThrows(applyAsByteThrows(t, u));
    }
    ...
    default ThrowableToCharBiFunction<T, U, X> andThenToChar(
        ...
        Objects.requireNonNull(after);
        return (t, u) -> after.applyAsCharThrows(applyAsByteThrows(t, u));
    }
    ...
    default ThrowableToDoubleBiFunction<T, U, X> andThenToDouble(
        ...
        Objects.requireNonNull(after);
        return (t, u) -> after.applyAsDoubleThrows(applyAsByteThrows(t, u));
    }
    ...
    default ThrowableToFloatBiFunction<T, U, X> andThenToFloat(
        ...
        Objects.requireNonNull(after);
        return (t, u) -> after.applyAsFloatThrows(applyAsByteThrows(t, u));
    }
    ...
    default ThrowableToIntBiFunction<T, U, X> andThenToInt(
        ...
        Objects.requireNonNull(after);
        return (t, u) -> after.applyAsIntThrows(applyAsByteThrows(t, u));
    }
    ...
    default ThrowableToLongBiFunction<T, U, X> andThenToLong(
        ...
        Objects.requireNonNull(after);
        return (t, u) -> after.applyAsLongThrows(applyAsByteThrows(t, u));
    }
    ...
    default ThrowableToShortBiFunction<T, U, X> andThenToShort(
        ...
        Objects.requireNonNull(after);
        return (t, u) -> after.applyAsShortThrows(applyAsByteThrows(t, u));
    }
     ...
     */
    @Nonnull
    default ThrowableBiConsumer<T, U, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, u) -> consumer.acceptThrows(applyAsByteThrows(t, u));
    }
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<Pair<T, U>, X> tupled() {
     ...
     */
    @Nonnull
    default ThrowableToByteBiFunction<U, T, X> reversed() {
        return (u, t) -> applyAsByteThrows(t, u);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableToByteBiFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableToByteBiFunction}.
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableToByteBiFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableToByteBiFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableToByteBiFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, U, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ToByteBiFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ToByteBiFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ToByteBiFunction<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ToByteBiFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ToByteBiFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends ToByteBiFunction<? super T, ? super U>> recover) {
        Objects.requireNonNull(recover);
        return (t, u) -> {
            try {
                return applyAsByteThrows(t, u);
            } catch (Error e) {
                throw e;
            } catch (Throwable throwable) {
                ToByteBiFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ToByteBiFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ToByteBiFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ToByteBiFunction<T, U> sneakyThrow() {
        return (t, u) -> {
            try {
                return applyAsByteThrows(t, u);
