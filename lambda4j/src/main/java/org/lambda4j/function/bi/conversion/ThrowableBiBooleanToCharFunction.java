...
/**
 * Represents an operation that accepts two {@code boolean}-valued input arguments and produces a {@code char}-valued
 * result which is able to throw any {@link Throwable}. This is a primitive specialization of {@link
 * ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(boolean, boolean)}.
 *
...
@FunctionalInterface
public interface ThrowableBiBooleanToCharFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiBooleanToCharFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiBooleanToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiBooleanToCharFunction<X> of(
            @Nullable ThrowableBiBooleanToCharFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiBooleanToCharFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code ThrowableBiBooleanToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> char call(@Nonnull ThrowableBiBooleanToCharFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiBooleanToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableBooleanToCharFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiBooleanToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableBooleanToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiBooleanToCharFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiBooleanToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableBooleanToCharFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiBooleanToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableBooleanToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiBooleanToCharFunction<X> onlySecond(
            @Nonnull ThrowableBooleanToCharFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiBooleanToCharFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiBooleanToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiBooleanToCharFunction<X> constant(char ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(boolean value1, boolean value2) throws X;
    ...
    /**
     * Returns a composed {@link ThrowableToCharBiFunction} that first applies the {@code before} predicates to its
     ...
     * @return A composed {@code ThrowableToCharBiFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
    ...
    default <A, B> ThrowableToCharBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsCharThrows(before1.testThrows(a), before2.testThrows(b));
    }

    /**
     * Returns a composed {@link ThrowableBiBooleanToCharFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result. This method is just convenience, to provide the ability
     * to execute an operation which accepts {@code boolean} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiBooleanToCharFunction} that first applies the {@code before} operators to
    ...
    default ThrowableBiBooleanToCharFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsCharThrows(before1.applyAsBooleanThrows(value1),
                before2.applyAsBooleanThrows(value2));
    }

    /**
     * Returns a composed {@link ThrowableBiByteToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code byte} input, before this primitive function is executed.
     *
     * @param before1 The first predicate to apply before this function is applied
     * @param before2 The second predicate to apply before this function is applied
     * @return A composed {@code ThrowableBiByteToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default ThrowableBiByteToCharFunction<X> composeFromByte(@Nonnull ThrowableBytePredicate<? extends X> before1,
            @Nonnull ThrowableBytePredicate<? extends X> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsCharThrows(before1.testThrows(value1), before2.testThrows(value2));
    }

    /**
     * Returns a composed {@link ThrowableCharBinaryOperator} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code char} input, before this primitive function is executed.
     *
     * @param before1 The first predicate to apply before this function is applied
     * @param before2 The second predicate to apply before this function is applied
     * @return A composed {@code ThrowableCharBinaryOperator} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * char}.
     */
    @Nonnull
    default ThrowableCharBinaryOperator<X> composeFromChar(@Nonnull ThrowableCharPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiDoubleToCharFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result. This method is just convenience, to provide the ability
     * to execute an operation which accepts {@code double} input, before this primitive function is executed.
     *
     * @param before1 The first predicate to apply before this function is applied
     * @param before2 The second predicate to apply before this function is applied
     * @return A composed {@code ThrowableBiDoubleToCharFunction} that first applies the {@code before} predicates to
     * its input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * double}.
    ...
    /**
     * Returns a composed {@link ThrowableBiFloatToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code float} input, before this primitive function is executed.
     *
     * @param before1 The first predicate to apply before this function is applied
     * @param before2 The second predicate to apply before this function is applied
     * @return A composed {@code ThrowableBiFloatToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
    ...
    /**
     * Returns a composed {@link ThrowableBiIntToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code int} input, before this primitive function is executed.
     *
     * @param before1 The first predicate to apply before this function is applied
     * @param before2 The second predicate to apply before this function is applied
     * @return A composed {@code ThrowableBiIntToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default ThrowableBiIntToCharFunction<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiLongToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code long} input, before this primitive function is executed.
     *
     * @param before1 The first predicate to apply before this function is applied
     * @param before2 The second predicate to apply before this function is applied
     * @return A composed {@code ThrowableBiLongToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     */
    @Nonnull
    default ThrowableBiLongToCharFunction<X> composeFromLong(@Nonnull ThrowableLongPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableBiShortToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code short} input, before this primitive function is executed.
     *
     * @param before1 The first predicate to apply before this function is applied
     * @param before2 The second predicate to apply before this function is applied
     * @return A composed {@code ThrowableBiShortToCharFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * short}.
     ...
     */
    @Nonnull
    default ThrowableBiBooleanConsumer<X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiBooleanToCharFunction<X> reversed() {
        return (value2, value1) -> applyAsCharThrows(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiBooleanToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiBooleanToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiBooleanToCharFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<Boolean, Boolean, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link BiBooleanToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiBooleanToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction nest() {
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiBooleanToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiBooleanToCharFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiBooleanToCharFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiBooleanToCharFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiBooleanToCharFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiBooleanToCharFunction sneakyThrow() {
        return (value1, value2) -> {
            try {
                return applyAsCharThrows(value1, value2);
