...
public interface ThrowableObjShortToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToLongFunction<T, X> of(
            @Nullable ThrowableObjShortToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjShortToLongFunction<? super T, ? extends X> function, T t, short value) throws X {
     ...
     */
    @Nonnull
    default ThrowableShortToLongFunction<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(short value) {
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjShortToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjShortToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjShortToLongFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjShortToLongFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjShortToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortToLongFunction<? super T> function = recover.apply(throwable);
