...
/**
 * Represents an operation that accepts two {@code byte}-valued input arguments and produces a {@code double}-valued
 * result which is able to throw any {@link Throwable}. This is a primitive specialization of {@link
 * ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(byte, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableBiByteToDoubleFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiByteToDoubleFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiByteToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiByteToDoubleFunction<X> of(
            @Nullable ThrowableBiByteToDoubleFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiByteToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code ThrowableBiByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> double call(@Nonnull ThrowableBiByteToDoubleFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiByteToDoubleFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableByteToDoubleFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiByteToDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiByteToDoubleFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiByteToDoubleFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableByteToDoubleFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiByteToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiByteToDoubleFunction<X> onlySecond(
            @Nonnull ThrowableByteToDoubleFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiByteToDoubleFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiByteToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiByteToDoubleFunction<X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(byte value1, byte value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableByteToDoubleFunction<X> applyAsDoubleThrowsPartially(byte value1) {
    ...
    default <A, B> ThrowableToDoubleBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsDoubleThrows(before1.applyAsByteThrows(a), before2.applyAsByteThrows(b));
    }
    ...
    default ThrowableBiBooleanToDoubleFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsDoubleThrows(before1.applyAsByteThrows(value1),
                before2.applyAsByteThrows(value2));
    }

    /**
     * Returns a composed {@link ThrowableBiByteToDoubleFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code byte} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiByteToDoubleFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     ...
     */
    @Nonnull
    default ThrowableBiBytePredicate<X> andThenToBoolean(@Nonnull ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiByteConsumer<X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiByteToDoubleFunction<X> reversed() {
        return (value2, value1) -> applyAsDoubleThrows(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiByteToDoubleFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiByteToDoubleFunction}.
    ...
    default ThrowableBiByteToDoubleFunction<X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<Byte, Byte>, Double> cache = new ConcurrentHashMap<>();
            return (ThrowableBiByteToDoubleFunction<X> & Memoized) (value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableBiByteToDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiByteToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableBiByteToDoubleFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<Byte, Byte, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link BiByteToDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiByteToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction nest() {
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiByteToDoubleFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiByteToDoubleFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiByteToDoubleFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiByteToDoubleFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiByteToDoubleFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiByteToDoubleFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiByteToDoubleFunction sneakyThrow() {
        return (value1, value2) -> {
            try {
                return applyAsDoubleThrows(value1, value2);
