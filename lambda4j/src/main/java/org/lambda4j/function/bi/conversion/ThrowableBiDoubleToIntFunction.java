...
/**
 * Represents an operation that accepts two {@code double}-valued input arguments and produces a {@code int}-valued
 * result which is able to throw any {@link Throwable}. This is a primitive specialization of {@link
 * ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(double, double)}.
 *
...
@FunctionalInterface
public interface ThrowableBiDoubleToIntFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiDoubleToIntFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiDoubleToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiDoubleToIntFunction<X> of(
            @Nullable ThrowableBiDoubleToIntFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiDoubleToIntFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code ThrowableBiDoubleToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> int call(@Nonnull ThrowableBiDoubleToIntFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiDoubleToIntFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableDoubleToIntFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiDoubleToIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableDoubleToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiDoubleToIntFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiDoubleToIntFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableDoubleToIntFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiDoubleToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiDoubleToIntFunction<X> onlySecond(
            @Nonnull ThrowableDoubleToIntFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiDoubleToIntFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiDoubleToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiDoubleToIntFunction<X> constant(int ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    int applyAsIntThrows(double value1, double value2) throws X;
    ...
    default <A, B> ThrowableToIntBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsIntThrows(before1.applyAsDoubleThrows(a), before2.applyAsDoubleThrows(b));
    }
    ...
    default ThrowableBiBooleanToIntFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsIntThrows(before1.applyAsDoubleThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableBiDoubleToIntFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code double} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiDoubleToIntFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * double}.
     ...
     */
    @Nonnull
    default ThrowableBiDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiDoubleConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToIntFunction<X> reversed() {
    ...
    default ThrowableBiDoubleToIntFunction<X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<Double, Double>, Integer> cache = new ConcurrentHashMap<>();
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableBiDoubleToIntFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiDoubleToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableBiDoubleToIntFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<Double, Double, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link BiDoubleToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiDoubleToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction nest() {
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiDoubleToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiDoubleToIntFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiDoubleToIntFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiDoubleToIntFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiDoubleToIntFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiDoubleToIntFunction sneakyThrow() {
        return (value1, value2) -> {
            try {
                return applyAsIntThrows(value1, value2);
