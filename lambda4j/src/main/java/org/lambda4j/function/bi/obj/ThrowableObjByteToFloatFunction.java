...
public interface ThrowableObjByteToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjByteToFloatFunction<T, X> of(
            @Nullable ThrowableObjByteToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull ThrowableObjByteToFloatFunction<? super T, ? extends X> function, T t, byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableByteToFloatFunction<X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<T, X> applyAsFloatThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjByteToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjByteToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjByteToFloatFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjByteToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjByteToFloatFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjByteToFloatFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjByteToFloatFunction<? super T> function = recover.apply(throwable);
