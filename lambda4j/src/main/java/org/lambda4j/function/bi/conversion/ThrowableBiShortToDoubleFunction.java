...
public interface ThrowableBiShortToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiShortToDoubleFunction<X> of(
            @Nullable ThrowableBiShortToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull ThrowableBiShortToDoubleFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableShortToDoubleFunction<X> applyAsDoubleThrowsPartially(short value1) {
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> andThenToBoolean(@Nonnull ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiShortConsumer<X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiShortToDoubleFunction<X> reversed() {
     ...
     * this {@code ThrowableBiShortToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiShortToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiShortToDoubleFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiShortToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiShortToDoubleFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiShortToDoubleFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiShortToDoubleFunction function = recover.apply(throwable);
