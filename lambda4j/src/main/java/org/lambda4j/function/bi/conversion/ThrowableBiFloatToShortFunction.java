...
/**
 * Represents an operation that accepts two {@code float}-valued input arguments and produces a {@code short}-valued
...
@FunctionalInterface
public interface ThrowableBiFloatToShortFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiFloatToShortFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiFloatToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiFloatToShortFunction<X> of(
            @Nullable ThrowableBiFloatToShortFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiFloatToShortFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code ThrowableBiFloatToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> short call(@Nonnull ThrowableBiFloatToShortFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiFloatToShortFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableFloatToShortFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiFloatToShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFloatToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiFloatToShortFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiFloatToShortFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableFloatToShortFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiFloatToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiFloatToShortFunction<X> onlySecond(
            @Nonnull ThrowableFloatToShortFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiFloatToShortFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiFloatToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiFloatToShortFunction<X> constant(short ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(float value1, float value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableFloatToShortFunction<X> applyAsShortThrowsPartially(float value1) {
    ...
    default <A, B> ThrowableToShortBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsShortThrows(before1.applyAsFloatThrows(a), before2.applyAsFloatThrows(b));
    }
    ...
    default ThrowableBiBooleanToShortFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsShortThrows(before1.applyAsFloatThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableBiFloatToShortFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code float} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiFloatToShortFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     ...
     */
    @Nonnull
    default ThrowableBiFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiFloatConsumer<X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiFloatToShortFunction<X> reversed() {
        return (value2, value1) -> applyAsShortThrows(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiFloatToShortFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiFloatToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiFloatToShortFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<Float, Float>, Short> cache = new ConcurrentHashMap<>();
            return (ThrowableBiFloatToShortFunction<X> & Memoized) (value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableBiFloatToShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiFloatToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableBiFloatToShortFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<Float, Float, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link BiFloatToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiFloatToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiFloatToShortFunction nest() {
     ...
     * @return A composed {@link BiFloatToShortFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiFloatToShortFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiFloatToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiFloatToShortFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiFloatToShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiFloatToShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiFloatToShortFunction sneakyThrow() {
        return (value1, value2) -> {
            try {
                return applyAsShortThrows(value1, value2);
