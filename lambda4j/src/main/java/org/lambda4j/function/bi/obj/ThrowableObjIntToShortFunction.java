...
public interface ThrowableObjIntToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjIntToShortFunction<T, X> of(
            @Nullable ThrowableObjIntToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull ThrowableObjIntToShortFunction<? super T, ? extends X> function, T t, int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableIntToShortFunction<X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> applyAsShortThrowsPartially(int value) {
     ...
     */
    @Nonnull
    default ThrowableObjIntPredicate<T, X> andThenToBoolean(@Nonnull ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjIntConsumer<T, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjIntToShortFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjIntToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjIntToShortFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjIntToShortFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjIntToShortFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjIntToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjIntToShortFunction<? super T> function = recover.apply(throwable);
