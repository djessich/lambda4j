...
public interface ThrowableObjShortToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjShortToByteFunction<T, X> of(
            @Nullable ThrowableObjShortToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjShortToByteFunction<? super T, ? extends X> function, T t, short value) throws X {
     ...
     */
    @Nonnull
    default ThrowableShortToByteFunction<X> applyAsByteThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> applyAsByteThrowsPartially(short value) {
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjShortToByteFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjShortToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjShortToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjShortToByteFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjShortToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortToByteFunction<? super T> function = recover.apply(throwable);
