...
public interface BiFloatToCharFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static BiFloatToCharFunction of(@Nullable BiFloatToCharFunction expression) {
        return expression;
    }
     ...
     */
    static char call(@Nonnull BiFloatToCharFunction function, float value1, float value2) {
     ...
     */
    @Nonnull
    static BiFloatToCharFunction onlyFirst(@Nonnull FloatToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiFloatToCharFunction onlySecond(@Nonnull FloatToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default FloatToCharFunction applyAsCharPartially(float value1) {
     ...
     */
    @Nonnull
    default <A, B> ToCharBiFunction<A, B> compose(@Nonnull ToFloatFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToCharFunction composeFromBoolean(@Nonnull BooleanToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiByteToCharFunction composeFromByte(@Nonnull ByteToFloatFunction before1,
     ...
     */
    @Nonnull
    default CharBinaryOperator composeFromChar(@Nonnull CharToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToCharFunction composeFromDouble(@Nonnull DoubleToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToCharFunction composeFromFloat(@Nonnull FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default BiIntToCharFunction composeFromInt(@Nonnull IntToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiLongToCharFunction composeFromLong(@Nonnull LongToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiShortToCharFunction composeFromShort(@Nonnull ShortToFloatFunction before1,
     ...
     */
    @Nonnull
    default <S> BiFloatFunction<S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiFloatPredicate andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToByteFunction andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToCharFunction andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToDoubleFunction andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatBinaryOperator andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToIntFunction andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToLongFunction andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToShortFunction andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatConsumer consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default BiFloatToCharFunction reversed() {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiFloatToCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiFloatToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiFloatToCharFunction}.
     */
    @Nonnull
    default BiFunction2<Float, Float, Character> boxed() {
