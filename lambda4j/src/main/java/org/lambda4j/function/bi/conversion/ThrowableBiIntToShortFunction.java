...
public interface ThrowableBiIntToShortFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiIntToShortFunction<X> of(
            @Nullable final ThrowableBiIntToShortFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> short call(@Nonnull final ThrowableBiIntToShortFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableIntToShortFunction<X> papplyAsShortThrows(int value1) {
    ...
    /**
     * Returns a composed {@link ThrowableBiIntToShortFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableBiIntPredicate<X> andThenToBoolean(@Nonnull final ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntBinaryOperator<X> andThenToInt(@Nonnull final ThrowableShortToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> consume(@Nonnull final ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiIntToShortFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiIntToShortFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BiIntToShortFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                final BiIntToShortFunction function = recover.apply(throwable);
