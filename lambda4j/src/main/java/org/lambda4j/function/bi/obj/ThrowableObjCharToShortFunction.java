 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, char) specialization
...
public interface ThrowableObjCharToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjCharToShortFunction<T, X> of(
            @Nullable ThrowableObjCharToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull ThrowableObjCharToShortFunction<? super T, ? extends X> function, T t, char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableCharToShortFunction<X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> applyAsShortThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjCharToShortFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjCharToShortFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjCharToShortFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjCharToShortFunction<? super T> function = recover.apply(throwable);
