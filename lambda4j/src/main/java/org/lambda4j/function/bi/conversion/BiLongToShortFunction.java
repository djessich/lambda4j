...
@FunctionalInterface
public interface BiLongToShortFunction extends Lambda {

    /**
     * Constructs a {@link BiLongToShortFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code BiLongToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static BiLongToShortFunction of(@Nullable BiLongToShortFunction expression) {
        return expression;
    }
     ...
     */
    static short call(@Nonnull BiLongToShortFunction function, long value1, long value2) {
     ...
     */
    @Nonnull
    static BiLongToShortFunction onlyFirst(@Nonnull LongToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiLongToShortFunction onlySecond(@Nonnull LongToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default LongToShortFunction applyAsShortPartially(long value1) {
     ...
     */
    @Nonnull
    default <A, B> ToShortBiFunction<A, B> compose(@Nonnull ToLongFunction<? super A> before1,
            @Nonnull ToLongFunction<? super B> before2) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (a, b) -> applyAsShort(before1.applyAsLong(a), before2.applyAsLong(b));
    }
     ...
     */
    @Nonnull
    default BiBooleanToShortFunction composeFromBoolean(@Nonnull BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default BiByteToShortFunction composeFromByte(@Nonnull ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default BiCharToShortFunction composeFromChar(@Nonnull CharToLongFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToShortFunction composeFromDouble(@Nonnull DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToShortFunction composeFromFloat(@Nonnull FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default BiIntToShortFunction composeFromInt(@Nonnull IntToLongFunction before1,
    ...
    /**
     * Returns a composed {@link BiLongToShortFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code BiLongToShortFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     */
    @Nonnull
    default BiLongToShortFunction composeFromLong(@Nonnull LongUnaryOperator before1,
     ...
     */
    @Nonnull
    default ShortBinaryOperator composeFromShort(@Nonnull ShortToLongFunction before1,
     ...
     */
    @Nonnull
    default <S> BiLongFunction<S> andThen(@Nonnull ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiLongPredicate andThenToBoolean(@Nonnull ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiLongToByteFunction andThenToByte(@Nonnull ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiLongToCharFunction andThenToChar(@Nonnull ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiLongToDoubleFunction andThenToDouble(@Nonnull ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiLongToFloatFunction andThenToFloat(@Nonnull ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiLongToIntFunction andThenToInt(@Nonnull ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongBinaryOperator2 andThenToLong(@Nonnull ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiLongToShortFunction andThenToShort(@Nonnull ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiLongConsumer consume(@Nonnull ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default BiLongToShortFunction reversed() {
        return (value2, value1) -> applyAsShort(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link BiLongToShortFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiLongToShortFunction}.
     ...
     */
    @Nonnull
    default BiLongToShortFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<Long, Long>, Short> cache = new ConcurrentHashMap<>();
            return (BiLongToShortFunction & Memoized) (value1, value2) -> {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiLongToShortFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiLongToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiLongToShortFunction}.
     */
    @Nonnull
    default BiFunction2<Long, Long, Short> boxed() {
