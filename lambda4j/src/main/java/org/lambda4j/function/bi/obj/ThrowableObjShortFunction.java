...
public interface ThrowableObjShortFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjShortFunction<T, R, X> of(
            @Nullable final ThrowableObjShortFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjShortFunction} into a total {@link ThrowableObjShortFunction} that returns an
     ...
     * @return A partial {@code ThrowableObjShortFunction} lifted into a total {@code ThrowableObjShortFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjShortFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjShortFunction<? super T, ? extends R, ? extends X> partial) {
     ...
     * {@code ThrowableObjShortFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjShortFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjShortFunction<T, R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjShortFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjShortFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjShortFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjShortFunction<? super T, ? extends R> function = recover.apply(throwable);
