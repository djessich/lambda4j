 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, short) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(Object, short)}.
 *
...
@FunctionalInterface
public interface ThrowableObjShortToCharFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjShortToCharFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjShortToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjShortToCharFunction<T, X> of(
            @Nullable ThrowableObjShortToCharFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjShortToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjShortToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjShortToCharFunction<? super T, ? extends X> function, T t, short value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsCharThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjShortToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjShortToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToCharFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjShortToCharFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableShortToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjShortToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableShortToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToCharFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjShortToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjShortToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjShortToCharFunction<T, X> constant(char ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(T t, short value) throws X;
     ...
     */
    @Nonnull
    default ThrowableShortToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(short value) {
    ...
    default <A, B> ThrowableToCharBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsCharThrows(before1.applyThrows(a), before2.applyAsShortThrows(b));
    }
    ...
    default ThrowableBiBooleanToCharFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsCharThrows(before1.applyThrows(value1), before2.applyAsShortThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjShortConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsCharThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjShortToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjShortToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjShortToCharFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<T, Short>, Character> cache = new ConcurrentHashMap<>();
            return (ThrowableObjShortToCharFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjShortToCharFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjShortToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjShortToCharFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Short, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link ObjShortToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjShortToCharFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link ObjShortToCharFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjShortToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjShortToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjShortToCharFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjShortToCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjShortToCharFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjShortToCharFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsCharThrows(t, value);
