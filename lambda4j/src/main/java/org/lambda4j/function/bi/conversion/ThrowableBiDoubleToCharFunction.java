 ...
 * ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(double, double)}.
 *
...
@FunctionalInterface
public interface ThrowableBiDoubleToCharFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiDoubleToCharFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiDoubleToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiDoubleToCharFunction<X> of(
            @Nullable ThrowableBiDoubleToCharFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiDoubleToCharFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code ThrowableBiDoubleToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> char call(@Nonnull ThrowableBiDoubleToCharFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiDoubleToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableDoubleToCharFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiDoubleToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableDoubleToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiDoubleToCharFunction<X> onlyFirst(
            @Nonnull ThrowableDoubleToCharFunction<? extends X> function) {
        Objects.requireNonNull(function);
        return (value1, value2) -> function.applyAsCharThrows(value1);
    }

    /**
     * Creates a {@link ThrowableBiDoubleToCharFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableDoubleToCharFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiDoubleToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiDoubleToCharFunction<X> onlySecond(
            @Nonnull ThrowableDoubleToCharFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiDoubleToCharFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiDoubleToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiDoubleToCharFunction<X> constant(char ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(double value1, double value2) throws X;
    ...
    default <A, B> ThrowableToCharBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsCharThrows(before1.applyAsDoubleThrows(a), before2.applyAsDoubleThrows(b));
    }
    ...
    default ThrowableBiBooleanToCharFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsCharThrows(before1.applyAsDoubleThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableBiDoubleToCharFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code double} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiDoubleToCharFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * double}.
     ...
     */
    @Nonnull
    default ThrowableBiDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiDoubleConsumer<X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToCharFunction<X> reversed() {
        return (value2, value1) -> applyAsCharThrows(value1, value2);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiDoubleToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiDoubleToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToCharFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<Double, Double>, Character> cache = new ConcurrentHashMap<>();
            return (ThrowableBiDoubleToCharFunction<X> & Memoized) (value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableBiDoubleToCharFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiDoubleToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableBiDoubleToCharFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<Double, Double, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link BiDoubleToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiDoubleToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiDoubleToCharFunction nest() {
     ...
     */
    @Nonnull
    default BiDoubleToCharFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiDoubleToCharFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiDoubleToCharFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiDoubleToCharFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiDoubleToCharFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiDoubleToCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiDoubleToCharFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiDoubleToCharFunction sneakyThrow() {
        return (value1, value2) -> {
            try {
                return applyAsCharThrows(value1, value2);
