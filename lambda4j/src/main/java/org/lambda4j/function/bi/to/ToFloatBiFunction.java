...
public interface ToFloatBiFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> ToFloatBiFunction<T, U> of(@Nullable final ToFloatBiFunction<T, U> expression) {
        return expression;
    }
    ...
    default ToFloatFunction<U> papplyAsFloat(T t) {
        return (u) -> this.applyAsFloat(t, u);
    }
     ...
     */
    @Nonnull
    default BiPredicate2<T, U> andThenToBoolean(@Nonnull final FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToDoubleBiFunction2<T, U> andThenToDouble(@Nonnull final FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> andThenToInt(@Nonnull final FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToLongBiFunction2<T, U> andThenToLong(@Nonnull final FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiConsumer2<T, U> consume(@Nonnull final FloatConsumer consumer) {
     ...
     * {@code ToFloatBiFunction} with methods provided by the {@code JDK}.
     *
