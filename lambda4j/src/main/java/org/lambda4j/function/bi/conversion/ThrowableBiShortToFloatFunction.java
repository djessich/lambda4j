...
/**
 * Represents an operation that accepts two {@code short}-valued input arguments and produces a {@code float}-valued
...
public interface ThrowableBiShortToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiShortToFloatFunction<X> of(
            @Nullable ThrowableBiShortToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull ThrowableBiShortToFloatFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiShortPredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiShortConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiShortToFloatFunction<X> reversed() {
     ...
     */
    @Nonnull
    default BiShortToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiShortToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiShortToFloatFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiShortToFloatFunction function = recover.apply(throwable);
