...
public interface ThrowableObjLongToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjLongToDoubleFunction<T, X> of(
            @Nullable ThrowableObjLongToDoubleFunction<T, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableLongToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableObjLongConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjLongToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjLongToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjLongToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjLongToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjLongToDoubleFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjLongToDoubleFunction<? super T> function = recover.apply(throwable);
