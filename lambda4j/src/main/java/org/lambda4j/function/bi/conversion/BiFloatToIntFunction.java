...
public interface BiFloatToIntFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static BiFloatToIntFunction of(@Nullable BiFloatToIntFunction expression) {
        return expression;
    }
     ...
     */
    static int call(@Nonnull BiFloatToIntFunction function, float value1, float value2) {
     ...
     */
    @Nonnull
    static BiFloatToIntFunction onlyFirst(@Nonnull FloatToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static BiFloatToIntFunction onlySecond(@Nonnull FloatToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B> ToIntBiFunction2<A, B> compose(@Nonnull ToFloatFunction<? super A> before1,
     ...
     */
    @Nonnull
    default BiBooleanToIntFunction composeFromBoolean(@Nonnull BooleanToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiByteToIntFunction composeFromByte(@Nonnull ByteToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiCharToIntFunction composeFromChar(@Nonnull CharToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiDoubleToIntFunction composeFromDouble(@Nonnull DoubleToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiFloatToIntFunction composeFromFloat(@Nonnull FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default IntBinaryOperator2 composeFromInt(@Nonnull IntToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiLongToIntFunction composeFromLong(@Nonnull LongToFloatFunction before1,
     ...
     */
    @Nonnull
    default BiShortToIntFunction composeFromShort(@Nonnull ShortToFloatFunction before1,
     ...
     */
    @Nonnull
    default <S> BiFloatFunction<S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiFloatPredicate andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToByteFunction andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToCharFunction andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToDoubleFunction andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatBinaryOperator andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToIntFunction andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToLongFunction andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatToShortFunction andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiFloatConsumer consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default BiFloatToIntFunction reversed() {
    ...
    /**
     * Returns a composed {@link BiFunction2} which represents this {@link BiFloatToIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiFloatToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code BiFunction2} which represents this {@code BiFloatToIntFunction}.
     */
    @Nonnull
    default BiFunction2<Float, Float, Integer> boxed() {
