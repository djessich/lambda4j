 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, byte) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableObjByteToByteFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjByteToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjByteToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjByteToByteFunction<T, X> of(
            @Nullable ThrowableObjByteToByteFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjByteToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjByteToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjByteToByteFunction<? super T, ? extends X> function, T t, byte value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsByteThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjByteToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjByteToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjByteToByteFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjByteToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableByteUnaryOperator}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param operator The operator which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjByteToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableByteUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjByteToByteFunction<T, X> onlySecond(
            @Nonnull ThrowableByteUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, value) -> operator.applyAsByteThrows(value);
    }

    /**
     * Creates a {@link ThrowableObjByteToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjByteToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjByteToByteFunction<T, X> constant(byte ret) {
        return (t, value) -> ret;
    }
    ...
    default <A, B> ThrowableToByteBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsByteThrows(before1.applyThrows(a), before2.applyAsByteThrows(b));
    }
    ...
    default ThrowableBiBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsByteThrows(before1.applyThrows(value1), before2.applyAsByteThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjBytePredicate<T, X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjByteConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsByteThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjByteToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjByteToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjByteToByteFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<T, Byte>, Byte> cache = new ConcurrentHashMap<>();
            return (ThrowableObjByteToByteFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjByteToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjByteToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjByteToByteFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Byte, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ObjByteToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjByteToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjByteToByteFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjByteToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjByteToByteFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjByteToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjByteToByteFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjByteToByteFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjByteToByteFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjByteToByteFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjByteToByteFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsByteThrows(t, value);
