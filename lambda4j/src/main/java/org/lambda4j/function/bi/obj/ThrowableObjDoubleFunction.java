 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, double) specialization of {@link
 * ThrowableBiFunction}.
 * <p>
...
public interface ThrowableObjDoubleFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjDoubleFunction<T, R, X> of(
            @Nullable ThrowableObjDoubleFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjDoubleFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjDoubleFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjDoubleFunction<? super T, ? extends R, ? extends X> function, T t,
    ...
    default ObjDoubleFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoubleFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoubleFunction<? super T, ? extends R> function = recover.apply(throwable);
