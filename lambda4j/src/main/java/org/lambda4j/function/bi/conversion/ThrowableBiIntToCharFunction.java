...
/**
 * Represents an operation that accepts two {@code int}-valued input arguments and produces a {@code char}-valued result
 * which is able to throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(int, int)}.
 *
...
@FunctionalInterface
public interface ThrowableBiIntToCharFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiIntToCharFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiIntToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableBiIntToCharFunction<X> of(
            @Nullable ThrowableBiIntToCharFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiIntToCharFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value1 The first argument to the function
     * @param value2 The second argument to the function
     * @return The result from the given {@code ThrowableBiIntToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> char call(@Nonnull ThrowableBiIntToCharFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableBiIntToCharFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableIntToCharFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableBiIntToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableIntToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiIntToCharFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiIntToCharFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableIntToCharFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableBiIntToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableIntToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiIntToCharFunction<X> onlySecond(
            @Nonnull ThrowableIntToCharFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableBiIntToCharFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiIntToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableBiIntToCharFunction<X> constant(char ret) {
    ...
    default <A, B> ThrowableToCharBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsCharThrows(before1.applyAsIntThrows(a), before2.applyAsIntThrows(b));
    }
    ...
    default ThrowableBiBooleanToCharFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsCharThrows(before1.applyAsIntThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableBiIntToCharFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code int} input, before this primitive function is executed.
     *
     * @param before1 The first operator to apply before this function is applied
     * @param before2 The second operator to apply before this function is applied
     * @return A composed {@code ThrowableBiIntToCharFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * int}.
     ...
     */
    @Nonnull
    default ThrowableBiIntPredicate<X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntBinaryOperator<X> andThenToInt(@Nonnull ThrowableCharToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiIntConsumer<X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiIntToCharFunction<X> reversed() {
    ...
    default ThrowableBiIntToCharFunction<X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<Integer, Integer>, Character> cache = new ConcurrentHashMap<>();
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableBiIntToCharFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiIntToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableBiIntToCharFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<Integer, Integer, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link BiIntToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiIntToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiIntToCharFunction nest() {
     ...
     * @return A composed {@link BiIntToCharFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiIntToCharFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiIntToCharFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiIntToCharFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiIntToCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiIntToCharFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiIntToCharFunction sneakyThrow() {
        return (value1, value2) -> {
            try {
                return applyAsCharThrows(value1, value2);
