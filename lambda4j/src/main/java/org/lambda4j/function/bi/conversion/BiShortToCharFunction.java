...
public interface BiShortToCharFunction extends Lambda {
     ...
     */
    static BiShortToCharFunction of(@Nullable final BiShortToCharFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ShortToCharFunction papplyAsChar(short value1) {
     ...
     * {@code BiShortToCharFunction} with methods provided by the {@code JDK}.
     *
