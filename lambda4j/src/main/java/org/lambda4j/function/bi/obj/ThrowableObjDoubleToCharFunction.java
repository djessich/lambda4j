 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, double) specialization
 * of {@link ThrowableBiFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableObjDoubleToCharFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjDoubleToCharFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjDoubleToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjDoubleToCharFunction<T, X> of(
            @Nullable ThrowableObjDoubleToCharFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjDoubleToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjDoubleToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjDoubleToCharFunction<? super T, ? extends X> function, T t, double value) throws X {
        Objects.requireNonNull(function);
        return function.applyAsCharThrows(t, value);
    }

    /**
     * Creates a {@link ThrowableObjDoubleToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjDoubleToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleToCharFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjDoubleToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableDoubleToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjDoubleToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleToCharFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjDoubleToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjDoubleToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjDoubleToCharFunction<T, X> constant(char ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(T t, double value) throws X;
    ...
    default <A, B> ThrowableToCharBiFunction<A, B, X> compose(
        ...
        return (a, b) -> applyAsCharThrows(before1.applyThrows(a), before2.applyAsDoubleThrows(b));
    }
    ...
    default ThrowableBiBooleanToCharFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyAsCharThrows(before1.applyThrows(value1), before2.applyAsDoubleThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value) -> consumer.acceptThrows(applyAsCharThrows(t, value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjDoubleToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjDoubleToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToCharFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Pair<T, Double>, Character> cache = new ConcurrentHashMap<>();
            return (ThrowableObjDoubleToCharFunction<T, X> & Memoized) (t, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjDoubleToCharFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjDoubleToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjDoubleToCharFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Double, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link ObjDoubleToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjDoubleToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjDoubleToCharFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjDoubleToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjDoubleToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjDoubleToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoubleToCharFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoubleToCharFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjDoubleToCharFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjDoubleToCharFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjDoubleToCharFunction<T> sneakyThrow() {
        return (t, value) -> {
            try {
                return applyAsCharThrows(t, value);
