...
public interface ThrowableBiLongToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBiLongToIntFunction<X> of(
            @Nullable ThrowableBiLongToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableBiLongToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableIntBinaryOperator<X> composeFromInt(@Nonnull ThrowableIntToLongFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableBiLongPredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiLongToIntFunction<X> andThenToInt(@Nonnull ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongBinaryOperator<X> andThenToLong(@Nonnull ThrowableIntToLongFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBiLongConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBiLongToIntFunction<X> reversed() {
     ...
     * this {@code ThrowableBiLongToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiLongToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiLongToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiLongToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiLongToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends BiLongToIntFunction> recover) {
        ...
        return (value1, value2) -> {
            try {
                ...
                BiLongToIntFunction function = recover.apply(throwable);
