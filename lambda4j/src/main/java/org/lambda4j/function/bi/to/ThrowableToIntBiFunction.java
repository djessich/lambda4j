...
public interface ThrowableToIntBiFunction<T, U, X extends Throwable> extends Lambda, ToIntBiFunction<T, U> {
    ...
    static <T, U, X extends Throwable> ThrowableToIntBiFunction<T, U, X> of(
            @Nullable final ThrowableToIntBiFunction<T, U, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
