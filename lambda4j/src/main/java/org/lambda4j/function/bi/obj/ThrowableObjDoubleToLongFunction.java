...
public interface ThrowableObjDoubleToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjDoubleToLongFunction<T, X> of(
            @Nullable ThrowableObjDoubleToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjDoubleToLongFunction<? super T, ? extends X> function, T t, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableDoubleToLongFunction<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
    ...
    default ThrowableObjDoubleToLongFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Pair<T, Double>, Long> cache = new ConcurrentHashMap<>();
     ...
     * this {@code ThrowableObjDoubleToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjDoubleToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjDoubleToLongFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjDoubleToLongFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjDoubleToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjDoubleToLongFunction<? super T>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                ObjDoubleToLongFunction<? super T> function = recover.apply(throwable);
