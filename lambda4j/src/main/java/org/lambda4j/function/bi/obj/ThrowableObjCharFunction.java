 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableObjCharFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjCharFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjCharFunction} from given lambda expression or method reference.
     ...
     */
    static <T, R, X extends Throwable> ThrowableObjCharFunction<T, R, X> of(
            @Nullable final ThrowableObjCharFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjCharFunction} into a total {@link ThrowableObjCharFunction} that returns an
     ...
     * @return A partial {@code ThrowableObjCharFunction} lifted into a total {@code ThrowableObjCharFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjCharFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjCharFunction<? super T, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, value) -> Optional.ofNullable(partial.applyThrows(t, value));
    }

    /**
     * Calls the given {@link ThrowableObjCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjCharFunction<? super T, ? extends R, ? extends X> function, T t,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableObjCharFunction} which uses the {@code first} parameter of this one as argument for the
     ...
     * @return Creates a {@code ThrowableObjCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjCharFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjCharFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjCharFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjCharFunction<T, R, X> constant(R ret) {
        return (t, value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, char value) throws X;
     ...
     */
    @Nonnull
    default ThrowableCharFunction<R, X> papplyThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFunction<T, R, X> papplyThrows(char value) {
    ...
    default <A, B> ThrowableBiFunction<A, B, R, X> compose(
        ...
        return (a, b) -> applyThrows(before1.applyThrows(a), before2.applyAsCharThrows(b));
    }
    ...
    default ThrowableBiBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        return (value1, value2) -> applyThrows(before1.applyThrows(value1), before2.applyAsCharThrows(value2));
    }
     ...
     */
    @Nonnull
    default ThrowableObjCharConsumer<T, X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjCharFunction<T, Optional<R>, X> nonNull() {
        return (t, value) -> Optional.ofNullable(applyThrows(t, value));
    }

    /**
     * Returns a composed {@link ThrowableBiFunction} which represents this {@link ThrowableObjCharFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableBiFunction} which represents this {@code ThrowableObjCharFunction}.
     */
    @Nonnull
    default ThrowableBiFunction<T, Character, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjCharFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjCharFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjCharFunction<T, R> nest() {
     ...
     */
    @Nonnull
    default ObjCharFunction<T, R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjCharFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjCharFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjCharFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value) -> {
            try {
                ...
                final ObjCharFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjCharFunction} that applies this function to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjCharFunction<T, R> sneakyThrow() {
        return (t, value) -> {
            try {
                return this.applyThrows(t, value);
