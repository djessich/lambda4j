...
/**
 * Represents an operation that accepts one {@code float}-valued input argument and produces a result which is able to
...
@FunctionalInterface
public interface ThrowableFloatFunction<R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableFloatFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ThrowableFloatFunction} from given lambda expression or method reference.
    ...
    static <R, X extends Throwable> ThrowableFloatFunction<R, X> of(
            @Nullable ThrowableFloatFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableFloatFunction<Optional<R>, X> lift(
            @Nonnull ThrowableFloatFunction<? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return value -> Optional.ofNullable(partial.applyThrows(value));
    }

    /**
     * Calls the given {@link ThrowableFloatFunction} with the given argument and returns its result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableFloatFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableFloatFunction<R, X> constant(R ret) {
        return value -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(float value) throws X;
    ...
    default <A> ThrowableFunction<A, R, X> compose(
        ...
        return a -> applyThrows(before.applyAsFloatThrows(a));
    }
    ...
    default ThrowableBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyThrows(before.applyAsFloatThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableFloatFunction} that first applies the {@code before} operator to its input,
     * and then applies this function to the result. This method is just convenience, to provide the ability to execute
     * an operation which accepts {@code float} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableFloatFunction} that first applies the {@code before} operator to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     ...
     */
    @Nonnull
    default ThrowableIntFunction<R, X> composeFromInt(@Nonnull ThrowableIntToFloatFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyThrows(before.applyAsFloatThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableFloatPredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> andThenToInt(@Nonnull ThrowableToIntFunction<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableFloatFunction<R, X> curried() {
        return this;
    }
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableFloatFunction}.
    ...
    default ThrowableFloatFunction<R, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableFloatFunction<R, X> & Memoized) value -> {
    ...
    @Deprecated
    @Nonnull
    default ThrowableFloatFunction<Optional<R>, X> nonNull() {
        return value -> Optional.ofNullable(applyThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableFloatFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ThrowableFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableFloatFunction}.
     */
    @Nonnull
    default ThrowableFunction<Float, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link FloatFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link FloatFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default FloatFunction<R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default FloatFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends FloatFunction<? extends R>> recover) {
        ...
        return value -> {
            try {
                ...
                FloatFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link FloatFunction} that applies this function to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link FloatFunction} that applies this function to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default FloatFunction<R> sneakyThrow() {
        return value -> {
            try {
                return applyThrows(value);
