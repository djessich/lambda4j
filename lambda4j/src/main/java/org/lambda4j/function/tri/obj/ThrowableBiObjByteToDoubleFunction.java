 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, byte)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(Object, Object, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjByteToDoubleFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjByteToDoubleFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjByteToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjByteToDoubleFunction<T, U, X> of(
            @Nullable ThrowableBiObjByteToDoubleFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjByteToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> double call(
            @Nonnull ThrowableBiObjByteToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToDoubleFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjByteToDoubleFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToDoubleFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjByteToDoubleFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToDoubleFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToDoubleFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjByteToDoubleFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToDoubleFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjByteToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToDoubleFunction<T, U, X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, U u, byte value) throws X;
     ...
     */
    default double applyAsDoubleThrows(@Nonnull Pair<T, U> tuple, byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjByteToDoubleFunction<Pair<T, U>, X> tupled() {
    ...
    default ThrowableBiObjByteToDoubleFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Byte>, Double> cache = new ConcurrentHashMap<>();
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjByteToDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjByteToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjByteToDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Byte, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link BiObjByteToDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjByteToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjByteToDoubleFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjByteToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjByteToDoubleFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjByteToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjByteToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjByteToDoubleFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjByteToDoubleFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjByteToDoubleFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsDoubleThrows(t, u, value);
