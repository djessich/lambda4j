...
public interface ThrowableTriFloatToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriFloatToCharFunction<X> of(
            @Nullable ThrowableTriFloatToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull ThrowableTriFloatToCharFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriFloatToCharFunction<X> reversed() {
    ...
    default TriFloatToCharFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriFloatToCharFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriFloatToCharFunction function = recover.apply(throwable);
