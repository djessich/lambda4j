 ...
 * This is a (reference, double, double) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShort(Object, double, double)}.
 *
...
@FunctionalInterface
public interface ObjBiDoubleToShortFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiDoubleToShortFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjBiDoubleToShortFunction} from given lambda expression or method reference.
     ...
     */
    static <T> ObjBiDoubleToShortFunction<T> of(@Nullable final ObjBiDoubleToShortFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiDoubleToShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiDoubleToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> short call(@Nonnull final ObjBiDoubleToShortFunction<? super T> function, T t, double value1,
            double value2) {
    ...
    /**
     * Creates a {@link ObjBiDoubleToShortFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiDoubleToShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiDoubleToShortFunction<T> onlyFirst(@Nonnull final ToShortFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsShort(t);
    }

    /**
     * Creates a {@link ObjBiDoubleToShortFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link DoubleToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiDoubleToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code DoubleToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiDoubleToShortFunction<T> onlySecond(@Nonnull final DoubleToShortFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsShort(value1);
    }

    /**
     * Creates a {@link ObjBiDoubleToShortFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link DoubleToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiDoubleToShortFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code DoubleToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiDoubleToShortFunction<T> onlyThird(@Nonnull final DoubleToShortFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsShort(value2);
    }

    /**
     * Creates a {@link ObjBiDoubleToShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiDoubleToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiDoubleToShortFunction<T> constant(short ret) {
     ...
     */
    short applyAsShort(T t, double value1, double value2);

    /**
     * Applies this function partially to some arguments of this one, producing a {@link BiDoubleToShortFunction} as
     * result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code BiDoubleToShortFunction} that represents this function partially applied the some arguments.
     */
    @Nonnull
    default BiDoubleToShortFunction papplyAsShort(T t) {
     ...
     */
    @Nonnull
    default DoubleToShortFunction papplyAsShort(T t, double value1) {
     ...
     */
    @Nonnull
    default ObjDoubleToShortFunction<T> papplyAsShort(double value1) {
     ...
     */
    @Nonnull
    default ToShortFunction<T> papplyAsShort(double value1, double value2) {
    ...
    default <A, B, C> ToShortTriFunction<A, B, C> compose(@Nonnull final Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsShort(before1.apply(a), before2.applyAsDouble(b), before3.applyAsDouble(c));
    }
    ...
    default TriBooleanToShortFunction composeFromBoolean(@Nonnull final BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsShort(before1.apply(value1), before2.applyAsDouble(value2),
     ...
     */
    @Nonnull
    default <S> ObjBiDoubleFunction<T, S> andThen(@Nonnull final ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiDoublePredicate<T> andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToByteFunction<T> andThenToByte(@Nonnull final ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToCharFunction<T> andThenToChar(@Nonnull final ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToDoubleFunction<T> andThenToDouble(@Nonnull final ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToFloatFunction<T> andThenToFloat(@Nonnull final ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToIntFunction<T> andThenToInt(@Nonnull final ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToLongFunction<T> andThenToLong(@Nonnull final ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleToShortFunction<T> andThenToShort(@Nonnull final ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiDoubleConsumer<T> consume(@Nonnull final ShortConsumer consumer) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiDoubleToShortFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjBiDoubleToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiDoubleToShortFunction}.
     */
    @Nonnull
    default TriFunction<T, Double, Double, Short> boxed() {
