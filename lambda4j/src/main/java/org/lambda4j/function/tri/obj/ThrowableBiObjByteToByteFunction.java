 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, Object, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjByteToByteFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjByteToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjByteToByteFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjByteToByteFunction<T, U, X> of(
            @Nullable final ThrowableBiObjByteToByteFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjByteToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjByteToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableBiObjByteToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToByteFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjByteToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToByteFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToByteFunction} which uses the {@code second} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjByteToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToByteFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjByteToByteFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjByteToByteFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableByteUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToByteFunction<T, U, X> onlyThird(
            @Nonnull final ThrowableByteUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, u, value) -> operator.applyAsByteThrows(value);
    }

    /**
     * Creates a {@link ThrowableBiObjByteToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjByteToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjByteToByteFunction<T, U, X> constant(byte ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, U u, byte value) throws X;
     ...
     */
    default byte applyAsByteThrows(@Nonnull Pair<T, U> tuple, byte value) throws X {
    ...
    /**
     * Applies this operator partially to some arguments of this one, producing a {@link ThrowableToByteBiFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjByteToByteFunction<Pair<T, U>, X> tupled() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjByteToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjByteToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjByteToByteFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjByteToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjByteToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjByteToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Byte, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link BiObjByteToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjByteToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjByteToByteFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjByteToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjByteToByteFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjByteToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjByteToByteFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjByteToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjByteToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjByteToByteFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return this.applyAsByteThrows(t, u, value);
