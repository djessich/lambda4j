...
public interface ThrowableBiObjIntFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjIntFunction<T, U, R, X> of(
            @Nullable ThrowableBiObjIntFunction<T, U, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableBiObjIntFunction} into a total {@link ThrowableBiObjIntFunction} that returns an
     ...
     * @return A partial {@code ThrowableBiObjIntFunction} lifted into a total {@code ThrowableBiObjIntFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjIntFunction<T, U, Optional<R>, X> lift(
            @Nonnull ThrowableBiObjIntFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
    ...
    static <T, U, R, X extends Throwable> R call(
            @Nonnull ThrowableBiObjIntFunction<? super T, ? super U, ? extends R, ? extends X> function, T t, U u,
            int value) throws X {
     ...
     *
     * @return A composed {@link BiObjIntFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default BiObjIntFunction<T, U, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiObjIntFunction<T, U, R> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjIntFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjIntFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
