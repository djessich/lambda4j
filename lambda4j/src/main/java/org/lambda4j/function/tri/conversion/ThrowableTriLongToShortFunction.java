 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(long, long, long)}.
 *
...
@FunctionalInterface
public interface ThrowableTriLongToShortFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriLongToShortFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableTriLongToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableTriLongToShortFunction<X> of(
            @Nullable ThrowableTriLongToShortFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriLongToShortFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriLongToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> short call(@Nonnull ThrowableTriLongToShortFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriLongToShortFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableLongToShortFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriLongToShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableLongToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToShortFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriLongToShortFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableLongToShortFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriLongToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToShortFunction<X> onlySecond(
            @Nonnull ThrowableLongToShortFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriLongToShortFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableLongToShortFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriLongToShortFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToShortFunction<X> onlyThird(
            @Nonnull ThrowableLongToShortFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriLongToShortFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriLongToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToShortFunction<X> constant(short ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(long value1, long value2, long value3) throws X;
    ...
    default <A, B, C> ThrowableToShortTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsShortThrows(before1.applyAsLongThrows(a), before2.applyAsLongThrows(b),
    ...
    default ThrowableTriBooleanToShortFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsShortThrows(before1.applyAsLongThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToShortFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code ThrowableTriLongToShortFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> andThenToBoolean(@Nonnull ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriLongToShortFunction<X> reversed() {
        return (value3, value2, value1) -> applyAsShortThrows(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableTriLongToShortFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriLongToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableTriLongToShortFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<Long, Long, Long>, Short> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ThrowableTriLongToShortFunction<X> & Memoized) (value1, value2, value3) -> {
                short returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriLongToShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableTriLongToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriLongToShortFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Long, Long, Long, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link TriLongToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriLongToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriLongToShortFunction nest() {
     ...
     */
    @Nonnull
    default TriLongToShortFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriLongToShortFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default TriLongToShortFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriLongToShortFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriLongToShortFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriLongToShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriLongToShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriLongToShortFunction sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyAsShortThrows(value1, value2, value3);
