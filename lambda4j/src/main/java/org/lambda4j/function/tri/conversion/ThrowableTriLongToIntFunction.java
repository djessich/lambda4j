...
public interface ThrowableTriLongToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriLongToIntFunction<X> of(
            @Nullable ThrowableTriLongToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableTriLongToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiLongToIntFunction<X> applyAsIntThrowsPartially(long value1) {
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> applyAsIntThrowsPartially(long value1, long value2) {
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToIntFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriLongToIntFunction<X> andThenToInt(@Nonnull ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriLongToIntFunction<X> reversed() {
     ...
     */
    @Nonnull
    default TriLongToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriLongToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriLongToIntFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriLongToIntFunction function = recover.apply(throwable);
