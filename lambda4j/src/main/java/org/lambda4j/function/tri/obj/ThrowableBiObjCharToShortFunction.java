 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, char)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(Object, Object, char)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjCharToShortFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjCharToShortFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjCharToShortFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjCharToShortFunction<T, U, X> of(
            @Nullable ThrowableBiObjCharToShortFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjCharToShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjCharToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> short call(
            @Nonnull ThrowableBiObjCharToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToShortFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjCharToShortFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToShortFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjCharToShortFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToShortFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToShortFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjCharToShortFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToShortFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjCharToShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjCharToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjCharToShortFunction<T, U, X> constant(short ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(T t, U u, char value) throws X;
     ...
     */
    @Nonnull
    default ThrowableObjCharToShortFunction<U, X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToShortFunction<X> applyAsShortThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToShortBiFunction<T, U, X> applyAsShortThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<U, X> applyAsShortThrowsPartially(T t, char value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToShortFunction<Pair<T, U>, X> tupled() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjCharToShortFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjCharToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjCharToShortFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Character>, Short> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ThrowableBiObjCharToShortFunction<T, U, X> & Memoized) (t, u, value) -> {
                short returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjCharToShortFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjCharToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjCharToShortFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Character, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link BiObjCharToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjCharToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjCharToShortFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjCharToShortFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjCharToShortFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjCharToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjCharToShortFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjCharToShortFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjCharToShortFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjCharToShortFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsShortThrows(t, u, value);
