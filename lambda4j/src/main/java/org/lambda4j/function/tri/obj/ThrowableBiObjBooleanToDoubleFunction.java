...
public interface ThrowableBiObjBooleanToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToDoubleFunction<T, U, X> of(
            @Nullable ThrowableBiObjBooleanToDoubleFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> double call(
            @Nonnull ThrowableBiObjBooleanToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjBooleanToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableBooleanToDoubleFunction<X> applyAsDoubleThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleBiFunction<T, U, X> applyAsDoubleThrowsPartially(boolean value) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t, boolean value) {
     ...
     * ThrowableBiObjBooleanToDoubleFunction}.
     */
    @Nonnull
    ...
    default BiObjBooleanToDoubleFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjBooleanToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjBooleanToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
