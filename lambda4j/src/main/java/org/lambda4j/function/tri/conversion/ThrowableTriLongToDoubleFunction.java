...
public interface ThrowableTriLongToDoubleFunction<X extends Throwable> extends Lambda {
     ...
     */
    @Nonnull
    default ThrowableTriLongToDoubleFunction<X> reversed() {
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
