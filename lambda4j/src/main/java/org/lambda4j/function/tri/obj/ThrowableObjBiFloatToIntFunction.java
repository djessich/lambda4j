 ...
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, float, float)
...
public interface ThrowableObjBiFloatToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatToIntFunction<T, X> of(
            @Nullable ThrowableObjBiFloatToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjBiFloatToIntFunction<? super T, ? extends X> function, T t, float value1,
     ...
     */
    @Nonnull
    default ThrowableBiFloatToIntFunction<X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> applyAsIntThrowsPartially(T t, float value1) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToIntFunction<T, X> applyAsIntThrowsPartially(float value1) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> applyAsIntThrowsPartially(float value1, float value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiFloatToIntFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Float, Float>, Integer> cache = new ConcurrentHashMap<>();
    ...
    default ObjBiFloatToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiFloatToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiFloatToIntFunction<? super T> function = recover.apply(throwable);
