...
public interface ObjBiDoubleFunction<T, R> extends Lambda {
     ...
     */
    static <T, R> ObjBiDoubleFunction<T, R> of(@Nullable ObjBiDoubleFunction<T, R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ObjBiDoubleFunction} into a total {@link ObjBiDoubleFunction} that returns an {@link
     * Optional} result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ObjBiDoubleFunction} lifted into a total {@code ObjBiDoubleFunction} that returns an
     * {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R> ObjBiDoubleFunction<T, Optional<R>> lift(
            @Nonnull ObjBiDoubleFunction<? super T, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, R> R call(@Nonnull ObjBiDoubleFunction<? super T, ? extends R> function, T t, double value1,
            double value2) {
     ...
     */
    @Nonnull
    static <T, R> ObjBiDoubleFunction<T, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjBiDoubleFunction<T, R> onlySecond(@Nonnull DoubleFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjBiDoubleFunction<T, R> onlyThird(@Nonnull DoubleFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiDoubleFunction<R> applyPartially(T t) {
     ...
     */
    @Nonnull
    default DoubleFunction2<R> applyPartially(T t, double value1) {
     ...
     */
    @Nonnull
    default ObjDoubleFunction<T, R> applyPartially(double value1) {
     ...
     */
    @Nonnull
    default Function2<T, R> applyPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default <S> ObjBiDoubleFunction<T, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiDoubleConsumer<T> consume(@Nonnull Consumer<? super R> consumer) {
    ...
    @Deprecated
    @Nonnull
    default ObjBiDoubleFunction<T, Optional<R>> nonNull() {
     ...
     * ObjBiDoubleFunction} with methods provided by the {@code JDK}.
     *
