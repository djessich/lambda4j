...
public interface ThrowableTriByteToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriByteToDoubleFunction<X> of(
            @Nullable ThrowableTriByteToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull ThrowableTriByteToDoubleFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriBytePredicate<X> andThenToBoolean(@Nonnull ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriByteToDoubleFunction<X> reversed() {
     ...
     * this {@code ThrowableTriByteToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriByteToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link TriByteToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default TriByteToDoubleFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriByteToDoubleFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriByteToDoubleFunction function = recover.apply(throwable);
