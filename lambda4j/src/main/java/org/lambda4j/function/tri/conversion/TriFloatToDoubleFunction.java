...
/**
 * Represents an operation that accepts three {@code float}-valued input arguments and produces a {@code double}-valued
...
@FunctionalInterface
public interface TriFloatToDoubleFunction extends Lambda {

    /**
     * Constructs a {@link TriFloatToDoubleFunction} based on a lambda expression or a method reference. Thereby the
     * given lambda expression or method reference is returned on an as-is basis to implicitly transform it to the
     * desired type. With this method, it is possible to ensure that correct type is used from lambda expression or
     * method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriFloatToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static TriFloatToDoubleFunction of(@Nullable TriFloatToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    static double call(@Nonnull TriFloatToDoubleFunction function, float value1, float value2, float value3) {
     ...
     */
    @Nonnull
    static TriFloatToDoubleFunction onlyFirst(@Nonnull FloatToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriFloatToDoubleFunction onlySecond(@Nonnull FloatToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriFloatToDoubleFunction onlyThird(@Nonnull FloatToDoubleFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B, C> ToDoubleTriFunction<A, B, C> compose(@Nonnull ToFloatFunction<? super A> before1,
            @Nonnull ToFloatFunction<? super B> before2, @Nonnull ToFloatFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> applyAsDouble(before1.applyAsFloat(a), before2.applyAsFloat(b), before3.applyAsFloat(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanToDoubleFunction composeFromBoolean(@Nonnull BooleanToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriByteToDoubleFunction composeFromByte(@Nonnull ByteToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriCharToDoubleFunction composeFromChar(@Nonnull CharToFloatFunction before1,
     ...
     */
    @Nonnull
    default DoubleTernaryOperator composeFromDouble(@Nonnull DoubleToFloatFunction before1,
    ...
    /**
     * Returns a composed {@link TriFloatToDoubleFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code TriFloatToDoubleFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     */
    @Nonnull
    default TriFloatToDoubleFunction composeFromFloat(@Nonnull FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriIntToDoubleFunction composeFromInt(@Nonnull IntToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction composeFromLong(@Nonnull LongToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriShortToDoubleFunction composeFromShort(@Nonnull ShortToFloatFunction before1,
     ...
     */
    @Nonnull
    default <S> TriFloatFunction<S> andThen(@Nonnull DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriFloatPredicate andThenToBoolean(@Nonnull DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToByteFunction andThenToByte(@Nonnull DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToCharFunction andThenToChar(@Nonnull DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction andThenToDouble(@Nonnull DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatTernaryOperator andThenToFloat(@Nonnull DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToIntFunction andThenToInt(@Nonnull DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToLongFunction andThenToLong(@Nonnull DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToShortFunction andThenToShort(@Nonnull DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatConsumer consume(@Nonnull DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction reversed() {
    ...
    default TriFloatToDoubleFunction memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<Float, Float, Float>, Double> cache = new ConcurrentHashMap<>();
     ...
     * TriFloatToDoubleFunction} with methods provided by the {@code JDK}.
     *
