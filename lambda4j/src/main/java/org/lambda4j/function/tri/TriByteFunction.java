...
/**
 * Represents an operation that accepts three {@code byte}-valued input arguments and produces a result. This is a
...
@FunctionalInterface
public interface TriByteFunction<R> extends Lambda {

    /**
     * Constructs a {@link TriByteFunction} based on a lambda expression or a method reference. Thereby the given lambda
     * expression or method reference is returned on an as-is basis to implicitly transform it to the desired type. With
     * this method, it is possible to ensure that correct type is used from lambda expression or method reference.
     *
     * @param <R> The type of return value from the function
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriByteFunction} from given lambda expression or method reference.
    ...
    /**
     * Constructs a {@link TriByteFunction} based on a curried lambda expression. Thereby the given curried lambda
     ...
     * value3)}
     * @return A {@code TriByteFunction} from given curried lambda expression.
     * @implNote This implementation allows the given argument to be {@code null}, but only if {@code null} given,
     * {@code null} will be returned.
     * @see <a href="https://docs.oracle.com/javase/tutorial/java/javaOO/lambdaexpressions.html#syntax">Lambda
     * Expression</a>
    ...
    @CheckForNull
    @Nullable
    static <R> TriByteFunction<R> of(@Nullable ByteFunction<ByteFunction<ByteFunction<R>>> curried) {
    ...
    /**
     * Lifts a partial {@link TriByteFunction} into a total {@link TriByteFunction} that returns an {@link Optional}
     * result.
     *
     * @param <R> The type of return value from the function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code TriByteFunction} lifted into a total {@code TriByteFunction} that returns an {@code
     * Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriByteFunction<Optional<R>> lift(@Nonnull TriByteFunction<? extends R> partial) {
        Objects.requireNonNull(partial);
        return (value1, value2, value3) -> Optional.ofNullable(partial.apply(value1, value2, value3));
    }

    /**
     * Calls the given {@link TriByteFunction} with the given arguments and returns its result.
     *
     * @param <R> The type of return value from the function
     ...
     * @return The result from the given {@code TriByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <R> R call(@Nonnull TriByteFunction<? extends R> function, byte value1, byte value2, byte value3) {
        Objects.requireNonNull(function);
        return function.apply(value1, value2, value3);
    }

    /**
     * Creates a {@link TriByteFunction} which uses the {@code first} parameter of this one as argument for the given
     * {@link ByteFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code TriByteFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@code ByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriByteFunction<R> onlyFirst(@Nonnull ByteFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (value1, value2, value3) -> function.apply(value1);
    }

    /**
     * Creates a {@link TriByteFunction} which uses the {@code second} parameter of this one as argument for the given
     * {@link ByteFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code TriByteFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@code ByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriByteFunction<R> onlySecond(@Nonnull ByteFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (value1, value2, value3) -> function.apply(value2);
    }

    /**
     * Creates a {@link TriByteFunction} which uses the {@code third} parameter of this one as argument for the given
     * {@link ByteFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code TriByteFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@code ByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriByteFunction<R> onlyThird(@Nonnull ByteFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (value1, value2, value3) -> function.apply(value3);
    }

    /**
     * Creates a {@link TriByteFunction} which always returns a given value.
     *
     * @param <R> The type of return value from the function
     * @param ret The return value for the constant
     * @return A {@code TriByteFunction} which always returns a given value.
     */
    @Nonnull
    static <R> TriByteFunction<R> constant(R ret) {
     ...
     */
    @Nonnull
    default <A, B, C> TriFunction<A, B, C, R> compose(@Nonnull ToByteFunction<? super A> before1,
            @Nonnull ToByteFunction<? super B> before2, @Nonnull ToByteFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> apply(before1.applyAsByte(a), before2.applyAsByte(b), before3.applyAsByte(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanFunction<R> composeFromBoolean(@Nonnull BooleanToByteFunction before1,
    ...
    /**
     * Returns a composed {@link TriByteFunction} that first applies the {@code before} operators to its input, and then
     * applies this function to the result. If evaluation of either operation throws an exception, it is relayed to the
     ...
     * @return A composed {@code TriByteFunction} that first applies the {@code before} operators to its input, and then
     * applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default TriByteFunction<R> composeFromByte(@Nonnull ByteUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriCharFunction<R> composeFromChar(@Nonnull CharToByteFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> composeFromDouble(@Nonnull DoubleToByteFunction before1,
     ...
     */
    @Nonnull
    default TriFloatFunction<R> composeFromFloat(@Nonnull FloatToByteFunction before1,
     ...
     */
    @Nonnull
    default TriIntFunction<R> composeFromInt(@Nonnull IntToByteFunction before1,
     ...
     */
    @Nonnull
    default TriLongFunction<R> composeFromLong(@Nonnull LongToByteFunction before1,
     ...
     */
    @Nonnull
    default TriShortFunction<R> composeFromShort(@Nonnull ShortToByteFunction before1,
     ...
     */
    @Nonnull
    default <S> TriByteFunction<S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default TriBytePredicate andThenToBoolean(@Nonnull Predicate<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteTernaryOperator andThenToByte(@Nonnull ToByteFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriByteToCharFunction andThenToChar(@Nonnull ToCharFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriByteToDoubleFunction andThenToDouble(@Nonnull ToDoubleFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriByteToFloatFunction andThenToFloat(@Nonnull ToFloatFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriByteToIntFunction andThenToInt(@Nonnull ToIntFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriByteToLongFunction andThenToLong(@Nonnull ToLongFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriByteToShortFunction andThenToShort(@Nonnull ToShortFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriByteConsumer consume(@Nonnull Consumer<? super R> consumer) {
     ...
     */
    @Nonnull
    default TriByteFunction<R> reversed() {
    ...
    @Deprecated
    @Nonnull
    default TriByteFunction<Optional<R>> nonNull() {
        return (value1, value2, value3) -> Optional.ofNullable(apply(value1, value2, value3));
    }

    /**
     * Returns a composed {@link TriFunction} which represents this {@link TriByteFunction}. Thereby the primitive input
     * argument for this function is autoboxed. This method provides the possibility to use this {@code TriByteFunction}
     * with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code TriByteFunction}.
     */
    @Nonnull
