...
@FunctionalInterface
public interface TriBooleanToByteFunction extends Lambda {

    /**
     * Constructs a {@link TriBooleanToByteFunction} based on a lambda expression or a method reference. Thereby the
     * given lambda expression or method reference is returned on an as-is basis to implicitly transform it to the
     * desired type. With this method, it is possible to ensure that correct type is used from lambda expression or
     * method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriBooleanToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static TriBooleanToByteFunction of(@Nullable TriBooleanToByteFunction expression) {
        return expression;
    }
     ...
     */
    static byte call(@Nonnull TriBooleanToByteFunction function, boolean value1, boolean value2, boolean value3) {
     ...
     */
    @Nonnull
    static TriBooleanToByteFunction onlyFirst(@Nonnull BooleanToByteFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriBooleanToByteFunction onlySecond(@Nonnull BooleanToByteFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriBooleanToByteFunction onlyThird(@Nonnull BooleanToByteFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiBooleanToByteFunction applyAsBytePartially(boolean value1) {
     ...
     */
    @Nonnull
    default BooleanToByteFunction applyAsBytePartially(boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    default <A, B, C> ToByteTriFunction<A, B, C> compose(@Nonnull Predicate<? super A> before1,
    ...
    /**
     * Returns a composed {@link TriBooleanToByteFunction} that first applies the {@code before} operators to its input,
     ...
     * @return A composed {@code TriBooleanToByteFunction} that first applies the {@code before} operators to its input,
     ...
     */
    @Nonnull
    default TriBooleanToByteFunction composeFromBoolean(@Nonnull BooleanUnaryOperator before1,
    ...
    /**
     * Returns a composed {@link ByteTernaryOperator} that first applies the {@code before} predicates to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     ...
     * @param before2 The second predicate to apply before this function is applied
     * @param before3 The third predicate to apply before this function is applied
     * @return A composed {@code ByteTernaryOperator} that first applies the {@code before} predicates to its input, and
     * then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default ByteTernaryOperator composeFromByte(@Nonnull BytePredicate before1,
    ...
    /**
     * Returns a composed {@link TriCharToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @param before2 The second predicate to apply before this function is applied
     * @param before3 The third predicate to apply before this function is applied
     * @return A composed {@code TriCharToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * char}.
     */
    @Nonnull
    default TriCharToByteFunction composeFromChar(@Nonnull CharPredicate before1,
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction composeFromDouble(@Nonnull DoublePredicate before1,
    ...
    /**
     * Returns a composed {@link TriFloatToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @param before2 The second predicate to apply before this function is applied
     * @param before3 The third predicate to apply before this function is applied
     * @return A composed {@code TriFloatToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     */
    @Nonnull
    default TriFloatToByteFunction composeFromFloat(@Nonnull FloatPredicate before1,
    ...
    /**
     * Returns a composed {@link TriIntToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default TriIntToByteFunction composeFromInt(@Nonnull IntPredicate before1,
    ...
    /**
     * Returns a composed {@link TriLongToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @param before2 The second predicate to apply before this function is applied
     * @param before3 The third predicate to apply before this function is applied
     * @return A composed {@code TriLongToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     */
    @Nonnull
    default TriLongToByteFunction composeFromLong(@Nonnull LongPredicate before1,
    ...
    /**
     * Returns a composed {@link TriShortToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @param before2 The second predicate to apply before this function is applied
     * @param before3 The third predicate to apply before this function is applied
     * @return A composed {@code TriShortToByteFunction} that first applies the {@code before} predicates to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default TriShortToByteFunction composeFromShort(@Nonnull ShortPredicate before1,
     ...
     */
    @Nonnull
    default <S> TriBooleanFunction<S> andThen(@Nonnull ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BooleanTernaryOperator andThenToBoolean(@Nonnull BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToByteFunction andThenToByte(@Nonnull ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToCharFunction andThenToChar(@Nonnull ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToDoubleFunction andThenToDouble(@Nonnull ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToFloatFunction andThenToFloat(@Nonnull ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToIntFunction andThenToInt(@Nonnull ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToLongFunction andThenToLong(@Nonnull ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanToShortFunction andThenToShort(@Nonnull ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriBooleanConsumer consume(@Nonnull ByteConsumer consumer) {
     ...
     */
    @Nonnull
    default TriBooleanToByteFunction reversed() {
        return (value3, value2, value1) -> applyAsByte(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link TriBooleanToByteFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code TriBooleanToByteFunction}.
    ...
    default TriBooleanToByteFunction memoized() {
        if (isMemoized()) {
            ...
            return (TriBooleanToByteFunction & Memoized) (value1, value2, value3) -> {
     ...
     * TriBooleanToByteFunction} with methods provided by the {@code JDK}.
     *
