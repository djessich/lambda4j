...
import org.lambda4j.function.bi.obj.ObjFloatToDoubleFunction;
 ...
 * {@code double}-valued result. This is a (reference, reference, float) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDouble(Object, Object, float)}.
 *
...
@FunctionalInterface
public interface BiObjFloatToDoubleFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjFloatToDoubleFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjFloatToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjFloatToDoubleFunction<T, U> of(@Nullable BiObjFloatToDoubleFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjFloatToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjFloatToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> double call(@Nonnull BiObjFloatToDoubleFunction<? super T, ? super U> function, T t, U u,
            float value) {
    ...
    /**
     * Creates a {@link BiObjFloatToDoubleFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjFloatToDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjFloatToDoubleFunction<T, U> onlyFirst(@Nonnull ToDoubleFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsDouble(t);
    }

    /**
     * Creates a {@link BiObjFloatToDoubleFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjFloatToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjFloatToDoubleFunction<T, U> onlySecond(@Nonnull ToDoubleFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsDouble(u);
    }

    /**
     * Creates a {@link BiObjFloatToDoubleFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link FloatToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjFloatToDoubleFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code FloatToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjFloatToDoubleFunction<T, U> onlyThird(@Nonnull FloatToDoubleFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsDouble(value);
    }

    /**
     * Creates a {@link BiObjFloatToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjFloatToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjFloatToDoubleFunction<T, U> constant(double ret) {
     ...
     */
    double applyAsDouble(T t, U u, float value);
     ...
     */
    default double applyAsDouble(@Nonnull Pair<T, U> tuple, float value) {
        Objects.requireNonNull(tuple);
        return applyAsDouble(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ObjFloatToDoubleFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default ObjFloatToDoubleFunction<U> applyAsDoublePartially(T t) {
     ...
     */
    @Nonnull
    default FloatToDoubleFunction applyAsDoublePartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToDoubleBiFunction2<T, U> applyAsDoublePartially(float value) {
     ...
     */
    @Nonnull
    default ToDoubleFunction2<U> applyAsDoublePartially(T t, float value) {
    ...
    default <A, B, C> ToDoubleTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsDouble(before1.apply(a), before2.apply(b), before3.applyAsFloat(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjFloatFunction<T, U, S> andThen(@Nonnull DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjFloatPredicate<T, U> andThenToBoolean(@Nonnull DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToByteFunction<T, U> andThenToByte(@Nonnull DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToCharFunction<T, U> andThenToChar(@Nonnull DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToDoubleFunction<T, U> andThenToDouble(@Nonnull DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToFloatFunction<T, U> andThenToFloat(@Nonnull DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToIntFunction<T, U> andThenToInt(@Nonnull DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToLongFunction<T, U> andThenToLong(@Nonnull DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToShortFunction<T, U> andThenToShort(@Nonnull DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatConsumer<T, U> consume(@Nonnull DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjFloatToDoubleFunction<Pair<T, U>> tupled() {
        return this::applyAsDouble;
    }

    /**
     * Returns a memoized (caching) version of this {@link BiObjFloatToDoubleFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiObjFloatToDoubleFunction}.
     ...
     */
    @Nonnull
    default BiObjFloatToDoubleFunction<T, U> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Float>, Double> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (BiObjFloatToDoubleFunction<T, U> & Memoized) (t, u, value) -> {
                double returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjFloatToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjFloatToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjFloatToDoubleFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Float, Double> boxed() {
        return this::applyAsDouble;
    }
