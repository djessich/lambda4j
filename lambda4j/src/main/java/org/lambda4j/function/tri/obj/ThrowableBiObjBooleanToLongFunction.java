...
public interface ThrowableBiObjBooleanToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToLongFunction<T, U, X> of(
            @Nullable ThrowableBiObjBooleanToLongFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> long call(
            @Nonnull ThrowableBiObjBooleanToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjBooleanToLongFunction<U, X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableBooleanToLongFunction<X> applyAsLongThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToLongBiFunction<T, U, X> applyAsLongThrowsPartially(boolean value) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<U, X> applyAsLongThrowsPartially(T t, boolean value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanConsumer<T, U, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     * ThrowableBiObjBooleanToLongFunction}.
     */
    @Nonnull
    ...
    default BiObjBooleanToLongFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjBooleanToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjBooleanToLongFunction<? super T, ? super U> function = recover.apply(throwable);
