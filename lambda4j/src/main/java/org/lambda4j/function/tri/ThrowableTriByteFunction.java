...
/**
 * Represents an operation that accepts three {@code byte}-valued input arguments and produces a result which is able to
...
public interface ThrowableTriByteFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableTriByteFunction<R, X> of(
            @Nullable ThrowableTriByteFunction<R, X> expression) {
        return expression;
    }

    /**
     * Constructs a {@link ThrowableTriByteFunction} based on a curried lambda expression. Thereby the given curried
     ...
     * value3)}
     * @return A {@code ThrowableTriByteFunction} from given curried lambda expression.
    ...
    @Nullable
    static <R, X extends Throwable> ThrowableTriByteFunction<R, X> of(
            @Nullable ThrowableByteFunction<ThrowableByteFunction<ThrowableByteFunction<R, X>, X>, X> curried)
            throws X {
    ...
    static <R, X extends Throwable> ThrowableTriByteFunction<Optional<R>, X> lift(
            @Nonnull ThrowableTriByteFunction<? extends R, ? extends X> partial) {
     ...
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableTriByteFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiByteFunction<R, X> applyThrowsPartially(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableByteFunction<R, X> applyThrowsPartially(byte value1, byte value2) {
    ...
    /**
     * Returns a composed {@link ThrowableTriByteFunction} that first applies the {@code before} operators to its input,
     ...
     */
    @Nonnull
    default ThrowableTriIntFunction<R, X> composeFromInt(@Nonnull ThrowableIntToByteFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriBytePredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriByteFunction<R, X> reversed() {
    ...
    @Deprecated
    @Nonnull
    default ThrowableTriByteFunction<Optional<R>, X> nonNull() {
     ...
     * {@code ThrowableTriByteFunction} with methods provided by the {@code JDK}.
     *
    ...
    default TriByteFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends TriByteFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriByteFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriByteFunction} that applies this function to its input and sneakily throws the thrown
