...
public interface ThrowableObjBiByteToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToShortFunction<T, X> of(
            @Nullable ThrowableObjBiByteToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull ThrowableObjBiByteToShortFunction<? super T, ? extends X> function, T t, byte value1,
     ...
     */
    @Nonnull
    default ThrowableBiByteToShortFunction<X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToShortFunction<X> applyAsShortThrowsPartially(T t, byte value1) {
     ...
     */
    @Nonnull
    default ThrowableObjByteToShortFunction<T, X> applyAsShortThrowsPartially(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> applyAsShortThrowsPartially(byte value1, byte value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjBiByteToShortFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBiByteToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiByteToShortFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiByteToShortFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiByteToShortFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiByteToShortFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiByteToShortFunction<? super T> function = recover.apply(throwable);
