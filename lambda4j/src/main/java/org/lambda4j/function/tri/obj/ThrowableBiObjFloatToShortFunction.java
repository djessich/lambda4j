 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, float)
...
public interface ThrowableBiObjFloatToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToShortFunction<T, U, X> of(
            @Nullable ThrowableBiObjFloatToShortFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> short call(
            @Nonnull ThrowableBiObjFloatToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjFloatToShortFunction<U, X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToShortFunction<X> applyAsShortThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToShortBiFunction<T, U, X> applyAsShortThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<U, X> applyAsShortThrowsPartially(T t, float value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
    ...
    default BiObjFloatToShortFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjFloatToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjFloatToShortFunction<? super T, ? super U> function = recover.apply(throwable);
