 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, double)
...
public interface ThrowableBiObjDoubleToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToCharFunction<T, U, X> of(
            @Nullable ThrowableBiObjDoubleToCharFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> char call(
            @Nonnull ThrowableBiObjDoubleToCharFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToCharFunction<U, X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToCharFunction<X> applyAsCharThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToCharBiFunction<T, U, X> applyAsCharThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<U, X> applyAsCharThrowsPartially(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableBiObjDoubleToCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjDoubleToCharFunction} that applies this function to its input and nests the thrown
    ...
    default BiObjDoubleToCharFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleToCharFunction<? super T, ? super U> function = recover.apply(throwable);
