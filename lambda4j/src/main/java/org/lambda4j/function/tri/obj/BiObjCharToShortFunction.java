 ...
 * {@code short}-valued result. This is a (reference, reference, char) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShort(Object, Object, char)}.
 *
...
@FunctionalInterface
public interface BiObjCharToShortFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjCharToShortFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjCharToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjCharToShortFunction<T, U> of(@Nullable BiObjCharToShortFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjCharToShortFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjCharToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> short call(@Nonnull BiObjCharToShortFunction<? super T, ? super U> function, T t, U u,
            char value) {
    ...
    /**
     * Creates a {@link BiObjCharToShortFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjCharToShortFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjCharToShortFunction<T, U> onlyFirst(@Nonnull ToShortFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsShort(t);
    }

    /**
     * Creates a {@link BiObjCharToShortFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjCharToShortFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjCharToShortFunction<T, U> onlySecond(@Nonnull ToShortFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsShort(u);
    }

    /**
     * Creates a {@link BiObjCharToShortFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link CharToShortFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjCharToShortFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code CharToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjCharToShortFunction<T, U> onlyThird(@Nonnull CharToShortFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsShort(value);
    }

    /**
     * Creates a {@link BiObjCharToShortFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjCharToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjCharToShortFunction<T, U> constant(short ret) {
     ...
     */
    short applyAsShort(T t, U u, char value);
     ...
     */
    default short applyAsShort(@Nonnull Pair<T, U> tuple, char value) {
        Objects.requireNonNull(tuple);
        return applyAsShort(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ObjCharToShortFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default ObjCharToShortFunction<U> applyAsShortPartially(T t) {
     ...
     */
    @Nonnull
    default CharToShortFunction applyAsShortPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToShortBiFunction<T, U> applyAsShortPartially(char value) {
     ...
     */
    @Nonnull
    default ToShortFunction<U> applyAsShortPartially(T t, char value) {
    ...
    default <A, B, C> ToShortTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsShort(before1.apply(a), before2.apply(b), before3.applyAsChar(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjCharFunction<T, U, S> andThen(@Nonnull ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjCharPredicate<T, U> andThenToBoolean(@Nonnull ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToByteFunction<T, U> andThenToByte(@Nonnull ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToCharFunction<T, U> andThenToChar(@Nonnull ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToDoubleFunction<T, U> andThenToDouble(@Nonnull ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToFloatFunction<T, U> andThenToFloat(@Nonnull ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToIntFunction<T, U> andThenToInt(@Nonnull ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToLongFunction<T, U> andThenToLong(@Nonnull ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharToShortFunction<T, U> andThenToShort(@Nonnull ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjCharConsumer<T, U> consume(@Nonnull ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjCharToShortFunction<Pair<T, U>> tupled() {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjCharToShortFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjCharToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjCharToShortFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Character, Short> boxed() {
        return this::applyAsShort;
    }
