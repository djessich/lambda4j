...
@FunctionalInterface
public interface ThrowableTriBooleanFunction<R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriBooleanFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableTriBooleanFunction} from given lambda expression or method reference.
    ...
    /**
     * Constructs a {@link ThrowableTriBooleanFunction} based on a curried lambda expression. Thereby the given curried
     ...
     * value3)}
     * @return A {@code ThrowableTriBooleanFunction} from given curried lambda expression.
    ...
    @Nullable
    static <R, X extends Throwable> ThrowableTriBooleanFunction<R, X> of(
            @Nullable ThrowableBooleanFunction<ThrowableBooleanFunction<ThrowableBooleanFunction<R, X>, X>, X> curried)
            throws X {
    ...
    /**
     * Lifts a partial {@link ThrowableTriBooleanFunction} into a total {@link ThrowableTriBooleanFunction} that returns
     * an {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ThrowableTriBooleanFunction} lifted into a total {@code ThrowableTriBooleanFunction}
     * that returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriBooleanFunction<Optional<R>, X> lift(
            @Nonnull ThrowableTriBooleanFunction<? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (value1, value2, value3) -> Optional.ofNullable(partial.applyThrows(value1, value2, value3));
    }

    /**
     * Calls the given {@link ThrowableTriBooleanFunction} with the given arguments and returns its result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriBooleanFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(
            @Nonnull ThrowableTriBooleanFunction<? extends R, ? extends X> function, boolean value1,
            boolean value2, boolean value3) throws X {
        Objects.requireNonNull(function);
        return function.applyThrows(value1, value2, value3);
    }

    /**
     * Creates a {@link ThrowableTriBooleanFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableBooleanFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriBooleanFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableBooleanFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriBooleanFunction<R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriBooleanFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableBooleanFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriBooleanFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableBooleanFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriBooleanFunction<R, X> onlySecond(
            @Nonnull ThrowableBooleanFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriBooleanFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableBooleanFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriBooleanFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableBooleanFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriBooleanFunction<R, X> onlyThird(
            @Nonnull ThrowableBooleanFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriBooleanFunction} which always returns a given value.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriBooleanFunction} which always returns a given value.
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriBooleanFunction<R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(boolean value1, boolean value2, boolean value3) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableBiBooleanFunction} as
     * result.
     *
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} that first applies the {@code before} predicates to its input,
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.testThrows(a), before2.testThrows(b), before3.testThrows(c));
    }

    /**
     * Returns a composed {@link ThrowableTriBooleanFunction} that first applies the {@code before} operators to its
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyAsBooleanThrows(value1),
     ...
     */
    @Nonnull
    default ThrowableTriByteFunction<R, X> composeFromByte(@Nonnull ThrowableBytePredicate<? extends X> before1,
            @Nonnull ThrowableBytePredicate<? extends X> before2,
            @Nonnull ThrowableBytePredicate<? extends X> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.testThrows(value1), before2.testThrows(value2),
     ...
     */
    @Nonnull
    default ThrowableTriCharFunction<R, X> composeFromChar(@Nonnull ThrowableCharPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriDoubleFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link ThrowableTriFloatFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableTriIntFunction<R, X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriLongFunction<R, X> composeFromLong(@Nonnull ThrowableLongPredicate<? extends X> before1,
    ...
    /**
     * Returns a composed {@link ThrowableTriShortFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableTriBooleanConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBooleanFunction<ThrowableBooleanFunction<ThrowableBooleanFunction<R, X>, X>, X> curried() {
     ...
     */
    @Nonnull
    default ThrowableTriBooleanFunction<R, X> reversed() {
        return (value3, value2, value1) -> applyThrows(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableTriBooleanFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriBooleanFunction}.
    ...
    default ThrowableTriBooleanFunction<R, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<Boolean, Boolean, Boolean>, R> cache = new ConcurrentHashMap<>();
            return (ThrowableTriBooleanFunction<R, X> & Memoized) (value1, value2, value3) -> {
     ...
     */
    @Nonnull
    default ThrowableTriFunction<Boolean, Boolean, Boolean, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link TriBooleanFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriBooleanFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
    ...
    default TriBooleanFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends TriBooleanFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriBooleanFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriBooleanFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriBooleanFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriBooleanFunction<R> sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyThrows(value1, value2, value3);
