...
public interface ThrowableBiObjFloatToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> long call(
            @Nonnull ThrowableBiObjFloatToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjFloatToLongFunction<U, X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToLongFunction<X> applyAsLongThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToLongBiFunction<T, U, X> applyAsLongThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<U, X> applyAsLongThrowsPartially(T t, float value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
    ...
    default BiObjFloatToLongFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjFloatToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjFloatToLongFunction<? super T, ? super U> function = recover.apply(throwable);
