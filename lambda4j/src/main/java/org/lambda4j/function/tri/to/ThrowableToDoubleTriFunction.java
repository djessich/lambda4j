...
@FunctionalInterface
public interface ThrowableToDoubleTriFunction<T, U, V, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableToDoubleTriFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableToDoubleTriFunction} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link ThrowableToDoubleTriFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <V> The type of the third argument to the function
     ...
     * @return The result from the given {@code ThrowableToDoubleTriFunction}.
    ...
    /**
     * Creates a {@link ThrowableToDoubleTriFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableToDoubleTriFunction} which uses the {@code first} parameter of this one as
    ...
    /**
     * Creates a {@link ThrowableToDoubleTriFunction} which uses the {@code second} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableToDoubleTriFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    ...
    /**
     * Creates a {@link ThrowableToDoubleTriFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableToDoubleTriFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    ...
    /**
     * Creates a {@link ThrowableToDoubleTriFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <V> The type of the third argument to the function
     ...
     * @return A {@code ThrowableToDoubleTriFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToDoubleTriFunction<T, U, V, X> constant(double ret) {
        return (t, u, v) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, U u, V v) throws X;
    ...
    default <A, B, C> ThrowableToDoubleTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsDoubleThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyThrows(c));
    }
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<Triple<T, U, V>, X> tupled() {
     ...
     */
    @Nonnull
    default ThrowableToDoubleTriFunction<V, U, T, X> reversed() {
        return (v, u, t) -> applyAsDoubleThrows(t, u, v);
    }
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableToDoubleTriFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableToDoubleTriFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableToDoubleTriFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, V, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link ToDoubleTriFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ToDoubleTriFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ToDoubleTriFunction<T, U, V> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ToDoubleTriFunction} that first applies this function to its input, and then applies
    ...
    /**
     * Returns a composed {@link ToDoubleTriFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ToDoubleTriFunction} that applies this function to its input and sneakily throws the
