 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, short, short)
...
public interface ThrowableObjBiShortToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToCharFunction<T, X> of(
            @Nullable ThrowableObjBiShortToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjBiShortToCharFunction<? super T, ? extends X> function, T t, short value1,
     ...
     */
    @Nonnull
    default ThrowableBiShortToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToCharFunction<X> applyAsCharThrowsPartially(T t, short value1) {
     ...
     */
    @Nonnull
    default ThrowableObjShortToCharFunction<T, X> applyAsCharThrowsPartially(short value1) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(short value1, short value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiShortToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiShortToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiShortToCharFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiShortToCharFunction<? super T> function = recover.apply(throwable);
