 ...
 * {@code float}-valued result. This is a (reference, reference, long) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloat(Object, Object, long)}.
 *
...
@FunctionalInterface
public interface BiObjLongToFloatFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjLongToFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjLongToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjLongToFloatFunction<T, U> of(@Nullable BiObjLongToFloatFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjLongToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjLongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> float call(@Nonnull BiObjLongToFloatFunction<? super T, ? super U> function, T t, U u,
            long value) {
    ...
    /**
     * Creates a {@link BiObjLongToFloatFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjLongToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToFloatFunction<T, U> onlyFirst(@Nonnull ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsFloat(t);
    }

    /**
     * Creates a {@link BiObjLongToFloatFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjLongToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToFloatFunction<T, U> onlySecond(@Nonnull ToFloatFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsFloat(u);
    }

    /**
     * Creates a {@link BiObjLongToFloatFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link LongToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjLongToFloatFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code LongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToFloatFunction<T, U> onlyThird(@Nonnull LongToFloatFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsFloat(value);
    }

    /**
     * Creates a {@link BiObjLongToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjLongToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjLongToFloatFunction<T, U> constant(float ret) {
     ...
     */
    float applyAsFloat(T t, U u, long value);
     ...
     */
    default float applyAsFloat(@Nonnull Pair<T, U> tuple, long value) {
    ...
    default <A, B, C> ToFloatTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsFloat(before1.apply(a), before2.apply(b), before3.applyAsLong(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjLongFunction<T, U, S> andThen(@Nonnull FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjLongPredicate<T, U> andThenToBoolean(@Nonnull FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> andThenToByte(@Nonnull FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToCharFunction<T, U> andThenToChar(@Nonnull FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> andThenToDouble(@Nonnull FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToFloatFunction<T, U> andThenToFloat(@Nonnull FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToIntFunction<T, U> andThenToInt(@Nonnull FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToLongFunction<T, U> andThenToLong(@Nonnull FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToShortFunction<T, U> andThenToShort(@Nonnull FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> consume(@Nonnull FloatConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjLongToFloatFunction<Pair<T, U>> tupled() {
    ...
    default BiObjLongToFloatFunction<T, U> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Long>, Float> cache = new ConcurrentHashMap<>();
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjLongToFloatFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjLongToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjLongToFloatFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Long, Float> boxed() {
        return this::applyAsFloat;
    }
