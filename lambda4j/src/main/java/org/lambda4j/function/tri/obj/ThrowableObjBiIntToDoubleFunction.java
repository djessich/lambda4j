 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, int, int)
...
public interface ThrowableObjBiIntToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToDoubleFunction<T, X> of(
            @Nullable ThrowableObjBiIntToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjBiIntToDoubleFunction<? super T, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiIntToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiIntToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiIntToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiIntToDoubleFunction<? super T> function = recover.apply(throwable);
