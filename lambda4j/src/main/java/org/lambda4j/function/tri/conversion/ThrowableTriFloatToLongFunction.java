...
public interface ThrowableTriFloatToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriFloatToLongFunction<X> of(
            @Nullable ThrowableTriFloatToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull ThrowableTriFloatToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriFloatToLongFunction<X> reversed() {
     ...
     */
    @Nonnull
    default TriFloatToLongFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriFloatToLongFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriFloatToLongFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriFloatToLongFunction function = recover.apply(throwable);
