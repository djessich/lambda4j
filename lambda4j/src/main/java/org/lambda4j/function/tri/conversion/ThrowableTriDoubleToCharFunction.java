...
public interface ThrowableTriDoubleToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToCharFunction<X> of(
            @Nullable ThrowableTriDoubleToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull ThrowableTriDoubleToCharFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToCharFunction<X> applyAsCharThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToCharFunction<X> applyAsCharThrowsPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableTriDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriDoubleToCharFunction<X> reversed() {
     ...
     * this {@code ThrowableTriDoubleToCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriDoubleToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriDoubleToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriDoubleToCharFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriDoubleToCharFunction function = recover.apply(throwable);
