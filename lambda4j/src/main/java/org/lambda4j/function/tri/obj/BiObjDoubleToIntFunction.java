 ...
 * {@code int}-valued result. This is a (reference, reference, double) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsInt(Object, Object, double)}.
 *
...
@FunctionalInterface
public interface BiObjDoubleToIntFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjDoubleToIntFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjDoubleToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjDoubleToIntFunction<T, U> of(@Nullable BiObjDoubleToIntFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjDoubleToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjDoubleToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> int call(@Nonnull BiObjDoubleToIntFunction<? super T, ? super U> function, T t, U u,
            double value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToIntFunction<T, U> onlyFirst(@Nonnull ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToIntFunction<T, U> onlySecond(@Nonnull ToIntFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToIntFunction<T, U> onlyThird(@Nonnull DoubleToIntFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsInt(value);
    }

    /**
     * Creates a {@link BiObjDoubleToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjDoubleToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjDoubleToIntFunction<T, U> constant(int ret) {
     ...
     */
    int applyAsInt(T t, U u, double value);
     ...
     */
    @Nonnull
    default ObjDoubleToIntFunction<U> applyAsIntPartially(T t) {
     ...
     */
    @Nonnull
    default DoubleToIntFunction2 applyAsIntPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> applyAsIntPartially(double value) {
     ...
     */
    @Nonnull
    default ToIntFunction2<U> applyAsIntPartially(T t, double value) {
    ...
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsInt(before1.apply(a), before2.apply(b), before3.applyAsDouble(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjDoubleFunction<T, U, S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToByteFunction<T, U> andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToCharFunction<T, U> andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToFloatFunction<T, U> andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToIntFunction<T, U> andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToLongFunction<T, U> andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToShortFunction<T, U> andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleConsumer<T, U> consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjDoubleToIntFunction<Pair<T, U>> tupled() {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjDoubleToIntFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjDoubleToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjDoubleToIntFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Double, Integer> boxed() {
        return this::applyAsInt;
    }
