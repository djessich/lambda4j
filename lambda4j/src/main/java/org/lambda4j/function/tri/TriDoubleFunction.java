...
public interface TriDoubleFunction<R> extends Lambda {
     ...
     */
    @Nonnull
    static <R> TriDoubleFunction<Optional<R>> lift(@Nonnull final TriDoubleFunction<? extends R> partial) {
     ...
     * {@code TriDoubleFunction} with methods provided by the {@code JDK}.
     *
