...
public interface ThrowableObjBiIntToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToIntFunction<T, X> of(
            @Nullable ThrowableObjBiIntToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjBiIntToIntFunction<? super T, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableIntBinaryOperator<X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> applyAsIntThrowsPartially(T t, int value1) {
     ...
     */
    @Nonnull
    default ThrowableObjIntToIntFunction<T, X> applyAsIntThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> applyAsIntThrowsPartially(int value1, int value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntPredicate<T, X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjBiIntToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBiIntToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiIntToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiIntToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjBiIntToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiIntToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiIntToIntFunction<? super T> function = recover.apply(throwable);
