...
@FunctionalInterface
public interface TriIntToShortFunction extends Lambda {

    /**
     * Constructs a {@link TriIntToShortFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriIntToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static TriIntToShortFunction of(@Nullable TriIntToShortFunction expression) {
        return expression;
    }
     ...
     */
    static short call(@Nonnull TriIntToShortFunction function, int value1, int value2, int value3) {
     ...
     */
    @Nonnull
    static TriIntToShortFunction onlyFirst(@Nonnull IntToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriIntToShortFunction onlySecond(@Nonnull IntToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriIntToShortFunction onlyThird(@Nonnull IntToShortFunction function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Applies this function partially to some arguments of this one, producing a {@link BiIntToShortFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default <A, B, C> ToShortTriFunction<A, B, C> compose(@Nonnull ToIntFunction<? super A> before1,
            @Nonnull ToIntFunction<? super B> before2, @Nonnull ToIntFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> applyAsShort(before1.applyAsInt(a), before2.applyAsInt(b), before3.applyAsInt(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanToShortFunction composeFromBoolean(@Nonnull BooleanToIntFunction before1,
     ...
     */
    @Nonnull
    default TriByteToShortFunction composeFromByte(@Nonnull ByteToIntFunction before1,
     ...
     */
    @Nonnull
    default TriCharToShortFunction composeFromChar(@Nonnull CharToIntFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction composeFromDouble(@Nonnull DoubleToIntFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToShortFunction composeFromFloat(@Nonnull FloatToIntFunction before1,
    ...
    /**
     * Returns a composed {@link TriIntToShortFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default TriIntToShortFunction composeFromInt(@Nonnull IntUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriLongToShortFunction composeFromLong(@Nonnull LongToIntFunction before1,
     ...
     */
    @Nonnull
    default ShortTernaryOperator composeFromShort(@Nonnull ShortToIntFunction before1,
     ...
     */
    @Nonnull
    default <S> TriIntFunction<S> andThen(@Nonnull ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriIntPredicate andThenToBoolean(@Nonnull ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntToByteFunction andThenToByte(@Nonnull ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntToCharFunction andThenToChar(@Nonnull ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntToDoubleFunction andThenToDouble(@Nonnull ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntToFloatFunction andThenToFloat(@Nonnull ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntTernaryOperator andThenToInt(@Nonnull ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntToLongFunction andThenToLong(@Nonnull ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntToShortFunction andThenToShort(@Nonnull ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriIntConsumer consume(@Nonnull ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default TriIntToShortFunction reversed() {
        return (value3, value2, value1) -> applyAsShort(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link TriIntToShortFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code TriIntToShortFunction}.
     ...
     */
    @Nonnull
    default TriIntToShortFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
     ...
     * TriIntToShortFunction} with methods provided by the {@code JDK}.
     *
