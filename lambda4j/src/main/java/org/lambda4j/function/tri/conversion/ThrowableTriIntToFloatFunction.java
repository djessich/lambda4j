 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(int, int, int)}.
 *
...
@FunctionalInterface
public interface ThrowableTriIntToFloatFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriIntToFloatFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableTriIntToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableTriIntToFloatFunction<X> of(
            @Nullable ThrowableTriIntToFloatFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriIntToFloatFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriIntToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> float call(@Nonnull ThrowableTriIntToFloatFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriIntToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableIntToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriIntToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableIntToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntToFloatFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriIntToFloatFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableIntToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriIntToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableIntToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntToFloatFunction<X> onlySecond(
            @Nonnull ThrowableIntToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriIntToFloatFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableIntToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriIntToFloatFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableIntToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntToFloatFunction<X> onlyThird(
            @Nonnull ThrowableIntToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriIntToFloatFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriIntToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriIntToFloatFunction<X> constant(float ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(int value1, int value2, int value3) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiIntToFloatFunction<X> applyAsFloatThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowableIntToFloatFunction<X> applyAsFloatThrowsPartially(int value1, int value2) {
    ...
    default <A, B, C> ThrowableToFloatTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsFloatThrows(before1.applyAsIntThrows(a), before2.applyAsIntThrows(b),
    ...
    default ThrowableTriBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsFloatThrows(before1.applyAsIntThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriIntToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code ThrowableTriIntToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * int}.
     ...
     */
    @Nonnull
    default ThrowableTriIntPredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntTernaryOperator<X> andThenToInt(@Nonnull ThrowableFloatToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriIntToFloatFunction<X> reversed() {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriIntToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableTriIntToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriIntToFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Integer, Integer, Integer, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link TriIntToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriIntToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriIntToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriIntToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default TriIntToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriIntToFloatFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriIntToFloatFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriIntToFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriIntToFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriIntToFloatFunction sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyAsFloatThrows(value1, value2, value3);
