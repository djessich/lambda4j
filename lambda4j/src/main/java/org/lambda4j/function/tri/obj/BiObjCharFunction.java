 ...
 * result. This is a (reference, reference, char) specialization of {@link TriFunction}.
 * <p>
...
public interface BiObjCharFunction<T, U, R> extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static <T, U, R> BiObjCharFunction<T, U, R> of(@Nullable BiObjCharFunction<T, U, R> expression) {
        return expression;
    }
    ...
    static <T, U, R> BiObjCharFunction<T, U, Optional<R>> lift(
            @Nonnull BiObjCharFunction<? super T, ? super U, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U, R> R call(@Nonnull BiObjCharFunction<? super T, ? super U, ? extends R> function, T t, U u,
            char value) {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjCharFunction<T, U, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjCharFunction<T, U, R> onlySecond(@Nonnull Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjCharFunction<T, U, R> onlyThird(@Nonnull CharFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjCharFunction<U, R> applyPartially(T t) {
     ...
     */
    @Nonnull
    default CharFunction<R> applyPartially(T t, U u) {
     ...
     */
    @Nonnull
    default BiFunction2<T, U, R> applyPartially(char value) {
     ...
     */
    @Nonnull
    default Function2<U, R> applyPartially(T t, char value) {
     ...
     */
    @Nonnull
    default <S> BiObjCharFunction<T, U, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjCharConsumer<T, U> consume(@Nonnull Consumer<? super R> consumer) {
     ...
     * BiObjCharFunction} with methods provided by the {@code JDK}.
     *
