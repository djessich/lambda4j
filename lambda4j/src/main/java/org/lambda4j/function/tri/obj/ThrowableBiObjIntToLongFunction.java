...
public interface ThrowableBiObjIntToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjIntToLongFunction<T, U, X> of(
            @Nullable ThrowableBiObjIntToLongFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> long call(
            @Nonnull ThrowableBiObjIntToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
            int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjIntConsumer<T, U, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjIntToLongFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Integer>, Long> cache = new ConcurrentHashMap<>();
     ...
     * this {@code ThrowableBiObjIntToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjIntToLongFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjIntToLongFunction<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiObjIntToLongFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjIntToLongFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjIntToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjIntToLongFunction<? super T, ? super U> function = recover.apply(throwable);
