...
public interface ThrowableObjBiByteToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToCharFunction<T, X> of(
            @Nullable ThrowableObjBiByteToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjBiByteToCharFunction<? super T, ? extends X> function, T t, byte value1,
     ...
     */
    @Nonnull
    default ThrowableBiByteToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToCharFunction<X> applyAsCharThrowsPartially(T t, byte value1) {
     ...
     */
    @Nonnull
    default ThrowableObjByteToCharFunction<T, X> applyAsCharThrowsPartially(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(byte value1, byte value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiByteToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiByteToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiByteToCharFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiByteToCharFunction<? super T> function = recover.apply(throwable);
