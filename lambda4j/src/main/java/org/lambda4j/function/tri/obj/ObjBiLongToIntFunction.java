 ...
 * {@code int}-valued result. This is a (reference, long, long) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsInt(Object, long, long)}.
 *
...
@FunctionalInterface
public interface ObjBiLongToIntFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiLongToIntFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code ObjBiLongToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T> ObjBiLongToIntFunction<T> of(@Nullable ObjBiLongToIntFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiLongToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> int call(@Nonnull ObjBiLongToIntFunction<? super T> function, T t, long value1, long value2) {
        Objects.requireNonNull(function);
        return function.applyAsInt(t, value1, value2);
    }

    /**
     * Creates a {@link ObjBiLongToIntFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiLongToIntFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiLongToIntFunction<T> onlyFirst(@Nonnull ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjBiLongToIntFunction<T> onlySecond(@Nonnull LongToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T> ObjBiLongToIntFunction<T> onlyThird(@Nonnull LongToIntFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsInt(value2);
    }

    /**
     * Creates a {@link ObjBiLongToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiLongToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiLongToIntFunction<T> constant(int ret) {
     ...
     */
    int applyAsInt(T t, long value1, long value2);

    /**
     * Applies this function partially to some arguments of this one, producing a {@link BiLongToIntFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default BiLongToIntFunction applyAsIntPartially(T t) {
     ...
     */
    @Nonnull
    default LongToIntFunction2 applyAsIntPartially(T t, long value1) {
     ...
     */
    @Nonnull
    default ObjLongToIntFunction<T> applyAsIntPartially(long value1) {
     ...
     */
    @Nonnull
    default ToIntFunction2<T> applyAsIntPartially(long value1, long value2) {
    ...
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsInt(before1.apply(a), before2.applyAsLong(b), before3.applyAsLong(c));
    }
    ...
    default TriBooleanToIntFunction composeFromBoolean(@Nonnull BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsInt(before1.apply(value1), before2.applyAsLong(value2),
     ...
     */
    @Nonnull
    default <S> ObjBiLongFunction<T, S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiLongPredicate<T> andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToByteFunction<T> andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToCharFunction<T> andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToDoubleFunction<T> andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToFloatFunction<T> andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToIntFunction<T> andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToLongFunction<T> andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongToShortFunction<T> andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiLongConsumer<T> consume(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(applyAsInt(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ObjBiLongToIntFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ObjBiLongToIntFunction}.
     ...
     */
    @Nonnull
    default ObjBiLongToIntFunction<T> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, Long, Long>, Integer> cache = new ConcurrentHashMap<>();
            return (ObjBiLongToIntFunction<T> & Memoized) (t, value1, value2) -> {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiLongToIntFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjBiLongToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiLongToIntFunction}.
     */
    @Nonnull
