...
public interface ThrowableObjBiCharToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToFloatFunction<T, X> of(
            @Nullable ThrowableObjBiCharToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull ThrowableObjBiCharToFloatFunction<? super T, ? extends X> function, T t, char value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjBiCharToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBiCharToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiCharToFloatFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiCharToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiCharToFloatFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiCharToFloatFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiCharToFloatFunction<? super T> function = recover.apply(throwable);
