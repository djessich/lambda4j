 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, char, char)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, char, char)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiCharToByteFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiCharToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjBiCharToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjBiCharToByteFunction<T, X> of(
            @Nullable ThrowableObjBiCharToByteFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiCharToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiCharToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjBiCharToByteFunction<? super T, ? extends X> function, T t, char value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiCharToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiCharToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiCharToByteFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiCharToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableCharToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiCharToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableCharToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiCharToByteFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiCharToByteFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableCharToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiCharToByteFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiCharToByteFunction<T, X> onlyThird(
            @Nonnull ThrowableCharToByteFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiCharToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiCharToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiCharToByteFunction<T, X> constant(byte ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, char value1, char value2) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableBiCharToByteFunction}
     * as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableBiCharToByteFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableBiCharToByteFunction<X> applyAsByteThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToByteFunction<X> applyAsByteThrowsPartially(T t, char value1) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToByteFunction<T, X> applyAsByteThrowsPartially(char value1) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> applyAsByteThrowsPartially(char value1, char value2) {
    ...
    default <A, B, C> ThrowableToByteTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsByteThrows(before1.applyThrows(a), before2.applyAsCharThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiCharToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiCharToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiCharToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Character, Character, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ObjBiCharToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiCharToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiCharToByteFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiCharToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiCharToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiCharToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiCharToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiCharToByteFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiCharToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiCharToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiCharToByteFunction<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return applyAsByteThrows(t, value1, value2);
