...
@FunctionalInterface
public interface TriCharToDoubleFunction extends Lambda {

    /**
     * Constructs a {@link TriCharToDoubleFunction} based on a lambda expression or a method reference. Thereby the
     * given lambda expression or method reference is returned on an as-is basis to implicitly transform it to the
     * desired type. With this method, it is possible to ensure that correct type is used from lambda expression or
     * method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriCharToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    @Nonnull
    default BiCharToDoubleFunction applyAsDoublePartially(char value1) {
     ...
     */
    @Nonnull
    default CharToDoubleFunction applyAsDoublePartially(char value1, char value2) {
    ...
    default <A, B, C> ToDoubleTriFunction<A, B, C> compose(@Nonnull ToCharFunction<? super A> before1,
        ...
        return (a, b, c) -> applyAsDouble(before1.applyAsChar(a), before2.applyAsChar(b), before3.applyAsChar(c));
    }
     ...
     */
    @Nonnull
    default TriCharToDoubleFunction reversed() {
     ...
     * TriCharToDoubleFunction} with methods provided by the {@code JDK}.
     *
