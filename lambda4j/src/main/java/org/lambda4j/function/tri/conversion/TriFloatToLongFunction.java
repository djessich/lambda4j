...
@FunctionalInterface
public interface TriFloatToLongFunction extends Lambda {

    /**
     * Constructs a {@link TriFloatToLongFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriFloatToLongFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static TriFloatToLongFunction of(@Nullable TriFloatToLongFunction expression) {
        return expression;
    }
     ...
     */
    static long call(@Nonnull TriFloatToLongFunction function, float value1, float value2, float value3) {
     ...
     */
    @Nonnull
    static TriFloatToLongFunction onlyFirst(@Nonnull FloatToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriFloatToLongFunction onlySecond(@Nonnull FloatToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriFloatToLongFunction onlyThird(@Nonnull FloatToLongFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiFloatToLongFunction applyAsLongPartially(float value1) {
     ...
     */
    @Nonnull
    default FloatToLongFunction applyAsLongPartially(float value1, float value2) {
     ...
     */
    @Nonnull
    default <A, B, C> ToLongTriFunction<A, B, C> compose(@Nonnull ToFloatFunction<? super A> before1,
            @Nonnull ToFloatFunction<? super B> before2, @Nonnull ToFloatFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> applyAsLong(before1.applyAsFloat(a), before2.applyAsFloat(b), before3.applyAsFloat(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanToLongFunction composeFromBoolean(@Nonnull BooleanToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriByteToLongFunction composeFromByte(@Nonnull ByteToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriCharToLongFunction composeFromChar(@Nonnull CharToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction composeFromDouble(@Nonnull DoubleToFloatFunction before1,
    ...
    /**
     * Returns a composed {@link TriFloatToLongFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default TriFloatToLongFunction composeFromFloat(@Nonnull FloatUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriIntToLongFunction composeFromInt(@Nonnull IntToFloatFunction before1,
     ...
     */
    @Nonnull
    default LongTernaryOperator composeFromLong(@Nonnull LongToFloatFunction before1,
     ...
     */
    @Nonnull
    default TriShortToLongFunction composeFromShort(@Nonnull ShortToFloatFunction before1,
     ...
     */
    @Nonnull
    default <S> TriFloatFunction<S> andThen(@Nonnull LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriFloatPredicate andThenToBoolean(@Nonnull LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToByteFunction andThenToByte(@Nonnull LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToCharFunction andThenToChar(@Nonnull LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction andThenToDouble(@Nonnull LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatTernaryOperator andThenToFloat(@Nonnull LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToIntFunction andThenToInt(@Nonnull LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToLongFunction andThenToLong(@Nonnull LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatToShortFunction andThenToShort(@Nonnull LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriFloatConsumer consume(@Nonnull LongConsumer consumer) {
     ...
     */
    @Nonnull
    default TriFloatToLongFunction reversed() {
        return (value3, value2, value1) -> applyAsLong(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link TriFloatToLongFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code TriFloatToLongFunction}.
    ...
    default TriFloatToLongFunction memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<Float, Float, Float>, Long> cache = new ConcurrentHashMap<>();
            return (TriFloatToLongFunction & Memoized) (value1, value2, value3) -> {
     ...
     * TriFloatToLongFunction} with methods provided by the {@code JDK}.
     *
