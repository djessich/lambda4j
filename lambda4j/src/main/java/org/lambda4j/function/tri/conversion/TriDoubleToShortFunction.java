...
public interface TriDoubleToShortFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static TriDoubleToShortFunction of(@Nullable TriDoubleToShortFunction expression) {
        return expression;
    }
     ...
     */
    static short call(@Nonnull TriDoubleToShortFunction function, double value1, double value2, double value3) {
     ...
     */
    @Nonnull
    static TriDoubleToShortFunction onlyFirst(@Nonnull DoubleToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriDoubleToShortFunction onlySecond(@Nonnull DoubleToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriDoubleToShortFunction onlyThird(@Nonnull DoubleToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiDoubleToShortFunction applyAsShortPartially(double value1) {
     ...
     */
    @Nonnull
    default DoubleToShortFunction applyAsShortPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default <A, B, C> ToShortTriFunction<A, B, C> compose(@Nonnull ToDoubleFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToShortFunction composeFromBoolean(@Nonnull BooleanToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriByteToShortFunction composeFromByte(@Nonnull ByteToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriCharToShortFunction composeFromChar(@Nonnull CharToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction composeFromDouble(@Nonnull DoubleUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriFloatToShortFunction composeFromFloat(@Nonnull FloatToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriIntToShortFunction composeFromInt(@Nonnull IntToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriLongToShortFunction composeFromLong(@Nonnull LongToDoubleFunction before1,
     ...
     */
    @Nonnull
    default ShortTernaryOperator composeFromShort(@Nonnull ShortToDoubleFunction before1,
     ...
     */
    @Nonnull
    default <S> TriDoubleFunction<S> andThen(@Nonnull ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriDoublePredicate andThenToBoolean(@Nonnull ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction andThenToByte(@Nonnull ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction andThenToChar(@Nonnull ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleTernaryOperator andThenToDouble(@Nonnull ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToFloatFunction andThenToFloat(@Nonnull ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction andThenToInt(@Nonnull ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction andThenToLong(@Nonnull ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction andThenToShort(@Nonnull ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleConsumer consume(@Nonnull ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction reversed() {
     ...
     * TriDoubleToShortFunction} with methods provided by the {@code JDK}.
     *
