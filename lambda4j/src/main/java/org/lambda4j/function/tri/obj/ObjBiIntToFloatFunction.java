 ...
 * {@code float}-valued result. This is a (reference, int, int) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloat(Object, int, int)}.
 *
...
@FunctionalInterface
public interface ObjBiIntToFloatFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiIntToFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjBiIntToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T> ObjBiIntToFloatFunction<T> of(@Nullable ObjBiIntToFloatFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiIntToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiIntToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> float call(@Nonnull ObjBiIntToFloatFunction<? super T> function, T t, int value1, int value2) {
        Objects.requireNonNull(function);
        return function.applyAsFloat(t, value1, value2);
    }

    /**
     * Creates a {@link ObjBiIntToFloatFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiIntToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiIntToFloatFunction<T> onlyFirst(@Nonnull ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsFloat(t);
    }

    /**
     * Creates a {@link ObjBiIntToFloatFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link IntToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiIntToFloatFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code IntToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiIntToFloatFunction<T> onlySecond(@Nonnull IntToFloatFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsFloat(value1);
    }

    /**
     * Creates a {@link ObjBiIntToFloatFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link IntToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiIntToFloatFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code IntToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiIntToFloatFunction<T> onlyThird(@Nonnull IntToFloatFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsFloat(value2);
    }

    /**
     * Creates a {@link ObjBiIntToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiIntToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiIntToFloatFunction<T> constant(float ret) {
     ...
     */
    float applyAsFloat(T t, int value1, int value2);
     ...
     */
    @Nonnull
    default BiIntToFloatFunction applyAsFloatPartially(T t) {
     ...
     */
    @Nonnull
    default IntToFloatFunction applyAsFloatPartially(T t, int value1) {
     ...
     */
    @Nonnull
    default ObjIntToFloatFunction<T> applyAsFloatPartially(int value1) {
     ...
     */
    @Nonnull
    default ToFloatFunction<T> applyAsFloatPartially(int value1, int value2) {
    ...
    default <A, B, C> ToFloatTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsFloat(before1.apply(a), before2.applyAsInt(b), before3.applyAsInt(c));
    }
     ...
     */
    @Nonnull
    default <S> ObjBiIntFunction<T, S> andThen(@Nonnull FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiIntPredicate<T> andThenToBoolean(@Nonnull FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntToByteFunction<T> andThenToByte(@Nonnull FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntToCharFunction<T> andThenToChar(@Nonnull FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntToDoubleFunction<T> andThenToDouble(@Nonnull FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntToFloatFunction<T> andThenToFloat(@Nonnull FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntToIntFunction<T> andThenToInt(@Nonnull FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntToLongFunction<T> andThenToLong(@Nonnull FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntToShortFunction<T> andThenToShort(@Nonnull FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiIntConsumer<T> consume(@Nonnull FloatConsumer consumer) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiIntToFloatFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjBiIntToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiIntToFloatFunction}.
     */
    @Nonnull
    default TriFunction<T, Integer, Integer, Float> boxed() {
