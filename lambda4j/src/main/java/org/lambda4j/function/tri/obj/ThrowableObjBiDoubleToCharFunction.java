 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, double, double)
...
public interface ThrowableObjBiDoubleToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToCharFunction<T, X> of(
            @Nullable ThrowableObjBiDoubleToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjBiDoubleToCharFunction<? super T, ? extends X> function, T t, double value1,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToCharFunction<X> applyAsCharThrowsPartially(T t, double value1) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToCharFunction<T, X> applyAsCharThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiDoubleToCharFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiDoubleToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiDoubleToCharFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiDoubleToCharFunction<? super T> function = recover.apply(throwable);
