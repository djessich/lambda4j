 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, float)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(Object, Object, float)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjFloatToFloatFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjFloatToFloatFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjFloatToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjFloatToFloatFunction<T, U, X> of(
            @Nullable ThrowableBiObjFloatToFloatFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjFloatToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjFloatToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> float call(
            @Nonnull ThrowableBiObjFloatToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToFloatFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjFloatToFloatFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToFloatFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjFloatToFloatFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToFloatFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToFloatFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjFloatToFloatFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableFloatUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToFloatFunction<T, U, X> onlyThird(
            @Nonnull ThrowableFloatUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, u, value) -> operator.applyAsFloatThrows(value);
    }

    /**
     * Creates a {@link ThrowableBiObjFloatToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjFloatToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToFloatFunction<T, U, X> constant(float ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(T t, U u, float value) throws X;
     ...
     */
    default float applyAsFloatThrows(@Nonnull Pair<T, U> tuple, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToFloatFunction<U, X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatUnaryOperator<X> applyAsFloatThrowsPartially(T t, U u) {
        return value -> applyAsFloatThrows(t, u, value);
    }

    /**
     * Applies this operator partially to some arguments of this one, producing a {@link ThrowableToFloatBiFunction} as
     * result.
     *
     * @param value The third argument to this function used to partially apply this function
     * @return A {@code ThrowableToFloatBiFunction} that represents this operator partially applied the some arguments.
     */
    @Nonnull
    default ThrowableToFloatBiFunction<T, U, X> applyAsFloatThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<U, X> applyAsFloatThrowsPartially(T t, float value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToFloatFunction<Pair<T, U>, X> tupled() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjFloatToFloatFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjFloatToFloatFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatToFloatFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Float>, Float> cache = new ConcurrentHashMap<>();
            return (ThrowableBiObjFloatToFloatFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjFloatToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjFloatToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjFloatToFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Float, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link BiObjFloatToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjFloatToFloatFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjFloatToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjFloatToFloatFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjFloatToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjFloatToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjFloatToFloatFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjFloatToFloatFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjFloatToFloatFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsFloatThrows(t, u, value);
