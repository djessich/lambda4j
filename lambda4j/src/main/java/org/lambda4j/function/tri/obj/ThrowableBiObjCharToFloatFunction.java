 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, char)
...
public interface ThrowableBiObjCharToFloatFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToFloatFunction<T, U, X> of(
            @Nullable ThrowableBiObjCharToFloatFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> float call(
            @Nonnull ThrowableBiObjCharToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharToFloatFunction<U, X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToFloatFunction<X> applyAsFloatThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToFloatBiFunction<T, U, X> applyAsFloatThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<U, X> applyAsFloatThrowsPartially(T t, char value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjCharToFloatFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Character>, Float> cache = new ConcurrentHashMap<>();
    ...
    default BiObjCharToFloatFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjCharToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjCharToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
