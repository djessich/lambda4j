...
public interface ThrowableBiObjFloatToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToCharFunction<T, U, X> of(
            @Nullable final ThrowableBiObjFloatToCharFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> char call(
            @Nonnull final ThrowableBiObjFloatToCharFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
    ...
    default BiObjFloatToCharFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjFloatToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjFloatToCharFunction<? super T, ? super U> function = recover.apply(throwable);
