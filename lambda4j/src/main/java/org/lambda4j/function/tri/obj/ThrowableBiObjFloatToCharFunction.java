 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, float)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(Object, Object, float)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjFloatToCharFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjFloatToCharFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjFloatToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjFloatToCharFunction<T, U, X> of(
            @Nullable ThrowableBiObjFloatToCharFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjFloatToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjFloatToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> char call(
            @Nonnull ThrowableBiObjFloatToCharFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToCharFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjFloatToCharFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToCharFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToCharFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjFloatToCharFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToCharFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToCharFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjFloatToCharFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToCharFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjFloatToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToCharFunction<T, U, X> constant(char ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(T t, U u, float value) throws X;
     ...
     */
    default char applyAsCharThrows(@Nonnull Pair<T, U> tuple, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToCharFunction<U, X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToCharFunction<X> applyAsCharThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToCharBiFunction<T, U, X> applyAsCharThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<U, X> applyAsCharThrowsPartially(T t, float value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToCharFunction<Pair<T, U>, X> tupled() {
    ...
    default ThrowableBiObjFloatToCharFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Float>, Character> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Float, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link BiObjFloatToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjFloatToCharFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjFloatToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjFloatToCharFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjFloatToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjFloatToCharFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjFloatToCharFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjFloatToCharFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjFloatToCharFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsCharThrows(t, u, value);
