 ...
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, long, long)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(Object, long, long)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiLongToIntFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiLongToIntFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjBiLongToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjBiLongToIntFunction<T, X> of(
            @Nullable ThrowableObjBiLongToIntFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiLongToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjBiLongToIntFunction<? super T, ? extends X> function, T t, long value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiLongToIntFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongToIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToIntFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiLongToIntFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableLongToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToIntFunction<T, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiLongToIntFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableLongToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiLongToIntFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToIntFunction<T, X> onlyThird(
            @Nonnull ThrowableLongToIntFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiLongToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiLongToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiLongToIntFunction<T, X> constant(int ret) {
     ...
     */
    @Nonnull
    default ThrowableBiLongToIntFunction<X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> applyAsIntThrowsPartially(T t, long value1) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToIntFunction<T, X> applyAsIntThrowsPartially(long value1) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> applyAsIntThrowsPartially(long value1, long value2) {
    ...
    default <A, B, C> ThrowableToIntTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsIntThrows(before1.applyThrows(a), before2.applyAsLongThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(applyAsIntThrows(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiLongToIntFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiLongToIntFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjBiLongToIntFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, Long, Long>, Integer> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ThrowableObjBiLongToIntFunction<T, X> & Memoized) (t, value1, value2) -> {
                int returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiLongToIntFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiLongToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiLongToIntFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Long, Long, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link ObjBiLongToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiLongToIntFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link ObjBiLongToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjBiLongToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiLongToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiLongToIntFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiLongToIntFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiLongToIntFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiLongToIntFunction<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return applyAsIntThrows(t, value1, value2);
