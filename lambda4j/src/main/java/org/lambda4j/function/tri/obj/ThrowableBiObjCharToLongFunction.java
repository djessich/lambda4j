...
public interface ThrowableBiObjCharToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToLongFunction<T, U, X> of(
            @Nullable ThrowableBiObjCharToLongFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> long call(
            @Nonnull ThrowableBiObjCharToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjCharToLongFunction<U, X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> applyAsLongThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToLongBiFunction<T, U, X> applyAsLongThrowsPartially(char value) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<U, X> applyAsLongThrowsPartially(T t, char value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
    ...
    default BiObjCharToLongFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjCharToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjCharToLongFunction<? super T, ? super U> function = recover.apply(throwable);
