 ...
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, boolean)
...
public interface ThrowableBiObjBooleanToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToIntFunction<T, U, X> of(
            @Nullable ThrowableBiObjBooleanToIntFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> int call(
            @Nonnull ThrowableBiObjBooleanToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjBooleanToIntFunction<U, X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableBooleanToIntFunction<X> applyAsIntThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToIntBiFunction<T, U, X> applyAsIntThrowsPartially(boolean value) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<U, X> applyAsIntThrowsPartially(T t, boolean value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanConsumer<T, U, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjBooleanToIntFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Boolean>, Integer> cache = new ConcurrentHashMap<>();
    ...
    default BiObjBooleanToIntFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjBooleanToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjBooleanToIntFunction<? super T, ? super U> function = recover.apply(throwable);
