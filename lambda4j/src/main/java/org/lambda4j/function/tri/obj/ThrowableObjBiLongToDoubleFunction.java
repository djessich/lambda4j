 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, long, long)
...
public interface ThrowableObjBiLongToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToDoubleFunction<T, X> of(
            @Nullable ThrowableObjBiLongToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjBiLongToDoubleFunction<? super T, ? extends X> function, T t, long value1,
     ...
     */
    @Nonnull
    default ThrowableBiLongToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToDoubleFunction<X> applyAsDoubleThrowsPartially(T t, long value1) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToDoubleFunction<T, X> applyAsDoubleThrowsPartially(long value1) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(long value1, long value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiLongToDoubleFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Long, Long>, Double> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ObjBiLongToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiLongToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiLongToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiLongToDoubleFunction<? super T> function = recover.apply(throwable);
