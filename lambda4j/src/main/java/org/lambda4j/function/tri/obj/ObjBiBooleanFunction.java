...
public interface ObjBiBooleanFunction<T, R> extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static <T, R> ObjBiBooleanFunction<T, R> of(@Nullable ObjBiBooleanFunction<T, R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ObjBiBooleanFunction} into a total {@link ObjBiBooleanFunction} that returns an {@link
     * Optional} result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ObjBiBooleanFunction} lifted into a total {@code ObjBiBooleanFunction} that returns an
     * {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R> ObjBiBooleanFunction<T, Optional<R>> lift(
            @Nonnull ObjBiBooleanFunction<? super T, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, R> R call(@Nonnull ObjBiBooleanFunction<? super T, ? extends R> function, T t, boolean value1,
            boolean value2) {
     ...
     */
    @Nonnull
    static <T, R> ObjBiBooleanFunction<T, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjBiBooleanFunction<T, R> onlySecond(@Nonnull BooleanFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, R> ObjBiBooleanFunction<T, R> onlyThird(@Nonnull BooleanFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiBooleanFunction<R> applyPartially(T t) {
     ...
     */
    @Nonnull
    default BooleanFunction<R> applyPartially(T t, boolean value1) {
     ...
     */
    @Nonnull
    default ObjBooleanFunction<T, R> applyPartially(boolean value1) {
     ...
     */
    @Nonnull
    default Function2<T, R> applyPartially(boolean value1, boolean value2) {
     ...
     */
    @Nonnull
    default <S> ObjBiBooleanFunction<T, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiBooleanConsumer<T> consume(@Nonnull Consumer<? super R> consumer) {
    ...
    default ObjBiBooleanFunction<T, R> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Boolean, Boolean>, R> cache = new ConcurrentHashMap<>();
    ...
    @Deprecated
    @Nonnull
    default ObjBiBooleanFunction<T, Optional<R>> nonNull() {
     ...
     * ObjBiBooleanFunction} with methods provided by the {@code JDK}.
     *
