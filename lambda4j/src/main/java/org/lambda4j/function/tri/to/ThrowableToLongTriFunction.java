...
/**
 * Represents an operation that accepts three input arguments and produces a {@code long}-valued result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(Object, Object, Object)}.
 *
...
@FunctionalInterface
public interface ThrowableToLongTriFunction<T, U, V, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableToLongTriFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableToLongTriFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, V, X extends Throwable> ThrowableToLongTriFunction<T, U, V, X> of(
            @Nullable ThrowableToLongTriFunction<T, U, V, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableToLongTriFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <V> The type of the third argument to the function
     ...
     * @return The result from the given {@code ThrowableToLongTriFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, V, X extends Throwable> long call(
            @Nonnull ThrowableToLongTriFunction<? super T, ? super U, ? super V, ? extends X> function, T t, U u,
            V v) throws X {
        Objects.requireNonNull(function);
        return function.applyAsLongThrows(t, u, v);
    }

    /**
     * Creates a {@link ThrowableToLongTriFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableToLongTriFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToLongTriFunction<T, U, V, X> onlyFirst(
            @Nonnull ThrowableToLongFunction<? super T, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, v) -> function.applyAsLongThrows(t);
    }

    /**
     * Creates a {@link ThrowableToLongTriFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableToLongTriFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToLongTriFunction<T, U, V, X> onlySecond(
            @Nonnull ThrowableToLongFunction<? super U, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, v) -> function.applyAsLongThrows(u);
    }

    /**
     * Creates a {@link ThrowableToLongTriFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableToLongTriFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToLongTriFunction<T, U, V, X> onlyThird(
            @Nonnull ThrowableToLongFunction<? super V, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, v) -> function.applyAsLongThrows(v);
    }

    /**
     * Creates a {@link ThrowableToLongTriFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <V> The type of the third argument to the function
     ...
     * @return A {@code ThrowableToLongTriFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, V, X extends Throwable> ThrowableToLongTriFunction<T, U, V, X> constant(long ret) {
        return (t, u, v) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(T t, U u, V v) throws X;
    ...
    default <A, B, C> ThrowableToLongTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsLongThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyThrows(c));
    }
    ...
    default <S> ThrowableTriFunction<T, U, V, S, X> andThen(
        ...
        return (t, u, v) -> after.applyThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableTriPredicate<T, U, V, X> andThenToBoolean(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.testThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableToByteTriFunction<T, U, V, X> andThenToByte(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsByteThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableToCharTriFunction<T, U, V, X> andThenToChar(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsCharThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableToDoubleTriFunction<T, U, V, X> andThenToDouble(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsDoubleThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableToFloatTriFunction<T, U, V, X> andThenToFloat(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsFloatThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableToIntTriFunction<T, U, V, X> andThenToInt(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsIntThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableToLongTriFunction<T, U, V, X> andThenToLong(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsLongThrows(applyAsLongThrows(t, u, v));
    }
    ...
    default ThrowableToShortTriFunction<T, U, V, X> andThenToShort(
        ...
        Objects.requireNonNull(after);
        return (t, u, v) -> after.applyAsShortThrows(applyAsLongThrows(t, u, v));
    }
     ...
     */
    @Nonnull
    default ThrowableTriConsumer<T, U, V, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, u, v) -> consumer.acceptThrows(applyAsLongThrows(t, u, v));
    }
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<Triple<T, U, V>, X> tupled() {
     ...
     */
    @Nonnull
    default ThrowableToLongTriFunction<V, U, T, X> reversed() {
        return (v, u, t) -> applyAsLongThrows(t, u, v);
    }
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableToLongTriFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableToLongTriFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableToLongTriFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, V, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link ToLongTriFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ToLongTriFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ToLongTriFunction<T, U, V> nest() {
     ...
     */
    @Nonnull
    default ToLongTriFunction<T, U, V> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ToLongTriFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ToLongTriFunction<T, U, V> recover(
            @Nonnull Function<? super Throwable, ? extends ToLongTriFunction<? super T, ? super U, ? super V>> recover) {
        Objects.requireNonNull(recover);
        return (t, u, v) -> {
            try {
                return applyAsLongThrows(t, u, v);
            } catch (Error e) {
                throw e;
            } catch (Throwable throwable) {
                ToLongTriFunction<? super T, ? super U, ? super V> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ToLongTriFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ToLongTriFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ToLongTriFunction<T, U, V> sneakyThrow() {
        return (t, u, v) -> {
            try {
                return applyAsLongThrows(t, u, v);
