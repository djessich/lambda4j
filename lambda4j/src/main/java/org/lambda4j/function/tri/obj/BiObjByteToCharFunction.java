 ...
 * {@code char}-valued result. This is a (reference, reference, byte) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsChar(Object, Object, byte)}.
 *
...
@FunctionalInterface
public interface BiObjByteToCharFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjByteToCharFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjByteToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjByteToCharFunction<T, U> of(@Nullable BiObjByteToCharFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjByteToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjByteToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> char call(@Nonnull BiObjByteToCharFunction<? super T, ? super U> function, T t, U u,
            byte value) {
    ...
    /**
     * Creates a {@link BiObjByteToCharFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjByteToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjByteToCharFunction<T, U> onlyFirst(@Nonnull ToCharFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(t);
    }

    /**
     * Creates a {@link BiObjByteToCharFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjByteToCharFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjByteToCharFunction<T, U> onlySecond(@Nonnull ToCharFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(u);
    }

    /**
     * Creates a {@link BiObjByteToCharFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link ByteToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjByteToCharFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code ByteToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjByteToCharFunction<T, U> onlyThird(@Nonnull ByteToCharFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(value);
    }

    /**
     * Creates a {@link BiObjByteToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjByteToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjByteToCharFunction<T, U> constant(char ret) {
     ...
     */
    char applyAsChar(T t, U u, byte value);
     ...
     */
    default char applyAsChar(@Nonnull Pair<T, U> tuple, byte value) {
     ...
     */
    @Nonnull
    default ObjByteToCharFunction<U> applyAsCharPartially(T t) {
     ...
     */
    @Nonnull
    default ByteToCharFunction applyAsCharPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToCharBiFunction<T, U> applyAsCharPartially(byte value) {
     ...
     */
    @Nonnull
    default ToCharFunction<U> applyAsCharPartially(T t, byte value) {
    ...
    default <A, B, C> ToCharTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsChar(before1.apply(a), before2.apply(b), before3.applyAsByte(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjByteFunction<T, U, S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjBytePredicate<T, U> andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToByteFunction<T, U> andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToCharFunction<T, U> andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToDoubleFunction<T, U> andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToFloatFunction<T, U> andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToIntFunction<T, U> andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToLongFunction<T, U> andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToShortFunction<T, U> andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteConsumer<T, U> consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjByteToCharFunction<Pair<T, U>> tupled() {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjByteToCharFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjByteToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjByteToCharFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Byte, Character> boxed() {
        return this::applyAsChar;
    }
