...
public interface ThrowableObjBiIntToByteFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiIntToByteFunction<T, X> of(
            @Nullable ThrowableObjBiIntToByteFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjBiIntToByteFunction<? super T, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiIntToByteFunction<X> applyAsByteThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> applyAsByteThrowsPartially(T t, int value1) {
     ...
     */
    @Nonnull
    default ThrowableObjIntToByteFunction<T, X> applyAsByteThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<T, X> applyAsByteThrowsPartially(int value1, int value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjBiIntToByteFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBiIntToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiIntToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiIntToByteFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjBiIntToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiIntToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiIntToByteFunction<? super T> function = recover.apply(throwable);
