 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, double)
...
public interface ThrowableBiObjDoubleToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToShortFunction<T, U, X> of(
            @Nullable ThrowableBiObjDoubleToShortFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> short call(
            @Nonnull ThrowableBiObjDoubleToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToShortFunction<U, X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToShortFunction<X> applyAsShortThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToShortBiFunction<T, U, X> applyAsShortThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<U, X> applyAsShortThrowsPartially(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     * ThrowableBiObjDoubleToShortFunction}.
     */
    @Nonnull
    ...
    default BiObjDoubleToShortFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleToShortFunction<? super T, ? super U> function = recover.apply(throwable);
