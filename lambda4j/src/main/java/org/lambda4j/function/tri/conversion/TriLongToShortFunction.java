...
public interface TriLongToShortFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static TriLongToShortFunction of(@Nullable TriLongToShortFunction expression) {
        return expression;
    }
     ...
     */
    static short call(@Nonnull TriLongToShortFunction function, long value1, long value2, long value3) {
     ...
     */
    @Nonnull
    static TriLongToShortFunction onlyFirst(@Nonnull LongToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriLongToShortFunction onlySecond(@Nonnull LongToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriLongToShortFunction onlyThird(@Nonnull LongToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default BiLongToShortFunction applyAsShortPartially(long value1) {
     ...
     */
    @Nonnull
    default LongToShortFunction applyAsShortPartially(long value1, long value2) {
     ...
     */
    @Nonnull
    default <A, B, C> ToShortTriFunction<A, B, C> compose(@Nonnull ToLongFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToShortFunction composeFromBoolean(@Nonnull BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default TriByteToShortFunction composeFromByte(@Nonnull ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default TriCharToShortFunction composeFromChar(@Nonnull CharToLongFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction composeFromDouble(@Nonnull DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToShortFunction composeFromFloat(@Nonnull FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default TriIntToShortFunction composeFromInt(@Nonnull IntToLongFunction before1,
     ...
     */
    @Nonnull
    default TriLongToShortFunction composeFromLong(@Nonnull LongUnaryOperator before1,
     ...
     */
    @Nonnull
    default ShortTernaryOperator composeFromShort(@Nonnull ShortToLongFunction before1,
     ...
     */
    @Nonnull
    default <S> TriLongFunction<S> andThen(@Nonnull ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriLongPredicate andThenToBoolean(@Nonnull ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToByteFunction andThenToByte(@Nonnull ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToCharFunction andThenToChar(@Nonnull ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction andThenToDouble(@Nonnull ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToFloatFunction andThenToFloat(@Nonnull ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToIntFunction andThenToInt(@Nonnull ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongTernaryOperator andThenToLong(@Nonnull ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToShortFunction andThenToShort(@Nonnull ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongConsumer consume(@Nonnull ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default TriLongToShortFunction reversed() {
     ...
     * TriLongToShortFunction} with methods provided by the {@code JDK}.
     *
