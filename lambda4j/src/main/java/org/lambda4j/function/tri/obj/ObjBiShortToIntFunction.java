 ...
 * {@code int}-valued result. This is a (reference, short, short) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsInt(Object, short, short)}.
 *
...
@FunctionalInterface
public interface ObjBiShortToIntFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiShortToIntFunction} based on a lambda expression or a method reference. Thereby the
    ...
    @CheckForNull
    @Nullable
    static <T> ObjBiShortToIntFunction<T> of(@Nullable ObjBiShortToIntFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiShortToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiShortToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> int call(@Nonnull ObjBiShortToIntFunction<? super T> function, T t, short value1, short value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiShortToIntFunction<T> onlyFirst(@Nonnull ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsInt(t);
    }

    /**
     * Creates a {@link ObjBiShortToIntFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ShortToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiShortToIntFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ShortToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiShortToIntFunction<T> onlySecond(@Nonnull ShortToIntFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsInt(value1);
    }

    /**
     * Creates a {@link ObjBiShortToIntFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link ShortToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiShortToIntFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code ShortToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiShortToIntFunction<T> onlyThird(@Nonnull ShortToIntFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsInt(value2);
    }

    /**
     * Creates a {@link ObjBiShortToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiShortToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiShortToIntFunction<T> constant(int ret) {
     ...
     */
    @Nonnull
    default BiShortToIntFunction applyAsIntPartially(T t) {
     ...
     */
    @Nonnull
    default ShortToIntFunction applyAsIntPartially(T t, short value1) {
     ...
     */
    @Nonnull
    default ObjShortToIntFunction<T> applyAsIntPartially(short value1) {
     ...
     */
    @Nonnull
    default ToIntFunction2<T> applyAsIntPartially(short value1, short value2) {
    ...
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsInt(before1.apply(a), before2.applyAsShort(b), before3.applyAsShort(c));
    }
     ...
     */
    @Nonnull
    default <S> ObjBiShortFunction<T, S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiShortPredicate<T> andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToByteFunction<T> andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToCharFunction<T> andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToDoubleFunction<T> andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToFloatFunction<T> andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToIntFunction<T> andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToLongFunction<T> andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortToShortFunction<T> andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiShortConsumer<T> consume(@Nonnull IntConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(applyAsInt(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ObjBiShortToIntFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ObjBiShortToIntFunction}.
     ...
     */
    @Nonnull
    default ObjBiShortToIntFunction<T> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, Short, Short>, Integer> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ObjBiShortToIntFunction<T> & Memoized) (t, value1, value2) -> {
                int returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiShortToIntFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjBiShortToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiShortToIntFunction}.
     */
    @Nonnull
