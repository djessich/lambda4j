...
public interface TriDoubleToCharFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static TriDoubleToCharFunction of(@Nullable TriDoubleToCharFunction expression) {
        return expression;
    }
     ...
     */
    static char call(@Nonnull TriDoubleToCharFunction function, double value1, double value2, double value3) {
     ...
     */
    @Nonnull
    static TriDoubleToCharFunction onlyFirst(@Nonnull DoubleToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriDoubleToCharFunction onlySecond(@Nonnull DoubleToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriDoubleToCharFunction onlyThird(@Nonnull DoubleToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B, C> ToCharTriFunction<A, B, C> compose(@Nonnull ToDoubleFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToCharFunction composeFromBoolean(@Nonnull BooleanToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriByteToCharFunction composeFromByte(@Nonnull ByteToDoubleFunction before1,
     ...
     */
    @Nonnull
    default CharTernaryOperator composeFromChar(@Nonnull CharToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction composeFromDouble(@Nonnull DoubleUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriFloatToCharFunction composeFromFloat(@Nonnull FloatToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriIntToCharFunction composeFromInt(@Nonnull IntToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriLongToCharFunction composeFromLong(@Nonnull LongToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriShortToCharFunction composeFromShort(@Nonnull ShortToDoubleFunction before1,
     ...
     */
    @Nonnull
    default <S> TriDoubleFunction<S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriDoublePredicate andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleTernaryOperator andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToFloatFunction andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleConsumer consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction reversed() {
