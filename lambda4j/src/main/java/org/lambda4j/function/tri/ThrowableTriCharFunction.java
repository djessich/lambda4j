...
public interface ThrowableTriCharFunction<R, X extends Throwable> extends Lambda {
    ...
    /**
     * Lifts a partial {@link ThrowableTriCharFunction} into a total {@link ThrowableTriCharFunction} that returns an
     * {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ThrowableTriCharFunction} lifted into a total {@code ThrowableTriCharFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriCharFunction<Optional<R>, X> lift(
            @Nonnull ThrowableTriCharFunction<? extends R, ? extends X> partial) {
     ...
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableTriCharFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriIntFunction<R, X> composeFromInt(@Nonnull ThrowableIntToCharFunction<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriCharPredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriCharConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableCharFunction<ThrowableCharFunction<ThrowableCharFunction<R, X>, X>, X> curried() {
     ...
     */
    @Nonnull
    default ThrowableTriCharFunction<R, X> reversed() {
     ...
     * {@code ThrowableTriCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriCharFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default TriCharFunction<R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriCharFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default TriCharFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends TriCharFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriCharFunction<? extends R> function = recover.apply(throwable);
