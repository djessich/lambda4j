...
public interface ThrowableBiObjIntToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjIntToDoubleFunction<T, U, X> of(
            @Nullable ThrowableBiObjIntToDoubleFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> double call(
            @Nonnull ThrowableBiObjIntToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
            int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntToDoubleFunction<X> applyAsDoubleThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleBiFunction<T, U, X> applyAsDoubleThrowsPartially(int value) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t, int value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjIntConsumer<T, U, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
    ...
    default BiObjIntToDoubleFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjIntToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjIntToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
