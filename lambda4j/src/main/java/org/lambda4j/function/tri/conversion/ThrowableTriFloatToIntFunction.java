...
public interface ThrowableTriFloatToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriFloatToIntFunction<X> of(
            @Nullable ThrowableTriFloatToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableTriFloatToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriFloatToIntFunction<X> reversed() {
     ...
     */
    @Nonnull
    default TriFloatToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriFloatToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriFloatToIntFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriFloatToIntFunction function = recover.apply(throwable);
