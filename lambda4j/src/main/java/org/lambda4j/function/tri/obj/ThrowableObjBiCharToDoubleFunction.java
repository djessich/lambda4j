 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, char, char)
...
public interface ThrowableObjBiCharToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiCharToDoubleFunction<T, X> of(
            @Nullable ThrowableObjBiCharToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjBiCharToDoubleFunction<? super T, ? extends X> function, T t, char value1,
     ...
     */
    @Nonnull
    default ThrowableBiCharToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableCharToDoubleFunction<X> applyAsDoubleThrowsPartially(T t, char value1) {
     ...
     */
    @Nonnull
    default ThrowableObjCharToDoubleFunction<T, X> applyAsDoubleThrowsPartially(char value1) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(char value1, char value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiCharConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjBiCharToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     */
    @Nonnull
    default ObjBiCharToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiCharToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiCharToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiCharToDoubleFunction<? super T> function = recover.apply(throwable);
