...
import org.lambda4j.function.bi.obj.ObjDoubleFunction;
 ...
 * result. This is a (reference, reference, double) specialization of {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface BiObjDoubleFunction<T, U, R> extends Lambda {

    /**
     * Constructs a {@link BiObjDoubleFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, R> BiObjDoubleFunction<T, U, R> of(@Nullable BiObjDoubleFunction<T, U, R> expression) {
        return expression;
    }
    ...
    static <T, U, R> BiObjDoubleFunction<T, U, Optional<R>> lift(
            @Nonnull BiObjDoubleFunction<? super T, ? super U, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U, R> R call(@Nonnull BiObjDoubleFunction<? super T, ? super U, ? extends R> function, T t, U u,
            double value) {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjDoubleFunction<T, U, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjDoubleFunction<T, U, R> onlySecond(@Nonnull Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjDoubleFunction<T, U, R> onlyThird(@Nonnull DoubleFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjDoubleFunction<T, U, R> constant(R ret) {
     ...
     */
    @Nonnull
    default <S> BiObjDoubleFunction<T, U, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjDoubleConsumer<T, U> consume(@Nonnull Consumer<? super R> consumer) {
    ...
    @Deprecated
    @Nonnull
    default BiObjDoubleFunction<T, U, Optional<R>> nonNull() {
        return (t, u, value) -> Optional.ofNullable(apply(t, u, value));
    }

    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjDoubleFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjDoubleFunction}.
     */
    @Nonnull
