 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(Object, Object, float)}.
 *
...
public interface ThrowableBiObjFloatToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> double call(
            @Nonnull final ThrowableBiObjFloatToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull final ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     * the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjFloatToDoubleFunction}.
     */
    @Nonnull
    ...
    default BiObjFloatToDoubleFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjFloatToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjFloatToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
