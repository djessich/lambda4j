 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, float)
...
@FunctionalInterface
public interface ThrowableBiObjFloatToDoubleFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjFloatToDoubleFunction} based on a lambda expression or a method reference.
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToDoubleFunction<T, U, X> of(
            @Nullable ThrowableBiObjFloatToDoubleFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjFloatToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjFloatToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> double call(
            @Nonnull ThrowableBiObjFloatToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToDoubleFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjFloatToDoubleFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToDoubleFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjFloatToDoubleFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToDoubleFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToDoubleFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjFloatToDoubleFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableFloatToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToDoubleFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjFloatToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToDoubleFunction<T, U, X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, U u, float value) throws X;
     ...
     */
    default double applyAsDoubleThrows(@Nonnull Pair<T, U> tuple, float value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToDoubleFunction<Pair<T, U>, X> tupled() {
     ...
     * ThrowableBiObjFloatToDoubleFunction}. Thereby the primitive input argument for this function is autoboxed. This
     * method provides the possibility to use this {@code ThrowableBiObjFloatToDoubleFunction} with methods provided by
     * the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code
     * ThrowableBiObjFloatToDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Float, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link BiObjFloatToDoubleFunction} that applies this function to its input and nests the
     * thrown {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjFloatToDoubleFunction} that applies this function to its input and nests the
     ...
     */
    @Nonnull
    default BiObjFloatToDoubleFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjFloatToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjFloatToDoubleFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjFloatToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjFloatToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjFloatToDoubleFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjFloatToDoubleFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjFloatToDoubleFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsDoubleThrows(t, u, value);
