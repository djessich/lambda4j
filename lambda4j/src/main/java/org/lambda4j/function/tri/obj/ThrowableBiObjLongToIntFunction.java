...
public interface ThrowableBiObjLongToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToIntFunction<T, U, X> of(
            @Nullable final ThrowableBiObjLongToIntFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> int call(
            @Nonnull final ThrowableBiObjLongToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
    ...
    default BiObjLongToIntFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjLongToIntFunction<? super T, ? super U> function = recover.apply(throwable);
