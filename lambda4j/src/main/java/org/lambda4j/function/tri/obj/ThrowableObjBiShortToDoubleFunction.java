 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, short, short)
...
public interface ThrowableObjBiShortToDoubleFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToDoubleFunction<T, X> of(
            @Nullable ThrowableObjBiShortToDoubleFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjBiShortToDoubleFunction<? super T, ? extends X> function, T t, short value1,
     ...
     */
    @Nonnull
    default ThrowableBiShortToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToDoubleFunction<X> applyAsDoubleThrowsPartially(T t, short value1) {
     ...
     */
    @Nonnull
    default ThrowableObjShortToDoubleFunction<T, X> applyAsDoubleThrowsPartially(short value1) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(short value1, short value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiShortToDoubleFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Short, Short>, Double> cache = new ConcurrentHashMap<>();
     ...
     * ThrowableObjBiShortToDoubleFunction}.
     */
    @Nonnull
    ...
    default ObjBiShortToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiShortToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiShortToDoubleFunction<? super T> function = recover.apply(throwable);
