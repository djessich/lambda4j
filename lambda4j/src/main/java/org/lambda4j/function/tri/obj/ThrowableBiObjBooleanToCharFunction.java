...
public interface ThrowableBiObjBooleanToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToCharFunction<T, U, X> of(
            @Nullable ThrowableBiObjBooleanToCharFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> char call(
            @Nonnull ThrowableBiObjBooleanToCharFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanConsumer<T, U, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjBooleanToCharFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Boolean>, Character> cache = new ConcurrentHashMap<>();
     ...
     * ThrowableBiObjBooleanToCharFunction}.
     */
    @Nonnull
    ...
    default BiObjBooleanToCharFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjBooleanToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjBooleanToCharFunction<? super T, ? super U> function = recover.apply(throwable);
