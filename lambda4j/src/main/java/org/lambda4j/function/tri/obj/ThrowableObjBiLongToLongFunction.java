...
public interface ThrowableObjBiLongToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToLongFunction<T, X> of(
            @Nullable ThrowableObjBiLongToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjBiLongToLongFunction<? super T, ? extends X> function, T t, long value1,
     ...
     */
    @Nonnull
    default ThrowableLongBinaryOperator<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongUnaryOperator<X> applyAsLongThrowsPartially(T t, long value1) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToLongFunction<T, X> applyAsLongThrowsPartially(long value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(long value1, long value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiLongToLongFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiLongToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiLongToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiLongToLongFunction<? super T> function = recover.apply(throwable);
