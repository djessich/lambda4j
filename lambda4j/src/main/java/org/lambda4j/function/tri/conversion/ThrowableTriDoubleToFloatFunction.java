...
public interface ThrowableTriDoubleToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToFloatFunction<X> of(
            @Nullable ThrowableTriDoubleToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull ThrowableTriDoubleToFloatFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToFloatFunction<X> applyAsFloatThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToFloatFunction<X> applyAsFloatThrowsPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableTriDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriDoubleToFloatFunction<X> reversed() {
     ...
     * this {@code ThrowableTriDoubleToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriDoubleToFloatFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link TriDoubleToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default TriDoubleToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriDoubleToFloatFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriDoubleToFloatFunction function = recover.apply(throwable);
