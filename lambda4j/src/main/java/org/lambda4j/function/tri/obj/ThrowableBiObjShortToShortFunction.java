 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, short)
...
public interface ThrowableBiObjShortToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortToShortFunction<T, U, X> of(
            @Nullable ThrowableBiObjShortToShortFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> short call(
            @Nonnull ThrowableBiObjShortToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableBiObjShortConsumer<T, U, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
    ...
    default BiObjShortToShortFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjShortToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjShortToShortFunction<? super T, ? super U> function = recover.apply(throwable);
