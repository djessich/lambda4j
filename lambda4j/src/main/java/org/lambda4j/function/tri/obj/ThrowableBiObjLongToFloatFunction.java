 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, long)
...
public interface ThrowableBiObjLongToFloatFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToFloatFunction<T, U, X> of(
            @Nullable ThrowableBiObjLongToFloatFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> float call(
            @Nonnull ThrowableBiObjLongToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongToFloatFunction<U, X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToFloatFunction<X> applyAsFloatThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToFloatBiFunction<T, U, X> applyAsFloatThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<U, X> applyAsFloatThrowsPartially(T t, long value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
    ...
    default BiObjLongToFloatFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjLongToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjLongToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
