 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, byte, byte)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(Object, byte, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiByteToDoubleFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiByteToDoubleFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableObjBiByteToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjBiByteToDoubleFunction<T, X> of(
            @Nullable ThrowableObjBiByteToDoubleFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiByteToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> double call(
            @Nonnull ThrowableObjBiByteToDoubleFunction<? super T, ? extends X> function, T t, byte value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToDoubleFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToDoubleFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableByteToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToDoubleFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToDoubleFunction<T, X> onlySecond(
            @Nonnull ThrowableByteToDoubleFunction<? extends X> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsDoubleThrows(value1);
    }

    /**
     * Creates a {@link ThrowableObjBiByteToDoubleFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@link ThrowableByteToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToDoubleFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableByteToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToDoubleFunction<T, X> onlyThird(
            @Nonnull ThrowableByteToDoubleFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiByteToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToDoubleFunction<T, X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, byte value1, byte value2) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link
     * ThrowableBiByteToDoubleFunction} as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableBiByteToDoubleFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableBiByteToDoubleFunction<X> applyAsDoubleThrowsPartially(T t) {
        return (value1, value2) -> applyAsDoubleThrows(t, value1, value2);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableByteToDoubleFunction}
     * as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @param value1 The second argument to this function used to partially apply this function
     * @return A {@code ThrowableByteToDoubleFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableByteToDoubleFunction<X> applyAsDoubleThrowsPartially(T t, byte value1) {
        return value2 -> applyAsDoubleThrows(t, value1, value2);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link
     * ThrowableObjByteToDoubleFunction} as result.
     *
     * @param value1 The second argument to this function used to partially apply this function
     * @return A {@code ThrowableObjByteToDoubleFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjByteToDoubleFunction<T, X> applyAsDoubleThrowsPartially(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<T, X> applyAsDoubleThrowsPartially(byte value1, byte value2) {
    ...
    default <A, B, C> ThrowableToDoubleTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsDoubleThrows(before1.applyThrows(a), before2.applyAsByteThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(applyAsDoubleThrows(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiByteToDoubleFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiByteToDoubleFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjBiByteToDoubleFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, Byte, Byte>, Double> cache = new ConcurrentHashMap<>();
            return (ThrowableObjBiByteToDoubleFunction<T, X> & Memoized) (t, value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiByteToDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiByteToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiByteToDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Byte, Byte, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link ObjBiByteToDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiByteToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiByteToDoubleFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiByteToDoubleFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiByteToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiByteToDoubleFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiByteToDoubleFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiByteToDoubleFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiByteToDoubleFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiByteToDoubleFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiByteToDoubleFunction<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return applyAsDoubleThrows(t, value1, value2);
