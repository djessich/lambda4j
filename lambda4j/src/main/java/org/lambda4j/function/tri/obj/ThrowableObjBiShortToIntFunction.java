...
public interface ThrowableObjBiShortToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToIntFunction<T, X> of(
            @Nullable ThrowableObjBiShortToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjBiShortToIntFunction<? super T, ? extends X> function, T t, short value1,
     ...
     */
    @Nonnull
    default ThrowableBiShortToIntFunction<X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> applyAsIntThrowsPartially(T t, short value1) {
     ...
     */
    @Nonnull
    default ThrowableObjShortToIntFunction<T, X> applyAsIntThrowsPartially(short value1) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<T, X> applyAsIntThrowsPartially(short value1, short value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjBiShortToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBiShortToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiShortToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiShortToIntFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiShortToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiShortToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiShortToIntFunction<? super T> function = recover.apply(throwable);
