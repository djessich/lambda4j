 ...
 * result. This is a (reference, reference, float) specialization of {@link TriFunction}.
 * <p>
...
public interface BiObjFloatFunction<T, U, R> extends Lambda {
     ...
     */
    static <T, U, R> BiObjFloatFunction<T, U, R> of(@Nullable BiObjFloatFunction<T, U, R> expression) {
        return expression;
    }
    ...
    static <T, U, R> BiObjFloatFunction<T, U, Optional<R>> lift(
            @Nonnull BiObjFloatFunction<? super T, ? super U, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U, R> R call(@Nonnull BiObjFloatFunction<? super T, ? super U, ? extends R> function, T t, U u,
            float value) {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjFloatFunction<T, U, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjFloatFunction<T, U, R> onlySecond(@Nonnull Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjFloatFunction<T, U, R> onlyThird(@Nonnull FloatFunction<? extends R> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Applies this function partially to some arguments of this one, producing a {@link ObjFloatFunction} as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ObjFloatFunction} that represents this function partially applied the some arguments.
     */
    @Nonnull
    default ObjFloatFunction<U, R> applyPartially(T t) {
     ...
     */
    @Nonnull
    default FloatFunction<R> applyPartially(T t, U u) {
     ...
     */
    @Nonnull
    default BiFunction2<T, U, R> applyPartially(float value) {
     ...
     */
    @Nonnull
    default Function2<U, R> applyPartially(T t, float value) {
     ...
     */
    @Nonnull
    default <S> BiObjFloatFunction<T, U, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjFloatConsumer<T, U> consume(@Nonnull Consumer<? super R> consumer) {
     ...
     * BiObjFloatFunction} with methods provided by the {@code JDK}.
     *
