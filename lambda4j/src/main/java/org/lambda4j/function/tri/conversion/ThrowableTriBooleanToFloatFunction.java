...
public interface ThrowableTriBooleanToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriBooleanToFloatFunction<X> of(
            @Nullable ThrowableTriBooleanToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull ThrowableTriBooleanToFloatFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiBooleanToFloatFunction<X> applyAsFloatThrowsPartially(boolean value1) {
     ...
     */
    @Nonnull
    default ThrowableBooleanToFloatFunction<X> applyAsFloatThrowsPartially(boolean value1, boolean value2) {
    ...
    /**
     * Returns a composed {@link ThrowableTriIntToFloatFunction} that first applies the {@code before} predicates to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableTriIntToFloatFunction<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriBooleanConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriBooleanToFloatFunction<X> reversed() {
     ...
     * this {@code ThrowableTriBooleanToFloatFunction} with methods provided by the {@code JDK}.
     *
    ...
    default TriBooleanToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriBooleanToFloatFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriBooleanToFloatFunction function = recover.apply(throwable);
