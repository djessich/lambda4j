 ...
 * {@code float}-valued result. This is a (reference, reference, double) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloat(Object, Object, double)}.
 *
...
@FunctionalInterface
public interface BiObjDoubleToFloatFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjDoubleToFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjDoubleToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjDoubleToFloatFunction<T, U> of(@Nullable BiObjDoubleToFloatFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjDoubleToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjDoubleToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> float call(@Nonnull BiObjDoubleToFloatFunction<? super T, ? super U> function, T t, U u,
            double value) {
    ...
    /**
     * Creates a {@link BiObjDoubleToFloatFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjDoubleToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjDoubleToFloatFunction<T, U> onlyFirst(@Nonnull ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsFloat(t);
    }

    /**
     * Creates a {@link BiObjDoubleToFloatFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjDoubleToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjDoubleToFloatFunction<T, U> onlySecond(@Nonnull ToFloatFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsFloat(u);
    }

    /**
     * Creates a {@link BiObjDoubleToFloatFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link DoubleToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjDoubleToFloatFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code DoubleToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjDoubleToFloatFunction<T, U> onlyThird(@Nonnull DoubleToFloatFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsFloat(value);
    }

    /**
     * Creates a {@link BiObjDoubleToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjDoubleToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjDoubleToFloatFunction<T, U> constant(float ret) {
     ...
     */
    float applyAsFloat(T t, U u, double value);
     ...
     */
    default float applyAsFloat(@Nonnull Pair<T, U> tuple, double value) {
     ...
     */
    @Nonnull
    default ObjDoubleToFloatFunction<U> applyAsFloatPartially(T t) {
     ...
     */
    @Nonnull
    default DoubleToFloatFunction applyAsFloatPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToFloatBiFunction<T, U> applyAsFloatPartially(double value) {
     ...
     */
    @Nonnull
    default ToFloatFunction<U> applyAsFloatPartially(T t, double value) {
    ...
    default <A, B, C> ToFloatTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsFloat(before1.apply(a), before2.apply(b), before3.applyAsDouble(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjDoubleFunction<T, U, S> andThen(@Nonnull FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> andThenToBoolean(@Nonnull FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToByteFunction<T, U> andThenToByte(@Nonnull FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToCharFunction<T, U> andThenToChar(@Nonnull FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> andThenToDouble(@Nonnull FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToFloatFunction<T, U> andThenToFloat(@Nonnull FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToIntFunction<T, U> andThenToInt(@Nonnull FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToLongFunction<T, U> andThenToLong(@Nonnull FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToShortFunction<T, U> andThenToShort(@Nonnull FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleConsumer<T, U> consume(@Nonnull FloatConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjDoubleToFloatFunction<Pair<T, U>> tupled() {
        return this::applyAsFloat;
    }

    /**
     * Returns a memoized (caching) version of this {@link BiObjDoubleToFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiObjDoubleToFloatFunction}.
     ...
     */
    @Nonnull
    default BiObjDoubleToFloatFunction<T, U> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Double>, Float> cache = new ConcurrentHashMap<>();
            return (BiObjDoubleToFloatFunction<T, U> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjDoubleToFloatFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjDoubleToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjDoubleToFloatFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Double, Float> boxed() {
        return this::applyAsFloat;
    }
}
