 ...
 * {@code double}-valued result. This is a (reference, reference, double) specialization of {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface BiObjDoubleToDoubleFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjDoubleToDoubleFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjDoubleToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U> BiObjDoubleToDoubleFunction<T, U> of(@Nullable BiObjDoubleToDoubleFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjDoubleToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjDoubleToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> double call(@Nonnull BiObjDoubleToDoubleFunction<? super T, ? super U> function, T t, U u,
            double value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToDoubleFunction<T, U> onlyFirst(@Nonnull ToDoubleFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToDoubleFunction<T, U> onlySecond(@Nonnull ToDoubleFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjDoubleToDoubleFunction<T, U> onlyThird(@Nonnull DoubleUnaryOperator operator) {
        Objects.requireNonNull(operator);
        return (t, u, value) -> operator.applyAsDouble(value);
    }

    /**
     * Creates a {@link BiObjDoubleToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjDoubleToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjDoubleToDoubleFunction<T, U> constant(double ret) {
     ...
     */
    @Nonnull
    default ObjDoubleToDoubleFunction<U> applyAsDoublePartially(T t) {
     ...
     */
    @Nonnull
    default DoubleUnaryOperator2 applyAsDoublePartially(T t, U u) {
        return value -> applyAsDouble(t, u, value);
    }

    /**
     * Applies this operator partially to some arguments of this one, producing a {@link ToDoubleBiFunction2} as
     * result.
     *
     ...
     */
    @Nonnull
    default ToDoubleBiFunction2<T, U> applyAsDoublePartially(double value) {
     ...
     */
    @Nonnull
    default ToDoubleFunction2<U> applyAsDoublePartially(T t, double value) {
     ...
     */
    @Nonnull
    default <S> BiObjDoubleFunction<T, U, S> andThen(@Nonnull DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjDoublePredicate<T, U> andThenToBoolean(@Nonnull DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToByteFunction<T, U> andThenToByte(@Nonnull DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToCharFunction<T, U> andThenToChar(@Nonnull DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> andThenToDouble(@Nonnull DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToFloatFunction<T, U> andThenToFloat(@Nonnull DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToIntFunction<T, U> andThenToInt(@Nonnull DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToLongFunction<T, U> andThenToLong(@Nonnull DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleToShortFunction<T, U> andThenToShort(@Nonnull DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjDoubleConsumer<T, U> consume(@Nonnull DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjDoubleToDoubleFunction<Pair<T, U>> tupled() {
        return this::applyAsDouble;
    }

    /**
     * Returns a memoized (caching) version of this {@link BiObjDoubleToDoubleFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiObjDoubleToDoubleFunction}.
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Double>, Double> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (BiObjDoubleToDoubleFunction<T, U> & Memoized) (t, u, value) -> {
                double returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjDoubleToDoubleFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjDoubleToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjDoubleToDoubleFunction}.
     */
    @Nonnull
