...
/**
 * Represents an operation that accepts three {@code short}-valued input arguments and produces a result. This is a
...
@FunctionalInterface
public interface TriShortFunction<R> extends Lambda {

    /**
     * Constructs a {@link TriShortFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code TriShortFunction} from given lambda expression or method reference.
    ...
    /**
     * Lifts a partial {@link TriShortFunction} into a total {@link TriShortFunction} that returns an {@link Optional}
     * result.
     *
     * @param <R> The type of return value from the function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code TriShortFunction} lifted into a total {@code TriShortFunction} that returns an {@code
     * Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriShortFunction<Optional<R>> lift(@Nonnull TriShortFunction<? extends R> partial) {
        Objects.requireNonNull(partial);
        return (value1, value2, value3) -> Optional.ofNullable(partial.apply(value1, value2, value3));
    }

    /**
     * Calls the given {@link TriShortFunction} with the given arguments and returns its result.
     *
     * @param <R> The type of return value from the function
     ...
     * @return The result from the given {@code TriShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <R> R call(@Nonnull TriShortFunction<? extends R> function, short value1, short value2, short value3) {
        Objects.requireNonNull(function);
        return function.apply(value1, value2, value3);
    }

    /**
     * Creates a {@link TriShortFunction} which uses the {@code first} parameter of this one as argument for the given
     * {@link ShortFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code TriShortFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@code ShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriShortFunction<R> onlyFirst(@Nonnull ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (value1, value2, value3) -> function.apply(value1);
    }

    /**
     * Creates a {@link TriShortFunction} which uses the {@code second} parameter of this one as argument for the given
     * {@link ShortFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code TriShortFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@code ShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriShortFunction<R> onlySecond(@Nonnull ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (value1, value2, value3) -> function.apply(value2);
    }

    /**
     * Creates a {@link TriShortFunction} which uses the {@code third} parameter of this one as argument for the given
     * {@link ShortFunction}.
     *
     * @param <R> The type of return value from the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code TriShortFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@code ShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R> TriShortFunction<R> onlyThird(@Nonnull ShortFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return (value1, value2, value3) -> function.apply(value3);
    }

    /**
     * Creates a {@link TriShortFunction} which always returns a given value.
     *
     * @param <R> The type of return value from the function
     * @param ret The return value for the constant
     * @return A {@code TriShortFunction} which always returns a given value.
     */
    @Nonnull
    static <R> TriShortFunction<R> constant(R ret) {
     ...
     */
    @Nonnull
    default <A, B, C> TriFunction<A, B, C, R> compose(@Nonnull ToShortFunction<? super A> before1,
            @Nonnull ToShortFunction<? super B> before2, @Nonnull ToShortFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> apply(before1.applyAsShort(a), before2.applyAsShort(b), before3.applyAsShort(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanFunction<R> composeFromBoolean(@Nonnull BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default TriByteFunction<R> composeFromByte(@Nonnull ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default TriCharFunction<R> composeFromChar(@Nonnull CharToShortFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> composeFromDouble(@Nonnull DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default TriFloatFunction<R> composeFromFloat(@Nonnull FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default TriIntFunction<R> composeFromInt(@Nonnull IntToShortFunction before1,
     ...
     */
    @Nonnull
    default TriLongFunction<R> composeFromLong(@Nonnull LongToShortFunction before1,
    ...
    /**
     * Returns a composed {@link TriShortFunction} that first applies the {@code before} operators to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     ...
     * @return A composed {@code TriShortFunction} that first applies the {@code before} operators to its input, and
     * then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default TriShortFunction<R> composeFromShort(@Nonnull ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <S> TriShortFunction<S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default TriShortPredicate andThenToBoolean(@Nonnull Predicate<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToByteFunction andThenToByte(@Nonnull ToByteFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToCharFunction andThenToChar(@Nonnull ToCharFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToDoubleFunction andThenToDouble(@Nonnull ToDoubleFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToFloatFunction andThenToFloat(@Nonnull ToFloatFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToIntFunction andThenToInt(@Nonnull ToIntFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToLongFunction andThenToLong(@Nonnull ToLongFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortTernaryOperator andThenToShort(@Nonnull ToShortFunction<? super R> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortConsumer consume(@Nonnull Consumer<? super R> consumer) {
     ...
     */
    @Nonnull
    default TriShortFunction<R> reversed() {
    ...
    @Deprecated
    @Nonnull
    default TriShortFunction<Optional<R>> nonNull() {
        return (value1, value2, value3) -> Optional.ofNullable(apply(value1, value2, value3));
    }

    /**
     * Returns a composed {@link TriFunction} which represents this {@link TriShortFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * TriShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code TriShortFunction}.
     */
    @Nonnull
