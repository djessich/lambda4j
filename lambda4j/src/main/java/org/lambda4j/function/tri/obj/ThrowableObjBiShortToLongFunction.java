 ...
 * {@code long}-valued result which is able to throw any {@link Throwable}. This is a (reference, short, short)
...
public interface ThrowableObjBiShortToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiShortToLongFunction<T, X> of(
            @Nullable ThrowableObjBiShortToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjBiShortToLongFunction<? super T, ? extends X> function, T t, short value1,
     ...
     */
    @Nonnull
    default ThrowableBiShortToLongFunction<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToLongFunction<X> applyAsLongThrowsPartially(T t, short value1) {
     ...
     */
    @Nonnull
    default ThrowableObjShortToLongFunction<T, X> applyAsLongThrowsPartially(short value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(short value1, short value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiShortConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiShortToLongFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiShortToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiShortToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiShortToLongFunction<? super T> function = recover.apply(throwable);
