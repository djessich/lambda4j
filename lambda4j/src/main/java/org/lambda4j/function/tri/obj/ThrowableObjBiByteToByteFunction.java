 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, byte, byte)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, byte, byte)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiByteToByteFunction<T, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiByteToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableObjBiByteToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, X extends Throwable> ThrowableObjBiByteToByteFunction<T, X> of(
            @Nullable ThrowableObjBiByteToByteFunction<T, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableObjBiByteToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiByteToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, X extends Throwable> byte call(
            @Nonnull ThrowableObjBiByteToByteFunction<? super T, ? extends X> function, T t, byte value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToByteFunction<T, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiByteToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableByteUnaryOperator}.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param operator The operator which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiByteToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableByteUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToByteFunction<T, X> onlySecond(
            @Nonnull ThrowableByteUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsByteThrows(value1);
    }

    /**
     * Creates a {@link ThrowableObjBiByteToByteFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableObjBiByteToByteFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableByteUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToByteFunction<T, X> onlyThird(
            @Nonnull ThrowableByteUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsByteThrows(value2);
    }

    /**
     * Creates a {@link ThrowableObjBiByteToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiByteToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, X extends Throwable> ThrowableObjBiByteToByteFunction<T, X> constant(byte ret) {
    ...
    default <A, B, C> ThrowableToByteTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsByteThrows(before1.applyThrows(a), before2.applyAsByteThrows(b),
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.acceptThrows(applyAsByteThrows(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableObjBiByteToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableObjBiByteToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableObjBiByteToByteFunction<T, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, Byte, Byte>, Byte> cache = new ConcurrentHashMap<>();
            return (ThrowableObjBiByteToByteFunction<T, X> & Memoized) (t, value1, value2) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiByteToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiByteToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiByteToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Byte, Byte, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link ObjBiByteToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiByteToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiByteToByteFunction<T> nest() {
     ...
     */
    @Nonnull
    default ObjBiByteToByteFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiByteToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiByteToByteFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiByteToByteFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiByteToByteFunction<? super T> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiByteToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link ObjBiByteToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiByteToByteFunction<T> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return applyAsByteThrows(t, value1, value2);
