 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, float, float) specialization of {@link
 * ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiFloatFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, R, X extends Throwable> ThrowableObjBiFloatFunction<T, R, X> of(
            @Nullable ThrowableObjBiFloatFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjBiFloatFunction} into a total {@link ThrowableObjBiFloatFunction} that returns
     ...
     * @return A partial {@code ThrowableObjBiFloatFunction} lifted into a total {@code ThrowableObjBiFloatFunction}
     * that returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiFloatFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjBiFloatFunction<? super T, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, value1, value2) -> Optional.ofNullable(partial.applyThrows(t, value1, value2));
    }

    /**
     * Calls the given {@link ThrowableObjBiFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjBiFloatFunction<? super T, ? extends R, ? extends X> function, T t, float value1,
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiFloatFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiFloatFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return Creates a {@code ThrowableObjBiFloatFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiFloatFunction<T, R, X> onlyThird(
            @Nonnull ThrowableFloatFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiFloatFunction<T, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, float value1, float value2) throws X;
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyAsFloatThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyThrows(value1), before2.applyAsFloatThrows(value2),
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(
    ...
    default ThrowableObjBiFloatFunction<T, R, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Float, Float>, R> cache = new ConcurrentHashMap<>();
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjBiFloatFunction<T, Optional<R>, X> nonNull() {
        return (t, value1, value2) -> Optional.ofNullable(applyThrows(t, value1, value2));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Float, Float, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjBiFloatFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiFloatFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default ObjBiFloatFunction<T, R> nest() {
     ...
     */
    @Nonnull
    default ObjBiFloatFunction<T, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiFloatFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiFloatFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiFloatFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiFloatFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiFloatFunction<T, R> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return applyThrows(t, value1, value2);
