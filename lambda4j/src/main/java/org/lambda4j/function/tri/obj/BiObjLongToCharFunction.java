 ...
 * {@code char}-valued result. This is a (reference, reference, long) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsChar(Object, Object, long)}.
 *
...
@FunctionalInterface
public interface BiObjLongToCharFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjLongToCharFunction} based on a lambda expression or a method reference. Thereby the
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjLongToCharFunction<T, U> of(@Nullable BiObjLongToCharFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjLongToCharFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjLongToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> char call(@Nonnull BiObjLongToCharFunction<? super T, ? super U> function, T t, U u,
            long value) {
    ...
    /**
     * Creates a {@link BiObjLongToCharFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjLongToCharFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToCharFunction<T, U> onlyFirst(@Nonnull ToCharFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(t);
    }

    /**
     * Creates a {@link BiObjLongToCharFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjLongToCharFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToCharFunction<T, U> onlySecond(@Nonnull ToCharFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(u);
    }

    /**
     * Creates a {@link BiObjLongToCharFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link LongToCharFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjLongToCharFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code LongToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToCharFunction<T, U> onlyThird(@Nonnull LongToCharFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsChar(value);
    }

    /**
     * Creates a {@link BiObjLongToCharFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjLongToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjLongToCharFunction<T, U> constant(char ret) {
     ...
     */
    char applyAsChar(T t, U u, long value);
     ...
     */
    default char applyAsChar(@Nonnull Pair<T, U> tuple, long value) {
    ...
    default <A, B, C> ToCharTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsChar(before1.apply(a), before2.apply(b), before3.applyAsLong(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjLongFunction<T, U, S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjLongPredicate<T, U> andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToCharFunction<T, U> andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToFloatFunction<T, U> andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToIntFunction<T, U> andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToLongFunction<T, U> andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToShortFunction<T, U> andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjLongToCharFunction<Pair<T, U>> tupled() {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjLongToCharFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjLongToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjLongToCharFunction}.
     */
    @Nonnull
