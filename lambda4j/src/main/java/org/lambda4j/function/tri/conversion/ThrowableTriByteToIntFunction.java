...
public interface ThrowableTriByteToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriByteToIntFunction<X> of(
            @Nullable ThrowableTriByteToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableTriByteToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiByteToIntFunction<X> applyAsIntThrowsPartially(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> applyAsIntThrowsPartially(byte value1, byte value2) {
     ...
     */
    @Nonnull
    default ThrowableTriBytePredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriByteToIntFunction<X> andThenToInt(@Nonnull ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriByteToIntFunction<X> reversed() {
     ...
     * this {@code ThrowableTriByteToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriByteToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriByteToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriByteToIntFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default TriByteToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriByteToIntFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriByteToIntFunction function = recover.apply(throwable);
