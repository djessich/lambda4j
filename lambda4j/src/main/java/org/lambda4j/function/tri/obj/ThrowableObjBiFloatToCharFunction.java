 ...
 * {@code char}-valued result which is able to throw any {@link Throwable}. This is a (reference, float, float)
...
public interface ThrowableObjBiFloatToCharFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiFloatToCharFunction<T, X> of(
            @Nullable ThrowableObjBiFloatToCharFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> char call(
            @Nonnull ThrowableObjBiFloatToCharFunction<? super T, ? extends X> function, T t, float value1,
     ...
     */
    @Nonnull
    default ThrowableBiFloatToCharFunction<X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToCharFunction<X> applyAsCharThrowsPartially(T t, float value1) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToCharFunction<T, X> applyAsCharThrowsPartially(float value1) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<T, X> applyAsCharThrowsPartially(float value1, float value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiFloatConsumer<T, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiFloatToCharFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Float, Float>, Character> cache = new ConcurrentHashMap<>();
    ...
    default ObjBiFloatToCharFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiFloatToCharFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiFloatToCharFunction<? super T> function = recover.apply(throwable);
