...
public interface ThrowableTriByteToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriByteToFloatFunction<X> of(
            @Nullable ThrowableTriByteToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull ThrowableTriByteToFloatFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriBytePredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriByteConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriByteToFloatFunction<X> reversed() {
     ...
     * this {@code ThrowableTriByteToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriByteToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriByteToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriByteToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default TriByteToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriByteToFloatFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriByteToFloatFunction function = recover.apply(throwable);
