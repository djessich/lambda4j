...
@FunctionalInterface
public interface TriLongToCharFunction extends Lambda {

    /**
     * Constructs a {@link TriLongToCharFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriLongToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static TriLongToCharFunction of(@Nullable TriLongToCharFunction expression) {
        return expression;
    }
     ...
     */
    static char call(@Nonnull TriLongToCharFunction function, long value1, long value2, long value3) {
     ...
     */
    @Nonnull
    static TriLongToCharFunction onlyFirst(@Nonnull LongToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriLongToCharFunction onlySecond(@Nonnull LongToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriLongToCharFunction onlyThird(@Nonnull LongToCharFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B, C> ToCharTriFunction<A, B, C> compose(@Nonnull ToLongFunction<? super A> before1,
            @Nonnull ToLongFunction<? super B> before2, @Nonnull ToLongFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> applyAsChar(before1.applyAsLong(a), before2.applyAsLong(b), before3.applyAsLong(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanToCharFunction composeFromBoolean(@Nonnull BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default TriByteToCharFunction composeFromByte(@Nonnull ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default CharTernaryOperator composeFromChar(@Nonnull CharToLongFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction composeFromDouble(@Nonnull DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToCharFunction composeFromFloat(@Nonnull FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default TriIntToCharFunction composeFromInt(@Nonnull IntToLongFunction before1,
    ...
    /**
     * Returns a composed {@link TriLongToCharFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default TriLongToCharFunction composeFromLong(@Nonnull LongUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriShortToCharFunction composeFromShort(@Nonnull ShortToLongFunction before1,
     ...
     */
    @Nonnull
    default <S> TriLongFunction<S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriLongPredicate andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToByteFunction andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToCharFunction andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToFloatFunction andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToIntFunction andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongTernaryOperator andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToShortFunction andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongConsumer consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default TriLongToCharFunction reversed() {
        return (value3, value2, value1) -> applyAsChar(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link TriLongToCharFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code TriLongToCharFunction}.
     ...
     */
    @Nonnull
    default TriLongToCharFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<Long, Long, Long>, Character> cache = new ConcurrentHashMap<>();
            return (TriLongToCharFunction & Memoized) (value1, value2, value3) -> {
     ...
     * TriLongToCharFunction} with methods provided by the {@code JDK}.
     *
