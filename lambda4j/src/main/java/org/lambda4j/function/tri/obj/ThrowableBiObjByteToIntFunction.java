...
import org.lambda4j.consumer.tri.obj.ThrowableBiObjByteConsumer;
...
import org.lambda4j.predicate.tri.obj.ThrowableBiObjBytePredicate;

/**
 * Represents an operation that accepts two object-valued and one {@code byte}-valued input argument and produces a
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, byte)
...
public interface ThrowableBiObjByteToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToIntFunction<T, U, X> of(
            @Nullable ThrowableBiObjByteToIntFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> int call(
            @Nonnull ThrowableBiObjByteToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjByteToIntFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Byte>, Integer> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default BiObjByteToIntFunction<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiObjByteToIntFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjByteToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjByteToIntFunction<? super T, ? super U> function = recover.apply(throwable);
