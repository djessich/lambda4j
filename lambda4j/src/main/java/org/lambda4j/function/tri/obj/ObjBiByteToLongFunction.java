...
import org.lambda4j.function.bi.obj.ObjByteToLongFunction;
 ...
 * {@code long}-valued result. This is a (reference, byte, byte) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLong(Object, byte, byte)}.
 *
...
@FunctionalInterface
public interface ObjBiByteToLongFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiByteToLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjBiByteToLongFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T> ObjBiByteToLongFunction<T> of(@Nullable ObjBiByteToLongFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiByteToLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiByteToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> long call(@Nonnull ObjBiByteToLongFunction<? super T> function, T t, byte value1, byte value2) {
     ...
     */
    @Nonnull
    static <T> ObjBiByteToLongFunction<T> onlyFirst(@Nonnull ToLongFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsLong(t);
    }

    /**
     * Creates a {@link ObjBiByteToLongFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ByteToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiByteToLongFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ByteToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiByteToLongFunction<T> onlySecond(@Nonnull ByteToLongFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsLong(value1);
    }

    /**
     * Creates a {@link ObjBiByteToLongFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link ByteToLongFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiByteToLongFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code ByteToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiByteToLongFunction<T> onlyThird(@Nonnull ByteToLongFunction function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsLong(value2);
    }

    /**
     * Creates a {@link ObjBiByteToLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiByteToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiByteToLongFunction<T> constant(long ret) {
     ...
     */
    @Nonnull
    default BiByteToLongFunction applyAsLongPartially(T t) {
     ...
     */
    @Nonnull
    default ByteToLongFunction applyAsLongPartially(T t, byte value1) {
     ...
     */
    @Nonnull
    default ObjByteToLongFunction<T> applyAsLongPartially(byte value1) {
     ...
     */
    @Nonnull
    default ToLongFunction2<T> applyAsLongPartially(byte value1, byte value2) {
    ...
    default <A, B, C> ToLongTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsLong(before1.apply(a), before2.applyAsByte(b), before3.applyAsByte(c));
    }
     ...
     */
    @Nonnull
    default <S> ObjBiByteFunction<T, S> andThen(@Nonnull LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiBytePredicate<T> andThenToBoolean(@Nonnull LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteToByteFunction<T> andThenToByte(@Nonnull LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteToCharFunction<T> andThenToChar(@Nonnull LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteToDoubleFunction<T> andThenToDouble(@Nonnull LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteToFloatFunction<T> andThenToFloat(@Nonnull LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteToIntFunction<T> andThenToInt(@Nonnull LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteToLongFunction<T> andThenToLong(@Nonnull LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteToShortFunction<T> andThenToShort(@Nonnull LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiByteConsumer<T> consume(@Nonnull LongConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(applyAsLong(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ObjBiByteToLongFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ObjBiByteToLongFunction}.
     ...
     */
    @Nonnull
    default ObjBiByteToLongFunction<T> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, Byte, Byte>, Long> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ObjBiByteToLongFunction<T> & Memoized) (t, value1, value2) -> {
                long returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiByteToLongFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjBiByteToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiByteToLongFunction}.
     */
    @Nonnull
