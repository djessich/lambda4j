...
public interface ThrowableBiObjFloatToByteFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToByteFunction<T, U, X> of(
            @Nullable final ThrowableBiObjFloatToByteFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableBiObjFloatToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
    ...
    default BiObjFloatToByteFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjFloatToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjFloatToByteFunction<? super T, ? super U> function = recover.apply(throwable);
