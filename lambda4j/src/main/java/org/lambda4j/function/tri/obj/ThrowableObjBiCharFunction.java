...
public interface ThrowableObjBiCharFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, R, X> of(
            @Nullable ThrowableObjBiCharFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjBiCharFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjBiCharFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjBiCharFunction<? super T, ? extends R, ? extends X> function, T t, char value1,
    ...
    default ObjBiCharFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiCharFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiCharFunction<? super T, ? extends R> function = recover.apply(throwable);
