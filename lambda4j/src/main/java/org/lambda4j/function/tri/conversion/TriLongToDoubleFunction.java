...
public interface TriLongToDoubleFunction extends Lambda {
     ...
     */
    @Nonnull
    default BiLongToDoubleFunction papplyAsDouble(long value1) {
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 papplyAsDouble(long value1, long value2) {
    ...
    /**
     * Returns a composed {@link TriLongToDoubleFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
