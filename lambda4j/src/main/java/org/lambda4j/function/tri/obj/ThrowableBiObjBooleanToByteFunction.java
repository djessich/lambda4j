 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, boolean)
...
public interface ThrowableBiObjBooleanToByteFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjBooleanToByteFunction<T, U, X> of(
            @Nullable ThrowableBiObjBooleanToByteFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> byte call(
            @Nonnull ThrowableBiObjBooleanToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableBiObjBooleanConsumer<T, U, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjBooleanToByteFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Boolean>, Byte> cache = new ConcurrentHashMap<>();
     ...
     * ThrowableBiObjBooleanToByteFunction}.
     */
    @Nonnull
    ...
    default BiObjBooleanToByteFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjBooleanToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjBooleanToByteFunction<? super T, ? super U> function = recover.apply(throwable);
