...
public interface ThrowableTriDoubleToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriDoubleToIntFunction<X> of(
            @Nullable ThrowableTriDoubleToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableTriDoubleToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToIntFunction<X> applyAsIntThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToIntFunction<X> applyAsIntThrowsPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableTriDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriDoubleToIntFunction<X> reversed() {
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriDoubleToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriDoubleToIntFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriDoubleToIntFunction function = recover.apply(throwable);
