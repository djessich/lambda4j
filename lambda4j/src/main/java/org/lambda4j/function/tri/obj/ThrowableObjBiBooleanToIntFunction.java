 ...
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, boolean, boolean)
...
public interface ThrowableObjBiBooleanToIntFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiBooleanToIntFunction<T, X> of(
            @Nullable ThrowableObjBiBooleanToIntFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> int call(
            @Nonnull ThrowableObjBiBooleanToIntFunction<? super T, ? extends X> function, T t, boolean value1,
     ...
     */
    @Nonnull
    default ThrowableObjBiBooleanConsumer<T, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableObjBiBooleanToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     */
    @Nonnull
    default ObjBiBooleanToIntFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiBooleanToIntFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiBooleanToIntFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiBooleanToIntFunction<? super T> function = recover.apply(throwable);
