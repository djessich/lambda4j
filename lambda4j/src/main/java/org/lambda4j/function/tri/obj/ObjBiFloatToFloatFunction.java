...
import org.lambda4j.function.bi.obj.ObjFloatToFloatFunction;
...
import org.lambda4j.predicate.tri.obj.ObjBiFloatPredicate;

/**
 * Represents an operation that accepts one object-valued and two {@code float}-valued input arguments and produces a
 * {@code float}-valued result. This is a (reference, float, float) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloat(Object, float, float)}.
 *
...
@FunctionalInterface
public interface ObjBiFloatToFloatFunction<T> extends Lambda {

    /**
     * Constructs a {@link ObjBiFloatToFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ObjBiFloatToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T> ObjBiFloatToFloatFunction<T> of(@Nullable ObjBiFloatToFloatFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ObjBiFloatToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     ...
     * @return The result from the given {@code ObjBiFloatToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T> float call(@Nonnull ObjBiFloatToFloatFunction<? super T> function, T t, float value1,
            float value2) {
    ...
    /**
     * Creates a {@link ObjBiFloatToFloatFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ObjBiFloatToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiFloatToFloatFunction<T> onlyFirst(@Nonnull ToFloatFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, value1, value2) -> function.applyAsFloat(t);
    }

    /**
     * Creates a {@link ObjBiFloatToFloatFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link FloatUnaryOperator}.
     *
     * @param <T> The type of the first argument to the function
     * @param operator The operator which accepts the {@code second} parameter of this one
     * @return Creates a {@code ObjBiFloatToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code FloatUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiFloatToFloatFunction<T> onlySecond(@Nonnull FloatUnaryOperator operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsFloat(value1);
    }

    /**
     * Creates a {@link ObjBiFloatToFloatFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link FloatUnaryOperator}.
     *
     * @param <T> The type of the first argument to the function
     * @param operator The operator which accepts the {@code third} parameter of this one
     * @return Creates a {@code ObjBiFloatToFloatFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code FloatUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T> ObjBiFloatToFloatFunction<T> onlyThird(@Nonnull FloatUnaryOperator operator) {
        Objects.requireNonNull(operator);
        return (t, value1, value2) -> operator.applyAsFloat(value2);
    }

    /**
     * Creates a {@link ObjBiFloatToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param ret The return value for the constant
     * @return A {@code ObjBiFloatToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T> ObjBiFloatToFloatFunction<T> constant(float ret) {
     ...
     */
    @Nonnull
    default FloatBinaryOperator applyAsFloatPartially(T t) {
     ...
     */
    @Nonnull
    default FloatUnaryOperator applyAsFloatPartially(T t, float value1) {
     ...
     */
    @Nonnull
    default ObjFloatToFloatFunction<T> applyAsFloatPartially(float value1) {
     ...
     */
    @Nonnull
    default ToFloatFunction<T> applyAsFloatPartially(float value1, float value2) {
    ...
    default <A, B, C> ToFloatTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsFloat(before1.apply(a), before2.applyAsFloat(b), before3.applyAsFloat(c));
    }
    ...
    default TriBooleanToFloatFunction composeFromBoolean(@Nonnull BooleanFunction<? extends T> before1,
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsFloat(before1.apply(value1), before2.applyAsFloat(value2),
     ...
     */
    @Nonnull
    default <S> ObjBiFloatFunction<T, S> andThen(@Nonnull FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ObjBiFloatPredicate<T> andThenToBoolean(@Nonnull FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatToByteFunction<T> andThenToByte(@Nonnull FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatToCharFunction<T> andThenToChar(@Nonnull FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatToDoubleFunction<T> andThenToDouble(@Nonnull FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatToFloatFunction<T> andThenToFloat(@Nonnull FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatToIntFunction<T> andThenToInt(@Nonnull FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatToLongFunction<T> andThenToLong(@Nonnull FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatToShortFunction<T> andThenToShort(@Nonnull FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ObjBiFloatConsumer<T> consume(@Nonnull FloatConsumer consumer) {
        Objects.requireNonNull(consumer);
        return (t, value1, value2) -> consumer.accept(applyAsFloat(t, value1, value2));
    }

    /**
     * Returns a memoized (caching) version of this {@link ObjBiFloatToFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ObjBiFloatToFloatFunction}.
     ...
     */
    @Nonnull
    default ObjBiFloatToFloatFunction<T> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, Float, Float>, Float> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ObjBiFloatToFloatFunction<T> & Memoized) (t, value1, value2) -> {
                float returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link ObjBiFloatToFloatFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ObjBiFloatToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code ObjBiFloatToFloatFunction}.
     */
    @Nonnull
    default TriFunction<T, Float, Float, Float> boxed() {
