 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, reference, double) specialization of
 * {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjDoubleFunction<T, U, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoubleFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, R, X> of(
            @Nullable ThrowableBiObjDoubleFunction<T, U, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableBiObjDoubleFunction} into a total {@link ThrowableBiObjDoubleFunction} that
     ...
     * @return A partial {@code ThrowableBiObjDoubleFunction} lifted into a total {@code ThrowableBiObjDoubleFunction}
     * that returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, Optional<R>, X> lift(
            @Nonnull ThrowableBiObjDoubleFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, u, value) -> Optional.ofNullable(partial.applyThrows(t, u, value));
    }

    /**
     * Calls the given {@link ThrowableBiObjDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return The result from the given {@code ThrowableBiObjDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, R, X extends Throwable> R call(
            @Nonnull ThrowableBiObjDoubleFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
            U u, double value) throws X {
        Objects.requireNonNull(function);
        return function.applyThrows(t, u, value);
    }

    /**
     * Creates a {@link ThrowableBiObjDoubleFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleFunction} which uses the {@code second} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleFunction} which uses the {@code third} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjDoubleFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, R, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return A {@code ThrowableBiObjDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, U u, double value) throws X;
     ...
     */
    default R applyThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleFunction<U, R, X> applyThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleFunction<R, X> applyThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, U, R, X> applyThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableFunction<U, R, X> applyThrowsPartially(T t, double value) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsDoubleThrows(c));
    }
     ...
     */
    @Nonnull
    default ThrowableObjDoubleFunction<Pair<T, U>, R, X> tupled() {
    ...
    default ThrowableBiObjDoubleFunction<T, U, R, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Double>, R> cache = new ConcurrentHashMap<>();
    ...
    @Deprecated
    @Nonnull
    default ThrowableBiObjDoubleFunction<T, U, Optional<R>, X> nonNull() {
        return (t, u, value) -> Optional.ofNullable(applyThrows(t, u, value));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Double, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link BiObjDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjDoubleFunction<T, U, R> nest() {
     ...
     */
    @Nonnull
    default BiObjDoubleFunction<T, U, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link BiObjDoubleFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default BiObjDoubleFunction<T, U, R> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleFunction<? super T, ? super U, ?
                    extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjDoubleFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjDoubleFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjDoubleFunction<T, U, R> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyThrows(t, u, value);
