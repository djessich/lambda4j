...
public interface ThrowableBiObjDoubleFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, R, X> of(
            @Nullable final ThrowableBiObjDoubleFunction<T, U, R, X> expression) {
        return expression;
    }
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjDoubleFunction<T, U, Optional<R>, X> lift(
            @Nonnull final ThrowableBiObjDoubleFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
    ...
    static <T, U, R, X extends Throwable> R call(
            @Nonnull final ThrowableBiObjDoubleFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
    ...
    default BiObjDoubleFunction<T, U, R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjDoubleFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjDoubleFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
