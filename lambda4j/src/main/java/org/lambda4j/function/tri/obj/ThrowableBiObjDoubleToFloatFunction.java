 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(Object, Object, double)}.
 *
...
public interface ThrowableBiObjDoubleToFloatFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToFloatFunction<T, U, X> of(
            @Nullable final ThrowableBiObjDoubleToFloatFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> float call(
            @Nonnull final ThrowableBiObjDoubleToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     * the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjDoubleToFloatFunction}.
     */
    @Nonnull
    ...
    default BiObjDoubleToFloatFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjDoubleToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjDoubleToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
