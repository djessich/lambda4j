 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, double)
...
@FunctionalInterface
public interface ThrowableBiObjDoubleToFloatFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoubleToFloatFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjDoubleToFloatFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToFloatFunction<T, U, X> of(
            @Nullable ThrowableBiObjDoubleToFloatFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjDoubleToFloatFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjDoubleToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> float call(
            @Nonnull ThrowableBiObjDoubleToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToFloatFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToFloatFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToFloatFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToFloatFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToFloatFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToFloatFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToFloatFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToFloatFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableDoubleToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToFloatFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToFloatFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjDoubleToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToFloatFunction<T, U, X> constant(float ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(T t, U u, double value) throws X;
     ...
     */
    default float applyAsFloatThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToFloatFunction<U, X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToFloatFunction<X> applyAsFloatThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToFloatBiFunction<T, U, X> applyAsFloatThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<U, X> applyAsFloatThrowsPartially(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToFloatFunction<Pair<T, U>, X> tupled() {
    ...
    default ThrowableBiObjDoubleToFloatFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Double>, Float> cache = new ConcurrentHashMap<>();
     ...
     * ThrowableBiObjDoubleToFloatFunction}. Thereby the primitive input argument for this function is autoboxed. This
     * method provides the possibility to use this {@code ThrowableBiObjDoubleToFloatFunction} with methods provided by
     * the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code
     * ThrowableBiObjDoubleToFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Double, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link BiObjDoubleToFloatFunction} that applies this function to its input and nests the
     * thrown {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjDoubleToFloatFunction} that applies this function to its input and nests the
     ...
     * @return A composed {@link BiObjDoubleToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjDoubleToFloatFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjDoubleToFloatFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjDoubleToFloatFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjDoubleToFloatFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsFloatThrows(t, u, value);
