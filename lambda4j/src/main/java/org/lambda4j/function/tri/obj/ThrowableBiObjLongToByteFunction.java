 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, long)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjLongToByteFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjLongToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjLongToByteFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjLongToByteFunction<T, U, X> of(
            @Nullable ThrowableBiObjLongToByteFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjLongToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjLongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> byte call(
            @Nonnull ThrowableBiObjLongToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjLongToByteFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjLongToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToByteFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongToByteFunction} which uses the {@code second} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjLongToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToByteFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongToByteFunction} which uses the {@code third} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjLongToByteFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToByteFunction<T, U, X> onlyThird(
            @Nonnull ThrowableLongToByteFunction<? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByteThrows(value);
    }

    /**
     * Creates a {@link ThrowableBiObjLongToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjLongToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToByteFunction<T, U, X> constant(byte ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, U u, long value) throws X;
     ...
     */
    default byte applyAsByteThrows(@Nonnull Pair<T, U> tuple, long value) throws X {
        Objects.requireNonNull(tuple);
        return applyAsByteThrows(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableObjLongToByteFunction}
     * as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableObjLongToByteFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjLongToByteFunction<U, X> applyAsByteThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToByteFunction<X> applyAsByteThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToByteBiFunction<T, U, X> applyAsByteThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<U, X> applyAsByteThrowsPartially(T t, long value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToByteFunction<Pair<T, U>, X> tupled() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjLongToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjLongToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjLongToByteFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Long>, Byte> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ThrowableBiObjLongToByteFunction<T, U, X> & Memoized) (t, u, value) -> {
                byte returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjLongToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjLongToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjLongToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Long, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link BiObjLongToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjLongToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjLongToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjLongToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjLongToByteFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjLongToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjLongToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsByteThrows(t, u, value);
