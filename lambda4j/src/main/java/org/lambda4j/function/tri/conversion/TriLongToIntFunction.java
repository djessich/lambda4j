...
/**
 * Represents an operation that accepts three {@code long}-valued input arguments and produces a {@code int}-valued
...
@FunctionalInterface
public interface TriLongToIntFunction extends Lambda {

    /**
     * Constructs a {@link TriLongToIntFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriLongToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static TriLongToIntFunction of(@Nullable TriLongToIntFunction expression) {
        return expression;
    }
     ...
     */
    static int call(@Nonnull TriLongToIntFunction function, long value1, long value2, long value3) {
     ...
     */
    @Nonnull
    static TriLongToIntFunction onlyFirst(@Nonnull LongToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriLongToIntFunction onlySecond(@Nonnull LongToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriLongToIntFunction onlyThird(@Nonnull LongToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull ToLongFunction<? super A> before1,
            @Nonnull ToLongFunction<? super B> before2, @Nonnull ToLongFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> applyAsInt(before1.applyAsLong(a), before2.applyAsLong(b), before3.applyAsLong(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanToIntFunction composeFromBoolean(@Nonnull BooleanToLongFunction before1,
     ...
     */
    @Nonnull
    default TriByteToIntFunction composeFromByte(@Nonnull ByteToLongFunction before1,
     ...
     */
    @Nonnull
    default TriCharToIntFunction composeFromChar(@Nonnull CharToLongFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction composeFromDouble(@Nonnull DoubleToLongFunction before1,
     ...
     */
    @Nonnull
    default TriFloatToIntFunction composeFromFloat(@Nonnull FloatToLongFunction before1,
     ...
     */
    @Nonnull
    default IntTernaryOperator composeFromInt(@Nonnull IntToLongFunction before1,
    ...
    /**
     * Returns a composed {@link TriLongToIntFunction} that first applies the {@code before} operators to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     ...
     */
    @Nonnull
    default TriLongToIntFunction composeFromLong(@Nonnull LongUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriShortToIntFunction composeFromShort(@Nonnull ShortToLongFunction before1,
     ...
     */
    @Nonnull
    default <S> TriLongFunction<S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriLongPredicate andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToByteFunction andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToCharFunction andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToDoubleFunction andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToFloatFunction andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToIntFunction andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongTernaryOperator andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongToShortFunction andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriLongConsumer consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default TriLongToIntFunction reversed() {
     ...
     * TriLongToIntFunction} with methods provided by the {@code JDK}.
     *
