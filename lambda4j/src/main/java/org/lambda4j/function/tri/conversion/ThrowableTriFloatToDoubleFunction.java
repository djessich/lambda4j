...
public interface ThrowableTriFloatToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriFloatToDoubleFunction<X> of(
            @Nullable ThrowableTriFloatToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull ThrowableTriFloatToDoubleFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriFloatToDoubleFunction<X> reversed() {
     ...
     */
    @Nonnull
    default TriFloatToDoubleFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriFloatToDoubleFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriFloatToDoubleFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriFloatToDoubleFunction function = recover.apply(throwable);
