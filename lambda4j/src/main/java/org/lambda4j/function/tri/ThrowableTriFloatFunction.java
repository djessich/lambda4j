 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(float, float, float)}.
 *
...
@FunctionalInterface
public interface ThrowableTriFloatFunction<R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableTriFloatFunction} from given lambda expression or method reference.
    ...
    /**
     * Constructs a {@link ThrowableTriFloatFunction} based on a curried lambda expression. Thereby the given curried
     ...
     * value3)}
     * @return A {@code ThrowableTriFloatFunction} from given curried lambda expression.
    ...
    @Nullable
    static <R, X extends Throwable> ThrowableTriFloatFunction<R, X> of(
            @Nullable ThrowableFloatFunction<ThrowableFloatFunction<ThrowableFloatFunction<R, X>, X>, X> curried)
            throws X {
    ...
    /**
     * Lifts a partial {@link ThrowableTriFloatFunction} into a total {@link ThrowableTriFloatFunction} that returns an
     * {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ThrowableTriFloatFunction} lifted into a total {@code ThrowableTriFloatFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriFloatFunction<Optional<R>, X> lift(
            @Nonnull ThrowableTriFloatFunction<? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (value1, value2, value3) -> Optional.ofNullable(partial.applyThrows(value1, value2, value3));
    }

    /**
     * Calls the given {@link ThrowableTriFloatFunction} with the given arguments and returns its result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableTriFloatFunction<? extends R, ? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriFloatFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableFloatFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriFloatFunction<R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriFloatFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableFloatFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriFloatFunction<R, X> onlySecond(
            @Nonnull ThrowableFloatFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriFloatFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableFloatFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriFloatFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriFloatFunction<R, X> onlyThird(
            @Nonnull ThrowableFloatFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriFloatFunction} which always returns a given value.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriFloatFunction<R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(float value1, float value2, float value3) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableBiFloatFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default ThrowableBiFloatFunction<R, X> applyThrowsPartially(float value1) {
     ...
     */
    @Nonnull
    default ThrowableFloatFunction<R, X> applyThrowsPartially(float value1, float value2) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyAsFloatThrows(a), before2.applyAsFloatThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyAsFloatThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code ThrowableTriFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     ...
     */
    @Nonnull
    default ThrowableTriFloatPredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriFloatConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableFloatFunction<ThrowableFloatFunction<ThrowableFloatFunction<R, X>, X>, X> curried() {
     ...
     */
    @Nonnull
    default ThrowableTriFloatFunction<R, X> reversed() {
        return (value3, value2, value1) -> applyThrows(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableTriFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriFloatFunction}.
    ...
    default ThrowableTriFloatFunction<R, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableTriFloatFunction<R, X> & Memoized) (value1, value2, value3) -> {
    ...
    @Deprecated
    @Nonnull
    default ThrowableTriFloatFunction<Optional<R>, X> nonNull() {
        return (value1, value2, value3) -> Optional.ofNullable(applyThrows(value1, value2, value3));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriFloatFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableTriFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Float, Float, Float, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link TriFloatFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriFloatFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     * @return A composed {@link TriFloatFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default TriFloatFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends TriFloatFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriFloatFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriFloatFunction<R> sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyThrows(value1, value2, value3);
