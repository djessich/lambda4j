...
public interface ThrowableBiObjLongToCharFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjLongToCharFunction<T, U, X> of(
            @Nullable ThrowableBiObjLongToCharFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> char call(
            @Nonnull ThrowableBiObjLongToCharFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongToCharFunction<U, X> applyAsCharThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToCharFunction<X> applyAsCharThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToCharBiFunction<T, U, X> applyAsCharThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableToCharFunction<U, X> applyAsCharThrowsPartially(T t, long value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjLongToCharFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Long>, Character> cache = new ConcurrentHashMap<>();
     ...
     * this {@code ThrowableBiObjLongToCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjLongToCharFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjLongToCharFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjLongToCharFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjLongToCharFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjLongToCharFunction<? super T, ? super U> function = recover.apply(throwable);
