...
@FunctionalInterface
public interface TriShortToFloatFunction extends Lambda {

    /**
     * Constructs a {@link TriShortToFloatFunction} based on a lambda expression or a method reference. Thereby the
     * given lambda expression or method reference is returned on an as-is basis to implicitly transform it to the
     * desired type. With this method, it is possible to ensure that correct type is used from lambda expression or
     * method reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code TriShortToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static TriShortToFloatFunction of(@Nullable TriShortToFloatFunction expression) {
        return expression;
    }
     ...
     */
    static float call(@Nonnull TriShortToFloatFunction function, short value1, short value2, short value3) {
     ...
     */
    @Nonnull
    static TriShortToFloatFunction onlyFirst(@Nonnull ShortToFloatFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriShortToFloatFunction onlySecond(@Nonnull ShortToFloatFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriShortToFloatFunction onlyThird(@Nonnull ShortToFloatFunction function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Applies this function partially to some arguments of this one, producing a {@link BiShortToFloatFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default <A, B, C> ToFloatTriFunction<A, B, C> compose(@Nonnull ToShortFunction<? super A> before1,
            @Nonnull ToShortFunction<? super B> before2, @Nonnull ToShortFunction<? super C> before3) {
        Objects.requireNonNull(before1);
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (a, b, c) -> applyAsFloat(before1.applyAsShort(a), before2.applyAsShort(b), before3.applyAsShort(c));
    }
     ...
     */
    @Nonnull
    default TriBooleanToFloatFunction composeFromBoolean(@Nonnull BooleanToShortFunction before1,
     ...
     */
    @Nonnull
    default TriByteToFloatFunction composeFromByte(@Nonnull ByteToShortFunction before1,
     ...
     */
    @Nonnull
    default TriCharToFloatFunction composeFromChar(@Nonnull CharToShortFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToFloatFunction composeFromDouble(@Nonnull DoubleToShortFunction before1,
     ...
     */
    @Nonnull
    default FloatTernaryOperator composeFromFloat(@Nonnull FloatToShortFunction before1,
     ...
     */
    @Nonnull
    default TriIntToFloatFunction composeFromInt(@Nonnull IntToShortFunction before1,
     ...
     */
    @Nonnull
    default TriLongToFloatFunction composeFromLong(@Nonnull LongToShortFunction before1,
    ...
    /**
     * Returns a composed {@link TriShortToFloatFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. If evaluation of either operation throws an exception, it is
     * relayed to the caller of the composed operation. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code TriShortToFloatFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * short}.
     */
    @Nonnull
    default TriShortToFloatFunction composeFromShort(@Nonnull ShortUnaryOperator before1,
     ...
     */
    @Nonnull
    default <S> TriShortFunction<S> andThen(@Nonnull FloatFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriShortPredicate andThenToBoolean(@Nonnull FloatPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToByteFunction andThenToByte(@Nonnull FloatToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToCharFunction andThenToChar(@Nonnull FloatToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToDoubleFunction andThenToDouble(@Nonnull FloatToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToFloatFunction andThenToFloat(@Nonnull FloatUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToIntFunction andThenToInt(@Nonnull FloatToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortToLongFunction andThenToLong(@Nonnull FloatToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortTernaryOperator andThenToShort(@Nonnull FloatToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriShortConsumer consume(@Nonnull FloatConsumer consumer) {
     ...
     */
    @Nonnull
    default TriShortToFloatFunction reversed() {
     ...
     * TriShortToFloatFunction} with methods provided by the {@code JDK}.
     *
