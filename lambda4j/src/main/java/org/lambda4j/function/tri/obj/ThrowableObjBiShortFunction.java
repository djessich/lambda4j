...
public interface ThrowableObjBiShortFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiShortFunction<T, R, X> of(
            @Nullable ThrowableObjBiShortFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjBiShortFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjBiShortFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjBiShortFunction<? super T, ? extends R, ? extends X> function, T t, short value1,
     ...
     */
    @Nonnull
    default ThrowableBiShortFunction<R, X> applyThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortFunction<R, X> applyThrowsPartially(T t, short value1) {
     ...
     */
    @Nonnull
    default ThrowableObjShortFunction<T, R, X> applyThrowsPartially(short value1) {
     ...
     */
    @Nonnull
    default ThrowableFunction<T, R, X> applyThrowsPartially(short value1, short value2) {
    ...
    default ObjBiShortFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiShortFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiShortFunction<? super T, ? extends R> function = recover.apply(throwable);
