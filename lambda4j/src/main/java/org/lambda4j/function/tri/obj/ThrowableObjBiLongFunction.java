...
public interface ThrowableObjBiLongFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiLongFunction<T, R, X> of(
            @Nullable ThrowableObjBiLongFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjBiLongFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjBiLongFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjBiLongFunction<? super T, ? extends R, ? extends X> function, T t, long value1,
     ...
     */
    @Nonnull
    default ObjBiLongFunction<T, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiLongFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiLongFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiLongFunction<? super T, ? extends R> function = recover.apply(throwable);
