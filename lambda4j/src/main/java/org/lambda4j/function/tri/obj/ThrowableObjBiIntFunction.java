 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, int, int) specialization of {@link
 * ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, int, int)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiIntFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiIntFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, R, X> of(
            @Nullable ThrowableObjBiIntFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjBiIntFunction} into a total {@link ThrowableObjBiIntFunction} that returns an
     ...
     * @return A partial {@code ThrowableObjBiIntFunction} lifted into a total {@code ThrowableObjBiIntFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjBiIntFunction<? super T, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, value1, value2) -> Optional.ofNullable(partial.applyThrows(t, value1, value2));
    }

    /**
     * Calls the given {@link ThrowableObjBiIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjBiIntFunction<? super T, ? extends R, ? extends X> function, T t, int value1,
            int value2) throws X {
    ...
    /**
     * Creates a {@link ThrowableObjBiIntFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiIntFunction} which uses the {@code second} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiIntFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return Creates a {@code ThrowableObjBiIntFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, R, X> onlyThird(
            @Nonnull ThrowableIntFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, int value1, int value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiIntFunction<R, X> applyThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntFunction<R, X> applyThrowsPartially(T t, int value1) {
        return value2 -> applyThrows(t, value1, value2);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableObjIntFunction} as
     * result.
     *
     * @param value1 The second argument to this function used to partially apply this function
     ...
     */
    @Nonnull
    default ThrowableObjIntFunction<T, R, X> applyThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowableFunction<T, R, X> applyThrowsPartially(int value1, int value2) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyAsIntThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyThrows(value1), before2.applyAsIntThrows(value2),
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
    ...
    default ThrowableObjBiIntFunction<T, R, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Integer, Integer>, R> cache = new ConcurrentHashMap<>();
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjBiIntFunction<T, Optional<R>, X> nonNull() {
        return (t, value1, value2) -> Optional.ofNullable(applyThrows(t, value1, value2));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiIntFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableObjBiIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiIntFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Integer, Integer, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjBiIntFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiIntFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     * @return A composed {@link ObjBiIntFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default ObjBiIntFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiIntFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiIntFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiIntFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiIntFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiIntFunction<T, R> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return applyThrows(t, value1, value2);
