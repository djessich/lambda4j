...
public interface ThrowableObjBiIntFunction<T, R, X extends Throwable> extends Lambda {
    ...
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, R, X> of(
            @Nullable final ThrowableObjBiIntFunction<T, R, X> expression) {
        return expression;
    }
    ...
    static <T, R, X extends Throwable> ThrowableObjBiIntFunction<T, Optional<R>, X> lift(
            @Nonnull final ThrowableObjBiIntFunction<? super T, ? extends R, ? extends X> partial) {
    ...
    static <T, R, X extends Throwable> R call(
            @Nonnull final ThrowableObjBiIntFunction<? super T, ? extends R, ? extends X> function, T t, int value1,
            int value2) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjBiIntConsumer<T, X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiIntFunction<T, R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiIntFunction<T, R> recover(
            @Nonnull final Function<? super Throwable, ? extends ObjBiIntFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                final ObjBiIntFunction<? super T, ? extends R> function = recover.apply(throwable);
