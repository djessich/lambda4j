 ...
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, short)
...
public interface ThrowableBiObjShortToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortToIntFunction<T, U, X> of(
            @Nullable ThrowableBiObjShortToIntFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> int call(
            @Nonnull ThrowableBiObjShortToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjShortToIntFunction<U, X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> applyAsIntThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToIntBiFunction<T, U, X> applyAsIntThrowsPartially(short value) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<U, X> applyAsIntThrowsPartially(T t, short value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjShortConsumer<T, U, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default BiObjShortToIntFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjShortToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjShortToIntFunction<? super T, ? super U> function = recover.apply(throwable);
