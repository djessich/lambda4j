 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, long, long)
...
public interface ThrowableObjBiLongToShortFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToShortFunction<T, X> of(
            @Nullable ThrowableObjBiLongToShortFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> short call(
            @Nonnull ThrowableObjBiLongToShortFunction<? super T, ? extends X> function, T t, long value1,
    ...
    static <T, X extends Throwable> ThrowableObjBiLongToShortFunction<T, X> onlySecond(
            @Nonnull ThrowableLongToShortFunction<? extends X> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ThrowableBiLongToShortFunction<X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToShortFunction<X> applyAsShortThrowsPartially(T t, long value1) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToShortFunction<T, X> applyAsShortThrowsPartially(long value1) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<T, X> applyAsShortThrowsPartially(long value1, long value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiLongConsumer<T, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ObjBiLongToShortFunction<T> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ObjBiLongToShortFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiLongToShortFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiLongToShortFunction<? super T> function = recover.apply(throwable);
