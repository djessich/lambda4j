...
import org.lambda4j.function.bi.obj.ObjLongToIntFunction;
 ...
 * {@code int}-valued result. This is a (reference, reference, long) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsInt(Object, Object, long)}.
 *
...
@FunctionalInterface
public interface BiObjLongToIntFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjLongToIntFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjLongToIntFunction} from given lambda expression or method reference.
    ...
    /**
     * Calls the given {@link BiObjLongToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjLongToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> int call(@Nonnull BiObjLongToIntFunction<? super T, ? super U> function, T t, U u, long value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToIntFunction<T, U> onlyFirst(@Nonnull ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToIntFunction<T, U> onlySecond(@Nonnull ToIntFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjLongToIntFunction<T, U> onlyThird(@Nonnull LongToIntFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsInt(value);
    }

    /**
     * Creates a {@link BiObjLongToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjLongToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjLongToIntFunction<T, U> constant(int ret) {
     ...
     */
    int applyAsInt(T t, U u, long value);
     ...
     */
    default int applyAsInt(@Nonnull Pair<T, U> tuple, long value) {
        Objects.requireNonNull(tuple);
        return applyAsInt(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ObjLongToIntFunction} as
     * result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ObjLongToIntFunction} that represents this function partially applied the some arguments.
     */
    @Nonnull
    default ObjLongToIntFunction<U> applyAsIntPartially(T t) {
     ...
     */
    @Nonnull
    default LongToIntFunction2 applyAsIntPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> applyAsIntPartially(long value) {
     ...
     */
    @Nonnull
    default ToIntFunction2<U> applyAsIntPartially(T t, long value) {
    ...
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsInt(before1.apply(a), before2.apply(b), before3.applyAsLong(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjLongFunction<T, U, S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjLongPredicate<T, U> andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToCharFunction<T, U> andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToFloatFunction<T, U> andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToIntFunction<T, U> andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToLongFunction<T, U> andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToShortFunction<T, U> andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjLongToIntFunction<Pair<T, U>> tupled() {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjLongToIntFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjLongToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjLongToIntFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Long, Integer> boxed() {
        return this::applyAsInt;
    }
}
