 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(char, char, char)}.
 *
...
@FunctionalInterface
public interface ThrowableTriCharToFloatFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriCharToFloatFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableTriCharToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableTriCharToFloatFunction<X> of(
            @Nullable ThrowableTriCharToFloatFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriCharToFloatFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriCharToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> float call(@Nonnull ThrowableTriCharToFloatFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriCharToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableCharToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriCharToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableCharToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriCharToFloatFunction<X> onlyFirst(
            @Nonnull ThrowableCharToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
        return (value1, value2, value3) -> function.applyAsFloatThrows(value1);
    }

    /**
     * Creates a {@link ThrowableTriCharToFloatFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableCharToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriCharToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableCharToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriCharToFloatFunction<X> onlySecond(
            @Nonnull ThrowableCharToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriCharToFloatFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableCharToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriCharToFloatFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableCharToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriCharToFloatFunction<X> onlyThird(
            @Nonnull ThrowableCharToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriCharToFloatFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriCharToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriCharToFloatFunction<X> constant(float ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(char value1, char value2, char value3) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiCharToFloatFunction<X> applyAsFloatThrowsPartially(char value1) {
     ...
     */
    @Nonnull
    default ThrowableCharToFloatFunction<X> applyAsFloatThrowsPartially(char value1, char value2) {
    ...
    default <A, B, C> ThrowableToFloatTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsFloatThrows(before1.applyAsCharThrows(a), before2.applyAsCharThrows(b),
    ...
    default ThrowableTriBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsFloatThrows(before1.applyAsCharThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriCharToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code ThrowableTriCharToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * char}.
    ...
    /**
     * Returns a composed {@link ThrowableTriCharPredicate} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ThrowableTriCharPredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
        return (value1, value2, value3) -> after.testThrows(applyAsFloatThrows(value1, value2, value3));
    }

    /**
     * Returns a composed {@link ThrowableTriCharToByteFunction} that first applies this function to its input, and then
    ...
    /**
     * Returns a composed {@link ThrowableCharTernaryOperator} that first applies this function to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link ThrowableTriCharToDoubleFunction} that first applies this function to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableTriCharToFloatFunction} that first applies this function to its input, and
    ...
    /**
     * Returns a composed {@link ThrowableTriCharToIntFunction} that first applies this function to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link ThrowableTriCharToLongFunction} that first applies this function to its input, and then
     * applies the {@code after} function to the result. This method is just convenience, to provide the ability to
    ...
    /**
     * Returns a composed {@link ThrowableTriCharToShortFunction} that first applies this function to its input, and
     * then applies the {@code after} function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableTriCharConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriCharToFloatFunction<X> reversed() {
        return (value3, value2, value1) -> applyAsFloatThrows(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableTriCharToFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriCharToFloatFunction}.
     ...
     */
    @Nonnull
    default ThrowableTriCharToFloatFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<Character, Character, Character>, Float> cache = new ConcurrentHashMap<>();
            return (ThrowableTriCharToFloatFunction<X> & Memoized) (value1, value2, value3) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriCharToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableTriCharToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriCharToFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Character, Character, Character, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link TriCharToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriCharToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriCharToFloatFunction nest() {
     ...
     */
    @Nonnull
    default TriCharToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriCharToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default TriCharToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriCharToFloatFunction> recover) {
        Objects.requireNonNull(recover);
        return (value1, value2, value3) -> {
            try {
                return applyAsFloatThrows(value1, value2, value3);
            } catch (Error e) {
                throw e;
            } catch (Throwable throwable) {
                TriCharToFloatFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriCharToFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriCharToFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriCharToFloatFunction sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyAsFloatThrows(value1, value2, value3);
