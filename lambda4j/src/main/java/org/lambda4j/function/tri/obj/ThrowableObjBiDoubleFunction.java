 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, double, double) specialization of {@link
 * ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, double, double)}.
 *
...
@FunctionalInterface
public interface ThrowableObjBiDoubleFunction<T, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableObjBiDoubleFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableObjBiDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> of(
            @Nullable ThrowableObjBiDoubleFunction<T, R, X> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link ThrowableObjBiDoubleFunction} into a total {@link ThrowableObjBiDoubleFunction} that
     ...
     * @return A partial {@code ThrowableObjBiDoubleFunction} lifted into a total {@code ThrowableObjBiDoubleFunction}
     * that returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, Optional<R>, X> lift(
            @Nonnull ThrowableObjBiDoubleFunction<? super T, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, value1, value2) -> Optional.ofNullable(partial.applyThrows(t, value1, value2));
    }

    /**
     * Calls the given {@link ThrowableObjBiDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableObjBiDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, R, X extends Throwable> R call(
            @Nonnull ThrowableObjBiDoubleFunction<? super T, ? extends R, ? extends X> function, T t,
    ...
    /**
     * Creates a {@link ThrowableObjBiDoubleFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableObjBiDoubleFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableObjBiDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableObjBiDoubleFunction} which uses the {@code third} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableObjBiDoubleFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> onlyThird(
            @Nonnull ThrowableDoubleFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableObjBiDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableObjBiDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, R, X extends Throwable> ThrowableObjBiDoubleFunction<T, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, double value1, double value2) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiDoubleFunction<R, X> applyThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleFunction<R, X> applyThrowsPartially(T t, double value1) {
        return value2 -> applyThrows(t, value1, value2);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableObjDoubleFunction} as
     * result.
     *
     * @param value1 The second argument to this function used to partially apply this function
     * @return A {@code ThrowableObjDoubleFunction} that represents this function partially applied the some arguments.
     */
    @Nonnull
    default ThrowableObjDoubleFunction<T, R, X> applyThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowableFunction<T, R, X> applyThrowsPartially(double value1, double value2) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyAsDoubleThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyThrows(value1), before2.applyAsDoubleThrows(value2),
     ...
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> consume(
    ...
    default ThrowableObjBiDoubleFunction<T, R, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Double, Double>, R> cache = new ConcurrentHashMap<>();
    ...
    @Deprecated
    @Nonnull
    default ThrowableObjBiDoubleFunction<T, Optional<R>, X> nonNull() {
        return (t, value1, value2) -> Optional.ofNullable(applyThrows(t, value1, value2));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableObjBiDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableObjBiDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableObjBiDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, Double, Double, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link ObjBiDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ObjBiDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ObjBiDoubleFunction<T, R> nest() {
     ...
     */
    @Nonnull
    default ObjBiDoubleFunction<T, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link ObjBiDoubleFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default ObjBiDoubleFunction<T, R> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiDoubleFunction<? super T, ? extends R>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiDoubleFunction<? super T, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ObjBiDoubleFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ObjBiDoubleFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ObjBiDoubleFunction<T, R> sneakyThrow() {
        return (t, value1, value2) -> {
            try {
                return applyThrows(t, value1, value2);
