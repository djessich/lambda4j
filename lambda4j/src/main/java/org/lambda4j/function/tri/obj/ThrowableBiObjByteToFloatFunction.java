...
public interface ThrowableBiObjByteToFloatFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToFloatFunction<T, U, X> of(
            @Nullable ThrowableBiObjByteToFloatFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> float call(
            @Nonnull ThrowableBiObjByteToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjByteToFloatFunction<U, X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToFloatFunction<X> applyAsFloatThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToFloatBiFunction<T, U, X> applyAsFloatThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<U, X> applyAsFloatThrowsPartially(T t, byte value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableBiObjByteToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjByteToFloatFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjByteToFloatFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjByteToFloatFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjByteToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjByteToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
