 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(double, double, double)}.
 *
...
@FunctionalInterface
public interface ThrowableTriDoubleToByteFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriDoubleToByteFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableTriDoubleToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableTriDoubleToByteFunction<X> of(
            @Nullable ThrowableTriDoubleToByteFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriDoubleToByteFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriDoubleToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> byte call(@Nonnull ThrowableTriDoubleToByteFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriDoubleToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableDoubleToByteFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriDoubleToByteFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableDoubleToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriDoubleToByteFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriDoubleToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableDoubleToByteFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriDoubleToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriDoubleToByteFunction<X> onlySecond(
            @Nonnull ThrowableDoubleToByteFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriDoubleToByteFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableDoubleToByteFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriDoubleToByteFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableDoubleToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriDoubleToByteFunction<X> onlyThird(
            @Nonnull ThrowableDoubleToByteFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriDoubleToByteFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriDoubleToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriDoubleToByteFunction<X> constant(byte ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(double value1, double value2, double value3) throws X;
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToByteFunction<X> applyAsByteThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToByteFunction<X> applyAsByteThrowsPartially(double value1, double value2) {
    ...
    default <A, B, C> ThrowableToByteTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsByteThrows(before1.applyAsDoubleThrows(a), before2.applyAsDoubleThrows(b),
    ...
    default ThrowableTriBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsByteThrows(before1.applyAsDoubleThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriDoubleToByteFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result. This method is just convenience, to provide the ability
     ...
     * @return A composed {@code ThrowableTriDoubleToByteFunction} that first applies the {@code before} operators to
     * its input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * double}.
     ...
     */
    @Nonnull
    default ThrowableTriDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriDoubleToByteFunction<X> reversed() {
        return (value3, value2, value1) -> applyAsByteThrows(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableTriDoubleToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriDoubleToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableTriDoubleToByteFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<Double, Double, Double>, Byte> cache = new ConcurrentHashMap<>();
            return (ThrowableTriDoubleToByteFunction<X> & Memoized) (value1, value2, value3) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriDoubleToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableTriDoubleToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriDoubleToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Double, Double, Double, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link TriDoubleToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriDoubleToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction nest() {
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriDoubleToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriDoubleToByteFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriDoubleToByteFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriDoubleToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link TriDoubleToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriDoubleToByteFunction sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyAsByteThrows(value1, value2, value3);
