 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, double)
...
@FunctionalInterface
public interface ThrowableBiObjDoubleToDoubleFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoubleToDoubleFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjDoubleToDoubleFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToDoubleFunction<T, U, X> of(
            @Nullable final ThrowableBiObjDoubleToDoubleFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjDoubleToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjDoubleToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> double call(
            @Nonnull final ThrowableBiObjDoubleToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToDoubleFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToDoubleFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToDoubleFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToDoubleFunction} which uses the {@code second} parameter of this
     * one as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToDoubleFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToDoubleFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToDoubleFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableDoubleUnaryOperator}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToDoubleFunction<T, U, X> onlyThird(
            @Nonnull final ThrowableDoubleUnaryOperator<? extends X> operator) {
        Objects.requireNonNull(operator);
        return (t, u, value) -> operator.applyAsDoubleThrows(value);
    }

    /**
     * Creates a {@link ThrowableBiObjDoubleToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjDoubleToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToDoubleFunction<T, U, X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, U u, double value) throws X;
     ...
     */
    default double applyAsDoubleThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToDoubleFunction<U, X> papplyAsDoubleThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleUnaryOperator<X> papplyAsDoubleThrows(T t, U u) {
        return (value) -> this.applyAsDoubleThrows(t, u, value);
    }

    /**
     * Applies this operator partially to some arguments of this one, producing a {@link ThrowableToDoubleBiFunction} as
     * result.
     *
     * @param value The third argument to this function used to partially apply this function
     * @return A {@code ThrowableToDoubleBiFunction} that represents this operator partially applied the some arguments.
     */
    @Nonnull
    default ThrowableToDoubleBiFunction<T, U, X> papplyAsDoubleThrows(double value) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<U, X> papplyAsDoubleThrows(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToDoubleFunction<Pair<T, U>, X> tupled() {
     ...
     * ThrowableBiObjDoubleToDoubleFunction}. Thereby the primitive input argument for this function is autoboxed. This
     * method provides the possibility to use this {@code ThrowableBiObjDoubleToDoubleFunction} with methods provided by
     * the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjDoubleToDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Double, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link BiObjDoubleToDoubleFunction} that applies this function to its input and nests the
     * thrown {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjDoubleToDoubleFunction} that applies this function to its input and nests the
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjDoubleToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjDoubleToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjDoubleToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjDoubleToDoubleFunction} that applies this function to its input and sneakily
     ...
     *
     * @return A composed {@link BiObjDoubleToDoubleFunction} that applies this function to its input and sneakily
     ...
     */
    @Nonnull
    default BiObjDoubleToDoubleFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return this.applyAsDoubleThrows(t, u, value);
