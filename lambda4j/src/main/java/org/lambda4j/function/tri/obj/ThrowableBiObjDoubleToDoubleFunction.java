...
public interface ThrowableBiObjDoubleToDoubleFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToDoubleFunction<T, U, X> of(
            @Nullable ThrowableBiObjDoubleToDoubleFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> double call(
            @Nonnull ThrowableBiObjDoubleToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleUnaryOperator<X> applyAsDoubleThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleBiFunction<T, U, X> applyAsDoubleThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t, double value) {
    ...
    default ThrowableBiObjDoubleToDoubleFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Double>, Double> cache = new ConcurrentHashMap<>();
     ...
     * ThrowableBiObjDoubleToDoubleFunction}.
     */
    @Nonnull
    ...
    default BiObjDoubleToDoubleFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
