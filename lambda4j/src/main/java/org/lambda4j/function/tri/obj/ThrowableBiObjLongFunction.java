 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, reference, long) specialization of {@link
 * ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(Object, Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjLongFunction<T, U, R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableBiObjLongFunction} from given lambda expression or method reference.
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjLongFunction<T, U, R, X> of(
            @Nullable ThrowableBiObjLongFunction<T, U, R, X> expression) {
        return expression;
    }
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjLongFunction<T, U, Optional<R>, X> lift(
            @Nonnull ThrowableBiObjLongFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (t, u, value) -> Optional.ofNullable(partial.applyThrows(t, u, value));
    }

    /**
     * Calls the given {@link ThrowableBiObjLongFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return The result from the given {@code ThrowableBiObjLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, R, X extends Throwable> R call(
            @Nonnull ThrowableBiObjLongFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
            U u, long value) throws X {
        Objects.requireNonNull(function);
        return function.applyThrows(t, u, value);
    }

    /**
     * Creates a {@link ThrowableBiObjLongFunction} which uses the {@code first} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjLongFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjLongFunction<T, U, R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjLongFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjLongFunction<T, U, R, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongFunction} which uses the {@code third} parameter of this one as argument for
     ...
     * @return Creates a {@code ThrowableBiObjLongFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjLongFunction<T, U, R, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <R> The type of return value from the function
     ...
     * @return A {@code ThrowableBiObjLongFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, R, X extends Throwable> ThrowableBiObjLongFunction<T, U, R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(T t, U u, long value) throws X;
     ...
     */
    default R applyThrows(@Nonnull Pair<T, U> tuple, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongFunction<U, R, X> applyThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongFunction<R, X> applyThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, U, R, X> applyThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableFunction<U, R, X> applyThrowsPartially(T t, long value) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyThrows(a), before2.applyThrows(b), before3.applyAsLongThrows(c));
    }
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(
     ...
     */
    @Nonnull
    default ThrowableObjLongFunction<Pair<T, U>, R, X> tupled() {
        return this::applyThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjLongFunction<T, U, R, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Long>, R> cache = new ConcurrentHashMap<>();
            return (ThrowableBiObjLongFunction<T, U, R, X> & Memoized) (t, u, value) -> {
    ...
    @Deprecated
    @Nonnull
    default ThrowableBiObjLongFunction<T, U, Optional<R>, X> nonNull() {
        return (t, u, value) -> Optional.ofNullable(applyThrows(t, u, value));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjLongFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableBiObjLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjLongFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Long, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link BiObjLongFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjLongFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     * @return A composed {@link BiObjLongFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default BiObjLongFunction<T, U, R> recover(
            @Nonnull Function<? super Throwable,
                    ? extends BiObjLongFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjLongFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjLongFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link BiObjLongFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjLongFunction<T, U, R> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyThrows(t, u, value);
