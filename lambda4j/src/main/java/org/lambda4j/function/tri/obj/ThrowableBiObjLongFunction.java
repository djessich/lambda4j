...
public interface ThrowableBiObjLongFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> R call(
            @Nonnull final ThrowableBiObjLongFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
    ...
    default BiObjLongFunction<T, U, R> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjLongFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjLongFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
