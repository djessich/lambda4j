 ...
 * {@code double}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, long)
 * specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsDoubleThrows(Object, Object, long)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjLongToDoubleFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjLongToDoubleFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjLongToDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, X extends Throwable> ThrowableBiObjLongToDoubleFunction<T, U, X> of(
            @Nullable ThrowableBiObjLongToDoubleFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjLongToDoubleFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjLongToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> double call(
            @Nonnull ThrowableBiObjLongToDoubleFunction<? super T, ? super U, ? extends X> function, T t, U u,
            long value) throws X {
    ...
    /**
     * Creates a {@link ThrowableBiObjLongToDoubleFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjLongToDoubleFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToDoubleFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongToDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToDoubleFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjLongToDoubleFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToDoubleFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongToDoubleFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjLongToDoubleFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableLongToDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToDoubleFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjLongToDoubleFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjLongToDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjLongToDoubleFunction<T, U, X> constant(double ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    double applyAsDoubleThrows(T t, U u, long value) throws X;
     ...
     */
    default double applyAsDoubleThrows(@Nonnull Pair<T, U> tuple, long value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjLongToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableLongToDoubleFunction<X> applyAsDoubleThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleBiFunction<T, U, X> applyAsDoubleThrowsPartially(long value) {
     ...
     */
    @Nonnull
    default ThrowableToDoubleFunction<U, X> applyAsDoubleThrowsPartially(T t, long value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjLongConsumer<T, U, X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjLongToDoubleFunction<Pair<T, U>, X> tupled() {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjLongToDoubleFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjLongToDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjLongToDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Long, Double, X> boxed() {
        return this::applyAsDoubleThrows;
    }

    /**
     * Returns a composed {@link BiObjLongToDoubleFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjLongToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjLongToDoubleFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjLongToDoubleFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjLongToDoubleFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjLongToDoubleFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjLongToDoubleFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return applyAsDoubleThrows(t, u, value);
