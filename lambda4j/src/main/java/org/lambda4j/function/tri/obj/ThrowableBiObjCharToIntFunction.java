...
public interface ThrowableBiObjCharToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjCharToIntFunction<T, U, X> of(
            @Nullable ThrowableBiObjCharToIntFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> int call(
            @Nonnull ThrowableBiObjCharToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
            char value) throws X {
     ...
     */
    @Nonnull
    default ThrowableBiObjCharConsumer<T, U, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default BiObjCharToIntFunction<T, U> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiObjCharToIntFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjCharToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjCharToIntFunction<? super T, ? super U> function = recover.apply(throwable);
