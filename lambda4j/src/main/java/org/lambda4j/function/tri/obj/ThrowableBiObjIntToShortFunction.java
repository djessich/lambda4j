 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, int)
...
public interface ThrowableBiObjIntToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjIntToShortFunction<T, U, X> of(
            @Nullable ThrowableBiObjIntToShortFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> short call(
            @Nonnull ThrowableBiObjIntToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
            int value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjIntToShortFunction<U, X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableIntToShortFunction<X> applyAsShortThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToShortBiFunction<T, U, X> applyAsShortThrowsPartially(int value) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<U, X> applyAsShortThrowsPartially(T t, int value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjIntConsumer<T, U, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
    ...
    default BiObjIntToShortFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjIntToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjIntToShortFunction<? super T, ? super U> function = recover.apply(throwable);
