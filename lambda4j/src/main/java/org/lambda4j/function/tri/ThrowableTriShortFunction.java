...
public interface ThrowableTriShortFunction<R, X extends Throwable> extends Lambda {
    ...
    /**
     * Constructs a {@link ThrowableTriShortFunction} based on a curried lambda expression. Thereby the given curried
     ...
     * value3)}
     * @return A {@code ThrowableTriShortFunction} from given curried lambda expression.
    ...
    @Nullable
    static <R, X extends Throwable> ThrowableTriShortFunction<R, X> of(
            @Nullable ThrowableShortFunction<ThrowableShortFunction<ThrowableShortFunction<R, X>, X>, X> curried)
            throws X {
     ...
     */
    @Nonnull
    default ThrowableShortFunction<ThrowableShortFunction<ThrowableShortFunction<R, X>, X>, X> curried() {
     ...
     */
    @Nonnull
    default ThrowableTriShortFunction<R, X> reversed() {
