 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(Object, Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjDoubleToIntFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoubleToIntFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjDoubleToIntFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToIntFunction<T, U, X> of(
            @Nullable final ThrowableBiObjDoubleToIntFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjDoubleToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjDoubleToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> int call(
            @Nonnull final ThrowableBiObjDoubleToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToIntFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToIntFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToIntFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToIntFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToIntFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToIntFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableDoubleToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToIntFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjDoubleToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToIntFunction<T, U, X> constant(int ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    int applyAsIntThrows(T t, U u, double value) throws X;
     ...
     */
    default int applyAsIntThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToIntFunction<U, X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToIntFunction<X> papplyAsIntThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToIntBiFunction<T, U, X> papplyAsIntThrows(double value) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<U, X> papplyAsIntThrows(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToIntFunction<Pair<T, U>, X> tupled() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjDoubleToIntFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjDoubleToIntFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleToIntFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Double>, Integer> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjDoubleToIntFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjDoubleToIntFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjDoubleToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjDoubleToIntFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Double, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link BiObjDoubleToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjDoubleToIntFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjDoubleToIntFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjDoubleToIntFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjDoubleToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjDoubleToIntFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjDoubleToIntFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjDoubleToIntFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjDoubleToIntFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return this.applyAsIntThrows(t, u, value);
