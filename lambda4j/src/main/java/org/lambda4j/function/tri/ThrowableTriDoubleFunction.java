...
public interface ThrowableTriDoubleFunction<R, X extends Throwable> extends Lambda {
    ...
    static <R, X extends Throwable> ThrowableTriDoubleFunction<R, X> of(
            @Nullable final ThrowableTriDoubleFunction<R, X> expression) {
        return expression;
    }
    ...
    static <R, X extends Throwable> ThrowableTriDoubleFunction<Optional<R>, X> lift(
            @Nonnull final ThrowableTriDoubleFunction<? extends R, ? extends X> partial) {
     ...
     */
    static <R, X extends Throwable> R call(@Nonnull final ThrowableTriDoubleFunction<? extends R, ? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull final ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriDoubleFunction<R> recover(
            @Nonnull final Function<? super Throwable, ? extends TriDoubleFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                final TriDoubleFunction<? extends R> function = recover.apply(throwable);
