...
/**
 * Represents an operation that accepts three {@code double}-valued input arguments and produces a result which is able
 * to throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(double, double, double)}.
 *
...
@FunctionalInterface
public interface ThrowableTriDoubleFunction<R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriDoubleFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableTriDoubleFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <R, X extends Throwable> ThrowableTriDoubleFunction<R, X> of(
            @Nullable ThrowableTriDoubleFunction<R, X> expression) {
        return expression;
    }

    /**
     * Constructs a {@link ThrowableTriDoubleFunction} based on a curried lambda expression. Thereby the given curried
     ...
     * value3)}
     * @return A {@code ThrowableTriDoubleFunction} from given curried lambda expression.
    ...
    @Nullable
    static <R, X extends Throwable> ThrowableTriDoubleFunction<R, X> of(
            @Nullable ThrowableDoubleFunction<ThrowableDoubleFunction<ThrowableDoubleFunction<R, X>, X>, X> curried)
            throws X {
    ...
    /**
     * Lifts a partial {@link ThrowableTriDoubleFunction} into a total {@link ThrowableTriDoubleFunction} that returns
     * an {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ThrowableTriDoubleFunction} lifted into a total {@code ThrowableTriDoubleFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriDoubleFunction<Optional<R>, X> lift(
            @Nonnull ThrowableTriDoubleFunction<? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (value1, value2, value3) -> Optional.ofNullable(partial.applyThrows(value1, value2, value3));
    }

    /**
     * Calls the given {@link ThrowableTriDoubleFunction} with the given arguments and returns its result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableTriDoubleFunction<? extends R, ? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriDoubleFunction} which uses the {@code first} parameter of this one as argument for
     * the given {@link ThrowableDoubleFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriDoubleFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriDoubleFunction<R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriDoubleFunction} which uses the {@code second} parameter of this one as argument for
     * the given {@link ThrowableDoubleFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriDoubleFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriDoubleFunction<R, X> onlySecond(
            @Nonnull ThrowableDoubleFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriDoubleFunction} which uses the {@code third} parameter of this one as argument for
     * the given {@link ThrowableDoubleFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriDoubleFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableDoubleFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriDoubleFunction<R, X> onlyThird(
            @Nonnull ThrowableDoubleFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriDoubleFunction} which always returns a given value.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriDoubleFunction} which always returns a given value.
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriDoubleFunction<R, X> constant(R ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    R applyThrows(double value1, double value2, double value3) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableBiDoubleFunction} as
     * result.
     *
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyAsDoubleThrows(a), before2.applyAsDoubleThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyAsDoubleThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriDoubleFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code ThrowableTriDoubleFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * double}.
     ...
     */
    @Nonnull
    default ThrowableTriDoublePredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriDoubleConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriDoubleFunction}.
     ...
     */
    @Nonnull
    default ThrowableTriDoubleFunction<R, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<Double, Double, Double>, R> cache = new ConcurrentHashMap<>();
            return (ThrowableTriDoubleFunction<R, X> & Memoized) (value1, value2, value3) -> {
    ...
    @Deprecated
    @Nonnull
    default ThrowableTriDoubleFunction<Optional<R>, X> nonNull() {
        return (value1, value2, value3) -> Optional.ofNullable(applyThrows(value1, value2, value3));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriDoubleFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableTriDoubleFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriDoubleFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Double, Double, Double, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link TriDoubleFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriDoubleFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> nest() {
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriDoubleFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default TriDoubleFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends TriDoubleFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriDoubleFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriDoubleFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriDoubleFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriDoubleFunction<R> sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyThrows(value1, value2, value3);
