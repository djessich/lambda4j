...
public interface BiObjFloatToShortFunction<T, U> extends Lambda {
     ...
     */
    static <T, U> BiObjFloatToShortFunction<T, U> of(@Nullable final BiObjFloatToShortFunction<T, U> expression) {
        return expression;
    }
     ...
     */
    static <T, U> short call(@Nonnull final BiObjFloatToShortFunction<? super T, ? super U> function, T t, U u,
            float value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatToShortFunction<T, U> onlyFirst(@Nonnull final ToShortFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatToShortFunction<T, U> onlySecond(@Nonnull final ToShortFunction<? super U> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjFloatToShortFunction<T, U> onlyThird(@Nonnull final FloatToShortFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjFloatToShortFunction<U> papplyAsShort(T t) {
     ...
     */
    @Nonnull
    default FloatToShortFunction papplyAsShort(T t, U u) {
     ...
     */
    @Nonnull
    default ToShortBiFunction<T, U> papplyAsShort(float value) {
     ...
     */
    @Nonnull
    default ToShortFunction<U> papplyAsShort(T t, float value) {
     ...
     */
    @Nonnull
    default <S> BiObjFloatFunction<T, U, S> andThen(@Nonnull final ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjFloatPredicate<T, U> andThenToBoolean(@Nonnull final ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToByteFunction<T, U> andThenToByte(@Nonnull final ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToCharFunction<T, U> andThenToChar(@Nonnull final ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToDoubleFunction<T, U> andThenToDouble(@Nonnull final ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToFloatFunction<T, U> andThenToFloat(@Nonnull final ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToIntFunction<T, U> andThenToInt(@Nonnull final ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToLongFunction<T, U> andThenToLong(@Nonnull final ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatToShortFunction<T, U> andThenToShort(@Nonnull final ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjFloatConsumer<T, U> consume(@Nonnull final ShortConsumer consumer) {
