...
import org.lambda4j.function.bi.obj.ObjIntFunction;
 ...
 * result. This is a (reference, reference, int) specialization of {@link TriFunction}.
 * <p>
...
@FunctionalInterface
public interface BiObjIntFunction<T, U, R> extends Lambda {

    /**
     * Constructs a {@link BiObjIntFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U, R> BiObjIntFunction<T, U, R> of(@Nullable BiObjIntFunction<T, U, R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link BiObjIntFunction} into a total {@link BiObjIntFunction} that returns an {@link Optional}
     * result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return A partial {@code BiObjIntFunction} lifted into a total {@code BiObjIntFunction} that returns an {@code
     * Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R> BiObjIntFunction<T, U, Optional<R>> lift(
            @Nonnull BiObjIntFunction<? super T, ? super U, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U, R> R call(@Nonnull BiObjIntFunction<? super T, ? super U, ? extends R> function, T t, U u,
            int value) {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjIntFunction<T, U, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjIntFunction<T, U, R> onlySecond(@Nonnull Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjIntFunction<T, U, R> onlyThird(@Nonnull IntFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjIntFunction<T, U, R> constant(R ret) {
     ...
     */
    default R apply(@Nonnull Pair<T, U> tuple, int value) {
        Objects.requireNonNull(tuple);
        return apply(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ObjIntFunction} as result.
     *
     ...
     */
    @Nonnull
    default <S> BiObjIntFunction<T, U, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjIntConsumer<T, U> consume(@Nonnull Consumer<? super R> consumer) {
     ...
     */
    @Nonnull
    default ObjIntFunction<Pair<T, U>, R> tupled() {
        return this::apply;
    }
    ...
    default BiObjIntFunction<T, U, R> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Integer>, R> cache = new ConcurrentHashMap<>();
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjIntFunction}.
     */
    @Nonnull
