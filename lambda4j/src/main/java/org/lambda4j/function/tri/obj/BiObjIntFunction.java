...
public interface BiObjIntFunction<T, U, R> extends Lambda {
     ...
     */
    static <T, U, R> BiObjIntFunction<T, U, R> of(@Nullable final BiObjIntFunction<T, U, R> expression) {
        return expression;
    }
    ...
    static <T, U, R> BiObjIntFunction<T, U, Optional<R>> lift(
            @Nonnull final BiObjIntFunction<? super T, ? super U, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U, R> R call(@Nonnull final BiObjIntFunction<? super T, ? super U, ? extends R> function, T t, U u,
            int value) {
     ...
     * {@code BiObjIntFunction} with methods provided by the {@code JDK}.
     *
