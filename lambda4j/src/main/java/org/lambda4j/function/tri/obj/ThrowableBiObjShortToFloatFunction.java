 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, short)
...
public interface ThrowableBiObjShortToFloatFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjShortToFloatFunction<T, U, X> of(
            @Nullable ThrowableBiObjShortToFloatFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> float call(
            @Nonnull ThrowableBiObjShortToFloatFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjShortToFloatFunction<U, X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortToFloatFunction<X> applyAsFloatThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToFloatBiFunction<T, U, X> applyAsFloatThrowsPartially(short value) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<U, X> applyAsFloatThrowsPartially(T t, short value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjShortConsumer<T, U, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjShortToFloatFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Short>, Float> cache = new ConcurrentHashMap<>();
    ...
    default BiObjShortToFloatFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjShortToFloatFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjShortToFloatFunction<? super T, ? super U> function = recover.apply(throwable);
