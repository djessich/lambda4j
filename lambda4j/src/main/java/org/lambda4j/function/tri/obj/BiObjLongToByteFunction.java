...
import org.lambda4j.function.bi.obj.ObjLongToByteFunction;
...
@FunctionalInterface
public interface BiObjLongToByteFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjLongToByteFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code BiObjLongToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjLongToByteFunction<T, U> of(@Nullable BiObjLongToByteFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjLongToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjLongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> byte call(@Nonnull BiObjLongToByteFunction<? super T, ? super U> function, T t, U u,
            long value) {
    ...
    /**
     * Creates a {@link BiObjLongToByteFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code BiObjLongToByteFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToByteFunction<T, U> onlyFirst(@Nonnull ToByteFunction<? super T> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByte(t);
    }

    /**
     * Creates a {@link BiObjLongToByteFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code BiObjLongToByteFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToByteFunction<T, U> onlySecond(@Nonnull ToByteFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByte(u);
    }

    /**
     * Creates a {@link BiObjLongToByteFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link LongToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjLongToByteFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code LongToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjLongToByteFunction<T, U> onlyThird(@Nonnull LongToByteFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByte(value);
    }

    /**
     * Creates a {@link BiObjLongToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjLongToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjLongToByteFunction<T, U> constant(byte ret) {
     ...
     */
    byte applyAsByte(T t, U u, long value);
     ...
     */
    default byte applyAsByte(@Nonnull Pair<T, U> tuple, long value) {
        Objects.requireNonNull(tuple);
        return applyAsByte(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ObjLongToByteFunction} as
     * result.
     *
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<U> applyAsBytePartially(T t) {
     ...
     */
    @Nonnull
    default LongToByteFunction applyAsBytePartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToByteBiFunction<T, U> applyAsBytePartially(long value) {
     ...
     */
    @Nonnull
    default ToByteFunction<U> applyAsBytePartially(T t, long value) {
    ...
    default <A, B, C> ToByteTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsByte(before1.apply(a), before2.apply(b), before3.applyAsLong(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjLongFunction<T, U, S> andThen(@Nonnull ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjLongPredicate<T, U> andThenToBoolean(@Nonnull BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToByteFunction<T, U> andThenToByte(@Nonnull ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToCharFunction<T, U> andThenToChar(@Nonnull ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToDoubleFunction<T, U> andThenToDouble(@Nonnull ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToFloatFunction<T, U> andThenToFloat(@Nonnull ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToIntFunction<T, U> andThenToInt(@Nonnull ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToLongFunction<T, U> andThenToLong(@Nonnull ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongToShortFunction<T, U> andThenToShort(@Nonnull ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> consume(@Nonnull ByteConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjLongToByteFunction<Pair<T, U>> tupled() {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjLongToByteFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjLongToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjLongToByteFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Long, Byte> boxed() {
        return this::applyAsByte;
    }
}
