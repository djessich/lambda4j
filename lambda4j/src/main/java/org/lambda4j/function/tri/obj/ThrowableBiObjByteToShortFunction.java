 ...
 * {@code short}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, byte)
...
public interface ThrowableBiObjByteToShortFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToShortFunction<T, U, X> of(
            @Nullable ThrowableBiObjByteToShortFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> short call(
            @Nonnull ThrowableBiObjByteToShortFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjByteToShortFunction<U, X> applyAsShortThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToShortFunction<X> applyAsShortThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToShortBiFunction<T, U, X> applyAsShortThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableToShortFunction<U, X> applyAsShortThrowsPartially(T t, byte value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjByteToShortFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Byte>, Short> cache = new ConcurrentHashMap<>();
    ...
    default BiObjByteToShortFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjByteToShortFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjByteToShortFunction<? super T, ? super U> function = recover.apply(throwable);
