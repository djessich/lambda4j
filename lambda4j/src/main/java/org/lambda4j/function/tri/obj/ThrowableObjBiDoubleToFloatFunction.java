 ...
 * {@code float}-valued result which is able to throw any {@link Throwable}. This is a (reference, double, double)
...
public interface ThrowableObjBiDoubleToFloatFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiDoubleToFloatFunction<T, X> of(
            @Nullable ThrowableObjBiDoubleToFloatFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> float call(
            @Nonnull ThrowableObjBiDoubleToFloatFunction<? super T, ? extends X> function, T t, double value1,
     ...
     */
    @Nonnull
    default ThrowableBiDoubleToFloatFunction<X> applyAsFloatThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToFloatFunction<X> applyAsFloatThrowsPartially(T t, double value1) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToFloatFunction<T, X> applyAsFloatThrowsPartially(double value1) {
     ...
     */
    @Nonnull
    default ThrowableToFloatFunction<T, X> applyAsFloatThrowsPartially(double value1, double value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiDoubleConsumer<T, X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     * ThrowableObjBiDoubleToFloatFunction}.
     */
    @Nonnull
    ...
    default ObjBiDoubleToFloatFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiDoubleToFloatFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiDoubleToFloatFunction<? super T> function = recover.apply(throwable);
