...
public interface ThrowableBiObjByteToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToLongFunction<T, U, X> of(
            @Nullable final ThrowableBiObjByteToLongFunction<T, U, X> expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default ThrowableObjByteToLongFunction<U, X> papplyAsLongThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> papplyAsLongThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToLongBiFunction<T, U, X> papplyAsLongThrows(byte value) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<U, X> papplyAsLongThrows(T t, byte value) {
    ...
    default BiObjByteToLongFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjByteToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjByteToLongFunction<? super T, ? super U> function = recover.apply(throwable);
