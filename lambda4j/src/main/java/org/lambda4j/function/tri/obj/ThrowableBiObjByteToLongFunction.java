...
public interface ThrowableBiObjByteToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjByteToLongFunction<T, U, X> of(
            @Nullable ThrowableBiObjByteToLongFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> long call(
            @Nonnull ThrowableBiObjByteToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
            byte value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjByteToLongFunction<U, X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> applyAsLongThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToLongBiFunction<T, U, X> applyAsLongThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<U, X> applyAsLongThrowsPartially(T t, byte value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjByteConsumer<T, U, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
    ...
    default ThrowableBiObjByteToLongFunction<T, U, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, U, Byte>, Long> cache = new ConcurrentHashMap<>();
     ...
     * this {@code ThrowableBiObjByteToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjByteToLongFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjByteToLongFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjByteToLongFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjByteToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjByteToLongFunction<? super T, ? super U> function = recover.apply(throwable);
