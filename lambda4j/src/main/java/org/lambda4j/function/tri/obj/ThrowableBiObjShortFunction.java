 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, reference, short) specialization of {@link
...
public interface ThrowableBiObjShortFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, R, X> of(
            @Nullable ThrowableBiObjShortFunction<T, U, R, X> expression) {
        return expression;
    }
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjShortFunction<T, U, Optional<R>, X> lift(
            @Nonnull ThrowableBiObjShortFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
    ...
    static <T, U, R, X extends Throwable> R call(
            @Nonnull ThrowableBiObjShortFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableObjShortFunction<U, R, X> applyThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableShortFunction<R, X> applyThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, U, R, X> applyThrowsPartially(short value) {
     ...
     */
    @Nonnull
    default ThrowableFunction<U, R, X> applyThrowsPartially(T t, short value) {
     ...
     */
    @Nonnull
    default BiObjShortFunction<T, U, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiObjShortFunction<T, U, R> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjShortFunction<? super T, ? super U,
                    ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjShortFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
