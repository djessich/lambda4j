...
public interface ThrowableBiObjDoubleToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToLongFunction<T, U, X> of(
            @Nullable final ThrowableBiObjDoubleToLongFunction<T, U, X> expression) {
        return expression;
    }
    ...
    default BiObjDoubleToLongFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjDoubleToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjDoubleToLongFunction<? super T, ? super U> function = recover.apply(throwable);
