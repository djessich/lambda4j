...
public interface ThrowableBiObjDoubleToLongFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToLongFunction<T, U, X> of(
            @Nullable ThrowableBiObjDoubleToLongFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> long call(
            @Nonnull ThrowableBiObjDoubleToLongFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToLongFunction<U, X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToLongFunction<X> applyAsLongThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToLongBiFunction<T, U, X> applyAsLongThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<U, X> applyAsLongThrowsPartially(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     * this {@code ThrowableBiObjDoubleToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BiObjDoubleToLongFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjDoubleToLongFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjDoubleToLongFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleToLongFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleToLongFunction<? super T, ? super U> function = recover.apply(throwable);
