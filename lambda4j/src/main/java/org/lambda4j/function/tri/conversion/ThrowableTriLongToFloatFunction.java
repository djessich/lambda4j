...
/**
 * Represents an operation that accepts three {@code long}-valued input arguments and produces a {@code float}-valued
 * result which is able to throw any {@link Throwable}. This is a primitive specialization of {@link
 * ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(long, long, long)}.
 *
...
@FunctionalInterface
public interface ThrowableTriLongToFloatFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriLongToFloatFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableTriLongToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableTriLongToFloatFunction<X> of(
            @Nullable ThrowableTriLongToFloatFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableTriLongToFloatFunction} with the given arguments and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriLongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> float call(@Nonnull ThrowableTriLongToFloatFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriLongToFloatFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@link ThrowableLongToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriLongToFloatFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableLongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToFloatFunction<X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriLongToFloatFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@link ThrowableLongToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriLongToFloatFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableLongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToFloatFunction<X> onlySecond(
            @Nonnull ThrowableLongToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriLongToFloatFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableLongToFloatFunction}.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriLongToFloatFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableLongToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToFloatFunction<X> onlyThird(
            @Nonnull ThrowableLongToFloatFunction<? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriLongToFloatFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriLongToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableTriLongToFloatFunction<X> constant(float ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(long value1, long value2, long value3) throws X;

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableBiLongToFloatFunction}
     * as result.
     *
     * @param value1 The first argument to this function used to partially apply this function
     * @return A {@code ThrowableBiLongToFloatFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableBiLongToFloatFunction<X> applyAsFloatThrowsPartially(long value1) {
     ...
     */
    @Nonnull
    default ThrowableLongToFloatFunction<X> applyAsFloatThrowsPartially(long value1, long value2) {
    ...
    default <A, B, C> ThrowableToFloatTriFunction<A, B, C, X> compose(
        ...
        return (a, b, c) -> applyAsFloatThrows(before1.applyAsLongThrows(a), before2.applyAsLongThrows(b),
    ...
    default ThrowableTriBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyAsFloatThrows(before1.applyAsLongThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriLongToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     * @return A composed {@code ThrowableTriLongToFloatFunction} that first applies the {@code before} operators to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     ...
     */
    @Nonnull
    default ThrowableTriLongPredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriLongConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriLongToFloatFunction<X> reversed() {
        return (value3, value2, value1) -> applyAsFloatThrows(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableTriLongToFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriLongToFloatFunction}.
     ...
     */
    @Nonnull
    default ThrowableTriLongToFloatFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<Long, Long, Long>, Float> cache = new ConcurrentHashMap<>();
            return (ThrowableTriLongToFloatFunction<X> & Memoized) (value1, value2, value3) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriLongToFloatFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableTriLongToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriLongToFloatFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Long, Long, Long, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link TriLongToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriLongToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriLongToFloatFunction nest() {
     ...
     */
    @Nonnull
    default TriLongToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriLongToFloatFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default TriLongToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriLongToFloatFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriLongToFloatFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriLongToFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link TriLongToFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriLongToFloatFunction sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyAsFloatThrows(value1, value2, value3);
