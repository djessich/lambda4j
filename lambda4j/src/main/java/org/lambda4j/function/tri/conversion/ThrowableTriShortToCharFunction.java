...
public interface ThrowableTriShortToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableTriShortToCharFunction<X> of(
            @Nullable ThrowableTriShortToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull ThrowableTriShortToCharFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableTriShortPredicate<X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriShortConsumer<X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableTriShortToCharFunction<X> reversed() {
     ...
     * this {@code ThrowableTriShortToCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link TriShortToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default TriShortToCharFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default TriShortToCharFunction recover(
            @Nonnull Function<? super Throwable, ? extends TriShortToCharFunction> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriShortToCharFunction function = recover.apply(throwable);
