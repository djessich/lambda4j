 ...
 * {@code int}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, float)
...
public interface ThrowableBiObjFloatToIntFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToIntFunction<T, U, X> of(
            @Nullable ThrowableBiObjFloatToIntFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> int call(
            @Nonnull ThrowableBiObjFloatToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    static <T, U, X extends Throwable> ThrowableBiObjFloatToIntFunction<T, U, X> onlyThird(
            @Nonnull ThrowableFloatToIntFunction<? extends X> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ThrowableObjFloatToIntFunction<U, X> applyAsIntThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> applyAsIntThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToIntBiFunction<T, U, X> applyAsIntThrowsPartially(float value) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<U, X> applyAsIntThrowsPartially(T t, float value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
    ...
    default BiObjFloatToIntFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjFloatToIntFunction<? super T, ? super U>> recover) {
        Objects.requireNonNull(recover);
        return (t, u, value) -> {
            try {
                return applyAsIntThrows(t, u, value);
            } catch (Error e) {
                throw e;
            } catch (Throwable throwable) {
                BiObjFloatToIntFunction<? super T, ? super U> function = recover.apply(throwable);
