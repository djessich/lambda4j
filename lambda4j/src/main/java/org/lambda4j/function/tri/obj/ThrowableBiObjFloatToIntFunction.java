...
import org.lambda4j.predicate.tri.obj.ThrowableBiObjFloatPredicate;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsIntThrows(Object, Object, float)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjFloatToIntFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjFloatToIntFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableBiObjFloatToIntFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjFloatToIntFunction<T, U, X> of(
            @Nullable final ThrowableBiObjFloatToIntFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjFloatToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjFloatToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> int call(
            @Nonnull final ThrowableBiObjFloatToIntFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToIntFunction} which uses the {@code first} parameter of this one as argument
     ...
     * @return Creates a {@code ThrowableBiObjFloatToIntFunction} which uses the {@code first} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToIntFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToIntFunction} which uses the {@code second} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjFloatToIntFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@code ThrowableToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToIntFunction<T, U, X> onlySecond(
    ...
    /**
     * Creates a {@link ThrowableBiObjFloatToIntFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@link ThrowableFloatToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableBiObjFloatToIntFunction} which uses the {@code third} parameter of this one as
     * argument for the given {@code ThrowableFloatToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToIntFunction<T, U, X> onlyThird(
            @Nonnull final ThrowableFloatToIntFunction<? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsIntThrows(value);
    }

    /**
     * Creates a {@link ThrowableBiObjFloatToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjFloatToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjFloatToIntFunction<T, U, X> constant(int ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    int applyAsIntThrows(T t, U u, float value) throws X;
     ...
     */
    default int applyAsIntThrows(@Nonnull Pair<T, U> tuple, float value) throws X {
        Objects.requireNonNull(tuple);
        return applyAsIntThrows(tuple.getLeft(), tuple.getRight(), value);
    }

    /**
     * Applies this function partially to some arguments of this one, producing a {@link ThrowableObjFloatToIntFunction}
     * as result.
     *
     * @param t The first argument to this function used to partially apply this function
     * @return A {@code ThrowableObjFloatToIntFunction} that represents this function partially applied the some
     * arguments.
     */
    @Nonnull
    default ThrowableObjFloatToIntFunction<U, X> papplyAsIntThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> papplyAsIntThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToIntBiFunction<T, U, X> papplyAsIntThrows(float value) {
     ...
     */
    @Nonnull
    default ThrowableToIntFunction<U, X> papplyAsIntThrows(T t, float value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatConsumer<T, U, X> consume(@Nonnull final ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjFloatToIntFunction<Pair<T, U>, X> tupled() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjFloatToIntFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjFloatToIntFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjFloatToIntFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Float>, Integer> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjFloatToIntFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjFloatToIntFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjFloatToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjFloatToIntFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Float, Integer, X> boxed() {
        return this::applyAsIntThrows;
    }

    /**
     * Returns a composed {@link BiObjFloatToIntFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjFloatToIntFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link BiObjFloatToIntFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjFloatToIntFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjFloatToIntFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                final BiObjFloatToIntFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjFloatToIntFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjFloatToIntFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjFloatToIntFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return this.applyAsIntThrows(t, u, value);
