...
public interface ThrowableObjBiByteToLongFunction<T, X extends Throwable> extends Lambda {
    ...
    static <T, X extends Throwable> ThrowableObjBiByteToLongFunction<T, X> of(
            @Nullable ThrowableObjBiByteToLongFunction<T, X> expression) {
        return expression;
    }
    ...
    static <T, X extends Throwable> long call(
            @Nonnull ThrowableObjBiByteToLongFunction<? super T, ? extends X> function, T t, byte value1,
     ...
     */
    @Nonnull
    default ThrowableBiByteToLongFunction<X> applyAsLongThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> applyAsLongThrowsPartially(T t, byte value1) {
     ...
     */
    @Nonnull
    default ThrowableObjByteToLongFunction<T, X> applyAsLongThrowsPartially(byte value1) {
     ...
     */
    @Nonnull
    default ThrowableToLongFunction<T, X> applyAsLongThrowsPartially(byte value1, byte value2) {
     ...
     */
    @Nonnull
    default ThrowableObjBiByteConsumer<T, X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
    ...
    default ThrowableObjBiByteToLongFunction<T, X> memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<T, Byte, Byte>, Long> cache = new ConcurrentHashMap<>();
     ...
     * this {@code ThrowableObjBiByteToLongFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link ObjBiByteToLongFunction} that applies this function to its input and nests the thrown
     ...
     * @return A composed {@link ObjBiByteToLongFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default ObjBiByteToLongFunction<T> recover(
            @Nonnull Function<? super Throwable, ? extends ObjBiByteToLongFunction<? super T>> recover) {
        ...
        return (t, value1, value2) -> {
            try {
                ...
                ObjBiByteToLongFunction<? super T> function = recover.apply(throwable);
