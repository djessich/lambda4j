...
import org.lambda4j.function.bi.obj.ObjByteToIntFunction;
 ...
 * {@code int}-valued result. This is a (reference, reference, byte) specialization of {@link TriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsInt(Object, Object, byte)}.
 *
...
@FunctionalInterface
public interface BiObjByteToIntFunction<T, U> extends Lambda {

    /**
     * Constructs a {@link BiObjByteToIntFunction} based on a lambda expression or a method reference. Thereby the given
     ...
     * @return A {@code BiObjByteToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T, U> BiObjByteToIntFunction<T, U> of(@Nullable BiObjByteToIntFunction<T, U> expression) {
        return expression;
    }

    /**
     * Calls the given {@link BiObjByteToIntFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return The result from the given {@code BiObjByteToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U> int call(@Nonnull BiObjByteToIntFunction<? super T, ? super U> function, T t, U u, byte value) {
     ...
     */
    @Nonnull
    static <T, U> BiObjByteToIntFunction<T, U> onlyFirst(@Nonnull ToIntFunction<? super T> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U> BiObjByteToIntFunction<T, U> onlySecond(@Nonnull ToIntFunction<? super U> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsInt(u);
    }

    /**
     * Creates a {@link BiObjByteToIntFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link ByteToIntFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code BiObjByteToIntFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code ByteToIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U> BiObjByteToIntFunction<T, U> onlyThird(@Nonnull ByteToIntFunction function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsInt(value);
    }

    /**
     * Creates a {@link BiObjByteToIntFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param ret The return value for the constant
     * @return A {@code BiObjByteToIntFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U> BiObjByteToIntFunction<T, U> constant(int ret) {
     ...
     */
    int applyAsInt(T t, U u, byte value);
     ...
     */
    @Nonnull
    default ObjByteToIntFunction<U> applyAsIntPartially(T t) {
     ...
     */
    @Nonnull
    default ByteToIntFunction applyAsIntPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ToIntBiFunction2<T, U> applyAsIntPartially(byte value) {
     ...
     */
    @Nonnull
    default ToIntFunction2<U> applyAsIntPartially(T t, byte value) {
    ...
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull Function<? super A, ? extends T> before1,
        ...
        return (a, b, c) -> applyAsInt(before1.apply(a), before2.apply(b), before3.applyAsByte(c));
    }
     ...
     */
    @Nonnull
    default <S> BiObjByteFunction<T, U, S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjBytePredicate<T, U> andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToByteFunction<T, U> andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToCharFunction<T, U> andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToDoubleFunction<T, U> andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToFloatFunction<T, U> andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToIntFunction<T, U> andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToLongFunction<T, U> andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteToShortFunction<T, U> andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BiObjByteConsumer<T, U> consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default ObjByteToIntFunction<Pair<T, U>> tupled() {
        return this::applyAsInt;
    }

    /**
     * Returns a memoized (caching) version of this {@link BiObjByteToIntFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code BiObjByteToIntFunction}.
     ...
     */
    @Nonnull
    default BiObjByteToIntFunction<T, U> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Triple<T, U, Byte>, Integer> cache = new ConcurrentHashMap<>();
            return (BiObjByteToIntFunction<T, U> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link TriFunction} which represents this {@link BiObjByteToIntFunction}. Thereby the
     * primitive input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BiObjByteToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code TriFunction} which represents this {@code BiObjByteToIntFunction}.
     */
    @Nonnull
    default TriFunction<T, U, Byte, Integer> boxed() {
        return this::applyAsInt;
    }
