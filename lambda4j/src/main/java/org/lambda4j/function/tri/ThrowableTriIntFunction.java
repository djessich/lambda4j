...
/**
 * Represents an operation that accepts three {@code int}-valued input arguments and produces a result which is able to
 * throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableTriFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyThrows(int, int, int)}.
 *
...
@FunctionalInterface
public interface ThrowableTriIntFunction<R, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableTriIntFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableTriIntFunction} from given lambda expression or method reference.
    ...
    /**
     * Constructs a {@link ThrowableTriIntFunction} based on a curried lambda expression. Thereby the given curried
     ...
     * value3)}
     * @return A {@code ThrowableTriIntFunction} from given curried lambda expression.
    ...
    @Nullable
    static <R, X extends Throwable> ThrowableTriIntFunction<R, X> of(
            @Nullable ThrowableIntFunction<ThrowableIntFunction<ThrowableIntFunction<R, X>, X>, X> curried)
            throws X {
    ...
    /**
     * Lifts a partial {@link ThrowableTriIntFunction} into a total {@link ThrowableTriIntFunction} that returns an
     * {@link Optional} result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param partial A function that is only defined for some values in its domain
     * @return A partial {@code ThrowableTriIntFunction} lifted into a total {@code ThrowableTriIntFunction} that
     * returns an {@code Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriIntFunction<Optional<R>, X> lift(
            @Nonnull ThrowableTriIntFunction<? extends R, ? extends X> partial) {
        Objects.requireNonNull(partial);
        return (value1, value2, value3) -> Optional.ofNullable(partial.applyThrows(value1, value2, value3));
    }

    /**
     * Calls the given {@link ThrowableTriIntFunction} with the given arguments and returns its result.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableTriIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <R, X extends Throwable> R call(@Nonnull ThrowableTriIntFunction<? extends R, ? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableTriIntFunction} which uses the {@code first} parameter of this one as argument for the
     * given {@link ThrowableIntFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code first} parameter of this one
     * @return Creates a {@code ThrowableTriIntFunction} which uses the {@code first} parameter of this one as argument
     * for the given {@code ThrowableIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriIntFunction<R, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableTriIntFunction} which uses the {@code second} parameter of this one as argument for the
     * given {@link ThrowableIntFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code second} parameter of this one
     * @return Creates a {@code ThrowableTriIntFunction} which uses the {@code second} parameter of this one as argument
     * for the given {@code ThrowableIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriIntFunction<R, X> onlySecond(
            @Nonnull ThrowableIntFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriIntFunction} which uses the {@code third} parameter of this one as argument for the
     * given {@link ThrowableIntFunction}.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function which accepts the {@code third} parameter of this one
     * @return Creates a {@code ThrowableTriIntFunction} which uses the {@code third} parameter of this one as argument
     * for the given {@code ThrowableIntFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriIntFunction<R, X> onlyThird(
            @Nonnull ThrowableIntFunction<? extends R, ? extends X> function) {
        Objects.requireNonNull(function);
    ...
    /**
     * Creates a {@link ThrowableTriIntFunction} which always returns a given value.
     *
     * @param <R> The type of return value from the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableTriIntFunction} which always returns a given value.
     */
    @Nonnull
    static <R, X extends Throwable> ThrowableTriIntFunction<R, X> constant(R ret) {
     ...
     */
    @Nonnull
    default ThrowableBiIntFunction<R, X> applyThrowsPartially(int value1) {
     ...
     */
    @Nonnull
    default ThrowableIntFunction<R, X> applyThrowsPartially(int value1, int value2) {
    ...
    default <A, B, C> ThrowableTriFunction<A, B, C, R, X> compose(
        ...
        return (a, b, c) -> applyThrows(before1.applyAsIntThrows(a), before2.applyAsIntThrows(b),
    ...
    default ThrowableTriBooleanFunction<R, X> composeFromBoolean(
        ...
        Objects.requireNonNull(before2);
        Objects.requireNonNull(before3);
        return (value1, value2, value3) -> applyThrows(before1.applyAsIntThrows(value1),
    ...
    /**
     * Returns a composed {@link ThrowableTriIntFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result. This method is just convenience, to provide the ability to execute
     ...
     * @return A composed {@code ThrowableTriIntFunction} that first applies the {@code before} operators to its input,
     * and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * int}.
     */
    @Nonnull
    default ThrowableTriIntFunction<R, X> composeFromInt(@Nonnull ThrowableIntUnaryOperator<? extends X> before1,
     ...
     */
    @Nonnull
    default ThrowableTriIntPredicate<X> andThenToBoolean(@Nonnull ThrowablePredicate<? super R, ? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableTriIntConsumer<X> consume(@Nonnull ThrowableConsumer<? super R, ? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableIntFunction<ThrowableIntFunction<ThrowableIntFunction<R, X>, X>, X> curried() {
     ...
     */
    @Nonnull
    default ThrowableTriIntFunction<R, X> reversed() {
        return (value3, value2, value1) -> applyThrows(value1, value2, value3);
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableTriIntFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableTriIntFunction}.
    ...
    default ThrowableTriIntFunction<R, X> memoized() {
        if (isMemoized()) {
            ...
            return (ThrowableTriIntFunction<R, X> & Memoized) (value1, value2, value3) -> {
    ...
    @Deprecated
    @Nonnull
    default ThrowableTriIntFunction<Optional<R>, X> nonNull() {
        return (value1, value2, value3) -> Optional.ofNullable(applyThrows(value1, value2, value3));
    }

    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableTriIntFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableTriIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableTriIntFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<Integer, Integer, Integer, R, X> boxed() {
        return this::applyThrows;
    }

    /**
     * Returns a composed {@link TriIntFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link TriIntFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default TriIntFunction<R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link TriIntFunction} that first applies this function to its input, and then applies the
     ...
     */
    @Nonnull
    default TriIntFunction<R> recover(
            @Nonnull Function<? super Throwable, ? extends TriIntFunction<? extends R>> recover) {
        ...
        return (value1, value2, value3) -> {
            try {
                ...
                TriIntFunction<? extends R> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link TriIntFunction} that applies this function to its input and sneakily throws the thrown
     ...
     *
     * @return A composed {@link TriIntFunction} that applies this function to its input and sneakily throws the thrown
     * {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default TriIntFunction<R> sneakyThrow() {
        return (value1, value2, value3) -> {
            try {
                return applyThrows(value1, value2, value3);
