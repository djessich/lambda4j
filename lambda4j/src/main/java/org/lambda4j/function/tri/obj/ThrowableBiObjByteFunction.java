 ...
 * result which is able to throw any {@link Throwable}. This is a (reference, reference, byte) specialization of {@link
...
public interface ThrowableBiObjByteFunction<T, U, R, X extends Throwable> extends Lambda {
    ...
    static <T, U, R, X extends Throwable> ThrowableBiObjByteFunction<T, U, Optional<R>, X> lift(
            @Nonnull ThrowableBiObjByteFunction<? super T, ? super U, ? extends R, ? extends X> partial) {
    ...
    static <T, U, R, X extends Throwable> R call(
            @Nonnull ThrowableBiObjByteFunction<? super T, ? super U, ? extends R, ? extends X> function, T t,
     ...
     */
    @Nonnull
    default ThrowableObjByteFunction<U, R, X> applyThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableByteFunction<R, X> applyThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableBiFunction<T, U, R, X> applyThrowsPartially(byte value) {
     ...
     */
    @Nonnull
    default ThrowableFunction<U, R, X> applyThrowsPartially(T t, byte value) {
     ...
     */
    @Nonnull
    default BiObjByteFunction<T, U, R> nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BiObjByteFunction<T, U, R> recover(
            @Nonnull Function<? super Throwable,
                    ? extends BiObjByteFunction<? super T, ? super U, ? extends R>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjByteFunction<? super T, ? super U, ? extends R> function = recover.apply(throwable);
