...
import org.lambda4j.predicate.tri.obj.ThrowableBiObjDoublePredicate;
 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(Object, Object, double)}.
 *
...
@FunctionalInterface
public interface ThrowableBiObjDoubleToByteFunction<T, U, X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableBiObjDoubleToByteFunction} based on a lambda expression or a method reference.
     ...
     * @return A {@code ThrowableBiObjDoubleToByteFunction} from given lambda expression or method reference.
     ...
     */
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToByteFunction<T, U, X> of(
            @Nullable final ThrowableBiObjDoubleToByteFunction<T, U, X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableBiObjDoubleToByteFunction} with the given arguments and returns its result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     ...
     * @return The result from the given {@code ThrowableBiObjDoubleToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <T, U, X extends Throwable> byte call(
            @Nonnull final ThrowableBiObjDoubleToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToByteFunction} which uses the {@code first} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToByteFunction} which uses the {@code first} parameter of this one
     * as argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToByteFunction<T, U, X> onlyFirst(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToByteFunction} which uses the {@code second} parameter of this one as
     * argument for the given {@link ThrowableToByteFunction}.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToByteFunction} which uses the {@code second} parameter of this one
     * as argument for the given {@code ThrowableToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToByteFunction<T, U, X> onlySecond(
            @Nonnull final ThrowableToByteFunction<? super U, ? extends X> function) {
        Objects.requireNonNull(function);
        return (t, u, value) -> function.applyAsByteThrows(u);
    }

    /**
     * Creates a {@link ThrowableBiObjDoubleToByteFunction} which uses the {@code third} parameter of this one as
     ...
     * @return Creates a {@code ThrowableBiObjDoubleToByteFunction} which uses the {@code third} parameter of this one
     * as argument for the given {@code ThrowableDoubleToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToByteFunction<T, U, X> onlyThird(
    ...
    /**
     * Creates a {@link ThrowableBiObjDoubleToByteFunction} which always returns a given value.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableBiObjDoubleToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToByteFunction<T, U, X> constant(byte ret) {
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(T t, U u, double value) throws X;
     ...
     */
    default byte applyAsByteThrows(@Nonnull Pair<T, U> tuple, double value) throws X {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToByteFunction<U, X> papplyAsByteThrows(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToByteFunction<X> papplyAsByteThrows(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToByteBiFunction<T, U, X> papplyAsByteThrows(double value) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<U, X> papplyAsByteThrows(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull final ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToByteFunction<Pair<T, U>, X> tupled() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableBiObjDoubleToByteFunction}. Whenever it is called,
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableBiObjDoubleToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleToByteFunction<T, U, X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Triple<T, U, Double>, Byte> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableBiObjDoubleToByteFunction<T, U, X> & Memoized) (t, u, value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableTriFunction} which represents this {@link ThrowableBiObjDoubleToByteFunction}.
     * Thereby the primitive input argument for this function is autoboxed. This method provides the possibility to use
     * this {@code ThrowableBiObjDoubleToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableTriFunction} which represents this {@code ThrowableBiObjDoubleToByteFunction}.
     */
    @Nonnull
    default ThrowableTriFunction<T, U, Double, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link BiObjDoubleToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link BiObjDoubleToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BiObjDoubleToByteFunction<T, U> nest() {
     ...
     * @return A composed {@link BiObjDoubleToByteFunction} that first applies this function to its input, and then
     ...
     */
    @Nonnull
    default BiObjDoubleToByteFunction<T, U> recover(
            @Nonnull final Function<? super Throwable, ? extends BiObjDoubleToByteFunction<? super T, ? super U>> recover) {
        Objects.requireNonNull(recover);
        return (t, u, value) -> {
            try {
                return this.applyAsByteThrows(t, u, value);
            } catch (Error e) {
                throw e;
            } catch (Throwable throwable) {
                final BiObjDoubleToByteFunction<? super T, ? super U> function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link BiObjDoubleToByteFunction} that applies this function to its input and sneakily throws
     ...
     *
     * @return A composed {@link BiObjDoubleToByteFunction} that applies this function to its input and sneakily throws
     * the thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default BiObjDoubleToByteFunction<T, U> sneakyThrow() {
        return (t, u, value) -> {
            try {
                return this.applyAsByteThrows(t, u, value);
