 ...
 * {@code byte}-valued result which is able to throw any {@link Throwable}. This is a (reference, reference, double)
...
public interface ThrowableBiObjDoubleToByteFunction<T, U, X extends Throwable> extends Lambda {
    ...
    static <T, U, X extends Throwable> ThrowableBiObjDoubleToByteFunction<T, U, X> of(
            @Nullable ThrowableBiObjDoubleToByteFunction<T, U, X> expression) {
        return expression;
    }
    ...
    static <T, U, X extends Throwable> byte call(
            @Nonnull ThrowableBiObjDoubleToByteFunction<? super T, ? super U, ? extends X> function, T t, U u,
     ...
     */
    @Nonnull
    default ThrowableObjDoubleToByteFunction<U, X> applyAsByteThrowsPartially(T t) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToByteFunction<X> applyAsByteThrowsPartially(T t, U u) {
     ...
     */
    @Nonnull
    default ThrowableToByteBiFunction<T, U, X> applyAsByteThrowsPartially(double value) {
     ...
     */
    @Nonnull
    default ThrowableToByteFunction<U, X> applyAsByteThrowsPartially(T t, double value) {
     ...
     */
    @Nonnull
    default ThrowableBiObjDoubleConsumer<T, U, X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
    ...
    default BiObjDoubleToByteFunction<T, U> recover(
            @Nonnull Function<? super Throwable, ? extends BiObjDoubleToByteFunction<? super T, ? super U>> recover) {
        ...
        return (t, u, value) -> {
            try {
                ...
                BiObjDoubleToByteFunction<? super T, ? super U> function = recover.apply(throwable);
