...
public interface BiObjLongFunction<T, U, R> extends Lambda {
     ...
     */
    static <T, U, R> BiObjLongFunction<T, U, R> of(@Nullable BiObjLongFunction<T, U, R> expression) {
        return expression;
    }

    /**
     * Lifts a partial {@link BiObjLongFunction} into a total {@link BiObjLongFunction} that returns an {@link Optional}
     * result.
     *
     * @param <T> The type of the first argument to the function
     * @param <U> The type of the second argument to the function
     ...
     * @return A partial {@code BiObjLongFunction} lifted into a total {@code BiObjLongFunction} that returns an {@code
     * Optional} result.
     * @throws NullPointerException If given argument is {@code null}
     */
    @Nonnull
    static <T, U, R> BiObjLongFunction<T, U, Optional<R>> lift(
            @Nonnull BiObjLongFunction<? super T, ? super U, ? extends R> partial) {
     ...
     * @throws NullPointerException If given argument is {@code null}
     */
    static <T, U, R> R call(@Nonnull BiObjLongFunction<? super T, ? super U, ? extends R> function, T t, U u,
            long value) {
     ...
     */
    @Nonnull
    static <T, U, R> BiObjLongFunction<T, U, R> onlyFirst(@Nonnull Function<? super T, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjLongFunction<T, U, R> onlySecond(@Nonnull Function<? super U, ? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static <T, U, R> BiObjLongFunction<T, U, R> onlyThird(@Nonnull LongFunction<? extends R> function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default ObjLongFunction<U, R> applyPartially(T t) {
     ...
     */
    @Nonnull
    default LongFunction2<R> applyPartially(T t, U u) {
     ...
     */
    @Nonnull
    default BiFunction2<T, U, R> applyPartially(long value) {
     ...
     */
    @Nonnull
    default Function2<U, R> applyPartially(T t, long value) {
     ...
     */
    @Nonnull
    default <S> BiObjLongFunction<T, U, S> andThen(@Nonnull Function<? super R, ? extends S> after) {
     ...
     */
    @Nonnull
    default BiObjLongConsumer<T, U> consume(@Nonnull Consumer<? super R> consumer) {
     ...
     * BiObjLongFunction} with methods provided by the {@code JDK}.
     *
