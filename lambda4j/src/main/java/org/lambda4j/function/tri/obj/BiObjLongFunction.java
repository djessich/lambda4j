...
public interface BiObjLongFunction<T, U, R> extends Lambda {
     ...
     */
    static <T, U, R> BiObjLongFunction<T, U, R> of(@Nullable final BiObjLongFunction<T, U, R> expression) {
        return expression;
    }
    ...
    static <T, U, R> BiObjLongFunction<T, U, Optional<R>> lift(
            @Nonnull final BiObjLongFunction<? super T, ? super U, ? extends R> partial) {
     ...
     * {@code BiObjLongFunction} with methods provided by the {@code JDK}.
     *
