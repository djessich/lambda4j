...
public interface TriDoubleToIntFunction extends Lambda {
     ...
     */
    static int call(@Nonnull TriDoubleToIntFunction function, double value1, double value2, double value3) {
     ...
     */
    @Nonnull
    static TriDoubleToIntFunction onlyFirst(@Nonnull DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriDoubleToIntFunction onlySecond(@Nonnull DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    static TriDoubleToIntFunction onlyThird(@Nonnull DoubleToIntFunction function) {
        Objects.requireNonNull(function);
     ...
     */
    @Nonnull
    default <A, B, C> ToIntTriFunction<A, B, C> compose(@Nonnull ToDoubleFunction<? super A> before1,
     ...
     */
    @Nonnull
    default TriBooleanToIntFunction composeFromBoolean(@Nonnull BooleanToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriByteToIntFunction composeFromByte(@Nonnull ByteToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriCharToIntFunction composeFromChar(@Nonnull CharToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction composeFromDouble(@Nonnull DoubleUnaryOperator before1,
     ...
     */
    @Nonnull
    default TriFloatToIntFunction composeFromFloat(@Nonnull FloatToDoubleFunction before1,
     ...
     */
    @Nonnull
    default IntTernaryOperator composeFromInt(@Nonnull IntToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriLongToIntFunction composeFromLong(@Nonnull LongToDoubleFunction before1,
     ...
     */
    @Nonnull
    default TriShortToIntFunction composeFromShort(@Nonnull ShortToDoubleFunction before1,
     ...
     */
    @Nonnull
    default <S> TriDoubleFunction<S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default TriDoublePredicate andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToByteFunction andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToCharFunction andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleTernaryOperator andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToFloatFunction andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToLongFunction andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleToShortFunction andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default TriDoubleConsumer consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default TriDoubleToIntFunction reversed() {
    ...
    default TriDoubleToIntFunction memoized() {
        if (isMemoized()) {
            ...
            Map<Triple<Double, Double, Double>, Integer> cache = new ConcurrentHashMap<>();
     ...
     * TriDoubleToIntFunction} with methods provided by the {@code JDK}.
     *
