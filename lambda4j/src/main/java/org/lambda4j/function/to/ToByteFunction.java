...
/**
 * Represents an operation that accepts one input argument and produces a {@code byte}-valued result. This is a
...
@FunctionalInterface
public interface ToByteFunction<T> extends Lambda {

    /**
     * Constructs a {@link ToByteFunction} based on a lambda expression or a method reference. Thereby the given lambda
     * expression or method reference is returned on an as-is basis to implicitly transform it to the desired type. With
     * this method, it is possible to ensure that correct type is used from lambda expression or method reference.
     *
     * @param <T> The type of the argument to the function
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code ToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <T> ToByteFunction<T> of(@Nullable ToByteFunction<T> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ToByteFunction} with the given argument and returns its result.
     *
     * @param <T> The type of the argument to the function
     ...
     */
    static <T> byte call(@Nonnull ToByteFunction<? super T> function, T t) {
     ...
     */
    @Nonnull
    default <A> ToByteFunction<A> compose(@Nonnull Function<? super A, ? extends T> before) {
        Objects.requireNonNull(before);
        return a -> applyAsByte(before.apply(a));
    }
     ...
     */
    @Nonnull
    default BooleanToByteFunction composeFromBoolean(@Nonnull BooleanFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default ByteUnaryOperator composeFromByte(@Nonnull ByteFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default CharToByteFunction composeFromChar(@Nonnull CharFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default DoubleToByteFunction composeFromDouble(@Nonnull DoubleFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default FloatToByteFunction composeFromFloat(@Nonnull FloatFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default IntToByteFunction composeFromInt(@Nonnull IntFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default LongToByteFunction composeFromLong(@Nonnull LongFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default ShortToByteFunction composeFromShort(@Nonnull ShortFunction<? extends T> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.apply(value));
    }
     ...
     */
    @Nonnull
    default <S> Function2<T, S> andThen(@Nonnull ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default Predicate2<T> andThenToBoolean(@Nonnull BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToByteFunction<T> andThenToByte(@Nonnull ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToCharFunction<T> andThenToChar(@Nonnull ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToDoubleFunction2<T> andThenToDouble(@Nonnull ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToFloatFunction<T> andThenToFloat(@Nonnull ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToIntFunction2<T> andThenToInt(@Nonnull ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToLongFunction2<T> andThenToLong(@Nonnull ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ToShortFunction<T> andThenToShort(@Nonnull ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default Consumer2<T> consume(@Nonnull ByteConsumer consumer) {
    ...
    /**
     * Returns a memoized (caching) version of this {@link ToByteFunction}. Whenever it is called, the mapping between
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ToByteFunction}.
    ...
    /**
     * Returns a composed {@link Function2} which represents this {@link ToByteFunction}. Thereby the primitive input
     * argument for this function is autoboxed. This method provides the possibility to use this {@code ToByteFunction}
     * with methods provided by the {@code JDK}.
     *
     * @return A composed {@code Function2} which represents this {@code ToByteFunction}.
     */
    @Nonnull
