...
/**
 * Represents an operation that accepts one {@code byte}-valued input argument and produces a {@code char}-valued
...
@FunctionalInterface
public interface ByteToCharFunction extends Lambda {

    /**
     * Constructs a {@link ByteToCharFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code ByteToCharFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static ByteToCharFunction of(@Nullable ByteToCharFunction expression) {
        return expression;
    }

    /**
     * Calls the given {@link ByteToCharFunction} with the given argument and returns its result.
     *
     ...
     */
    static char call(@Nonnull ByteToCharFunction function, byte value) {
        Objects.requireNonNull(function);
        return function.applyAsChar(value);
    }

    /**
     * Creates a {@link ByteToCharFunction} which always returns a given value.
     *
     * @param ret The return value for the constant
     * @return A {@code ByteToCharFunction} which always returns a given value.
     */
    @Nonnull
    static ByteToCharFunction constant(char ret) {
        return value -> ret;
    }
     ...
     */
    @Nonnull
    default <A> ToCharFunction<A> compose(@Nonnull ToByteFunction<? super A> before) {
        Objects.requireNonNull(before);
        return a -> applyAsChar(before.applyAsByte(a));
    }
     ...
     */
    @Nonnull
    default BooleanToCharFunction composeFromBoolean(@Nonnull BooleanToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }

    /**
     * Returns a composed {@link ByteToCharFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     * operation which accepts {@code byte} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ByteToCharFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     */
    @Nonnull
    default ByteToCharFunction composeFromByte(@Nonnull ByteUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default CharUnaryOperator composeFromChar(@Nonnull CharToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default DoubleToCharFunction composeFromDouble(@Nonnull DoubleToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default FloatToCharFunction composeFromFloat(@Nonnull FloatToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default IntToCharFunction composeFromInt(@Nonnull IntToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default LongToCharFunction composeFromLong(@Nonnull LongToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default ShortToCharFunction composeFromShort(@Nonnull ShortToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default <S> ByteFunction<S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BytePredicate andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteUnaryOperator andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToCharFunction andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToDoubleFunction andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToFloatFunction andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToIntFunction andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToLongFunction andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToShortFunction andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteConsumer consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default ByteToCharFunction reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link ByteToCharFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ByteToCharFunction}.
     ...
     */
    @Nonnull
    default ByteToCharFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Byte, Character> cache = new ConcurrentHashMap<>();
            return (ByteToCharFunction & Memoized) value -> {
    ...
    /**
     * Returns a composed {@link Function2} which represents this {@link ByteToCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * ByteToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code Function2} which represents this {@code ByteToCharFunction}.
     */
    @Nonnull
    default Function2<Byte, Character> boxed() {
