...
public interface IntToByteFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static IntToByteFunction of(@Nullable IntToByteFunction expression) {
        return expression;
    }
     ...
     */
    static byte call(@Nonnull IntToByteFunction function, int value) {
     ...
     */
    @Nonnull
    default <A> ToByteFunction<A> compose(@Nonnull ToIntFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToByteFunction composeFromBoolean(@Nonnull BooleanToIntFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteUnaryOperator composeFromByte(@Nonnull ByteToIntFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default CharToByteFunction composeFromChar(@Nonnull CharToIntFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default DoubleToByteFunction composeFromDouble(@Nonnull DoubleToIntFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default FloatToByteFunction composeFromFloat(@Nonnull FloatToIntFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default IntToByteFunction composeFromInt(@Nonnull IntUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default LongToByteFunction composeFromLong(@Nonnull LongToIntFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default ShortToByteFunction composeFromShort(@Nonnull ShortToIntFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsInt(value));
    }
     ...
     */
    @Nonnull
    default <S> IntFunction2<S> andThen(@Nonnull ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default IntPredicate2 andThenToBoolean(@Nonnull BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToByteFunction andThenToByte(@Nonnull ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToCharFunction andThenToChar(@Nonnull ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToDoubleFunction2 andThenToDouble(@Nonnull ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToFloatFunction andThenToFloat(@Nonnull ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntUnaryOperator2 andThenToInt(@Nonnull ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToLongFunction2 andThenToLong(@Nonnull ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntToShortFunction andThenToShort(@Nonnull ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default IntConsumer2 consume(@Nonnull ByteConsumer consumer) {
     ...
     */
    @Nonnull
    default IntToByteFunction reversed() {
        return this;
    }
    ...
    /**
     * Returns a composed {@link Function2} which represents this {@link IntToByteFunction}. Thereby the primitive input
     * argument for this function is autoboxed. This method provides the possibility to use this {@code
     * IntToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code Function2} which represents this {@code IntToByteFunction}.
     */
    @Nonnull
