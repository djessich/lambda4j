...
public interface FloatToLongFunction extends Lambda {
     ...
     */
    static FloatToLongFunction of(@Nullable final FloatToLongFunction expression) {
        return expression;
    }
     ...
     */
    @Nonnull
    default <A> ToLongFunction2<A> compose(@Nonnull final ToFloatFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToLongFunction composeFromBoolean(@Nonnull final BooleanToFloatFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToLongFunction composeFromByte(@Nonnull final ByteToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default CharToLongFunction composeFromChar(@Nonnull final CharToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 composeFromDouble(@Nonnull final DoubleToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default FloatToLongFunction composeFromFloat(@Nonnull final FloatUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default IntToLongFunction2 composeFromInt(@Nonnull final IntToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default LongUnaryOperator2 composeFromLong(@Nonnull final LongToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default ShortToLongFunction composeFromShort(@Nonnull final ShortToFloatFunction before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsLong(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default <S> FloatFunction<S> andThen(@Nonnull final LongFunction<? extends S> after) {
     ...
     * {@code FloatToLongFunction} with methods provided by the {@code JDK}.
     *
