 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsCharThrows(short)}.
 *
...
@FunctionalInterface
public interface ThrowableShortToCharFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableShortToCharFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableShortToCharFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableShortToCharFunction<X> of(
            @Nullable final ThrowableShortToCharFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableShortToCharFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableShortToCharFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> char call(@Nonnull final ThrowableShortToCharFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableShortToCharFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableShortToCharFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableShortToCharFunction<X> constant(char ret) {
        return (value) -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    char applyAsCharThrows(short value) throws X;
    ...
    default <A> ThrowableToCharFunction<A, X> compose(
        ...
        return (a) -> applyAsCharThrows(before.applyAsShortThrows(a));
    }
    ...
    default ThrowableBooleanToCharFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsCharThrows(before.applyAsShortThrows(value));
    }
    ...
    default ThrowableIntToCharFunction<X> composeFromInt(
            @Nonnull final ThrowableIntToShortFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsCharThrows(before.applyAsShortThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableShortToCharFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code short} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableShortToCharFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * short}.
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> andThenToBoolean(@Nonnull final ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> andThenToInt(@Nonnull final ThrowableCharToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> consume(@Nonnull final ThrowableCharConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsCharThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableShortToCharFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableShortToCharFunction}.
     ...
     */
    @Nonnull
    default ThrowableShortToCharFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            final Map<Short, Character> cache = new ConcurrentHashMap<>();
            final Object lock = new Object();
            return (ThrowableShortToCharFunction<X> & Memoized) (value) -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableShortToCharFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableShortToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableShortToCharFunction}.
     */
    @Nonnull
    default ThrowableFunction<Short, Character, X> boxed() {
        return this::applyAsCharThrows;
    }

    /**
     * Returns a composed {@link ShortToCharFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ShortToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ShortToCharFunction nest() {
     ...
     */
    @Nonnull
    default ShortToCharFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default ShortToCharFunction recover(
            @Nonnull final Function<? super Throwable, ? extends ShortToCharFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final ShortToCharFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ShortToCharFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ShortToCharFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ShortToCharFunction sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsCharThrows(value);
