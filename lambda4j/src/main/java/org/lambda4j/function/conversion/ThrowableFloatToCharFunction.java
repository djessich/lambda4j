...
public interface ThrowableFloatToCharFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableFloatToCharFunction<X> of(
            @Nullable ThrowableFloatToCharFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> char call(@Nonnull ThrowableFloatToCharFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableCharPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> andThenToInt(@Nonnull ThrowableCharToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> consume(@Nonnull ThrowableCharConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableFloatToCharFunction<X> reversed() {
        return this;
    }
     ...
     * {@code ThrowableFloatToCharFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link FloatToCharFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default FloatToCharFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default FloatToCharFunction recover(
            @Nonnull Function<? super Throwable, ? extends FloatToCharFunction> recover) {
        ...
        return value -> {
            try {
                ...
                FloatToCharFunction function = recover.apply(throwable);
