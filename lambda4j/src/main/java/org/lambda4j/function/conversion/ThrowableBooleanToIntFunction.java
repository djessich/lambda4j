...
public interface ThrowableBooleanToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBooleanToIntFunction<X> of(
            @Nullable ThrowableBooleanToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableBooleanToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default <A> ThrowableToIntFunction<A, X> compose(@Nonnull ThrowablePredicate<? super A, ? extends X> before) {
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> composeFromByte(@Nonnull ThrowableBytePredicate<? extends X> before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> composeFromChar(@Nonnull ThrowableCharPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsIntThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsIntThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> composeFromLong(@Nonnull ThrowableLongPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsIntThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableBooleanUnaryOperator<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBooleanToIntFunction<X> andThenToInt(@Nonnull ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableBooleanConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     * {@code ThrowableBooleanToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BooleanToIntFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BooleanToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BooleanToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends BooleanToIntFunction> recover) {
        ...
        return value -> {
            try {
                ...
                BooleanToIntFunction function = recover.apply(throwable);
