...
public interface ThrowableDoubleToByteFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableDoubleToByteFunction<X> of(
            @Nullable ThrowableDoubleToByteFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> byte call(@Nonnull ThrowableDoubleToByteFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleToIntFunction<X> andThenToInt(@Nonnull ThrowableByteToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleConsumer<X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToByteFunction<X> reversed() {
        return this;
    }
     ...
     * {@code ThrowableDoubleToByteFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link DoubleToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default DoubleToByteFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default DoubleToByteFunction recover(
            @Nonnull Function<? super Throwable, ? extends DoubleToByteFunction> recover) {
        ...
        return value -> {
            try {
                ...
                DoubleToByteFunction function = recover.apply(throwable);
