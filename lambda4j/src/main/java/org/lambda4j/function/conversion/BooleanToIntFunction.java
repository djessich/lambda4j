...
public interface BooleanToIntFunction extends Lambda {
     ...
     */
    static BooleanToIntFunction of(@Nullable final BooleanToIntFunction expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ToIntFunction2} that first applies the {@code before} predicate to its input, and
     ...
     */
    @Nonnull
    default <A> ToIntFunction2<A> compose(@Nonnull final Predicate<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToIntFunction composeFromBoolean(@Nonnull final BooleanUnaryOperator before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.applyAsBoolean(value));
    }

    /**
     * Returns a composed {@link ByteToIntFunction} that first applies the {@code before} predicate to
     ...
     */
    @Nonnull
    default ByteToIntFunction composeFromByte(@Nonnull final BytePredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.test(value));
    }

    /**
     * Returns a composed {@link CharToIntFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default CharToIntFunction composeFromChar(@Nonnull final CharPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.test(value));
    }
     ...
     */
    @Nonnull
    default DoubleToIntFunction2 composeFromDouble(@Nonnull final DoublePredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.test(value));
    }
     ...
     */
    @Nonnull
    default FloatToIntFunction composeFromFloat(@Nonnull final FloatPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.test(value));
    }

    /**
     * Returns a composed {@link IntUnaryOperator2} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default IntUnaryOperator2 composeFromInt(@Nonnull final IntPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.test(value));
    }

    /**
     * Returns a composed {@link LongToIntFunction2} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     * If evaluation of either operation throws an exception, it is relayed to the caller of the composed operation.
     ...
     */
    @Nonnull
    default LongToIntFunction2 composeFromLong(@Nonnull final LongPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.test(value));
    }
     ...
     */
    @Nonnull
    default ShortToIntFunction composeFromShort(@Nonnull final ShortPredicate before) {
        Objects.requireNonNull(before);
        return (value) -> applyAsInt(before.test(value));
    }
     ...
     */
    @Nonnull
    default <S> BooleanFunction<S> andThen(@Nonnull final IntFunction<? extends S> after) {
