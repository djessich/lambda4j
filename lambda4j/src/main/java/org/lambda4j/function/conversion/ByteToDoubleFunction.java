...
/**
 * Represents an operation that accepts one {@code byte}-valued input argument and produces a {@code double}-valued
...
public interface ByteToDoubleFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static ByteToDoubleFunction of(@Nullable ByteToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    static double call(@Nonnull ByteToDoubleFunction function, byte value) {
     ...
     */
    @Nonnull
    default <A> ToDoubleFunction2<A> compose(@Nonnull ToByteFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToDoubleFunction composeFromBoolean(@Nonnull BooleanToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }

    /**
     * Returns a composed {@link ByteToDoubleFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     ...
     */
    @Nonnull
    default ByteToDoubleFunction composeFromByte(@Nonnull ByteUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default CharToDoubleFunction composeFromChar(@Nonnull CharToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default DoubleUnaryOperator2 composeFromDouble(@Nonnull DoubleToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default FloatToDoubleFunction composeFromFloat(@Nonnull FloatToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default IntToDoubleFunction2 composeFromInt(@Nonnull IntToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 composeFromLong(@Nonnull LongToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default ShortToDoubleFunction composeFromShort(@Nonnull ShortToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default <S> ByteFunction<S> andThen(@Nonnull DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BytePredicate andThenToBoolean(@Nonnull DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteUnaryOperator andThenToByte(@Nonnull DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToCharFunction andThenToChar(@Nonnull DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToDoubleFunction andThenToDouble(@Nonnull DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToFloatFunction andThenToFloat(@Nonnull DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToIntFunction andThenToInt(@Nonnull DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToLongFunction andThenToLong(@Nonnull DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToShortFunction andThenToShort(@Nonnull DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteConsumer consume(@Nonnull DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default ByteToDoubleFunction reversed() {
        return this;
    }
    ...
    default ByteToDoubleFunction memoized() {
        if (isMemoized()) {
            ...
            Map<Byte, Double> cache = new ConcurrentHashMap<>();
     ...
     * ByteToDoubleFunction} with methods provided by the {@code JDK}.
     *
