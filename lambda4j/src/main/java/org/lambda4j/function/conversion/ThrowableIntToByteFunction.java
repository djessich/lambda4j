...
@FunctionalInterface
public interface ThrowableIntToByteFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableIntToByteFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableIntToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableIntToByteFunction<X> of(
            @Nullable ThrowableIntToByteFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableIntToByteFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableIntToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> byte call(@Nonnull ThrowableIntToByteFunction<? extends X> function,
            int value) throws X {
    ...
    /**
     * Creates a {@link ThrowableIntToByteFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableIntToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableIntToByteFunction<X> constant(byte ret) {
        return value -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(int value) throws X;
    ...
    default <A> ThrowableToByteFunction<A, X> compose(
        ...
        return a -> applyAsByteThrows(before.applyAsIntThrows(a));
    }
    ...
    default ThrowableBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyAsByteThrows(before.applyAsIntThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> composeFromInt(@Nonnull ThrowableIntUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsByteThrows(before.applyAsIntThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntPredicate<X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> andThenToByte(@Nonnull ThrowableByteUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToCharFunction<X> andThenToChar(@Nonnull ThrowableByteToCharFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> andThenToInt(@Nonnull ThrowableByteToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToLongFunction<X> andThenToLong(@Nonnull ThrowableByteToLongFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableIntToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableIntToByteFunction}.
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Integer, Byte> cache = new ConcurrentHashMap<>();
            return (ThrowableIntToByteFunction<X> & Memoized) value -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableIntToByteFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableIntToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableIntToByteFunction}.
     */
    @Nonnull
    default ThrowableFunction<Integer, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link IntToByteFunction} that applies this function to its input and nests the thrown {@link
     ...
     */
    @Nonnull
    default IntToByteFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default IntToByteFunction recover(@Nonnull Function<? super Throwable, ? extends IntToByteFunction> recover) {
        ...
        return value -> {
            try {
                ...
                IntToByteFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link IntToByteFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link IntToByteFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default IntToByteFunction sneakyThrow() {
        return value -> {
            try {
                return applyAsByteThrows(value);
