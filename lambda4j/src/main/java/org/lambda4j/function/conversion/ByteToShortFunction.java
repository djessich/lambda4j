...
public interface ByteToShortFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static ByteToShortFunction of(@Nullable ByteToShortFunction expression) {
        return expression;
    }
     ...
     */
    static short call(@Nonnull ByteToShortFunction function, byte value) {
     ...
     */
    @Nonnull
    default <A> ToShortFunction<A> compose(@Nonnull ToByteFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToShortFunction composeFromBoolean(@Nonnull BooleanToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }

    /**
     * Returns a composed {@link ByteToShortFunction} that first applies the {@code before} operator to its input, and
     ...
     */
    @Nonnull
    default ByteToShortFunction composeFromByte(@Nonnull ByteUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default CharToShortFunction composeFromChar(@Nonnull CharToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default DoubleToShortFunction composeFromDouble(@Nonnull DoubleToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default FloatToShortFunction composeFromFloat(@Nonnull FloatToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default IntToShortFunction composeFromInt(@Nonnull IntToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default LongToShortFunction composeFromLong(@Nonnull LongToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default ShortUnaryOperator composeFromShort(@Nonnull ShortToByteFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsShort(before.applyAsByte(value));
    }
     ...
     */
    @Nonnull
    default <S> ByteFunction<S> andThen(@Nonnull ShortFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BytePredicate andThenToBoolean(@Nonnull ShortPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteUnaryOperator andThenToByte(@Nonnull ShortToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToCharFunction andThenToChar(@Nonnull ShortToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToDoubleFunction andThenToDouble(@Nonnull ShortToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToFloatFunction andThenToFloat(@Nonnull ShortToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToIntFunction andThenToInt(@Nonnull ShortToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToLongFunction andThenToLong(@Nonnull ShortToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteToShortFunction andThenToShort(@Nonnull ShortUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ByteConsumer consume(@Nonnull ShortConsumer consumer) {
     ...
     */
    @Nonnull
    default ByteToShortFunction reversed() {
        return this;
    }
     ...
     * ByteToShortFunction} with methods provided by the {@code JDK}.
     *
