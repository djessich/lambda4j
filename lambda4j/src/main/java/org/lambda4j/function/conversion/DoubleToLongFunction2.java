...
public interface DoubleToLongFunction2 extends Lambda, DoubleToLongFunction {
    ...
    @CheckForNull
    @Nullable
    static DoubleToLongFunction2 of(@Nullable DoubleToLongFunction2 expression) {
        return expression;
    }
     ...
     */
    static long call(@Nonnull DoubleToLongFunction function, double value) {
     ...
     */
    @Nonnull
    default <A> ToLongFunction2<A> compose(@Nonnull ToDoubleFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToLongFunction composeFromBoolean(@Nonnull BooleanToDoubleFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToLongFunction composeFromByte(@Nonnull ByteToDoubleFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default CharToLongFunction composeFromChar(@Nonnull CharToDoubleFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 composeFromDouble(@Nonnull DoubleUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default FloatToLongFunction composeFromFloat(@Nonnull FloatToDoubleFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default IntToLongFunction2 composeFromInt(@Nonnull IntToDoubleFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default LongUnaryOperator2 composeFromLong(@Nonnull LongToDoubleFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default ShortToLongFunction composeFromShort(@Nonnull ShortToDoubleFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsDouble(value));
    }
     ...
     */
    @Nonnull
    default <S> DoubleFunction2<S> andThen(@Nonnull LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default DoublePredicate2 andThenToBoolean(@Nonnull LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToByteFunction andThenToByte(@Nonnull LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToCharFunction andThenToChar(@Nonnull LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleUnaryOperator2 andThenToDouble(@Nonnull LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToFloatFunction andThenToFloat(@Nonnull LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToIntFunction2 andThenToInt(@Nonnull LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 andThenToLong(@Nonnull LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleToShortFunction andThenToShort(@Nonnull LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default DoubleConsumer2 consume(@Nonnull LongConsumer consumer) {
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 reversed() {
        return this;
    }
    ...
    /**
     * Returns a composed {@link Function2} which represents this {@link DoubleToLongFunction2}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * DoubleToLongFunction2} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code Function2} which represents this {@code DoubleToLongFunction2}.
     */
    @Nonnull
