...
/**
 * Represents an operation that accepts one {@code short}-valued input argument and produces a {@code int}-valued
...
public interface ShortToIntFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static ShortToIntFunction of(@Nullable ShortToIntFunction expression) {
        return expression;
    }
     ...
     */
    static int call(@Nonnull ShortToIntFunction function, short value) {
     ...
     */
    @Nonnull
    default <A> ToIntFunction2<A> compose(@Nonnull ToShortFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToIntFunction composeFromBoolean(@Nonnull BooleanToShortFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToIntFunction composeFromByte(@Nonnull ByteToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default CharToIntFunction composeFromChar(@Nonnull CharToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default DoubleToIntFunction2 composeFromDouble(@Nonnull DoubleToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default FloatToIntFunction composeFromFloat(@Nonnull FloatToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default IntUnaryOperator2 composeFromInt(@Nonnull IntToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default LongToIntFunction2 composeFromLong(@Nonnull LongToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default ShortToIntFunction composeFromShort(@Nonnull ShortUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default <S> ShortFunction<S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ShortPredicate andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToByteFunction andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToCharFunction andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToDoubleFunction andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToFloatFunction andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToIntFunction andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToLongFunction andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortUnaryOperator andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortConsumer consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default ShortToIntFunction reversed() {
        return this;
    }
     ...
     * ShortToIntFunction} with methods provided by the {@code JDK}.
     *
