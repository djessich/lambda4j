...
public interface ThrowableFloatToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableFloatToIntFunction<X> of(
            @Nullable ThrowableFloatToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableFloatToIntFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> andThenToInt(@Nonnull ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> reversed() {
        return this;
    }
     ...
     * {@code ThrowableFloatToIntFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link FloatToIntFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default FloatToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default FloatToIntFunction recover(
            @Nonnull Function<? super Throwable, ? extends FloatToIntFunction> recover) {
        ...
        return value -> {
            try {
                ...
                FloatToIntFunction function = recover.apply(throwable);
