...
/**
 * Represents an operation that accepts one {@code float}-valued input argument and produces a {@code int}-valued
...
@FunctionalInterface
public interface FloatToIntFunction extends Lambda {

    /**
     * Constructs a {@link FloatToIntFunction} based on a lambda expression or a method reference. Thereby the given
     * lambda expression or method reference is returned on an as-is basis to implicitly transform it to the desired
     * type. With this method, it is possible to ensure that correct type is used from lambda expression or method
     * reference.
     *
     * @param expression A lambda expression or (typically) a method reference, e.g. {@code this::method}
     * @return A {@code FloatToIntFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static FloatToIntFunction of(@Nullable FloatToIntFunction expression) {
        return expression;
    }

    /**
     * Calls the given {@link FloatToIntFunction} with the given argument and returns its result.
     *
     ...
     */
    static int call(@Nonnull FloatToIntFunction function, float value) {
     ...
     */
    @Nonnull
    default <A> ToIntFunction2<A> compose(@Nonnull ToFloatFunction<? super A> before) {
        Objects.requireNonNull(before);
        return a -> applyAsInt(before.applyAsFloat(a));
    }
     ...
     */
    @Nonnull
    default BooleanToIntFunction composeFromBoolean(@Nonnull BooleanToFloatFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToIntFunction composeFromByte(@Nonnull ByteToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default CharToIntFunction composeFromChar(@Nonnull CharToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default DoubleToIntFunction2 composeFromDouble(@Nonnull DoubleToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsFloat(value));
    }

    /**
     * Returns a composed {@link FloatToIntFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     * operation which accepts {@code float} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code FloatToIntFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     */
    @Nonnull
    default FloatToIntFunction composeFromFloat(@Nonnull FloatUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default IntUnaryOperator2 composeFromInt(@Nonnull IntToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default LongToIntFunction2 composeFromLong(@Nonnull LongToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default ShortToIntFunction composeFromShort(@Nonnull ShortToFloatFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsInt(before.applyAsFloat(value));
    }
     ...
     */
    @Nonnull
    default <S> FloatFunction<S> andThen(@Nonnull IntFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default FloatPredicate andThenToBoolean(@Nonnull IntPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatToByteFunction andThenToByte(@Nonnull IntToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatToCharFunction andThenToChar(@Nonnull IntToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatToDoubleFunction andThenToDouble(@Nonnull IntToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatUnaryOperator andThenToFloat(@Nonnull IntToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatToIntFunction andThenToInt(@Nonnull IntUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatToLongFunction andThenToLong(@Nonnull IntToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatToShortFunction andThenToShort(@Nonnull IntToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default FloatConsumer consume(@Nonnull IntConsumer consumer) {
     ...
     */
    @Nonnull
    default FloatToIntFunction reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link FloatToIntFunction}. Whenever it is called, the mapping
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code FloatToIntFunction}.
     ...
     */
    @Nonnull
    default FloatToIntFunction memoized() {
        if (isMemoized()) {
            return this;
        } else {
    ...
    /**
     * Returns a composed {@link Function2} which represents this {@link FloatToIntFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * FloatToIntFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code Function2} which represents this {@code FloatToIntFunction}.
     */
    @Nonnull
    default Function2<Float, Integer> boxed() {
