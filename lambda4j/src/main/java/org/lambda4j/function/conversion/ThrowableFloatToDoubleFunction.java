...
public interface ThrowableFloatToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableFloatToDoubleFunction<X> of(
            @Nullable ThrowableFloatToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull ThrowableFloatToDoubleFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableDoublePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableFloatToDoubleFunction<X> reversed() {
        return this;
    }
     ...
     * this {@code ThrowableFloatToDoubleFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link FloatToDoubleFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default FloatToDoubleFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default FloatToDoubleFunction recover(
            @Nonnull Function<? super Throwable, ? extends FloatToDoubleFunction> recover) {
        ...
        return value -> {
            try {
                ...
                FloatToDoubleFunction function = recover.apply(throwable);
