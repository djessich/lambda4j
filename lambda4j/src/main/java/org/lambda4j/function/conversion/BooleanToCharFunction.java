...
public interface BooleanToCharFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static BooleanToCharFunction of(@Nullable BooleanToCharFunction expression) {
        return expression;
    }
     ...
     */
    static char call(@Nonnull BooleanToCharFunction function, boolean value) {
     ...
     */
    @Nonnull
    default <A> ToCharFunction<A> compose(@Nonnull Predicate<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToCharFunction composeFromBoolean(@Nonnull BooleanUnaryOperator before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToCharFunction composeFromByte(@Nonnull BytePredicate before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default CharUnaryOperator composeFromChar(@Nonnull CharPredicate before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.test(value));
    }
     ...
     */
    @Nonnull
    default DoubleToCharFunction composeFromDouble(@Nonnull DoublePredicate before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.test(value));
    }
     ...
     */
    @Nonnull
    default FloatToCharFunction composeFromFloat(@Nonnull FloatPredicate before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.test(value));
    }
     ...
     */
    @Nonnull
    default IntToCharFunction composeFromInt(@Nonnull IntPredicate before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.test(value));
    }
     ...
     */
    @Nonnull
    default LongToCharFunction composeFromLong(@Nonnull LongPredicate before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.test(value));
    }
     ...
     */
    @Nonnull
    default ShortToCharFunction composeFromShort(@Nonnull ShortPredicate before) {
        Objects.requireNonNull(before);
        return value -> applyAsChar(before.test(value));
    }
     ...
     */
    @Nonnull
    default <S> BooleanFunction<S> andThen(@Nonnull CharFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default BooleanUnaryOperator andThenToBoolean(@Nonnull CharPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanToByteFunction andThenToByte(@Nonnull CharToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanToCharFunction andThenToChar(@Nonnull CharUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanToDoubleFunction andThenToDouble(@Nonnull CharToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanToFloatFunction andThenToFloat(@Nonnull CharToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanToIntFunction andThenToInt(@Nonnull CharToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanToLongFunction andThenToLong(@Nonnull CharToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanToShortFunction andThenToShort(@Nonnull CharToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default BooleanConsumer consume(@Nonnull CharConsumer consumer) {
     ...
     */
    @Nonnull
    default BooleanToCharFunction reversed() {
        return this;
    }
    ...
    /**
     * Returns a composed {@link Function2} which represents this {@link BooleanToCharFunction}. Thereby the primitive
     * input argument for this function is autoboxed. This method provides the possibility to use this {@code
     * BooleanToCharFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code Function2} which represents this {@code BooleanToCharFunction}.
     */
    @Nonnull
