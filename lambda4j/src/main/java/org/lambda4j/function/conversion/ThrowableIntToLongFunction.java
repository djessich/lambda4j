...
/**
 * Represents an operation that accepts one {@code int}-valued input argument and produces a {@code long}-valued result
...
public interface ThrowableIntToLongFunction<X extends Throwable> extends Lambda, IntToLongFunction {
    ...
    static <X extends Throwable> ThrowableIntToLongFunction<X> of(
            @Nullable ThrowableIntToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull ThrowableIntToLongFunction<? extends X> function,
            int value) throws X {
    ...
    /**
     * Returns a composed {@link ThrowableIntToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableIntToLongFunction<X> composeFromInt(@Nonnull ThrowableIntUnaryOperator<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsLongThrows(before.applyAsIntThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntPredicate<X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToByteFunction<X> andThenToByte(@Nonnull ThrowableLongToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToCharFunction<X> andThenToChar(@Nonnull ThrowableLongToCharFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> andThenToInt(@Nonnull ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntToLongFunction<X> andThenToLong(@Nonnull ThrowableLongUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableIntConsumer<X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableIntToLongFunction<X> reversed() {
        return this;
    }
     ...
     */
    @Nonnull
    default IntToLongFunction2 nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default IntToLongFunction2 recover(
            @Nonnull Function<? super Throwable, ? extends IntToLongFunction> recover) {
        ...
        return value -> {
            try {
                ...
                IntToLongFunction function = recover.apply(throwable);
