...
/**
 * Represents an operation that accepts one {@code long}-valued input argument and produces a {@code byte}-valued
...
public interface LongToByteFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static LongToByteFunction of(@Nullable LongToByteFunction expression) {
        return expression;
    }
     ...
     */
    static byte call(@Nonnull LongToByteFunction function, long value) {
     ...
     */
    @Nonnull
    default <A> ToByteFunction<A> compose(@Nonnull ToLongFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToByteFunction composeFromBoolean(@Nonnull BooleanToLongFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteUnaryOperator composeFromByte(@Nonnull ByteToLongFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default CharToByteFunction composeFromChar(@Nonnull CharToLongFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default DoubleToByteFunction composeFromDouble(@Nonnull DoubleToLongFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default FloatToByteFunction composeFromFloat(@Nonnull FloatToLongFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default IntToByteFunction composeFromInt(@Nonnull IntToLongFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsLong(value));
    }

    /**
     * Returns a composed {@link LongToByteFunction} that first applies the {@code before} operator to its input, and
     * then applies this function to the result. If evaluation of either operation throws an exception, it is relayed to
     * the caller of the composed operation. This method is just convenience, to provide the ability to execute an
     ...
     */
    @Nonnull
    default LongToByteFunction composeFromLong(@Nonnull LongUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default ShortToByteFunction composeFromShort(@Nonnull ShortToLongFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsByte(before.applyAsLong(value));
    }
     ...
     */
    @Nonnull
    default <S> LongFunction2<S> andThen(@Nonnull ByteFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default LongPredicate2 andThenToBoolean(@Nonnull BytePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToByteFunction andThenToByte(@Nonnull ByteUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToCharFunction andThenToChar(@Nonnull ByteToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 andThenToDouble(@Nonnull ByteToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToFloatFunction andThenToFloat(@Nonnull ByteToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToIntFunction2 andThenToInt(@Nonnull ByteToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongUnaryOperator2 andThenToLong(@Nonnull ByteToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongToShortFunction andThenToShort(@Nonnull ByteToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default LongConsumer2 consume(@Nonnull ByteConsumer consumer) {
     ...
     */
    @Nonnull
    default LongToByteFunction reversed() {
        return this;
    }
     ...
     * LongToByteFunction} with methods provided by the {@code JDK}.
     *
