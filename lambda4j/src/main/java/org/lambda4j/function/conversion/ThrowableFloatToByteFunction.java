...
/**
 * Represents an operation that accepts one {@code float}-valued input argument and produces a {@code byte}-valued
 * result which is able to throw any {@link Throwable}. This is a primitive specialization of {@link
 * ThrowableFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsByteThrows(float)}.
 *
...
@FunctionalInterface
public interface ThrowableFloatToByteFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableFloatToByteFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableFloatToByteFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableFloatToByteFunction<X> of(
            @Nullable ThrowableFloatToByteFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableFloatToByteFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableFloatToByteFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> byte call(@Nonnull ThrowableFloatToByteFunction<? extends X> function,
    ...
    /**
     * Creates a {@link ThrowableFloatToByteFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableFloatToByteFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableFloatToByteFunction<X> constant(byte ret) {
        return value -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    byte applyAsByteThrows(float value) throws X;
    ...
    default <A> ThrowableToByteFunction<A, X> compose(
        ...
        return a -> applyAsByteThrows(before.applyAsFloatThrows(a));
    }
    ...
    default ThrowableBooleanToByteFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyAsByteThrows(before.applyAsFloatThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableFloatToByteFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code float} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableFloatToByteFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * float}.
     ...
     */
    @Nonnull
    default ThrowableFloatPredicate<X> andThenToBoolean(@Nonnull ThrowableBytePredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatToIntFunction<X> andThenToInt(@Nonnull ThrowableByteToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableFloatConsumer<X> consume(@Nonnull ThrowableByteConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableFloatToByteFunction<X> reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableFloatToByteFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableFloatToByteFunction}.
    ...
    default ThrowableFloatToByteFunction<X> memoized() {
        if (isMemoized()) {
            ...
            Map<Float, Byte> cache = new ConcurrentHashMap<>();
            return (ThrowableFloatToByteFunction<X> & Memoized) value -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableFloatToByteFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableFloatToByteFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableFloatToByteFunction}.
     */
    @Nonnull
    default ThrowableFunction<Float, Byte, X> boxed() {
        return this::applyAsByteThrows;
    }

    /**
     * Returns a composed {@link FloatToByteFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link FloatToByteFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default FloatToByteFunction nest() {
     ...
     */
    @Nonnull
    default FloatToByteFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default FloatToByteFunction recover(
            @Nonnull Function<? super Throwable, ? extends FloatToByteFunction> recover) {
        ...
        return value -> {
            try {
                ...
                FloatToByteFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link FloatToByteFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link FloatToByteFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default FloatToByteFunction sneakyThrow() {
        return value -> {
            try {
                return applyAsByteThrows(value);
