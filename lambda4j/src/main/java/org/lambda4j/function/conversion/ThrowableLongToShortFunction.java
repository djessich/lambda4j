 ...
 * ThrowableFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(long)}.
 *
...
@FunctionalInterface
public interface ThrowableLongToShortFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableLongToShortFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableLongToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableLongToShortFunction<X> of(
            @Nullable ThrowableLongToShortFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableLongToShortFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableLongToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> short call(@Nonnull ThrowableLongToShortFunction<? extends X> function,
            long value) throws X {
    ...
    /**
     * Creates a {@link ThrowableLongToShortFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableLongToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableLongToShortFunction<X> constant(short ret) {
        return value -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(long value) throws X;
    ...
    default <A> ThrowableToShortFunction<A, X> compose(
        ...
        return a -> applyAsShortThrows(before.applyAsLongThrows(a));
    }
    ...
    default ThrowableBooleanToShortFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyAsShortThrows(before.applyAsLongThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableLongToShortFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code long} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableLongToShortFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * long}.
     ...
     */
    @Nonnull
    default ThrowableLongPredicate<X> andThenToBoolean(@Nonnull ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongToIntFunction<X> andThenToInt(@Nonnull ThrowableShortToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableLongConsumer<X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableLongToShortFunction<X> reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableLongToShortFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableLongToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableLongToShortFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableLongToShortFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableLongToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableLongToShortFunction}.
     */
    @Nonnull
    default ThrowableFunction<Long, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link LongToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link LongToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default LongToShortFunction nest() {
     ...
     * @return A composed {@link LongToShortFunction} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default LongToShortFunction recover(
            @Nonnull Function<? super Throwable, ? extends LongToShortFunction> recover) {
        ...
        return value -> {
            try {
                ...
                LongToShortFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link LongToShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link LongToShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default LongToShortFunction sneakyThrow() {
        return value -> {
            try {
                return applyAsShortThrows(value);
