...
/**
 * Represents an operation that accepts one {@code short}-valued input argument and produces a {@code long}-valued
...
public interface ThrowableShortToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableShortToLongFunction<X> of(
            @Nullable ThrowableShortToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull ThrowableShortToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableShortPredicate<X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortToIntFunction<X> andThenToInt(@Nonnull ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableShortConsumer<X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableShortToLongFunction<X> reversed() {
        return this;
    }
    ...
    default ThrowableShortToLongFunction<X> memoized() {
        if (isMemoized()) {
            ...
            Map<Short, Long> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ShortToLongFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ShortToLongFunction recover(
            @Nonnull Function<? super Throwable, ? extends ShortToLongFunction> recover) {
        ...
        return value -> {
            try {
                ...
                ShortToLongFunction function = recover.apply(throwable);
