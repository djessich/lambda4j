...
/**
 * Represents an operation that accepts one {@code byte}-valued input argument and produces a {@code short}-valued
 * result which is able to throw any {@link Throwable}. This is a primitive specialization of {@link
 * ThrowableFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsShortThrows(byte)}.
 *
...
@FunctionalInterface
public interface ThrowableByteToShortFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableByteToShortFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableByteToShortFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableByteToShortFunction<X> of(
            @Nullable ThrowableByteToShortFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableByteToShortFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableByteToShortFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> short call(@Nonnull ThrowableByteToShortFunction<? extends X> function,
            byte value) throws X {
    ...
    /**
     * Creates a {@link ThrowableByteToShortFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableByteToShortFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableByteToShortFunction<X> constant(short ret) {
        return value -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    short applyAsShortThrows(byte value) throws X;
    ...
    default <A> ThrowableToShortFunction<A, X> compose(
        ...
        return a -> applyAsShortThrows(before.applyAsByteThrows(a));
    }
    ...
    default ThrowableBooleanToShortFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyAsShortThrows(before.applyAsByteThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableByteToShortFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code byte} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableByteToShortFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * byte}.
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> andThenToBoolean(@Nonnull ThrowableShortPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> andThenToInt(@Nonnull ThrowableShortToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> consume(@Nonnull ThrowableShortConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableByteToShortFunction<X> reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableByteToShortFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableByteToShortFunction}.
     ...
     */
    @Nonnull
    default ThrowableByteToShortFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Byte, Short> cache = new ConcurrentHashMap<>();
            Object lock = new Object();
            return (ThrowableByteToShortFunction<X> & Memoized) value -> {
                short returnValue;
                synchronized (lock) {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableByteToShortFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableByteToShortFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableByteToShortFunction}.
     */
    @Nonnull
    default ThrowableFunction<Byte, Short, X> boxed() {
        return this::applyAsShortThrows;
    }

    /**
     * Returns a composed {@link ByteToShortFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link ByteToShortFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default ByteToShortFunction nest() {
     ...
     */
    @Nonnull
    default ByteToShortFunction recover(
            @Nonnull Function<? super Throwable, ? extends ByteToShortFunction> recover) {
        ...
        return value -> {
            try {
                ...
                ByteToShortFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link ByteToShortFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link ByteToShortFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default ByteToShortFunction sneakyThrow() {
        return value -> {
            try {
                return applyAsShortThrows(value);
