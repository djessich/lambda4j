...
/**
 * Represents an operation that accepts one {@code char}-valued input argument and produces a {@code long}-valued result
 * which is able to throw any {@link Throwable}. This is a primitive specialization of {@link ThrowableFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(char)}.
 *
...
@FunctionalInterface
public interface ThrowableCharToLongFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableCharToLongFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableCharToLongFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableCharToLongFunction<X> of(
            @Nullable ThrowableCharToLongFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableCharToLongFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableCharToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> long call(@Nonnull ThrowableCharToLongFunction<? extends X> function,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableCharToLongFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableCharToLongFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableCharToLongFunction<X> constant(long ret) {
        return value -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    long applyAsLongThrows(char value) throws X;
    ...
    default <A> ThrowableToLongFunction<A, X> compose(
        ...
        return a -> applyAsLongThrows(before.applyAsCharThrows(a));
    }
    ...
    default ThrowableBooleanToLongFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyAsLongThrows(before.applyAsCharThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableCharToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code char} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableCharToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * char}.
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharUnaryOperator<X> andThenToChar(@Nonnull ThrowableLongToCharFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> andThenToInt(@Nonnull ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> andThenToLong(@Nonnull ThrowableLongUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableCharToLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableCharToLongFunction}.
     ...
     */
    @Nonnull
    default ThrowableCharToLongFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Character, Long> cache = new ConcurrentHashMap<>();
            return (ThrowableCharToLongFunction<X> & Memoized) value -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableCharToLongFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableCharToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableCharToLongFunction}.
     */
    @Nonnull
    default ThrowableFunction<Character, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link CharToLongFunction} that applies this function to its input and nests the thrown {@link
     * Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link ThrownByFunctionalInterfaceException},
     * which is constructed from the thrown {@code Throwable}s message and the thrown {@code Throwable} itself.
     *
     * @return A composed {@link CharToLongFunction} that applies this function to its input and nests the thrown {@code
     * Throwable} from it.
     ...
     */
    @Nonnull
    default CharToLongFunction nest() {
     ...
     */
    @Nonnull
    default CharToLongFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default CharToLongFunction recover(
            @Nonnull Function<? super Throwable, ? extends CharToLongFunction> recover) {
        ...
        return value -> {
            try {
                ...
                CharToLongFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link CharToLongFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link CharToLongFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default CharToLongFunction sneakyThrow() {
        return value -> {
            try {
                return applyAsLongThrows(value);
