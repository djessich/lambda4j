...
public interface ThrowableBooleanToFloatFunction<X extends Throwable> extends Lambda {
    ...
    /**
     * Returns a composed {@link ThrowableByteToFloatFunction} that first applies the {@code before} predicate to
    ...
    /**
     * Returns a composed {@link ThrowableCharToFloatFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
    ...
    /**
     * Returns a composed {@link ThrowableIntToFloatFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
    ...
    /**
     * Returns a composed {@link ThrowableLongToFloatFunction} that first applies the {@code before} predicate to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default BooleanToFloatFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default BooleanToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends BooleanToFloatFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final BooleanToFloatFunction function = recover.apply(throwable);
