...
public interface ThrowableBooleanToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBooleanToFloatFunction<X> of(
            @Nullable ThrowableBooleanToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull ThrowableBooleanToFloatFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableByteToFloatFunction<X> composeFromByte(@Nonnull ThrowableBytePredicate<? extends X> before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ThrowableCharToFloatFunction<X> composeFromChar(@Nonnull ThrowableCharPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsFloatThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableIntToFloatFunction<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsFloatThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableLongToFloatFunction<X> composeFromLong(@Nonnull ThrowableLongPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsFloatThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableBooleanConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableBooleanToFloatFunction<X> reversed() {
        return this;
    }
     ...
     * this {@code ThrowableBooleanToFloatFunction} with methods provided by the {@code JDK}.
     *
     ...
     *
     * @return A composed {@link BooleanToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default BooleanToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends BooleanToFloatFunction> recover) {
        ...
        return value -> {
            try {
                ...
                BooleanToFloatFunction function = recover.apply(throwable);
