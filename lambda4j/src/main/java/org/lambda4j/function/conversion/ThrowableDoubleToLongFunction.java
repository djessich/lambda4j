 ...
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsLongThrows(double)}.
 *
...
@FunctionalInterface
public interface ThrowableDoubleToLongFunction<X extends Throwable> extends Lambda, DoubleToLongFunction {

    /**
     * Constructs a {@link ThrowableDoubleToLongFunction} based on a lambda expression or a method reference. Thereby
     ...
     * @return A {@code ThrowableDoubleToLongFunction} from given lambda expression or method reference.
     ...
     */
    static <X extends Throwable> ThrowableDoubleToLongFunction<X> of(
            @Nullable final ThrowableDoubleToLongFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableDoubleToLongFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableDoubleToLongFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> long call(@Nonnull final ThrowableDoubleToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    static <X extends Throwable> ThrowableDoubleToLongFunction<X> constant(long ret) {
        return (value) -> ret;
    }
     ...
     * @param value The argument to the function
     * @return The return value from the function, which is its result.
     * @apiNote This method mainly exists to use this {@link ThrowableDoubleToLongFunction} in JRE specific methods only
     * accepting {@link DoubleToLongFunction}. If this function should be applied, then the {@link
     * #applyAsLongThrows(double)} method should be used.
     * @apiNote Overrides the {@link DoubleToLongFunction#applyAsLong(double)} method by using a redefinition as default
     * method. This implementation calls the {@link #applyAsLongThrows(double)} method of this function and catches the
    ...
    default <A> ThrowableToLongFunction<A, X> compose(
        ...
        return (a) -> applyAsLongThrows(before.applyAsDoubleThrows(a));
    }
    ...
    default ThrowableBooleanToLongFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return (value) -> applyAsLongThrows(before.applyAsDoubleThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableDoubleToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code double} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableDoubleToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is a able to handle primitive values. In this case this is {@code
     * double}.
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> andThenToBoolean(@Nonnull final ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleToIntFunction<X> andThenToInt(@Nonnull final ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleConsumer<X> consume(@Nonnull final ThrowableLongConsumer<? extends X> consumer) {
        Objects.requireNonNull(consumer);
        return (value) -> consumer.acceptThrows(applyAsLongThrows(value));
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableDoubleToLongFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableDoubleToLongFunction}.
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableDoubleToLongFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableDoubleToLongFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableDoubleToLongFunction}.
     */
    @Nonnull
    default ThrowableFunction<Double, Long, X> boxed() {
        return this::applyAsLongThrows;
    }

    /**
     * Returns a composed {@link DoubleToLongFunction2} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link DoubleToLongFunction2} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 nest() {
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     * @return A composed {@link DoubleToLongFunction2} that first applies this function to its input, and then applies
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 recover(
            @Nonnull final Function<? super Throwable, ? extends DoubleToLongFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final DoubleToLongFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link DoubleToLongFunction2} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link DoubleToLongFunction2} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default DoubleToLongFunction2 sneakyThrow() {
        return (value) -> {
            try {
                return this.applyAsLongThrows(value);
            } catch (RuntimeException | Error e) {
