...
public interface ThrowableDoubleToLongFunction<X extends Throwable> extends Lambda, DoubleToLongFunction {
    ...
    static <X extends Throwable> ThrowableDoubleToLongFunction<X> of(
            @Nullable ThrowableDoubleToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull ThrowableDoubleToLongFunction<? extends X> function,
     ...
     */
    @Nonnull
    default ThrowableDoublePredicate<X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleToIntFunction<X> andThenToInt(@Nonnull ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableDoubleConsumer<X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableDoubleToLongFunction<X> reversed() {
        return this;
    }
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default DoubleToLongFunction2 recover(
            @Nonnull Function<? super Throwable, ? extends DoubleToLongFunction> recover) {
        ...
        return value -> {
            try {
                ...
                DoubleToLongFunction function = recover.apply(throwable);
