...
/**
 * Represents an operation that accepts one {@code byte}-valued input argument and produces a {@code long}-valued result
...
public interface ThrowableByteToLongFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableByteToLongFunction<X> of(
            @Nullable ThrowableByteToLongFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> long call(@Nonnull ThrowableByteToLongFunction<? extends X> function,
            byte value) throws X {
    ...
    /**
     * Returns a composed {@link ThrowableByteToLongFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> andThenToBoolean(@Nonnull ThrowableLongPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteUnaryOperator<X> andThenToByte(@Nonnull ThrowableLongToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> andThenToInt(@Nonnull ThrowableLongToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> andThenToLong(@Nonnull ThrowableLongUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> consume(@Nonnull ThrowableLongConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> reversed() {
        return this;
    }
    ...
    default ThrowableByteToLongFunction<X> memoized() {
        if (isMemoized()) {
            ...
            Map<Byte, Long> cache = new ConcurrentHashMap<>();
     ...
     */
    @Nonnull
    default ByteToLongFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default ByteToLongFunction recover(
            @Nonnull Function<? super Throwable, ? extends ByteToLongFunction> recover) {
        ...
        return value -> {
            try {
                ...
                ByteToLongFunction function = recover.apply(throwable);
