...
public interface ShortToLongFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static ShortToLongFunction of(@Nullable ShortToLongFunction expression) {
        return expression;
    }
     ...
     */
    static long call(@Nonnull ShortToLongFunction function, short value) {
     ...
     */
    @Nonnull
    default <A> ToLongFunction2<A> compose(@Nonnull ToShortFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToLongFunction composeFromBoolean(@Nonnull BooleanToShortFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToLongFunction composeFromByte(@Nonnull ByteToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default CharToLongFunction composeFromChar(@Nonnull CharToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default DoubleToLongFunction2 composeFromDouble(@Nonnull DoubleToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default FloatToLongFunction composeFromFloat(@Nonnull FloatToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default IntToLongFunction2 composeFromInt(@Nonnull IntToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default LongUnaryOperator2 composeFromLong(@Nonnull LongToShortFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default ShortToLongFunction composeFromShort(@Nonnull ShortUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsLong(before.applyAsShort(value));
    }
     ...
     */
    @Nonnull
    default <S> ShortFunction<S> andThen(@Nonnull LongFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default ShortPredicate andThenToBoolean(@Nonnull LongPredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToByteFunction andThenToByte(@Nonnull LongToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToCharFunction andThenToChar(@Nonnull LongToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToDoubleFunction andThenToDouble(@Nonnull LongToDoubleFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToFloatFunction andThenToFloat(@Nonnull LongToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToIntFunction andThenToInt(@Nonnull LongToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortToLongFunction andThenToLong(@Nonnull LongUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortUnaryOperator andThenToShort(@Nonnull LongToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ShortConsumer consume(@Nonnull LongConsumer consumer) {
     ...
     */
    @Nonnull
    default ShortToLongFunction reversed() {
        return this;
    }
     ...
     * ShortToLongFunction} with methods provided by the {@code JDK}.
     *
