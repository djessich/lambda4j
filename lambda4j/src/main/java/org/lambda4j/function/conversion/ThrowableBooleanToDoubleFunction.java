...
public interface ThrowableBooleanToDoubleFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableBooleanToDoubleFunction<X> of(
            @Nullable ThrowableBooleanToDoubleFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> double call(@Nonnull ThrowableBooleanToDoubleFunction<? extends X> function,
    ...
    /**
     * Returns a composed {@link ThrowableByteToDoubleFunction} that first applies the {@code before} predicate to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
    ...
    default ThrowableByteToDoubleFunction<X> composeFromByte(
            @Nonnull ThrowableBytePredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsDoubleThrows(before.testThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableCharToDoubleFunction} that first applies the {@code before} predicate to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
    ...
    default ThrowableCharToDoubleFunction<X> composeFromChar(
            @Nonnull ThrowableCharPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsDoubleThrows(before.testThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableIntToDoubleFunction} that first applies the {@code before} predicate to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableIntToDoubleFunction<X> composeFromInt(@Nonnull ThrowableIntPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsDoubleThrows(before.testThrows(value));
    }

    /**
     * Returns a composed {@link ThrowableLongToDoubleFunction} that first applies the {@code before} predicate to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
    ...
    default ThrowableLongToDoubleFunction<X> composeFromLong(
            @Nonnull ThrowableLongPredicate<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsDoubleThrows(before.testThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableBooleanConsumer<X> consume(@Nonnull ThrowableDoubleConsumer<? extends X> consumer) {
    ...
    default BooleanToDoubleFunction recover(
            @Nonnull Function<? super Throwable, ? extends BooleanToDoubleFunction> recover) {
        ...
        return value -> {
            try {
                ...
                BooleanToDoubleFunction function = recover.apply(throwable);
