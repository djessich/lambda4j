...
public interface CharToDoubleFunction extends Lambda {
    ...
    @CheckForNull
    @Nullable
    static CharToDoubleFunction of(@Nullable CharToDoubleFunction expression) {
        return expression;
    }
     ...
     */
    static double call(@Nonnull CharToDoubleFunction function, char value) {
     ...
     */
    @Nonnull
    default <A> ToDoubleFunction2<A> compose(@Nonnull ToCharFunction<? super A> before) {
     ...
     */
    @Nonnull
    default BooleanToDoubleFunction composeFromBoolean(@Nonnull BooleanToCharFunction before) {
        Objects.requireNonNull(before);
     ...
     */
    @Nonnull
    default ByteToDoubleFunction composeFromByte(@Nonnull ByteToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default CharToDoubleFunction composeFromChar(@Nonnull CharUnaryOperator before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default DoubleUnaryOperator2 composeFromDouble(@Nonnull DoubleToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default FloatToDoubleFunction composeFromFloat(@Nonnull FloatToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default IntToDoubleFunction2 composeFromInt(@Nonnull IntToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default LongToDoubleFunction2 composeFromLong(@Nonnull LongToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default ShortToDoubleFunction composeFromShort(@Nonnull ShortToCharFunction before) {
        Objects.requireNonNull(before);
        return value -> applyAsDouble(before.applyAsChar(value));
    }
     ...
     */
    @Nonnull
    default <S> CharFunction<S> andThen(@Nonnull DoubleFunction<? extends S> after) {
     ...
     */
    @Nonnull
    default CharPredicate andThenToBoolean(@Nonnull DoublePredicate after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToByteFunction andThenToByte(@Nonnull DoubleToByteFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharUnaryOperator andThenToChar(@Nonnull DoubleToCharFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToDoubleFunction andThenToDouble(@Nonnull DoubleUnaryOperator after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToFloatFunction andThenToFloat(@Nonnull DoubleToFloatFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToIntFunction andThenToInt(@Nonnull DoubleToIntFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToLongFunction andThenToLong(@Nonnull DoubleToLongFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharToShortFunction andThenToShort(@Nonnull DoubleToShortFunction after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default CharConsumer consume(@Nonnull DoubleConsumer consumer) {
     ...
     */
    @Nonnull
    default CharToDoubleFunction reversed() {
        return this;
    }
     ...
     * CharToDoubleFunction} with methods provided by the {@code JDK}.
     *
