 ...
 * ThrowableFunction}.
 * <p>
 * This is a {@link FunctionalInterface} whose functional method is {@link #applyAsFloatThrows(char)}.
 *
...
@FunctionalInterface
public interface ThrowableCharToFloatFunction<X extends Throwable> extends Lambda {

    /**
     * Constructs a {@link ThrowableCharToFloatFunction} based on a lambda expression or a method reference. Thereby the
     ...
     * @return A {@code ThrowableCharToFloatFunction} from given lambda expression or method reference.
    ...
    @CheckForNull
    @Nullable
    static <X extends Throwable> ThrowableCharToFloatFunction<X> of(
            @Nullable ThrowableCharToFloatFunction<X> expression) {
        return expression;
    }

    /**
     * Calls the given {@link ThrowableCharToFloatFunction} with the given argument and returns its result.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param function The function to be called
     * @param value The argument to the function
     * @return The result from the given {@code ThrowableCharToFloatFunction}.
     * @throws NullPointerException If given argument is {@code null}
     * @throws X Any throwable from this functions action
     */
    static <X extends Throwable> float call(@Nonnull ThrowableCharToFloatFunction<? extends X> function,
            char value) throws X {
    ...
    /**
     * Creates a {@link ThrowableCharToFloatFunction} which always returns a given value.
     *
     * @param <X> The type of the throwable to be thrown by this function
     * @param ret The return value for the constant
     * @return A {@code ThrowableCharToFloatFunction} which always returns a given value.
     */
    @Nonnull
    static <X extends Throwable> ThrowableCharToFloatFunction<X> constant(float ret) {
        return value -> ret;
    }
     ...
     * @throws X Any throwable from this functions action
     */
    float applyAsFloatThrows(char value) throws X;
    ...
    default <A> ThrowableToFloatFunction<A, X> compose(
        ...
        return a -> applyAsFloatThrows(before.applyAsCharThrows(a));
    }
    ...
    default ThrowableBooleanToFloatFunction<X> composeFromBoolean(
        ...
        Objects.requireNonNull(before);
        return value -> applyAsFloatThrows(before.applyAsCharThrows(value));
    }
    ...
    /**
     * Returns a composed {@link ThrowableCharToFloatFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     * execute an operation which accepts {@code char} input, before this primitive function is executed.
     *
     * @param before The operator to apply before this function is applied
     * @return A composed {@code ThrowableCharToFloatFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result.
     * @throws NullPointerException If given argument is {@code null}
     * @implSpec The input argument of this method is able to handle primitive values. In this case this is {@code
     * char}.
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> andThenToBoolean(@Nonnull ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> andThenToInt(@Nonnull ThrowableFloatToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> consume(@Nonnull ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableCharToFloatFunction<X> reversed() {
        return this;
    }

    /**
     * Returns a memoized (caching) version of this {@link ThrowableCharToFloatFunction}. Whenever it is called, the
     ...
     * forever.
     *
     * @return A memoized (caching) version of this {@code ThrowableCharToFloatFunction}.
     ...
     */
    @Nonnull
    default ThrowableCharToFloatFunction<X> memoized() {
        if (isMemoized()) {
            return this;
        } else {
            Map<Character, Float> cache = new ConcurrentHashMap<>();
            return (ThrowableCharToFloatFunction<X> & Memoized) value -> {
    ...
    /**
     * Returns a composed {@link ThrowableFunction} which represents this {@link ThrowableCharToFloatFunction}. Thereby
     * the primitive input argument for this function is autoboxed. This method provides the possibility to use this
     * {@code ThrowableCharToFloatFunction} with methods provided by the {@code JDK}.
     *
     * @return A composed {@code ThrowableFunction} which represents this {@code ThrowableCharToFloatFunction}.
     */
    @Nonnull
    default ThrowableFunction<Character, Float, X> boxed() {
        return this::applyAsFloatThrows;
    }

    /**
     * Returns a composed {@link CharToFloatFunction} that applies this function to its input and nests the thrown
     * {@link Throwable} from it. The {@code Throwable} is nested (wrapped) in a {@link
     * ThrownByFunctionalInterfaceException}, which is constructed from the thrown {@code Throwable}s message and the
     * thrown {@code Throwable} itself.
     *
     * @return A composed {@link CharToFloatFunction} that applies this function to its input and nests the thrown
     ...
     */
    @Nonnull
    default CharToFloatFunction nest() {
     ...
     */
    @Nonnull
    default CharToFloatFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default CharToFloatFunction recover(
            @Nonnull Function<? super Throwable, ? extends CharToFloatFunction> recover) {
        ...
        return value -> {
            try {
                ...
                CharToFloatFunction function = recover.apply(throwable);
    ...
    /**
     * Returns a composed {@link CharToFloatFunction} that applies this function to its input and sneakily throws the
     ...
     *
     * @return A composed {@link CharToFloatFunction} that applies this function to its input and sneakily throws the
     * thrown {@link Throwable} from it, unless it is of type {@link RuntimeException} or {@link Error}.
     * @implNote If thrown {@link Throwable} is of type {@link RuntimeException} or {@link Error}, it is thrown as-is
     * and thus not sneakily thrown.
     */
    @Nonnull
    default CharToFloatFunction sneakyThrow() {
        return value -> {
            try {
                return applyAsFloatThrows(value);
