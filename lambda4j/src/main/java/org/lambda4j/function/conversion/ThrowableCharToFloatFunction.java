...
public interface ThrowableCharToFloatFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableCharToFloatFunction<X> of(
            @Nullable final ThrowableCharToFloatFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> float call(@Nonnull final ThrowableCharToFloatFunction<? extends X> function,
            char value) throws X {
    ...
    /**
     * Returns a composed {@link ThrowableCharToFloatFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default ThrowableCharPredicate<X> andThenToBoolean(@Nonnull final ThrowableFloatPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharToIntFunction<X> andThenToInt(@Nonnull final ThrowableFloatToIntFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableCharConsumer<X> consume(@Nonnull final ThrowableFloatConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default CharToFloatFunction nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default CharToFloatFunction recover(
            @Nonnull final Function<? super Throwable, ? extends CharToFloatFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final CharToFloatFunction function = recover.apply(throwable);
