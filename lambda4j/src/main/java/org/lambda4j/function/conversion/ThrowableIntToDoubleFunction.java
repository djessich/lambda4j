...
public interface ThrowableIntToDoubleFunction<X extends Throwable> extends Lambda, IntToDoubleFunction {
    ...
    static <X extends Throwable> ThrowableIntToDoubleFunction<X> of(
            @Nullable final ThrowableIntToDoubleFunction<X> expression) {
        return expression;
    }
    ...
    /**
     * Returns a composed {@link ThrowableIntToDoubleFunction} that first applies the {@code before} operator to
     * its input, and then applies this function to the result.
     ...
     */
    @Nonnull
    default IntToDoubleFunction2 nest(@Nonnull final Function<? super Throwable, ? extends RuntimeException> mapper) {
    ...
    default IntToDoubleFunction2 recover(
            @Nonnull final Function<? super Throwable, ? extends IntToDoubleFunction> recover) {
        ...
        return (value) -> {
            try {
                ...
                final IntToDoubleFunction function = recover.apply(throwable);
