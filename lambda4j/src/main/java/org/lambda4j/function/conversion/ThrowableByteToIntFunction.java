...
public interface ThrowableByteToIntFunction<X extends Throwable> extends Lambda {
    ...
    static <X extends Throwable> ThrowableByteToIntFunction<X> of(
            @Nullable ThrowableByteToIntFunction<X> expression) {
        return expression;
    }
     ...
     */
    static <X extends Throwable> int call(@Nonnull ThrowableByteToIntFunction<? extends X> function,
            byte value) throws X {
    ...
    /**
     * Returns a composed {@link ThrowableByteToIntFunction} that first applies the {@code before} operator to its
     * input, and then applies this function to the result. This method is just convenience, to provide the ability to
     ...
     */
    @Nonnull
    default ThrowableIntUnaryOperator<X> composeFromInt(@Nonnull ThrowableIntToByteFunction<? extends X> before) {
        Objects.requireNonNull(before);
        return value -> applyAsIntThrows(before.applyAsByteThrows(value));
    }
     ...
     */
    @Nonnull
    default ThrowableBytePredicate<X> andThenToBoolean(@Nonnull ThrowableIntPredicate<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteUnaryOperator<X> andThenToByte(@Nonnull ThrowableIntToByteFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToCharFunction<X> andThenToChar(@Nonnull ThrowableIntToCharFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> andThenToInt(@Nonnull ThrowableIntUnaryOperator<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteToLongFunction<X> andThenToLong(@Nonnull ThrowableIntToLongFunction<? extends X> after) {
        Objects.requireNonNull(after);
     ...
     */
    @Nonnull
    default ThrowableByteConsumer<X> consume(@Nonnull ThrowableIntConsumer<? extends X> consumer) {
     ...
     */
    @Nonnull
    default ThrowableByteToIntFunction<X> reversed() {
        return this;
    }
     ...
     */
    @Nonnull
    default ByteToIntFunction nest(@Nonnull Function<? super Throwable, ? extends RuntimeException> mapper) {
     ...
     */
    @Nonnull
    default ByteToIntFunction recover(@Nonnull Function<? super Throwable, ? extends ByteToIntFunction> recover) {
        ...
        return value -> {
            try {
                ...
                ByteToIntFunction function = recover.apply(throwable);
